const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/RealisticTree.glsl-CqadIGfZ.js","assets/MapPage-BJqczGqk.js","assets/index-D-2rXIQn.js","assets/index-j2QWNen5.css","assets/rotate-ccw-Dtygc1MB.js","assets/leaf-C0E8s7OC.js","assets/MapPage-OCMtRbrJ.css","assets/HUDMaterial.glsl-DJKJvaTS.js","assets/vec42-KQwmbPKj.js","assets/vec4f64-DPb6J-GU.js","assets/meshVertexSpaceUtils-q_L2UEk-.js","assets/MeshLocalVertexSpace-CkNcDUFZ.js","assets/projectVectorToVector-D7PCG8zx.js","assets/projectPointToVector-CR4uikRk.js","assets/hydratedFeatures-CHsPXQvB.js","assets/vec3f32-WCVSSNPR.js","assets/OutputColorHighlightOID.glsl-D9QMMJV6.js","assets/Indices-BctbzROb.js","assets/BufferView-aHSSCVOP.js","assets/triangle-BFfzIlCJ.js","assets/sphere-D0CpxzzN.js","assets/vectorStacks-BHqEYFXq.js","assets/quatf64-aQ5IuZRd.js","assets/lineSegment-BXs7tGEn.js","assets/renderState-CKc66y4x.js","assets/glsl-B5bJgrnA.js","assets/frustum-CFL4HVCD.js","assets/plane-CqsjI0dZ.js","assets/orientedBoundingBox-CN7Jc0EW.js","assets/quat-CUA6iAzG.js","assets/spatialReferenceEllipsoidUtils-T66w68Px.js","assets/computeTranslationToOriginAndRotation-CgI8qLIN.js","assets/VertexAttributeLocations-BfZbt_DV.js","assets/VertexElementDescriptor-BLyltQyJ.js","assets/InterleavedLayout-DCmZwmki.js","assets/types-BKo2foNY.js","assets/ShaderBuilder-CJB55FM3.js","assets/memoryEstimations-DYzMhPGm.js"])))=>i.map(i=>d[i]);
import{gT as ze,dD as x,dL as k,eM as $e,aI as At,eb as Dt,ho as Gt,eE as V,he as jt,mz as Bt,iG as Ht,pS as et,_ as c,v as H,x as tt,pT as Wt,pU as kt,eg as at,j4 as Fe,jb as Q,hm as Ge,hc as Ut,kl as Yt,pV as U,fP as ot,iH as ne,bm as re,d9 as qt,db as Zt,dl as Xt,a7 as Jt,i9 as Kt,cd as Qt,eh as ea,dP as ta,dJ as aa,dA as be,dB as oa,dR as je,dH as ra,ha as ia,dK as na}from"./MapPage-BJqczGqk.js";import{a6 as E,i as he,d as me,a7 as I,a as rt,a8 as pe,a9 as it,aa as nt,ab as sa,ac as W,ad as la,ae as ca,af as da,f as ua,ag as J,r as O,a2 as ae,D as A,E as D,ah as G,G as K,b as y,I as j,ai as ha,H as ma,aj as pa,ak as st,q as se,al as lt,o as ct,am as dt,g as fa,j as Ne,k as fe,s as ut,an as va,ao as ga,u as xa,v as Be,ap as ba,aq as _,ar as Oe,as as wa,at as ya,c as ee,au as Ma,V as oe,av as Ta,M as _a,aw as ht,ax as le,F as mt,L as pt,K as ft,ay as vt,J as gt,N as Sa,O as Ca,P as za,Q as $a,R as Fa,X as Na,T as Oa,U as Ia,W as La,Y as Va,x as m,A as Ea,az as we,aA as ye,a1 as Ra,aB as Pa,B as Aa,aC as Da,a3 as Ga,aD as ja}from"./OutputColorHighlightOID.glsl-D9QMMJV6.js";import{_ as ve}from"./index-D-2rXIQn.js";import{n as xt,r as Ba}from"./vec4f64-DPb6J-GU.js";import{t as Ce,Q as Ie}from"./InterleavedLayout-DCmZwmki.js";import{t as i,n as p}from"./glsl-B5bJgrnA.js";import{s as S,T as bt,g as ce,I as He}from"./BufferView-aHSSCVOP.js";import{r as Ha}from"./VertexBuffer-B3SswID1.js";import{g as Wa}from"./plane-CqsjI0dZ.js";import{s as ge}from"./ShaderBuilder-CJB55FM3.js";import{T as Le,d as Ve,_ as ka}from"./renderState-CKc66y4x.js";import{s as z}from"./vec42-KQwmbPKj.js";import{t as Ua}from"./VertexAttributeLocations-BfZbt_DV.js";function xe(a,e){switch(a.fragment.code.add(i`vec3 screenDerivativeNormal(vec3 positionView) {
...
return posClip;
  ...
  `)}function Tt(a,e){e.instancedColor?(a.attributes.add("instanceColor","vec4"),a.vertex.include(pe),a.vertex.include(it),a.vertex.include(nt),a.vertex.code.add(i`
      MaskedColor applyInstanceColor(MaskedColor color) {
        return multiplyMaskedColors( color, createMaskedFromUInt8NaNColor(${"instanceColor"}));
      }
    `)):a.vertex.code.add(i`MaskedColor applyInstanceColor(MaskedColor color) {
return color;
}`)}const Ue=k();function _t(a,e){const{hasModelTransformation:t,instancedDoublePrecision:o,instanced:r,output:s,hasVertexTangents:d}=e;t&&(a.vertex.uniforms.add(new sa("model",l=>l.modelTransformation??Ge)),a.vertex.uniforms.add(new I("normalLocalOriginFromModel",l=>(Ut(Ue,l.modelTransformation??Ge),Ue)))),r&&o&&(a.attributes.add("instanceModelOriginHi","vec3"),a.attributes.add("instanceModelOriginLo","vec3"),a.attributes.add("instanceModel","mat3"),a.attributes.add("instanceModelNormal","mat3"));const n=a.vertex;o&&(n.include(Ya,e),n.uniforms.add(new W("viewOriginHi",l=>la(V(ie,l.camera.viewInverseTransposeMatrix[3],l.camera.viewInverseTransposeMatrix[7],l.camera.viewInverseTransposeMatrix[11]),ie)),new W("viewOriginLo",l=>ca(V(ie,l.camera.viewInverseTransposeMatrix[3],l.camera.viewInverseTransposeMatrix[7],l.camera.viewInverseTransposeMatrix[11]),ie)))),n.code.add(i`
    ...
    }`)}const ie=x();function St(a,e){a.varyings.add("colorMixMode","int"),a.varyings.add("opacityMixMode","int"),a.vertex.uniforms.add(new ua("symbolColorMixMode",t=>J[t.colorMixMode])),e.hasSymbolColors?(a.vertex.include(pe),a.vertex.include(it),a.vertex.include(nt),a.attributes.add("symbolColor","vec4"),a.vertex.code.add(i`
...
forwardTextureCoordinates();`),a.include(B,e),o.main.add(i`
        ...
        ${p(n,i`vec4 texColor = texture(tex, ${f?"colorUV":"vuv0"});
                discardOrAdjustAlpha(texColor);`)}`);break;case 4:case 5:case 6:case 7:case 10:A(t,e),a.include(D),a.include(G,e),a.include(K,e),a.include(co,e),o.include(j,e),a.include(ma,e),pa(a),r.add("depth","float",{invariant:!0}),n&&o.uniforms.add(new y("tex",v=>v.texture)),t.main.add(i`vpos = getVertexInLocalOriginSpace();
vpos = subtractOrigin(vpos);
vpos = addVerticalOffset(vpos, localOrigin);
...
vpos = addVerticalOffset(vpos, localOrigin);
gl_Position = transformPosition(proj, view, vpos);
forwardTextureCoordinates();`),o.include(j,e),a.include(B,e),a.include(ha,e),o.main.add(i`
        discardBySlice(vpos);
        ${p(n,i`vec4 texColor = texture(tex, ${f?"colorUV":"vuv0"});
                discardOrAdjustAlpha(texColor);`)}
...
}`),s&&d!==0&&(a.include(st,e),t.uniforms.add(n===1?new y("normalTexture",u=>u.textureNormal):new se("normalTexture",u=>u.textureNormal)),l&&(t.uniforms.add(new lt("scale",u=>u.scale??Yt)),t.uniforms.add(new I("normalTextureTransformMatrix",u=>u.normalTextureTransformMatrix??U))),t.code.add(i`vec3 computeTextureNormal(mat3 tangentSpace, vec2 uv) {
...
}`),a.outputs.add("fragOcclusion","float"),e.uniforms.add(new y("normalMap",t=>t.normalTexture),new y("depthMap",t=>t.depthTexture),new O("projScale",t=>t.projScale),new y("rnm",t=>t.noiseTexture),new lt("rnmScale",(t,o)=>ne(Xe,o.camera.fullWidth/t.noiseTexture.descriptor.width,o.camera.fullHeight/t.noiseTexture.descriptor.height)),new O("intensity",t=>t.intensity),new ga("screenSize",t=>ne(Xe,t.camera.fullWidth,t.camera.fullHeight))).main.add(i`
...
}`))}const Ke=x(),$=xt();function ue(a){a.uniforms.add(new W("mainLightDirection",e=>e.lighting.mainLight.direction))}function te(a){a.uniforms.add(new W("mainLightIntensity",e=>e.lighting.mainLight.intensity))}function So(a){ue(a.fragment),te(a.fragment),a.fragment.code.add(i`vec3 applyShading(vec3 shadingNormal, float shadow) {
...
}`))}function Pr(a,e){a.include(Oe),a.code.add(i`
...
float getBakedOcclusion() { return 1.0; }`);const{hasMetallicRoughnessTexture:r,hasMetallicRoughnessTextureTransform:s,hasOcclusionTexture:d,hasOcclusionTextureTransform:n,bindType:l}=e;(r||d)&&a.include(st,e),o.code.add(i`vec3 mrr;
float occlusion;`),r&&o.uniforms.add(l===1?new y("texMetallicRoughness",u=>u.textureMetallicRoughness):new se("texMetallicRoughness",u=>u.textureMetallicRoughness)),d&&o.uniforms.add(l===1?new y("texOcclusion",u=>u.textureOcclusion):new se("texOcclusion",u=>u.textureOcclusion)),o.uniforms.add(l===1?new ee("mrrFactors",u=>u.mrrFactors):new Ma("mrrFactors",u=>u.mrrFactors)),o.code.add(i`
...
}`)):a.vertex.code.add(i`void forwardMetallicRoughnessUV(){}`)}function Lt(a){a.include(_a),a.code.add(i`
...
return mix(mrr, vec3(0.0, 1.0, 0.04), snow);
}`))}function Ho(a){const e=new ge,{attributes:t,vertex:o,fragment:r,varyings:s}=e,{output:d,normalType:n,offsetBackfaces:l,spherical:u,snowCover:f,pbrMode:v,textureAlphaPremultiplied:M,instancedDoublePrecision:C,hasVertexColors:g,hasVertexTangents:F,hasColorTexture:N,hasNormalTexture:Y,hasNormalTextureTransform:R,hasColorTextureTransform:P}=a;if(A(o,a),t.add("position","vec3"),s.add("vpos","vec3",{invariant:!0}),e.include(K,a),e.include(_t,a),e.include(ht,a),e.include(Ao,a),!oe(d))return e.include(Ct,a),e;e.include(Do,a),e.include(Go,a),e.include(jo,a),e.include(Bo,a),le(o,a),e.include(xe,a),e.include(D);const L=n===0||n===1;return L&&l&&e.include(Mt),e.include(ho,a),e.include(wt,a),e.include(Tt,a),s.add("vPositionLocal","vec3"),e.include(G,a),e.include(St,a),e.include(mt,a),o.uniforms.add(new pt("externalColor",b=>b.externalColor,{supportsNaN:!0})),s.add("vcolorExt","vec4"),e.include(ft,a),o.include(pe),o.include(vt),e.include(C?Nt:Ot,a),o.main.add(i`
  ...
  `);const{hasColorTexture:M,hasColorTextureTransform:C}=a;return e.include(zt,a),r.include(Re,a),e.include(B,a),r.include(j,a),e.include(gt,a),le(r,a),ue(r),Ae(r),De(r),r.uniforms.add(o.uniforms.get("localOrigin"),o.uniforms.get("view"),new ee("ambient",g=>g.ambient),new ee("diffuse",g=>g.diffuse),new O("opacity",g=>g.opacity),new O("layerOpacity",g=>g.layerOpacity)),M&&r.uniforms.add(new y("tex",g=>g.texture)),e.include($t,a),r.include(Pe,a),r.include(Lt),r.include(Vt,a),te(r),r.main.add(i`
      discardBySlice(vpos);
      discardByTerrainDepth();
