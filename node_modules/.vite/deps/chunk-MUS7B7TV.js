...
async function v(t2, r) {
  const n3 = U((await H(t2, { responseType: "text", query: { SERVICE: "WFS", REQUEST: "GetCapabilities", VERSION: S, ...r == null ? void 0 : r.customParameters }, signal: r == null ? void 0 : r.signal })).data);
  return D(t2, n3), n3;
}
function U(e) {
  const t2 = te(e);
...
function M(e) {
  ...
  if (o(e, { OperationsMetadata: { Parameter: (e2) => {
    var _a;
    if ("outputformat" === ((_a = e2.getAttribute("name")) == null ? void 0 : _a.toLowerCase())) return { AllowedValues: { Value: ({ textContent: e3 }) => {
      e3 && a.push(e3);
    } } };
  }, Operation: (e2) => {
    switch (e2.getAttribute("name")) {
      ...
      case "GetFeature":
        return { DCP: { HTTP: { Get: (e3) => {
          ...
          var _a;
          if ("outputformat" === ((_a = e3.getAttribute("name")) == null ? void 0 : _a.toLowerCase())) return { AllowedValues: { Value: ({ textContent: e4 }) => {
            e4 && o2.push(e4);
          } } };
        } };
    }
...
function V(e) {
  var _a, _b, _c;
  const t2 = parseInt(((_c = (_b = (_a = e.textContent) == null ? void 0 : _a.match(/(?<wkid>\d+$)/i)) == null ? void 0 : _b.groups) == null ? void 0 : _c.wkid) ?? "", 10);
...
async function X(e, r, n3, a = {}) {
  const o2 = e.readFeatureTypes(), s2 = r ? Y(o2, r, n3) : o2.next().value, { spatialReference: i = new f({ wkid: s2 == null ? void 0 : s2.defaultSpatialReference }) } = a;
...
async function q(e, r, n3, a = {}) {
  ...
  const { fields: u2, errors: l } = s2.value ?? {}, c = ((_a = s2.value) == null ? void 0 : _a.geometryType) || ((_b = i.value) == null ? void 0 : _b.geometryType), m2 = ((_c = i.value) == null ? void 0 : _c.swapXY) ?? false;
...
function z2(e) {
  ...
  return e = e.filter((e2) => "geometry" !== e2.type), r || (r = new m({ name: F2, type: "oid", alias: F2 }), e.unshift(r)), { geometryField: (t2 == null ? void 0 : t2.name) ?? null, objectIdField: r.name, fields: e };
}
async function _(t2, r, n3, a = {}) {
  var _a;
  let o2, s2 = false;
  const [i, p] = await Promise.all([K(t2.operations.GetFeature.url, r, n3, t2.operations.GetFeature.outputFormat, { ...a, count: 1 }), H(t2.operations.GetFeature.url, { responseType: "text", query: Z(r, n3, void 0, { ...a, count: 1 }), signal: a == null ? void 0 : a.signal })]), u2 = "FeatureCollection" === i.type && ((_a = i.features[0]) == null ? void 0 : _a.geometry);
  if (u2) {
    let e;
...
async function J(t2, r, n3) {
  return Q(r, (await H(t2, { responseType: "text", query: { SERVICE: "WFS", REQUEST: "DescribeFeatureType", VERSION: S, TYPENAME: r, TYPENAMES: r, ...n3 == null ? void 0 : n3.customParameters }, signal: n3 == null ? void 0 : n3.signal })).data);
}
function Q(e, n3) {
...
async function K(r, n3, a, o2, s2) {
  let { data: i } = await H(r, { responseType: "text", query: Z(n3, a, o2, s2), signal: s2 == null ? void 0 : s2.signal });
...
function Z(e, t2, r, n3) {
  ...
  return { SERVICE: "WFS", REQUEST: "GetFeature", VERSION: S, TYPENAMES: e, OUTPUTFORMAT: r, SRSNAME: "EPSG:" + a, STARTINDEX: n3 == null ? void 0 : n3.startIndex, COUNT: n3 == null ? void 0 : n3.count, ...n3 == null ? void 0 : n3.customParameters };
}
async function ee(t2, r, n3) {
  const a = await H(t2, { responseType: "text", query: { SERVICE: "WFS", REQUEST: "GetFeature", VERSION: S, TYPENAMES: r, RESULTTYPE: "hits", ...n3 == null ? void 0 : n3.customParameters }, signal: n3 == null ? void 0 : n3.signal }), o2 = /numberMatched=["'](?<numberMatched>\d+)["']/gi.exec(a.data);
  if (o2 == null ? void 0 : o2.groups) return +o2.groups.numberMatched;
}
function te(e) {
...
function oe(e, t2, r) {
  const n3 = { wkid: t2.defaultSpatialReference }, a = null != (r == null ? void 0 : r.wkid) ? { wkid: r.wkid } : n3;
...
//# sourceMappingURL=chunk-MUS7B7TV.js.map
