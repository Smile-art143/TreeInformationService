import {
  l as l5
} from "./chunk-MVKLROPQ.js";
import {
  G
} from "./chunk-CI5YDGEF.js";
import {
  s as s7,
  v as v2
} from "./chunk-2IA3B26W.js";
import {
  t as t2
} from "./chunk-M7RQIHHA.js";
import {
  b as b3
...
import {
  s as s6
} from "./chunk-7FRTD4NI.js";
import {
  et
} from "./chunk-BKKULWQY.js";
import {
  c as c7
} from "./chunk-L623OXHS.js";
import {
  p as p4
} from "./chunk-UE62VJB3.js";
import {
  d as d3
} from "./chunk-K6TGIAKJ.js";
import {
  A,
  B as B2,
  Ce,
  ...
  ye,
  z
} from "./chunk-R67VL22F.js";
import {
  u as u2
} from "./chunk-RIYDIMKQ.js";
import {
  N as N3
} from "./chunk-BUMFELVS.js";
import {
  o
...
import {
  ...
  l as l4,
  p as p3
} from "./chunk-DPSLSTXW.js";
import {
  ge
} from "./chunk-T4GK6CYR.js";
import {
  l as l3
} from "./chunk-AJADK2NT.js";
import {
  c as c6
...
import {
  s as s4
} from "./chunk-3QEEWKMT.js";
import {
  c as c3
} from "./chunk-GBEVGA4U.js";
import {
  s as s5
...
import {
  n as n2
} from "./chunk-GAJ3Q44J.js";
import {
  H2 as H,
  _
} from "./chunk-JURCYX7Y.js";
import {
  r as r2
...
var y3 = class extends b {
  ...
  get supportsTypeWildcard() {
    ...
    if (!t6) return false;
    const e14 = t6.sourceLayer ?? t6.layer;
    return (e14 == null ? void 0 : e14.loaded) && "capabilities" in e14 && e14.capabilities && "attachment" in e14.capabilities && e14.capabilities.attachment && "supportsResize" in e14.capabilities.attachment && e14.capabilities.attachment.supportsTypeWildcard || false;
  }
  async getAttachments() {
    ...
    const c14 = a6 == null ? void 0 : a6.map((t7) => `${t7.field} ${"descending" === t7.order ? "DESC" : "ASC"}`), h7 = new p4({ objectIds: [o4], returnMetadata: true, orderByFields: c14, attachmentTypes: s13 ? i10 == null ? void 0 : i10.filter(Boolean).map((t7) => `${t7}/*`) : void 0, keywords: r5 }), d9 = [], l9 = t6.queryAttachments(h7).then((t7) => t7[o4] || d9).catch(() => d9);
  ...
  async addAttachment(t6, e14 = this.graphic) {
    ...
    if (!((_a2 = r5.operations) == null ? void 0 : _a2.add)) throw new s("invalid-capabilities", "addAttachment(): add capabilities are required.");
  ...
  async deleteAttachment(t6) {
    ...
    if (!((_a2 = r5.operations) == null ? void 0 : _a2.delete)) throw new s("invalid-capabilities", "deleteAttachment(): delete capabilities are required.");
  ...
  async updateAttachment(t6, e14 = this.activeAttachmentInfo) {
    ...
    if (!((_a2 = s13.operations) == null ? void 0 : _a2.update)) throw new s("invalid-capabilities", "updateAttachment(): Update capabilities are required.");
  ...
  async _queryAttachment(t6, e14) {
    ...
    if (!t6 || !(a6 == null ? void 0 : a6.queryAttachments)) throw new s("invalid-attachment-id", "Could not query attachment.");
...
function p5(e14) {
  const p12 = n2("esri/themes/base/images/files/");
...
var k2 = class extends B {
  ...
  loadDependencies() {
    return c4({ icon: () => import("./calcite-icon-ZV6LJS7F.js") });
  }
  get capabilities() {
  ...
  deleteFile(e14) {
    var _a2;
    const t6 = this.viewModel.deleteFile(e14 || ((_a2 = this.viewModel.activeFileInfo) == null ? void 0 : _a2.file));
    return this.viewModel.mode = "view", t6;
  }
  render() {
    const { submitting: e14, viewModel: t6 } = this, { state: s13 } = t6;
    return n("div", { class: this.classes(M2.base, e5.widget) }, e14 ? this._renderProgressBar() : null, "loading" === s13 ? this._renderLoading() : this._renderAttachments(), this._renderErrorMessage());
  }
  _renderErrorMessage() {
    const { error: e14, visibleElements: t6 } = this;
    return e14 && t6.errorMessage ? n("div", { class: M2.errorMessage, key: "error-message" }, e14.message) : null;
  }
  _renderAttachments() {
  ...
  _renderLoading() {
    return n("div", { class: M2.loaderContainer, key: "loader" }, n("div", { class: M2.loader }));
  }
  _renderProgressBar() {
    return this.visibleElements.progressBar ? n("div", { class: M2.progressBar, key: "progress-bar" }) : null;
  }
  _renderAddForm() {
    const { submitting: e14, selectedFile: t6 } = this, s13 = e14 || !t6, i10 = this.visibleElements.cancelAddButton ? n("button", { bind: this, class: this.classes(e5.button, e5.buttonTertiary, e5.buttonSmall, e5.buttonHalf, e14 && e5.buttonDisabled), disabled: e14, onclick: this._cancelForm, type: "button" }, this.messages.cancel) : null, a6 = this.visibleElements.addSubmitButton ? n("button", { class: this.classes(e5.button, e5.buttonSecondary, e5.buttonSmall, e5.buttonHalf, { [e5.buttonDisabled]: s13 }), disabled: s13, type: "submit" }, this.messages.add) : null, n11 = t6 ? n("span", { class: M2.fileName, key: "file-name" }, t6.name) : null, r5 = n("form", { afterCreate: y2, afterRemoved: h2, bind: this, "data-node-ref": "_addAttachmentForm", onsubmit: this._submitAddAttachment }, n("fieldset", { class: M2.fileFieldset }, n11, n("label", { class: this.classes(M2.fileLabel, e5.button, e5.buttonSecondary) }, t6 ? this.messages.changeFile : this.messages.selectFile, n("input", { bind: this, class: M2.fileInput, name: "attachment", onchange: this._handleFileInputChange, type: "file" }))), a6, i10);
    return n("div", { class: M2.formNode, key: "add-form-container" }, r5);
  }
  _renderDetailsForm(e14) {
    ...
    const h7 = r5.editing && ((_a2 = r5.operations) == null ? void 0 : _a2.delete) && t6.deleteButton ? n("button", { bind: this, class: this.classes(e5.button, e5.buttonSmall, e5.buttonTertiary, M2.deleteButton, { [e5.buttonDisabled]: a6 }), disabled: a6, key: "delete-button", onclick: (t7) => this._submitDeleteAttachment(t7, e14), type: "button" }, this.messages.delete) : void 0, u8 = r5.editing && ((_b = r5.operations) == null ? void 0 : _b.update) && t6.updateButton ? n("button", { class: this.classes(e5.button, e5.buttonSmall, e5.buttonThird, { [e5.buttonDisabled]: l9 }), disabled: l9, key: "update-button", type: "submit" }, this.messages.update) : void 0, b10 = this.visibleElements.cancelUpdateButton ? n("button", { bind: this, class: this.classes(e5.button, e5.buttonSmall, e5.buttonTertiary, e5.buttonThird, { [e5.buttonDisabled]: a6 }), disabled: a6, key: "cancel-button", onclick: this._cancelForm, type: "button" }, this.messages.cancel) : void 0, v9 = r5.editing && ((_c = r5.operations) == null ? void 0 : _c.update) ? n("fieldset", { class: M2.fileFieldset, key: "file" }, n("span", { class: M2.fileName, key: "file-name" }, d9), n("label", { class: this.classes(M2.fileLabel, e5.button, e5.buttonSecondary) }, this.messages.changeFile, n("input", { bind: this, class: M2.fileInput, name: "attachment", onchange: this._handleFileInputChange, type: "file" }))) : void 0, f9 = n("fieldset", { class: M2.metadataFieldset, key: "size" }, n("label", null, G(this.messagesUnits, c14 ?? 0))), w6 = n("fieldset", { class: M2.metadataFieldset, key: "content-type" }, n("label", null, o4)), A5 = null != m8 ? n("a", { class: M2.itemLink, href: m8, rel: "noreferrer", target: "_blank" }, this._renderImageMask(e14, 400), n("div", { class: M2.itemLinkOverlay }, n("span", { class: M2.itemLinkOverlayIcon }, n("calcite-icon", { icon: "launch" })))) : this._renderImageMask(e14, 400), F9 = n("form", { afterCreate: y2, afterRemoved: h2, bind: this, "data-node-ref": "_updateAttachmentForm", onsubmit: (t7) => this._submitUpdateAttachment(t7, e14) }, n("div", { class: M2.metadata }, f9, w6), v9, n("div", { class: M2.actions }, h7, b10, u8));
    return n("div", { class: M2.formNode, key: "edit-form-container" }, A5, F9);
  }
  ...
  _renderGenericImageMask(e14, t6) {
    ...
    return n("div", { class: this.classes(M2.itemMaskIcon, M2.itemMask), key: i10 }, n("img", { alt: e14, class: this.classes(a6, M2.itemImage), src: i10, title: e14 }));
  }
  _renderImageMaskForAttachment(e14, t6) {
    ...
    const l9 = this._getCSSTransform(e14), o4 = l9 ? { transform: l9, "image-orientation": "none" } : {}, d9 = `${r5}${(r5 == null ? void 0 : r5.includes("?")) ? "&" : "?"}w=${t6}&s=${n11}`, c14 = { [M2.itemImageResizable]: s13 };
    return n("div", { class: this.classes(M2.itemMask), key: d9 }, n("img", { alt: a6, class: this.classes(c14, M2.itemImage), src: d9, styles: o4, title: a6 }));
  }
  _renderFile(e14) {
    const { file: t6 } = e14;
    return n("li", { class: M2.item, key: t6 }, n("button", { "aria-label": this.messages.attachmentDetails, bind: this, class: M2.itemButton, key: "details-button", onclick: () => this._startEditFile(e14), title: this.messages.attachmentDetails, type: "button" }, this._renderImageMask(e14), n("label", { class: M2.itemLabel }, n("span", { class: M2.itemFilename }, t6.name || this.messages.noTitle), n("span", { "aria-hidden": "true", class: this.classes(M2.itemChevronIcon, L2(this.container) ? i7.left : i7.right) }))));
  }
  _renderAttachmentInfo({ attachmentInfo: e14, displayType: t6 }) {
    const { viewModel: s13, effectiveDisplayType: i10 } = this, { capabilities: a6, supportsResizeAttachments: n11 } = s13, { contentType: r5, name: l9, url: o4 } = e14, d9 = this._renderImageMask(e14, "list" === t6 ? 48 : 400), c14 = a6.editing ? n("span", { "aria-hidden": "true", class: this.classes(M2.itemChevronIcon, L2(this.container) ? i7.left : i7.right) }) : null, m8 = [d9, "preview" === i10 && n11 && e6(r5) ? null : n("label", { class: M2.itemLabel }, n("span", { class: M2.itemFilename }, l9 || this.messages.noTitle), c14)], u8 = a6.editing ? n("button", { "aria-label": this.messages.attachmentDetails, bind: this, class: M2.itemButton, "data-attachment-info-id": e14.id, key: "details-button", onclick: () => this._startEditAttachment(e14), title: this.messages.attachmentDetails, type: "button" }, m8) : n("a", { class: M2.itemButton, href: o4 ?? void 0, key: "details-link", rel: "noreferrer", target: "_blank" }, m8);
    return n("li", { class: M2.item, key: e14 }, u8);
  }
  _renderAttachmentContainer() {
    var _a2;
    const { effectiveDisplayType: e14, viewModel: t6, visibleElements: s13 } = this, { attachmentInfos: i10, capabilities: a6, fileInfos: n11 } = t6, r5 = !!(i10 == null ? void 0 : i10.length), l9 = !!(n11 == null ? void 0 : n11.length), o4 = { [M2.containerList]: "preview" !== e14, [M2.containerPreview]: "preview" === e14 }, d9 = a6.editing && ((_a2 = a6.operations) == null ? void 0 : _a2.add) && s13.addButton ? n("button", { bind: this, class: this.classes(e5.button, e5.buttonTertiary, M2.addAttachmentButton), onclick: () => this._startAddAttachment(), type: "button" }, n("span", { "aria-hidden": "true", class: this.classes(M2.itemAddIcon, i7.plus) }), this.messages.add) : void 0, c14 = r5 ? n("ul", { class: M2.items, key: "attachments-list" }, i10.toArray().map((t7) => this._renderAttachmentInfo({ attachmentInfo: t7, displayType: e14 }))) : void 0, m8 = l9 ? n("ul", { class: M2.items, key: "file-list" }, n11.toArray().map((e15) => this._renderFile(e15))) : void 0, h7 = l9 || r5 ? void 0 : n("div", { class: e5.empty }, this.messages.noAttachments);
    return n("div", { class: this.classes(M2.container, o4), key: "attachments-container" }, c14, m8, h7, d9);
  }
  _modeChanged() {
  ...
  _handleFileInputChange(e14) {
    var _a2;
    const t6 = e14.target, s13 = (_a2 = t6.files) == null ? void 0 : _a2.item(0);
...
__decorate([m()], k2.prototype, "capabilities", null), __decorate([m()], k2.prototype, "displayType", void 0), __decorate([m({ readOnly: true })], k2.prototype, "effectiveDisplayType", null), __decorate([m()], k2.prototype, "attachmentKeywords", null), __decorate([m()], k2.prototype, "attachmentTypes", null), __decorate([m()], k2.prototype, "graphic", null), __decorate([m()], k2.prototype, "icon", null), __decorate([m()], k2.prototype, "label", null), __decorate([m(), e4("esri/widgets/Attachments/t9n/Attachments")], k2.prototype, "messages", void 0), __decorate([m(), e4("esri/core/t9n/Units")], k2.prototype, "messagesUnits", void 0), __decorate([m({ readOnly: true })], k2.prototype, "selectedFile", void 0), __decorate([m({ readOnly: true })], k2.prototype, "submitting", void 0), __decorate([m({ readOnly: true })], k2.prototype, "error", void 0), __decorate([m({ type: y3 })], k2.prototype, "viewModel", void 0), __decorate([m()], k2.prototype, "visibleElements", void 0), __decorate([s3("visibleElements")], k2.prototype, "castVisibleElements", null), k2 = __decorate([a("esri.widgets.Attachments")], k2);
...
function s9({ level: r5, class: s13, ...l9 }, n11) {
  const a6 = e7(r5);
  return n(`h${a6}`, { ...l9, "aria-level": String(a6), class: v(e5.heading, s13), role: "heading" }, n11);
}
function e7(t6) {
...
var l6 = class extends B {
  ...
  render() {
    return n("div", { class: n5.base }, this._renderTitle(), this._renderDescription());
  }
  _renderTitle() {
    const { title: e14 } = this;
    return e14 ? n(s9, { class: n5.title, innerHTML: e14, level: this.headingLevel }) : null;
  }
  _renderDescription() {
    const { description: e14 } = this;
    return e14 ? n("div", { class: n5.description, innerHTML: e14, key: "description" }) : null;
  }
};
...
var h3 = class extends B {
  ...
  initialize() {
    this._featureElementInfo = new l6(), this.addHandles([l(() => {
      var _a2, _b;
      return [(_a2 = this.viewModel) == null ? void 0 : _a2.description, (_b = this.viewModel) == null ? void 0 : _b.title, this.headingLevel];
    }, () => this._setupFeatureElementInfo(), h), l(() => this.viewModel, (t6) => this.attachmentsWidget.viewModel = t6, h)]);
  }
  destroy() {
    var _a2;
    this.attachmentsWidget.viewModel = null, this.attachmentsWidget.destroy(), (_a2 = this._featureElementInfo) == null ? void 0 : _a2.destroy();
  }
  get description() {
  ...
  render() {
    ...
    return n("div", { class: d4.base }, (_a2 = this._featureElementInfo) == null ? void 0 : _a2.render(), t6 == null ? void 0 : t6.render());
  }
  _setupFeatureElementInfo() {
    var _a2;
    const { description: t6, title: e14, headingLevel: i10 } = this;
    (_a2 = this._featureElementInfo) == null ? void 0 : _a2.set({ description: t6, title: e14, headingLevel: i10 });
  }
};
...
var l7 = class extends B {
  ...
  get creator() {
    var _a2;
    return (_a2 = this.viewModel) == null ? void 0 : _a2.creator;
  }
  set creator(e14) {
  ...
  render() {
    var _a2;
    const e14 = (_a2 = this.viewModel) == null ? void 0 : _a2.state;
    return n("div", { class: c9.base }, "loading" === e14 ? this._renderLoading() : this._renderCreated());
  }
  _renderLoading() {
    return n("div", { class: c9.loaderContainer, key: "loader" }, n("div", { class: c9.loader }));
  }
  _renderCreated() {
    var _a2;
    const e14 = (_a2 = this.viewModel) == null ? void 0 : _a2.created;
    return e14 ? e14 instanceof HTMLElement ? n("div", { afterCreate: this._attachToNode, bind: e14, key: e14 }) : e9(e14) ? n("div", { key: e14 }, !e14.destroyed && e14.render()) : n("div", { afterCreate: this._addTargetToAnchors, innerHTML: e14, key: e14 }) : null;
  }
  _attachToNode(e14) {
    const r5 = this;
    e14.appendChild(r5);
...
function r3(r5, t6) {
  ...
  if (!n11) return t6;
  const i10 = t6.match(n11.pattern), l9 = i10 == null ? void 0 : i10[2], o4 = r(r(n11.label, { messages: r5, hierPart: l9 }), { appName: n11.appName }), m8 = n11.target ? ` target="${n11.target}"` : "", g5 = "_blank" === n11.target ? ' rel="noreferrer"' : "";
...
var c10 = class extends B {
  ...
  initialize() {
    this._featureElementInfo = new l6(), this.addHandles(l(() => {
      var _a2, _b;
      return [(_a2 = this.viewModel) == null ? void 0 : _a2.description, (_b = this.viewModel) == null ? void 0 : _b.title];
    }, () => this._setupFeatureElementInfo(), h));
  }
  destroy() {
    var _a2;
    (_a2 = this._featureElementInfo) == null ? void 0 : _a2.destroy();
  }
  get attributes() {
  ...
  render() {
    var _a2;
    return n("div", { class: m2.base }, (_a2 = this._featureElementInfo) == null ? void 0 : _a2.render(), this._renderFields());
  }
  _renderFieldInfo(e14, t6) {
    var _a2;
    const { attributes: s13 } = this.viewModel, i10 = e14.fieldName || "", r5 = e14.label || i10, o4 = s13 ? null == s13[i10] ? "" : s13[i10] : "", l9 = !("date-time" !== ((_a2 = e14 == null ? void 0 : e14.fieldFormat) == null ? void 0 : _a2.type)), n11 = "number" == typeof o4 && !l9 ? this._forceLTR(o4) : r3(this.messagesURIUtils, o4), d9 = { [m2.fieldDataDate]: l9 };
    return n("tr", { key: `fields-element-info-row-${i10}-${t6}` }, n("th", { class: m2.fieldHeader, innerHTML: r5, key: `fields-element-info-row-header-${i10}-${t6}` }), n("td", { class: this.classes(m2.fieldData, d9), innerHTML: n11, key: `fields-element-info-row-data-${i10}-${t6}` }));
  }
  _renderFields() {
    const { formattedFieldInfos: e14 } = this.viewModel;
    return (e14 == null ? void 0 : e14.length) ? n("table", { class: e5.table, summary: this.messages.fieldsSummary }, n("tbody", null, e14.map((e15, t6) => this._renderFieldInfo(e15, t6)))) : null;
  }
  _setupFeatureElementInfo() {
    var _a2;
    const { description: e14, title: t6 } = this;
    (_a2 = this._featureElementInfo) == null ? void 0 : _a2.set({ description: e14, title: t6 });
  }
  _forceLTR(e14) {
    return `&lrm;${e14}`;
  }
...
function r4(r5) {
  ...
  const e14 = [...r5.colorStops].filter((o4) => {
    var _a2;
    return ((_a2 = o4.color) == null ? void 0 : _a2.a) > 0;
  });
  let t6 = e14.length - 1;
  if (e14 && e14[0]) {
    const r6 = e14[t6];
  ...
  return e14.map((o4, e15) => {
    var _a2, _b;
    let l9 = "";
    return 0 === e15 ? l9 = ((_a2 = r5.legendOptions) == null ? void 0 : _a2.minLabel) || "low" : e15 === t6 && (l9 = ((_b = r5.legendOptions) == null ? void 0 : _b.maxLabel) || "high"), { color: o4.color, label: l9, ratio: o4.ratio };
  }).reverse();
}
...
async function x3(l9) {
  ...
  if ("heatmap" === l9.type) {
    ...
    await w2(t6, "default", [(_a2 = l9 == null ? void 0 : l9.othersCategory) == null ? void 0 : _a2.color, b3(l9.backgroundFillSymbol, null)]);
  } else if ("dot-density" === l9.type) {
    for (const e14 of l9.attributes) await w2(t6, e14.field || e14.valueExpression, [e14.color]);
    await w2(t6, "default", [l9.backgroundColor]);
  } else if ("unique-value" === l9.type) if ("predominance" === ((_b = l9.authoringInfo) == null ? void 0 : _b.type)) for (const e14 of l9.uniqueValueInfos ?? []) await w2(t6, e14.value.toString(), [b3(e14.symbol, null)]);
  else {
...
function I3({ originRelationship: e14, relationships: t6, layerId: r5 }) {
  return t6.find(({ relatedTableId: t7, id: i10 }) => `${t7}` === r5 && i10 === (e14 == null ? void 0 : e14.id)) ?? null;
}
function F2(e14, t6) {
...
function g(e14, t6) {
  if (!t6) return;
  if (!e14) return;
  const { features: r5, statsFeatures: i10 } = e14, o4 = r5 == null ? void 0 : r5.value;
  t6.relatedFeatures = o4 ? o4.features : [];
  const s13 = i10 == null ? void 0 : i10.value;
  t6.relatedStatsFeatures = s13 ? s13.features : [];
}
function S(e14, t6, r5, i10) {
  var _a2;
  const o4 = new u2();
  return o4.outFields = ["*"], o4.relationshipId = "number" == typeof t6.id ? t6.id : parseInt(t6.id, 10), o4.objectIds = [e14.attributes[r5.objectIdField]], o4.gdbVersion = r5.gdbVersion ?? null, o4.historicMoment = r5.historicMoment ?? null, ((_a2 = r5.queryRelatedFeatures) == null ? void 0 : _a2.call(r5, o4, i10)) ?? Promise.resolve({});
}
...
async function $(e14, t6, r5, i10) {
  ...
  if ((b10 == null ? void 0 : b10.relationshipTableId) && b10.keyFieldInRelationshipTable) {
    ...
    if ((y9 == null ? void 0 : y9.length) && u8.supportsStatistics) {
      const e15 = new b2();
...
function q2({ relatedInfo: e14, fieldName: t6, fieldInfo: r5 }) {
  var _a2, _b;
  if ((_a2 = e14.relatedFields) == null ? void 0 : _a2.push(t6), r5.statisticType) {
    const i10 = new p2({ statisticType: r5.statisticType, onStatisticField: t6, outStatisticFieldName: t6 });
    (_b = e14.outStatistics) == null ? void 0 : _b.push(i10);
  }
}
function L3(e14, t6) {
  if (null != e14) {
...
var v5 = class extends b {
  ...
  _formatMediaInfos() {
    ...
    return (t6 == null ? void 0 : t6.map((t7) => {
      const i10 = t7 == null ? void 0 : t7.clone();
      if (!i10) return null;
  ...
  _setChartValue(t6) {
    ...
    if (!p12.some((t7) => !!(null != o4[t7] || he(t7) && (n11 == null ? void 0 : n11.size)))) return;
    const h7 = (l9 == null ? void 0 : l9.fieldInfos) ?? [];
    p12.forEach((t7, a7) => {
      var _a2;
      const l10 = (_a2 = e14.colors) == null ? void 0 : _a2[a7];
  ...
  _getRelatedChartInfos(t6) {
    var _a2;
    const { fieldInfos: e14, fieldName: i10, formattedAttributes: o4, chartType: r5, value: a6, color: s13 } = t6, l9 = [], n11 = h4(i10), p12 = n11 && ((_a2 = this.relatedInfos) == null ? void 0 : _a2.get(n11.layerId.toString()));
    if (!p12) return l9;
    ...
    d9.forEach((t7) => {
      ...
      p13 && Object.keys(p13).forEach((t8) => {
        t8 === n11.fieldName && l9.push(this._getChartOption({ value: a6, attributes: p13, formattedAttributes: o4, fieldName: i10, chartType: r5, relatedFieldName: t8, hasMultipleRelatedFeatures: (d9 == null ? void 0 : d9.length) > 1, fieldInfos: e14, color: s13 }));
      });
    });
...
var T3 = class extends B {
  constructor(e14, t6) {
    super(e14, t6), this._refreshTimer = null, this._refreshIntervalInfo = null, this._featureElementInfo = null, this._chartRootMap = /* @__PURE__ */ new WeakMap(), this.viewModel = new v5(), this.messages = null, this._disposeChart = (e15) => {
      var _a2;
      (_a2 = this._chartRootMap.get(e15)) == null ? void 0 : _a2.dispose(), this._chartRootMap.delete(e15);
    }, this._createChart = async (e15) => {
      const { destroyed: t7, viewModel: i10 } = this;
      if (t7 || !i10 || !e15) return;
      const { createRoot: a6 } = await import("./chartUtilsAm5-2KANGAE7.js"), r5 = await a6(e15);
  ...
  initialize() {
    this._featureElementInfo = new l6(), this.addHandles([l(() => {
      var _a2, _b;
      return [(_a2 = this.viewModel) == null ? void 0 : _a2.activeMediaInfo, (_b = this.viewModel) == null ? void 0 : _b.activeMediaInfoIndex];
  ...
  destroy() {
    var _a2;
    this._clearMediaRefreshTimer(), (_a2 = this._featureElementInfo) == null ? void 0 : _a2.destroy();
  }
  get attributes() {
    return this.viewModel.attributes;
  }
  ...
  render() {
    var _a2;
    return n("div", { bind: this, class: _4.base, onkeyup: this._handleMediaKeyup }, (_a2 = this._featureElementInfo) == null ? void 0 : _a2.render(), this._renderMedia());
  }
  _renderMedia() {
    const { formattedMediaInfoCount: e14, activeMediaInfoIndex: t6 } = this.viewModel, i10 = this._renderMediaText();
    return e14 ? n("div", { class: _4.mediaContainer, key: "media-element-container" }, this._renderMediaInfo(), n("div", { class: _4.mediaNavigation }, i10, e14 > 1 ? n("div", { class: _4.mediaPagination }, this._renderMediaPageButton("previous"), n("span", { class: _4.mediaPaginationText }, s4(this.messages.pageText, { index: t6 + 1, total: e14 })), this._renderMediaPageButton("next")) : null)) : null;
  }
  _renderMediaText() {
    const { activeMediaInfo: e14 } = this.viewModel;
    if (!e14) return null;
    const t6 = e14 && e14.title ? n("div", { class: _4.mediaItemTitle, innerHTML: e14.title, key: "media-title" }) : null, i10 = e14 && e14.caption ? n("div", { class: _4.mediaItemCaption, innerHTML: e14.caption, key: "media-caption" }) : null;
    return t6 || i10 ? n("div", { class: _4.mediaItemText, key: "media-text" }, t6, i10) : null;
  }
  _renderImageMediaInfo(e14) {
    if (!e14.value) return null;
    const { _refreshIntervalInfo: t6 } = this, { activeMediaInfoIndex: i10, formattedMediaInfoCount: a6 } = this.viewModel, { value: r5, refreshInterval: o4, altText: s13, title: n11, type: l9 } = e14, { sourceURL: d9, linkURL: c14 } = r5, h7 = A(c14 ?? void 0) ? "_blank" : "_self", p12 = "_blank" === h7 ? "noreferrer" : "", f9 = o4 ? t6 : null, g5 = f9 ? f9.timestamp : 0, M6 = f9 ? f9.sourceURL : d9, _6 = n("img", { alt: s13 || n11, key: `media-${l9}-${i10}-${a6}-${g5}`, src: M6 ?? void 0 });
    return (c14 ? n("a", { href: c14, rel: p12, target: h7, title: n11 }, _6) : null) ?? _6;
  }
  _renderChartMediaInfo(e14) {
    const { activeMediaInfoIndex: t6, formattedMediaInfoCount: i10 } = this.viewModel;
    return n("div", { afterCreate: this._createChart, afterRemoved: this._disposeChart, bind: this, class: _4.mediaChart, key: `media-${e14.type}-${t6}-${i10}` });
  }
  ...
  _renderMediaInfo() {
    const { activeMediaInfo: e14 } = this.viewModel;
    return e14 ? n("div", { class: _4.mediaItemContainer, key: "media-container" }, n("div", { class: _4.mediaItem, key: "media-item-container" }, this._renderMediaInfoType())) : null;
  }
  _renderMediaPageButton(e14) {
    ...
    return n("button", { "aria-label": i10, bind: this, class: _4.mediaPaginationButton, key: r5, onclick: o4, tabIndex: 0, title: i10, type: "button" }, n("calcite-icon", { class: _4.mediaPaginationIcon, icon: a6, scale: "s" }));
  }
  _setupFeatureElementInfo() {
    var _a2;
    const { description: e14, title: t6 } = this;
  ...
  _getRenderer() {
    ...
    return (e14 == null ? void 0 : e14.isAggregate) && (t6 == null ? void 0 : t6.featureReduction) && "renderer" in t6.featureReduction ? t6.featureReduction.renderer : t6 == null ? void 0 : t6.renderer;
  }
  async _getSeriesColors(e14) {
    const { colorAm5: t6 } = await import("./chartCommon-2YYIIRRA.js"), i10 = /* @__PURE__ */ new Map();
    return e14.forEach((e15) => {
      e15.color && i10.set(e15, t6(e15.color.toCss(true)));
    }), i10;
  }
  async _getRendererColors() {
    const { colorAm5: e14 } = await import("./chartCommon-2YYIIRRA.js"), t6 = /* @__PURE__ */ new Map(), i10 = this._getRenderer(), a6 = "default";
    if (!i10) return t6;
    const r5 = await x3(i10);
    r5.delete(a6);
    return Array.from(r5.values()).every((e15) => 1 === (e15 == null ? void 0 : e15.length)) ? (Array.from(r5.keys()).forEach((i11) => {
      var _a2, _b;
      const a7 = (_b = (_a2 = r5.get(i11)) == null ? void 0 : _a2[0]) == null ? void 0 : _b.toCss(true);
  ...
  async _renderChart(e14) {
    const { root: t6, mediaInfo: i10 } = e14, { value: a6, type: r5 } = i10, { ResponsiveThemeAm5: o4, DarkThemeAm5: s13, AnimatedThemeAm5: n11, ColorSetAm5: l9, ThemeAm5: d9, esriChartColorSet: m8 } = await import("./chartCommon-2YYIIRRA.js"), c14 = d9.new(t6);
  ...
  async _customizeChartTooltip(e14, t6 = "horizontal") {
    var _a2;
    const { colorAm5: i10 } = await import("./chartCommon-2YYIIRRA.js");
    e14.setAll({ pointerOrientation: t6 }), (_a2 = e14.get("background")) == null ? void 0 : _a2.setAll({ stroke: i10(I5) }), e14.label.setAll({ direction: this._getDirection(), oversizedBehavior: "wrap", maxWidth: x4 });
  }
  async _createPieChart(e14, t6) {
    const { TooltipAm5: i10 } = await import("./chartCommon-2YYIIRRA.js"), { PieChartAm5: a6, PieSeriesAm5: r5 } = await import("./pieChart-NSBLG6UP.js"), { mediaInfo: o4, root: s13 } = e14, { title: n11 } = o4, l9 = 5, d9 = (o4 == null ? void 0 : o4.altText) || (o4 == null ? void 0 : o4.title) || "", m8 = s13.container.children.push(a6.new(s13, { ariaLabel: d9, focusable: true, paddingBottom: l9, paddingTop: l9, paddingLeft: l9, paddingRight: l9 })), c14 = "{category}: {valuePercentTotal.formatNumber('0.00')}%\n ({value})", h7 = i10.new(s13, { labelText: c14 }), p12 = m8.series.push(r5.new(s13, { name: n11, valueField: A3, categoryField: w4, tooltip: h7 }));
  ...
  async _createColumnChart(e14, t6, i10) {
    const { TooltipAm5: a6, ScrollbarAm5: r5 } = await import("./chartCommon-2YYIIRRA.js"), { CategoryAxisAm5: o4, AxisRendererXAm5: s13, ValueAxisAm5: n11, AxisRendererYAm5: l9, ColumnSeriesAm5: d9 } = await import("./xyChart-NZF2LRW3.js"), { mediaInfo: m8, root: c14 } = t6, { value: p12, title: u8 } = m8;
  ...
  async _createLineChart(e14, t6, i10) {
    var _a2, _b, _c;
    const { TooltipAm5: a6, ScrollbarAm5: r5 } = await import("./chartCommon-2YYIIRRA.js"), { CategoryAxisAm5: o4, AxisRendererXAm5: s13, ValueAxisAm5: n11, AxisRendererYAm5: l9, LineSeriesAm5: d9 } = await import("./xyChart-NZF2LRW3.js"), { root: m8, mediaInfo: c14 } = t6, { value: p12, title: u8 } = c14;
    e14.setAll({ wheelX: "panX", wheelY: "zoomX" });
    ...
    g5.get("renderer").labels.template.setAll({ direction: this._getDirection() });
    const M6 = "{categoryX}", _6 = (_b = (_a2 = i10[0]) == null ? void 0 : _a2.lineSettings) == null ? void 0 : _b.stroke, I8 = a6.new(m8, { getFillFromSprite: !_6, labelText: M6 });
    _6 && ((_c = I8.get("background")) == null ? void 0 : _c.setAll({ fill: _6 }));
  ...
  async _createXYChart(e14, t6) {
    const { XYChartAm5: i10, XYCursorAm5: a6 } = await import("./xyChart-NZF2LRW3.js"), { root: r5, mediaInfo: o4 } = e14, { type: s13 } = o4, n11 = (o4 == null ? void 0 : o4.altText) || (o4 == null ? void 0 : o4.title) || "", l9 = r5.container.children.push(i10.new(r5, { ariaLabel: n11, focusable: true, panX: true, panY: true }));
...
async function g2({ graphic: e14, view: r5, options: t6 }) {
  ...
  if (!a6 || !i10 || "2d" !== (r5 == null ? void 0 : r5.type)) return [];
...
function v7(e14) {
  var _a2, _b;
  return { scale: e14 == null ? void 0 : e14.scale, timeProperties: { currentStart: (_a2 = e14 == null ? void 0 : e14.timeExtent) == null ? void 0 : _a2.start, currentEnd: (_b = e14 == null ? void 0 : e14.timeExtent) == null ? void 0 : _b.end, startIncluded: true, endIncluded: true } };
}
function x5(e14) {
  return { $voxel: e14 };
}
function b7(e14) {
  var _a2;
  let r5 = null;
  if (((_a2 = e14.origin.layer.fields) == null ? void 0 : _a2.length) > 0) {
    r5 = e14.cloneShallow();
...
async function F3(e14, r5, t6, a6, i10, n11, o4) {
  ...
  return { vars: { $feature: r5, $aggregatedFeatures: s13, $view: v7(t6) }, track: o4 ? await $2(e14, r5, t6) : null, [Symbol.dispose]: () => s13 == null ? void 0 : s13[Symbol.dispose]() };
}
function I6(e14) {
...
async function $2(e14, r5, t6) {
  ...
  const n11 = (_a2 = a6.timeInfo) == null ? void 0 : _a2.trackIdField;
  ...
  const u8 = a6.fieldsIndex.normalizeFieldName(a6.timeInfo.startField) ?? i3, p12 = a6.timeInfo.endField ? a6.fieldsIndex.normalizeFieldName(a6.timeInfo.endField) : null, d9 = l9.map((r6) => {
    ...
    const i10 = e14.ArcadeFeature.createFromGraphic(r6, t6 == null ? void 0 : t6.timeZone), n12 = I6(r6.getAttribute(u8));
...
async function j4(e14, r5, a6, i10, n11, o4) {
  ...
  return { vars: { $feature: r5, $layer: null != s13 && N3(s13) ? s13 : "scene" === (s13 == null ? void 0 : s13.type) && null != s13.associatedLayer ? s13.associatedLayer : void 0, $map: a6, $datastore: s13 && "url" in s13 ? s13.url : void 0, $userInput: i10, $graph: "knowledge-graph-sublayer" === (s13 == null ? void 0 : s13.type) ? (_a2 = s13.parentCompositeLayer) == null ? void 0 : _a2.knowledgeGraph : void 0, $view: v7(n11) }, track: o4 ? await $2(e14, r5, n11) : null };
}
...
async function k3() {
  const [e14, r5, { Feature: t6 }] = await Promise.all([import("./arcade-LILJ56CS.js"), import("./arcade-K2YVTOTZ.js"), import("./Feature-PAEL2DJW.js")]);
...
async function E2(t6, a6, i10) {
  ...
  return { dependencies: p12, async evaluate({ graphic: a7, interceptor: n12, location: o5, map: s14, options: l10, spatialReference: p13, view: m8 }) {
    ...
    try {
      const r5 = __addDisposableResource(g5, await T4(c14, { arcade: i10, graphic: a7, map: s14, location: o5, view: m8, options: l10, interceptor: n12, arcadeExecutor: u8, usesTrack: d9 }), false), w6 = { abortSignal: (l10 == null ? void 0 : l10.signal) ?? void 0, interceptor: n12 ?? void 0, rawOutput: true, spatialReference: p13 ?? void 0, timeZone: m8 == null ? void 0 : m8.timeZone, track: r5.track, console(...e14) {
        f5().info(...e14);
      } };
      try {
        return await u8.executeAsync(r5.vars, w6);
      } catch (y9) {
        if ((_a2 = l10 == null ? void 0 : l10.signal) == null ? void 0 : _a2.aborted) return;
...
async function L4(e14, r5) {
  ...
  for (const n11 of e14) {
    ...
    i10.set(`expression/${n11.name}`, e15), e15 == null ? void 0 : e15.dependencies.forEach((e16) => a6.add(e16));
  }
...
var k4 = class extends b {
  constructor(t6) {
    super(t6), this._compileTask = null, this._evaluateTask = null, this.expressionInfo = null, this.graphic = null, this.contentElementViewModel = null, this.interceptor = null, this.location = null, this.view = null, this._createVM = () => {
      var _a2, _b;
      const t7 = (_a2 = this.contentElement) == null ? void 0 : _a2.type;
      ...
      const t7 = this._compileTask.value, e14 = t7 == null ? void 0 : t7.dependencies;
      return [t7, this.spatialReference, this.map, this.view, (e14 == null ? void 0 : e14.has("view-scale")) ? (_b = this.view) == null ? void 0 : _b.scale : null, (e14 == null ? void 0 : e14.has("view-time-extent")) ? (_d = (_c = this.view) == null ? void 0 : _c.timeExtent) == null ? void 0 : _d.start : null, (e14 == null ? void 0 : e14.has("view-time-extent")) ? (_f = (_e = this.view) == null ? void 0 : _e.timeExtent) == null ? void 0 : _f.end : null];
  ...
  get state() {
    ...
    return this._compileThrottled.hasPendingUpdates() || this._evaluateThrottled.hasPendingUpdates() || !((_a2 = this._compileTask) == null ? void 0 : _a2.finished) || !((_b = this._evaluateTask) == null ? void 0 : _b.finished) ? "loading" : t6 || e14 ? "ready" : "disabled";
  }
  get map() {
    var _a2;
  ...
  _startCompile() {
    this._evaluateTask = e(this._evaluateTask), this._compileTask = e(this._compileTask), this._compileTask = d2(async (t6) => {
      const { expressionInfo: e14, graphic: o4 } = this, i10 = e14 == null ? void 0 : e14.expression;
  ...
  _startEvaluate(t6) {
    this._evaluateTask = e(this._evaluateTask), this._evaluateTask = d2(async (e14) => {
      ...
      s2(e14);
      const h7 = m8 == null ? void 0 : m8.type, v9 = "media" === h7 ? I2.fromJSON(m8) : "text" === h7 ? i5.fromJSON(m8) : "fields" === h7 ? l4.fromJSON(m8) : null;
...
var g3 = class extends B {
  ...
  loadDependencies() {
    return c4({ loader: () => import("./calcite-loader-7C57RZVQ.js") });
  }
  destroy() {
  ...
  render() {
    ...
    return n("div", { class: u6.base }, "loading" === e14 ? this._renderLoading() : "disabled" === e14 ? null : (_a2 = this._contentWidget) == null ? void 0 : _a2.render());
  }
  _renderLoading() {
    return n("div", { class: u6.loadingSpinnerContainer, key: "loading-container" }, n("calcite-loader", { inline: true, label: "" }));
  }
  ...
  _setupExpressionWidget() {
    const { contentElementViewModel: e14, contentElement: t6 } = this.viewModel, o4 = t6 == null ? void 0 : t6.type;
    this._destroyContentWidget();
...
var R4 = (e14) => {
  ...
  if (e14.formTemplate) {
    ...
    (_a2 = e14.fields) == null ? void 0 : _a2.forEach((e15) => {
...
var _5 = class extends l2(s5(b)) {
  constructor(e14) {
    super(e14), this._loaded = false, this._queryAbortController = null, this._queryPageAbortController = null, this._queryFeatureCountAbortController = null, this.featuresPerPage = 10, this.activeCategory = null, this.allCategories = null, this.description = null, this.graphic = null, this.layer = null, this.map = null, this.orderByFields = null, this.featureCount = 0, this.relationshipId = null, this.showAllEnabled = false, this.title = null, this._cancelQuery = () => {
      ...
      this.featureCount && ("subtype-group" !== ((_a2 = this.relatedLayer) == null ? void 0 : _a2.type) || this.activeCategory) && (this._destroyRelatedFeatureViewModels(), this.featurePage = 1, t6.destroyAll(), this.destroyed || t6.addMany(this._sliceFeatures(await this._queryRelatedFeatures({ signal: e15 == null ? void 0 : e15.signal }))));
    }, this.addHandles([l(() => {
      var _a2;
  ...
  get orderByFieldsFixedCasing() {
    ...
    return e14 && (t6 == null ? void 0 : t6.loaded) ? e14.map((e15) => {
      const r5 = e15.clone();
  ...
  get canQuery() {
    var _a2, _b;
    const e14 = (_b = (_a2 = this.layer) == null ? void 0 : _a2.capabilities) == null ? void 0 : _b.queryRelated;
  ...
  get relatedLayer() {
    ...
    if (!(e14 == null ? void 0 : e14.loaded) || !t6 || !r5) return null;
  ...
  get relatedLayerKeyField() {
    ...
    return (e14 == null ? void 0 : e14.loaded) && null != t6 ? (_b = (_a2 = e14.relationships) == null ? void 0 : _a2.find((e15) => e15.id === t6)) == null ? void 0 : _b.keyField : null;
  }
  get relatedLayerKeyFields() {
    var _a2;
    const { relatedLayer: e14 } = this;
    return (e14 == null ? void 0 : e14.loaded) ? ((_a2 = e14.relationships) == null ? void 0 : _a2.map((e15) => e15.keyField).filter(N)) ?? [] : [];
  }
  get relationship() {
    var _a2;
    const { relationshipId: e14, layer: t6 } = this;
    return null != e14 && (t6 == null ? void 0 : t6.loaded) ? ((_a2 = t6.relationships) == null ? void 0 : _a2.find(({ id: t7 }) => t7 === e14)) ?? null : null;
  }
  get relationshipKey() {
    var _a2, _b;
    const { relationshipKeyField: e14 } = this;
    return (e14 && ((_b = (_a2 = this.graphic) == null ? void 0 : _a2.attributes) == null ? void 0 : _b[e14])) ?? null;
  }
  ...
  async _queryFeatureCount() {
    ...
    await (e14 == null ? void 0 : e14.load()), await (t6 == null ? void 0 : t6.load());
    ...
    if ("subtype-group" === (t6 == null ? void 0 : t6.type) && !l9) {
      if (this._set("featureCount", 0), this._destroyRelatedFeatureViewModels(), this.featurePage = 1, this.relatedFeatures.destroyAll(), s13 && null != u8) {
        const { default: e15 } = await import("./uniqueValues-KSNRK7DC.js"), { uniqueValueInfos: l10 } = await e15({ layer: t6, sqlWhere: `${s13} = '${u8}'`, field: t6.subtypeField, signal: r5 == null ? void 0 : r5.signal }), a7 = l10.map(({ count: e16, value: r6 }) => {
          var _a2, _b;
          const o4 = (_b = (_a2 = t6.subtypes) == null ? void 0 : _a2.find((e17) => e17.code === r6)) == null ? void 0 : _b.name;
    ...
    const { historicMoment: y9, gdbVersion: h7 } = e14, c14 = new u2({ cacheHint: d9, gdbVersion: h7, historicMoment: y9, relationshipId: n11, returnGeometry: false, objectIds: [i10], where: this._getRelationshipWhereClause(t6) }), g5 = await e14.queryRelatedFeaturesCount(c14, { signal: r5 == null ? void 0 : r5.signal });
  ...
  async _queryPage() {
    ...
    !r5 || t6 < 2 || !l9 || "subtype-group" === ((_a2 = this.relatedLayer) == null ? void 0 : _a2.type) && !this.activeCategory || e14.addMany(await this._queryRelatedFeatures({ signal: o4 == null ? void 0 : o4.signal }));
  }
...
var M5 = b8 = class extends B {
  ...
  loadDependencies() {
    return c4({ chip: () => import("./calcite-chip-A4XOUIE3.js"), icon: () => import("./calcite-icon-ZV6LJS7F.js"), list: () => import("./calcite-list-UUK3UE72.js"), "list-item": () => import("./calcite-list-item-Q6UKVERC.js"), loader: () => import("./calcite-loader-7C57RZVQ.js"), notice: () => import("./calcite-notice-BCNMWRSO.js") });
  }
  destroy() {
  ...
  get allItemsDescription() {
    ...
    return s4(e14 == null ? void 0 : e14.numberRecords, { number: c3(s13 ? i10 : t6) });
  }
  get description() {
    return this.viewModel.description;
  }
  ...
  get title() {
    ...
    return (e14 == null ? void 0 : e14.name) ?? t6;
  }
  set title(e14) {
    this.viewModel.title = e14;
  }
  ...
  render() {
    var _a2;
    const { state: e14 } = this.viewModel;
    return n("div", { class: this.classes(F7.base, e5.widget) }, (_a2 = this._featureElementInfo) == null ? void 0 : _a2.render(), "loading" === e14 ? this._renderLoading() : "disabled" === e14 ? this._renderRelationshipNotFound() : this._renderRelatedFeatures());
  }
  _selectCategory(e14) {
  ...
  async _selectRecord(e14) {
    ...
    const { default: i10 } = await import("./Feature-S4MOZOEF.js");
  ...
  _renderCategory(e14) {
    ...
    return n("calcite-list-item", { class: F7.listItem, disabled: !t6, key: i10, label: s13, onCalciteListItemSelect: () => this._selectCategory(e14) }, n("calcite-chip", { label: r5, scale: "s", slot: "content-end" }, r5), this._renderChevronIconNode());
  }
  _renderRelatedFeature(e14) {
    var _a2;
    const { itemDescriptionFieldName: t6 } = this.viewModel, s13 = e14.title;
    e14.description = t6 && ((_a2 = e14.formattedAttributes) == null ? void 0 : _a2.global[t6]);
    const i10 = "loading" === e14.state;
    return n("calcite-list-item", { class: this.classes(F7.listItem, { [F7.listItemHidden]: i10 }), description: c2(e14.description ?? ""), key: e14.uid, label: c2(s13), onCalciteListItemSelect: () => this._selectRecord(e14) }, this._renderChevronIconNode());
  }
  _renderShowAllListItem() {
    var _a2;
    return this.displayShowAllButton ? n("calcite-list-item", { description: this.allItemsDescription, key: "show-all-item", label: (_a2 = this.messages) == null ? void 0 : _a2.showAll, onCalciteListItemSelect: () => this._showAllRecords() }, this._renderShowAllIconNode()) : null;
  }
  _renderNoRelatedFeaturesMessage() {
    var _a2;
    return n("calcite-notice", { icon: "information", key: "no-related-features-message", kind: "brand", open: true, scale: "s", width: "full" }, n("div", { slot: "message" }, (_a2 = this.messages) == null ? void 0 : _a2.noRelatedFeatures));
  }
  ...
  _renderList() {
    ...
    return n("calcite-list", { displayMode: "flat", label: (_a2 = this.messages) == null ? void 0 : _a2.relatedFeaturesList }, (t6 == null ? void 0 : t6.map((e15) => this._renderCategory(e15))) ?? e14.toArray().map((e15) => this._renderRelatedFeature(e15)), this._renderShowAllListItem());
  }
  _renderRelatedFeatures() {
    const { displayListItems: e14 } = this, { state: t6 } = this.viewModel;
    return n("div", { class: this.classes(F7.listContainer, { [F7.listContainerQuerying]: "querying" === t6 }), key: "list-container" }, e14 ? this._renderList() : "ready" === t6 ? this._renderNoRelatedFeaturesMessage() : null, this._renderStickyLoading(), this._renderFeatureObserver());
  }
  _renderRelationshipNotFound() {
    var _a2;
    return n("calcite-notice", { icon: "exclamation-mark-triangle", key: "relationship-not-found", kind: "danger", open: true, scale: "s", width: "full" }, n("div", { slot: "message" }, (_a2 = this.messages) == null ? void 0 : _a2.relationshipNotFound));
  }
  _setupRelatedFeatureViewModels() {
    const { relatedFeatureViewModels: e14 } = this.viewModel, t6 = "related-feature-viewmodels";
    this.removeHandles(t6), e14 == null ? void 0 : e14.forEach((e15) => {
  ...
  _setupFeatureElementInfo() {
    ...
    (_a2 = this._featureElementInfo) == null ? void 0 : _a2.set({ description: s13, title: i10, headingLevel: e14 });
  }
...
__decorate([m()], M5.prototype, "_relatedFeatureIntersectionObserverNode", void 0), __decorate([m({ readOnly: true })], M5.prototype, "displayShowAllButton", null), __decorate([m({ readOnly: true })], M5.prototype, "displayListItems", null), __decorate([m({ readOnly: true })], M5.prototype, "allItemsDescription", null), __decorate([m()], M5.prototype, "description", null), __decorate([m()], M5.prototype, "featureVisibleElements", void 0), __decorate([m()], M5.prototype, "flowItems", void 0), __decorate([m()], M5.prototype, "flowType", void 0), __decorate([m()], M5.prototype, "headingLevel", void 0), __decorate([m()], M5.prototype, "title", null), __decorate([m({ type: _5 })], M5.prototype, "viewModel", void 0), __decorate([m(), e4("esri/widgets/Feature/t9n/Feature")], M5.prototype, "messages", void 0), __decorate([m(), e4("esri/t9n/common")], M5.prototype, "messagesCommon", void 0), __decorate([m()], M5.prototype, "visibleElements", void 0), __decorate([s3("visibleElements")], M5.prototype, "castVisibleElements", null), M5 = b8 = __decorate([a("esri.widgets.Feature.FeatureRelationship")], M5);
...
var v8 = class extends B {
  ...
  loadDependencies() {
    return c4({ icon: () => import("./calcite-icon-ZV6LJS7F.js"), list: () => import("./calcite-list-UUK3UE72.js"), "list-item": () => import("./calcite-list-item-Q6UKVERC.js"), loader: () => import("./calcite-loader-7C57RZVQ.js"), notice: () => import("./calcite-notice-BCNMWRSO.js") });
  }
  destroy() {
  ...
  render() {
    var _a2;
    const { state: e14 } = this.viewModel;
    return n("div", { class: this.classes(f8.base, e5.widget) }, (_a2 = this._featureElementInfo) == null ? void 0 : _a2.render(), "loading" === e14 ? this._renderLoading() : "disabled" === e14 ? this._renderAssociationNotFound() : this._renderContent());
  }
  _renderStickyLoading() {
    return "querying" === this.viewModel.state ? n("div", { class: f8.loadingContainerSticky, key: "sticky-loader" }, this._renderLoadingIcon()) : null;
  }
  _renderLoadingIcon() {
    return n("calcite-loader", { inline: true, label: this.messagesCommon.loading });
  }
  _renderLoading() {
    return n("div", { class: f8.loadingContainer, key: "loading-container" }, this._renderLoadingIcon());
  }
  _renderAssociationNotFound() {
    var _a2;
    return n("calcite-notice", { icon: "information", key: "association-not-found", kind: "info", open: true, scale: "s", width: "full" }, n("div", { slot: "message" }, (_a2 = this.messages) == null ? void 0 : _a2.noAssociations));
  }
  _renderAssociationType(e14) {
    const { viewModel: t6 } = this, i10 = this._getAssociationTypeTitle(e14);
    return n("calcite-list-item", { description: c2(e14.description), key: `association-type-${e14.type}`, label: c2(i10), value: e14.type, onCalciteListItemSelect: () => this.onSelectAssociationType({ viewModel: t6, listType: e14, title: i10 }) }, n("calcite-icon", { flipRtl: true, icon: "chevron-right", scale: "s", slot: "content-end" }));
  }
  ...
  _renderContent() {
    ...
    return n("div", { class: f8.listContainer, key: "list-container" }, "ready" === i10 ? n("div", null, n("calcite-list", { displayMode: "flat", label: e14 == null ? void 0 : e14.associationsList }, o4.map((e15) => this._renderAssociations(e15)))) : null, this._renderStickyLoading());
  }
  ...
  _setupFeatureElementInfo() {
    ...
    (_a2 = this._featureElementInfo) == null ? void 0 : _a2.set({ description: i10, title: o4, headingLevel: e14 });
  }
};
...
var ne = (_a = class extends s5(b) {
  constructor(e14) {
    super(e14), this._error = null, this._graphicChangedTask = null, this._evaluateExpressionAttributesTask = null, this._associationVMAbortController = null, this._expressionAttributes = null, this._graphicExpressionAttributes = null, this.abilities = { ...ae }, this.content = null, this.contentViewModels = [], this.description = null, this.defaultPopupTemplateEnabled = false, this.formattedAttributes = null, this.graphic = null, this.lastEditInfo = null, this.location = null, this.relatedInfos = /* @__PURE__ */ new Map(), this.title = "", this.view = null, this._graphicChangedThrottled = l5(this._graphicChanged, () => this.notifyChange("waitingForContent"), ie, this), this._isAllowedContentType = (e15) => {
      ...
      const e15 = this._graphicChangedTask.value, t6 = (_b = e15 == null ? void 0 : e15.expressionInfos) == null ? void 0 : _b.dependencies;
      return [e15, (t6 == null ? void 0 : t6.has("view-scale")) ? (_c = this.view) == null ? void 0 : _c.scale : null, (t6 == null ? void 0 : t6.has("view-time-extent")) ? (_e = (_d = this.view) == null ? void 0 : _d.timeExtent) == null ? void 0 : _e.start : null, (t6 == null ? void 0 : t6.has("view-time-extent")) ? (_g = (_f = this.view) == null ? void 0 : _f.timeExtent) == null ? void 0 : _g.end : null];
  ...
  get timeZone() {
    var _a2;
    return ((_a2 = this.view) == null ? void 0 : _a2.timeZone) ?? e3;
  }
  set timeZone(e14) {
  ...
  async updateGeometry() {
    ...
    await (i10 == null ? void 0 : i10.load());
    const s13 = i10 == null ? void 0 : i10.objectIdField;
    if (!s13 || !e14 || !i10) return;
    const o4 = (_a2 = e14 == null ? void 0 : e14.attributes) == null ? void 0 : _a2[s13];
    if (null == o4) return;
    const r5 = [o4];
    if (!e14.geometry) {
      const s14 = await me({ layer: i10, graphic: e14, outFields: [], objectIds: r5, returnGeometry: true, spatialReference: t6 }), o5 = s14 == null ? void 0 : s14.geometry;
      o5 && (e14.geometry = o5);
    }
  }
  _clear() {
  ...
  _graphicChanged() {
    this._evaluateExpressionAttributesTask = e(this._evaluateExpressionAttributesTask), this._graphicChangedTask = e(this._graphicChangedTask), this._graphicChangedTask = d2(async (e14) => {
      ...
      try {
        ...
        const [{ value: r5 }, { value: a6 }] = await j([this._getContent(), this._getTitle()]), [, { value: n11 }] = await j([this._checkForRelatedFeatures({ signal: e14 }), L4(s13 == null ? void 0 : s13.expressionInfos, t6)]);
  ...
  _matchesFeature(e14, t6) {
    var _a2;
    const i10 = (_a2 = e14 == null ? void 0 : e14.graphic) == null ? void 0 : _a2.getObjectId(), s13 = t6 == null ? void 0 : t6.getObjectId();
  ...
  _setRelatedFeaturesViewModels({ relatedFeatureViewModels: e14, relatedFeatures: t6, map: i10 }) {
    ...
    t6 == null ? void 0 : t6.filter(Boolean).forEach((t7) => {
      ...
      const s14 = t6 == null ? void 0 : t6.find((e15) => this._matchesFeature(i11, e15));
      s14 || e14.remove(i11);
    });
  }
  _setExpressionContentVM(e14, t6) {
    const i10 = this.formattedAttributes, { contentElement: s13, contentElementViewModel: o4 } = e14, r5 = s13 == null ? void 0 : s13.type;
  ...
  _setUpUtilityNetworkAssociationsViewModels(e14, t6, i10) {
    ...
    e14.forEach((i11, s14) => {
      ...
      t7 == null ? void 0 : t7.filter(Boolean).forEach((e15, t8) => {
  ...
  _compileTitleAndDesc({ title: e14, description: t6 }) {
    const { _fieldInfoMap: i10, _sourceLayer: s13, graphic: o4, formattedAttributes: r5 } = this, a6 = o4 == null ? void 0 : o4.attributes, n11 = this._expressionAttributes, l9 = r5.global;
  ...
  _createFieldsVMParams(e14, t6) {
    const i10 = this._effectivePopupTemplate, s13 = this.formattedAttributes, o4 = { ...s13 == null ? void 0 : s13.global, ...s13 == null ? void 0 : s13.content[t6] }, r5 = !!(e14 == null ? void 0 : e14.fieldInfos), a6 = (e14 == null ? void 0 : e14.fieldInfos) || (i10 == null ? void 0 : i10.fieldInfos), n11 = a6 == null ? void 0 : a6.filter(({ fieldName: e15 }) => !!e15 && (U(e15) || he(e15) || o4.hasOwnProperty(e15))), l9 = i10 == null ? void 0 : i10.expressionInfos, { description: p12, title: c14 } = e14;
  ...
  _createMediaVMParams(e14, t6) {
    const { abilities: i10, graphic: s13, _fieldInfoMap: o4, _effectivePopupTemplate: r5, relatedInfos: a6, _sourceLayer: n11, _expressionAttributes: l9 } = this, p12 = this.formattedAttributes, c14 = (s13 == null ? void 0 : s13.attributes) ?? {}, { description: d9, mediaInfos: h7, title: u8 } = e14;
    return { abilities: { chartAnimation: i10.chartAnimation }, activeMediaInfoIndex: e14.activeMediaInfoIndex || 0, attributes: c14, graphic: s13, layer: n11, fieldInfoMap: o4, formattedAttributes: { ...p12 == null ? void 0 : p12.global, ...p12 == null ? void 0 : p12.content[t6] }, expressionAttributes: l9, mediaInfos: h7, popupTemplate: r5, relatedInfos: a6, ...this._compileTitleAndDesc({ title: u8, description: d9 }) };
  }
  ...
  _createTextVMParams(e14) {
    ...
    if (e14 && e14.text) {
      const r5 = (t6 == null ? void 0 : t6.attributes) ?? {}, a6 = ((_a2 = this.formattedAttributes) == null ? void 0 : _a2.global) ?? {};
  ...
  _compileLastEditInfo() {
    ...
    if (!e14) return;
    const { lastEditInfoEnabled: o4 } = e14, r5 = t6 == null ? void 0 : t6.editFieldsInfo;
    return o4 && r5 ? ue(r5, i10 == null ? void 0 : i10.attributes, s13, t6) : void 0;
  }
  _compileTitle(e14) {
    var _a2;
    const { _fieldInfoMap: t6, _sourceLayer: i10, graphic: s13, _expressionAttributes: o4 } = this, r5 = (s13 == null ? void 0 : s13.attributes) ?? {}, a6 = ((_a2 = this.formattedAttributes) == null ? void 0 : _a2.global) ?? {};
  ...
  async _getTitle() {
    ...
    return t6 ? q({ type: "title", value: e14 == null ? void 0 : e14.title, event: { graphic: t6 } }) : null;
  }
  async _getContent() {
    const { _effectivePopupTemplate: e14, graphic: t6 } = this;
    return t6 ? q({ type: "content", value: e14 == null ? void 0 : e14.content, event: { graphic: t6 } }) : null;
  }
  _evaluateExpressionAttributes({ title: e14, content: t6, expressionInfos: i10 }) {
    this._evaluateExpressionAttributesTask = e(this._evaluateExpressionAttributesTask), this._evaluateExpressionAttributesTask = d2(async (s13) => {
  ...
  _createMediaFormattedAttributes({ contentElement: e14, contentElementIndex: t6, formattedAttributes: i10 }) {
    ...
    i10.content[t6] = ye({ attributes: { ...l9, ...e14.attributes }, fieldInfoMap: n11, fieldInfos: s13 == null ? void 0 : s13.fieldInfos, graphic: o4, layer: a6, relatedInfos: r5, timeZone: p12 });
  }
  ...
  _createFormattedAttributes(e14) {
    const { _effectivePopupTemplate: t6, graphic: i10, relatedInfos: s13, _sourceLayer: o4, _fieldInfoMap: r5, _graphicExpressionAttributes: a6, timeZone: n11 } = this, l9 = t6 == null ? void 0 : t6.fieldInfos, p12 = { global: ye({ attributes: a6, fieldInfoMap: r5, fieldInfos: l9, graphic: i10, layer: o4, relatedInfos: s13, timeZone: n11 }), content: [] };
  ...
  async _queryRelatedInfos(e14, t6, i10) {
    ...
    s13.clear();
    const r5 = null != (o4 == null ? void 0 : o4.associatedLayer) ? await (o4 == null ? void 0 : o4.associatedLayer.load(i10)) : o4;
    if (!r5 || !e14) return;
    const a6 = t6.filter((e15) => !!e15.fieldName && he(e15.fieldName));
    if (!(a6 == null ? void 0 : a6.length)) return;
    ...
    Object.keys(n11).forEach((e15) => {
      var _a2;
      const t7 = s13.get(e15.toString()), i11 = (_a2 = n11[e15]) == null ? void 0 : _a2.value;
      t7 && i11 && (t7.layerInfo = i11.data);
    });
    const l9 = await T2({ graphic: e14, relatedInfos: s13, layer: r5 }, i10);
    Object.keys(l9).forEach((e15) => {
      var _a2;
      g((_a2 = l9[e15]) == null ? void 0 : _a2.value, s13.get(e15.toString()));
    });
  }
...
__decorate([m()], ne.prototype, "_error", void 0), __decorate([m()], ne.prototype, "_graphicChangedTask", void 0), __decorate([m()], ne.prototype, "_evaluateExpressionAttributesTask", void 0), __decorate([m()], ne.prototype, "_associationVMAbortController", void 0), __decorate([m({ readOnly: true })], ne.prototype, "_effectivePopupTemplate", null), __decorate([m({ readOnly: true })], ne.prototype, "_fieldInfoMap", null), __decorate([m({ readOnly: true })], ne.prototype, "_sourceLayer", null), __decorate([m()], ne.prototype, "abilities", void 0), __decorate([s3("abilities")], ne.prototype, "castAbilities", null), __decorate([m({ readOnly: true })], ne.prototype, "content", void 0), __decorate([m({ readOnly: true })], ne.prototype, "contentViewModels", void 0), __decorate([m()], ne.prototype, "description", void 0), __decorate([m({ type: Boolean })], ne.prototype, "defaultPopupTemplateEnabled", void 0), __decorate([m({ readOnly: true })], ne.prototype, "isFeatureFromTable", null), __decorate([m({ readOnly: true })], ne.prototype, "state", null), __decorate([m({ readOnly: true })], ne.prototype, "formattedAttributes", void 0), __decorate([m({ type: _3 })], ne.prototype, "graphic", void 0), __decorate([m({ readOnly: true })], ne.prototype, "lastEditInfo", void 0), __decorate([m({ type: _2 })], ne.prototype, "location", void 0), __decorate([m({ readOnly: true })], ne.prototype, "relatedInfos", void 0), __decorate([m({ type: f2 })], ne.prototype, "spatialReference", null), __decorate([m()], ne.prototype, "timeZone", null), __decorate([m({ readOnly: true })], ne.prototype, "title", void 0), __decorate([m()], ne.prototype, "map", null), __decorate([m({ readOnly: true })], ne.prototype, "waitingForContent", null), __decorate([m()], ne.prototype, "view", void 0), ne = te = __decorate([a("esri.widgets.Feature.FeatureViewModel")], ne);
...
var n10 = (n11) => {
  ...
  let d9 = class extends i10 {
    constructor() {
      super(...arguments), this.renderNodeContent = (o4) => e9(o4) && !o4.destroyed ? n("div", { class: t5.contentNode, key: o4 }, o4.render()) : o4 instanceof HTMLElement ? n("div", { afterCreate: this._attachToNode, bind: o4, class: t5.contentNode, key: o4 }) : o3(o4) ? n("div", { afterCreate: this._attachToNode, bind: o4.domNode, class: t5.contentNode, key: o4 }) : null;
    }
    _attachToNode(o4) {
      const t6 = this;
      o4.appendChild(t6);
...
var F8 = class extends n10(B) {
  ...
  loadDependencies() {
    return c4({ notice: () => import("./calcite-notice-BCNMWRSO.js"), loader: () => import("./calcite-loader-7C57RZVQ.js") });
  }
  destroy() {
  ...
  render() {
    const { state: e14 } = this.viewModel, t6 = n("div", { class: t5.container, key: "container" }, this._renderTitle(), "error" === e14 ? this._renderError() : "loading" === e14 ? this._renderLoading() : this._renderContentContainer());
    return n("div", { class: this.classes(t5.base, e5.widget) }, t6);
  }
  _renderError() {
    const { messagesCommon: e14, messages: t6, visibleElements: s13 } = this;
    return n("calcite-notice", { icon: "exclamation-mark-circle", kind: "danger", open: true, scale: "s" }, s13.title ? n("div", { key: "error-title", slot: "title" }, e14.errorMessage) : null, n("div", { key: "error-message", slot: "message" }, t6.loadingError));
  }
  _renderLoading() {
    return n("div", { class: t5.loadingSpinnerContainer, key: "loading-container" }, n("calcite-loader", { inline: true, label: "" }));
  }
  _renderContentContainer() {
    const { visibleElements: e14 } = this;
    return e14.content ? n("div", { class: t5.main }, [this._renderContent(), this._renderLastEditInfo()]) : null;
  }
  _renderTitle() {
    const { visibleElements: e14, title: t6 } = this;
    return e14.title ? n(s9, { class: t5.title, innerHTML: t6, level: this.headingLevel }) : null;
  }
  _renderContent() {
    const e14 = this.viewModel.content, t6 = "content";
    if (!e14) return null;
    if (Array.isArray(e14)) return e14.length ? n("div", { class: t5.contentNode, key: `${t6}-content-elements` }, e14.map(this._renderContentElement, this)) : null;
    if ("string" == typeof e14) {
      const e15 = this._contentWidgets[0];
      return !e15 || e15.destroyed ? null : n("div", { class: this.classes(t5.contentNode, t5.contentNodeText), key: `${t6}-content` }, e15.render());
    }
  ...
  _renderContentElement(e14, t6) {
    ...
    if ("boolean" != typeof s13.content && !((_a2 = s13.content) == null ? void 0 : _a2[e14.type])) return null;
    switch (e14.type) {
      case "attachments":
  ...
  _renderAttachments(e14) {
    ...
    return "loading" === s13 || i10.length > 0 ? n("div", { class: this.classes(t5.contentElement), key: this._buildKey("attachments-element", e14) }, t6.render()) : null;
  }
  _renderRelationship(e14) {
    const t6 = this._contentWidgets[e14];
    return t6 && !t6.destroyed && this.flowItems ? n("div", { class: t5.contentElement, key: this._buildKey("relationship-element", e14) }, t6.render()) : null;
  }
  _renderAssociation(e14) {
    const t6 = this._contentWidgets[e14];
    return t6 && !t6.destroyed && this.flowItems ? n("div", { class: t5.contentElement, key: this._buildKey("utility-network-association-element", e14) }, t6.render()) : null;
  }
  _renderExpression(e14) {
    const t6 = this._contentWidgets[e14];
    return t6 && !t6.destroyed && t6.viewModel.contentElement ? n("div", { class: t5.contentElement, key: this._buildKey("expression-element", e14) }, t6.render()) : null;
  }
  _renderCustom(e14, t6) {
    const { creator: s13 } = e14, i10 = this._contentWidgets[t6];
    return !i10 || i10.destroyed ? null : s13 ? n("div", { class: t5.contentElement, key: this._buildKey("custom-element", t6) }, i10.render()) : null;
  }
  _renderFields(e14) {
    const t6 = this._contentWidgets[e14];
    return !t6 || t6.destroyed ? null : n("div", { class: t5.contentElement, key: this._buildKey("fields-element", e14) }, t6.render());
  }
  _renderMedia(e14) {
    const t6 = this._contentWidgets[e14];
    return !t6 || t6.destroyed ? null : n("div", { class: t5.contentElement, key: this._buildKey("media-element", e14) }, t6.render());
  }
  _renderLastEditInfo() {
    const { visibleElements: e14, messages: t6 } = this, { lastEditInfo: s13 } = this.viewModel;
    if (!s13 || !e14.lastEditedInfo) return null;
    const { date: i10, user: n11 } = s13, o4 = "edit" === s13.type ? n11 ? t6.lastEditedByUser : t6.lastEdited : n11 ? t6.lastCreatedByUser : t6.lastCreated, r5 = s4(o4, { date: i10, user: n11 });
    return n("div", { class: this.classes(t5.lastEditedInfo, t5.contentElement), key: "edit-info-element" }, r5);
  }
  _renderText(e14, t6) {
    const s13 = e14.text, i10 = this._contentWidgets[t6];
    return !i10 || i10.destroyed ? null : s13 ? n("div", { class: this.classes(t5.contentElement, t5.text), key: this._buildKey("text-element", t6) }, i10.render()) : null;
  }
  _buildKey(e14, ...t6) {
    var _a2, _b;
    return `${e14}__${((_b = (_a2 = this.viewModel) == null ? void 0 : _a2.graphic) == null ? void 0 : _b.uid) || "0"}-${t6.join("-")}`;
  }
  ...
  _setupContentWidgets() {
    this._destroyContentWidgets();
    const { headingLevel: e14, visibleElements: t6, flowItems: s13, viewModel: i10 } = this, n11 = i10 == null ? void 0 : i10.content, { contentViewModels: o4 } = i10;
    if (Array.isArray(n11)) n11.forEach((n12, r5) => {
      ...
      if ("utility-network-associations" === n12.type) {
        const e15 = async (e16) => {
          ...
          const { default: l9 } = await import("./FeatureUtilityNetworkAssociationList-EIODAUBJ.js"), d9 = new l9({ viewModel: n14, parentFeatureViewModel: i10, listType: o5, title: r6, featureVisibleElements: t6, description: i10.title, flowItems: s13 });
          s13.push(d9);
...
__decorate([m()], F8.prototype, "flowType", void 0), __decorate([m()], F8.prototype, "graphic", null), __decorate([m()], F8.prototype, "defaultPopupTemplateEnabled", null), __decorate([m()], F8.prototype, "flowItems", void 0), __decorate([m()], F8.prototype, "headingLevel", void 0), __decorate([m({ readOnly: true })], F8.prototype, "isTable", null), __decorate([m()], F8.prototype, "icon", null), __decorate([m()], F8.prototype, "label", null), __decorate([m()], F8.prototype, "location", null), __decorate([m(), e4("esri/widgets/Feature/t9n/Feature")], F8.prototype, "messages", void 0), __decorate([m(), e4("esri/t9n/common")], F8.prototype, "messagesCommon", void 0), __decorate([m()], F8.prototype, "spatialReference", null), __decorate([m()], F8.prototype, "timeZone", null), __decorate([m({ readOnly: true })], F8.prototype, "title", null), __decorate([m()], F8.prototype, "visibleElements", void 0), __decorate([s3("visibleElements")], F8.prototype, "castVisibleElements", null), __decorate([m()], F8.prototype, "map", null), __decorate([m()], F8.prototype, "view", null), __decorate([m({ type: ne })], F8.prototype, "viewModel", void 0), F8 = __decorate([a("esri.widgets.Feature")], F8);
...
//# sourceMappingURL=chunk-2N24PXOG.js.map
