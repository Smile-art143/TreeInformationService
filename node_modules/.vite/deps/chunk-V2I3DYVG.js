...
var d = 5e4;
var n = { minX: 0, minY: 0, maxX: 0, maxY: 0 };
function t(i) {
...
var o = class {
  ...
  get fullBounds() {
    ...
    const i = K();
    for (const s2 of this._boundsById.values()) s2 && (i[0] = Math.min(s2[0], i[0]), i[1] = Math.min(s2[1], i[1]), i[2] = Math.max(s2[2], i[2]), i[3] = Math.max(s2[3], i[3]));
    return i;
  }
  get valid() {
...
//# sourceMappingURL=chunk-V2I3DYVG.js.map
