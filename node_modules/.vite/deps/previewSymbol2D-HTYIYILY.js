...
function E2(t2) {
  const e = t2 == null ? void 0 : t2.size;
...
async function U2(t2, e) {
  ...
  if ("pattern" === (o == null ? void 0 : o.type) && i && t2.type !== y3) {
...
async function F(t2, e, o, n2) {
  ...
  if (!/[\uE600-\uE6FF]/.test(e.shape.text)) {
    const { width: i, height: s3, x: r, y: h2 } = $(e.shape.text, { weight: (_a = e.font) == null ? void 0 : _a.weight, size: (_b = e.font) == null ? void 0 : _b.size, family: (_c = e.font) == null ? void 0 : _c.family });
    o[0] = a ?? i, o[1] = l2 ?? s3, e.shape.x = r, e.shape.y = h2;
    let c2 = "angle" in t2 ? t2.angle : null;
    if (null != (n2 == null ? void 0 : n2.rotation) && (c2 = (c2 ?? 0) + n2.rotation), c2) {
...
function A(t2, e, o, i, a) {
  ...
  null == t2.backgroundColor && null == t2.borderLineColor || (i[0] += 2 * s2, i[1] += 2 * s2, o.unshift([{ shape: { type: "rect", x: 0, y: 0, width: i[0], height: i[1] }, fill: t2.backgroundColor, stroke: { color: t2.borderLineColor, width: u(t2.borderLineSize) } }]), (_a = a.masking) == null ? void 0 : _a.unshift([]));
}
function Z(t2, e) {
...
function D(t2, e) {
  var _a, _b, _c, _d, _e;
  const o = "number" == typeof (e == null ? void 0 : e.size) ? e == null ? void 0 : e.size : null, i = null != o ? u(o) : null, a = null != (e == null ? void 0 : e.maxSize) ? u(e.maxSize) : null;
  let l2 = "angle" in t2 ? t2.angle : null;
  null != (e == null ? void 0 : e.rotation) && (l2 = (l2 ?? 0) + e.rotation);
  const s3 = u3(t2);
  let r = y(t2);
  "dark" !== T(t2, 245) || (e == null ? void 0 : e.ignoreWhiteSymbols) || (r = { width: 0.75, ...r, color: "#bdc3c7" });
  let u4 = null;
  const d = { shape: null, fill: s3, stroke: r, offset: [0, 0] };
  (r == null ? void 0 : r.width) && (r.width = Math.min(r.width, S));
  const f2 = (r == null ? void 0 : r.width) || 0;
  let g2 = null != (e == null ? void 0 : e.size) && (null == (e == null ? void 0 : e.scale) || (e == null ? void 0 : e.scale)), j2 = 0, B2 = 0, U3 = false;
  switch (t2.type) {
    case b: {
      const o2 = t2.style, { width: s4, height: r2 } = E2(e);
      let h2 = s4 === r2 && null != s4 ? s4 : null != i ? i : Math.min(u(t2.size), a || L);
      if (true === (e == null ? void 0 : e.useMarkerSymbolSize) && null !== s4 && null !== r2) {
    ...
    case v: {
      ...
      if (g2 = true, "polyline" === ((_a = e == null ? void 0 : e.geometry) == null ? void 0 : _a.type) && ((_b = e == null ? void 0 : e.geometry) == null ? void 0 : _b.extent)) {
        j2 = s4, B2 = o2 ?? j2;
        const t4 = 1e3, i2 = 0.15 * t4;
        u4 = [j2, B2], B2 = u4[0] > u4[1] ? t4 * u4[1] / u4[0] : t4, j2 = u4[0] > u4[1] ? t4 : t4 * u4[0] / u4[1], (r == null ? void 0 : r.width) && (r.width = r.width * t4 / (u4[1] > u4[0] ? u4[1] : u4[0]), r.width > i2 && (r.width = i2)), d.shape = { type: "path", path: P(e.geometry, j2, B2) };
      } else j2 = null != (e == null ? void 0 : e.maxSize) ? Math.min(s4, e.maxSize) : s4, B2 = l3, r && (r.width = l3), d.shape = { type: "path", path: [{ command: "M", values: [l3 / 2, B2 / 2] }, { command: "L", values: [j2 - l3 / 2, B2 / 2] }] };
      break;
    }
    case y3:
    case x: {
      const t3 = "object" == typeof (e == null ? void 0 : e.symbolConfig) && !!((_c = e == null ? void 0 : e.symbolConfig) == null ? void 0 : _c.isSquareFill), { width: o2, height: n2 } = E2(e);
      j2 = !t3 && o2 !== n2 || null == o2 ? null != i ? i : z : o2, B2 = !t3 && o2 !== n2 || null == n2 ? j2 : n2, g2 || (j2 += f2, B2 += f2), g2 = true, ((_d = e == null ? void 0 : e.geometry) == null ? void 0 : _d.extent) && "polygon" === ((_e = e == null ? void 0 : e.geometry) == null ? void 0 : _e.type) ? (u4 = [j2, B2], B2 = u4[0] > u4[1] ? 1e3 * u4[1] / u4[0] : 1e3, j2 = u4[0] > u4[1] ? 1e3 : 1e3 * u4[0] / u4[1], d.shape = { type: "path", path: P(e.geometry, j2, B2) }) : d.shape = t3 ? { type: "path", path: [{ command: "M", values: [0, 0] }, { command: "L", values: [j2, 0] }, { command: "L", values: [j2, B2] }, { command: "L", values: [0, B2] }, { command: "L", values: [0, 0] }, { command: "Z", values: [] }] } : t.fill[0];
      break;
    }
    case w: {
    ...
    case M: {
      const o2 = t2, l3 = (e == null ? void 0 : e.overrideText) || o2.text || k2, s4 = o2.font, { width: r2, height: h2 } = E2(e), c2 = null != h2 ? h2 : null != i ? i : Math.min(u(s4.size), a || L), { width: m, height: u5 } = $(l3, { weight: s4.weight, size: c2, family: s4.family }), p = /[\uE600-\uE6FF]/.test(l3);
  ...
  return { shapeDescriptor: d, size: [j2, B2], outputSize: u4, renderOptions: { node: e == null ? void 0 : e.node, scale: g2, opacity: e == null ? void 0 : e.opacity, rotations: [l2], useRotationSize: U3, cssEffectFilter: e == null ? void 0 : e.cssEffectFilter, ariaLabel: e == null ? void 0 : e.ariaLabel, clipBloomEffect: e == null ? void 0 : e.clipBloomEffect } };
}
async function q(t2, e) {
  ...
  const s3 = [[i]];
  if ("object" == typeof (e == null ? void 0 : e.symbolConfig) && ((_a = e == null ? void 0 : e.symbolConfig) == null ? void 0 : _a.applyColorModulation)) {
    const t3 = 0.6 * n2[0];
...
function T(o, i = j) {
  const n2 = u3(o), a = y(o), l2 = !n2 || "type" in n2 ? null : new u2(n2), s3 = (a == null ? void 0 : a.color) ? new u2(a == null ? void 0 : a.color) : null, r = l2 ? Z(E(l2), i) : null, m = s3 ? Z(E(s3), i) : null;
...
//# sourceMappingURL=previewSymbol2D-HTYIYILY.js.map
