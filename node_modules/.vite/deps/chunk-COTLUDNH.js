...
async function u() {
  if (!s2()) {
    const [e, t] = await Promise.all([import("./OperatorGeodesicBuffer-DMVB4ASB.js"), import("./SpatialReference-XPFQIWMJ.js").then(({ injectPe: e2 }) => e2), n()]);
...
//# sourceMappingURL=chunk-COTLUDNH.js.map
