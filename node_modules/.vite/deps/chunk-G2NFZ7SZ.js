...
var O3 = class extends s2(b) {
  ...
  initialize() {
    this._initAttributeStore(), this._metadata = n5.createGraphics(this.view.spatialReference), this._resourceProxy = new s4({ fetch: (e5) => Promise.all(e5.map((e6) => this.view.stage.textureManager.rasterizeItem(e6))), fetchDictionary: (e5) => {
      ...
      var _a;
      this.addHandles([this.graphics.on("change", () => this._pushUpdate())]), (_a = this._graphicStore) == null ? void 0 : _a.destroy(), this._graphicStore = new y8(this.view.spatialReference, this._cimResourceManager, this.view.featuresTilingScheme, this.view.state.scale, this._attributeStore), this._attached = true, this.requestUpdate(), this._pushUpdate();
  ...
  setHighlight(e4) {
    ...
    for (const { objectId: s5, highlightFlags: r2 } of e4) {
      const e5 = (_a = this._graphicStore.getItem(s5)) == null ? void 0 : _a.displayId;
  ...
  _cleanupSharedResources() {
    ...
    for (const r2 of this._graphicStore.items()) {
      const e5 = (_a = r2.symbolResource) == null ? void 0 : _a.symbolInfo.hash;
      t4.add(e5);
    }
...
//# sourceMappingURL=chunk-G2NFZ7SZ.js.map
