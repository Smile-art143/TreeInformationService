...
function A(t3, o4, e6, i4, s2) {
  ...
  if (!U(t3.field)) {
    if (((_a = t3.stops) == null ? void 0 : _a[0]) && n3(t3.stops[0].size)) return o4.minSize[e6] = t3.stops[0].size, o4.maxSize[e6] = t3.stops[0].size, o4.offset[e6] = o4.minSize[e6], o4.factor[e6] = 0, o4.type[e6] = 1, true;
...
function H(t3, o4, e6) {
  ...
  return !(t3.length > 0 && i4) || i4.size || i4.color || i4.opacity || i4.rotation ? (i4 == null ? void 0 : i4.size) && !O(i4.size, o4, e6) ? null : i4 : null;
}
var J = class {
...
function W(t3, o4, e6) {
  ...
  if (t3 && t3.field !== (o4 == null ? void 0 : o4.field)) return false;
  if (t3 && "rotation" === e6) {
    const e7 = t3, i4 = o4;
...
var X = class extends c3 {
  constructor(t3) {
    super(), this.vvSize = (t3 == null ? void 0 : t3.size) ?? null, this.vvColor = (t3 == null ? void 0 : t3.color) ?? null, this.vvOpacity = (t3 == null ? void 0 : t3.opacity) ?? null;
  }
  get hasVVSize() {
    return !!this.vvSize;
  }
...
//# sourceMappingURL=chunk-TUMR3ERX.js.map
