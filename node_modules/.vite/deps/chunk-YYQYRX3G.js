...
function a2(r2, e2, t2 = null) {
  ...
  const a3 = f(l);
  if (null != t2 && (a3 == null ? void 0 : a3.type) !== t2) throw new n(null, "InvalidParameter", null);
  return a3;
}
...
var I2 = class _I {
  ...
  _fixFieldTypes() {
    ...
    for (let i4 = 0; i4 < ((t2 == null ? void 0 : t2.length) ?? 0); i4++) {
  ...
  castAsJson(e2) {
    var _a;
    const t2 = { attributes: {}, geometry: true === (e2 == null ? void 0 : e2.keepGeometryType) ? this.geometry() : ((_a = this.geometry()) == null ? void 0 : _a.toJSON()) ?? null };
...
//# sourceMappingURL=chunk-YYQYRX3G.js.map
