...
var l2 = class _l {
  ...
  static fromDefinition(e4, a4) {
    ...
    return a4 = a4 ? { ...m2, ...a4 } : m2, o(n2(e4), a4).then((t) => t.data).catch((t) => {
      var _a2;
      if (422 === ((_a2 = t == null ? void 0 : t.details) == null ? void 0 : _a2.httpStatus)) return { location: { top: r3, left: s3, width: h2, height: c }, valid: true, data: new Array(h2 * c).fill(0) };
      throw t;
    }).then((t) => {
...
function s2(t) {
  if (!(t == null ? void 0 : t.location)) throw new s("tilemap:missing-location", "Location missing from tilemap response");
...
var j = (_a = class extends b {
  ...
  async _fetchAvailabilityUpsamplePrefetch(e4, t, i2, r3, l3) {
    ...
    }), c || (c = true, this.removeHandles(o)), a2(a4)) return;
  ...
  _fetchTilemap(e4, t, i2, s3) {
    ...
    const a4 = s3 == null ? void 0 : s3.signal;
  ...
  _initializeTilemapDefinition() {
    ...
    this._tilemapCache.clear(), this._tmpTilemapDefinition = { service: { url: e4.path, query: A({ ...e4.query, ...i2, token: t ?? ((_a2 = e4.query) == null ? void 0 : _a2.token) }), tileServers: this.layer.tileServers, request: this.request }, width: this.size, height: this.size, level: 0, row: 0, col: 0 };
  }
