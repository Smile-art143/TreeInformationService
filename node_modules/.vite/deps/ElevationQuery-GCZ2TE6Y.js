...
var l2 = class extends s2 {
  ...
  populateElevationTiles(e3) {
    var _a;
    for (const t3 of this.geometry.coordinates) !t3.elevationTile && ((_a = t3.tile) == null ? void 0 : _a.id) && (t3.elevationTile = e3[t3.tile.id]);
  }
  remapTiles(e3) {
    var _a;
    for (const t3 of this.geometry.coordinates) {
      const i4 = (_a = t3.tile) == null ? void 0 : _a.id;
      t3.tile = i4 ? e3[i4] : null;
    }
  }
  getTilesToFetch() {
    return c(this.geometry.coordinates.filter(({ tile: e3, elevationTile: t3 }) => (e3 == null ? void 0 : e3.id) && !t3), (e3, t3) => {
      var _a, _b;
      return ((_a = e3.tile) == null ? void 0 : _a.id) === ((_b = t3.tile) == null ? void 0 : _b.id);
    }).map(({ tile: e3 }) => e3);
  }
...
var n2 = class extends s2 {
  ...
  forEachTileToFetch(e3, t3) {
    ...
    this._candidateTiles = [], i4.forEach((i5) => {
      if (this._fetchedCandidates.has(i5)) return void (t3 == null ? void 0 : t3(i5));
      let s3 = false;
      e3(i5, () => s3 = true), s3 ? t3 == null ? void 0 : t3(i5) : this._candidateTiles.push(i5);
  ...
  _tileIsMasked(e3) {
    var _a;
    return ((_a = this.maskExtents) == null ? void 0 : _a.some((i4) => z(i4, e3.extent))) ?? false;
  }
};
function o2(e3) {
  return null != (e3 == null ? void 0 : e3.tileInfo);
}
function a2(e3, t3) {
  const i4 = e3.lods;
  if (o2(t3)) {
...
var p3 = class extends i3 {
  ...
  constructor(t3) {
    ...
    if (n3) {
      ...
      this.extent = c2(i2(), (e4 == null ? void 0 : e4.spatialReference) ?? f2.WGS84), this.demResolution = { min: 0, max: 0 };
    }
  }
  elevationAt(t3, o3) {
    let n3;
...
async function h(e3, n3, a4) {
  if (e3 = (a4 == null ? void 0 : a4.ignoreInvisibleLayers) ? e3.filter((e4) => e4.visible) : e3.slice(), !e3.length) throw new s(G, "Elevation queries require at least one elevation layer to fetch tiles from");
  const o3 = r.fromGeometry(n3), i4 = { ...A, ...a4, returnSampleInfo: true }, l4 = e3.pop(), r3 = await v(l4, o3, i4), s3 = await x(e3, r3, i4);
  return s3.geometry = s3.geometry.export(), (a4 == null ? void 0 : a4.returnSampleInfo) || delete s3.sampleInfo, s3;
}
...
async function g(e3, n3, a4) {
  if (e3 = Array.isArray(e3) ? e3 : [e3], 0 === (e3 = (a4 == null ? void 0 : a4.ignoreInvisibleLayers) ? e3.filter((e4) => e4.visible) : e3.slice()).length) throw new s(G, "Elevation queries require at least one elevation layer to fetch tiles from");
...
async function L(e3, t3) {
  const n3 = e3.getTilesToFetch(), o3 = {}, i4 = e3.parameters.cache, l4 = e3.parameters.noDataValue, r3 = { noDataValue: l4, signal: t3 }, s3 = n3.map(async (t4) => {
    ...
    const n4 = `${e3.layer.uid}:${t4.id}:${l4}`, a4 = i4 == null ? void 0 : i4.get(n4), s4 = a4 ?? await e3.layer.fetchTile(t4.level, t4.row, t4.col, r3);
    i4 == null ? void 0 : i4.put(n4, s4), o3[t4.id] = new t2(t4, s4);
  });
...
//# sourceMappingURL=ElevationQuery-GCZ2TE6Y.js.map
