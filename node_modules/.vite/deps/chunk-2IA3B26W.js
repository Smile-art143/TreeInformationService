...
function t(t2) {
  ...
  if (!l3 || !n) return "";
  const e2 = "displayField" in n ? n.displayField : null, i = null != e2 ? l3[e2] : null, r2 = null != i ? i.toString() : null, u = (_a = t2.getObjectId()) == null ? void 0 : _a.toString();
  return r2 || u || "";
}
...
var v = class extends l2(s2(b)) {
  ...
  get canQuery() {
    var _a, _b;
    const t2 = (_b = (_a = this.layer) == null ? void 0 : _a.capabilities) == null ? void 0 : _b.query;
    return !!this.associationTypes && "string" == typeof this.globalId && !!(t2 == null ? void 0 : t2.supportsPagination);
  }
  set displayCount(t2) {
    const e2 = 0, o3 = 3;
  ...
  get globalIdField() {
    const { layer: t2 } = this;
    return t2 == null ? void 0 : t2.globalIdField;
  }
  ...
  get utilityNetwork() {
    ...
    if (!(t2 == null ? void 0 : t2.loaded) || !e2) return null;
  ...
  async _loadUtiltyNetworks() {
    ...
    const t2 = this.map;
    if (!t2) return;
    await Promise.allSettled(((_a = t2.utilityNetworks) == null ? void 0 : _a.map(async (t3) => {
      await t3.load();
    })) ?? []);
  ...
  async _findLayersBySourceId(t2) {
    const { utilityNetwork: e2, map: o3 } = this, r2 = (t3) => {
      ...
      if (o4.layerId === s5) {
        return t3.url.replace(/\/\d+$/, "") === (e2 == null ? void 0 : e2.featureServiceUrl);
      }
      return false;
    };
    await (e2 == null ? void 0 : e2.load());
  ...
  async _createAssociationFeatureObjects(t2, e2, o3, r2, s5, i) {
    ...
    return await Promise.all(t2.toArray().map(async (t3) => {
      ...
      await Promise.all(i2.map(async (e4) => {
        var _a, _b;
        const o4 = (_b = (_a = this.utilityNetwork) == null ? void 0 : _a.getTerminalById(s6 == null ? void 0 : s6.terminalId)) == null ? void 0 : _b.name, r4 = e4.sourceLayer && "getFeatureTitle" in e4.sourceLayer && await e4.sourceLayer.getFeatureTitle(e4) || t(e4);
  ...
  _parseFeatureObjects(t2, e2) {
    ...
    t2.forEach((t3) => {
      const e3 = t3 == null ? void 0 : t3.feature, r2 = e3.sourceLayer;
  ...
  async _queryAssociations(t2) {
    ...
    if (await Promise.allSettled([e2 == null ? void 0 : e2.load(), s5 == null ? void 0 : s5.load()]), this._clearAssociations(), !(i && e2 && r2 && s5 && o3)) return;
    ...
    const l3 = await (s5 == null ? void 0 : s5.queryAssociations({ elements: [n], types: Array.from(c) }, { signal: t2 == null ? void 0 : t2.signal })), u = /* @__PURE__ */ new Map(), y2 = /* @__PURE__ */ new Map();
    r2.forEach((t3) => {
      ...
      switch (t3.associationType) {
        ...
        case "junction-edge-to-connectivity":
          if ((r3 == null ? void 0 : r3.globalId) === o3) {
            if (this._shouldDiscardNetworkElement(e3, "connectivity", y2)) break;
            (_a = u.get("connectivity")) == null ? void 0 : _a.push(e3.globalId);
          } else {
            if (this._shouldDiscardNetworkElement(r3, "connectivity", y2)) break;
            (_b = u.get("connectivity")) == null ? void 0 : _b.push(r3.globalId);
          }
        ...
        case "containment":
          if ((r3 == null ? void 0 : r3.globalId) === o3) {
            ...
            (_c = u.get("content")) == null ? void 0 : _c.push(e3.globalId), this.contentAssociations.add(t3);
          } else {
            if (this._shouldDiscardNetworkElement(r3, "container", y2)) break;
            (_d = u.get("container")) == null ? void 0 : _d.push(r3.globalId), this.containerAssociations.add(t3);
          }
          break;
        case "attachment":
          if ((r3 == null ? void 0 : r3.globalId) === o3) {
            if (this._shouldDiscardNetworkElement(e3, "attachment", y2)) break;
            (_e = u.get("attachment")) == null ? void 0 : _e.push(e3.globalId), this.attachmentsAssociations.add(t3);
          } else {
            if (this._shouldDiscardNetworkElement(r3, "structure", y2)) break;
            (_f = u.get("structure")) == null ? void 0 : _f.push(r3.globalId), this.structureAssociations.add(t3);
          }
      }
    });
  ...
  async _countAssociatedFeatureCount(t2, e2, o3, r2, s5) {
    ...
    return t2.queryFeatureCount({ where: i, outFields: ["*"], returnGeometry: false }, { signal: s5 == null ? void 0 : s5.signal });
  }
  ...
  async _queryAssociatedFeatures(t2, e2) {
    ...
    if (await Promise.allSettled([o3 == null ? void 0 : o3.load(), i == null ? void 0 : i.load()]), !(a2 && o3 && s5 && i)) return;
  ...
  async _query(t2) {
    ...
    this._destroyAssociatedFeatureViewModels(), this._clearFeatures(), 0 !== this.featureCount && (this.destroyed || await this._queryAssociatedFeatures(t2, { signal: e2 == null ? void 0 : e2.signal }));
  }
  _shouldDiscardNetworkElement(t2, e2, o3) {
    var _a;
    if (!t2) return false;
    const { networkSourceIdsInUse: r2 } = this, { networkSourceId: s5 } = t2, i = (_a = o3.get(e2)) == null ? void 0 : _a.associatedNetworkSourceId, a2 = r2.has(s5);
  ...
  _getFeatureQueryWhereClause(t2, e2, o3, r2) {
    ...
    return [s5 ? o(s5, e2) : null, n ? `(${i == null ? void 0 : i.name} = ${o3})` : null, n && c ? `(${a2 == null ? void 0 : a2.name} = ${r2})` : null].filter(Boolean).join(" AND ");
  }
};
...
//# sourceMappingURL=chunk-2IA3B26W.js.map
