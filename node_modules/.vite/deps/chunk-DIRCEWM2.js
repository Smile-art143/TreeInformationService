...
async function r(r2, t2, s2) {
  var _a, _b;
  const u = (_a = s) == null ? void 0 : _a.findCredential(r2.restUrl);
  if (!u) return null;
  if ("loaded" === r2.loadStatus && "" === t2 && ((_b = r2.user) == null ? void 0 : _b.sourceJSON) && false === s2) return r2.user.sourceJSON;
...
function B2(B3) {
  "async" === B3.mode && (B3.functions.disjoint = function(n2, t2) {
    ...
    return B3.standardFunctionAsync(n2, t2, async (r2, o3, s2) => {
      ...
      if (!(c2 instanceof c)) throw new n(n2, "InvalidParameter", t2);
      if (true === c2.hasZ) {
        const { convertFromSpatialReferenceUnit: n3, toLengthUnit: t3 } = await import("./unitConversion-H662TI4W.js"), e = x(c2);
    ...
    return B3.standardFunctionAsync(n2, t2, async (r2, o3, s2) => {
      ...
      if (null === u) {
        const n3 = "point" === c2.type ? c2 : (_a = c2.extent) == null ? void 0 : _a.center;
        return f(await a("rotate", [c2.toJSON(), l2, n3 == null ? void 0 : n3.x, n3 == null ? void 0 : n3.y]));
      }
    ...
    return B3.standardFunctionAsync(r2, a2, async (o3, s2, c2) => {
      ...
      if (u = true === u || false === u ? "" : ge(u), 0 === c2.length || c2[0] instanceof t) {
        let n2;
        n2 = ((_a = r2.services) == null ? void 0 : _a.portal) ? r2.services.portal : M.getDefault(), c2.length > 0 && (n2 = l(c2[0], n2));
      ...
      if (B(c2[0]) && (w = c2[0]), w) {
        ...
        let a3;
        a3 = ((_b = r2.services) == null ? void 0 : _b.portal) ? r2.services.portal : M.getDefault(), a3 = l(new t(e), a3);
...
//# sourceMappingURL=chunk-DIRCEWM2.js.map
