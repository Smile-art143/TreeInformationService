...
import "./chunk-R4QBNSXX.js";
import "./chunk-TY53BONF.js";
import "./chunk-FYAJ6THT.js";
import "./chunk-ZRSU3QHB.js";
...
import "./chunk-YYMK4UHI.js";
import "./chunk-V2I3DYVG.js";
import "./chunk-G65QEP6R.js";
import "./chunk-5HO2SWP4.js";
...
var K = class extends b(p(t2(l2(b3)))) {
  ...
  _initializeLayerProperties(e3) {
    ...
    ((_a = e3.inclusionModeDefinition) == null ? void 0 : _a.generateAllSublayers) ? (a2 = e3.knowledgeGraph.dataModel.entityTypes ?? [], o4 = e3.knowledgeGraph.dataModel.relationshipTypes ?? []) : ((_b = e3.inclusionModeDefinition) == null ? void 0 : _b.namedTypeDefinitions) && ((_c = e3.inclusionModeDefinition) == null ? void 0 : _c.namedTypeDefinitions.size) > 0 ? (_d = e3.inclusionModeDefinition) == null ? void 0 : _d.namedTypeDefinitions.forEach((i2, s4) => {
      var _a2, _b2;
      const r2 = this._graphTypeLookup.get(s4);
      if (!r2) return i.getLogger(this).warn(`A named type, ${s4}, was in the inclusion list that wasn't in the data model and will be removed`), void ((_a2 = e3.inclusionModeDefinition) == null ? void 0 : _a2.namedTypeDefinitions.delete(s4));
      "relationship" === r2.type ? t4.has(s4) || (t4.add(s4), o4.push(r2)) : "entity" === r2.type ? t4.has(s4) || (t4.add(s4), a2.push(r2)) : (i.getLogger(this).warn(`A named type, ${s4}, was in the inclusion list that wasn't properly modeled and will be removed`), (_b2 = e3.inclusionModeDefinition) == null ? void 0 : _b2.namedTypeDefinitions.delete(s4));
  ...
  load(e3) {
    const a2 = async () => {
      var _a;
      const e4 = [], t4 = [];
      this.loadLayerAssumingLocalCache(), this._layersLoadedFromAuthoritativeItem() || await L2(this), this.dataManager.inclusionModeDefinition && (this.dataManager.inclusionModeDefinition.generateAllSublayers = false), (_a = this.dataManager.inclusionModeDefinition) == null ? void 0 : _a.namedTypeDefinitions.forEach((e5) => {
        e5.useAllData = false;
    ...
    return this.addResolvingPromise(new Promise((i2) => {
      ue(this.url).then(async (n) => {
        ...
        if (6 === (s3 == null ? void 0 : s3.originIdOf("entitiesUrl")) && (this.membershipModified = false, this._originalInclusionList = await I.fetchAndConvertSerializedLinkChart({ entitiesUrl: s3 == null ? void 0 : s3.entitiesUrl, relationshipsUrl: s3 == null ? void 0 : s3.relationshipsUrl }), this._alignLayersDataModelAndInclusionDefinition(n.dataModel), this.initializationLinkChartConfig = { layoutSettings: (s3 == null ? void 0 : s3.layoutSettings) ?? void 0, layoutMode: C(s3.layoutType) }), this._initializeLayerProperties({ knowledgeGraph: n, inclusionModeDefinition: this._originalInclusionList }), ((_e = (_d = this.dataManager.inclusionModeDefinition) == null ? void 0 : _d.namedTypeDefinitions) == null ? void 0 : _e.size) || (this.dataManager.inclusionModeDefinition = { generateAllSublayers: false, namedTypeDefinitions: /* @__PURE__ */ new Map() }, (_f = this.dataManager.knowledgeGraph.dataModel.entityTypes) == null ? void 0 : _f.forEach((e4) => {
          ...
          for (const [t4, a3] of ((_h = this.dataManager.inclusionModeDefinition) == null ? void 0 : _h.namedTypeDefinitions) ?? []) for (const i3 of ((_i = a3.members) == null ? void 0 : _i.values()) ?? []) {
  ...
  async addRecords(e3, t4) {
    let a2 = [];
    (t4 == null ? void 0 : t4.cascadeAddRelationshipEndNodes) && this.dataManager.knowledgeGraph.dataModel && (a2 = await g(e3, this.dataManager.knowledgeGraph));
    const i2 = e3.concat(a2).filter((e4) => {
      var _a;
  ...
  async createSublayerForNamedType(e3) {
    ...
    return "entity" === t4.type ? this.dataManager.entityTypeNames.add(e3) : this.dataManager.relationshipTypeNames.add(e3), (_b = (_a = this.dataManager.inclusionModeDefinition) == null ? void 0 : _a.namedTypeDefinitions) == null ? void 0 : _b.set(e3, { useAllData: false, members: /* @__PURE__ */ new Map() }), a2.geometryType ? this.layers.push(a2) : this.tables.push(a2), await L2(this, [e3]), this._refreshNamedTypes(), a2;
  }
  async removeRecords(e3, { cascadeRemoveRelationships: t4 = true, recalculateLayout: a2 = false, overrideMembershipCheck: i2 = false } = { cascadeRemoveRelationships: true, recalculateLayout: false, overrideMembershipCheck: false }) {
    ...
    let n = [];
    for (const r2 of e3) (i2 || false === ((_c = (_b = (_a = this.dataManager.inclusionModeDefinition) == null ? void 0 : _a.namedTypeDefinitions) == null ? void 0 : _b.get(r2.typeName)) == null ? void 0 : _c.useAllData) && ((_g = (_f = (_e = (_d = this.dataManager.inclusionModeDefinition) == null ? void 0 : _d.namedTypeDefinitions) == null ? void 0 : _e.get(r2.typeName)) == null ? void 0 : _f.members) == null ? void 0 : _g.has(r2.id))) && n.push(r2);
    if (t4) {
    ...
    for (const r2 of n) (_h = this.sublayerIdsCache.get(r2.typeName)) == null ? void 0 : _h.delete(r2.id), this.dataManager.relationshipTypeNames.has(r2.typeName) ? this.relationshipLinkChartDiagramLookup.delete(r2.id) : this.entityLinkChartDiagramLookup.delete(r2.id);
  ...
  async expand(e3, t4) {
    let a2 = [];
    try {
      const i2 = await this.dataManager.getConnectedRecordIds(e3, t4 == null ? void 0 : t4.relationshipTypeNames, t4);
      a2 = i2.filter((e4) => {
        var _a;
        return !((_a = this.sublayerIdsCache.get(e4.typeName)) == null ? void 0 : _a.has(e4.id));
      }), await this._handleNewRecords(a2, t4), i2.length > 0 && (this.membershipModified = true), s2(t4 == null ? void 0 : t4.signal);
    } catch (i2) {
  ...
  async calculateLinkChartLayout(e3 = "organic-standard", t4) {
    ...
    a2.forEach(({ typeName: a3, feature: i2 }) => {
      ...
      if ("chronological-mono-timeline" !== e3 && "chronological-multi-timeline" !== e3 && ((_a2 = t4 == null ? void 0 : t4.lockedNodeLocations) == null ? void 0 : _a2.has(i2.attributes[_2]))) {
        ...
        y3[K2] = 2;
        let e4 = null;
        const t5 = i2.attributes[this.dataManager.geographicLookup.get(a3).name], n = (_b2 = this.dataManager.geographicLookup.get(a3)) == null ? void 0 : _b2.geometryType;
        switch (n) {
          case "esriGeometryPoint":
            L3[K2] = t5 == null ? void 0 : t5.x, D[K2] = t5 == null ? void 0 : t5.y;
            break;
          case "esriGeometryPolygon": {
            const a4 = o(t5);
            e4 = a4 ? _.fromJSON(a4) : null, null != (e4 == null ? void 0 : e4.x) && null != (e4 == null ? void 0 : e4.y) ? (L3[K2] = e4.x, D[K2] = e4.y) : y3[K2] = 1;
            break;
          }
          case "esriGeometryPolyline":
          case "esriGeometryMultipoint":
            e4 = (_c2 = t5 == null ? void 0 : t5.extent) == null ? void 0 : _c2.center, null != (e4 == null ? void 0 : e4.x) && null != (e4 == null ? void 0 : e4.y) ? (L3[K2] = e4.x, D[K2] = e4.y) : y3[K2] = 1;
            break;
          default:
            y3[K2] = 1;
        }
        ...
        !q && ((_d2 = t4 == null ? void 0 : t4.lockedNodeLocations) == null ? void 0 : _d2.has(i2.attributes[_2])) && (q = true);
        const e4 = (_e2 = t4 == null ? void 0 : t4.timeInfoByTypeName) == null ? void 0 : _e2.get(a3), n = e4 == null ? void 0 : e4.startField, o4 = n && (e4 == null ? void 0 : e4.startField) ? i2.attributes[n] : null;
        x[K2] = o4 ? new Date(o4).getTime() : NaN;
        const s4 = e4 == null ? void 0 : e4.endField, r2 = s4 && (e4 == null ? void 0 : e4.endField) ? i2.attributes[s4] : null;
    ...
    s3.forEach((a3) => {
      var _a2;
      const i2 = a3.feature.attributes[I2], n = a3.feature.attributes[t3], o4 = u2.get(i2), s4 = u2.get(n), r2 = (_a2 = t4 == null ? void 0 : t4.timeInfoByTypeName) == null ? void 0 : _a2.get(a3.typeName), h = (t4 == null ? void 0 : t4.timeInfoByTypeName) ? r2 == null ? void 0 : r2.startField : null, d4 = h ? a3.feature.attributes[h] : null, p4 = r2 == null ? void 0 : r2.endField, c2 = p4 ? a3.feature.attributes[p4] : null;
      if (void 0 !== o4 && void 0 !== s4) {
        let t5 = i2 + "-" + n;
        "chronological-mono-timeline" !== e3 && "chronological-multi-timeline" !== e3 || (t5 = t5 + "-" + d4 + "-" + c2);
        const r3 = Y.get(t5), h2 = r3 == null ? void 0 : r3.has(a3.typeName);
    ...
    const Z = this._validateOrganicLayoutSettings(e3, (_a = t4 == null ? void 0 : t4.layoutSettings) == null ? void 0 : _a.organicLayoutSettings), ee = this._convertValidatedOrganicSettingsToCalculationSettings(Z);
    await r();
    let te = 1, ae = null;
    if ("chronological-mono-timeline" === e3 || "chronological-multi-timeline" === e3) {
      let a3;
      ({ status: te, links: ae, graphics: a3 } = V(() => {
        var _a2;
        return ((_a2 = t4 == null ? void 0 : t4.signal) == null ? void 0 : _a2.aborted) ?? false;
      }, y3, L3, D, x, v, I3.subarray(0, J2), E.subarray(0, J2), S2.subarray(0, J2), _3.subarray(0, J2), "chronological-multi-timeline" === e3, (_b = t4 == null ? void 0 : t4.layoutSettings) == null ? void 0 : _b.chronologicalLayoutSettings)), 0 === te && (this.chronologicalAuxiliaryGraphics = a3);
    } else ({ status: te, links: ae } = z2(() => {
      var _a2;
      return ((_a2 = t4 == null ? void 0 : t4.signal) == null ? void 0 : _a2.aborted) ?? false;
    }, y3, L3, D, I3.subarray(0, J2), E.subarray(0, J2), ee.computationBudgetTime, ee.idealEdgeLengthMultiplier, ee.repulsionRadiusMultiplier));
    if (s2(t4 == null ? void 0 : t4.signal), 1 === te) throw new s("knowledge-graph:layout-failed", "Attempting to arrange the records in the specified layout failed");
    if (2 === te) throw u();
    for (let i2 = 0; i2 < A2.length; i2++) {
      if (D[i2] > 84.9999 ? D[i2] = 84.9999 : D[i2] < -84.9999 && (D[i2] = -84.9999), L3[i2] > 179.9999 ? L3[i2] = 179.9999 : L3[i2] < -179.9999 && (L3[i2] = -179.9999), A2[i2].feature.attributes[S] = new _(L3[i2], D[i2]), d3.has(A2[i2].typeName)) {
        ...
        e5 == null ? void 0 : e5.set(A2[i2].feature.attributes[_2], A2[i2].feature);
      } else {
    ...
    for (let i2 = 0; i2 < l3.length; i2++) {
      ...
      let d4 = r2 + "-" + h;
      if ("chronological-mono-timeline" === e3 || "chronological-multi-timeline" === e3) {
        const e4 = (_c = t4 == null ? void 0 : t4.timeInfoByTypeName) == null ? void 0 : _c.get(s4.typeName), a4 = (t4 == null ? void 0 : t4.timeInfoByTypeName) ? e4 == null ? void 0 : e4.startField : null, i3 = a4 ? s4.feature.attributes[a4] : null, n = e4 == null ? void 0 : e4.endField;
        d4 += "-" + i3 + "-" + (n ? s4.feature.attributes[n] : null);
      }
      const y4 = Y.get(d4).get(s4.typeName), g2 = 0 === y4 ? 0 : ae == null ? void 0 : ae.vertexEndIndex[y4 - 1];
      if (!se.has(y4)) {
        ...
        if ("chronological-mono-timeline" !== e3 && "chronological-multi-timeline" !== e3) {
          const e4 = (_d = A2[u2.get(r2)]) == null ? void 0 : _d.feature.attributes[S], t5 = (_e = A2[u2.get(h)]) == null ? void 0 : _e.feature.attributes[S];
      ...
      if (s4.feature.attributes[S] = D2, p3.has(s4.typeName)) {
        ...
        e4 == null ? void 0 : e4.set(s4.feature.attributes[_2], s4.feature);
      } else {
    ...
    for (const i2 of l3) i2.feature.attributes[o2] = ((_f = oe.get(i2.feature.attributes[I2] + "-" + i2.feature.attributes[t3])) == null ? void 0 : _f.get(i2.typeName)) ?? null;
    return this._currentLinkChartConfig = { layoutMode: e3, layoutSettings: (_g = t4 == null ? void 0 : t4.layoutSettings) == null ? void 0 : _g.clone() }, { nodes: d3, links: p3, idMap: c };
  }
  ...
  getCurrentNodeLocations() {
    ...
    for (const [t4, a2] of ((_a = this.dataManager.inclusionModeDefinition) == null ? void 0 : _a.namedTypeDefinitions.entries()) ?? []) this.dataManager.relationshipTypeNames.has(t4) || ((_b = a2 == null ? void 0 : a2.members) == null ? void 0 : _b.forEach((t5) => {
  ...
  async _calculateLayoutWithSublayerTimeInfo(e3 = "organic-standard", t4) {
    ...
    }), await this.calculateLinkChartLayout(e3, { timeInfoByTypeName: a2, ...t4 }), (_a = this.linkChart) == null ? void 0 : _a.handleChronologicalOverlay();
  }
  ...
  _alignLayersDataModelAndInclusionDefinition(e3) {
    ...
    if (this.layers && this._originalInclusionList) {
      const e4 = new Set(this._originalInclusionList.namedTypeDefinitions.keys()), t5 = ((_a = this.tables) == null ? void 0 : _a.map((e5) => e5.graphTypeName)) ?? [], a2 = this.layers.map((e5) => e5.graphTypeName).concat(t5);
...
//# sourceMappingURL=LinkChartLayer-SEK6ADFT.js.map
