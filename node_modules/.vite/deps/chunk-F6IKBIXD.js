...
// node_modules/@arcgis/core/chunks/antlr4.web.js
var t = { 763: () => {
} };
var e = {};
function n(s2) {
...
var s = {};
n.d(s, { MG: () => $, fr: () => Lt, sR: () => Ae, Zo: () => Ne, iH: () => Re, rt: () => Pt, jB: () => be, M8: () => le, $t: () => Ce, aq: () => me, pG: () => Ot, eP: () => Te, KU: () => xe, zW: () => Ie, IX: () => E, mY: () => _, a7: () => j, JG: () => Ut, ay: () => Xt, X2: () => ee, WU: () => de, Uw: () => ge, gw: () => pe, iX: () => Fe, re: () => se, Pg: () => Be, tD: () => ie, R$: () => te, Dj: () => Ft, m7: () => U, NZ: () => P, xo: () => b, ou: () => i, qC: () => ze, mD: () => d, Ay: () => Ye });
var i = class {
  constructor() {
...
var g = class {
  ...
  getOrAdd(t2) {
    ...
    for (const s2 of n2) if (this.equalsFunction(s2, t2)) return s2;
  ...
  _expand() {
    ...
    for (const n2 of t2) if (n2) for (const t3 of n2) {
      const e3 = this._getSlot(t3);
      let n3 = this.buckets[e3];
      n3 || (n3 = [], this.buckets[e3] = n3), n3.push(t3);
    }
  }
};
var p = class _p {
...
var f = class _f extends p {
  ...
  evalPrecedence(t2, e2) {
    let n2 = false;
    const s2 = [];
    for (let r2 = 0; r2 < this.opnds.length; r2++) {
      const i3 = this.opnds[r2], o2 = i3.evalPrecedence(t2, e2);
      if (n2 |= o2 !== i3, null === o2) return null;
...
var N = class extends k {
  constructor(t2, e2, n2, s2) {
    super(t2), this.ruleIndex = e2, this.precedence = n2, this.followState = s2, this.serializationType = k.RULE, this.isEpsilon = true;
  }
  matches(t2, e2, n2) {
    return false;
  }
...
var I = class extends k {
  constructor(t2, e2) {
    super(t2), this.serializationType = k.SET, null != e2 ? this.label = e2 : (this.label = new _(), this.label.addOne(i.INVALID_TYPE));
  }
  matches(t2, e2, n2) {
...
var y = class extends I {
  constructor(t2, e2) {
    super(t2, e2), this.serializationType = k.NOT_SET;
  }
  matches(t2, e2, n2) {
...
var L = class extends k {
  constructor(t2) {
    super(t2), this.serializationType = k.WILDCARD;
  }
  matches(t2, e2, n2) {
    return t2 >= e2 && t2 <= n2;
  }
...
var F = { toStringTree: function(t2, e2, n2) {
  ...
  for (let o2 = 1; o2 < i2; o2++) s2 = F.toStringTree(t2.getChild(o2), e2), r2 = r2.concat(" " + s2);
...
function Y(t2, e2, n2) {
  ...
  for (let a2 = 0; a2 < r2.length; a2++) {
    const s3 = Y(t2.getParent(a2), e2, n2);
    if (i2 || s3 !== t2.getParent(a2)) {
      if (!i2) {
        r2 = [];
...
function G(t2, e2, n2, s2) {
  ...
  return t2 instanceof V && (t2 = new z([t2.getParent()], [t2.returnState])), e2 instanceof V && (e2 = new z([e2.getParent()], [e2.returnState])), (function(t3, e3, n3, s3) {
    ...
    if (i2 < t3.returnStates.length) for (let c2 = i2; c2 < t3.returnStates.length; c2++) l2[o2] = t3.parents[c2], a2[o2] = t3.returnStates[c2], o2 += 1;
    else for (let c2 = r2; c2 < e3.returnStates.length; c2++) l2[o2] = e3.parents[c2], a2[o2] = e3.returnStates[c2], o2 += 1;
    if (o2 < l2.length) {
      if (1 === o2) {
...
var ht = class extends k {
  constructor(t2, e2) {
    super(t2), this.label_ = e2, this.label = this.makeLabel(), this.serializationType = k.ATOM;
  }
  makeLabel() {
    const t2 = new _();
...
var ct = class extends k {
  constructor(t2, e2, n2) {
    super(t2), this.serializationType = k.RANGE, this.start = e2, this.stop = n2, this.label = this.makeLabel();
  }
  makeLabel() {
    const t2 = new _();
...
var ut = class extends k {
  constructor(t2, e2, n2, s2) {
    super(t2), this.serializationType = k.ACTION, this.ruleIndex = e2, this.actionIndex = void 0 === n2 ? -1 : n2, this.isCtxDependent = void 0 !== s2 && s2, this.isEpsilon = true;
  }
  matches(t2, e2, n2) {
    return false;
  }
...
var dt = class extends k {
  constructor(t2, e2) {
    super(t2), this.serializationType = k.EPSILON, this.isEpsilon = true, this.outermostPrecedenceReturn = e2;
  }
  matches(t2, e2, n2) {
    return false;
  }
...
var pt = class extends O {
  constructor(t2, e2, n2, s2) {
    super(t2), this.serializationType = k.PREDICATE, this.ruleIndex = e2, this.predIndex = n2, this.isCtxDependent = s2, this.isEpsilon = true;
  }
  matches(t2, e2, n2) {
    return false;
  }
...
var xt = class extends O {
  constructor(t2, e2) {
    super(t2), this.serializationType = k.PRECEDENCE, this.precedence = e2, this.isEpsilon = true;
  }
  matches(t2, e2, n2) {
    return false;
  }
...
var Lt = class {
  ...
  readStates(t2, e2) {
    ...
    for (let c2 = 0; c2 < a2; c2++) {
      ...
      if (n3 === C.INVALID_TYPE) {
        t2.addState(null);
        continue;
      }
      let s3 = this.readInt();
      e2 && 65535 === s3 && (s3 = -1);
      const i3 = this.stateFactory(n3, s3);
      if (n3 === C.LOOP_END) {
  ...
  lexerActionFactory(t2, e2, n2) {
    if (null === this.actionFactories) {
      const t3 = [];
      t3[0] = (t4, e3) => new Et(t4), t3[1] = (t4, e3) => new _t(t4, e3), t3[2] = (t4, e3) => new It(t4), t3[3] = (t4, e3) => Ct.INSTANCE, t3[4] = (t4, e3) => Nt.INSTANCE, t3[5] = (t4, e3) => new kt(t4), t3[6] = (t4, e3) => mt.INSTANCE, t3[7] = (t4, e3) => new At(t4), this.actionFactories = t3;
    }
    ...
    try {
      for (; ; ) {
        ...
        for (; ; ) {
          ...
          if (this._input.LA(1) === i.EOF && (this._hitEOF = true), this._type === i.INVALID_TYPE && (this._type = n2), this._type === _Ut.SKIP) {
            e2 = true;
            break;
          }
...
var Xt = class _Xt extends Ht {
  ...
  getEpsilonTarget(t2, e2, n2, s2, r2, o2) {
    let a2 = null;
    if (n2.serializationType === k.RULE) {
      const t3 = V.create(e2.context, n2.followState.stateNumber);
      a2 = new Yt({ state: n2.target, context: t3 }, e2);
    } else {
      if (n2.serializationType === k.PRECEDENCE) throw "Precedence predicates are not supported in lexers.";
      if (n2.serializationType === k.PREDICATE) _Xt.debug && console.log("EVAL rule " + n2.ruleIndex + ":" + n2.predIndex), s2.hasSemanticContext = true, this.evaluatePredicate(t2, n2.ruleIndex, n2.predIndex, r2) && (a2 = new Yt({ state: n2.target }, e2));
      else if (n2.serializationType === k.ACTION) if (null === e2.context || e2.context.hasEmptyPath()) {
      ...
      else n2.serializationType === k.EPSILON ? a2 = new Yt({ state: n2.target }, e2) : n2.serializationType !== k.ATOM && n2.serializationType !== k.RANGE && n2.serializationType !== k.SET || o2 && n2.matches(i.EOF, 0, Ut.MAX_CHAR_VALUE) && (a2 = new Yt({ state: n2.target }, e2));
    }
    return a2;
  }
  ...
  addDFAState(t2) {
    ...
    let n2 = null;
    for (let o2 = 0; o2 < t2.items.length; o2++) {
      const e3 = t2.items[o2];
      if (e3.state instanceof A) {
        n2 = e3;
        break;
      }
    }
...
var Qt = { SLL: 0, LL: 1, LL_EXACT_AMBIG_DETECTION: 2, hasSLLConflictTerminatingPrediction: function(t2, e2) {
  ...
  for (let n2 = 0; n2 < e2.length; n2++) if (1 === e2[n2].length) return true;
  return false;
...
var se = class extends Ht {
  ...
  computeReachSet(t2, e2, n2) {
    ...
    const s2 = new Vt(n2);
    let r2 = null;
    for (let a2 = 0; a2 < t2.items.length; a2++) {
      const o3 = t2.items[a2];
      if (this.debug && console.log("testing " + this.getTokenName(e2) + " at " + o3), o3.state instanceof A) (n2 || e2 === i.EOF) && (null === r2 && (r2 = []), r2.push(o3), this.debug_add && console.log("added " + o3 + " to skippedStopStates"));
      else for (let t3 = 0; t3 < o3.state.transitions.length; t3++) {
        const n3 = o3.state.transitions[t3], i2 = this.getReachableTarget(n3, e2);
        if (null !== i2) {
          const t4 = new m({ state: i2 }, o3);
    ...
    if (e2 === i.EOF && (o2 = this.removeAllConfigsNotInRuleStopState(o2, o2 === s2)), !(null === r2 || n2 && te.hasConfigInRuleStopState(o2))) for (let i2 = 0; i2 < r2.length; i2++) o2.add(r2[i2], this.mergeCache);
  ...
  computeStartState(t2, e2, n2) {
    ...
    for (let r2 = 0; r2 < t2.transitions.length; r2++) {
      const e3 = t2.transitions[r2].target, o2 = new m({ state: e3, alt: r2 + 1, context: s2 }, null), a2 = new g();
  ...
  getPredsForAmbigAlts(t2, e2, n2) {
    ...
    for (let r2 = 0; r2 < e2.items.length; r2++) {
      const n3 = e2.items[r2];
      t2.get(n3.alt) && (s2[n3.alt] = p.orContext(s2[n3.alt] || null, n3.semanticContext));
    }
    let i2 = 0;
    for (let r2 = 1; r2 < n2 + 1; r2++) {
      const t3 = s2[r2] || null;
      null === t3 ? s2[r2] = p.NONE : t3 !== p.NONE && (i2 += 1);
    }
  ...
  canDropLoopEntryEdgeInLeftRecursiveRule(t2) {
    ...
    for (let r2 = 0; r2 < n2; r2++) if (this.atn.states[t2.context.getReturnState(r2)].ruleIndex !== e2.ruleIndex) return false;
    const s2 = e2.transitions[0].target.endState.stateNumber, i2 = this.atn.states[s2];
    for (let r2 = 0; r2 < n2; r2++) {
      const n3 = t2.context.getReturnState(r2), s3 = this.atn.states[n3];
      if (1 !== s3.transitions.length || !s3.transitions[0].isEpsilon) return false;
      const o2 = s3.transitions[0].target;
      if (!(s3.stateType === C.BLOCK_END && o2 === e2 || s3 === i2 || o2 === i2 || o2.stateType === C.BLOCK_END && 1 === o2.transitions.length && o2.transitions[0].isEpsilon && o2.transitions[0].target === e2)) return false;
    }
    return true;
  }
  getRuleName(t2) {
  ...
  dumpDeadEndConfigs(t2) {
    ...
    for (let n2 = 0; n2 < e2.length; n2++) {
      const t3 = e2[n2];
      let s2 = "no edges";
      if (t3.state.transitions.length > 0) {
        const e3 = t3.state.transitions[0];
        e3 instanceof ht ? s2 = "Atom " + this.getTokenName(e3.label) : e3 instanceof I && (s2 = (e3 instanceof y ? "~" : "") + "Set " + e3.set);
      }
      console.error(t3.toString(this.parser, true) + ":" + s2);
    }
  }
...
var me = class extends Ot {
  ...
  getConflictingAlts(t2, e2) {
    if (null !== t2) return t2;
    const n2 = new W();
    for (let s2 = 0; s2 < e2.items.length; s2++) n2.set(e2.items[s2].alt);
...
var ke = { RecognitionException: Ft, NoViableAltException: ee, LexerNoViableAltException: Mt, InputMismatchException: xe, FailedPredicateException: Te, DiagnosticErrorListener: me, BailErrorStrategy: Ae, DefaultErrorStrategy: Ce, ErrorListener: Ot };
var Ne = class {
  constructor(t2, e2) {
    if (this.name = "<empty>", this.strdata = t2, this.decodeToUnicodeCodePoints = e2 || false, this._index = 0, this.data = [], this.decodeToUnicodeCodePoints) for (let n2 = 0; n2 < this.strdata.length; ) {
      const t3 = this.strdata.codePointAt(n2);
      this.data.push(t3), n2 += t3 <= 65535 ? 1 : 2;
    }
    else {
...
var ve = { arrayToString: d, stringToCharArray: function(t2) {
...
var _ze = class _ze {
  ...
  getText(t2) {
    ...
    if (o2 === this.tokens.size - 1) for (const i2 of l2.values()) i2.index >= this.tokens.size - 1 && a2.push(i2.text.toString());
    return a2.join("");
  }
  reduceToSingleOperationPerIndex(t2) {
    for (let n2 = 0; n2 < t2.length; n2++) {
      let e3 = t2[n2];
      if (null == e3) continue;
      if (!(e3 instanceof Ke)) continue;
      let s2 = e3, i2 = this.getKindOfOps(t2, qe, n2);
      for (let n3 of i2) n3.index === s2.index ? (t2[n3.instructionIndex] = void 0, s2.text = n3.text.toString() + (null != s2.text ? s2.text.toString() : "")) : n3.index > s2.index && n3.index <= s2.lastIndex && (t2[n3.instructionIndex] = void 0);
      let r2 = this.getKindOfOps(t2, Ke, n2);
      for (let n3 of r2) {
        if (n3.index >= s2.index && n3.lastIndex <= s2.lastIndex) {
          t2[n3.instructionIndex] = void 0;
          continue;
        }
        let e4 = n3.lastIndex < s2.index || n3.index > s2.lastIndex;
        if (null != n3.text || null != s2.text || e4) {
          if (!e4) throw new Error(`replace op boundaries of ${s2} overlap with previous ${n3}`);
        } else t2[n3.instructionIndex] = void 0, s2.index = Math.min(n3.index, s2.index), s2.lastIndex = Math.max(n3.lastIndex, s2.lastIndex);
      }
    }
    for (let n2 = 0; n2 < t2.length; n2++) {
      let e3 = t2[n2];
      if (null == e3) continue;
      if (!(e3 instanceof qe)) continue;
      let s2 = e3, i2 = this.getKindOfOps(t2, qe, n2);
      for (let n3 of i2) n3.index === s2.index && (n3 instanceof He ? (s2.text = this.catOpText(n3.text, s2.text), t2[n3.instructionIndex] = void 0) : n3 instanceof qe && (s2.text = this.catOpText(s2.text, n3.text), t2[n3.instructionIndex] = void 0));
      let r2 = this.getKindOfOps(t2, Ke, n2);
      for (let o2 of r2) if (s2.index !== o2.index) {
        if (s2.index >= o2.index && s2.index <= o2.lastIndex) throw new Error(`insert op ${s2} within boundaries of previous ${o2}`);
      } else o2.text = this.catOpText(s2.text, o2.text), t2[n2] = void 0;
    }
...
var Ye = { atn: re, dfa: he, context: ce, misc: ue, tree: fe, error: ke, Token: i, CommonToken: Pt, CharStreams: Re, CharStream: Ne, InputStream: Ie, CommonTokenStream: be, Lexer: Ut, Parser: Fe, ParserRuleContext: Be, Interval: E, IntervalSet: _, LL1Analyzer: j, Utils: ve, TokenStreamRewriter: ze };
s.MG, s.fr, s.sR;
var Ge = s.Zo;
s.iH, s.rt;
var We = s.jB;
s.M8, s.$t, s.aq;
var je = s.pG;
s.eP, s.KU, s.zW, s.IX, s.mY, s.a7, s.JG, s.ay, s.X2, s.WU, s.Uw;
var $e = s.gw;
s.iX, s.re, s.Pg, s.tD, s.R$, s.Dj, s.m7, s.NZ, s.xo, s.ou, s.qC, s.mD;
var Xe = s.Ay;
...
//# sourceMappingURL=chunk-F6IKBIXD.js.map
