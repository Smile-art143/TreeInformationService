...
var m = 0;
var u2 = 0;
var l = { time: n(0), deltaTime: n(0), elapsedFrameTime: n(0), frameDuration: n(0) };
...
var v = { frameTasks: h, willDispatch: false, clearFrameTasks: j, dispatch: y, executeFrameTasks: q, reschedule: w };
function A(t3) {
  const n2 = new c(t3);
  return f.push(n2), v.willDispatch || (v.willDispatch = true, t(y)), n2;
}
function F(e2) {
  const t3 = new i(e2);
...
function q(e2) {
  const t3 = n(e2 - m);
  m = e2;
  const n2 = u2 > 0 ? u2 : 1e3 / 60, r3 = Math.max(0, t3 - n2);
  l.time = e2, l.frameDuration = n(n2 - r3);
  for (let s3 = 0; s3 < p.length; s3++) {
    ...
    h.forAll((n4) => {
      ...
      0 === s3 && n4.ticks++;
      n4.phases[r4] && (l.elapsedFrameTime = n(performance.now() - e2), l.deltaTime = 0 === n4.ticks ? n(0) : t3, (_a = n4.phases[r4]) == null ? void 0 : _a.call(n4, l));
    }), S[s3].push(performance.now() - n3);
  }
  b(), z.push(performance.now() - e2);
}
var _ = new r();
function b() {
  h.forAll((e2) => {
...
function M(t3 = 1, n2) {
  const a2 = $(), i2 = () => {
    a(n2) ? a2.reject(u()) : 0 === t3 ? a2() : (--t3, t(() => i2()));
  };
  return i2(), a2.promise;
}
function P(e2) {
  return M(1, e2);
}
async function U(e2) {
  await P(e2), await new Promise((t3) => requestAnimationFrame(() => {
    (e2 == null ? void 0 : e2.aborted) || t3();
  }));
}
var S = p.map((e2) => new s(e2));
var z = new s("total");
...
//# sourceMappingURL=chunk-SK572VBG.js.map
