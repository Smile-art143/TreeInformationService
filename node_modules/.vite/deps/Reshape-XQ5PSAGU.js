import {
  h as h7
} from "./chunk-VHDKJC6C.js";
import {
  j as j3,
  l as l6
} from "./chunk-5VW4LQYR.js";
import {
  a as a3,
  t as t4
} from "./chunk-MURNF66K.js";
import {
  e as e7,
  i as i4,
  p as p4
...
import {
  f as f6
} from "./chunk-QSY2ANAY.js";
import {
  h as h6,
  x as x3
} from "./chunk-JLPNCQVY.js";
import {
  e as e6,
  g,
  w2
...
var G2 = class extends b {
  ...
  async _initializeGraphic(e8, i7) {
    e8.symbol ?? (e8.symbol = await this._updatingHandles.addPromise(F(e8, { scale: this.view.scale, useSourceLayer: true }))), this._pendingFeatures.has(i7.uniqueId) ? this._pendingGraphicsLayer.add(e8) : this._modifiedFeatures.has(i7.uniqueId) && this._modifiedGraphicsLayer.add(e8), this.addHandles(await L(i7.originalGraphic, e8, this.view), w3);
  }
  _update(e8) {
    for (const i7 of e8) {
      const e9 = this._modifiedFeatures.delete(i7.uniqueId);
      this._pendingFeatures.set(i7.uniqueId, i7);
      const t5 = e3(this._graphics, i7.uniqueId, () => {
...
async function L(e8, i7, a4) {
  ...
  let c3 = null;
  function h9(e9) {
    c3 == null ? void 0 : c3.abort(), c3 = d(async (i8) => {
      var _a;
      const t5 = await b2(a4, o);
      s2(i8), t5 && ((_a = t5.setVisibility) == null ? void 0 : _a.call(t5, d5, e9));
    });
  }
  return await F3(a4, i7), h9(false), t([j4(a4, i7, (e9) => h9(!e9)), e2(async () => {
    h9(true);
    const e9 = await b2(a4, o);
    await j(() => !(e9 == null ? void 0 : e9.updating));
  })]);
}
...
function g2(e8, r3) {
  ...
  return t([l2(() => {
    var _a, _b;
    const t5 = a4();
    return { context: t5, geometry: (_a = t5.graphic) == null ? void 0 : _a.geometry, vertexGeometry: (_b = t5.selectedVertex) == null ? void 0 : _b.geometry };
  }, ({ context: t5 }) => {
    l7(() => {
...
function d4(t5, { graphic: e8 }) {
  T(t5, e8, e8 == null ? void 0 : e8.geometry);
}
function x4(t5, { graphic: e8, selectedVertex: o, automaticAreaMeasurementUtils: n5, automaticLengthMeasurementUtils: i7 }) {
  T(t5, e8, o == null ? void 0 : o.geometry);
  const r3 = e8 == null ? void 0 : e8.geometry;
  if (!r3 || !n2(r3)) switch (r3 == null ? void 0 : r3.type) {
    case "polygon":
...
function T(t5, e8, o) {
  var _a;
  e8 && "point" === (o == null ? void 0 : o.type) && (t5.setLocationFromPoint(o), t5.elevation.actual = y3(o), t5.elevation.visible = !!((_a = e8.geometry) == null ? void 0 : _a.hasZ), t5.elevation.readOnly = false, t5.elevation.showAsZ = true);
}
function j5(t5) {
  function e8(e9, o2) {
    const n6 = o2 == null ? void 0 : o2.geometry;
...
function k(t5, e8, o, n5, i7) {
  ...
  "polygon" === (o == null ? void 0 : o.type) ? t5.area = r3.autoArea2D(o) : "polyline" === (o == null ? void 0 : o.type) && (t5.totalLength = a4.autoLength2D(o)), w4(t5, e8, i7, n5);
}
...
function K(t5, o, r3) {
  const n5 = [];
  return t5 == null ? void 0 : t5.forEach((t6, i7) => {
    t6.forEach((t7, s4) => {
      var _a;
      n5.push(new _2({ geometry: r3.arrayToPoint(f3(t7)), symbol: (_a = o == null ? void 0 : o.vertices) == null ? void 0 : _a.default, attributes: { [R2.tool]: k2, [R2.pathIndex]: i7, [R2.pointIndex]: s4 } }));
    });
  }), n5;
}
function F4(t5, o, r3) {
  ...
  for (let i7 = 0; i7 < t5.length; i7++) {
    ...
    if (!Z(t5, i7)) for (let t6 = 1; t6 < s4.length; t6++) {
      ...
      if (t3(l7)) {
        ...
        n5.push(...t7.map((t8, n6) => {
          var _a2;
          return new _2({ geometry: r3.arrayToPoint(t8), symbol: (_a2 = o == null ? void 0 : o.controlPoints) == null ? void 0 : _a2.default, attributes: { ...a4, [R2.controlPointKind]: 0 === n6 ? U3.bezier.cp1 : U3.bezier.cp2 } });
        }));
      }
      const m4 = u3(l7), g3 = c(l7);
      if (m4 || g3) {
        const t7 = m4 ? l3(c3, l7) : h4(c3, l7), i8 = h3(t7, 0.25);
        n5.push(new _2({ geometry: r3.arrayToPoint(i8), symbol: (_a = o == null ? void 0 : o.controlPoints) == null ? void 0 : _a.default, attributes: { ...a4, [R2.controlPointKind]: U3.circle.interior } }));
      }
    }
  }
  return n5;
...
function G3(t5, o, n5) {
  ...
  for (let l7 = 0; l7 < t5.length; l7++) {
    ...
    for (let t6 = 1; t6 < n6.length; t6++) {
      ...
      i7.push(new _2({ geometry: new y2({ paths: [[[m4[0], m4[1]], p5]], spatialReference: s4 }), symbol: o == null ? void 0 : o.constructionLines, attributes: { ...f7, [R2.controlPointKind]: U3.bezier.line1 } }), new _2({ geometry: new y2({ paths: [[[a4[0], a4[1]], u6]], spatialReference: s4 }), symbol: o == null ? void 0 : o.constructionLines, attributes: { ...f7, [R2.controlPointKind]: U3.bezier.line2 } }));
    }
  }
  return i7;
}
...
function Z(e8, o) {
  const r3 = e8.at(o);
  return 2 === (r3 == null ? void 0 : r3.length) && h(f3(r3[1]), f3(r3[0])) && c(r3[1]);
}
function A(e8, o) {
  const r3 = e8.at(o);
  return 2 === (r3 == null ? void 0 : r3.length) && h(f3(r3[1]), f3(r3[0])) && a2(r3[1]);
}
function O2(e8, o) {
  const r3 = e8.at(o);
  return 2 === (r3 == null ? void 0 : r3.length) && h(f3(r3[1]), f3(r3[0])) && e5(r3[1]);
}
function V(e8, t5) {
...
var _t = class extends l {
  ...
  initialize() {
    const t5 = this.view;
    this._highlightHelper = new l6({ view: t5 }), this._setup(), this._updateHandlesOnExternalGeometryChange = P(() => {
      var _a;
      ...
      i7 && h9.push(o), s4 == null ? void 0 : s4.set("graphics", h9);
    }, U), this.tooltip = R(() => ({ view: t5, options: this.sketchOptions.tooltips })), this.tooltipInfos = v(this.sketchOptions), this.addHandles([f(() => t5 == null ? void 0 : t5.ready, () => {
  ...
  destroy() {
    var _a;
    this._reset(), (_a = this._mover) == null ? void 0 : _a.destroy(), this._mover = null, this._connectedReshapeManager = u(this._connectedReshapeManager), this.tooltip = u(this.tooltip);
  }
  get _coordinateHelper() {
    var _a, _b, _c;
    return ((_a = this._editGeometryOperations) == null ? void 0 : _a.data.coordinateHelper) ?? w2(!!((_b = this.graphic.geometry) == null ? void 0 : _b.hasZ), !!((_c = this.graphic.geometry) == null ? void 0 : _c.hasM), this.view.spatialReference);
  }
  ...
  get _tooltipsContext() {
    ...
    return { sketchOptions: i7, activeTooltipInfo: s4, graphic: o, selectedVertex: this._selectedManipulator, automaticAreaMeasurementUtils: t5, automaticLengthMeasurementUtils: e8, updateGeometry: (t6, e9, i8, s5, o2) => {
      ...
      if (this._syncGeometryAfterVertexMove(t6, e9, s5, o2, n5), r3) {
        const { view: t7 } = this, s6 = t7.toScreen(i8), o3 = t7.toScreen(e9), r4 = ((o3 == null ? void 0 : o3.x) ?? 0) - ((s6 == null ? void 0 : s6.x) ?? 0), n6 = ((o3 == null ? void 0 : o3.y) ?? 0) - ((s6 == null ? void 0 : s6.y) ?? 0);
  ...
  _setup() {
    ...
    if (!e8 || null == (t5 == null ? void 0 : t5.geometry)) return;
  ...
  _setUpHighlights() {
    var _a;
    this.highlightsEnabled && this.graphic && ((_a = this._highlightHelper) == null ? void 0 : _a.add(this.graphic, this.highlightName));
  }
  _setUpGeometryHelper() {
    const t5 = this.graphic.geometry;
    null != t5 && "mesh" !== t5.type && "extent" !== t5.type ? this._editGeometryOperations ?? (this._editGeometryOperations = g.fromGeometry(t5, 2, { allowCurves: true })) : this._logGeometryTypeError();
  }
  _saveSnappingContextForHandle(t5, e8) {
    ...
    n(i7), this._snappingContext = new e6({ editGeometryOperations: i7, elevationInfo: { mode: "on-the-ground", offset: 0 }, pointer: ((_a = e8.viewEvent) == null ? void 0 : _a.pointerType) || "mouse", excludeFeature: this.graphic, feature: this.graphic, visualizer: new f6(this._snappingGraphicsLayer), vertexHandle: this._getVertexFromEditGeometry(t5) });
  }
  _reset() {
    var _a, _b;
    this._clearSelection(), (_a = this._highlightHelper) == null ? void 0 : _a.removeAll(), this._updateTooltip(), this._resetGraphics(), this._resetSnappingStateVars(), this._activeOperationInfo = null, (_b = this._mover) == null ? void 0 : _b.destroy(), this._mover = null, this.removeHandles(yt);
  }
  ...
  _removeMidpointGraphics(t5 = this.layer) {
    ...
    t5 == null ? void 0 : t5.removeMany(e8.items), e8.drain(u);
  }
  ...
  _removeCurveGraphics(t5 = this.layer) {
    ...
    t5 == null ? void 0 : t5.removeMany(e8.items), t5 == null ? void 0 : t5.removeMany(i7.items), e8.drain(u), i7.drain(u);
  }
  _setupGraphics() {
    const t5 = this.graphic.geometry;
  ...
  _setUpMidpointGraphics(t5) {
    ...
    const e8 = L2(t5, this.symbols, this._coordinateHelper, "polygon" === ((_a = this.graphic.geometry) == null ? void 0 : _a.type));
  ...
  _updateSymbolsForTheme() {
    ...
    this.symbols = { vertices: { ...this.symbols.vertices, default: this.symbols.vertices.default.clone().set("color", t5), hover: (_a = this.symbols.vertices.hover) == null ? void 0 : _a.clone().set("color", t5) }, controlPoints: { ...this.symbols.controlPoints, default: this.symbols.controlPoints.default.clone().set("color", t5), hover: (_b = this.symbols.controlPoints.hover) == null ? void 0 : _b.clone().set("color", t5) }, midpoints: { ...this.symbols.midpoints }, constructionLines: this.symbols.constructionLines.clone().set("color", t5) };
  ...
  _onGraphicClickCallback(t5) {
    ...
    if (e8 === this.graphic) this.clearSelection(), this.emit("graphic-click", t5), (_b = (_a = this.callbacks).onGraphicClick) == null ? void 0 : _b.call(_a, t5);
  ...
  _onGraphicMoveStartCallback(t5) {
    ...
    if (s4 === this.graphic) {
      ...
      return this._setUpOperation(t5), this._emitMoveStartEvent(e8, i7), r3 && (o == null ? void 0 : o.startFeatureMove([r3])), void (null != n6 && "point" === n6.type && this._onHandleMove(s4, e8, i7, t5, () => {
    ...
    if (this._setUpOperation(t5), r3) {
      ...
      o == null ? void 0 : o.startVertexMove(r3, It(t6));
    }
  ...
  _onGraphicMoveCallback(t5) {
    ...
    if (null != n5) {
      if ("move" !== r3) this._onHandleMove(o, i7, s4, t5, () => {
        ...
        (_a = this._connectedReshapeManager) == null ? void 0 : _a.translate(o2, r4, 0), this._updateTooltip(this.graphic, t5.viewEvent), this._emitMoveEvent(i7, s4);
      }
    }
  }
  ...
  _updateCurveGraphicLocations(t5) {
    ...
    for (const s4 of this.selectedManipulators) {
      const [t6, e9] = Et(s4);
      null != t6 && null != e9 && s4.getAttribute(R2.controlPointKind) && ((_a = e3(i7, t6, () => /* @__PURE__ */ new Set())) == null ? void 0 : _a.add(e9));
    }
    for (const s4 of this.curveControlPointGraphics) {
      const [e9, o] = Et(s4);
      if ((_b = i7.get(e9)) == null ? void 0 : _b.has(o)) continue;
      const r3 = t5[e9][o];
      if (u3(r3) || c(r3)) {
  ...
  _syncGeometryAfterVertexMove(t5, e8, i7, s4, o = false) {
    ...
    if (h9) {
      ...
      "point" !== r3.type && "mesh" !== r3.type || ((_b = this._editGeometryOperations) == null ? void 0 : _b.moveVertices([h9], e9, i8, s5)), (_c = this._connectedReshapeManager) == null ? void 0 : _c.translate(e9, i8, s5);
    }
  ...
  _moveRelatedCoordinates(t5, e8, i7) {
    ...
    if (!(s4 == null ? void 0 : s4.length)) return t5;
    for (const r3 of s4) {
  ...
  _moveSelectedHandleCoordinates(t5, e8, i7, s4, o) {
    ...
    for (const n5 of this.selectedManipulators) if (n5 !== e8) {
      ...
      if (n5.geometry = p5, this._updateGeometryFromGraphic(n5, t5, e9, a4, c3, r3, o), h9 == null ? void 0 : h9.length) for (const i8 of h9) {
  ...
  _updateTooltip(t5, e8) {
    let i7 = null;
    const { graphic: s4, view: o, tooltipInfos: r3 } = this, n5 = s4 == null ? void 0 : s4.geometry;
    "point" === (n5 == null ? void 0 : n5.type) ? i7 = r3.movePoint : this._selectedManipulator ? i7 = r3.selectedVertex : t5 === this.graphic ? (i7 = r3.translateGraphic, U2(i7, o, this._tooltipsContext, e8)) : t5 && this.selectedManipulators.length > 1 && (i7 = r3.translateVertices, k(i7, o, n5, this._tooltipsContext, e8)), this.activeTooltipInfo = i7;
  }
  _updateGraphicGeometry(t5) {
    var _a, _b;
    (_a = this._updateHandlesOnExternalGeometryChange) == null ? void 0 : _a.pause(), this.graphic.geometry = t5, (_b = this._updateHandlesOnExternalGeometryChange) == null ? void 0 : _b.resume();
  }
  _emitMoveStartEvent(t5, e8) {
    var _a, _b;
    const i7 = { type: "move-start", mover: this.graphic, dx: t5, dy: e8 };
    this.emit("move-start", i7), (_b = (_a = this.callbacks).onMoveStart) == null ? void 0 : _b.call(_a, i7);
  }
  _emitMoveEvent(t5, e8) {
    var _a, _b;
    const i7 = { type: "move", mover: this.graphic, dx: t5, dy: e8 };
    this.emit("move", i7), (_b = (_a = this.callbacks).onMove) == null ? void 0 : _b.call(_a, i7);
  }
  _emitMoveStopEvent(t5, e8) {
    ...
    this.emit("move-stop", i7), (_b = (_a = this.callbacks).onMoveStop) == null ? void 0 : _b.call(_a, i7);
  }
  _emitReshapeStartEvent(t5) {
    ...
    this.emit("reshape-start", e8), (_b = (_a = this.callbacks).onReshapeStart) == null ? void 0 : _b.call(_a, e8);
  }
  _emitReshapeEvent(t5) {
    var _a, _b;
    const e8 = { type: "reshape", graphic: this.graphic, mover: t5, selected: this.selectedManipulators.toArray() };
    this.emit("reshape", e8), (_b = (_a = this.callbacks).onReshape) == null ? void 0 : _b.call(_a, e8);
  }
  _emitReshapeStopEvent(t5) {
    ...
    this.emit("reshape-stop", e8), (_b = (_a = this.callbacks).onReshapeStop) == null ? void 0 : _b.call(_a, e8);
  }
  _emitSelectEvent(t5) {
    var _a, _b;
    const e8 = { type: "vertex-select", added: t5 };
    this.emit("select", e8), (_b = (_a = this.callbacks).onVertexSelect) == null ? void 0 : _b.call(_a, e8);
  }
  _emitDeselectEvent(t5) {
    var _a, _b;
    const e8 = { type: "vertex-deselect", removed: t5 };
    this.emit("deselect", e8), (_b = (_a = this.callbacks).onVertexDeselect) == null ? void 0 : _b.call(_a, e8);
  }
  _emitVertexAddEvent(t5, e8, i7) {
    var _a, _b;
    const s4 = { type: "vertex-add", added: t5, graphic: this.graphic, oldGraphic: e8, vertices: i7 };
    this.emit("vertex-add", s4), (_b = (_a = this.callbacks).onVertexAdd) == null ? void 0 : _b.call(_a, s4);
  }
  _emitVertexRemoveEvent(t5, e8, i7) {
    var _a, _b;
    const s4 = { type: "vertex-remove", removed: t5, graphic: this.graphic, oldGraphic: e8, vertices: i7 };
    this.emit("vertex-remove", s4), (_b = (_a = this.callbacks).onVertexRemove) == null ? void 0 : _b.call(_a, s4);
  }
...
function ft(t5) {
  var _a, _b;
  return "polygon" === t5.type ? ((_a = t5.curveRings) == null ? void 0 : _a.slice()) ?? t5.rings.slice() : "polyline" === t5.type ? ((_b = t5.curvePaths) == null ? void 0 : _b.slice()) ?? t5.paths.slice() : t5.points.map((t6) => [t6]);
}
...
function Et({ attributes: t5 }) {
  return [(t5 == null ? void 0 : t5[R2.pathIndex]) || 0, (t5 == null ? void 0 : t5[R2.pointIndex]) || 0];
}
function wt({ attributes: t5 }) {
  return `${t5 == null ? void 0 : t5[R2.pathIndex]}-${t5 == null ? void 0 : t5[R2.pointIndex]}`;
}
function Ot(t5) {
...
//# sourceMappingURL=Reshape-XQ5PSAGU.js.map
