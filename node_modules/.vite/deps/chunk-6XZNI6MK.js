...
function getBoundingClientRect(element, includeScale, isFixedStrategy, offsetParent2) {
  ...
  if (domElement && offsetParent2) {
    const win = getWindow(domElement);
    const offsetWin = isElement(offsetParent2) ? getWindow(offsetParent2) : offsetParent2;
    let currentWin = win;
...
var positionFloatingUI = (
  ...
  (async (component, {
    ...
    const {
      ...
      strategy: position,
      middlewareData
    } = await computePosition2(referenceEl, floatingEl, {
      strategy: overlayPositioning,
      placement: placement === "auto" || placement === "auto-start" || placement === "auto-end" ? void 0 : getEffectivePlacement(placement, isRTL2),
      middleware: getMiddleware({
        placement,
        flipDisabled,
        flipPlacements: flipPlacements2 == null ? void 0 : flipPlacements2.map((placement2) => getEffectivePlacement(placement2, isRTL2)),
        offsetDistance,
        offsetSkidding,
        arrowEl,
        type
...
function disconnectFloatingUI(component) {
  var _a;
  const trackedState = autoUpdatingComponentMap.get(component);
  if ((trackedState == null ? void 0 : trackedState.state) === "active") {
    trackedState.cleanUp();
  }
  autoUpdatingComponentMap.delete(component);
  (_a = componentToDebouncedRepositionMap.get(component)) == null ? void 0 : _a.cancel();
...
@esri/calcite-components/dist/chunks/floating-ui.js:
  ...
  v3.3.3 *)
*/
//# sourceMappingURL=chunk-6XZNI6MK.js.map
