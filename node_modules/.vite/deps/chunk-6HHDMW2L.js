...
var X = class extends n {
  ...
  set rasterJobHandler(e2) {
    var _a, _b;
    this._set("rasterJobHandler", e2), t(this) && ((_b = (_a = this.primaryRasters) == null ? void 0 : _a.rasters) == null ? void 0 : _b.forEach((t3) => t3.rasterJobHandler = e2));
  }
  get rasterId() {
  ...
  _computeMagDirValues(e2) {
    ...
    if (!(2 === t3 && "vector-magdir" === i5 || "vector-uv" === i5) || 2 !== (e2 == null ? void 0 : e2.length) || !((_a = e2[0]) == null ? void 0 : _a.length)) return null;
  ...
  _processIdentifyResult(e2, t3) {
    ...
    if (f2) {
      ...
      a3 = a3.map((t4) => e3.map((e4) => t4[e4])), c2 = c2 == null ? void 0 : c2.map((t4) => e3.map((e4) => t4[e4])), u5 = e3.map((e4) => u5[e4]);
    }
    ...
    return { location: i5, value: null, dataSeries: u5.map((e3, t4) => {
      const i6 = { value: 0 === (x3 == null ? void 0 : x3[t4]) ? null : a3.map((e4) => e4[t4]), multidimensionalDefinition: e3.multidimensionalDefinition.map((e4) => new p2({ ...e4, isSlice: true })) };
      return (c2 == null ? void 0 : c2.length) && (i6.magdirValue = [c2[0][t4], c2[1][t4]]), i6;
    }), pyramidLevel: r5 };
  }
};
function K(e2, t3, i5) {
...
var m4 = class extends X {
  ...
  async fetchPixels(t3, e2, r5, s4 = {}) {
    ...
    let l6 = false;
    const { interpolation: c2 } = s4, p6 = (_a = this.rasterFunction.flatWebGLFunctionChain) == null ? void 0 : _a.hasFocalFunction;
    ...
    const f2 = ((_b = u5.find((t4) => null != t4.pixelBlock)) == null ? void 0 : _b.extent) ?? t3;
  ...
  async _open(t3) {
    ...
    r5.isRoot = true, ((_b = (_a = this.primaryRasters) == null ? void 0 : _a.rasters) == null ? void 0 : _b.length) ? r5.sourceRasters = this.primaryRasters.rasters : (this.primaryRasters = r5.getPrimaryRasters(), this.rasterJobHandler && ((_c = this.primaryRasters.rasters) == null ? void 0 : _c.forEach((t4) => t4.rasterJobHandler = this.rasterJobHandler)));
    ...
    const l6 = "Table" === r5.functionName ? r5 : (_d = r5.functionArguments) == null ? void 0 : _d.raster;
    "Table" === (l6 == null ? void 0 : l6.functionName) && (r5.rasterInfo.attributeTable = g.fromJSON(l6.functionArguments.attributeTableAsRecordSet)), await this.syncJobHandler();
    const p6 = a3[0];
  ...
  async _updateClipGeometry() {
    ...
    if (e2 && "inside" === t3.clippingType) {
      const { extent: t4 } = this.rasterInfo, r5 = await import("./densifyOperator-4MOPZSJU.js"), s4 = await import("./differenceOperator-OFWVQLMQ.js");
...
var X2 = (X3) => {
  ...
  let Z = class extends Y {
    ...
    get renderer() {
      ...
      if (e2) {
        const i5 = t3 == null ? void 0 : t3.find(({ name: t4 }) => t4 === e2);
    ...
    readRenderer(e2, t3, i5) {
      var _a, _b;
      const r5 = (_b = (_a = t3 == null ? void 0 : t3.layerDefinition) == null ? void 0 : _a.drawingInfo) == null ? void 0 : _b.renderer;
    ...
    async updateRenderer() {
      ...
      if (!e2 || !t3 || !i5) return;
      const { rasterInfo: r5 } = this.raster, s4 = v(r5, { multidimensionalDefinition: this.multidimensionalDefinition, multidimensionalSubset: this.multidimensionalSubset }), n4 = s4 == null ? void 0 : s4.name, o3 = D3(r5, n4);
      return this._updateSymbolizer(t3, i5, n4, o3);
    }
    async applyRenderer(e2, t3, i5) {
      const r5 = e2 == null ? void 0 : e2.pixelBlock;
    ...
    getRawDisplayBandIds() {
      ...
      if (this.rasterFunction && t(t3)) {
        ...
        e2 = (e2 == null ? void 0 : e2.length) && (i5 == null ? void 0 : i5.length) && 1 !== t3.rasterInfo.bandCount ? e2.map((e3) => i5[Math.min(e3, i5.length - 1)]) : i5;
      }
    ...
    async fetchTile(e2, i5, r5, s4 = {}) {
      ...
      return await this._initJobHandler(), await this.updateRasterFunction(), "raster-shaded-relief" === ((_a = this.renderer) == null ? void 0 : _a.type) && (s4 = { ...s4, buffer: { cols: 1, rows: 1 } }), this.raster.fetchTile(e2, i5, r5, s4);
    }
    async fetchPixels(e2, t3, i5, r5 = {}) {
      ...
      return ((_a = r5.bandIds) == null ? void 0 : _a.length) && !this.raster.rasterInfo.storageInfo.isBsqTile && (s4.pixelBlock = (_b = s4.pixelBlock) == null ? void 0 : _b.extractBands(r5.bandIds)), s4;
    }
    async getSamples(e2, t3) {
      ...
      const r5 = (_a = e2.mosaicRule) == null ? void 0 : _a.multidimensionalDefinition, s4 = { ...t3, multidimensionalDefinition: r5 }, n4 = (await this._getSampleLocations(e2)).map((e3) => this.identify(e3, s4).then((t4) => (t4.location = e3, t4))), a3 = (await Promise.all(n4)).flatMap((e3, t4) => this._convertRasterIdentifyResultToSample(e3, t4));
    ...
    hasStandardTime() {
      ...
      const t3 = this.multidimensionalDefinition, i5 = (_c = t3 == null ? void 0 : t3[0]) == null ? void 0 : _c.variableName;
      return e2.variables.some((e3) => e3.name === i5 && (!(t3 == null ? void 0 : t3[0].dimensionName) || e3.dimensions.some((e4) => "StdTime" === e4.name)));
    }
    ...
    async _getSampleLocations(e2) {
      ...
      if ("polyline" === r5) {
        ...
        if (e2.sampleCount || e2.sampleDistance) {
          const i6 = await import("./densifyOperator-4MOPZSJU.js"), s5 = (await import("./lengthOperator-ICDXYTWZ.js")).execute(t3, { unit: "meters" }), n5 = Math.min(e2.sampleCount || 100, Q3);
    ...
    _configDefaultInterpolation() {
      ...
      if (null == this.interpolation) {
        ee(this);
        const { raster: e2 } = this, t3 = N3(e2.rasterInfo, e2.tileType, (_a = this.sourceJSON) == null ? void 0 : _a.defaultResamplingMethod);
    ...
    _configDefaultRenderer(e2 = "no") {
      var _a, _b, _c;
      ee(this);
      const { rasterInfo: t3 } = this.raster, i5 = v(t3, { multidimensionalDefinition: this.multidimensionalDefinition, multidimensionalSubset: this.multidimensionalSubset }), s4 = i5 == null ? void 0 : i5.name, n4 = q({ variableName: s4, rasterFunctionName: (_a = this.rasterFunction) == null ? void 0 : _a.functionName, presetRenderers: this.presetRenderers });
      if (!this.bandIds && t3.bandCount > 1 && (this.bandIds = (n4 == null ? void 0 : n4.bandIds) ?? W2(t3)), !this.renderer || "override" === e2) {
        const e3 = z3(this.raster), i6 = (n4 == null ? void 0 : n4.renderer) ?? B(t3, { bandIds: this.bandIds, variableName: s4, rasterFunctionColorRamp: e3 }), r5 = t3.statistics, o4 = r5 && r5.length > 0 ? r5[0] : null, a4 = (o4 == null ? void 0 : o4.max) ?? 0, l7 = (o4 == null ? void 0 : o4.min) ?? 0;
      ...
      if (l6.success) {
        if ("auto" === e2) {
          ...
          if (null != e3 && "raster-colormap" === t4.type) {
            ...
            const e4 = (_b = this.bandIds) == null ? void 0 : _b.length, i6 = (_c = t4.customStatistics) == null ? void 0 : _c.length;
    ...
    async _updateRasterFunction() {
      ...
      if (r5) {
        ...
        const s5 = T2(((_a = r5.functionDefinition) == null ? void 0 : _a.toJSON()) ?? r5.toJSON(), i6), n5 = new m4({ rasterFunction: s5 });
    ...
    _convertRasterIdentifyResultToSample(e2, t3) {
      ...
      if (!((_a = e2.dataSeries) == null ? void 0 : _a.length)) return [new i2({ location: e2.location, pixelValue: e2.value, locationId: t3, resolution: s4 })];
      const n4 = [];
...
function i4(n4, e2) {
  var _a;
  const t3 = (_a = n4 == null ? void 0 : n4.nodeName) == null ? void 0 : _a.toLowerCase(), l6 = e2.toLowerCase();
...
//# sourceMappingURL=chunk-6HHDMW2L.js.map
