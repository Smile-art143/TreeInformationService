...
function f(e2) {
  var _a, _b;
  const t = (_a = e2.symbolLayers) == null ? void 0 : _a.at(-1);
...
function m(e2) {
  ...
  return e((_a = y(e2)) == null ? void 0 : _a.width);
}
function h(e2) {
...
function d(e2) {
  var _a;
  return ((_a = e2.resource) == null ? void 0 : _a.href) ?? "";
}
function b(t, r) {
  if (!t) return null;
  let o = null;
...
function w(t) {
  ...
  return r.forEach((e2) => {
    var _a;
    "object" === e2.type && ((_a = e2.resource) == null ? void 0 : _a.href) || (o = "water" === e2.type ? e2.color : e2.material ? e2.material.color : null);
  }), o ? new u(o) : null;
}
function k2(t, r) {
...
function j(t, r, o) {
  ...
  const l = (t2, n2 = false) => {
    let l2 = r ?? t2 ?? null;
    return null != (o == null ? void 0 : o.override) && (!l2 && n2 && (l2 = new u([255, 255, 255])), l2 && (l2.a = o.override)), k2(l2, o == null ? void 0 : o.add);
  };
  n.forEach((e2) => {
    var _a, _b;
    if ("water" === e2.type) return void (e2.color = k2(e2.color, o == null ? void 0 : o.add));
    const t2 = null != e2.material ? e2.material.color : null, r2 = l(t2, "icon" === e2.type && null != ((_a = e2.resource) == null ? void 0 : _a.href));
    null == e2.material ? e2.material = new p({ color: r2 }) : e2.material.color = r2, "outline" in e2 && ((_b = e2.outline) == null ? void 0 : _b.color) && null != (o == null ? void 0 : o.add) && (e2.outline.color = k2(e2.outline.color, o.add)), "marker" in e2 && null != e2.marker && (e2.marker.color = l(e2.marker.color));
  });
}
function g(e2, t, r) {
  var _a;
  t = t ?? e2.color, null != (r == null ? void 0 : r.override) && t && (t.a = r.override), t && (e2.color = k2(t, r == null ? void 0 : r.add)), "outline" in e2 && ((_a = e2.outline) == null ? void 0 : _a.color) && (e2.outline.color = k2(e2.outline.color, r == null ? void 0 : r.add));
}
function L(t, r, o) {
...
async function C(e2) {
  const { computeObjectLayerResourceSize: t } = await import("./symbolLayerUtils-5VAG2KB7.js"), r = await t(e2, 10), { width: o, height: n, depth: l } = e2, i2 = [o, l, n];
  let c = 1;
  for (let s = 0; s < 3; s++) {
    const e3 = i2[s];
    if (null != e3) {
...
//# sourceMappingURL=chunk-JSL7RVU3.js.map
