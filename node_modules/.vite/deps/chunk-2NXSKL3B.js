...
function o(r2, o2, i2, c2 = e) {
  const u = new IANAZone(O(c2)), a = DateTime.fromJSDate(r2, { zone: u }), l = "decades" === i2 || "centuries" === i2 ? "year" : T(i2);
...
function c(r2, o2, i2 = e) {
  const c2 = new IANAZone(O(i2)), u = DateTime.fromJSDate(r2, { zone: c2 });
...
//# sourceMappingURL=chunk-2NXSKL3B.js.map
