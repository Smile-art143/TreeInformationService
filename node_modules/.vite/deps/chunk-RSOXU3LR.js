...
function i2(t) {
  ...
  if (r3 == null ? void 0 : r3[1]) return { integer: r3[1].split("").length, fractional: r3[3] ? r3[3].split("").length : 0 };
...
function p(t) {
  ...
  return "number" === (n2 == null ? void 0 : n2.type) || !!e2 && null == e2.dateFormat && (null != e2.places || null != e2.digitSeparator);
}
function d(t, e2) {
  if (null == t) return t;
  const { fieldType: n2, format: i3, fieldFormat: l3, timeZoneOptions: u3 } = e2 || {};
  if (F(n2)) return x(t, { fieldType: n2, format: i3 == null ? void 0 : i3.dateFormat, fieldFormat: "date-time" === (l3 == null ? void 0 : l3.type) ? l3 : void 0, timeZoneOptions: u3 });
  if ("string" == typeof t && p(e2)) {
    const e3 = Number(t);
    isNaN(e3) || (t = e3);
  }
  if ("string" == typeof t) return t;
  const f2 = "number" === (l3 == null ? void 0 : l3.type) ? s(l3) : i3 ? l(i3) : void 0;
...
async function g(t) {
  ...
  const o2 = null != n2 && null != i3 ? n2 + (i3 - n2) / 2 : 0, { getColor: r3 } = await import("./visualVariableUtils-5UBGXJBC.js");
...
function y(t, e2) {
  var _a, _b;
  if (!e2) return null;
  if ("featureReduction" in t) switch ((_a = t.featureReduction) == null ? void 0 : _a.type) {
    case "cluster":
    case "binning": {
  ...
  return "getField" in t ? (_b = t.getField) == null ? void 0 : _b.call(t, e2) : null;
}
function I2(t, e2) {
  var _a;
  const n2 = "popupTemplate" in t ? (_a = t.popupTemplate) == null ? void 0 : _a.fieldInfos : null;
  if ((n2 == null ? void 0 : n2.length) && e2) return n2.find((t2) => {
    var _a2;
    return ((_a2 = t2.fieldName) == null ? void 0 : _a2.toLowerCase()) === e2.toLowerCase();
  });
}
function U(e2) {
  var _a, _b, _c, _d;
  let n2 = 0, i3 = 0;
  return e2.stops ? (n2 = ((_b = (_a = e2.stops) == null ? void 0 : _a.at(0)) == null ? void 0 : _b.value) ?? n2, i3 = ((_d = (_c = e2.stops) == null ? void 0 : _c.at(-1)) == null ? void 0 : _d.value) ?? i3) : "minDataValue" in e2 && "maxDataValue" in e2 && (n2 = e2.minDataValue ?? n2, i3 = e2.maxDataValue ?? i3), i3 - n2 > 2 * r.days ? "short-date" : "short-date-short-time";
}
function F(t) {
...
function V(t, n2, o2) {
  ...
  return r3 ? (F(r3.fieldType) && (h(t) ? r3.fieldFormat ?? (r3.fieldFormat = new i({ dateStyle: "short", timeStyle: "short-date-short-time" === U(n2) ? "short" : null })) : r3.format ?? (r3.format = new m2({ dateFormat: U(n2) }))), r3) : null;
}
function j(t, e2, n2) {
  var _a, _b;
  const i3 = y(t, e2), o2 = i3 == null ? void 0 : i3.name;
  if (!o2) return null;
  const r3 = i3 == null ? void 0 : i3.type, l3 = h(t);
  return { fieldType: r3, format: l3 ? null : (_a = I2(t, o2)) == null ? void 0 : _a.format, fieldFormat: l3 ? (_b = t.getFieldConfiguration(o2)) == null ? void 0 : _b.fieldFormat : null, timeZoneOptions: F(r3) ? { layerTimeZone: "preferredTimeZone" in t ? t.preferredTimeZone : null, viewTimeZone: n2, datesInUnknownTimezone: "datesInUnknownTimezone" in t && t.datesInUnknownTimezone } : null };
}
function C(t, e2) {
  var _a, _b;
  if ("authoringInfo" in t) return (_b = (_a = t.authoringInfo) == null ? void 0 : _a.visualVariables) == null ? void 0 : _b.find(({ theme: t2 }) => t2 === e2);
}
function b(t, e2) {
  let n2 = null != t ? t : "";
...
//# sourceMappingURL=chunk-RSOXU3LR.js.map
