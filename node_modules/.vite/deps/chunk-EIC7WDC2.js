...
async function r(r2, n3, t, s4, a2, i4, l) {
  ...
  if (!n3) return null;
  const p3 = n3 == null ? void 0 : n3.split("/").pop(), c = `${r2}/nodes/`, u3 = c + p3;
  try {
...
var _ = (_2) => {
  ...
  let E = class extends A {
    ...
    readFullExtent(e, t, r2) {
      ...
      return null == i4 || null == (o3 == null ? void 0 : o3.extent) || !Array.isArray(o3.extent) || o3.extent.some((e2) => e2 < R) ? null : new z({ xmin: o3.extent[0], ymin: o3.extent[1], xmax: o3.extent[2], ymax: o3.extent[3], spatialReference: i4 });
    }
    ...
    readTitleService(e, t) {
      var _a;
      const r2 = (_a = this.portalItem) == null ? void 0 : _a.title;
    ...
    async _fetchIndexAndUpdateExtent(e, t) {
      var _a;
      this.indexInfo = r(((_a = this.parsedUrl) == null ? void 0 : _a.path) ?? "", this.rootNode, e, this.customParameters, this.apiKey, i.getLogger(this), t);
      const { fullExtent: r2 } = this;
      null == r2 || r2.hasZ || this._updateExtent(r2, await this.indexInfo);
    }
    _updateExtent(e, t) {
      var _a, _b, _c;
      if ("page" === (t == null ? void 0 : t.type)) {
        const r2 = t.rootIndex % t.pageSize, o3 = (_b = (_a = t.rootPage) == null ? void 0 : _a.nodes) == null ? void 0 : _b[r2];
        O(e, o3 == null ? void 0 : o3.obb);
      } else if ("node" === (t == null ? void 0 : t.type)) {
        const r2 = (_c = t.rootNode) == null ? void 0 : _c.mbs;
    ...
    async _fetchServiceLayer(e) {
      var _a;
      const r2 = await H(((_a = this.parsedUrl) == null ? void 0 : _a.path) ?? "", { query: { f: "json", ...this.customParameters, token: this.apiKey }, responseType: "json", signal: e });
    ...
    async _fetchVoxelServiceLayer(e) {
      var _a;
      const r2 = (await H(((_a = this.parsedUrl) == null ? void 0 : _a.path) + "/layer", { query: { f: "json", ...this.customParameters, token: this.apiKey }, responseType: "json", signal: e })).data;
    ...
    async _saveAs(e, t) {
      ...
      return await Promise.all(a2.resources.pendingOperations ?? []), await this._validateAgainstJSONSchema(n3, a2, o3), this.url && (i4.url = this.url), i4.title || (i4.title = this.title), T(i4, o3, 1), await s4.signIn(), await s4.user.addItem({ item: i4, folder: o3 == null ? void 0 : o3.folder, data: n3 }), await p2(this.resourceReferences, a2), this.portalItem = i4, i3(a2), a2.portalItem = i4, i4;
    }
    async _save(e) {
      const t = { ...P, ...e };
    ...
    async _validateAgainstJSONSchema(e, t, i4) {
      const s4 = i4 == null ? void 0 : i4.validationOptions;
      s3(t, { errorName: "sceneservice:save" }, { ignoreUnsupported: s4 == null ? void 0 : s4.ignoreUnsupported, supplementalUnsupportedErrors: ["scenemodification:unsupported"] });
      const a2 = s4 == null ? void 0 : s4.enabled, n3 = u2();
      if (a2 && n3) {
...
function O(e, t) {
  if (null == (t == null ? void 0 : t.center) || null == t.halfSize) throw new s("sceneservice:invalid-node-page", "Invalid node page.");
...
//# sourceMappingURL=chunk-EIC7WDC2.js.map
