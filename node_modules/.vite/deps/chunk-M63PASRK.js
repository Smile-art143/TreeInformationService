...
var v = j = class extends s3 {
  ...
  readRenderer(e2, r4, o4) {
    var _a2;
    const t = (_a2 = r4.drawingInfo) == null ? void 0 : _a2.renderer;
...
function w(e2) {
  var _a2;
  return "simple" === e2.type && !((_a2 = e2.visualVariables) == null ? void 0 : _a2.length);
}
var I = S = class extends n {
  ...
  readRenderer(e2, r4, t) {
    var _a2, _b;
    const o4 = (_a2 = r4.drawingInfo) == null ? void 0 : _a2.renderer;
    return ((_b = o4 == null ? void 0 : o4.authoringInfo) == null ? void 0 : _b.isAutoGenerated) ? null : o4 ? w(o4) ? null : o3(o4, r4, t) ?? void 0 : te(r4, t);
  }
  readSymbol(e2, r4, t) {
    var _a2, _b;
    const o4 = (_a2 = r4.drawingInfo) == null ? void 0 : _a2.renderer;
    if ((_b = o4 == null ? void 0 : o4.authoringInfo) == null ? void 0 : _b.isAutoGenerated) return null;
    if (o4 && w(o4)) {
      const e3 = o3(o4, r4, t);
  ...
  writeSymbol(e2, r4, t, o4) {
    var _a2, _b;
    const s4 = (_b = (_a2 = this.renderer) == null ? void 0 : _a2.authoringInfo) == null ? void 0 : _b.isAutoGenerated;
    if (!this.renderer || s4) {
...
var f2 = (f3) => {
  ...
  let m4 = class extends p7 {
    ...
    _normalizeFeatureReduction(e2) {
      ...
      const r4 = e2.clone(), t = [new n3({ name: "cluster_count", alias: "cluster_count", isAutoGenerated: true, statisticType: "count" })], i2 = (r4.fields ?? []).filter((e3) => !e3.isAutoGenerated), s4 = e2.renderer && !((_a2 = e2.renderer.authoringInfo) == null ? void 0 : _a2.isAutoGenerated), { clusterMinSize: a6, clusterMaxSize: n5 } = r4;
      if (s4) {
        r4.fields = [...t, ...i2];
...
//# sourceMappingURL=chunk-M63PASRK.js.map
