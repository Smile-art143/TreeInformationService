...
var L = class extends b {
  ...
  initialize() {
    this._debugLevel > 2 && (i.getLogger(this).level = "info"), this._debugLog(0, 3, "Lyr3DWasmPerSceneView.initialize()"), this.addHandles([l(() => {
      var _a;
  ...
  destroy() {
    ...
    e2 && e2.destroyWasm().then(() => {
      var _a2;
      (_a2 = this._workerHandle) == null ? void 0 : _a2.destroy(), this._workerHandle = null;
  ...
  initializeWasm(e2, t2) {
    return this._lyr3DMain ? Promise.resolve() : this.view.renderSpatialReference ? (this._debugLog(0, 3, "Lyr3DWasmPerSceneView.initializeWasm()"), this._lyr3DMainPromise || (this._lyr3DMainPromise = n().then((i2) => {
      ...
      this._viewSR = (_a = this.view.renderSpatialReference) == null ? void 0 : _a.toJSON();
      ...
      else if ((_b = this.view.renderSpatialReference) == null ? void 0 : _b.isWebMercator) this._viewSR.wkid = this._viewSR.latestWkid = w, this._viewSR.vcsWkid = this._viewSR.latestVcsWkid = f;
      else if (((_c = this.view.renderSpatialReference) == null ? void 0 : _c.wkid) === b2) this._viewSR.wkid = this._viewSR.latestWkid = p, this._viewSR.vcsWkid = this._viewSR.latestVcsWkid = f;
      else if (!this._viewSR.latestVcsWkid && !this._viewSR.vcsWkid) {
        const e3 = (_d = this.view.heightModelInfo) == null ? void 0 : _d.heightModel, t3 = !e3 || "gravity-related-height" === e3;
  ...
  _getInitialPromise(e2, t2, i2, s, a2, n2, o4) {
    ...
    return Promise.all(l2).then((e3) => (a2.inputs = e3, this._workerHandle.invoke(a2, n2))).then((e3) => e3).catch((t3) => {
      var _a;
      let i3 = 1;
      return d(t3) ? this._debugLog(1, 2, `job ${e2.jobId} was cancelled.`) : o4 && 400 === ((_a = t3.details) == null ? void 0 : _a.httpStatus) ? (i3 = 3, this._debugLog(1, 2, "Session expired, trying to create new Session.")) : this._debugLog(1, 1, `job ${e2.jobId} failed with error ${t3}.`), { status: i3, error: "", jobDescJson: "", data: new Uint8Array(0), missingInputUrls: [], inputs: [] };
    });
  }
  async _onNewJob() {
  ...
  _makeSRWasmSerializable(e2) {
    return { wkid: (e2 == null ? void 0 : e2.wkid) ?? -1, latestWkid: (e2 == null ? void 0 : e2.latestWkid) ?? -1, vcsWkid: (e2 == null ? void 0 : e2.vcsWkid) ?? -1, latestVcsWkid: (e2 == null ? void 0 : e2.latestVcsWkid) ?? -1, wkt: (e2 == null ? void 0 : e2.wkt) ?? "" };
  }
  _cleanUpSR(e2) {
    return -1 === (e2 == null ? void 0 : e2.wkid) && e2.latestWkid && -1 !== e2.latestWkid ? e2.wkid = e2.latestWkid : -1 === (e2 == null ? void 0 : e2.latestWkid) && e2.wkid && -1 !== e2.wkid && (e2.latestWkid = e2.wkid), -1 === (e2 == null ? void 0 : e2.vcsWkid) && e2.latestVcsWkid && -1 !== e2.latestVcsWkid ? e2.vcsWkid = e2.latestVcsWkid : -1 === (e2 == null ? void 0 : e2.latestVcsWkid) && e2.vcsWkid && -1 !== e2.vcsWkid && (e2.latestVcsWkid = e2.vcsWkid), e2;
  }
};
...
//# sourceMappingURL=Lyr3DWasmPerSceneView-YQLOWR2V.js.map
