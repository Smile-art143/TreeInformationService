...
var a4 = class extends b {
  ...
  _applyTimeTransition(t2) {
    ...
    for (let s2 = 0; s2 < this._current.length; s2++) {
      ...
      for (let s3 = 0; s3 < t3.effects.length; s3++) {
        const n2 = t3.effects[s3], c = r3.effects[s3], o = i2.effects[s3];
        n2.interpolate(c, o, e4);
      }
    }
  ...
  _updateForScale(t2) {
    ...
    if (1 === e4.length || t2 >= e4[0].scale) i2 = r3 = e4[0].effects;
      ...
      const s3 = e4[c], o = e4[c + 1];
      if (s3.scale >= t2 && o.scale <= t2) {
        n2 = (t2 - s3.scale) / (o.scale - s3.scale), r3 = s3.effects, i2 = o.effects;
        break;
      }
    }
...
function _(t2, e4, s2) {
  const r3 = t2.length > e4.length ? t2 : e4, i2 = t2.length > e4.length ? e4 : t2, n2 = i2[i2.length - 1], c = (n2 == null ? void 0 : n2.scale) ?? s2, o = (n2 == null ? void 0 : n2.effects) ?? [];
  for (let f = i2.length; f < r3.length; f++) i2.push({ scale: c, effects: [...o] });
...
__decorate([m()], a4.prototype, "_to", void 0), __decorate([m()], a4.prototype, "duration", void 0), __decorate([m({ value: "" })], a4.prototype, "effect", null), __decorate([m({ readOnly: true })], a4.prototype, "effects", void 0), __decorate([m({ readOnly: true })], a4.prototype, "final", null), __decorate([m({ readOnly: true })], a4.prototype, "hasEffects", null), __decorate([m({ value: 0 })], a4.prototype, "scale", null), __decorate([m({ readOnly: true })], a4.prototype, "transitioning", null), a4 = __decorate([a3("esri.layers.effects.EffectView")], a4);
  ...
  transitionStep(t2, e4) {
    ...
    if (0 === s2) this.computedOpacity = this.opacity, this.computedVisible = this.visible;
      ...
      if (i3 === e5) this.computedVisible = this.visible;
        ...
        const o = t2 * s2;
        this.computedOpacity = i3 > e5 ? Math.max(e5, i3 - o) : Math.min(e5, i3 + o), this.computedVisible = this.computedOpacity > 0;
      }
    }
...
__decorate([m()], r2.prototype, "computedOpacity", void 0), __decorate([m()], r2.prototype, "computedVisible", void 0), __decorate([m()], r2.prototype, "opacity", void 0), __decorate([m()], r2.prototype, "visible", void 0), __decorate([m()], r2.prototype, "transitioning", null), __decorate([m()], r2.prototype, "_fadeOutResolver", void 0), __decorate([m()], r2.prototype, "_fadeInResolver", void 0), r2 = __decorate([a3("esri.views.2d.engine.transitions.FadeTransition")], r2);

// node_modules/@arcgis/core/views/2d/engine/DisplayObject.js
var e3 = class extends r {
  constructor() {
  ...
  set stage(t2) {
    ...
    this._stage = t2, t2 ? ((_a = this._stage) == null ? void 0 : _a.untrashDisplayObject(this)) || (this.onAttach(), this.emit("attach")) : i2 == null ? void 0 : i2.trashDisplayObject(this);
  }
  get transforms() {
  ...
  removeTransitionable(i2) {
    i2.endTransition(), this._transitionables && L(this._transitionables, i2), this.requestRender();
  }
  fadeIn() {
...
var n = class extends e3 {
  ...
  get usedMemory() {
    return this.children.reduce((e4, t2) => e4 + t2.usedMemory, 0);
  }
  doRender(e4) {
    var _a;
...
//# sourceMappingURL=chunk-SUTTEBNR.js.map
