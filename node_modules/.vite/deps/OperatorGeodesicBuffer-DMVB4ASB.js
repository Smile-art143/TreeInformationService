...
function me(e, t2, s2, n2, a2, h2) {
  n2 < Number.MAX_VALUE && n2 > -Number.MAX_VALUE || P("Geodesic_bufferer.buffer - bad distance"), j(e);
  const c = i(e), u = c.getGeometryType();
  if (y(u)) {
    const e2 = c.getPointCount(), i2 = 8e6;
    if (Math.abs(n2) > i2 && (e2 > 50 || u !== a.enumMultiPoint && 4 === s2 && e2 > 2)) {
      let e3 = c;
      const r = n2 > 0 ? 1 : -1, o = 7e6;
      let m2 = n2, u2 = 1;
      do {
        u2++, m2 = (Math.abs(m2) - o) * r;
      } while (Math.abs(m2) > i2);
      m2 = n2;
      for (let n3 = 0; n3 < u2 - 1; n3++) e3 = he(e3, t2, s2, o * r, a2, u2, h2), m2 = (Math.abs(m2) - o) * r;
      return e3 = he(e3, t2, s2, m2, a2, u2, h2), e3;
    }
  }
  return he(c, t2, s2, n2, a2, 1, h2);
}
var ae = class {
  constructor(e) {
  ...
  bufferPolygon(e) {
    const t2 = new ur(), s2 = new we(this, e, t2);
      ...
      if (d = s2.getGnomonic(), d !== n2) {
        if (null !== n2) {
          ...
          if (r = null, o = null, null != t3) {
            const s3 = Bt(i2, t3, true), r2 = Ft(s3);
            t3 = n2.unproject(t3, r2, this.m_progressTracker), this.putInGridCursors(e, t3, i2, true, m2, a2, h2, c, u);
          }
        }
        null !== d && (r = new Ag(), o = new al().executeMany(r, i2, this.m_progressTracker, 2)), n2 = d;
      }
      if (s2.isRunningInGnomonic()) {
        if (d.project(l2), s2.needsSimplify()) {
    ...
    if (p) {
      ...
      if (e) {
        ...
        if (s2.m_densified = null, null !== n3) {
          const s3 = new x();
          s3.scale(1 / this.m_rpu, 1 / this.m_rpu), n3.applyTransformation(s3), this.m_distance > 0 ? this.putInGridCursors(e, n3, i2, false, m2, a2, h2, c, u) : (this.processInGrid(e, n3, false, m2, a2, h2, l3), t3 = true);
        }
      }
      ...
      if (null !== o) {
        let t4 = o.next();
        r = null, o = null;
        const s3 = Bt(i2, t4, true), l4 = Ft(s3);
        t4 = n2.unproject(t4, l4, this.m_progressTracker), this.putInGridCursors(e, t4, i2, true, m2, a2, h2, c, u);
      }
      for (let e2 = 0; e2 < 6; e2++) if (null != u[e2]) {
        let s3 = u[e2].next();
        u[e2] = null, c[e2] = null, t3 && null !== l3[e2] && (s3 = new Km().execute(l3[e2], s3, i2, this.m_progressTracker));
        const n3 = Bt(i2, s3, true), r2 = Ft(n3);
        s3 = h2[e2].unproject(s3, r2, this.m_progressTracker), s3 = new Eh().execute(s3, this.m_gcs, true, this.m_progressTracker), _.tick(ye(s3)), d2.tock();
      }
      g = d2.next();
    } else {
      let t3, m3 = false;
      if (e) {
        ...
        if (s2.m_densified = null, null !== e2) {
          ...
          const n3 = Bt(null, e2, true);
          e2 = Ma(e2, n3, false, true, -1, this.m_progressTracker, 0, false), this.m_distance > 0 ? (r.tick(ye(e2)), o.tock()) : (t3 = e2, m3 = true);
        }
      }
      let a3 = o.next();
  ...
  putInGridCursors(e, t2, s2, n2, i2, r, o, m2, a2) {
    const h2 = [null, null, null, null, null, null];
    this.processInGrid(e, t2, n2, i2, r, o, h2);
    for (let c = 0; c < 6; c++) null !== h2[c] && (null === m2[c] && (m2[c] = new Ag(), a2[c] = new al().executeMany(m2[c], s2, this.m_progressTracker, 2)), m2[c].tick(ye(h2[c])), a2[c].tock());
  }
  processInGrid(e, t2, s2, n2, i2, r, o) {
    ...
    for (let h2 = 0; h2 < 6; h2++) {
      ...
      if (null !== l2 && !l2.isEmpty()) {
        ...
        l2 = Ma(l2, e3, s2, true, -1, this.m_progressTracker, 0, false), o[h2] = l2;
      }
    }
  }
  insertGeodeticPointsAlongGrid(e, t2, s2) {
    const n2 = n.construct(t2[3].xmin, t2[3].ymin, t2[2].xmax, t2[2].ymax), i2 = cm(this.m_gcs, n2, e, true, this.m_progressTracker), r = new Pr(), o = r.addGeometry(i2);
    return kl(r, o, this.m_gcs, 0, 2, true, t2[0].xmax + s2), kl(r, o, this.m_gcs, 0, 2, true, t2[1].xmax + s2), kl(r, o, this.m_gcs, 0, 2, false, t2[1].ymin + s2), 0 !== s2 && (kl(r, o, this.m_gcs, 0, 2, true, t2[0].xmax - s2), kl(r, o, this.m_gcs, 0, 2, true, t2[1].xmax - s2), kl(r, o, this.m_gcs, 0, 2, false, t2[1].ymin - s2)), r.getGeometry(o);
  }
  initializeGrid(e, t2) {
  ...
  checkAndPrepSegmentForCrossingAzimuthsOrPoleWrap(e, t2, s2, n2, i2, r) {
    ...
    const l2 = s2 - Wt, _ = n2 + Wt, f3 = l2 - Math.PI, d = l2 + Math.PI, g = _ + Math.PI, P2 = [Number.NaN], x2 = [Number.NaN], y2 = [Number.NaN], b2 = [Number.NaN];
    let w = false;
    if (le(this.m_a, this.m_eSquared, this.m_rpu, this.m_absDistance, o, l2, f3, m2, _, P2, x2), le(this.m_a, this.m_eSquared, this.m_rpu, this.m_absDistance, m2, g, _, o, f3, y2, b2), (_ < P2[0] && P2[0] < g || _ < x2[0] && x2[0] < g) && (w = true), w || (f3 < y2[0] && y2[0] < l2 || f3 < b2[0] && b2[0] < l2) && (w = true), !w && i2) return false;
    const C = [];
    for (let p = e.length - 1; p >= 0; p--) C.push(e[p]);
    r.setEmpty(), r.addPathPoint2D(null, 0, true);
    let v2 = 0;
    v2 = ce(this.m_a, this.m_eSquared, this.m_rpu, this.m_absDistance, this.m_curveType, e, l2, _, i2, v2, r), v2 = ue(this.m_a, this.m_eSquared, this.m_rpu, this.m_absDistance, m2, _, g, this.m_cornerStep, i2, v2, r, P2[0], x2[0]), v2 = ce(this.m_a, this.m_eSquared, this.m_rpu, this.m_absDistance, this.m_curveType, C, g, d, i2, v2, r), v2 = ue(this.m_a, this.m_eSquared, this.m_rpu, this.m_absDistance, o, f3, l2, this.m_cornerStep, i2, v2, r, y2[0], b2[0]);
    let S = false;
  ...
  prepPoleTouch(e) {
    ...
    do {
      const n3 = e.getXY(o), r2 = Pc(n3.y, this.m_gcs90), h2 = Pc(n3.y, -this.m_gcs90), c = s2 + (o + 1 - s2) % i2;
      if (r2 || h2) {
        let s3 = mi.construct(a2, n3.y);
        t2.insertPoint2D(0, -1, s3);
        const i3 = e.getXY(c), r3 = Pc(i3.y, this.m_gcs90), o2 = Pc(i3.y, -this.m_gcs90);
        r3 || o2 || (s3 = mi.construct(i3.x, n3.y), m2 ? t2.setXY(t2.getPointCount() - 1, s3) : t2.insertPoint2D(0, -1, s3)), m2 = true;
      } else t2.insertPoint2D(0, -1, n3), a2 = n3.x, m2 = false;
      o = c;
    } while (o !== r);
    e.setEmpty(), e.add(t2, false);
  }
  prepSinglePoleWrap(e) {
    const t2 = new ur(), s2 = new ur(), n2 = new x(), i2 = e.getXY(e.getPathStart(0)), r = e.getXY(e.getPathEnd(0) - 1), o = this.m_gcs360, m2 = this.m_gcs180, a2 = new n();
    a2.setCoords({ xmin: -this.m_gcs180, ymin: -this.m_gcs90, xmax: this.m_gcs180, ymax: this.m_gcs90 });
    const h2 = new n();
    e.queryEnvelope(h2);
    const c = Math.ceil(h2.width() / o);
    let u, l2;
    i2.x > r.x ? (u = -o, l2 = this.m_gcs90) : (u = o, l2 = -this.m_gcs90), n2.setShiftCoords(u, 0), t2.addPath(e, 0, true), s2.add(t2, false);
    const f3 = new ee();
    for (let _ = 0; _ < c; _++) s2.applyTransformation(n2), s2.getPointByVal(0, f3), t2.lineToPoint(f3), t2.addSegmentsFromPath(s2, 0, 0, s2.getSegmentCount() - 1, false);
    ...
    b2 - P2 > m2 ? y2 = -Math.ceil((b2 - P2 - m2) / o) : P2 - b2 > m2 && (y2 = Math.ceil((P2 - b2 - m2) / o)), 0 !== y2 && (n2.setShiftCoords(y2 * o, 0), t2.applyTransformation(n2));
  ...
  prepDoublePoleWrap(e) {
    ...
    if (a2 - i2 > s2 ? m2 = -Math.ceil((a2 - i2 - s2) / t2) : i2 - a2 > s2 && (m2 = Math.ceil((i2 - a2 - s2) / t2)), 0 !== m2) {
      const s3 = new x();
      s3.setShiftCoords(m2 * t2, 0), e.getImpl().applyTransformationToPath(s3, 0), e.queryPathEnvelope(0, r), a2 = r.getCenter().x;
    }
    const h2 = new n();
    n2.containsExclusiveEnvelope(r) ? (o = false, h2.setCoords({ env2D: n2 })) : (o = true, h2.setCoords({ env2D: n2 }), h2.xmin -= t2, h2.xmax += t2);
    ...
    if (u.setCoords(h2.xmin, h2.ymin), c.insertPoint2D(0, -1, u), u.setCoords(h2.xmin, h2.ymax), c.insertPoint2D(0, -1, u), u.setCoords(0.5 * (h2.xmin + h2.xmax), h2.ymax), c.insertPoint2D(0, -1, u), u.setCoords(h2.xmax, h2.ymax), c.insertPoint2D(0, -1, u), u.setCoords(h2.xmax, h2.ymin), c.insertPoint2D(0, -1, u), u.setCoords(0.5 * (h2.xmin + h2.xmax), h2.ymin), c.insertPoint2D(0, -1, u), o) {
      ...
      kl(r2, o2, this.m_gcs, 0, 2, true, n2.xmin), kl(r2, o2, this.m_gcs, 0, 2, true, n2.xmax), c = r2.getGeometry(o2);
      const m3 = Dt(c, n2);
  ...
  setMinCornerStep() {
    ...
    try {
      ...
      const i2 = 0;
      let r = 45 * this.m_rpu;
      const o = __addDisposableResource(e, new Ht(new Cc(), new Cc()), false), m2 = __addDisposableResource(e, new Ht(new Cc(), new Cc()), false), a2 = __addDisposableResource(e, new Ht(new Cc(), new Cc()), false), h2 = __addDisposableResource(e, new Ht(new Cc(), new Cc()), false), c = new mi(), u = new mi(), l2 = new mi(), _ = new mi();
      for (Dc.geodesicCoordinate(this.m_a, this.m_eSquared, n2.x, n2.y, s2, i2, o.at(0), o.at(1)), c.setCoords(o.at(0).val, o.at(1).val), Dc.geodesicCoordinate(this.m_a, this.m_eSquared, n2.x, n2.y, s2, r, m2.at(0), m2.at(1)), u.setCoords(m2.at(0).val, m2.at(1).val); ; ) {
        ...
        try {
          ...
          const o2 = __addDisposableResource(e2, new Cc(), false), f4 = __addDisposableResource(e2, new Cc(), false);
          ...
          r *= 0.9, Dc.geodesicCoordinate(this.m_a, this.m_eSquared, n2.x, n2.y, s2, r, m2.at(0), m2.at(1)), u.setCoords(m2.at(0).val, m2.at(1).val);
        } catch (t2) {
  ...
  setMinSegmentStep() {
    ...
    try {
      ...
      const o = __addDisposableResource(e, new Cc(), false), m2 = __addDisposableResource(e, new Cc(), false), a2 = __addDisposableResource(e, new Cc(), false);
      ...
      for (Dc.geodesicCoordinate(this.m_a, this.m_eSquared, i2.x, i2.y, n2, S, _.at(0), _.at(1)), p.setCoords(_.at(0).val, _.at(1).val), Dc.geodesicCoordinate(this.m_a, this.m_eSquared, r.x, r.y, n2, D, f3.at(0), f3.at(1)), P2.setCoords(f3.at(0).val, f3.at(1).val); ; ) {
        const e2 = { stack: [], error: void 0, hasError: false };
        try {
          const s2 = 0.5 * (b2 + w);
          ...
          Dc.geodesicCoordinate(this.m_a, this.m_eSquared, u.x, u.y, n2, o2, d.at(0), d.at(1)), x2.setCoords(d.at(0).val, d.at(1).val);
          const m3 = __addDisposableResource(e2, new Cc(), false), a3 = __addDisposableResource(e2, new Cc(), false);
          Dc.geodeticDistance(this.m_a, this.m_eSquared, p.x, p.y, P2.x, P2.y, m3, a3, null, 2), Dc.geodeticCoordinate(this.m_a, this.m_eSquared, p.x, p.y, 0.5 * m3.val, a3.val, g.at(0), g.at(1), 2), y2.setCoords(g.at(0).val, g.at(1).val);
...
function he(e, t2, s2, n2, i2, r, o) {
  ...
  w.m_radTolerance = S * w.m_rpu, 4 === s2 ? (w.m_curveType = 2, w.m_bShapePreserving = true) : (w.m_curveType = s2, w.m_bShapePreserving = false), w.m_distance = n2, w.m_absDistance = Math.abs(n2), Number.isNaN(i2) || i2 <= 0 ? w.setConvergenceOffset() : w.m_convergenceOffset = Math.max(i2, 1e-3), w.m_convergenceOffset /= r;
  ...
  if (f(I)) {
    ...
    const e2 = f3, t3 = new n();
    e2.queryEnvelope(t3);
    const s3 = Ft(At(w.m_sr, v2, true));
...
function ce(e, t2, s2, n2, i2, r, o, m2, a2, h2, c) {
...
function ue(e, t2, s2, n2, i2, r, o, m2, a2, h2, c, u = Number.NaN, l2 = Number.NaN) {
...
function le(e, t2, s2, n2, i2, r, o, m2, a2, h2, c) {
  const u = { stack: [], error: void 0, hasError: false };
  try {
    const s3 = new mi(), l2 = new mi(), _ = __addDisposableResource(u, new Ht(new Cc(), new Cc()), false);
    Dc.geodesicCoordinate(e, t2, i2.x, i2.y, n2, r, _.at(0), _.at(1)), s3.setCoords(_.at(0).val, _.at(1).val), Dc.geodesicCoordinate(e, t2, i2.x, i2.y, n2, o, _.at(0), _.at(1)), l2.setCoords(_.at(0).val, _.at(1).val);
    const f3 = __addDisposableResource(u, new Cc(), false);
    for (Dc.geodeticDistance(e, t2, m2.x, m2.y, s3.x, s3.y, null, f3, null, 0), h2[0] = f3.val, Dc.geodeticDistance(e, t2, m2.x, m2.y, l2.x, l2.y, null, f3, null, 0), c[0] = f3.val; h2[0] <= c[0]; ) h2[0] += Kt;
...
function fe(e, t2) {
  ...
  for (let m2 = 0; m2 < n2; m2++) {
    ...
    if (h(s2)) {
      const t3 = new n();
      e.queryPathEnvelope(m2, t3), n3.assign(t3.getCenter());
    } else n3.assign(e.getXY(m2));
    const o2 = t2.toGeohash(n3);
    r.push(o2);
  }
  ...
  for (let m2 = 0; m2 < n2; m2++) {
    const t3 = i2[m2];
    h(s2) ? o.addPath(e, t3, true) : o.addPoints(e, t3, t3 + 1);
  }
  return o;
}
function de(e, t2, s2, n2, i2, r) {
  ...
  try {
    ...
    const m2 = s2[0], a2 = s2.at(-1), h2 = __addDisposableResource(o, new Cc(), false), c = __addDisposableResource(o, new Cc(), false), u = __addDisposableResource(o, new Cc(), false);
    ...
    if (_ < r) return true;
    const f3 = __addDisposableResource(o, new Cc(), false);
...
function ge(e, t2, s2, n2, i2, r, o, m2) {
  let a2;
  if (n2.length % 2 == 0) {
  ...
  return !!de(e, t2, n2, i2, h2, c) && (null !== r && (r.setCoordsPoint2D(a2), r.scale(1 / s2)), null !== o && o.setCoordsPoint2D(h2), null !== m2 && (m2[0] = c), true);
}
function pe(e, t2, s2, n2, i2, r) {
  const o = { stack: [], error: void 0, hasError: false };
  try {
    if (n2 >= r) return false;
    const m2 = __addDisposableResource(o, new Cc(), false);
    Dc.greatEllipticDistance(e, t2, i2.x, i2.y, s2.x, s2.y, m2, null, null);
    return m2.val + n2 < r;
  } catch (m2) {
    o.error = m2, o.hasError = true;
  } finally {
...
function Pe(e, t2, s2, n2, i2, r, o, m2) {
  const a2 = um(e, t2, n2, 75 / 180 * Math.PI);
  return !!pe(e, t2, n2, i2, n2, a2) && (null !== r && (r.setCoordsPoint2D(n2), r.scale(1 / s2)), null !== o && o.setCoordsPoint2D(n2), null !== m2 && (m2[0] = a2), true);
}
function xe(e, t2) {
  return new _m(e, t2);
}
  ...
  next() {
    ...
    for (; this.m_segIter.hasNextSegment() && this.m_numWinds < s2; ) {
      ...
      if (i2.setCoordsPoint2D(e2.getStartXY()), r.setCoordsPoint2D(e2.getEndXY()), i2.scale(this.m_bufferer.m_rpu), r.scale(this.m_bufferer.m_rpu), Lh(i2, r)) i2.x = r.x;
        ...
        let e3 = -1, t3 = -1;
        const s4 = this.m_segIter.getPathIndex(), n3 = this.m_multiPath.getPathStart(s4), o = this.m_multiPath.getPathEnd(s4);
        if (e3 = this.m_segIter.getStartPointIndex() - 1, t3 = this.m_segIter.getEndPointIndex() + 1, e3 < n3 && (e3 = this.m_multiPath.isClosedPath(s4) ? o - 1 : -1), t3 > o - 1 && (t3 = this.m_multiPath.isClosedPath(s4) ? n3 : -1), -1 !== e3) {
      ...
      null != this.m_densified && this.m_densified.insertPointsFromPoints(this.m_densified.getPathCount() - 1, -1, this.m_densifiedPoints, 0, this.m_densifiedPoints.length - 1, true), null === t2 && (t2 = new ur(), t2.addPathPoint2D(null, 0, true)), this.addJoinAndBufferLeftSide(t2), n2++;
    }
...
var Ce = class extends be {
  ...
  next() {
    ...
    const t2 = new ur(), s2 = this.m_bufferer.bufferPoint2D(e, this.m_bRunningInGnomonic, t2);
...
var ve = class {
  ...
  executeMany(e, t2, s2, n2, i2, r, o, m2) {
    if (o) {
      const o2 = new Se(e, t2, s2, n2, i2, false, r, m2);
      return new al().executeMany(o2, t2, m2);
    }
    return new Se(e, t2, s2, n2, i2, false, r, m2);
  }
  execute(t2, n2, i2, r, o, m2, a2) {
    const h2 = new s([t2]), c = [r], u = this.executeMany(h2, n2, i2, c, o, false, m2, a2).next();
    return u || b("geodesic buffer null output"), u;
  }
};
var Se = class extends t {
  constructor(e, t2, s2, r, o, m2, a2, h2) {
    super(), this.m_currentUnionEnvelope2D = new n(), this.m_index = -1, this.m_dindex = -1, this.m_progressTracker = h2, m2 && z(""), t2 || P("");
    0 === t2.getCoordinateSystemType() && P(""), this.m_inputGeoms = e, this.m_spatialReference = t2, this.m_curveType = s2, this.m_distances = r, this.m_convergenceOffset = o, this.m_bOutlineOnly = m2, this.m_bUnion = a2;
  }
  next() {
    let e;
...
//# sourceMappingURL=OperatorGeodesicBuffer-DMVB4ASB.js.map
