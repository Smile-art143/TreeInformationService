import {
  m
} from "./chunk-F76KXBPJ.js";
import {
  u
} from "./chunk-J4TMMI7B.js";
import {
  C,
  R,
  x
...
var d = class extends t {
  ...
  labelPointPolygon(e) {
    ...
    const x3 = new mi();
    if (Math.abs(h) <= 2 * n4 * n4 ? x3.setNAN() : x3.assign(u(o, u3)), Number.isNaN(x3.x)) {
      const e2 = new n2();
    ...
    const S = [0, 1, 2, 3], X = _2 ? 0 : 1;
    for (let s2 = X; s2 < 4; s2++) for (let e2 = X; e2 < 3; e2++) {
    ...
    return n(!w2[j2].isNAN()), new ee({ x: w2[j2].x, y: w2[j2].y });
  }
...
//# sourceMappingURL=chunk-AYWXHIKZ.js.map
