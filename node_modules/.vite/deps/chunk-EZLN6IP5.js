...
function f(e, t = 1e4) {
  ...
  for (let i2 = 0; i2 < e.length; i2++) {
    const t2 = e[i2], n4 = (t2 == null ? void 0 : t2.text) ? JSON.parse(t2.text) : null;
    "EsriVideoServer" === (n4 == null ? void 0 : n4.source) && (r2 = [...n4.data]);
  }
  const o2 = r2.find((e2) => e2.tagId === t);
  return Array.isArray(o2 == null ? void 0 : o2.value) && (n3 = [...o2.value]), n3;
}
function g(e) {
...
function C(e) {
  if (!(e == null ? void 0 : e.size)) return new m2();
  const t = b(e), r2 = P2(e), o2 = O(e), i2 = A(t, r2);
  return new m2({ frameCenter: r2, frameOutline: o2, lineOfSight: i2, sensorLocation: t });
}
function L2(e) {
  var _a;
  if (!(e == null ? void 0 : e.size)) return null;
  return ((_a = e.get(d.EsriGroundControlPoints)) == null ? void 0 : _a.value) ?? null ?? null;
}
function c(e) {
  var _a;
  return (e == null ? void 0 : e.size) ? ((_a = e.get(d.EsriHorizonPixelPack)) == null ? void 0 : _a.value) ?? null : null;
}
function P2(e) {
  return S(e) ?? y2(e);
}
...
function p2(e) {
  const t = e == null ? void 0 : e.layers;
  return (t == null ? void 0 : t.length) ? t.map((e2) => ({ layerId: e2.id, posterUrl: e2.poster, sourceType: e2.serviceType, title: e2.name, type: e2.type || "Video Layer" })) : [];
}
function v(e, t, r2) {
  var _a;
  if (!e) return null;
  ...
  switch (n3.type) {
    ...
    case "simple-line":
      ...
      break;
    case "simple-marker":
      L(n3, t), ((_a = n3 == null ? void 0 : n3.outline) == null ? void 0 : _a.color) && (n3.outline.color = t);
      break;
    case "cim":
      k(n3, t);
  }
...
function S(t) {
  var _a, _b;
  return t && t.has(d.EsriFrameCenterLatitude) && t.has(d.EsriFrameCenterLongitude) ? new _({ x: t.get(d.EsriFrameCenterLongitude).value, y: t.get(d.EsriFrameCenterLatitude).value, z: ((_a = t.get(d.FrameCenterAboveEllipsoid)) == null ? void 0 : _a.value) ?? ((_b = t.get(d.FrameCenterElevation)) == null ? void 0 : _b.value) }) : null;
}
function y2(t) {
  var _a, _b, _c;
  return t && t.has(d.FrameCenterLatitude) && t.has(d.FrameCenterLongitude) ? new _({ x: (_a = t.get(d.FrameCenterLongitude)) == null ? void 0 : _a.value, y: (_b = t.get(d.FrameCenterLatitude)) == null ? void 0 : _b.value, z: (_c = t.get(d.FrameCenterElevation)) == null ? void 0 : _c.value }) : null;
}
function O(e) {
  var _a;
  if (!e) return null;
  const r2 = (_a = e.get(d.EsriFrameOutline)) == null ? void 0 : _a.value;
...
function F(e) {
  ...
  const r2 = [(_a = e.get(d.EsriCornerLongitudePt1)) == null ? void 0 : _a.value, (_b = e.get(d.EsriCornerLatitudePt1)) == null ? void 0 : _b.value], n3 = [(_c = e.get(d.EsriCornerLongitudePt2)) == null ? void 0 : _c.value, (_d = e.get(d.EsriCornerLatitudePt2)) == null ? void 0 : _d.value], o2 = [(_e = e.get(d.EsriCornerLongitudePt3)) == null ? void 0 : _e.value, (_f = e.get(d.EsriCornerLatitudePt3)) == null ? void 0 : _f.value], i2 = [(_g = e.get(d.EsriCornerLongitudePt4)) == null ? void 0 : _g.value, (_h = e.get(d.EsriCornerLatitudePt4)) == null ? void 0 : _h.value];
...
function T(e) {
  ...
  const r2 = (_a = e.get(d.FrameCenterLatitude)) == null ? void 0 : _a.value, n3 = (_b = e.get(d.FrameCenterLongitude)) == null ? void 0 : _b.value, o2 = r2 + ((_c = e.get(d.OffsetCorner1Latitude)) == null ? void 0 : _c.value), i2 = n3 + ((_d = e.get(d.OffsetCorner1Longitude)) == null ? void 0 : _d.value), a3 = r2 + ((_e = e.get(d.OffsetCorner2Latitude)) == null ? void 0 : _e.value), u2 = n3 + ((_f = e.get(d.OffsetCorner2Longitude)) == null ? void 0 : _f.value), s2 = r2 + ((_g = e.get(d.OffsetCorner3Latitude)) == null ? void 0 : _g.value), l3 = n3 + ((_h = e.get(d.OffsetCorner3Longitude)) == null ? void 0 : _h.value), f2 = r2 + ((_i = e.get(d.OffsetCorner4Latitude)) == null ? void 0 : _i.value), g2 = n3 + ((_j = e.get(d.OffsetCorner4Longitude)) == null ? void 0 : _j.value);
...
function b(t) {
  var _a, _b, _c, _d;
  if (!(t == null ? void 0 : t.size)) return null;
  if (t.has(d.EsriSensorPosition)) {
    const r2 = (_a = t.get(d.EsriSensorPosition)) == null ? void 0 : _a.value;
    if (r2) return _.fromJSON(r2.geometry);
  }
  return t.has(d.SensorLongitude) && t.has(d.SensorLatitude) ? new _({ x: (_b = t.get(d.SensorLongitude)) == null ? void 0 : _b.value, y: (_c = t.get(d.SensorLatitude)) == null ? void 0 : _c.value, z: (_d = t.get(d.SensorTrueAltitude)) == null ? void 0 : _d.value }) : null;
}
...
//# sourceMappingURL=chunk-EZLN6IP5.js.map
