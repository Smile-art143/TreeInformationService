...
import {
  e as e6,
  e2 as e7
} from "./chunk-VY6NW6PV.js";
import {
  h as h7
} from "./chunk-YA5YFF26.js";
import "./chunk-BC5LEBBS.js";
import {
  i as i4
} from "./chunk-ZXPXYVXJ.js";
import {
  t as t5
} from "./chunk-YYFTSIGH.js";
import {
  r as r7
...
function T3(t19, n19, e17) {
  ...
  let r14 = P2(t19, n19);
  const a12 = o18 == null ? void 0 : o18.find((t20) => "CIMSymbolAnimationColor" === t20.type);
  return a12 && (r14 = Q(t19, a12, "ToColor")), { type: "AnimatedColor", color: z(r14), opacity: z(1), parent: e17 };
}
function k3(t19, n19, e17) {
  const { animations: o18 } = n19, i12 = o18 == null ? void 0 : o18.find((t20) => "CIMSymbolAnimationColor" === t20.type);
  return i12 ? { type: "AnimatedColor", color: z([1, 1, 1, 1]), opacity: { from: 0, to: 1, timing: D3(t19, i12 == null ? void 0 : i12.animatedSymbolProperties) }, parent: [1, 1, 1, 1] } : e17;
}
function v5(t19, n19, e17) {
  const { animations: o18 } = n19;
  let r14 = z(1);
  const a12 = o18 == null ? void 0 : o18.find((t20) => "CIMSymbolAnimationTransparency" === t20.type);
  if (a12) {
...
function O2(t19, n19, e17) {
  const { animations: o18 } = n19, i12 = o18 == null ? void 0 : o18.find((t20) => "CIMSymbolAnimationTransparency" === t20.type);
  return i12 ? { type: "AnimatedColor", color: z([1, 1, 1, 1]), opacity: { from: 0, to: 1, timing: D3(t19, i12 == null ? void 0 : i12.animatedSymbolProperties) }, parent: [1, 1, 1, 1] } : e17;
}
function x5(t19, n19, e17) {
  const { animations: o18 } = n19, a12 = o18 == null ? void 0 : o18.find((t20) => "CIMSymbolAnimationMoveAlongLine" === t20.type);
  if (!a12) return e17;
  let s13, m11;
...
function L4(t19, n19) {
  ...
  const r14 = e17 == null ? void 0 : e17.find((t20) => "CIMSymbolAnimationScale" === t20.type);
  if (!r14) {
    const n20 = e17 == null ? void 0 : e17.find((t20) => "CIMSymbolAnimationSize" === t20.type);
    if (!n20) return z(1);
...
function R4(t19, n19) {
  const { animations: e17 } = n19, o18 = e17 == null ? void 0 : e17.find((t20) => "CIMSymbolAnimationOffset" === t20.type);
  if (!o18) return z([0, 0]);
  return { from: [0, 0], to: [Q(t19, o18, "OffsetX"), Q(t19, o18, "OffsetY")], timing: D3(t19, o18.animatedSymbolProperties) };
}
function w2(t19, n19) {
  const { animations: e17 } = n19, o18 = h12(t19, n19), r14 = { type: "Process", op: "Divide", left: g2(t19, n19), right: { type: "Process", op: "Cond", condition: o18, ifTrue: -1, ifFalse: 1 } }, a12 = e17 == null ? void 0 : e17.find((t20) => "CIMSymbolAnimationRotation" === t20.type);
  if (!a12) return z(r14);
...
var Q2 = class {
  ...
  _analyzeSymbol(e17, t19) {
    switch (e17 == null ? void 0 : e17.type) {
      case "CIMPointSymbol":
      case "CIMLineSymbol":
  ...
  _analyzeMultiLayerSymbol(e17, t19) {
    const r14 = e17 == null ? void 0 : e17.symbolLayers;
    if (!r14) return;
    ...
    for (; c12--; ) {
      ...
      let n19;
      (i12 == null ? void 0 : i12.length) && (n19 = [...i12]);
      const m11 = l16.effects;
      (m11 == null ? void 0 : m11.length) && (i12 ? n19.push(...m11) : n19 = [...m11]);
      let y4 = null;
      if (n19) {
        y4 = [];
  ...
  _analyzeSolidFill(e17, t19, r14, i12) {
    ...
    if (!i12 && (t19 == null ? void 0 : t19.some((e18) => "CIMGeometricEffectTaperedPolygon" === e18.effect.type))) {
  ...
  _analyzeHatchFill(e17, t19) {
    ...
    if ((_a = e17.lineSymbol) == null ? void 0 : _a.symbolLayers) for (const p5 of e17.lineSymbol.symbolLayers) {
      if ("CIMSolidStroke" !== p5.type) continue;
      const e18 = p5.primitiveName ?? r14;
      l16 || !e18 || p5.colorLocked || null == ((_b = this._poMap[e18]) == null ? void 0 : _b.Color) && null == ((_c = this._poMap[e18]) == null ? void 0 : _c.StrokeColor) || (s13 = M3(p5.color), s13 = this._maybeGetValueOrOverrideExpression(e18, "StrokeColor") ?? this._getValueOrOverrideExpression(i12, e18, "Color", s13), l16 = true);
  ...
  _analyzePictureMarker(e17, t19, i12, o18, a12, l16, n19, p5, c12, m11, y4, d12, f12, h19) {
    ...
    const k5 = [...o18];
    let C4;
    e17.primitiveName && k5.push(e17.primitiveName), u15 || S2 ? C4 = { type: "animated", url: e17.url, urlHash: "H" + l(e17.url), playAnimation: (_a = e17.animatedSymbolProperties) == null ? void 0 : _a.playAnimation, reverseAnimation: (_b = e17.animatedSymbolProperties) == null ? void 0 : _b.reverseAnimation, randomizeStartTime: (_c = e17.animatedSymbolProperties) == null ? void 0 : _c.randomizeStartTime, randomizeStartSeed: (_d = e17.animatedSymbolProperties) == null ? void 0 : _d.randomizeStartSeed, startTimeOffset: (_e = e17.animatedSymbolProperties) == null ? void 0 : _e.startTimeOffset, duration: (_f = e17.animatedSymbolProperties) == null ? void 0 : _f.duration, repeatType: (_g = e17.animatedSymbolProperties) == null ? void 0 : _g.repeatType, repeatDelay: (_h = e17.animatedSymbolProperties) == null ? void 0 : _h.repeatDelay } : (C4 = a(e17), C4.markerPlacement = null);
  ...
  _analyzeTextGraphic(e17, r14, i12, o18, a12, s13, l16, n19) {
    ...
    let k5 = [0, 0, 0, 0];
    if ((_a = _5 == null ? void 0 : _5.symbolLayers) == null ? void 0 : _a.length) {
      const e18 = _5.symbolLayers;
      for (const t19 of e18) if (t19.color) {
        k5 = this._getValueOrOverrideExpression(((_b = m11 == null ? void 0 : m11.haloSymbol) == null ? void 0 : _b.type) ?? "CIMPolygonSymbol", t19.primitiveName, "Color", M3(t19.color));
        break;
      }
    }
    const C4 = i12.primitiveName;
    let b6 = [0, 0, 0, 1], x7 = [0, 0, 0, 0], z2 = 0, I4 = false;
    if ((_c = m11.symbol) == null ? void 0 : _c.symbolLayers) for (const t19 of m11.symbol.symbolLayers) {
  ...
  _analyzePrimitiveOverrides(e17, t19, r14, i12) {
    ...
    if (null != t19) {
      for (const o18 of t19) if ((o18 == null ? void 0 : o18.overrides.length) > 0) return true;
    }
    if (null != r14) {
      for (const o18 of r14) if ((o18 == null ? void 0 : o18.overrides.length) > 0) return true;
    }
    if (null != i12) {
      for (const o18 of i12) if ((o18 == null ? void 0 : o18.overrides.length) > 0) return true;
    }
    return false;
  }
...
function $2(e17) {
  if (e17 == null ? void 0 : e17.startsWith("Level_")) {
...
function re(e17) {
  ...
  if (!t19) return false;
  const r14 = t19.find((e18) => {
    var _a;
    return (_a = e18.effects) == null ? void 0 : _a.find((e19) => "CIMGeometricEffectDashes" === e19.type && null != e19.dashTemplate);
  }), i12 = t19.find((e18) => {
    var _a;
    return (_a = e18.effects) == null ? void 0 : _a.find((e19) => "CIMGeometricEffectAddControlPoints" === e19.type);
  });
  return !!r14 || !!i12;
}
function ie(e17) {
...
function oe(e17, t19) {
  var _a;
  if ((t19 == null ? void 0 : t19.some((e18) => "CIMGeometricEffectRadial" === e18.type)) && (t19 == null ? void 0 : t19.some((e18) => "CIMGeometricEffectTaperedPolygon" === e18.type)) && 2 === e17.length) {
    const t20 = e17.find((e18) => "CIMSolidFill" === e18.type), r14 = e17.find((e18) => "CIMSolidStroke" === e18.type), i12 = (_a = r14 == null ? void 0 : r14.effects) == null ? void 0 : _a.some((e18) => "CIMGeometricEffectDashes" === e18.type);
...
var l12 = class {
  ...
  _getMosaicItem(t19, e17, i12) {
    if (!t19[i12]) {
      ...
      if (!(h19 == null ? void 0 : h19.metrics)) return o11(i12);
...
var a10 = class {
  ...
  draw(i12, r14, n19) {
    ...
    return new Promise((i13, r15) => {
      ...
      const g5 = n19 == null ? void 0 : n19.signal;
      g5 && w(g5, () => r15(u2()));
    });
  }
  _initSVG() {
...
var c7 = class _c {
  ...
  getMosaicItemPosition(t19) {
    const i12 = this.getSpriteItem(t19), s13 = i12 == null ? void 0 : i12.rect;
    if (!s13) return null;
...
var n14 = class {
  ...
  delete(t19) {
    var _a;
    (_a = t19.parent) == null ? void 0 : _a.delete(t19.key);
  }
  get(t19) {
    let e17 = this._root;
...
var F5 = class {
  ...
  async _rasterizeSprite(e17, t19) {
    ...
    switch (e17.type) {
      case "CIMPictureMarker":
        return "CIMMarkerPlacementInsidePolygon" === ((_a = e17.markerPlacement) == null ? void 0 : _a.type) ? this._rasterizeJSONResource(i12, e17) : this._handleAsyncResource(i12, e17, t19);
      case "animated":
      case "CIMPictureFill":
      case "CIMPictureStroke":
      case "path":
...
var o14 = class extends s7 {
  ...
  _createOrResizeTexture(e17, t19, r14) {
    ...
    if (null !== this._backBufferTexture && ((_a = this._backBufferTexture.descriptor) == null ? void 0 : _a.width) === t19 && ((_b = this._backBufferTexture.descriptor) == null ? void 0 : _b.height) === r14) return this._backBufferTexture;
  ...
  render(e17) {
    ...
    if (r14.recordPassStart(this.name), a12) {
      ...
      for (const r15 of this.effects) {
        ...
        const a13 = r15.apply, n19 = (_a = r15.args) == null ? void 0 : _a.call(r15), i12 = t19.getViewport(), d12 = t19.getBoundFramebufferObject(), o18 = e17.passOptions;
...
var P3 = class {
  ...
  submitDraw(e17, t19, s13) {
    let r14 = s13 == null ? void 0 : s13.stencilRef;
  ...
  submitDrawMeshUntyped(e17, t19, s13, r14) {
    const i12 = r14 == null ? void 0 : r14.parts, n19 = r14 == null ? void 0 : r14.stencilRef, { shader: a12, uniforms: o18, defines: l16, optionalAttributes: h19 } = this.setShader(t19), f12 = this._programCache.getProgram(a12, {}, o18, l16 ?? {}, h19 ?? {});
...
var j4 = class extends n6 {
  ...
  destroy() {
    var _a, _b;
    super.destroy(), k2(this.context), this.removeAllChildren(), this._emptyTrash(), this._taskHandle = l2(this._taskHandle), this._lostWebGLContextHandle = l2(this._lostWebGLContextHandle), this._managedCanvas.destroy(), (_b = (_a = this._debugOutput) == null ? void 0 : _a.parentNode) == null ? void 0 : _b.removeChild(this._debugOutput), this._bufferPool.destroy(), this.painter.dispose(), this.context.dispose(), this._managedCanvas = null;
  }
  get textureManager() {
  ...
  async takeScreenshot(e17, t19, r14, s13) {
    ...
    const g5 = await p5;
    let b6;
    return 1 === e17.outputScale ? b6 = g5 : (b6 = new ImageData(Math.round(g5.width * e17.outputScale), Math.round(g5.height * e17.outputScale)), (await import("./screenshotUtils-E4TTRQ3O.js")).resampleHermite(g5, b6, true)), m11.dispose(), b6;
  }
  async _readbackScreenshot(e17, t19) {
    const r14 = (await import("./screenshotUtils-E4TTRQ3O.js")).createEmptyImageData(t19.width, t19.height, document.createElement("canvas"));
...
var c11 = class extends s7 {
  ...
  render(e17, t19) {
    ...
    (_a = m11.vertexBuffers.get("geometry")) == null ? void 0 : _a.setData(d12);
...
var m10 = class extends e8 {
  ...
  _update(e17) {
    const { state: r14 } = e17, a12 = this._controlPointsOwner, n19 = a12.groundControlPoints(), c12 = a12.getSize(), d12 = r14.size, h19 = n19 == null ? void 0 : n19.length;
    if (!h19) return;
    if (f2().then(() => {
...
async function s12(s13) {
  const r14 = import("./mask-svg-ZICTGFBP.js"), i12 = import("./overlay-svg-5NQTFNCD.js"), o18 = t5((await r14).default, { signal: s13 }), e17 = t5((await i12).default, { signal: s13 }), m11 = { mask: await o18, overlay: await e17 };
  return s3(s13), m11;
}
...
var P5 = class extends e8 {
  ...
  set grid(e17) {
    this._grid = e17, this._handles.removeAll(), this._handles.add([l3(() => e17 == null ? void 0 : e17.center, () => {
      this._projectedCenter = null;
    }, h2), l3(() => [e17 == null ? void 0 : e17.center, e17 == null ? void 0 : e17.dynamicScaling, e17 == null ? void 0 : e17.majorLineColor, e17 == null ? void 0 : e17.majorLineInterval, e17 == null ? void 0 : e17.minorLineColor, e17 == null ? void 0 : e17.rotateWithMap, e17 == null ? void 0 : e17.rotation, e17 == null ? void 0 : e17.spacing, e17 == null ? void 0 : e17.units], () => this.requestRender(), h2)]);
  }
  _createTransforms() {
    return { displayViewScreenMat3: e5() };
  }
...
//# sourceMappingURL=mapViewDeps-A5JOA2SA.js.map
