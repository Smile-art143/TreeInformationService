...
async function f2(e2, r) {
  try {
    return { data: (await p2(e2, r)).data, baseUrl: Rt(e2), styleUrl: e2 };
  } catch (s2) {
    return f(s2), null;
  }
}
function u(e2, r, t) {
  ...
  let s2;
  const l = `${o.url} - ${(_a = o.user) == null ? void 0 : _a.username} - ${e2}`, f3 = e.get(l);
  if (f3) return f3;
...
function i(e2, t, o) {
  return null != (e2 == null ? void 0 : e2.styleUrl) ? f2(e2.styleUrl, o) : null != (e2 == null ? void 0 : e2.styleName) ? u(e2.styleName, t, o) : Promise.reject(new s("symbolstyleutils:style-url-and-name-missing", "Either styleUrl or styleName is required to resolve a style"));
}
function m(e2) {
...
//# sourceMappingURL=chunk-RVGIH5B7.js.map
