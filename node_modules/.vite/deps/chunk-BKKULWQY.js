...
var T3 = class extends p3(m3(O)) {
  ...
  async queryAttributeBins(e4, t5 = {}) {
    return await this.load(), this._connection.invoke("queryAttributeBins", e4 == null ? void 0 : e4.toJSON(), t5);
  }
  ...
  async _startWorker(e4) {
    ...
    const d3 = { features: c6.features, fields: t5 == null ? void 0 : t5.map((e5) => e5.toJSON()), geometryType: m4.toJSON(this._workerGeometryType), hasM: "mesh" !== this._layerOrSourceGeometryType && s7, hasZ: "mesh" === this._layerOrSourceGeometryType || n8, objectIdField: o7, spatialReference: p9 ? null : r3 && r3.toJSON(), timeInfo: (l9 == null ? void 0 : l9.toJSON()) ?? null, dateFieldsTimeZone: u6 }, y2 = await this._connection.invoke("load", d3, { signal: e4 });
...
function r2(n8) {
  const { popupTemplate: t5, fieldsIndex: s7 } = n8, f6 = t5 == null ? void 0 : t5.fieldInfos;
  if (!(f6 == null ? void 0 : f6.length) || !s7) return;
  const i4 = [];
  for (const l9 of f6) {
...
function a7(n8) {
  const { fields: o7 } = n8;
  if (!(o7 == null ? void 0 : o7.length)) return;
  const f6 = [];
  for (const i4 of o7) {
...
function c5(e4, o7, s7) {
  ...
  for (const n8 of s7) {
    ...
    n8.label = (s8 == null ? void 0 : s8.alias) || o8.alias, n8.format = h(o8) && (s8 == null ? void 0 : s8.fieldFormat) ? D(s8.fieldFormat, o8) : null, i4 = true, l9.delete(o8.name);
  }
...
function Ye(e4, t5, r3) {
  const i4 = !!(r3 == null ? void 0 : r3.writeLayerSchema);
...
var et = class extends V(f5(c2(n7(F2(a4(p4(p5(l6(e2(t(f3(l5(b4(j2(l(s4(o3(l2(b5))))))))))))))))))) {
  constructor(...e4) {
    super(...e4), this.attributeTableTemplate = null, this.charts = null, this.copyright = null, this.displayField = null, this.dynamicDataSource = null, this.fields = null, this.fieldsIndex = null, this.formTemplate = null, this.fullExtent = null, this.geometryType = null, this.graphicOrigin = new a6(this), this.hasM = void 0, this.hasZ = void 0, this.infoFor3D = null, this.isTable = false, this.labelsVisible = true, this.labelingInfo = null, this.legendEnabled = true, this.objectIdField = null, this.operationalLayerType = "ArcGISFeatureLayer", this.outFields = null, this.path = null, this.popupEnabled = true, this.popupTemplate = null, this.resourceInfo = null, this.screenSizePerspectiveEnabled = true, this.spatialReference = f2.WGS84, this.subtypeCode = null, this.supportedSourceTypes = /* @__PURE__ */ new Set(["Feature Layer", "Oriented Imagery Layer", "Table", "Catalog Layer"]), this.templates = null, this.timeInfo = null, this.title = null, this.sublayerTitleMode = "item-title", this.type = "feature", this.typeIdField = null, this.types = null, this.visible = true, this._debouncedSaveOperations = L(async (e5, t5, r3) => {
      const { save: i4, saveAs: o7 } = await import("./featureLayerUtils-CK25ENUY.js");
      switch (e5) {
        case 0:
          return i4(this, t5);
        case 1:
  ...
  writeIsTable(e4, t5, r3, i4) {
    (i4 == null ? void 0 : i4.writeLayerSchema) && e(r3, e4 ? "Table" : "Feature Layer", t5);
  }
  ...
  writePopupTemplate(e4, t5, r3, i4) {
    e4 && (t5[r3] = e4.toJSON({ ...i4, writeFieldFormat: !(i4 == null ? void 0 : i4.writeLayerSchema) }));
  }
  ...
  readRenderer(e4, t5, r3) {
    ...
    const i4 = (_a = t5.drawingInfo) == null ? void 0 : _a.renderer;
    if (i4) {
  ...
  readTemplates(e4, t5) {
    const r3 = t5.editFieldsInfo, i4 = r3 == null ? void 0 : r3.creatorField, o7 = r3 == null ? void 0 : r3.editorField;
    return e4 = e4 == null ? void 0 : e4.map((e5) => a5.fromJSON(e5)), this._fixTemplates(e4, i4), this._fixTemplates(e4, o7), e4;
  }
  readTitle(e4, t5) {
    var _a, _b, _c;
    const r3 = ((_a = t5.layerDefinition) == null ? void 0 : _a.name) ?? t5.name, i4 = t5.title || ((_b = t5.layerDefinition) == null ? void 0 : _b.title);
    if (r3) {
  ...
  readTypes(e4, t5) {
    ...
    const r3 = t5.editFieldsInfo, i4 = r3 == null ? void 0 : r3.creatorField, o7 = r3 == null ? void 0 : r3.editorField;
    return e4 == null ? void 0 : e4.map((e5) => (e5 = c4.fromJSON(e5), this._fixTemplates(e5.templates, i4), this._fixTemplates(e5.templates, o7), e5));
  }
  readVisible(e4, t5) {
    var _a;
  ...
  async createGraphicsSource(e4) {
    ...
    const { default: t5 } = await p(import("./FeatureLayerSource-ANVU4O56.js"), e4);
  ...
  getFieldAlias(e4) {
    ...
    if (t5) return ((_a = this.getFieldConfiguration(t5.name)) == null ? void 0 : _a.alias) || t5.alias;
  }
  getFieldConfiguration(e4) {
    var _a;
    return e4 = e4.toLowerCase(), (_a = this.fieldConfigurations) == null ? void 0 : _a.find((t5) => t5.name.toLowerCase() === e4);
  }
  getFieldDomain(e4, t5) {
    var _a;
    return N(this, e4, t5, ((_a = this.getField(e4)) == null ? void 0 : _a.domain) ?? null);
  }
  ...
  async queryFeatures(e4, t5) {
    ...
    if (i4 == null ? void 0 : i4.features) for (const s7 of i4.features) s7.layer = s7.sourceLayer = r3, s7.origin = o7;
    return i4;
  }
  ...
  async queryPivot(e4, t5) {
    ...
    if (!r3.queryPivot || !((_a = i4 == null ? void 0 : i4.operations) == null ? void 0 : _a.supportsQueryPivot)) throw new s(ze, "Layer source does not support queryPivot capability");
    const o7 = await import("./PivotQuery-5LHXWUED.js"), a8 = await r3.queryPivot(o7.default.from(e4), t5);
    if (a8 == null ? void 0 : a8.features) for (const s7 of a8.features) s7.layer = s7.sourceLayer = this;
    return a8;
  }
  async queryTopFeatures(e4, t5) {
    var _a;
    const { source: r3, capabilities: i4 } = await this.load();
    if (!r3.queryTopFeatures || !((_a = i4 == null ? void 0 : i4.query) == null ? void 0 : _a.supportsTopFeaturesQuery)) throw new s(ze, "Layer source does not support queryTopFeatures capability");
    const o7 = await import("./TopFeaturesQuery-HJQCCOAQ.js"), a8 = await r3.queryTopFeatures(o7.default.from(e4), t5);
    if (a8 == null ? void 0 : a8.features) for (const s7 of a8.features) s7.layer = s7.sourceLayer = this;
    return a8;
  }
  async queryAttributeBins(e4, t5) {
    ...
    ae(e4, i4, ze);
    const o7 = await import("./AttributeBinsQuery-XQ5CILK5.js"), a8 = await r3.queryAttributeBins(o7.default.from(e4), t5);
    if (a8.features) for (const s7 of a8.features) s7.layer = s7.sourceLayer = this;
    return a8;
  }
  async queryTopObjectIds(e4, t5) {
    const { source: r3, capabilities: i4 } = await this.load();
    if (!r3.queryTopObjectIds || !(i4 == null ? void 0 : i4.query.supportsTopFeaturesQuery)) throw new s(ze, "Layer source does not support queryTopObjectIds capability");
    const o7 = await import("./TopFeaturesQuery-HJQCCOAQ.js");
    return (await r3.queryTopObjectIds(o7.default.from(e4), t5)).filter(n3);
  }
  async queryTopFeaturesExtent(e4, t5) {
    var _a;
    const { source: r3, capabilities: i4 } = await this.load();
    if (!r3.queryTopExtents || !((_a = i4 == null ? void 0 : i4.query) == null ? void 0 : _a.supportsTopFeaturesQuery)) throw new s(ze, "Layer source does not support queryTopExtents capability");
    const o7 = await import("./TopFeaturesQuery-HJQCCOAQ.js");
  ...
  async queryTopFeatureCount(e4, t5) {
    var _a;
    const { source: r3, capabilities: i4 } = await this.load();
    if (!r3.queryTopCount || !((_a = i4 == null ? void 0 : i4.query) == null ? void 0 : _a.supportsTopFeaturesQuery)) throw new s(ze, "Layer source does not support queryFeatureCount capability");
    const o7 = await import("./TopFeaturesQuery-HJQCCOAQ.js");
  ...
  read(e4, t5) {
    ...
    if ((r3 || "Feature Collection" === e4.type) && (this.resourceInfo = e4), r3) {
      ...
      1 === (e5 == null ? void 0 : e5.length) && (super.read(e5[0], t5), null != i4 && super.read({ showLegend: i4 }, t5));
    }
  ...
  write(e4, t5) {
    ...
    if (this.dynamicDataSource) return o7 == null ? void 0 : o7.push(ke(this, "using a dynamic data source cannot be written to web scenes, web maps and feature service items")), null;
    if (this.isTable) {
      if (("web-map" === r3 || "web-scene" === r3) && "tables" !== i4) return o7 == null ? void 0 : o7.push(ke(this, `a table source can only be written to tables, not ${i4}`)), null;
      if (this._hasMemorySource()) return o7 == null ? void 0 : o7.push(ke(this, "using an in-memory table source cannot be written to web scenes and web maps")), null;
    } else if (this.loaded && ("web-map" === r3 || "web-scene" === r3) && "tables" === i4) return o7 == null ? void 0 : o7.push(ke(this, "using a non-table source cannot be written to tables in web maps or web scenes")), null;
  ...
  _readEditingEnabled(e4, t5, r3) {
    var _a;
    let i4 = (_a = e4.layerDefinition) == null ? void 0 : _a.capabilities;
    return i4 ? this._hasEditingCapability(i4) : (i4 = e4.capabilities, t5 && "web-map" === (r3 == null ? void 0 : r3.origin) && !this._hasMemorySource() && i4 ? this._hasEditingCapability(i4) : void 0);
  }
  ...
  _writeEditingEnabled(e4, t5, r3, i4) {
    ...
    if (!e4) {
      ...
      e("layerDefinition.capabilities", e5, t5), r3 && !(i4 == null ? void 0 : i4.writeLayerSchema) && (t5.capabilities = e5);
    }
  }
...
__decorate([m({ clonable: false, readOnly: true })], et.prototype, "_titleCreator", null), __decorate([m(I)], et.prototype, "attributeTableTemplate", void 0), __decorate([o("service", "capabilities")], et.prototype, "readCapabilities", null), __decorate([m({ json: { origins: { "web-scene": { write: false } }, write: true } })], et.prototype, "charts", void 0), __decorate([m({ readOnly: true })], et.prototype, "createQueryVersion", null), __decorate([m({ json: { read: { source: "layerDefinition.copyrightText" } } })], et.prototype, "copyright", void 0), __decorate([m({ json: { read: { source: "layerDefinition.displayField" } } })], et.prototype, "displayField", void 0), __decorate([m({ types: x, readOnly: true })], et.prototype, "defaultSymbol", void 0), __decorate([m({ type: R })], et.prototype, "dynamicDataSource", void 0), __decorate([m({ type: Boolean })], et.prototype, "editingEnabled", null), __decorate([o(["portal-item", "web-scene"], "editingEnabled", ["layerDefinition.capabilities"])], et.prototype, "readEditingEnabled", null), __decorate([o("web-map", "editingEnabled", ["capabilities", "layerDefinition.capabilities"])], et.prototype, "readEditingEnabledFromWebMap", null), __decorate([r(["portal-item", "web-scene"], "editingEnabled", { "layerDefinition.capabilities": { type: String } })], et.prototype, "writeEditingEnabled", null), __decorate([r("web-map", "editingEnabled", { capabilities: { type: String }, "layerDefinition.capabilities": { type: String } })], et.prototype, "writeEditingEnabledToWebMap", null), __decorate([m({ readOnly: true })], et.prototype, "effectiveEditingEnabled", null), __decorate([m({ clonable: false, readOnly: true })], et.prototype, "featureTitleFields", null), __decorate([m({ type: [p8], json: { name: "layerDefinition.fieldConfigurations", write: { overridePolicy(e4, t5, r3) {
  return { enabled: !(r3 == null ? void 0 : r3.writeLayerSchema), ignoreOrigin: 1 === this.originIdOf(t5) };
...
//# sourceMappingURL=chunk-BKKULWQY.js.map
