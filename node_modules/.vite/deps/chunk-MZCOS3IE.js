...
var y = class extends b {
  ...
  get layerDefs() {
    ...
    return r.length ? JSON.stringify(r.reduce((e3, r2) => {
      const t = n(this.floors, r2), i = l(t, r2.definitionExpression);
...
__decorate([m({ readOnly: true })], y.prototype, "dynamicLayers", null), __decorate([m()], y.prototype, "floors", void 0), __decorate([m({ readOnly: true })], y.prototype, "hasDynamicLayers", null), __decorate([m()], y.prototype, "layer", null), __decorate([m({ readOnly: true })], y.prototype, "layers", null), __decorate([m({ readOnly: true })], y.prototype, "layerDefs", null), __decorate([m({ type: Number })], y.prototype, "scale", void 0), __decorate([m({ readOnly: true })], y.prototype, "version", null), __decorate([m({ readOnly: true })], y.prototype, "visibleSublayers", null), y = __decorate([a("esri.layers.support.ExportImageParameters")], y);

export {
  y
};
//# sourceMappingURL=chunk-MZCOS3IE.js.map
