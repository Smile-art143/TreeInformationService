...
function n(n5) {
  var _a, _b;
  return "curveRings" in n5 && !!((_a = n5.curveRings) == null ? void 0 : _a.length) || "curvePaths" in n5 && !!((_b = n5.curvePaths) == null ? void 0 : _b.length);
}
function r5(n5) {
...
function j2(t4) {
  ...
  switch (e10 ?? (e10 = []), x6(e10) && (e10 = [e10]), (_b = (_a = e10[0]) == null ? void 0 : _a[0]) == null ? void 0 : _b.length) {
    case 4:
      s7 ?? (s7 = true), r8 ?? (r8 = true);
      break;
    case 3:
      s7 ?? (s7 = true !== r8), r8 ?? (r8 = !s7);
      break;
    default:
      s7 ?? (s7 = false), r8 ?? (r8 = false);
  }
  return i8 ?? (i8 = f.WGS84), { ...t4, hasM: r8, hasZ: s7, rings: e10, spatialReference: i8 };
}
...
function m9(t4) {
  ...
  switch (e10 ?? (e10 = []), f11(e10) && (e10 = [e10]), (_b = (_a = e10[0]) == null ? void 0 : _a[0]) == null ? void 0 : _b.length) {
    case 4:
      s7 ?? (s7 = true), r8 ?? (r8 = true);
      break;
    case 3:
  ...
  return i8 ?? (i8 = f.WGS84), { ...t4, hasM: r8, hasZ: s7, paths: e10, spatialReference: i8 };
}
...
//# sourceMappingURL=chunk-Z5BO22MQ.js.map
