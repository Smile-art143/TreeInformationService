...
var u4 = class extends n {
  ...
  get flatWebGLFunctionChain() {
    ...
    return { functions: s11, hasBranches: i25, hasFocalFunction: n21, isSourceSingleBand: 1 === ((_a = o9 == null ? void 0 : o9[0]) == null ? void 0 : _a.bandCount) };
  }
  bind(t6, s11 = false, e9 = -1) {
    ...
    if (!this.rasterInfo || s11) {
      if (this.sourceRasterInfos = this._getSourceRasterInfos(t6), this._bindingResult = this._bindSourceRasters(), i25 && (i25 = this._bindingResult.supportsGPU), this._bindingResult.success && (this._patchRasterInfo(), i25 && this.isRoot)) {
...
var n4 = class extends p3 {
  ...
  _processPixels(t6) {
    ...
    const { extent: e9, primaryPixelSizes: r11 } = t6, o9 = r11 == null ? void 0 : r11[0], n21 = o9 ?? (e9 ? { x: e9.width / s11.width, y: e9.height / s11.height } : { x: 1, y: 1 });
...
var u7 = class extends p3 {
  ...
  _swizzleBandIds(e9) {
    ...
    return i25[2] ?? (i25[2] = i25[1]), this.isInputBandIdsSwizzled = true, this.swizzledBandSelection = i25, false;
  }
};
...
var c10;
var n6 = new o2({ 1: "outside", 2: "inside" }, { useNumericKeys: true });
...
var u10 = i6 = class extends p2 {
  ...
  clone() {
    var _a;
    return new i6({ colormap: a(this.colormap), colormapName: this.colormapName, colorRamp: (_a = this.colorRamp) == null ? void 0 : _a.clone(), colorRampName: this.colorRampName });
  }
};
__decorate([m({ type: [[Number]], json: { write: true } })], u10.prototype, "colormap", void 0), __decorate([m({ type: String, json: { write: true } })], u10.prototype, "colormapName", void 0), __decorate([s2("colormapName")], u10.prototype, "castColormapName", null), __decorate([m({ types: m3, json: { write: true } })], u10.prototype, "colorRamp", void 0), __decorate([o("colorRamp")], u10.prototype, "readColorRamp", null), __decorate([m({ type: m6.apiValues, json: { type: m6.jsonValues, write: m6.write } })], u10.prototype, "colorRampName", void 0), __decorate([o("colorRampName")], u10.prototype, "readColorRampName", null), u10 = i6 = __decorate([a2("esri.layers.support.rasterFunctions.ColormapFunctionArguments")], u10);
var d6 = u10;
...
var m13 = class extends p3 {
  ...
  _bindSourceRasters() {
    ...
    if (!(r11 == null ? void 0 : r11.length)) if (s11) this.colorRamp = s11, r11 = B(s11, { interpolateAlpha: true });
    else if (e9) {
      const o10 = d2(e9);
      o10 && (r11 = B(o10), this.colorRamp = p(o10));
    } else t6 && (r11 = c12(t6));
    if (!(r11 == null ? void 0 : r11.length)) return { success: false, supportsGPU: false, error: "colormap-function: missing colormap argument" };
  ...
  _processPixels(o9) {
    var _a;
    let r11 = (_a = o9.pixelBlocks) == null ? void 0 : _a[0];
...
var a12 = class extends p3 {
  ...
  _processPixels(t6) {
    var _a;
    let o9 = (_a = t6.pixelBlocks) == null ? void 0 : _a[0];
...
var i9 = class extends p3 {
  ...
  _bindSourceRasters() {
    ...
    e9.multidimensionalInfo && e9.multidimensionalInfo.variables.forEach((s12) => {
      const e10 = t6.map((t7) => {
        var _a;
        return (_a = t7.multidimensionalInfo) == null ? void 0 : _a.variables.find(({ name: t8 }) => t8 === s12.name);
      }), r12 = e10.map((t7) => {
        var _a;
  ...
  _processPixels(t6) {
    ...
    if (!s11) return null;
    const e9 = s11 == null ? void 0 : s11[0];
...
var n8 = new o2({ 0: "difference", 1: "relative-difference", 2: "categorical", 3: "euclidean-distance", 4: "angle-difference", 5: "band-with-most-change" }, { useNumericKeys: true });
...
var c18;
var u13 = new o2({ 0: "standard", 1: "planform", 2: "profile" }, { useNumericKeys: true });
...
__decorate([m({ json: { write: { target: "type" } } }), r2(u13)], i13.prototype, "curvatureType", void 0), __decorate([o("curvatureType", ["type", "curvatureType"])], i13.prototype, "readCurvatureType", null), __decorate([m({ type: Number, json: { write: true } })], i13.prototype, "zFactor", void 0), i13 = c18 = __decorate([a2("esri.layers.support.rasterFunctions.CurvatureFunctionArguments")], i13);
var n11 = i13;
...
var u14 = class extends p3 {
  ...
  _processPixels(t6) {
    var _a;
    const r11 = (_a = t6.pixelBlocks) == null ? void 0 : _a[0];
    if (null == r11) return null;
    const { zFactor: e9, curvatureType: s11 } = this.functionArguments, { extent: o9, primaryPixelSizes: u20 } = t6, c35 = u20 == null ? void 0 : u20[0], a29 = c35 ?? (o9 ? { x: o9.width / r11.width, y: o9.height / r11.height } : { x: 1, y: 1 }), p18 = this.isGCS && e9 >= 1 ? e9 * n2 : e9;
...
var a17 = n12 = class extends p2 {
  ...
  clone() {
    var _a, _b, _c;
    return new n12({ bandIds: (_a = this.bandIds) == null ? void 0 : _a.slice(), bandNames: (_b = this.bandNames) == null ? void 0 : _b.slice(), bandWavelengths: (_c = this.bandWavelengths) == null ? void 0 : _c.slice(), missingBandAction: this.missingBandAction, method: this.method, wavelengthMatchTolerance: this.wavelengthMatchTolerance });
  }
};
...
var i15 = class extends p3 {
  ...
  _bindSourceRasters() {
    var _a;
    const { functionArguments: t6, sourceRasterInfos: n21 } = this, e9 = n21[0], { method: s11, bandNames: r11, bandWavelengths: o9, bandIds: i25, missingBandAction: a29 } = t6, d9 = (r11 == null ? void 0 : r11.length) && ("name" === s11 || "id" !== s11 && !(i25 == null ? void 0 : i25.length)), h6 = (o9 == null ? void 0 : o9.length) && ("wavelength" === s11 || "id" !== s11 && !(i25 == null ? void 0 : i25.length)), m19 = 1 === a29, g4 = d9 ? l15(e9, r11) : h6 ? c20(e9, o9, this.functionArguments, m19) : u15(e9, i25, m19);
    if (null == g4) {
    ...
    let b4 = (_a = p18.keyProperties) == null ? void 0 : _a.BandProperties;
    (b4 == null ? void 0 : b4.length) && (b4 = g4.map((t7) => t7 >= b4.length ? b4[b4.length - 1] : b4[t7]), p18.keyProperties = { ...p18.keyProperties, BandProperties: b4 }), this.rasterInfo = p18;
    return { success: true, supportsGPU: p18.bandCount <= 3 };
  }
  _processPixels(t6) {
    var _a;
    const n21 = (_a = t6.pixelBlocks) == null ? void 0 : _a[0];
  ...
  _swizzleBandIds(t6) {
    ...
    return this.isInputBandIdsSwizzled = true, n21[1] ?? (n21[1] = n21[0]), n21[2] ?? (n21[2] = n21[1]), this.swizzledBandSelection = n21, false;
  }
};
...
function u15(t6, n21, e9) {
  ...
  return !(n21 == null ? void 0 : n21.length) || e9 && n21.some((t7) => t7 < 0 || t7 >= s11) ? null : n21;
}
...
function i16(i25, s11, a29) {
  const { pixels: l22, width: n21, height: r11, mask: o9, bandMasks: h6 } = i25, p18 = n21 * r11, m19 = (h6 == null ? void 0 : h6.length) ? c2.combineBandMasks(h6) : o9, f9 = Math.min(s11.length, l22.length), c35 = a29.startsWith("f"), d9 = !c35 && a29 !== i25.pixelType, [x6, g4] = u(a29), k5 = c2.createEmptyBand(a29, p18);
...
var p13;
var a20 = new o2({ 0: "traditional", 1: "multi-directional" }, { useNumericKeys: true });
var c22 = new o2({ 1: "degree", 2: "percent-rise", 3: "scaled" }, { useNumericKeys: true });
...
var c23 = class extends p3 {
  ...
  _bindSourceRasters() {
    ...
    this.outputPixelType = this._getOutputPixelType("u8");
    const s11 = t6.clone();
    return this._removeStatsHistColormapVAT(s11), s11.pixelType = this.outputPixelType, s11.bandCount = 1, s11.statistics = [{ min: 0, max: 255, avg: 60, stddev: 10 }], this.rasterInfo = s11, this.isGCS = ((_a = s11.spatialReference) == null ? void 0 : _a.isGeographic) ?? false, { success: true, supportsGPU: true };
  }
  _processPixels(t6) {
    var _a;
    const s11 = (_a = t6.pixelBlocks) == null ? void 0 : _a[0];
    if (!s11) return null;
    const { extent: e9, primaryPixelSizes: r11 } = t6, o9 = r11 == null ? void 0 : r11[0], i25 = o9 ?? (e9 ? { x: e9.width / s11.width, y: e9.height / s11.height } : { x: 1, y: 1 }), p18 = d(this.functionArguments, i25, this.isGCS), a29 = r5(s11, p18);
...
var m17 = class extends p3 {
  ...
  _getWebGLParameters() {
    var _a;
    const { operation: t6 } = this.functionArguments, s11 = c6[t6], e9 = ((_a = Object.keys(m7).find((s12) => m7[s12] === t6)) == null ? void 0 : _a.toLowerCase()) ?? "undefined", i25 = this.outputPixelType ?? "f32";
    let [a29, u20] = u(i25);
    const p18 = r3(i25);
  ...
  _updateStatistics(t6) {
    var _a, _b;
    const s11 = this.sourceRasterInfos[0], { operation: e9 } = this.functionArguments, o9 = (_a = l6(e9)) == null ? void 0 : _a.domain;
    if (o9) {
      t6.statistics = [];
      for (let s12 = 0; s12 < t6.bandCount; s12++) t6.statistics[s12] = { min: o9[0], max: o9[1], avg: (o9[0] + o9[1]) / 2, stddev: (o9[0] + o9[1]) / 10 };
    } else 45 === e9 && ((_b = s11.statistics) == null ? void 0 : _b.length) && (t6.statistics = s11.statistics.map((t7) => ({ min: -t7.max, max: -t7.min, avg: null != t7.avg ? -t7.avg : void 0, stddev: null != t7.stddev ? -t7.stddev : void 0 })));
  }
  _updatePixelType(t6) {
    ...
    if (n21 && a29) u20 = i(n21[0], n21[1]);
      ...
      const t7 = s11 == null ? void 0 : s11.map(({ max: t8 }) => -t8), o10 = s11 == null ? void 0 : s11.map(({ min: t8 }) => -t8), n22 = (t7 == null ? void 0 : t7.length) ? Math.min(...t7) : null, r11 = (o10 == null ? void 0 : o10.length) ? Math.min(...o10) : null;
...
var s9 = n13 = class extends p2 {
  ...
  clone() {
    var _a, _b;
    return new n13({ includedRanges: ((_a = this.includedRanges) == null ? void 0 : _a.slice()) ?? [], noDataValues: ((_b = this.noDataValues) == null ? void 0 : _b.slice()) ?? [], noDataInterpretation: this.noDataInterpretation });
  }
};
...
var l18 = class extends p3 {
  ...
  _bindSourceRasters() {
    ...
    if (!(s11 == null ? void 0 : s11.length) && !(o9 == null ? void 0 : o9.length)) return { success: false, supportsGPU: false, error: "missing includedRanges or noDataValues argument" };
    let r11 = [];
    for (let i25 = 0; i25 < t6.bandCount; i25++) {
      const t7 = M(e9, s11 == null ? void 0 : s11.slice(2 * i25, 2 * i25 + 2), o9 == null ? void 0 : o9[i25]);
      if (null == t7) {
        r11 = null;
        break;
      }
    ...
    this.lookups = r11;
    const n21 = null != o9 && o9.every((t7) => {
      var _a;
      return (t7 == null ? void 0 : t7.length) === ((_a = o9[0]) == null ? void 0 : _a.length);
    });
  ...
  _getWebGLParameters() {
    ...
    o9.fill(q), ((_a = s11 == null ? void 0 : s11[0]) == null ? void 0 : _a.length) && o9.set(s11[0]);
    const r11 = new Float32Array(6);
    for (let n21 = 0; n21 < r11.length; n21 += 2) r11[n21] = (t6 == null ? void 0 : t6[n21]) ?? -q, r11[n21 + 1] = (t6 == null ? void 0 : t6[n21 + 1]) ?? q;
    return (t6 == null ? void 0 : t6.length) && r11.set(t6), { bandCount: this.sourceRasterInfos[0].bandCount, noDataValues: o9, includedRanges: r11 };
  }
};
...
var g3 = class extends p3 {
  ...
  _bindSourceRasters() {
    ...
    if (this.outputPixelType = this._getOutputPixelType(e9), r11 == null ? void 0 : r11.length) {
      const u20 = s11 == null ? void 0 : s11[0];
      if (n21 && null == a29) {
        let e10 = (u20 == null ? void 0 : u20.min) ?? r11[0], s12 = (u20 == null ? void 0 : u20.max) ?? r11[0];
        e10 = Math.min.apply(null, [...r11, e10]), s12 = Math.max.apply(null, [...r11, s12]), t6.statistics = [{ min: e10, max: s12, avg: (u20 == null ? void 0 : u20.avg) ?? 0, stddev: (u20 == null ? void 0 : u20.stddev) ?? -1 }];
      } else {
        let e10 = r11[0], s12 = e10;
        for (let t7 = 0; t7 < r11.length; t7++) e10 = e10 > r11[t7] ? r11[t7] : e10, s12 = s12 > r11[t7] ? s12 : r11[t7];
        n21 && null != a29 && (e10 = Math.min(e10, a29), s12 = Math.max(s12, a29)), t6.statistics = [{ min: e10, max: s12, avg: (u20 == null ? void 0 : u20.avg) ?? 0, stddev: (u20 == null ? void 0 : u20.stddev) ?? -1 }];
      }
      if (c35) {
  ...
  _getWebGLParameters() {
    ...
    l22.fill(q), (s11 == null ? void 0 : s11.length) && l22.set(s11);
...
__decorate([m({ json: { write: true } })], l19.prototype, "colorRamp", void 0), __decorate([o("colorRamp")], l19.prototype, "readColorRamp", null), __decorate([m({ type: [[Number]], json: { write: true } })], l19.prototype, "colormap", void 0), l19 = a25 = __decorate([a2("esri.layers.support.rasterFunctions.ShadedReliefFunctionArguments")], l19);
var c26 = l19;
...
var h5 = class extends p3 {
  ...
  _bindSourceRasters() {
    ...
    if (!t6 && !(s11 == null ? void 0 : s11.length)) return { success: false, supportsGPU: false, error: "shadedrelief-function: a color ramp argument must be specified" };
    this.outputPixelType = this._getOutputPixelType("u8");
    const r11 = e9.clone();
    this._removeStatsHistColormapVAT(r11), r11.pixelType = this.outputPixelType, r11.bandCount = 3, r11.statistics = [{ min: 0, max: 255, avg: 60, stddev: 10 }, { min: 0, max: 255, avg: 60, stddev: 10 }, { min: 0, max: 255, avg: 60, stddev: 10 }], this.rasterInfo = r11, this.isGCS = ((_a = r11.spatialReference) == null ? void 0 : _a.isGeographic) ?? false, (s11 == null ? void 0 : s11.length) || (s11 = B(t6, { interpolateAlpha: true }));
    const { indexedColormap: o9, offset: n21 } = a3({ colormap: s11 });
    if (!(o9 == null ? void 0 : o9.length)) return { success: false, supportsGPU: false, error: "shadedrelief-function: a valid colorramp is required" };
    const p18 = D(o9);
  ...
  _processPixels(e9) {
    ...
    let s11 = (_b = e9.primaryPixelSizes) == null ? void 0 : _b[0];
    if (null == s11) {
      const { extent: r12 } = e9;
      s11 = r12 ? { x: r12.width / t6.width, y: r12.height / t6.height } : { x: 1, y: 1 };
    }
    const r11 = d(this.functionArguments, s11, this.isGCS), o9 = r5(t6, r11), i25 = ((_c = this.sourceRasterInfos[0].statistics) == null ? void 0 : _c[0]) ?? { min: 0, max: 8e3 };
    return c4(o9, t6, this.lookup.hsvMap, i25), o9.pixelType = this.outputPixelType, o9;
  }
  _getWebGLParameters() {
    var _a;
    const e9 = d(this.functionArguments, { x: 1, y: 1 }, this.isGCS), t6 = a4(e9), { slopeType: s11, zFactor: o9, pixelSizeFactor: i25, pixelSizePower: n21 } = this.functionArguments, a29 = "scaled" === s11, { indexedColormap: u20, offset: m19 } = this.lookup, d9 = (_a = this.sourceRasterInfos[0].statistics) == null ? void 0 : _a[0], f9 = r3(this.outputPixelType);
    return { ...t6, indexedColormap: u20, offset: m19, zFactor: o9, gcsFactor: this.isGCS ? n2 : 1, pixelSizeFactor: a29 ? i25 : 0, pixelSizePower: a29 ? n21 : 0, minValue: (d9 == null ? void 0 : d9.min) ?? 0, maxValue: (d9 == null ? void 0 : d9.max) ?? 8e3, isOutputRounded: f9 };
  }
};
...
var i20;
var c27 = new o2({ 1: "degree", 2: "percent-rise", 3: "adjusted" }, { useNumericKeys: true });
...
var u18 = class extends p3 {
  ...
  _bindSourceRasters() {
    ...
    this.outputPixelType = this._getOutputPixelType("f32");
    const t6 = this.sourceRasterInfos[0].clone();
    return t6.pixelType = this.outputPixelType, this._removeStatsHistColormapVAT(t6), t6.statistics = "percent-rise" !== this.functionArguments.slopeType ? [{ min: 0, max: 90, avg: 1, stddev: 1 }] : null, t6.bandCount = 1, this.rasterInfo = t6, this.isGCS = ((_a = t6.spatialReference) == null ? void 0 : _a.isGeographic) ?? false, { success: true, supportsGPU: true };
  }
  _processPixels(t6) {
    var _a;
    const e9 = (_a = t6.pixelBlocks) == null ? void 0 : _a[0];
    if (null == e9) return null;
    const { zFactor: s11, slopeType: r11, pixelSizePower: o9, pixelSizeFactor: i25 } = this.functionArguments, { isGCS: n21 } = this, { extent: u20, primaryPixelSizes: c35 } = t6, a29 = c35 == null ? void 0 : c35[0], l22 = a29 ?? (u20 ? { x: u20.width / e9.width, y: u20.height / e9.height } : { x: 1, y: 1 });
...
var n16 = new o2({ 1: "min", 2: "max", 3: "mean", 4: "stddev", 5: "median", 6: "majority", 7: "minority" }, { useNumericKeys: true });
function s10(t6, e9) {
...
function i21(t6, e9) {
  ...
  for (let d9 = f9; d9 < r11 - f9; d9++) {
    ...
    for (let e10 = h6; e10 < s11 - h6; e10++) {
      if (o9 && (i25 == null ? void 0 : i25[t7 + e10])) continue;
      const r12 = [];
...
function a27(t6, n21) {
  ...
  for (let N2 = 0; N2 < y3; N2++) {
    ...
    c35 && d10.set(t7);
    const y4 = (u20 == null ? void 0 : u20[N2]) ?? a29, j4 = (y4 == null ? void 0 : y4.slice()) ?? null, B6 = { band: t7, width: h6, height: m19, mask: j4, outBand: d10 };
    switch (g4) {
      case "min":
      case "max":
        r10(B6, n21);
  ...
  let j3 = x6[0] ?? a29;
  x6.length !== y3 && (x6.length = 0), y3 > 1 && (u20 == null ? void 0 : u20.length) && (j3 = c2.combineBandMasks(u20));
...
__decorate([m({ json: { write: true, read: { source: ["kernelRows", "rows"], reader: (s11, r11) => Number(s11 ?? (r11 == null ? void 0 : r11.kernelRows) ?? 3) } } })], p14.prototype, "rows", void 0), __decorate([m({ json: { write: true, read: { source: ["kernelCols", "cols"], reader: (s11, r11) => Number(s11 ?? (r11 == null ? void 0 : r11.kernelCols) ?? 3) } } })], p14.prototype, "cols", void 0), __decorate([m({ json: { write: true } })], p14.prototype, "fillNoDataOnly", void 0), __decorate([m({ json: { read: { source: ["statisticsType", "type"], reader: (s11, r11) => n16.fromJSON((r11 == null ? void 0 : r11.statisticsType) ?? (r11 == null ? void 0 : r11.type)) ?? "min" }, write: { target: "type" } } }), r2(n16)], p14.prototype, "statisticsType", void 0), p14 = c29 = __decorate([a2("esri.layers.support.rasterFunctions.StatisticsFunctionArguments")], p14);
var l21 = p14;
...
__decorate([m({ json: { write: true } })], n17.prototype, "statistics", void 0), __decorate([o("statistics")], n17.prototype, "readStatistics", null), __decorate([r("statistics")], n17.prototype, "writeStatistics", null), __decorate([m({ json: { write: true } })], n17.prototype, "histograms", void 0), n17 = c31 = __decorate([a2("esri.layers.support.rasterFunctions.StatisticsHistogramFunctionArguments")], n17);
var p16 = n17;
...
var n19;
var p17 = new o2({ 0: "none", 3: "standard-deviation", 4: "histogram-equalization", 5: "min-max", 6: "percent-clip", 9: "sigmoid" }, { useNumericKeys: true });
var c32 = n19 = class extends p2 {
  ...
  writeStatistics(t6, e9, o9) {
    (t6 == null ? void 0 : t6.length) && (Array.isArray(t6[0]) || (t6 = t6.map((t7) => [t7.min, t7.max, t7.avg, t7.stddev])), e9[o9] = t6);
  }
  clone() {
...
var c33 = class extends p3 {
  ...
  _getWebGLParameters() {
    const { outputMin: t6 = 0, outputMax: s11 = 255, gamma: e9, useGamma: r11 } = this.functionArguments, u20 = this.rasterInfo.bandCount >= 2 ? 3 : 1, i25 = r11 && (e9 == null ? void 0 : e9.length) ? w3(u20, e9) : [1, 1, 1], { minCutOff: n21, maxCutOff: p18 } = this.cutOffs ?? { minCutOff: [0, 0, 0], maxCutOff: [255, 255, 255] };
...
function B4(t6) {
  ...
  return "Local" !== e9 || ((_a = n21.rasters) == null ? void 0 : _a.length) || (n21.rasters = ["$$"]), { ...t6, rasterFunctionArguments: n21 };
}
function k4(t6, r11) {
  var _a, _b;
  const { rasterFunction: n21, rasterFunctionArguments: o9 } = t6, s11 = (_a = t6.outputPixelType) == null ? void 0 : _a.toLowerCase();
  ...
  for (let e9 = 0; e9 < m19.length; e9++) {
    const t7 = m19[e9];
    let n22;
    null == t7 || "string" == typeof t7 && t7.startsWith("$") ? u20.push(r11 == null ? void 0 : r11.raster) : "string" == typeof t7 ? r11[t7] && u20.push(r11[t7]) : "number" != typeof t7 && "rasterFunction" in t7 && (n22 = k4(t7, r11), l22 || (i25.functionArguments[c35[e9]] = n22), u20.push(n22)), l22 && p18.push(n22 ?? t7);
  }
  if (l22 && ("rasters" === c35[0] ? i25.functionArguments.rasters = p18 : c35.forEach((t7, e9) => {
    ...
    const t7 = (_b = r11.raster) == null ? void 0 : _b.url;
...
function L2(t6) {
  ...
  if ("object" != typeof r11 || !(r11 == null ? void 0 : r11.rasterFunctionArguments) || !n21.size) return;
...
//# sourceMappingURL=chunk-BMHMBZAO.js.map
