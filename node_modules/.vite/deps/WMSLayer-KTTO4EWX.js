...
__decorate([m()], m3.prototype, "description", void 0), __decorate([m({ readOnly: true })], m3.prototype, "dimensions", void 0), __decorate([m({ type: z, json: { name: "extent" } })], m3.prototype, "fullExtent", void 0), __decorate([m()], m3.prototype, "fullExtents", void 0), __decorate([m({ type: Number, json: { write: { enabled: false, overridePolicy: () => ({ ignoreOrigin: true, enabled: true }) } } })], m3.prototype, "id", null), __decorate([m({ type: String, json: { name: "legendUrl", write: { ignoreOrigin: true } } })], m3.prototype, "legendUrl", void 0), __decorate([o("legendUrl", ["legendUrl", "legendURL"])], m3.prototype, "readLegendUrl", null), __decorate([m({ type: Boolean, json: { name: "showLegend", origins: { "web-map": { read: false, write: false }, "web-scene": { read: false, write: false } } } })], m3.prototype, "legendEnabled", void 0), __decorate([m()], m3.prototype, "layer", void 0), __decorate([m()], m3.prototype, "maxScale", void 0), __decorate([m()], m3.prototype, "minScale", void 0), __decorate([m({ readOnly: true })], m3.prototype, "effectiveScaleRange", null), __decorate([m({ type: String, json: { write: { ignoreOrigin: true } } })], m3.prototype, "name", void 0), __decorate([m()], m3.prototype, "parent", void 0), __decorate([m({ type: Boolean, json: { read: { source: "showPopup" }, write: { ignoreOrigin: true, target: "showPopup" } } })], m3.prototype, "popupEnabled", void 0), __decorate([m({ type: Boolean, json: { write: { ignoreOrigin: true } } })], m3.prototype, "queryable", void 0), __decorate([m()], m3.prototype, "sublayers", void 0), __decorate([s3("sublayers")], m3.prototype, "castSublayers", null), __decorate([m({ type: [Number], json: { read: { source: "spatialReferences" } } })], m3.prototype, "spatialReferences", void 0), __decorate([m({ type: String, json: { write: { ignoreOrigin: true } } })], m3.prototype, "title", void 0), __decorate([m({ type: Boolean, value: true, json: { read: { source: "defaultVisibility" } } })], m3.prototype, "visible", null), m3 = h = __decorate([a2("esri.layers.support.WMSSublayer")], m3);
...
function a5(n) {
  ...
  0 === U3.length && U3.push(M2), M2.extent ?? (M2.extent = U3[0].extent);
  ...
  if (j2.length) {
    const t4 = j2.map((e) => {
      const { extent: t5 } = e;
      return A(t5) ? t5.map((e2) => e2.getTime()) : t5 == null ? void 0 : t5.map((e2) => [e2.min.getTime(), e2.max.getTime()]);
...
function c3(e) {
  var _a;
  let t4 = [];
  for (const n of e) t4.push(n), ((_a = n.sublayers) == null ? void 0 : _a.length) && (t4 = t4.concat(c3(n.sublayers)), delete n.sublayers);
  return t4;
}
function m4(e, t4, n) {
...
function x3(e, t4, n) {
  var _a;
  return ((_a = d2(e, t4)) == null ? void 0 : _a.textContent) ?? n;
}
function h2(e, t4, n) {
...
function b4(e, t4, n) {
  ...
  return Array.prototype.slice.call(e.childNodes).forEach((e2) => {
    ...
    if ("Name" === e2.nodeName) a6.name = e2.textContent || "";
      ...
      const n2 = e2.getAttribute(f5), i3 = n2 == null ? void 0 : n2.indexOf(":");
      if (i3 && i3 > -1) {
...
var Q = new o2({ bmp: "image/bmp", gif: "image/gif", jpg: "image/jpeg", png: "image/png", svg: "image/svg+xml" }, { ignoreUnknown: false });
function K(e) {
  return "text/html" === e;
}
function X2(e) {
...
var Y = class extends p(l3(f3(t2(b2(j(l2(b3))))))) {
  ...
  writeSublayers(e, t4, r2, o5) {
    ...
    for (const a6 of i2) {
      const e2 = { sublayer: a6, ...o5 }, r3 = a6.write({ parentLayerId: "number" == typeof ((_b = a6.parent) == null ? void 0 : _b.id) ? a6.parent.id : -1 }, e2);
  ...
  createExportImageParameters(e, t4, r2, o5) {
    const s5 = (o5 == null ? void 0 : o5.pixelRatio) ?? 1, i2 = i({ extent: e, width: t4 }) * s5, a6 = new a4({ layer: this, scale: i2 }), { xmin: n, ymin: l6, xmax: p3, ymax: m5, spatialReference: u2 } = e, c4 = X(u2, this.spatialReferences), y3 = "1.3.0" === this.version && o3(c4) ? `${l6},${n},${m5},${p3}` : `${n},${l6},${p3},${m5}`, f5 = a6.toJSON(), d3 = "1.3.0" === this.version ? "crs" : "srs";
  ...
  async fetchImage(e, t4, r2, o5) {
    ...
    const n = B(o5 == null ? void 0 : o5.timeExtent), l6 = { responseType: "image", query: this._mixCustomParameters({ width: t4, height: r2, ...a6, time: n, ...this.refreshParameters }), signal: o5 == null ? void 0 : o5.signal };
  ...
  async fetchImageBitmap(e, t4, r2, o5) {
    ...
    const n = B(o5 == null ? void 0 : o5.timeExtent), l6 = { responseType: "blob", query: this._mixCustomParameters({ width: t4, height: r2, ...a6, time: n, ...this.refreshParameters }), signal: o5 == null ? void 0 : o5.signal }, { data: p3 } = await H(i2, l6);
    return t3(p3, i2, o5 == null ? void 0 : o5.signal);
  }
