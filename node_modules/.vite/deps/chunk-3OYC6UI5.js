...
function a4(e, n2, t) {
  ...
  for (let a5 = 0; a5 < s2; a5++) {
    ...
    (_a = i.values) == null ? void 0 : _a.forEach((a6) => {
...
function r(e, n2, t) {
  ...
  }), i.length && null != (t == null ? void 0 : t.start) && null != t.end) {
...
function m2(e, n2, t) {
  ...
  if (t) {
    ...
    i = t2 == null ? void 0 : t2.extent;
  }
  const a5 = i;
  if (!(a5 == null ? void 0 : a5.length)) return e;
...
function h(e, n2) {
  ...
  if (2 === r2.length && (t == null ? void 0 : t.extent.length) && (r2[0] = Math.max(r2[0], t.extent[0]), r2[1] = Math.min(r2[1], t.extent[1] ?? t.extent[0]), r2[1] < r2[0])) return null;
...
function g(e) {
  ...
  let a5 = ((_a = e.multidimensionalDefinition) == null ? void 0 : _a.length) ? e.multidimensionalDefinition : b(n2, { multidimensionalSubset: t });
  if (!(a5 == null ? void 0 : a5.length)) return null;
  if (a5.some((e2) => !e2.dimensionName)) {
    ...
    i2 == null ? void 0 : i2.forEach((e3) => {
      var _a2;
      const n3 = a5 == null ? void 0 : a5.find(({ dimensionName: n4 }) => n4 === e3.dimensionName);
      ((_a2 = n3 == null ? void 0 : n3.values) == null ? void 0 : _a2.length) && (e3.values = n3.values, e3.isSlice = n3.isSlice);
    }), a5 = i2;
  }
  const { timeExtent: s2 } = e;
  if (null != a5 && null != s2 && (null != s2.start || null != s2.end)) {
    a5 = a5.map((e3) => e3.clone());
    const e2 = (_c = (_b = i.variables.find(({ name: e3 }) => e3 === a5[0].variableName)) == null ? void 0 : _b.dimensions) == null ? void 0 : _c.find(({ name: e3 }) => "StdTime" === e3), n3 = a5.find(({ dimensionName: e3 }) => "StdTime" === e3);
...
function v(e, n2 = {}) {
  ...
  const { variableName: a5, multidimensionalSubset: s2, multidimensionalDefinition: r2 } = n2, l2 = null != r2 ? (_a = r2[0]) == null ? void 0 : _a.variableName : null, u2 = a5 || l2 || (i == null ? void 0 : i.DefaultVariable);
  let { variables: o3 } = t;
  ((_b = s2 == null ? void 0 : s2.variables) == null ? void 0 : _b.length) && (o3 = o3.filter(({ name: e2 }) => s2.variables.includes(e2)));
...
function b(e, n2 = {}) {
  ...
  for (let l2 = 0; l2 < s2.length; l2++) {
    ...
    let o3 = (t2 == null ? void 0 : t2[0]) ?? (u2 == null ? void 0 : u2[0]);
    "stdz" === e2.name.toLowerCase() && !e2.hasRanges && u2 && Math.abs(u2[1]) <= Math.abs(u2[0]) && (o3 = (t2 == null ? void 0 : t2.length) ? t2[t2.length - 1] : u2[1]), a5.push(new p({ variableName: r2, dimensionName: e2.name, values: [o3], isSlice: !n2.useRangeForRangedDimensionInfo || !!e2.hasRanges }));
  }
  return a5;
}
function y(e) {
...
function D(n2, t) {
  ...
  return ((_a = n2 == null ? void 0 : n2.variables) == null ? void 0 : _a.length) && (i = i.filter(({ name: e }) => n2.variables.includes(e)), i.forEach((t2) => {
...
function w(e) {
  ...
  if ("ISO8601" === e.unit) {
    const a6 = ((_b = e.intervalUnit) == null ? void 0 : _b.toLowerCase()) ?? "days";
...
//# sourceMappingURL=chunk-3OYC6UI5.js.map
