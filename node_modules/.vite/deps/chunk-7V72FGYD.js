...
async function J2(t, r3, n4, o2) {
  ...
  if (O.isCollection(t) && (t = t.toArray()), Array.isArray(t) && t.length && "object" == typeof t[0]) {
    ...
    if (e3 && a3 && r3 && r3.allLayerViews) {
      ...
      e4.forEach((t2, e5) => {
        var _a2;
        const o4 = (_a2 = r3.allLayerViews) == null ? void 0 : _a2.find((t3) => t3.layer.id === e5.id);
  ...
  if (Array.isArray(t) && 2 === t.length && "number" == typeof t[0] && "number" == typeof t[1]) a2 = new _(t);
    ...
    if (t.geometry) a2 = t.geometry;
      ...
      const e3 = t.layer, n5 = (_a = r3.allLayerViews) == null ? void 0 : _a.find((t2) => t2.layer.id === e3.id);
      if (n5 && "queryFeatures" in n5) {
        ...
        a2 = (_c = (_b = o3 == null ? void 0 : o3.features) == null ? void 0 : _b[0]) == null ? void 0 : _c.geometry;
      }
    }
  }
...
async function Y(e3, r3) {
  ...
  let l4 = null;
  (u4 == null ? void 0 : u4.targetGeometry) ? l4 = u4.targetGeometry : e3 instanceof z ? l4 = e3 : e3 instanceof c ? l4 = await J2(e3, r3, n4) : e3 && (l4 = await J2(e3.center, r3, n4) || await J2(e3.target, r3, n4) || await J2(e3, r3, n4)), !l4 && (i2 == null ? void 0 : i2.targetGeometry) ? l4 = i2.targetGeometry : !l4 && r3.extent && (l4 = r3.extent), n4 || (n4 = B2(r3.spatialReference || r3.extent || l4)), G2() || T(l4.spatialReference, n4) || J(l4.spatialReference, n4) || await L();
  const f4 = X(l4, n4), m3 = "center" in f4 ? f4.center : f4;
  false !== r3.pickClosestTarget && "point" === m3.type && "point" === ((_a = i2.targetGeometry) == null ? void 0 : _a.type) && (m3.x = L2(m3.x, i2.targetGeometry.x, m3.spatialReference));
  let y2 = 0;
  u4 ? y2 = u4.rotation : e3.hasOwnProperty("rotation") ? y2 = e3.rotation : i2 && (y2 = i2.rotation);
  let p3 = 0;
  p3 = null != (u4 == null ? void 0 : u4.targetGeometry) && "point" === u4.targetGeometry.type ? u4.scale : "scale" in e3 && e3.scale ? e3.scale : "zoom" in e3 && -1 !== e3.zoom && o2 && o2.effectiveLODs ? o2.zoomToScale(e3.zoom) : Array.isArray(l4) || "point" === l4.type || "extent" === l4.type && 0 === l4.width && 0 === l4.height ? i2.scale : H(X(l4.extent, n4), s4, y2);
...
function tt(t, e3, r3, n4, o2) {
  var _a;
  return xt(t, e3, r3.center), t.scale = H(r3, n4), (_a = o2 == null ? void 0 : o2.constraints) == null ? void 0 : _a.constrain(t), t;
}
...
function ot(t) {
  var _a;
  return t.scale * at((_a = t.targetGeometry) == null ? void 0 : _a.spatialReference);
}
function at(t) {
...
//# sourceMappingURL=chunk-7V72FGYD.js.map
