...
function d(n3, i3, t) {
  var _a;
  const a = "visualVariables" in n3 ? (_a = n3.visualVariables) == null ? void 0 : _a.find((e2) => "color" === e2.type) : n3;
  if (!a) return;
  if ("esri.renderers.visualVariables.ColorVariable" !== a.declaredClass) return void o("ColorVariable");
  const l2 = "number" == typeof i3, s2 = l2 ? null : i3, u3 = s2 == null ? void 0 : s2.attributes;
  let f2 = l2 ? i3 : null;
  ...
  if ("number" != typeof f2) if (v2) {
    if (null == (t == null ? void 0 : t.arcade)) return void c();
...
function v(e2, n3, i3) {
  var _a;
  const t = "visualVariables" in e2 ? (_a = e2.visualVariables) == null ? void 0 : _a.find((e3) => "opacity" === e3.type) : e2;
  if (!t) return;
  if ("esri.renderers.visualVariables.OpacityVariable" !== t.declaredClass) return void o("OpacityVariable");
  const a = "number" == typeof n3, l2 = a ? null : n3, s2 = l2 == null ? void 0 : l2.attributes;
  let u3 = a ? n3 : null;
  ...
  if ("number" != typeof u3) if (d2) {
    if (null == (i3 == null ? void 0 : i3.arcade)) return void c();
...
function m2(e2, n3, i3) {
  var _a;
  const t = "visualVariables" in e2 ? (_a = e2.visualVariables) == null ? void 0 : _a.find((e3) => "rotation" === e3.type) : e2;
  if (!t) return;
  if ("esri.renderers.visualVariables.RotationVariable" !== t.declaredClass) return void o("RotationVariable");
  const a = t.axis || "heading", r = "heading" === a && "arithmetic" === t.rotationType ? 90 : 0, l2 = "heading" === a && "arithmetic" === t.rotationType ? -1 : 1, s2 = "number" == typeof n3 ? null : n3, u3 = s2 == null ? void 0 : s2.attributes, f2 = t.field, { hasExpression: p2 } = t.cache;
...
function h(e2, n3, i3) {
  const t = "number" == typeof n3, a = t ? null : n3, l2 = a == null ? void 0 : a.attributes;
  let s2 = t ? n3 : null;
...
function V(e2, n3, i3) {
  var _a;
  const t = "visualVariables" in e2 ? (_a = e2.visualVariables) == null ? void 0 : _a.find((e3) => "size" === e3.type) : e2;
  if (!t) return;
...
function g(e2, n3, i3) {
  const t = e2.stops;
  let a = (t == null ? void 0 : t.length) && t[0].size;
...
function S(e2, n3, i3, t, a) {
  ...
  if (r === l2) return x((_a = n3.stops) == null ? void 0 : _a[r].size, i3, t);
  {
    const e3 = x((_b = n3.stops) == null ? void 0 : _b[r].size, i3, t), a2 = x((_c = n3.stops) == null ? void 0 : _c[l2].size, i3, t);
    return null == e3 || null == a2 ? null : e3 + (a2 - e3) * s2;
  }
}
function E(e2, n3, i3, t) {
  const r = ((t == null ? void 0 : t.resolution) ?? 1) * m[n3.valueUnit], l2 = x(n3.minSize, i3, t), s2 = x(n3.maxSize, i3, t), { valueRepresentation: o2 } = n3;
...
//# sourceMappingURL=chunk-FLKH6G5G.js.map
