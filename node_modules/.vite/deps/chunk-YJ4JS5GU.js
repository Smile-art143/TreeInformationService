...
import {
  h as h3,
  h2 as h4
} from "./chunk-ZRO75J36.js";
import {
  n as n6
} from "./chunk-4IT2QVEY.js";
import {
  i as i3
} from "./chunk-CT6RKCRZ.js";
import {
  r as r5,
  s as s3
...
__decorate([m({ constructOnly: true })], i4.prototype, "layer", void 0), __decorate([m()], i4.prototype, "enabled", void 0), __decorate([m()], i4.prototype, "updating", void 0), __decorate([m()], i4.prototype, "availability", void 0), __decorate([m()], i4.prototype, "sublayerSources", void 0), i4 = __decorate([a2("esri.views.interactive.snapping.FeatureSnappingLayerSource")], i4);
...
var q3 = class extends l {
  ...
  async _createSelfSnappingEngine(e8) {
    const [{ SelfSnappingEngine: t6 }, n11] = await Promise.all([import("./SelfSnappingEngine-BZ2PSVFM.js"), g4()]);
  ...
  async _createGridSnappingEngine(e8) {
    ...
    const { GridSnappingEngine: n11 } = await import("./GridSnappingEngine-TYYCG7T7.js");
    return s2(e8), { type: "grid", engine: new n11({ view: t6, options: this.options }) };
  }
  async _createFeatureSnappingEngine(e8) {
    const { FeatureSnappingEngine: t6 } = await import("./FeatureSnappingEngine-4RISEQIO.js");
    s2(e8);
...
__decorate([m({ constructOnly: true })], q3.prototype, "view", void 0), __decorate([m()], q3.prototype, "options", void 0), __decorate([m({ readOnly: true })], q3.prototype, "updating", null), __decorate([m()], q3.prototype, "_loadTask", void 0), __decorate([m()], q3.prototype, "_engines", void 0), __decorate([m()], q3.prototype, "_squaredMouseProximityThreshold", null), __decorate([m()], q3.prototype, "_squaredTouchProximityThreshold", null), q3 = __decorate([a2("esri.views.interactive.snapping.SnappingManager")], q3);
...
async function o2() {
  const e8 = await import("./geometryEngine-MWC24XJ3.js");
  return s4(e8);
}
function n7(t6) {
...
var a10 = class {
  ...
  onGraphicsChange(r9) {
    var _a2, _b;
    const { layer: t6 } = this;
    if ((_a2 = t6.sublayers) == null ? void 0 : _a2.length) return t((_b = t6.sublayers) == null ? void 0 : _b.toArray().map((e8) => a3(() => e8.graphics, "change", (e9) => r9(e9))));
  }
  has(r9) {
    var _a2;
    const { layer: e8 } = this;
...
var de2 = class extends l {
  ...
  initialize() {
    this.addHandles([a3(() => {
      ...
      this._defaultSnappingManager = u(this._defaultSnappingManager), e8 && (this.snappingManager || (this._defaultSnappingManager = new q3({ view: e8, options: this.snappingOptions })), "2d" === e8.type ? import("./editingTools-HXLYW7AI.js") : "3d" === e8.type && (import("./editingTools-RQY3PKLB.js"), import("./GraphicsLayerView3D-LPEHK27C.js")));
    }, w), l2(() => {
      var _a;
  ...
  async _makeDrawGraphicTool2D(e8) {
    const [t6, o3, a11] = await Promise.all([this._requireModule(import("./editingTools-HXLYW7AI.js")), u5(), c5()]);
  ...
  async _makeDrawGraphicTool3D(e8) {
    var _a;
    const [t6, o3, a11] = await Promise.all([this._requireModule(import("./editingTools-RQY3PKLB.js")), u5(), c5()]);
  ...
  async _setupMove3DOperation(e8, t6, o3, a11, i5 = false) {
    const [s7, n11] = await Promise.all([this._requireModule(import("./editingTools-RQY3PKLB.js")), c5()]);
    if (Ge(s7)) return s7;
  ...
  async _setupPointTransform3DOperation(e8, t6, o3) {
    const a11 = "transform", { enableRotation: i5, enableScaling: s7, enableZ: n11 } = t6, p7 = await this._requireModule(import("./editingTools-RQY3PKLB.js"));
    if (Ge(p7)) return p7;
  ...
  async _setupPolyTransform3DOperation(e8, t6, o3, a11 = false) {
    var _a, _b;
    const i5 = "transform", { enableRotation: s7, enableScaling: n11, enableZ: p7, preserveAspectRatio: l8 } = t6, [h7, c6] = await Promise.all([this._requireModule(import("./editingTools-RQY3PKLB.js")), c5()]);
    if (Ge(h7)) return h7;
  ...
  async _setupReshape3DOperation(e8, t6, o3, a11 = false) {
    const i5 = "reshape", [s7, n11, p7] = await Promise.all([this._requireModule(import("./editingTools-RQY3PKLB.js")), u5(), c5()]);
    if (Ge(s7)) return s7;
  ...
  async _getGraphicMover(e8, t6, o3) {
    const { enableMoveAllGraphics: a11, highlightOptions: i5 } = t6, r9 = await this._requireModule(import("./GraphicMover-SECFOOLX.js"));
  ...
  async _getBox(e8, t6, o3) {
    var _a, _b;
    const { enableRotation: a11, enableScaling: i5, highlightOptions: r9, preserveAspectRatio: s7 } = t6, [n11, p7] = await Promise.all([this._requireModule(import("./Box-YZTJZLNV.js")), c5()]);
  ...
  async _getReshape(e8, t6, o3) {
    const { highlightOptions: a11, reshapeOptions: i5 } = t6, r9 = "split" === (i5 == null ? void 0 : i5.edgeOperation), s7 = "move" === (i5 == null ? void 0 : i5.shapeOperation), n11 = !!(i5 == null ? void 0 : i5.enableCreateCurveFromStraightEdge), [p7, l8, h7] = await Promise.all([this._requireModule(import("./Reshape-XQ5PSAGU.js")), u5(), c5()]);
...
//# sourceMappingURL=chunk-YJ4JS5GU.js.map
