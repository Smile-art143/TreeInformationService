...
function $(e4) {
  return "esri.arcade.Pixel" === (e4 == null ? void 0 : e4.arcadeDeclaredClass);
}
function B(e4) {
...
function Ce(e4, t3, n4 = null, r4 = null) {
  ...
  return null != r4 && f4.some((e5) => {
    var _a;
    return e5[l4] === r4 && (i5 = (_a = e5.domains) == null ? void 0 : _a[u.name], i5 && "inherited" === i5.type && (i5 = Fe(u.name, t3), o2 = true), true);
  }), o2 || i5 || (i5 = Fe(e4, t3)), { field: u, domain: i5 };
}
function Fe(e4, t3) {
  let n4;
...
function we(e4, t3) {
  ...
  return (function e5(t4) {
    ...
    const u = a.push(t4) - 1, s4 = Object.keys(t4).sort(r4 == null ? void 0 : r4(t4));
...
var p2;
function f3(i5) {
  return null === i5 ? null : ne(i5) ? i5.clone() : V(i5) ? i5 : U(i5) ? i5.clone() : te(i5) ? i5.toArray().map((a) => f3(a)) : o(i5) ? i5.map((a) => f3(a)) : H(i5) ? p2.createFromArcadeFeature(i5) : X(i5) || B(i5) ? i5 : K(i5) || "esri.arcade.Attachment" === (i5 == null ? void 0 : i5.declaredClass) ? i5.deepClone() : ("esri.arcade.Portal" === (i5 == null ? void 0 : i5.declaredClass) || ee(i5) || i5 instanceof s2 || L(i5), i5);
}
...
var p3 = class _p {
  ...
  castAsJson(t3 = null) {
    ...
    for (let s4 in this.attributes) {
      ...
      void 0 !== r4 && ((t3 == null ? void 0 : t3.keyTranslate) && (s4 = t3.keyTranslate(s4)), e4[s4] = Ge(r4, t3));
    }
    return e4;
  }
  ...
  async castAsJsonAsync(e4 = null, s4 = null) {
    ...
    for (let o2 in this.attributes) {
      ...
      (s4 == null ? void 0 : s4.keyTranslate) && (o2 = s4.keyTranslate(o2)), void 0 !== u && (V(u) || u instanceof c || u instanceof m ? r4[o2] = Ge(u, s4) : i5.push(this.castDictionaryValueAsJsonAsync(r4, o2, u, e4, s4)));
    }
...
//# sourceMappingURL=chunk-AS7V7V2K.js.map
