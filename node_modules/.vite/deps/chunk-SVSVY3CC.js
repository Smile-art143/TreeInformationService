...
var i4 = class _i {
  ...
  decode(n15, s6, r14) {
    ...
    return new Promise((t8, d5) => {
      ...
      let _3;
      m6.src = v6, m6.onload = () => {
        if (URL.revokeObjectURL(v6), a2(r14)) return void d5(u());
...
var n5 = null;
function r5() {
  return n5 || (n5 = import("./lerc-wasm-HHBOTF6P.js").then((e7) => e7.l).then(({ default: t8 }) => t8({ locateFile: (t9) => n3(`esri/layers/support/rasterFormats/${t9}`) })).then((e7) => {
    l2(e7);
  }), n5);
}
...
var e3;
function o7() {
  return e3 ?? (e3 = import("./qb3-wasm-BNY3F3UU.js").then(({ default: n15 }) => n15({ locateFile: (n16) => n3(`esri/layers/support/rasterFormats/${n16}`) })).then((t8) => {
    u4(t8);
  })), e3;
}
...
var a8 = class {
  static decode(a16, n15) {
    const s6 = n15.pixelType, l6 = [], i12 = n15.width * n15.height, h6 = e4(a16, n15), { bandIds: c6, format: y5 } = n15, o13 = (c6 == null ? void 0 : c6.length) || e4(a16, n15), b5 = a16.byteLength - a16.byteLength % (i12 * t4(s6)), f6 = new s6(a16, 0, i12 * h6);
...
function p2(e7, t8) {
  var _a2;
  return (_a2 = e7.get(t8)) == null ? void 0 : _a2.values;
}
function d(e7, t8) {
  var _a2;
  return (_a2 = e7.get(t8)) == null ? void 0 : _a2.values;
...
function m2(e7, t8) {
  var _a2, _b;
  return (_b = (_a2 = e7.get(t8)) == null ? void 0 : _a2.values) == null ? void 0 : _b[0];
}
function y(e7, t8) {
  var _a2, _b;
  return (_b = (_a2 = e7.get(t8)) == null ? void 0 : _a2.values) == null ? void 0 : _b[0];
...
function N(e7, t8, n15, a16 = 0, i12 = false, r14 = 4) {
  ...
  if (I4 <= p5) {
    if (!t8) if (p5 <= 32) o13 >>>= 32 - I4;
      ...
      const e8 = (d5 == null ? void 0 : d5.length) ? d5[0] : o13 >>> 0, t9 = (d5 == null ? void 0 : d5.length) ? d5[1] : Math.round((o13 - e8) / g2);
...
function k(e7) {
  ...
  let h6 = null;
  (c6 == null ? void 0 : c6.length) && (h6 = c6.map((e8) => parseFloat(e8)), h6.some((e8) => isNaN(e8)) && (h6 = null));
  ...
  const K2 = v(e7).length === F2.length + 1, J = (F2 == null ? void 0 : F2.length) ? F2.map((e8) => ({ x: i12 / y(e8, "IMAGEWIDTH"), y: r14 / y(e8, "IMAGELENGTH") })) : void 0;
...
async function X(e7, t8) {
  ...
  return null != M4 ? g(L3, M4, { matchAllNoData: t8 == null ? void 0 : t8.matchAllNoData }) : O5 && b5 && t8.applyMinMaxConstraint && (L3.mask = R(m6, O5, b5)), L3;
}
async function K(e7, t8 = {}) {
  ...
  if (null != u11) {
    g(o13, u11, { matchAllNoData: null == s6 && (t8 == null ? void 0 : t8.matchAllNoData) });
  }
  return o13;
}
...
async function b2(e7, s6) {
  ...
  return (p5 == null ? void 0 : p5.length) || y5.updateStatistics(), y5;
}
...
async function R2(e7, i12 = {}, s6) {
  ...
  let r14 = (_a2 = i12.format) == null ? void 0 : _a2.toLowerCase();
  ...
  } else o13 = await n15(e7, { ...i12, offset: (h6 == null ? void 0 : h6[0]) ?? i12.offset });
...
var n8 = new o2({ none: "none", standardDeviation: "standard-deviation", histogramEqualization: "histogram-equalization", minMax: "min-max", percentClip: "percent-clip", sigmoid: "sigmoid" });
...
function f3(t8, n15, e7) {
  ...
  const m6 = (e7 == null ? void 0 : e7.histogramSize) ?? 256, f6 = !!(e7 == null ? void 0 : e7.pixelType) && ["u8", "s8", "u4", "u2", "u1"].includes(e7.pixelType), g4 = !(e7 == null ? void 0 : e7.skipHistograms);
  if (null == l6) {
...
function k3(t8, n15) {
  const { pixels: e7, mask: s6, pixelType: i12, bandMasks: o13 } = t8, a16 = e7.map((t9, e8) => f3(t9, (o13 == null ? void 0 : o13[e8]) ?? s6, { pixelType: i12, ...n15 }));
  return { statistics: a16.map(({ statistics: t9 }) => t9), histograms: a16.map(({ histogram: t9 }) => t9) };
}
function y3(t8) {
  var _a2;
  if (!((_a2 = t8 == null ? void 0 : t8.pixels) == null ? void 0 : _a2.length)) return null;
  ...
  for (let f6 = 0; f6 < a16; f6++) {
    ...
    const h6 = n15[f6], d5 = (s6 == null ? void 0 : s6[f6]) ?? e7;
    if ("u8" === i12) {
      if (c6 = 255, m6 = 0, d5) {
...
function b3(n15, i12) {
  ...
  if ("number" == typeof f6 && (f6 = a9[f6]), n15.dra) if ("minMax" === f6 && (o13 == null ? void 0 : o13.statistics)) c6 = o13.statistics.map((t8) => [t8.minValue, t8.maxValue, 0, 0]);
  else {
    const t8 = y3(o13);
    c6 = null != t8 ? t8.statistics : null, m6 = null != t8 ? t8.histograms : null;
  }
  else c6 = ((_a2 = n15.statistics) == null ? void 0 : _a2.length) ? n15.statistics : u11.statistics, m6 = "histograms" in n15 ? n15.histograms : void 0, m6 || (m6 = u11.histograms);
  "percentClip" !== f6 && "histogramEqualization" !== f6 || (m6 == null ? void 0 : m6.length) || (f6 = "minMax");
  const h6 = (c6 == null ? void 0 : c6.length) || (m6 == null ? void 0 : m6.length) || u11.bandCount, d5 = [], g4 = [];
...
function z2(t8, e7) {
  var _a2;
  if (!((_a2 = t8 == null ? void 0 : t8.pixels) == null ? void 0 : _a2.length)) return t8;
  ...
  if (v6) {
    ...
    for (let n15 = 0; n15 < p5; n15++) {
      const e8 = (i12 == null ? void 0 : i12[n15]) ?? s6;
    ...
    const t9 = (i12 == null ? void 0 : i12[n15]) ?? s6;
...
var m4 = u7 = class extends n2 {
  ...
  get dataType() {
    var _a2, _b;
    const t8 = ((_b = (_a2 = this.keyProperties) == null ? void 0 : _a2.DataType) == null ? void 0 : _b.toLowerCase()) ?? "generic";
  ...
  get hasMultidimensionalTranspose() {
    var _a2;
    return !!((_a2 = this.storageInfo) == null ? void 0 : _a2.transposeInfo);
  }
  get sensorInfo() {
    var _a2;
    if ((_a2 = this.keyProperties) == null ? void 0 : _a2.SensorName) return u6.fromJSON(this.keyProperties);
  }
  clone() {
...
function o11(t8, e7) {
  ...
  const p5 = e7 == null ? void 0 : e7.curvatureType;
...
function p4(o13) {
  ...
  if ("multipart" === o13.type) {
    const r14 = o13.clone();
    return ((_a2 = r14.colorRamps) == null ? void 0 : _a2.length) ? (r14.colorRamps = r14.colorRamps.reverse().map((o14) => g3(o14)), r14) : r14;
  }
  return g3(o13);
}
function u9(o13, r14) {
  ...
  if ("algorithmic" === o13.type) {
    ...
    return (_a2 = t8.find((o14) => a14(r15, o14.fromColor) && a14(l7, o14.toColor))) == null ? void 0 : _a2.id;
  }
  if ((_b = o13.weights) == null ? void 0 : _b.length) return;
  const l6 = (_c = o13.colorRamps) == null ? void 0 : _c.map((o14) => ({ fromColor: o14.fromColor.toRgb(), toColor: o14.toColor.toRgb() }));
  return (_d = t8.find((o14) => {
...
function s5(o13, r14 = false) {
  var _a2;
  const t8 = "string" == typeof o13 ? o13 : (_a2 = f5(o13, void 0, r14)) == null ? void 0 : _a2.id;
...
function k4(o13, r14) {
  ...
  if (r14 ?? (r14 = t8.map(({ start: o14, stop: r15 }) => null == o14 || null == r15 ? -1 : r15 - o14)), r14.length !== t8.length || r14.some((o14) => o14 < 0)) return Array.from({ length: t8.length }, () => 1 / t8.length);
  const l6 = r14.reduce((o14, r15) => o14 + r15);
  return r14.map((o14) => o14 / l6);
}
function R3(o13, r14) {
  const { numColors: t8, interpolateAlpha: l6 } = c5(r14), e7 = k4(o13, r14 == null ? void 0 : r14.weights), { colorRamps: i12 } = o13, n15 = [], C5 = 1 / (t8 - 1);
  let m6 = 0, a16 = false;
...
function B3(o13, r14) {
  const t8 = w4(o13, r14), l6 = r14 == null ? void 0 : r14.interpolateAlpha;
...
function A3(o13) {
  ...
  return { Algorithm: (r14 == null ? void 0 : r14.Algorithm) || "esriHSVAlgorithm", type: "AlgorithmicColorRamp", FromColor: I3(o13.fromColor), ToColor: I3(o13.toColor) };
}
function G2(o13) {
  const r14 = s5(o13);
  if (!r14) return null;
...
function n14(n15) {
  var _a2, _b, _c;
  return ["u8", "s8"].includes(n15.pixelType) && null != ((_b = (_a2 = n15.statistics) == null ? void 0 : _a2[0]) == null ? void 0 : _b.min) && null != ((_c = n15.statistics[0]) == null ? void 0 : _c.max) && 1 === n15.bandCount;
}
function t7(t8, e7) {
...
function u10(n15, t8 = false) {
  ...
  return 1 === e7 && (!!(u11 == null ? void 0 : u11.length) || !t8 && "u8" === r14);
}
...
var O4 = class extends n2 {
  ...
  _symbolizeStretch(e7, t8) {
    ...
    if (p5 && (t8 = null), "histogramEqualization" === n15.stretchType) {
      const a17 = p5 ? null : s6.histogramLut, o14 = b3(n15, { rasterInfo: r14, pixelBlock: e7, bandIds: t8, returnHistogramLut: !a17 }), i12 = "u8" === r14.pixelType && !p5 && a10((_a2 = r14.histograms) == null ? void 0 : _a2[0]) ? e7 : z2(e7, { ...o14, gamma: b5, isRenderer: true });
      c6 = f2(i12, { lut: p5 ? o14.histogramLut : (t8 == null ? void 0 : t8.length) ? t8.map((e8) => a17[e8]) : a17, offset: 0 });
    } else if (l6) {
      let i12;
      if (p5) {
      ...
      if (!i12) return e7;
      o13 > 1 && null != t8 && t8.length === (e7 == null ? void 0 : e7.pixels.length) && i12.lut.length === o13 && (i12 = { lut: t8.map((e8) => i12.lut[e8]), offset: i12.offset }), c6 = f2(e7, i12);
    } else {
      const s7 = b3(n15, { rasterInfo: r14, pixelBlock: e7, bandIds: t8 });
  ...
  _symbolizeShadedRelief(e7, t8) {
    ...
    if (!o13) return a16;
    const n15 = ((_a2 = this.rasterInfo.statistics) == null ? void 0 : _a2[0]) ?? { min: 0, max: 8e3 };
  ...
  _updateUVRenderer(e7) {
    ...
    if (null != r14) {
      ...
      r14.features.forEach((r15) => {
        var _a3, _b;
        const s7 = (_a3 = e7.uniqueValueInfos) == null ? void 0 : _a3.find((e8) => String(e8.value) === String(r15.attributes[a16])), n16 = (_b = s7 == null ? void 0 : s7.symbol) == null ? void 0 : _b.color;
      ...
      (_a2 = e7.uniqueValueInfos) == null ? void 0 : _a2.forEach((e8) => {
        var _a3;
        const t9 = (_a3 = e8 == null ? void 0 : e8.symbol) == null ? void 0 : _a3.color;
        t9 ? i12.push([parseInt("" + e8.value, 10)].concat(t9)) : o13 && i12.push([parseInt("" + e8.value, 10)].concat(o13 == null ? void 0 : o13.color));
      });
    }
    ...
    return this.lookup = { rendererJSON: e7, colormapLut: l6 }, this.canRenderInWebGL = a15(l6 == null ? void 0 : l6.indexedColormap), { success: true };
  }
  _updateColormapRenderer(e7) {
    ...
    return this.lookup = { rendererJSON: e7, colormapLut: r14 }, this.canRenderInWebGL = a15(r14 == null ? void 0 : r14.indexedColormap), { success: true };
  }
  ...
  _analyzeClassBreaks(e7) {
    const { attributeTable: t8, pixelType: r14 } = this.rasterInfo, s6 = t8 == null ? void 0 : t8.fields.find((e8) => "value" === e8.name.toLowerCase()), a16 = t8 == null ? void 0 : t8.fields.find((t9) => t9.name.toLowerCase() === e7.field.toLowerCase()), o13 = null != s6 && null !== a16;
  ...
  _updateClassBreaksRenderer(e7) {
    ...
    if (!(o13 == null ? void 0 : o13.length)) return { success: false, error: "Unsupported renderer; missing or invalid ClassBreaksRenderer.classBreakInfos." };
    ...
    return this.lookup = { rendererJSON: e7, colormapLut: d5 }, this.canRenderInWebGL = a15(d5 == null ? void 0 : d5.indexedColormap), { success: true };
  }
  _updateStretchRenderer(e7) {
    var _a2, _b;
    let { stretchType: t8, dra: r14 } = e7;
    if (!("none" === t8 || ((_a2 = e7.statistics) == null ? void 0 : _a2.length) || v5(this.rasterInfo.statistics) || r14)) return { success: false, error: "Unsupported renderer; StretchRenderer.customStatistics is required when dynamic range adjustment is not used." };
    const s6 = e7.histograms || this.rasterInfo.histograms;
    !V2(e7.stretchType) || (s6 == null ? void 0 : s6.length) || r14 || (t8 = "minMax");
    const { computeGamma: a16, useGamma: o13, colorRamp: n15 } = e7;
    let { gamma: i12 } = e7;
    if (o13 && a16 && !(i12 == null ? void 0 : i12.length)) {
    ...
    return this.lookup.gamma = o13 && (i12 == null ? void 0 : i12.length) ? i12 : null, this.canRenderInWebGL = "histogramEqualization" !== t8, { success: true };
  }
  ...
  _generateStretchWebGLParams(e7, t8, r14) {
    const { colormapLut: s6 } = this.lookup, a16 = t8.colorRamp ? s6 == null ? void 0 : s6.indexedColormap : null, o13 = t8.colorRamp ? s6 == null ? void 0 : s6.offset : null;
    "histogramEqualization" === t8.stretchType && (t8 = { ...t8, stretchType: "minMax" });
    const { gamma: n15 } = this.lookup, i12 = !(!t8.useGamma || !(n15 == null ? void 0 : n15.some((e8) => 1 !== e8)));
    let l6 = 0;
    null != e7 && (l6 = e7.getPlaneCount(), 2 === l6 && ((e7 = e7.clone()).statistics = [e7.statistics[0]], e7.pixels = [e7.pixels[0]]));
    const { bandCount: u11 } = this.rasterInfo, c6 = Math.min(3, (r14 == null ? void 0 : r14.length) || l6 || u11, u11), p5 = a16 || i12 ? 1 : 255, d5 = new Float32Array(c6);
  ...
  _generateShadedReliefWebGLParams(e7, t8 = false, r14 = { x: 0, y: 0 }) {
    var _a2;
    const { colormapLut: s6 } = this.lookup, a16 = e7.colorRamp ? s6 == null ? void 0 : s6.indexedColormap : null, o13 = e7.colorRamp ? s6 == null ? void 0 : s6.offset : null, n15 = { ...e7, isGCS: t8, resolution: r14 }, i12 = a13(n15), l6 = (_a2 = this.rasterInfo.statistics) == null ? void 0 : _a2[0];
    return { ...i12, minValue: (l6 == null ? void 0 : l6.min) ?? 0, maxValue: (l6 == null ? void 0 : l6.max) ?? 8e3, hillshadeType: "traditional" === e7.hillshadeType ? 0 : 1, type: "hillshade", colormap: a16, colormapOffset: o13 };
  }
  _generateVectorFieldWebGLParams(e7) {
    var _a2, _b, _c;
    const { style: t8, inputUnit: r14, outputUnit: s6, visualVariables: a16, symbolTileSize: o13, flowRepresentation: n15 } = e7, i12 = ((_a2 = this.rasterInfo.statistics) == null ? void 0 : _a2[0].min) ?? 0, l6 = ((_b = this.rasterInfo.statistics) == null ? void 0 : _b[0].max) ?? 50, u11 = (a16 == null ? void 0 : a16.find((e8) => "sizeInfo" === e8.type)) ?? { maxDataValue: l6, maxSize: 0.8 * o13, minDataValue: i12, minSize: 0.2 * o13 }, c6 = u11.minDataValue ?? i12, p5 = u11.maxDataValue ?? l6, d5 = null != u11.maxSize && null != u11.minSize ? [u11.minSize / o13, u11.maxSize / o13] : [0.2, 0.8];
    if ("wind_speed" === t8) {
    ...
    const f6 = "flow_to" === n15 === ("ocean_current_kn" === t8 || "ocean_current_m" === t8) ? 0 : Math.PI, b5 = a16 == null ? void 0 : a16.find((e8) => "rotationInfo" === e8.type);
    return { breakValues: h6, dataRange: m6, inputUnit: r14, outputUnit: s6, symbolTileSize: o13, symbolPercentRange: d5, style: t8 || "single_arrow", rotation: f6, rotationType: ((_c = this.rasterInfo.storageInfo) == null ? void 0 : _c.tileInfo) && "vector-uv" === this.rasterInfo.dataType ? "geographic" : (b5 == null ? void 0 : b5.rotationType) || e7.rotationType, type: "vectorField" };
  }
};
function V2(e7) {
...
__decorate([m({ json: { write: true } })], O4.prototype, "rendererJSON", void 0), __decorate([m({ type: m4, json: { write: true } })], O4.prototype, "rasterInfo", void 0), __decorate([m({ json: { write: true } })], O4.prototype, "lookup", void 0), __decorate([m()], O4.prototype, "canRenderInWebGL", void 0), O4 = __decorate([a3("esri.renderers.support.RasterSymbolizer")], O4);
...
//# sourceMappingURL=chunk-SVSVY3CC.js.map
