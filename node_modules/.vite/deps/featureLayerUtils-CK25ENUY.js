...
function $2(e, r) {
  ...
  return (r == null ? void 0 : r.isTable) && (a.layerContainerType = "tables"), a;
}
function j(e) {
  const r = $2(e), a = $2(e);
...
async function H(e) {
  ...
  e.forEach(({ type: e2 }) => {
    switch (l2(e2)) {
      case "CatalogLayer":
        r.push(import("./CatalogLayer-JT7B45HM.js").then((e3) => e3.default));
        break;
      case "FeatureLayer":
        r.push(import("./FeatureLayer-FJGPCTQR.js").then((e3) => e3.default));
        break;
      case "OrientedImageryLayer":
        r.push(import("./OrientedImageryLayer-TFRBW5YI.js").then((e3) => e3.default));
    }
  });
...
function ee(e) {
  var _a, _b, _c, _d;
  if (!("layerType" in e)) return !!((_a = e.charts) == null ? void 0 : _a.length);
  switch (e.layerType) {
    case "OrientedImageryLayer":
      return !!((_b = e.charts) == null ? void 0 : _b.length);
    case "SubtypeGroupLayer":
      return !!e.layers.some((e2) => {
        var _a2;
        return !!((_a2 = e2.charts) == null ? void 0 : _a2.length);
      });
    case "SubtypeGroupTable":
      return !!e.tables.some((e2) => {
        var _a2;
        return !!((_a2 = e2.charts) == null ? void 0 : _a2.length);
      });
    case "CatalogLayer":
      return !!((_d = (_c = e.footprintLayer) == null ? void 0 : _c.charts) == null ? void 0 : _d.length);
  }
}
function re(e, r) {
...
async function ne(e, r, a) {
  ...
  r.url = ("FeatureServer" === (i2 == null ? void 0 : i2.serverType) ? t : `${t}/${n2}`) ?? null, r.title || (r.title = s3), r.extent = null, l3 || null == o2 || (r.extent = await l(o2)), ae([e], r, a);
}
function se(e, r) {
  for (const o2 of e) {
    const a2 = o2.parsedUrl.path, n3 = p(a2), s4 = n3 == null ? void 0 : n3.url.path;
    if (!s4) throw new s(`${r}:invalid-parameters`, m(o2, `has unsupported url pattern: ${a2}`), { layer: o2 });
    const l3 = n3 == null ? void 0 : n3.serverType;
  ...
  const a = p(e[0].parsedUrl.path), n2 = a == null ? void 0 : a.url.path, s3 = e.every((e2) => {
    const r2 = p(e2.parsedUrl.path);
    return (r2 == null ? void 0 : r2.url.path) === n2;
  });
...
async function ie(e, r, t) {
  ...
  if (r.url = "FeatureServer" === (o2 == null ? void 0 : o2.serverType) ? o2.url.path : s3, r.title || (r.title = o2.title), r.extent = null, n2 > 0) {
...
//# sourceMappingURL=featureLayerUtils-CK25ENUY.js.map
