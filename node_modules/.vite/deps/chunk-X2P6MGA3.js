...
var p = (() => {
  const e5 = /* @__PURE__ */ new Map(), o6 = new ResizeObserver((t9) => {
    var _a;
    t4();
    for (const n7 of t9) (_a = e5.get(n7.target)) == null ? void 0 : _a(n7);
  ...
  return (e6, o7, c4) => {
    ...
    return t([l2(() => "function" == typeof e6 ? e6() : e6, (e7) => {
      a3 == null ? void 0 : a3.remove(), e7 && (a3 = s3(e7, o7, c4));
    }, w), e(() => a3 == null ? void 0 : a3.remove())]);
  };
})();
function L(e5) {
  const t9 = e5 == null ? void 0 : e5.closest("[dir]");
...
async function j(e5, t9) {
  await U(l(t9));
  const n7 = "function" == typeof e5 ? e5() : e5;
  n7 && ("setFocus" in n7 && "function" == typeof n7.setFocus ? await n7.setFocus() : n7 instanceof HTMLElement && n7.focus());
}
...
function d(e5, t9) {
  let r2 = t9.children;
  if (r2 == null ? void 0 : r2.length) for (let o6 = 0; o6 < r2.length; ++o6) r2[o6] = d(e5, r2[o6]);
  else r2 = o2;
  const i5 = t9.vnodeSelector;
  if (f(i5)) {
    const o6 = t9.properties || n2, d5 = o6.key || i5, f3 = { key: d5, afterCreate: c2, afterUpdate: s, afterRemoved: a, parentWidget: e5, widgetConstructor: i5, widgetProperties: { ...o6, key: d5, children: r2 } };
...
function c2(t9, o6, n7, { parentWidget: d5, widgetConstructor: c4, widgetProperties: s3 }) {
  var _a;
  const f3 = new c4(s3);
  f3.container = t9, i.set(t9, f3), (_a = f3.afterCreate) == null ? void 0 : _a.call(f3, f3, t9), d5.addHandles(e(() => a(t9))), queueMicrotask(() => {
    var _a2;
    (_a2 = f3[e3].projector) == null ? void 0 : _a2.renderNow();
  });
}
...
function a(e5) {
  var _a;
  const t9 = i.get(e5);
  t9 && ((_a = t9.afterRemoved) == null ? void 0 : _a.call(t9, t9, e5), t9.destroy(), i.delete(e5));
}
function f(e5) {
...
//# sourceMappingURL=chunk-X2P6MGA3.js.map
