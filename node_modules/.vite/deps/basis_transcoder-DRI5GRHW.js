...
var r;
var _a;
var e = (r = "undefined" != typeof document ? (_a = document.currentScript) == null ? void 0 : _a.src : void 0, function(e2 = {}) {
  ...
  function D(r2) {
    var _a2;
    E++, (_a2 = a.monitorRunDependencies) == null ? void 0 : _a2.call(a, E);
  }
  function x(r2) {
    var _a2;
    if (E--, (_a2 = a.monitorRunDependencies) == null ? void 0 : _a2.call(a, E), 0 == E && R) {
      var e3 = R;
      R = null, e3();
    }
  }
  function I(r2) {
    var _a2;
    (_a2 = a.onAbort) == null ? void 0 : _a2.call(a, r2), d(r2 = "Aborted(" + r2 + ")"), b = true, r2 += ". Build with -sASSERTIONS for more info.";
  ...
  function M(r2) {
    return !l && i && "function" == typeof fetch ? fetch(r2, { credentials: "same-origin" }).then((e3) => {
  ...
  function q(r2, e3, t2, n2) {
    return r2 || "function" != typeof WebAssembly.instantiateStreaming || U(e3) || "function" != typeof fetch ? z(e3, t2, n2) : fetch(e3, { credentials: "same-origin" }).then((r3) => WebAssembly.instantiateStreaming(r3, t2).then(n2, function(r4) {
  ...
  var er, tr, nr, ar = {}, or = {}, ir = {}, sr = (r2) => {
    ...
    ur([r2], o2, (r3) => {
      ...
      return a2.forEach((e4, t3) => {
        ...
        o3[n3] = { read: (r4) => i2.fromWireType(s2(u2, r4)), write: (r4, e5) => {
          var t4 = [];
      ...
      }, argPackAdvance: mr, readValueFromPointer: rr, destructorFunction: n2 }];
    });
  }, lr = (r2, e3, t2, n2, a2) => {
  }, pr = () => {
  ...
  var yr, mr = 8, gr = (r2, e3, t2, n2) => {
    vr(r2, { name: e3 = hr(e3), fromWireType: function(r3) {
      return !!r3;
    }, toWireType: function(r3, e4) {
      return e4 ? t2 : n2;
    }, argPackAdvance: mr, readValueFromPointer: function(r3) {
      return this.fromWireType(v[r3]);
    }, destructorFunction: null });
  }, $r = (r2) => ({ count: r2.count, deleteScheduled: r2.deleteScheduled, preservePointerOnDelete: r2.preservePointerOnDelete, ptr: r2.ptr, ptrType: r2.ptrType, smartPtr: r2.smartPtr, smartPtrType: r2.smartPtrType }), wr = (r2) => {
    function e3(r3) {
    ...
    return e3;
  }, Dr = (r2, e3) => (e3 = Rr(r2, e3), Er[e3]), xr = (r2, e3) => (e3.ptrType && e3.ptr || sr("makeClassHandle requires ptr and ptrType"), !!e3.smartPtrType != !!e3.smartPtr && sr("Both smartPtrType and smartPtr must be specified"), e3.count = { value: 1 }, Vr(Object.create(r2, { $$: { value: e3, writable: true } })));
  function Ir(r2) {
    ...
    function a2() {
      return this.isSmartPointer ? xr(this.registeredClass.instancePrototype, { ptrType: this.pointeeType, ptr: e3, smartPtrType: this, smartPtr: r2 }) : xr(this.registeredClass.instancePrototype, { ptrType: this, ptr: r2 });
    }
    ...
    return null === u2 ? a2.call(this) : this.isSmartPointer ? xr(o2.registeredClass.instancePrototype, { ptrType: o2, ptr: u2, smartPtrType: this, smartPtr: r2 }) : xr(o2.registeredClass.instancePrototype, { ptrType: o2, ptr: u2 });
  }
  var Vr = (r2) => "undefined" == typeof FinalizationRegistry ? (Vr = (r3) => r3, r2) : (Tr = new FinalizationRegistry((r3) => {
    ...
    Object.assign(Ur.prototype, { isAliasOf(r2) {
      ...
      var r2 = Vr(Object.create(Object.getPrototypeOf(this), { $$: { value: $r(this.$$) } }));
  ...
  var Br = (r2, e3) => Object.defineProperty(e3, "name", { value: r2 }), Nr = (r2, e3, t2) => {
  ...
  var Xr = () => {
    Object.assign(Yr.prototype, { getPointee(r2) {
      return this.rawGetPointee && (r2 = this.rawGetPointee(r2)), r2;
    }, destructor(r2) {
      var _a2;
      (_a2 = this.rawDestructor) == null ? void 0 : _a2.call(this, r2);
    }, argPackAdvance: mr, readValueFromPointer: rr, fromWireType: Ir });
  };
  ...
  var re, ee, te = (r2, e3, t2) => {
    ...
    l2 = hr(l2), o2 = ue(a2, o2), s2 && (s2 = ue(i2, s2)), c2 && (c2 = ue(u2, c2)), h2 = ue(p2, h2);
    var d2 = Gr(l2);
    Mr(d2, function() {
      ...
      }), u3 = Object.create(a3, { constructor: { value: i3 } });
      i3.prototype = u3;
      var p3 = new Lr(l2, i3, u3, h2, t3, o2, s2, c2);
      p3.baseClass && ((_a2 = p3.baseClass).__derivedClasses ?? (_a2.__derivedClasses = []), p3.baseClass.__derivedClasses.push(p3));
      var f2 = new Yr(l2, p3, true, false, false), v2 = new Yr(l2 + "*", p3, false, false, false), y2 = new Yr(l2 + " const*", p3, false, true, false);
      return Wr[r2] = { pointerType: v2, constPointerType: y2 }, te(d2, i3), [f2, v2, y2];
    });
  }, de = (r2, e3) => {
...
`, p2.push(`${h2}_dtor`));
  ...
  var ge = (r2, e3, t2, n2, a2, o2) => {
  ...
  }, _e = { toValue: (r2) => (r2 || dr("Cannot use deleted val. handle = " + r2), Ce[r2]), toHandle: (r2) => {
    switch (r2) {
      case void 0:
        return 2;
      case null:
  ...
  } }, Fe = { name: "emscripten::val", fromWireType: (r2) => {
    var e3 = _e.toValue(r2);
    return Pe(r2), e3;
  }, toWireType: (r2, e3) => _e.toHandle(e3), argPackAdvance: mr, readValueFromPointer: rr, destructorFunction: null }, Se = (r2) => vr(r2, Fe), Oe = (r2, e3, t2) => {
    switch (e3) {
      case 1:
    ...
    e3 = hr(e3), a2.values = {}, vr(r2, { name: e3, constructor: a2, fromWireType: function(r3) {
      return this.constructor.values[r3];
    }, toWireType: (r3, e4) => e4.value, argPackAdvance: mr, readValueFromPointer: Oe(e3, t2, n2), destructorFunction: null }), Mr(e3, a2);
  }, ke = (r2, e3) => {
    var t2 = or[r2];
    ...
    var n2 = ke(r2, "enum");
    e3 = hr(e3);
    var a2 = n2.constructor, o2 = Object.create(n2.constructor.prototype, { value: { value: t2 }, constructor: { value: Br(`${n2.name}_${e3}`, function() {
    }) } });
    ...
    vr(r2, { name: e3 = hr(e3), fromWireType: (r3) => r3, toWireType: (r3, e4) => e4, argPackAdvance: mr, readValueFromPointer: De(e3, t2), destructorFunction: null });
    ...
    vr(r2, { name: e3, fromWireType: o2, toWireType: s2 ? function(r3, e4) {
      return u2(e4, this.name), e4 >>> 0;
    } : function(r3, e4) {
      return u2(e4, this.name), e4;
    }, argPackAdvance: mr, readValueFromPointer: Ve(e3, t2, 0 !== n2), destructorFunction: null });
  }, Ue = (r2, e3, t2) => {
    ...
    vr(r2, { name: t2 = hr(t2), fromWireType: a2, argPackAdvance: mr, readValueFromPointer: a2 }, { ignoreDuplicateRegistrations: true });
  }, Be = (r2, e3, t2, n2) => {
    if (!(n2 > 0)) return 0;
    ...
    }, argPackAdvance: mr, readValueFromPointer: rr, destructorFunction(r3) {
      xt(r3);
    } });
    ...
    if (t2 ?? (t2 = 2147483647), t2 < 2) return 0;
    ...
    if (t2 ?? (t2 = 2147483647), t2 < 4) return 0;
    ...
    var n2, a2, o2, i2;
    t2 = hr(t2), 2 === e3 ? (n2 = Ke, a2 = Qe, i2 = Ze, o2 = (r3) => m[r3 >> 1]) : 4 === e3 && (n2 = Xe, a2 = Ye, i2 = rt, o2 = (r3) => $[r3 >> 2]), vr(r2, { name: t2, fromWireType: (r3) => {
    ...
    X[r2] = { name: hr(e3), rawConstructor: ue(t2, n2), rawDestructor: ue(a2, o2), fields: [] };
  }, nt = (r2, e3, t2, n2, a2, o2, i2, s2, u2, c2) => {
    X[r2].fields.push({ fieldName: hr(e3), getterReturnType: t2, getter: ue(n2, a2), getterContext: o2, setterArgumentType: i2, setter: ue(s2, u2), setterContext: c2 });
  }, at = (r2, e3) => {
    vr(r2, { isVoid: true, name: e3 = hr(e3), argPackAdvance: 0, fromWireType: () => {
    }, toWireType: (r3, e4) => {
    } });
...
`, a2.isVoid || (u2.push("emval_returnValue"), c2.push(it), o2 += "  return emval_returnValue(retType, destructorsRef, rv);\n"), o2 += "};\n", u2.push(o2);
  ...
  var jt, kt = { K: Q, G: Z, s: cr, C: lr, I: gr, w: he, v: ge, d: we, m: Te, H: Se, o: je, a: Ee, A: xe, k: Ie, l: He, f: Ue, z: Le, u: et, t: tt, c: nt, J: at, F: ot, n: st, q: ct, p: ht, b: Pe, x: ft, i: mt, r: gt, g: $t, j: wt, h: Tt, e: bt, D: At, E: Wt, B: _t, y: Ot }, Et = L(), Rt = (r2) => (Rt = Et.N)(r2), Dt = (r2) => (Dt = Et.O)(r2), xt = (r2) => (xt = Et.P)(r2), It = (r2) => (It = Et.R)(r2);
  function Vt() {
    function r2() {
...
//# sourceMappingURL=basis_transcoder-DRI5GRHW.js.map
