...
var p = class _p {
  static async create(e3, r2, i2, n) {
    ...
    const u2 = { vars: n.reduce((e4, t2) => ({ ...e4, [t2]: null }), {}), spatialReference: r2, useAsync: false }, d = s2.compileScript(c, u2);
    let h2 = null;
    null != i2 && (h2 = new o(i2), h2.immutable = true);
    const m3 = new o();
    return m3.immutable = false, m3.setField("scale", 0), new _p(e3, s2, c, d, r2, m3, h2, o);
  }
  ...
  evaluate(t2, r2) {
    var _a;
    const i2 = (_a = r2.$view) == null ? void 0 : _a.timeZone;
    if (r2.$view) {
      let t3;
      if (this._viewDict.setField("scale", r2.$view.scale), null != r2.$view.timeProperties) {
        ...
        t3 = new this._dictionaryCtor({ currentStart: null != n ? null != i2 ? m.epochToArcadeDate(n, i2) : m.unknownEpochToArcadeDate(n) : void 0, currentEnd: null != s2 ? null != i2 ? m.epochToArcadeDate(s2, i2) : m.unknownEpochToArcadeDate(s2) : void 0, startIncluded: true, endIncluded: true });
      }
...
var f2 = class {
  ...
  castAsJson(e3 = null) {
    var _a;
    return { attributes: this._boundTarget.attributes, geometry: true === (e3 == null ? void 0 : e3.keepGeometryType) ? this.geometry() : ((_a = this.geometry()) == null ? void 0 : _a.toJSON()) ?? null };
  }
...
//# sourceMappingURL=chunk-VZ2XIRJY.js.map
