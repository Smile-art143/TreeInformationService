import {
  i as i3,
  o as o4
} from "./chunk-CEU3QQBR.js";
import "./chunk-YQIZW7B4.js";
...
var u3 = class extends b {
  get _sortedTilesCoveringView() {
    var _a, _b;
    const e5 = (((_b = (_a = this.view.featureTiles) == null ? void 0 : _a.tiles) == null ? void 0 : _b.toArray()) ?? []).map(a4), t3 = this._effectivePointOfInterest;
...
var d3 = class extends b {
  ...
  update() {
    ...
    t3.forEach((m5, u6) => {
      ...
      n3.delete(d4);
      const g4 = ((_a = m5.measures) == null ? void 0 : _a.lodLevel) ?? m5.level, f = m5.geometry;
...
var u5 = class extends b {
  ...
  async setup(e5, t3) {
    ...
    if (null == o5) return;
    const i4 = { configuration: h4(e5.configuration), serviceInfo: o5, spatialReference: e5.spatialReference.toJSON(), hasZ: this.hasZ, elevationInfo: (_a = e5.layer.elevationInfo) == null ? void 0 : _a.toJSON() };
  ...
  async fetchCandidates(e5, t3) {
    const { point: o5, filter: i4, coordinateHelper: n3 } = e5, a6 = { ...e5, point: t(o5[0], o5[1], o5[2], n3.spatialReference.toJSON()), filter: i4 == null ? void 0 : i4.toJSON() };
  ...
  async handleEdits({ historicMoment: e5, addedFeatures: t3, deletedFeatures: i4, updatedFeatures: n3 }, a6) {
    const r2 = { historicMoment: e5, addedFeatures: (t3 == null ? void 0 : t3.map(({ objectId: e6 }) => e6).filter(N)) ?? [], deletedFeatures: (i4 == null ? void 0 : i4.map(({ objectId: e6, globalId: t4 }) => ({ objectId: e6, globalId: t4 }))) ?? [], updatedFeatures: (n3 == null ? void 0 : n3.map(({ objectId: e6 }) => e6).filter(N)) ?? [] };
  ...
  async setSuspended(e5) {
    var _a;
    (_a = this._suspendController) == null ? void 0 : _a.abort(), this._suspendController = new AbortController(), await this._updatingHandles.addPromise(this._workerHandle.invokeMethod("setSuspended", e5, this._suspendController.signal));
  }
};
function h4(e5) {
...
function c4(e5) {
  var _a, _b;
  return "multipatch" === e5.geometryType || "mesh" === e5.geometryType ? null : { url: ((_a = e5.parsedUrl) == null ? void 0 : _a.path) ?? "", fieldsIndex: e5.fieldsIndex.toJSON(), geometryType: y2.toJSON(e5.geometryType), capabilities: e5.capabilities, objectIdField: e5.objectIdField, globalIdField: e5.globalIdField, spatialReference: e5.spatialReference.toJSON(), timeInfo: (_b = e5.timeInfo) == null ? void 0 : _b.toJSON() };
}
...
var O2 = class extends b {
  ...
  get _isSuspended() {
    ...
    return this._snappingComplexityExceeded || !!this.view && (false !== ((_a = this._layerView) == null ? void 0 : _a.suspended) || !this.layerSource.enabled);
  }
  ...
  get updating() {
    var _a;
    return ((_a = this._workerHandle) == null ? void 0 : _a.updating) || this._updatingHandles.updating || this._tilesOfInterest.updating;
  }
  get _outFields() {
    var _a, _b, _c, _d, _e, _f, _g, _h;
    const { view: e5, _layerView: t3, layerSource: i4 } = this, { layer: r2 } = i4, { fieldsIndex: s2, timeInfo: o5, floorInfo: a6, subtypeField: n3 } = r2, l5 = t3 && "filter" in t3 ? t3.filter : null, d4 = (l5 == null ? void 0 : l5.where) && "1=1" !== l5.where ? this._getOrLoadWhereFields(l5.where, s2) : [];
    if ((l5 == null ? void 0 : l5.timeExtent) && o5) {
      const { startField: e6, endField: t4 } = o5, i5 = ((_a = s2.get(e6)) == null ? void 0 : _a.name) ?? e6, r3 = ((_b = s2.get(t4)) == null ? void 0 : _b.name) ?? t4;
      i5 && d4.push(i5), r3 && d4.push(r3);
    }
    if ((e5 == null ? void 0 : e5.map) && x(e5.map) && ((_c = e5.map.utilityNetworks) == null ? void 0 : _c.find((e6) => e6.isUtilityLayer(r2)))) {
      const e6 = (_d = r2.fieldsIndex.get("assetGroup")) == null ? void 0 : _d.name, t4 = (_e = r2.fieldsIndex.get("assetType")) == null ? void 0 : _e.name;
      e6 && t4 && (d4.push(e6), d4.push(t4));
    }
    if (r2 && (a6 == null ? void 0 : a6.floorField) && ((_f = e5 == null ? void 0 : e5.floors) == null ? void 0 : _f.length)) {
      const e6 = ((_g = s2.get(a6.floorField)) == null ? void 0 : _g.name) ?? a6.floorField;
      e6 && d4.push(e6);
    }
    if (n3) {
      const e6 = ((_h = s2.get(n3)) == null ? void 0 : _h.name) ?? n3;
      e6 && d4.push(e6);
    }
    return new Set(d4);
  }
  get configuration() {
    ...
    return this._layerView && "effectiveDisplayFilter" in this._layerView && (s2.where = l3(s2.where, (_a = this._layerView.effectiveDisplayFilter) == null ? void 0 : _a.where)), { filter: s2, customParameters: t3 ? { ...i4, token: t3 } : i4, viewType: r2 };
  }
  get availability() {
    var _a;
  ...
  initialize() {
    ...
    if (null == t3 || t3.destroyed) this._tilesOfInterest = new a5({ layer: this._layer }), e5 = this._workerHandle = new u5();
      ...
      case "3d": {
        ...
        } }), this._updatingHandles.add(() => r2.elevationInfo, () => y(e5.notifyElevationSourceChange()), h2), this._updatingHandles.add(() => {
          var _a, _b;
          return (_b = (_a = this._layerView) == null ? void 0 : _a.layer) == null ? void 0 : _b.renderer;
        }, () => y(e5.notifySymbologyChange()), h2), this._updatingHandles.add(() => {
          var _a;
          return ((_a = this._layerView) == null ? void 0 : _a.symbologySnappingSupported) ?? false;
        }, (t4) => y(e5.setSymbologySnappingSupported(t4)), h2), this.addHandles([t3.elevationProvider.on("elevation-change", ({ context: t4 }) => {
  ...
  _getOrLoadWhereFields(e5, t3) {
    ...
    if (!this._loadWhereModuleTask && !r2) {
      const e6 = d(async () => {
        const e7 = await import("./WhereClause-7HEYIXTD.js");
...
//# sourceMappingURL=FeatureServiceSnappingSource-NCXXZ5ZQ.js.map
