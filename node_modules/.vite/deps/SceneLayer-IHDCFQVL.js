import {
  a as a5
} from "./chunk-BAUSWMHI.js";
import {
  $
} from "./chunk-JFF4NURA.js";
import "./chunk-DMTNIHMP.js";
import "./chunk-OU7KSVD4.js";
import {
  n as n6,
  p as p5
} from "./chunk-JQ5YFBP5.js";
import "./chunk-KEQI4WPI.js";
import {
  t as t4
...
import {
  ...
  p as p4,
  y as y2
} from "./chunk-EMNAZOQ7.js";
import {
  _ as _3
} from "./chunk-EIC7WDC2.js";
import {
  $ as $2,
  R,
  j as j3
} from "./chunk-TNVMVYLK.js";
import "./chunk-MJU5R5SV.js";
import "./chunk-D7NJHO7F.js";
...
import "./chunk-VZEUC4NE.js";
import "./chunk-F574CBIB.js";
import {
  i as i4,
  m as m5,
  t2 as t3
} from "./chunk-Z6CFB5AI.js";
import "./chunk-RI7CUAOI.js";
import "./chunk-NXIH53FX.js";
import {
  p as p2,
  s as s5
} from "./chunk-33VZHKKC.js";
...
import {
  s as s8
} from "./chunk-4INI75WH.js";
import "./chunk-IWPIZDTX.js";
import {
  t as t2
} from "./chunk-YDYARXQD.js";
...
import {
  l as l6
} from "./chunk-AN2TCSFE.js";
import {
  j as j4
} from "./chunk-IOMD2ENS.js";
...
function e({ associatedLayer: e3, serviceUpdateTimeStamp: t6 }) {
  var _a;
  const n8 = (_a = e3 == null ? void 0 : e3.editingInfo) == null ? void 0 : _a.lastEditDate, r3 = e3 == null ? void 0 : e3.serverGens, a8 = null != n8, i6 = null != t6, s10 = a8 && i6 && t6.lastUpdate !== n8.getTime();
  return a8 && (s10 || !i6 && (r3 == null ? void 0 : r3.minServerGen) !== (r3 == null ? void 0 : r3.serverGen));
}
...
var a7 = (t6) => {
  ...
  let p6 = class extends a8 {
    ...
    get timeInfo() {
      var _a;
      const e3 = (_a = this.associatedLayer) == null ? void 0 : _a.timeInfo;
    ...
    async loadTimeInfoFromService(e3) {
      ...
      const n8 = async (t8) => {
        ...
        let i7 = null;
        try {
          const r4 = await ((_a = this.fetchStatistics) == null ? void 0 : _a.call(this, t8, e3));
          i7 = r4 == null ? void 0 : r4.stats;
        } catch {
        }
  ...
  return __decorate([m3({ type: u3, json: { read: false, write: false } })], p6.prototype, "timeInfo", null), __decorate([m3({ type: m4, json: { read: false, write: false } })], p6.prototype, "timeExtent", null), __decorate([m3({ type: c, json: { read: false, write: false } })], p6.prototype, "timeOffset", null), __decorate([m3({ type: Boolean, nonNullable: true, json: { read: false, write: false } })], p6.prototype, "datesInUnknownTimezone", null), __decorate([m3({ type: c2, readOnly: true, json: { read: { source: "timeInfo" } }, clonable: false })], p6.prototype, "serviceTimeInfo", void 0), p6 = __decorate([a2("esri.layers.mixins.TemporalSceneLayer")], p6), p6;
};
...
__decorate([m3({ type: String })], c2.prototype, "endTimeField", void 0), __decorate([m3({ type: String })], c2.prototype, "startTimeField", void 0), c2 = __decorate([a2("esri.layers.mixins.TemporalSceneLayer.SceneServiceTimeInfo")], c2);
...
__decorate([m3({ type: String, json: { read: true, write: { isRequired: true } } })], s9.prototype, "name", void 0), __decorate([m3({ type: String, json: { read: true, write: { isRequired: true } } })], s9.prototype, "field", void 0), __decorate([m3({ type: [Number], json: { read: true, write: true } })], s9.prototype, "currentRangeExtent", void 0), __decorate([m3({ type: [Number], json: { read: true, write: true } })], s9.prototype, "fullRangeExtent", void 0), __decorate([m3({ type: ["rangeInfo"], readOnly: true, json: { read: false, write: { isRequired: true } } })], s9.prototype, "type", void 0), s9 = __decorate([a2("esri.layers.support.RangeInfo")], s9);
...
var g2 = u4 = class extends n2 {
  ...
  async loadGeometries(e3, o5) {
    ...
    const { url: s10, context: t6 } = this._geometriesSource, i6 = await H(s10, { responseType: "json", signal: o5 == null ? void 0 : o5.signal }), a8 = e3.toJSON(), p6 = i6.data.map((e4) => ({ ...e4, spatialReference: a8 }));
...
__decorate([m3({ type: ["disjoint", "contains"], nonNullable: true, json: { write: { isRequired: true } } })], g2.prototype, "spatialRelationship", void 0), __decorate([m3({ type: l6, nonNullable: true, json: { write: true, origins: { "web-scene": { write: { isRequired: true } } } } }), j4({ origins: ["web-scene", "portal-item"], type: "resource", prefix: "geometries", contentAddressed: true })], g2.prototype, "geometries", void 0), __decorate([o(["web-scene", "portal-item", "service"], "geometries")], g2.prototype, "readGeometries", null), g2 = u4 = __decorate([a2("esri.layers.support.SceneFilter")], g2);
var d4 = g2;
...
async function t5(e3) {
  const { BlobReader: t6, ZipReader: r3, BlobWriter: n8 } = await import("./zipjs-wrapper-7LLCUKQO.js"), a8 = [], i6 = new r3(new t6(e3));
...
var Te = class extends a7(F(_3(l3(b2(j2(t(l(s4(o3(l2(b3))))))))))) {
  ...
  getFieldDomain(e3, t6) {
    var _a;
    const r3 = ((_a = this.getField(e3)) == null ? void 0 : _a.domain) ?? null;
  ...
  async _load(e3) {
    const t6 = e3 == null ? void 0 : e3.signal;
  ...
  queryFeatures(e3, t6) {
    return this._getAssociatedLayerForQuery().then((r3) => r3.queryFeatures(e3 || this.createQuery(), t6)).then((e4) => {
      if (e4 == null ? void 0 : e4.features) for (const t7 of e4.features) t7.layer = this, t7.sourceLayer = this, t7.origin = this.graphicOrigin;
      return e4;
    });
  }
  ...
  async queryCachedAttributes(e3, t6) {
    ...
    return $(((_a = this.parsedUrl) == null ? void 0 : _a.path) ?? "", this.attributeStorageInfo ?? [], e3, t6, r3, this.apiKey, this.customParameters);
  }
  ...
  async applyEdits(e3, t6) {
    const { applyEdits: r3 } = await import("./editingSupport-3Y5SDRIN.js");
    let i6 = t6;
    await this.load();
    const s10 = this.associatedLayer;
    if (!s10) throw new s(`${this.type}-layer:not-editable`, "Service is not editable");
    await s10.load();
    const { globalIdField: o5 } = s10, n8 = !!s10.infoFor3D, l7 = (i6 == null ? void 0 : i6.globalIdUsed) ?? true;
  ...
  async convertMesh(e3, t6) {
    t6 ?? (t6 = {}), null != t6.location && m(i.getLogger(this), "The 'location' option of convertMesh() has been deprecated in favour of 'origin'.", { version: "4.34", replacement: "origin", warnOnce: true });
    const r3 = (e4) => {
    ...
    const n8 = this.spatialReference, p6 = t6.origin ?? t6.location, d5 = await H2(p6 ?? t6.defaultOrigin ?? new _({ x: 0, y: 0, z: 0, spatialReference: n8 }), n8, t6), y3 = d5.spatialReference.isGeographic ? "local" : "georeferenced", { default: u5 } = await import("./Mesh-UA6IU3PU.js");
    s2(t6);
  ...
  _populateFieldUsageInfo() {
    ...
    if (this._fieldUsageInfo = {}, this.fields) for (const e3 of this.fields) {
      const t6 = !!((_a = this.attributeStorageInfo) == null ? void 0 : _a.some((t7) => t7.name === e3.name)), r3 = !!((_c = (_b = this.associatedLayer) == null ? void 0 : _b.fields) == null ? void 0 : _c.some((t7) => t7 && e3.name === t7.name)), i6 = { supportsLabelingInfo: t6, supportsRenderer: t6, supportsPopupTemplate: t6 || r3, supportsLayerQuery: r3 };
  ...
  _applyAssociatedLayerExtentOverride() {
    var _a, _b, _c;
    const e3 = (_a = this.associatedLayer) == null ? void 0 : _a.getAtOrigin("fullExtent", "service");
    if (null == ((_b = this.associatedLayer) == null ? void 0 : _b.infoFor3D) || !e3 || !g((_c = this.associatedLayer) == null ? void 0 : _c.url) || !e(this)) return;
  ...
  async fetchStatistics(e3, t6) {
    var _a;
    return await i5({ fieldName: e3, statisticsInfo: this.statisticsInfo, errorContext: "scenelayer", fieldsIndex: this.fieldsIndex, path: ((_a = this.parsedUrl) == null ? void 0 : _a.path) ?? "", customParameters: this.customParameters, apiKey: this.apiKey, signal: t6 == null ? void 0 : t6.signal });
  }
};
__decorate([m3({ types: { key: "type", base: s5, typeMap: { selection: p2 } }, json: { origins: { "web-scene": { name: "layerDefinition.featureReduction", write: { allowNull: true } }, "portal-item": { name: "layerDefinition.featureReduction", write: { allowNull: true } } } } })], Te.prototype, "featureReduction", void 0), __decorate([m3({ type: [s9], json: { read: false, origins: { "web-scene": { name: "layerDefinition.rangeInfos", write: true }, "portal-item": { name: "layerDefinition.rangeInfos", write: true } } }, clonable: false })], Te.prototype, "rangeInfos", void 0), __decorate([m3({ json: { read: false } })], Te.prototype, "associatedLayer", void 0), __decorate([m3({ type: ["show", "hide"] })], Te.prototype, "listMode", void 0), __decorate([m3({ type: ["ArcGISSceneServiceLayer"] })], Te.prototype, "operationalLayerType", void 0), __decorate([m3({ json: { read: false }, readOnly: true })], Te.prototype, "type", void 0), __decorate([m3({ ...Pe.fields, readOnly: true, json: { read: false, origins: { service: { read: true } } } })], Te.prototype, "fields", void 0), __decorate([m3()], Te.prototype, "types", null), __decorate([m3()], Te.prototype, "typeIdField", null), __decorate([m3()], Te.prototype, "templates", null), __decorate([m3()], Te.prototype, "formTemplate", null), __decorate([m3({ readOnly: true })], Te.prototype, "graphicOrigin", void 0), __decorate([m3({ readOnly: true, clonable: false })], Te.prototype, "fieldsIndex", null), __decorate([m3({ type: i3, json: { read: { source: "layerDefinition.floorInfo" }, write: { target: "layerDefinition.floorInfo" } } })], Te.prototype, "floorInfo", void 0), __decorate([m3(Pe.outFields)], Te.prototype, "outFields", void 0), __decorate([m3({ type: p4, readOnly: true, json: { read: false }, clonable: false })], Te.prototype, "nodePages", void 0), __decorate([o("service", "nodePages", ["nodePages", "pointNodePages"])], Te.prototype, "readNodePages", null), __decorate([m3({ type: [a4], readOnly: true, clonable: false })], Te.prototype, "materialDefinitions", void 0), __decorate([m3({ type: [y2], readOnly: true, clonable: false })], Te.prototype, "textureSetDefinitions", void 0), __decorate([m3({ type: [m7], readOnly: true, clonable: false })], Te.prototype, "geometryDefinitions", void 0), __decorate([m3({ readOnly: true })], Te.prototype, "serviceUpdateTimeStamp", void 0), __decorate([m3({ readOnly: true })], Te.prototype, "attributeStorageInfo", void 0), __decorate([m3({ readOnly: true })], Te.prototype, "statisticsInfo", void 0), __decorate([m3({ type: O.ofType(Number), nonNullable: true, json: { origins: { service: { read: false, write: false } }, name: "layerDefinition.excludeObjectIds", write: { enabled: true } } })], Te.prototype, "excludeObjectIds", void 0), __decorate([m3({ type: String, json: { origins: { service: { read: false, write: false } }, name: "layerDefinition.definitionExpression", write: { enabled: true, allowNull: true } } })], Te.prototype, "definitionExpression", void 0), __decorate([m3({ type: d4, json: { name: "layerDefinition.polygonFilter", write: { enabled: true, allowNull: true }, origins: { service: { read: false, write: false } } } })], Te.prototype, "filter", void 0), __decorate([m3({ type: String, json: { origins: { "web-scene": { read: true, write: true } }, read: false } })], Te.prototype, "path", void 0), __decorate([m3(m6)], Te.prototype, "elevationInfo", null), __decorate([m3({ readOnly: true, json: { read: false } })], Te.prototype, "effectiveCapabilities", null), __decorate([m3({ readOnly: true })], Te.prototype, "effectiveEditingEnabled", null), __decorate([m3({ type: String })], Te.prototype, "geometryType", null), __decorate([m3(p3)], Te.prototype, "labelsVisible", void 0), __decorate([m3({ type: [A], json: { origins: { service: { name: "drawingInfo.labelingInfo", read: { reader: l4 }, write: false } }, name: "layerDefinition.drawingInfo.labelingInfo", read: { reader: l4 }, write: true } })], Te.prototype, "labelingInfo", void 0), __decorate([m3(d3)], Te.prototype, "legendEnabled", void 0), __decorate([m3({ type: Number, json: { origins: { "web-document": { default: 1, write: { enabled: true, target: { opacity: { type: Number }, "layerDefinition.drawingInfo.transparency": { type: Number } } }, read: { source: ["opacity", "layerDefinition.drawingInfo.transparency"], reader(e3, t6) {
  var _a, _b;
  if ("number" == typeof e3 && e3 >= 0 && e3 <= 1) return e3;
  const r3 = (_b = (_a = t6.layerDefinition) == null ? void 0 : _a.drawingInfo) == null ? void 0 : _b.transparency;
  return void 0 !== r3 ? r(r3) : void 0;
} } }, "portal-item": { write: true }, service: { read: false } } } })], Te.prototype, "opacity", void 0), __decorate([m3({ type: ["Low", "High"], readOnly: true, json: { read: false, origins: { service: { read: true } } } })], Te.prototype, "priority", void 0), __decorate([m3({ type: ["Labels"], readOnly: true, json: { read: false, origins: { service: { read: true } } } })], Te.prototype, "semantic", void 0), __decorate([m3({ types: u2, json: { origins: { service: { read: { source: "drawingInfo.renderer" } } }, name: "layerDefinition.drawingInfo.renderer", write: true }, value: null })], Te.prototype, "renderer", null), __decorate([m3({ json: { read: false } })], Te.prototype, "cachedDrawingInfo", void 0), __decorate([o("service", "cachedDrawingInfo")], Te.prototype, "readCachedDrawingInfo", null), __decorate([m3({ readOnly: true, json: { read: false } })], Te.prototype, "capabilities", null), __decorate([m3({ type: Boolean, json: { read: false } })], Te.prototype, "editingEnabled", null), __decorate([m3({ readOnly: true, json: { write: false, read: false } })], Te.prototype, "infoFor3D", null), __decorate([m3({ readOnly: true, json: { write: false, read: false } })], Te.prototype, "relationships", null), __decorate([m3(l5)], Te.prototype, "popupEnabled", void 0), __decorate([m3({ type: q, json: { name: "popupInfo", write: true } })], Te.prototype, "popupTemplate", void 0), __decorate([m3({ readOnly: true, json: { read: false } })], Te.prototype, "defaultPopupTemplate", null), __decorate([m3(I)], Te.prototype, "attributeTableTemplate", void 0), __decorate([m3({ type: String, json: { read: false } })], Te.prototype, "objectIdField", void 0), __decorate([o("service", "objectIdField", ["objectIdField", "fields"])], Te.prototype, "readObjectIdField", null), __decorate([m3({ type: String, json: { read: false } })], Te.prototype, "globalIdField", void 0), __decorate([o("service", "globalIdField", ["globalIdField", "fields"])], Te.prototype, "readGlobalIdField", null), __decorate([m3({ readOnly: true, type: String, json: { read: false } })], Te.prototype, "displayField", null), __decorate([m3({ type: String, json: { read: false } })], Te.prototype, "profile", void 0), __decorate([o("service", "profile", ["store.profile"])], Te.prototype, "readProfile", null), __decorate([m3({ readOnly: true, type: String, json: { origins: { service: { read: { source: "store.normalReferenceFrame" } } }, read: false } })], Te.prototype, "normalReferenceFrame", void 0), __decorate([m3(s7)], Te.prototype, "screenSizePerspectiveEnabled", void 0), __decorate([m3({ json: { read: false, origins: { service: { read: true } } } })], Te.prototype, "serviceItemId", void 0), __decorate([m3(f2)], Te.prototype, "useViewTime", null), Te = __decorate([a2("esri.layers.SceneLayer")], Te);
...
//# sourceMappingURL=SceneLayer-IHDCFQVL.js.map
