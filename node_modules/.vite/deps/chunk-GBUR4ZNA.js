...
function q2(t3, n5, r3) {
  ...
  if (a2(e3, n5) && (!a4 || B(a4.localMatrix, r)) && Z(s2)) {
    const { position: t4, normal: n6, tangent: e4 } = i3, o5 = r3 == null ? void 0 : r3.allowBufferReuse;
    return { position: o5 ? t4 : t4.slice(), normal: o5 ? n6 : n6 == null ? void 0 : n6.slice(), tangent: o5 ? e4 : e4 == null ? void 0 : e4.slice() };
  }
...
function z({ vertexAttributes: t3, transform: n5, spatialReference: r3 }, { origin: e3 }, o4, i3) {
  const l = Y2(r3, i3, 3), a4 = e3 || !Z(l) ? n2(rt, (n5 == null ? void 0 : n5.localMatrix) ?? r) : null;
  a4 && X(a4, r3, i3, 3);
  const { position: s2, normal: u, tangent: f3 } = a4 ? K(t3, a4) : t3, g = i3 == null ? void 0 : i3.allowBufferReuse, x2 = g ? s2 : new Float64Array(s2.length);
  let h3 = s2;
  if (e3 && (h3 = a3(x2, h3, e3)), o4) {
    const t4 = y(it, o4);
    h3 = a3(x2, h3, t4);
  }
  return { position: h3 !== t3.position || g ? h3 : h3.slice(), normal: u !== t3.normal || g ? u : u == null ? void 0 : u.slice(), tangent: f3 !== t3.tangent || g ? f3 : f3 == null ? void 0 : f3.slice() };
}
function D2(t3, n5) {
  return (n5 == null ? void 0 : n5.useEllipsoid) && P(t3) ? c3 : a(t3);
}
...
function Y2(t3, n5, r3) {
  const e3 = !!(1 & r3), o4 = !!(2 & r3), i3 = n5 == null ? void 0 : n5.sourceUnit, l = n5 == null ? void 0 : n5.targetUnit;
  if (!i3 && !l) return 1;
  let a4 = nt(i3, t3);
...
//# sourceMappingURL=chunk-GBUR4ZNA.js.map
