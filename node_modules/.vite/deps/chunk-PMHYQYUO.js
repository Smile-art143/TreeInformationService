...
var F = class extends b {
  ...
  setFeatureAttribute(t6, e7) {
    var _a;
    (_a = this._view.featureAttribute) == null ? void 0 : _a.setVec(t6, e7);
  }
  getFeatureAttribute(t6, e7) {
    var _a;
    (_a = this._view.featureAttribute) == null ? void 0 : _a.getVec(t6, e7);
  }
  setColor(t6, e7) {
    var _a;
    (_a = this._view.color) == null ? void 0 : _a.setVec(t6, e7);
  }
  setObjectAndLayerIdColor(t6, e7) {
    var _a;
    (_a = this._view.olidColor) == null ? void 0 : _a.setVec(t6, e7);
  }
  setVisible(t6, e7) {
...
var M = class extends m3 {
  constructor(e7, t6, i5 = new t3(K, () => import("./DefaultMaterial.glsl-7P6TSUDX.js"))) {
    const s7 = [t(F2(t6))];
...
var o5 = class extends M {
  constructor(r9, o6) {
    super(r9, o6, new t3(z, () => import("./RealisticTree.glsl-52NY2B6U.js")));
  }
};
...
//# sourceMappingURL=chunk-PMHYQYUO.js.map
