import {
  ...
  ee,
  oe
} from "./chunk-MUS7B7TV.js";
import "./chunk-Y2QJFDQ5.js";
import {
  E,
  N
} from "./chunk-UX7ULDKZ.js";
import {
  d as d3
...
var S = class {
  ...
  async refresh(t) {
    var _a;
    return this._customParameters = t.customParameters, this._maxRecordCount = t.maxRecordCount, this._maxTotalRecordCount = t.maxTotalRecordCount, this._maxPageCount = t.maxPageCount, (_a = this._snapshotTask) == null ? void 0 : _a.abort(), this._snapshotTask = d2((e) => this._snapshotFeatures({ signal: e })), this._snapshotTask.promise.then((e) => {
      var _a2;
      this._queryEngine.featureStore.clear(), this._queryEngine.featureStore.addMany(e.features);
      for (const t2 of E2(e)) i.getLogger(F).warn(new s3("wfs-layer:refresh-warning", t2.message, t2.details));
      ((_a2 = e.errors) == null ? void 0 : _a2.length) && i.getLogger(F).warn(new s3("wfs-layer:refresh-error", "Refresh completed with errors", { errors: e.errors }));
    }, () => {
  ...
  async _snapshotFeatures(e) {
    const t = e == null ? void 0 : e.signal, r2 = this._maxTotalRecordCount, n3 = this._maxPageCount, i2 = this._supportsPagination && n3 > 1 ? await ee(this._getFeatureUrl, this._featureType.typeName, { customParameters: this._customParameters, signal: t }) : void 0;
    let u = [];
    const l = [];
    if (null == i2) try {
    ...
    return s2(t), { features: u, totalRecordCount: i2, maxTotalRecordCount: r2, maxPageCount: n3, errors: l };
  }
...
//# sourceMappingURL=WFSSourceWorker-LAV2IKWA.js.map
