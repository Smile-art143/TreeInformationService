...
var _ = class {
  ...
  push(e, o) {
    ...
    return this._deferreds.set(e, a), this._controllers.set(e, c), a.promise.then(u3, u3), this._queue.push(e), this._scheduleNext(), a.promise;
  }
  last() {
  ...
  popLast() {
    ...
    return e && ((_a = this._deferreds.get(e)) == null ? void 0 : _a.reject(u()), this._removeItem(e)), e;
  }
  reset() {
  ...
  _process(e) {
    ...
    C(s3) ? (r2.promise = s3, s3.then((e2) => this._processResult(r2, e2), (e2) => this._processError(r2, e2))) : this._processResult(r2, s3);
  }
  get test() {
  }
};
...
//# sourceMappingURL=chunk-LNMZ44TE.js.map
