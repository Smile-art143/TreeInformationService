...
async function t(l, o, r2) {
  ...
  return (await Promise.all(u3.map(async (e, r3) => {
    const n2 = "opacity" === l.type ? await a(e, l, o) : (await import("./visualVariableUtils-5UBGXJBC.js")).getColor(l, e), u4 = t2 ? s2[r3] : (p == null ? void 0 : p[r3]) ?? "";
    return null == n2 ? null : { value: e, color: n2, label: u4 };
  }))).filter(N).reverse();
}
async function a(e, o, n2) {
  const t2 = new u(n2 ?? r), a2 = (await import("./visualVariableUtils-5UBGXJBC.js")).getOpacity(o, e);
...
function u2(l) {
  ...
  const u3 = e ? null : n(o);
  return o.map((o2, n2) => ({ value: o2, color: s(o2, l), label: e ? r2[n2] : (u3 == null ? void 0 : u3[n2]) ?? "" })).reverse();
}
function s(e, o) {
...
//# sourceMappingURL=chunk-M7RQIHHA.js.map
