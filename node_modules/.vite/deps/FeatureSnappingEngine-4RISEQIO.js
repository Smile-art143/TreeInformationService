...
import {
  r as r2,
  s as s4
} from "./chunk-JSOMX4ZV.js";
import "./chunk-3KXCGVVM.js";
import {
  e as e3
} from "./chunk-NFD7ZJKB.js";
import {
  e as e2,
  i as i2
} from "./chunk-UN2BL23A.js";
...
var f2 = class extends b {
  ...
  get layerView() {
    var _a, _b;
    return (_b = (_a = this.view) == null ? void 0 : _a.allLayerViews) == null ? void 0 : _b.find((e4) => e4.layer === this.layer);
  }
  get valid() {
  ...
  get subtypeFilter() {
    ...
    if (!d(e4) || !((_a = e4.subtypes) == null ? void 0 : _a.length) || !t) return { mode: "not-in-use", filter: null };
    const r3 = t.layerSource.sublayerSources.filter((e5) => {
      var _a2;
      return e5.enabled && e5.layer.visible && r((_a2 = this.view) == null ? void 0 : _a2.scale, e5.layer.effectiveScaleRange.minScale, e5.layer.effectiveScaleRange.maxScale);
    }).map((e5) => e5.layer.subtypeCode);
    if (!r3.length) return { mode: "none-visible", filter: null };
    if (r3.length === e4.subtypes.length) return { mode: "all-visible", filter: null };
    const i3 = ((_b = e4.fieldsIndex.get(e4.subtypeField)) == null ? void 0 : _b.name) ?? e4.subtypeField;
  ...
  getFetchCandidatesParameters(e4, t, r3) {
    ...
    const { layer: i3, layerView: l3, floorFilter: o3, rulesTable: a2, subtypeFilter: u2 } = this, y2 = { distance: r3, mode: ((_a = this.view) == null ? void 0 : _a.type) ?? "2d", point: e4, coordinateHelper: t.coordinateHelper, ...h2(), filter: l3 && "filter" in l3 ? l3.filter : null };
    ...
    if (a2 && f3 && x((_c = this.view) == null ? void 0 : _c.map) && (o(i3) || d(i3)) && (o(v2) || d(v2)) && ((_d = this.view.map.utilityNetworks) == null ? void 0 : _d.find((e5) => e5.isUtilityLayer(v2)))) {
      if ("loaded" !== a2.loadStatus) return [];
      const e5 = [], t2 = i3.layerId, r4 = (_e = a2.getFeatureSQL(v2, f3)) == null ? void 0 : _e[t2];
      if (!r4) return [];
  ...
  async loadRules() {
    ...
    if (i3 && e4 && t && x(t == null ? void 0 : t.map) && (o(e4) || d(e4))) try {
      await Promise.allSettled(((_a = t.map.utilityNetworks) == null ? void 0 : _a.map((e5) => e5.load())) ?? []);
      const r3 = (_b = t.map.utilityNetworks) == null ? void 0 : _b.find((t2) => t2.isUtilityLayer(e4));
      r3 && (this.rulesTable = await r3.getRulesTable(), await ((_c = this.rulesTable) == null ? void 0 : _c.load()));
    } catch (l3) {
...
var H = class extends b {
  get updating() {
    return this._snappingSources.some((e4) => {
      var _a;
      return null == (e4 == null ? void 0 : e4.valid) || true === e4.valid && true === ((_a = e4.snappingSource) == null ? void 0 : _a.updating);
  ...
  initialize() {
    ...
    }, (e5, t) => this._createSourceInfo(e5, t));
    this._snappingSources = e4, this.addHandles([c(e4), l(() => {
      var _a;
      return { rulesEnabled: !!((_a = this.options) == null ? void 0 : _a.attributeRulesEnabled), sources: this._snappingSources.filter(N) };
    }, ({ rulesEnabled: e5, sources: t }) => {
  ...
  async fetchCandidates(e4, t, r3, a2) {
    ...
    for (const s5 of this._snappingSources) {
      if (!(s5 == null ? void 0 : s5.valid) || !((_b = (_a = s5.snappingSource) == null ? void 0 : _a.layerSource) == null ? void 0 : _b.enabled) || ((_c = s5.layerView) == null ? void 0 : _c.suspended)) continue;
  ...
  _addRightAngleCandidates(e4, t, r3, a2) {
    ...
    const n2 = null != a2.vertexHandle ? (_b = (_a = a2.vertexHandle.rightSegment) == null ? void 0 : _a.rightVertex) == null ? void 0 : _b.pos : null != a2.editGeometryOperations && "polygon" === a2.editGeometryOperations.data.type ? (_d = (_c = a2.editGeometryOperations.data.parts[0]) == null ? void 0 : _c.getFirstVertex()) == null ? void 0 : _d.pos : null, s5 = null != a2.vertexHandle ? (_f = (_e = a2.vertexHandle.leftSegment) == null ? void 0 : _e.leftVertex) == null ? void 0 : _f.pos : null != a2.editGeometryOperations ? (_h = (_g = a2.editGeometryOperations.data.parts[0]) == null ? void 0 : _g.getLastVertex()) == null ? void 0 : _h.pos : null, { view: i3 } = this, o3 = m2(n2, i3, a2), c2 = m2(s5, i3, a2), u2 = e4.length;
  ...
  async _createFeatureSnappingSourceFeatureLayer(e4) {
    var _a;
    switch ((_a = e4.layer.source) == null ? void 0 : _a.type) {
      case "feature-layer":
      case "oriented-imagery":
  ...
  async _createFeatureSnappingSourceMapNotesLayer(e4) {
    return new (await this._getSourceModule("notes")).GraphicsSnappingSource({ getGraphicsLayers: () => {
      var _a;
      return ((_a = e4.layer.sublayers) == null ? void 0 : _a.toArray()) ?? [];
    }, spatialReference: this.spatialReference, view: this.view, layerSource: e4 });
  }
  ...
  _loadSourceModule(e4) {
    ...
    switch (e4) {
      case "featureService":
        return t.addPromise(import("./FeatureServiceSnappingSource-NCXXZ5ZQ.js"));
      case "featureCollection":
        return t.addPromise(import("./FeatureCollectionSnappingSource-UXBZDZVK.js"));
      case "graphics":
      case "notes":
        return t.addPromise(import("./GraphicsSnappingSource-HOMJ3H3S.js"));
      case "scene":
        return t.addPromise(import("./SceneLayerSnappingSource-TRMHJ76E.js"));
    }
  }
  get test() {
  }
...
//# sourceMappingURL=FeatureSnappingEngine-4RISEQIO.js.map
