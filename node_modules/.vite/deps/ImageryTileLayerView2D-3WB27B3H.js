...
import {
  n as n3
} from "./chunk-SZERI7P6.js";
import {
  E as E2,
  J as J2,
  g as g3
} from "./chunk-EMEEBG7G.js";
import {
  m as m4
} from "./chunk-UEMPCLRZ.js";
import {
  i as i7
...
var m5 = class extends e4 {
  ...
  set highlightTexture(t10) {
    var _a;
    this._highlightTexture !== t10 && ((_a = this._highlightTexture) == null ? void 0 : _a.dispose(), this._highlightTexture = t10), null == t10 && (this._highlighted = false);
  }
  get rasterTexture() {
  ...
  set rasterTexture(t10) {
    var _a;
    this._rasterTexture !== t10 && ((_a = this._rasterTexture) == null ? void 0 : _a.dispose(), this._rasterTexture = t10), null == t10 && (this.projected = false);
  }
  get processed() {
  ...
  getRasterTextureSize(t10 = false) {
    ...
    return [e8 ? this.width : ((_a = this.source) == null ? void 0 : _a.width) || this.width, e8 ? this.height : ((_b = this.source) == null ? void 0 : _b.height) || this.height];
  }
  getRasterCellSize() {
    var _a;
    const t10 = (_a = this.rawPixelData) == null ? void 0 : _a.srcPixelSize, { projected: e8, resolution: s10 } = this;
  ...
  updateProcessedTexture(t10 = true) {
    ...
    0 !== e8.length && (this.processedTexture = e8.shift(), e8.forEach((t11) => t11 == null ? void 0 : t11.dispose()), e8.length = 0, this.processed = !!this.processedTexture);
  }
  _createOrDestroyRasterTexture(e8) {
    var _a;
    const s10 = (_a = this.source) == null ? void 0 : _a.extractBands(this.bandIds);
  ...
  _isValidSource(t10) {
    var _a;
    return null != t10 && ((_a = t10.pixels) == null ? void 0 : _a.length) > 0;
  }
...
var F2 = class extends s2 {
  ...
  get meanValuesTexture() {
    var _a;
    return ((_a = this._resultsFramebuffer) == null ? void 0 : _a.getColorTexture(U2)) || null;
  }
  get stdDevValuesTexture() {
    var _a;
    return ((_a = this._resultsFramebuffer) == null ? void 0 : _a.getColorTexture(P)) || null;
  }
  get statsFbo() {
...
var f5 = class extends s2 {
  ...
  _computeStatisticsTextures(e8, t10) {
    this._statisticsTechnique ?? (this._statisticsTechnique = new F2());
...
var g8 = class extends s2 {
  ...
  shutdown(e8) {
    var _a;
    super.shutdown(e8), (_a = this._fbo) == null ? void 0 : _a.dispose(), this._fbo = void 0;
  }
  render(t10, r15) {
    var _a;
    ...
    for (const n7 of r15.bitmaps) {
      ...
      const r16 = ((_a = n7.bandIds) == null ? void 0 : _a.length) ? n7.bandIds.indexOf(h20.bandId) : 0;
  ...
  render(r15, i15) {
    ...
    for (const o6 of i15.bitmaps) {
      ...
      if (h20.copyToTexture(0, 0, l7, g12, 0, 0, x6), p6) o6.rasterTexture = x6;
        ...
        (_a = o6.functionTextures[e8]) == null ? void 0 : _a.dispose(), o6.functionTextures[e8] = x6;
      }
      f10 || h20.dispose(), r15.timeline.end(this.name);
    }
    m12 == null ? void 0 : m12.dispose(), u9.bindFramebuffer(d8), u9.setViewport(c10.x, c10.y, c10.width, c10.height);
  }
  _getCommonConfig(e8, t10) {
    var _a;
    const { rasterFunction: r15, hasBranches: n7 } = e8, { raster: s10, rasters: o6 } = r15.parameters, i15 = n7 ? (s10 == null ? void 0 : s10.id) ?? ((_a = o6 == null ? void 0 : o6.find((e9) => "Constant" !== e9.name)) == null ? void 0 : _a.id) ?? -1 : 0, a10 = t10.functionTextures[i15] ?? t10.rasterTexture, u9 = "Reproject" === r15.name;
    return { texture: { texture: a10, unit: 0 }, srcImageSize: t10.getRasterTextureSize(u9) };
  }
  _getMultipleInputConfig(e8, t10) {
    return (t10 == null ? void 0 : t10.length) ? 2 === t10.length ? { twoRasterConfig: this._getTwoInputConfig(t10, e8) } : 3 === t10.length ? { threeRasterConfig: this._getThreeInputConfig(t10, e8) } : {} : {};
  }
  _getConstantCount(e8) {
    return (e8 == null ? void 0 : e8.filter((e9) => "Constant" === e9.name).length) ?? 0;
  }
  _getTextures(e8, t10) {
...
var x4 = class extends h12 {
  ...
  _processIndex(t10) {
    var _a;
    const { r: u9, g: s10 } = t10, r15 = (_a = this.adjustmentConfig) == null ? void 0 : _a.adjustments;
...
var e6 = class extends i13 {
  ...
  _process(s10, t10) {
    const { rasters: e8 } = s10.rasterFunction.parameters, o6 = { constantCount: this._getConstantCount(e8), imageCount: (e8 == null ? void 0 : e8.length) ?? 1 }, r15 = this._getMultipleInputConfig(t10, e8), n7 = this._getCommonConfig(s10, t10), a10 = { shader: this.shaders.compositeBand, uniforms: { config: n7, ...r15 }, defines: o6, optionalAttributes: null, useComputeBuffer: false }, { painter: i15, context: p6 } = s10;
...
var g11 = class extends s2 {
  ...
  render(o6, r15) {
    this._fbo ?? (this._fbo = s4(o6.context, o2, o2));
...
var o5 = class extends n3 {
  ...
  onDetach() {
    var _a, _b, _c;
    super.onDetach(), (_a = this._colorizerTechnique) == null ? void 0 : _a.shutdown(), this._colorizerTechnique = void 0, (_b = this._processorTechnique) == null ? void 0 : _b.shutdown(), this._processorTechnique = void 0, (_c = this._highlightTechnique) == null ? void 0 : _c.shutdown(), this._highlightTechnique = void 0;
  }
  doRender(e8) {
    var _a, _b;
    if (!this.visible || 1 !== e8.drawPhase || !this._colorizerTechnique) return;
    const { rasterFunctionChain: i15 } = this;
    if ((_a = i15 == null ? void 0 : i15.functions) == null ? void 0 : _a.length) {
    ...
    if (((_b = this._pixelHighlights) == null ? void 0 : _b.length) && this._highlightTechnique) for (const s10 of this._pixelHighlights) {
...
var S7 = class extends b {
  ...
  get isCPUBasedDRA() {
    ...
    return "raster-stretch" === (e8 == null ? void 0 : e8.type) && e8.dynamicRangeAdjustment && (!this.canUseWebGLForProcessing || !("min-max" === e8.stretchType || "standard-deviation" === e8.stretchType));
  }
  ...
  update(e8) {
    ...
    if (this.layer.raster) {
      ...
      this._needBlockCacheUpdate = false, ((_a = this.previousLOD) == null ? void 0 : _a.level) !== r15.level && (this.previousLOD = r15, null != this._symbolizerParams && this.canUseLocalSymbolizerParams && this._updateSymbolizerParams(), this._tileStrategy.updateCacheSize(0));
    }
  }
  moveEnd() {
  ...
  _getBandIds() {
    ...
    return (e8 == null ? void 0 : e8.length) && (i15 == null ? void 0 : i15.length) && 1 !== t10.rasterInfo.bandCount ? e8.map((e9) => i15[Math.min(e9, i15.length - 1)]) : "rasterFunction" in t10 ? i15 : e8;
  }
  ...
  _getFetchOptions(e8, t10) {
    var _a;
    const { canUseWebGLForProcessing: i15 } = this, { layerView: s10 } = this, { tileInfo: r15 } = s10, a10 = !r15.isWrappable && null != $(s10.view.spatialReference), o6 = i15 && this.layer.raster.hasUniqueSourceStorageInfo, { layer: l7 } = this.layerView, n7 = ((_a = l7.serviceRasterInfo) == null ? void 0 : _a.storageInfo.isBsqTile) ? l7.getRawDisplayBandIds() : void 0;
  ...
  _canUseLayerLODs() {
    ...
    const { lods: i15 } = e8.tileInfo, s10 = (_a = t10.view.constraints) == null ? void 0 : _a.effectiveLODs;
    return (s10 == null ? void 0 : s10.length) === i15.length && s10.every(({ scale: e9 }, t11) => Math.abs(e9 - i15[t11].scale) < 1e-3);
  }
  ...
  async _redrawImage(e8) {
    ...
    if (await this.layer.updateRenderer(), this.isCPUBasedDRA ? await this._updateGlobalSymbolizerParams(e8) : (this.canUseLocalSymbolizerParams && this._updateSymbolizerParams(), this._globalSymbolizerParams = null), !this.attached || (e8 == null ? void 0 : e8.aborted)) return;
    ...
    await Promise.allSettled(t10), this.attached && !(e8 == null ? void 0 : e8.aborted) && this.container.requestRender();
  }
  async _updateGlobalSymbolizerParams(e8) {
    ...
    if (!(i15 == null ? void 0 : i15.pixelBlock)) return;
...
var m11 = class extends S7 {
  ...
  get canUseWebGLForProcessing() {
    ...
    const r15 = (_a = t10.lookup.colormapLut) == null ? void 0 : _a.indexedColormap, s10 = r15 && r15.length > this._maxIndexedColormapSize, i15 = l2(this.layer.serviceRasterInfo);
  ...
  updateRasterFunctionParameters() {
    ...
    const s10 = this._rasterFunctionState, { rasterFunction: i15, primaryRasters: o6 } = e8, n7 = i15.supportsGPU && (!o6 || o6.rasters.length <= 1), a10 = n7 ? i15.flatWebGLFunctionChain : null, { renderer: l7 } = this.layer, c10 = !n7 || !(a10 == null ? void 0 : a10.functions.length) || "raster-stretch" === (l7 == null ? void 0 : l7.type) && l7.dynamicRangeAdjustment || !this.canUseWebGLForProcessing;
    r15.rasterFunctionChain = c10 ? null : this._addProjection(a10);
    const p6 = null == i15 ? "na" : r15.rasterFunctionChain ? "gpu" : "cpu", u9 = s10 === p6 || "na" === s10 && "cpu" === p6 && 0 === ((_a = a10 == null ? void 0 : a10.functions) == null ? void 0 : _a.length);
  ...
  async updateTileSource(e8, t10) {
    ...
    if ([d8.x, d8.y] = p6, d8.resolution = u9, null != (n7 == null ? void 0 : n7.pixelBlock)) {
      ...
      if (d8.rawPixelData = e9, i15) d8.source = n7.pixelBlock, d8.isRendereredSource = false;
        ...
        const t11 = await this.layer.applyRenderer(e9, "stretch" === (l7 == null ? void 0 : l7.type) ? l7 : void 0);
  ...
  async updateTileSymbolizerParameters(e8, t10, r15) {
    ...
    a10 || null == c10 ? (l7.isRendereredSource && null != c10 && (l7.source = c10.pixelBlock), l7.isRendereredSource = false) : (l7.source = await this.layer.applyRenderer(c10, "stretch" === (i15 == null ? void 0 : i15.type) ? i15 : void 0, { signal: r15 }), l7.isRendereredSource = true), l7.symbolizerParameters = a10 ? this.layerView.hasTilingEffects ? i15 : s10 : null;
  ...
  updateHighlightOptions(e8) {
    ...
    for (const { target: o6, options: n7 } of e8) {
      ...
      const c10 = o6.bandId ?? 0, p6 = r6(n7), u9 = ((_a = i15.find((e10) => e10.name === p6)) == null ? void 0 : _a.color) ?? e2, m12 = u2.toUnitRGBA(u9);
  ...
  _addProjection(e8) {
    var _a;
    return ((_a = e8 == null ? void 0 : e8.functions) == null ? void 0 : _a.length) && !e8.hasFocalFunction && e8.functions.unshift({ name: "Reproject", parameters: { targetImageSize: this._tileInfoView.tileInfo.size, requireNNEdge: e8.isSourceSingleBand }, pixelType: "f32", id: 0, isNoopProcess: false }), e8;
  }
};
...
var a9 = class extends S7 {
  ...
  async fetchTile(e8, t10) {
    ...
    return "vector-magdir" === ((_a = this.layer.serviceRasterInfo) == null ? void 0 : _a.dataType) && (i15 == null ? void 0 : i15.pixelBlock) && (i15.pixelBlock = await this.layer.convertVectorFieldData(i15.pixelBlock, "vector-magdir", t10)), i15;
  }
  updateTileSource(e8, t10) {
    ...
    if (r15.offset = this._getTileSymbolOffset(r15.key, o6), null != (s10 == null ? void 0 : s10.pixelBlock)) {
  ...
  updateTileSymbolizerParameters(e8, t10) {
    ...
    const l7 = (_a = o6.rawPixelData) == null ? void 0 : _a.pixelBlock;
  ...
  _updateSymbolType(e8) {
    "vector-field" === (e8 == null ? void 0 : e8.type) && (this.container.symbolTypes = "wind-barb" === e8.style ? ["scalar", "triangle"] : "simple-scalar" === e8.style ? ["scalar"] : ["triangle"]);
  }
};
...
var f9 = (f10) => {
  ...
  let d8 = class extends h20 {
    ...
    get timeExtent() {
      var _a;
      return i8(this.layer, (_a = this.view) == null ? void 0 : _a.timeExtent, this._get("timeExtent"));
    }
    get hasTilingEffects() {
      const { renderer: t10 } = this.layer;
      return !!("raster-stretch" === (t10 == null ? void 0 : t10.type) && t10.dynamicRangeAdjustment && !("min-max" === t10.stretchType || "standard-deviation" === t10.stretchType));
    }
    ...
    async fetchPopupFeaturesAtLocation(t10, i15) {
      ...
      const c10 = [], { value: m12, magdirValue: f11, processedValue: h21 } = await s10.identify(t10, { timeExtent: this.timeExtent, signal: i15 == null ? void 0 : i15.signal });
      let d9 = "";
      if (m12 == null ? void 0 : m12.length) {
        ...
        t11[i5.servicePixelValue] = "imagery-tile" === s10.type && t(s10.raster) ? h21 == null ? void 0 : h21.join(", ") : d9, t11[i5.rawServicePixelValue] = d9;
        const r15 = ((_a = s10.raster) == null ? void 0 : _a.rasterInfo) ?? s10.serviceRasterInfo, i16 = r15 == null ? void 0 : r15.attributeTable;
        if (null != i16) {
        ...
        const l8 = r15 == null ? void 0 : r15.dataType;
        "vector-magdir" !== l8 && "vector-uv" !== l8 || (t11[i5.magnitude] = f11 == null ? void 0 : f11[0], t11[i5.direction] = f11 == null ? void 0 : f11[1]);
        ...
        const { graphicOrigin: y8 } = s10, g12 = new _2({ geometry: (_b = this.fullExtent) == null ? void 0 : _b.clone(), attributes: t11, layer: s10, origin: y8, sourceLayer: s10 });
        c10.push(g12);
      }
      return c10;
    }
...
var b8 = class extends f9(i7(b3(d2))) {
  ...
  update(e8) {
    var _a;
    (_a = this.subview) == null ? void 0 : _a.update(e8), this.notifyChange("updating");
  }
  isUpdating() {
  ...
  attach() {
    this.layer.increaseRasterJobHandlerUsage(), this._updateSubview(), this.addAttachHandles([l(() => this.displayParameters, (e8, i15) => {
      var _a, _b, _c, _d;
      const r15 = e8.interpolation !== (i15 == null ? void 0 : i15.interpolation) && ("majority" === e8.interpolation || "majority" === (i15 == null ? void 0 : i15.interpolation)) && o3(this.layer), o6 = !!((_b = (_a = this.layer.serviceRasterInfo) == null ? void 0 : _a.storageInfo) == null ? void 0 : _b.isBsqTile) && ((_c = e8.bandIds) == null ? void 0 : _c.join()) !== ((_d = i15 == null ? void 0 : i15.bandIds) == null ? void 0 : _d.join()), a10 = e8.renderer !== (i15 == null ? void 0 : i15.renderer) && this._getSubviewType(i15 == null ? void 0 : i15.renderer) !== this._getSubviewType(e8.renderer);
      a10 && this._updateSubview();
      const n7 = e8.multidimensionalDefinition !== (i15 == null ? void 0 : i15.multidimensionalDefinition), h20 = e8.rasterFunction !== (i15 == null ? void 0 : i15.rasterFunction), u9 = h20 && !this._useWebGLForProcessing, l7 = n7 || r15 || a10 || u9 || o6;
  ...
  highlight(e8, s10) {
    var _a;
    if (!((_a = e8.pixelRanges) == null ? void 0 : _a.length)) return e();
  ...
  _detachSubview(e8) {
    (e8 == null ? void 0 : e8.attached) && (this.container.removeChild(e8.container), e8.detach(), e8.attached = false);
  }
  _getSubviewType(e8) {
    const i15 = e8 == null ? void 0 : e8.type;
    return "vector-field" === i15 ? "rasterVF" : "flow" === i15 ? "flow" : "raster";
  }
  _updateHighlightOptions(e8) {
    "raster" === (e8 == null ? void 0 : e8.type) && e8.updateHighlightOptions(this._pixelHighlights);
  }
};
...
//# sourceMappingURL=ImageryTileLayerView2D-3WB27B3H.js.map
