...
var _DropdownItem = class _DropdownItem extends LitElement {
  constructor() {
    super();
  ...
  render() {
    ...
    })}>${selectionMode !== "none" ? html`<calcite-icon class=${safeClassMap(CSS.icon)} .icon=${selectionMode === "multiple" ? ICONS.check : ICONS.bulletPoint} .scale=${getIconScale(this.scale)}></calcite-icon>` : null}${contentEl}</div>` });
  }
};
_DropdownItem.properties = { disabled: [7, {}, { reflect: true, type: Boolean }], href: [3, {}, { reflect: true }], iconEnd: [3, {}, { reflect: true }], iconFlipRtl: [3, {}, { reflect: true }], iconStart: [3, {}, { reflect: true }], label: 1, rel: [3, {}, { reflect: true }], scale: [3, {}, { reflect: true }], selected: [7, {}, { reflect: true, type: Boolean }], selectionMode: 1, target: [3, {}, { reflect: true }] };
_DropdownItem.styles = styles;
...
@esri/calcite-components/dist/components/calcite-dropdown-item/customElement.js:
  ...
  v3.3.3 *)
*/
//# sourceMappingURL=chunk-PX5L5FAR.js.map
