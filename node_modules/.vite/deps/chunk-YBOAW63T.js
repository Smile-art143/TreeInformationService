...
var d2 = class _d extends O {
  ...
  readCentroidForDisplay() {
    var _a;
    const r8 = (_a = this._reader.readCentroidForDisplay()) == null ? void 0 : _a.clone();
    if (r8) {
...
var h2 = class {
  ...
  onChunkInsert(e4) {
    ...
    if (this._overrides.size) {
      ...
      for (; t4.next(); ) {
        ...
        if ((s4 == null ? void 0 : s4.lastWeak) && (s4.lastWeak = null), s4 == null ? void 0 : s4.isWeak) {
          const e6 = t4.readOptimizedFeatureWorldSpace(), r8 = ((_a = s4.inner) == null ? void 0 : _a.attributes) ?? {};
  ...
  apply(e4, t4) {
    ...
    for (const n8 of s4) {
      ...
      (t5 == null ? void 0 : t5.isStrong) ? t5.lastWeak = e5 : (this._overrides.set(n8.objectId, e5), this._update.modify(n8));
    }
    for (const n8 of i8) {
      const e5 = new d3(n8, false), t5 = this._overrides.get(n8.objectId);
      e5.lastWeak = (t5 == null ? void 0 : t5.isWeak) ? t5 : (t5 == null ? void 0 : t5.lastWeak) ?? null, this._overrides.set(n8.objectId, e5), this._update.modify(n8);
    }
    for (const n8 of r8) {
      const e5 = new d3(null, true), t5 = this._overrides.get(n8);
      (t5 == null ? void 0 : t5.isStrong) ? t5.lastWeak = e5 : (this._overrides.set(n8, e5), this._update.remove(n8));
    }
    for (const n8 of a4) {
      const e5 = new d3(null, false), t5 = this._overrides.get(n8);
      e5.lastWeak = (t5 == null ? void 0 : t5.isWeak) ? t5 : (t5 == null ? void 0 : t5.lastWeak) ?? null, this._overrides.set(n8, e5), this._update.remove(n8);
    }
    if (o7.length) {
      const e5 = /* @__PURE__ */ new Set();
      for (const t5 of o7) {
        const s5 = this._overrides.get(t5);
        (s5 == null ? void 0 : s5.lastWeak) ? (this._overrides.set(t5, s5.lastWeak), null == s5.lastWeak.inner ? this._update.remove(t5) : this._update.modify(s5.lastWeak.inner)) : s5 && !s5.isWeak && (this._overrides.delete(t5), e5.add(t5));
      }
      t4.forEachUnsafe((t5) => {
...
var n7 = class {
  ...
  clear() {
    ...
    this._chunks.clear(), (_a = this._overrides) == null ? void 0 : _a.clearWeakOverrides();
  }
  get usedMemory() {
    let e4 = 0;
  ...
  *chunks() {
  ...
  insert(e4) {
    var _a;
    has("esri-2d-update-debug") && console.debug(`Chunk[${e4.chunkId}] SourceChunkStore.insert`), (_a = this._overrides) == null ? void 0 : _a.onChunkInsert(e4), this._chunks.set(e4.chunkId, e4), this.events.emit("changed");
  }
  remove(e4) {
  ...
  cleanup() {
    ...
    return this._chunksToRemove = [], (_a = this._overrides) == null ? void 0 : _a.cleanup(this._chunks.values()), e4;
  }
  ...
  takeOverrideUpdate() {
    var _a;
    return (_a = this._overrides) == null ? void 0 : _a.takeOverrideUpdate();
  }
  refresh() {
  ...
  mapObjectIdsFromGlobalIds(e4, s4) {
    ...
    return (_a = this._overrides) == null ? void 0 : _a.putWeakObjectIdsFromGlobalIds(t4, r8, s4), this._forEachUnsafeIgnoreOverrides((e5) => {
...
//# sourceMappingURL=chunk-YBOAW63T.js.map
