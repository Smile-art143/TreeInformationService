...
function r(r2, n, a) {
  ...
  const u = o;
  let d, c, y;
  if (l && (c = l.spatialReference, y = A(c), u.geometryType = v(l), u.geometry = i(l, s), u.inSR = y), o.groupByFieldsForStatistics && (u.groupByFieldsForStatistics = o.groupByFieldsForStatistics.join(",")), o.objectIds) switch ((_a = a == null ? void 0 : a.uniqueIdFields) == null ? void 0 : _a.length) {
    case void 0:
  ...
  if (o.orderByFields && (u.orderByFields = o.orderByFields.join(",")), !o.outFields || !o.returnDistinctValues && ((n == null ? void 0 : n.returnCountOnly) || (n == null ? void 0 : n.returnExtentOnly) || (n == null ? void 0 : n.returnIdsOnly)) ? delete u.outFields : o.outFields.includes("*") ? u.outFields = "*" : u.outFields = o.outFields.join(","), o.outSR ? (u.outSR = A(o.outSR), d = r2.outSpatialReference) : l && (o.returnGeometry || o.returnCentroid) && (u.outSR = u.inSR, d = c), o.returnGeometry && delete o.returnGeometry, o.outStatistics && (u.outStatistics = JSON.stringify(o.outStatistics)), o.fullText && (u.fullText = JSON.stringify(o.fullText)), o.pixelSize && (u.pixelSize = JSON.stringify(o.pixelSize)), o.quantizationParameters && (r2.defaultSpatialReferenceEnabled && null != c && null != ((_b = r2.quantizationParameters) == null ? void 0 : _b.extent) && c.equals(r2.quantizationParameters.extent.spatialReference) && delete o.quantizationParameters.extent.spatialReference, u.quantizationParameters = JSON.stringify(o.quantizationParameters)), o.parameterValues && (u.parameterValues = JSON.stringify(o.parameterValues)), o.rangeValues && (u.rangeValues = JSON.stringify(o.rangeValues)), o.dynamicDataSource && (u.layer = JSON.stringify({ source: o.dynamicDataSource }), delete o.dynamicDataSource), o.timeExtent) {
...
//# sourceMappingURL=chunk-42BC2RBT.js.map
