...
async function S(n2, o, a = {}, s2 = 5) {
  ...
  if (C2) {
    ...
    C2.timeReference || (C2.timeReference = { timeZoneIANA: n }), C2.startTimeField || C2.endTimeField || (F().warn({ name: "ogc-feature-layer:invalid-timeInfo", message: "startTimeField and endTimeField are missing", details: { timeInfo: C2 } }), C2 = void 0);
  }
...
function U(e2, t, n2) {
  var _a;
  if (!n2) return;
  const i3 = L(n2, "next", "application/geo+json"), r = (_a = I(i3 == null ? void 0 : i3.href)) == null ? void 0 : _a.query;
  if (!r) return;
  const a = I(e2).query, s2 = Object.keys(a ?? {}), l = Object.entries(r).filter(([e3]) => !s2.includes(e3)).find(([e3, n3]) => T.has(e3.toLowerCase()) && Number.parseInt(n3, 10) === t), c = l == null ? void 0 : l[0];
  return c;
}
...
//# sourceMappingURL=chunk-AGFKUVLU.js.map
