...
async function m3(e2, t3, r2) {
  ...
  if (null != r2 && "mesh" === (s4 == null ? void 0 : s4.type)) {
...
async function g2(e2, t3) {
  ...
  if (r2 && ("attributes" in r2 ? d2.parentGlobalId = (_a = r2.attributes) == null ? void 0 : _a[e2.globalIdField] : r2.globalId && (d2.parentGlobalId = r2.globalId)), u3) d2.uploadId = u3;
  else if (i5) {
...
function y(e2) {
  var _a, _b, _c;
  const t3 = e2 == null ? void 0 : e2.assetMaps;
  if (t3) {
  ...
  const a2 = e2 == null ? void 0 : e2.attachments, s4 = { addFeatureResults: ((_a = e2 == null ? void 0 : e2.addResults) == null ? void 0 : _a.map(R)) ?? [], updateFeatureResults: ((_b = e2 == null ? void 0 : e2.updateResults) == null ? void 0 : _b.map(R)) ?? [], deleteFeatureResults: ((_c = e2 == null ? void 0 : e2.deleteResults) == null ? void 0 : _c.map(R)) ?? [], addAttachmentResults: (a2 == null ? void 0 : a2.addResults) ? a2.addResults.map(R) : [], updateAttachmentResults: (a2 == null ? void 0 : a2.updateResults) ? a2.updateResults.map(R) : [], deleteAttachmentResults: (a2 == null ? void 0 : a2.deleteResults) ? a2.deleteResults.map(R) : [] };
  return (e2 == null ? void 0 : e2.editMoment) && (s4.editMoment = e2.editMoment), s4;
}
function R(e2) {
...
function I2(e2, t3) {
  var _a, _b, _c;
  return { adds: ((_a = e2 == null ? void 0 : e2.adds) == null ? void 0 : _a.map((e3) => h2(e3, t3))) || [], updates: ((_b = e2 == null ? void 0 : e2.updates) == null ? void 0 : _b.map((e3) => ({ original: h2(e3[0], t3), current: h2(e3[1], t3) }))) || [], deletes: ((_c = e2 == null ? void 0 : e2.deletes) == null ? void 0 : _c.map((e3) => h2(e3, t3))) || [], spatialReference: t3 };
}
function j(e2) {
...
var G = class extends u {
  ...
  get queryTask() {
    var _a;
    const { capabilities: e2, parsedUrl: t3, gdbVersion: r2, spatialReference: s4, fieldsIndex: a2, uniqueIdFields: i5 } = this.layer, n = "infoFor3D" in this.layer ? this.layer.infoFor3D : null, o3 = "dynamicDataSource" in this.layer ? this.layer.dynamicDataSource : null, u3 = has("featurelayer-pbf") && (e2 == null ? void 0 : e2.query.supportsFormatPBF) && null == n;
    return new S({ dynamicDataSource: o3, fieldsIndex: a2, gdbVersion: r2, infoFor3D: n, pbfSupported: u3, queryAttachmentsSupported: ((_a = e2 == null ? void 0 : e2.operations) == null ? void 0 : _a.supportsQueryAttachments) ?? false, sourceSpatialReference: s4, uniqueIdFields: i5, url: t3.path });
  }
  ...
  async applyEdits(e2, t3) {
    ...
    const { layer: a2 } = this;
    await H2(a2, "editing");
    const n = "infoFor3D" in a2 ? a2.infoFor3D : null, o3 = null != n, u3 = o3 || ((t3 == null ? void 0 : t3.globalIdUsed) ?? false), l2 = o3 ? await this._uploadMeshesAndGetAssetMapEditsJSON(e2) : null, c2 = ((_a = e2.addFeatures) == null ? void 0 : _a.map((e3) => m3(this.layer, e3, n))) ?? [], d2 = (await Promise.all(c2)).filter(N), p = ((_b = e2.updateFeatures) == null ? void 0 : _b.map((e3) => m3(this.layer, e3, n))) ?? [], y2 = (await Promise.all(p)).filter(N), h3 = b2(this.layer, e2.deleteFeatures, u3);
    i3(d2, y2, a2.spatialReference);
    const m4 = await f4(this.layer, e2), f5 = a2.capabilities.editing.supportsAsyncApplyEdits && o3, g3 = (t3 == null ? void 0 : t3.gdbVersion) || a2.gdbVersion, q = { gdbVersion: g3, rollbackOnFailure: t3 == null ? void 0 : t3.rollbackOnFailureEnabled, useGlobalIds: u3, returnEditMoment: t3 == null ? void 0 : t3.returnEditMoment, usePreviousEditMoment: t3 == null ? void 0 : t3.usePreviousEditMoment, async: f5 };
    ...
    (t3 == null ? void 0 : t3.returnServiceEditsOption) ? (q.edits = JSON.stringify([{ id: a2.layerId, adds: d2.length ? d2 : null, updates: y2.length ? y2 : null, deletes: h3.length ? h3 : null, attachments: m4, assetMaps: l2 }]), q.returnServiceEditsOption = V2.toJSON(t3 == null ? void 0 : t3.returnServiceEditsOption), q.returnServiceEditsInSourceSR = t3 == null ? void 0 : t3.returnServiceEditsInSourceSR) : (q.adds = d2.length ? JSON.stringify(d2) : null, q.updates = y2.length ? JSON.stringify(y2) : null, q.deletes = h3.length ? u3 ? JSON.stringify(h3) : h3.join(",") : null, q.attachments = m4 && JSON.stringify(m4), q.assetMaps = null != l2 ? JSON.stringify(l2) : void 0);
    ...
    const E = (t3 == null ? void 0 : t3.returnServiceEditsOption) ? a2.url : a2.parsedUrl.path;
    let O;
    try {
  ...
  async queryFeatures(e2, t3) {
    ...
    if (((_a = e2.outStatistics) == null ? void 0 : _a.length) && r2.features.length) {
  ...
  async uploadAssets(e2, t3) {
    const { uploadAssets: r2 } = await import("./uploadAssets-BWCT4G6S.js");
  ...
  async _fetchService(e2, t3) {
    if (!e2) {
      ...
      const { data: a2 } = await H(this.layer.parsedUrl.path, this._getLayerRequestOptions({ query: s5, signal: t3 == null ? void 0 : t3.signal }));
      e2 = a2;
    }
    this.layer.applyPreferredHost(e2), this.sourceJSON = await this._patchServiceJSON(e2, t3 == null ? void 0 : t3.signal);
    const s4 = e2.type;
  ...
  async _uploadMeshesAndGetAssetMapEditsJSON(e2) {
    ...
    for (const i5 of t3) {
      ...
      if (t(t4)) s4.push(e3);
        ...
        const t5 = e3.origin, { convertMeshVertexSpace: r3 } = await import("./convertMeshVertexSpace-CTKZ23Q5.js"), n = await r3(e3, new i2({ origin: [t5.x, t5.y, t5.z ?? 0] }));
  ...
  _createEditsResult(e2) {
    ...
    if (s4.length > 0) {
      ...
      for (const e3 of s4) {
        const { editedFeatures: t4 } = e3, r3 = (t4 == null ? void 0 : t4.spatialReference) ? new f2(t4.spatialReference) : null;
  ...
  _createAttachmentErrorResult(e2, t3) {
    var _a;
    const r2 = ((_a = t3.details.messages) == null ? void 0 : _a[0]) || t3.message, s4 = t3.details.httpStatus || t3.details.messageCode;
...
//# sourceMappingURL=chunk-BA7YZAML.js.map
