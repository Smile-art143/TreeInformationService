...
import {
  a as a9,
  m as m5
} from "./chunk-XJJP374I.js";
import {
  l as l4,
  n as n12
} from "./chunk-7W5XSUBK.js";
import {
  v as v3
} from "./chunk-LDJGDFK3.js";
import {
  a as a11
} from "./chunk-J5QSHRZZ.js";
import {
  g as g3,
  o as o9
} from "./chunk-QSEN2Y3V.js";
import {
  h as h7
} from "./chunk-N5L3K6FA.js";
import {
  a as a10,
  o as o8,
  u as u4
} from "./chunk-E2AHAB5G.js";
import {
  h as h6
} from "./chunk-YA5YFF26.js";
import {
  t as t9
} from "./chunk-MZRHMV6X.js";
import {
  a as a6,
  a3 as a7,
  c2 as c7,
...
var t11 = class {
  ...
  ensureFramebuffer(e9, t15) {
    var _a, _b, _c;
    this._handle && ((_a = this._handle.fbo) == null ? void 0 : _a.width) === e9 && ((_b = this._handle.fbo) == null ? void 0 : _b.height) === t15 || ((_c = this._handle) == null ? void 0 : _c.release(), this._handle = this._fbos.acquire(e9, t15, this._name, this._format));
  }
  bind(e9) {
    var _a;
    e9.bindFramebuffer((_a = this._handle) == null ? void 0 : _a.fbo);
  }
  generateMipMap() {
    var _a, _b, _c, _d, _e;
...
var s7 = class {
  ...
  getTexture(e9) {
    var _a;
    return (_a = this.targets[e9]) == null ? void 0 : _a.fbo.texture;
  }
  dispose(e9) {
...
var n14 = class extends m4 {
  constructor(r18, o14) {
    super(r18, o14, new t6(a11, () => import("./HighlightApply.glsl-USIBN4ZN.js")), n10(i8));
  }
  initializePipeline() {
...
var a12 = class extends m4 {
  constructor(r18, i12) {
    super(r18, i12, new t6(g3, () => import("./HighlightBlur.glsl-4YD55HBH.js")), n10(i8));
  }
  initializePipeline() {
...
var l6 = class extends m4 {
  constructor(r18, i12) {
    super(r18, i12, new t6(a10, () => import("./HighlightDownsample.glsl-5S664YUK.js")), s6);
  }
  initializePipeline() {
    return T({ colorWrite: d });
  }
...
var a13 = class extends m4 {
  constructor(r18, t15) {
    super(r18, t15, new t6(h7, () => import("./HighlightToSingle.glsl-NJFAFHNM.js")), n10(i8));
  }
  initializePipeline() {
    return T({ colorWrite: d });
  }
...
var q2 = class extends a8 {
  ...
  destroy() {
    this._grid.coverage = t(this._grid.coverage), this._grid.vao = r(this._grid.vao), this._passParameters.highlightOptionsTexture = t(this._passParameters.highlightOptionsTexture);
  }
  ...
  _prepareAndDownSample(e9) {
    ...
    return o14.horizontalCellCount = i12, o14.verticalCellCount = s14, o14.coverageTexture = (_a = r18.coverage) == null ? void 0 : _a.getTexture(), r18;
  }
  _renderGrid(e9) {
  ...
  _renderHighlightPostprocess(e9, t15) {
    ...
    for (let g7 = 0; g7 < q3.length; ++g7) {
      ...
      h10.unbindTexture((_a = c9.fbo) == null ? void 0 : _a.colorTexture), h10.bindFramebuffer(c9.fbo), h10.setViewport(0, 0, _6, v7), h10.clear(16384), h10.bindTechnique(a16, s14, o14, j6), this._renderGrid(p4), i13.release(), o2(j6.blurSize, 0, 1 / v7), o14.highlightBlurTexture = c9.getTexture(), h10.bindFramebuffer(t15.fbo), h10.setViewport4fv(C2), h10.bindTechnique(u6, s14, o14, j6), this._renderGrid(p4), c9.release();
    }
  ...
  _gridComputeCoverage(e9, t15) {
    ...
    (_a = i12.coverage) == null ? void 0 : _a.release();
...
function G2(e9, t15, r18, i12, s14, o14 = 0) {
  ...
  const g7 = l9 == null ? void 0 : l9.getTexture();
  ...
  }), i12.highlightLevel = null, i12.highlightMixTexture = null, l9 == null ? void 0 : l9.release();
}
var I = 4;
...
var a14 = class {
  ...
  acquire(e9, t15, r18) {
    ...
    if (!(s14 == null ? void 0 : s14(r18))) return null;
...
var v4 = class {
  ...
  _updateAnchorPoint(t15) {
    var _a;
    return A(this._anchorPoint, t15.eye), g(this._anchorPoint, this._anchorPoint, t3.radius), 0 === this.fadeState && 2 === ((_a = this.data) == null ? void 0 : _a.state) ? (s2(this.parallax.anchorPoint, this._anchorPoint), 0) : r8(c4(C, this.parallax.anchorPoint, this._anchorPoint));
  }
  requestFade() {
  ...
  _switchReadChannels() {
    var _a;
    2 === ((_a = this.data) == null ? void 0 : _a.state) && (this._readChannels = 1 - this._readChannels, this.data.state = 3);
  }
  get isFading() {
...
var r16 = class {
  constructor(r18, a16, m7) {
    this.rctx = r18, this.techniques = m7, this.lastFrameCamera = new tt(), this.output = 0, this.renderOccludedMask = s9, this.time = n2(0), this.bind = new g5(a16), this.bind.alignPixelEnabled = true;
  }
};
var s9 = 13;
...
var z2 = class {
  ...
  get depthTexture() {
    var _a;
    return (_a = this._handle) == null ? void 0 : _a.getTexture(n9);
  }
  get _textureWidth() {
  ...
  moveSnapshot(t15) {
    var _a, _b;
    s3(this.enabled), (_a = this._snapshots[t15]) == null ? void 0 : _a.release(), this._snapshots[t15] = this._handle, (_b = this._handle) == null ? void 0 : _b.setName(0 === t15 ? "shadow map highlight" : "shadow map excluding highlight"), this._handle = null;
  }
  copySnapshot(t15) {
    var _a, _b, _c, _d;
    if (!this.enabled) return;
    const s14 = (_b = (_a = this._handle) == null ? void 0 : _a.getTexture(n9)) == null ? void 0 : _b.descriptor;
    if (!s14) return;
    (_c = this._snapshots[t15]) == null ? void 0 : _c.release();
    const e9 = 0 === t15 ? "shadow map highlight" : "shadow map excluding highlight", i12 = this._acquireFBO(e9);
    this._snapshots[t15] = i12;
    const a16 = (_d = this._handle) == null ? void 0 : _d.fbo;
    if (!a16 || !(i12 == null ? void 0 : i12.fbo)) return void console.error("No FBO");
    const { rctx: r18 } = this._fbos;
    r18.blitFramebuffer(a16, i12.fbo, 256);
  }
  getSnapshot(t15) {
    var _a;
    return this.enabled ? (_a = this._snapshots[t15]) == null ? void 0 : _a.getTexture(n9) : null;
  }
  clear() {
  ...
  _ensureFbo() {
    var _a, _b, _c, _d;
    ((_b = (_a = this._handle) == null ? void 0 : _a.fbo) == null ? void 0 : _b.width) === this._textureWidth && ((_c = this._handle) == null ? void 0 : _c.fbo.height) === this._textureHeight || ((_d = this._handle) == null ? void 0 : _d.release(), this._handle = this._acquireFBO("shadow map"));
  }
  _acquireFBO(t15) {
    var _a;
    const s14 = this._fbos.acquire(this._textureWidth, this._textureHeight, t15, 12);
    return (_a = s14.getTexture(n9)) == null ? void 0 : _a.setShadowFiltering(true), s14;
  }
  _discardSnapshot(t15) {
    this._snapshots[t15] = t(this._snapshots[t15]);
  }
  _discardSnapshots() {
...
var a15 = class extends m4 {
  constructor(o14, i12) {
    super(o14, i12, new t6(m5, () => import("./TextureOnly.glsl-GUKBKKUK.js")), s6);
  }
...
var t13 = class extends m4 {
  constructor(r18, t15) {
    super(r18, t15, new t6(l4, () => import("./OverlayCompositing.glsl-WFRVVHUY.js")), s6);
  }
};
...
var I3 = class extends n13 {
  ...
  get updating() {
    return this._sortedDrapeSourceRenderersDirty || n4(this._renderers, (e9) => e9.updating || e9.canCompact);
  }
  get hasOverlays() {
  ...
  releaseRenderTargets(e9) {
    var _a;
    (_a = this._renderTargets) == null ? void 0 : _a.dispose(e9);
  }
  get overlays() {
    return this._overlays ?? [];
  }
  ensureDrapeTargets(e9) {
    this._hasTargetWithoutRasterImage = !!this._overlays && n3(e9, (e10) => 1 === e10.drapeTargetType);
  }
  ensureDrapeSources(e9) {
    this._overlays ? (this._hasDrapedFeatureSource = n3(e9, (e10) => 1 === e10.drapeSourceType), this._hasDrapedRasterSource = n3(e9, (e10) => 0 === e10.drapeSourceType), this._hasDrapedFlowSource = n3(e9, (e10) => 2 === e10.drapeSourceType)) : this._hasDrapedFeatureSource = this._hasDrapedRasterSource = this._hasDrapedFlowSource = false;
  }
  ...
  disposeOverlays() {
    var _a;
    this._overlays = null, (_a = this._renderTargets) == null ? void 0 : _a.dispose(1), this._renderTargets = null, this.events.emit("textures-disposed");
  }
  ...
  getTexture(e9) {
    ...
    return (_a = this._renderTargets) == null ? void 0 : _a.getTexture(r18 ? 0 : e9);
  }
  get readyToRun() {
  ...
  _onMaterialOrContentChanged() {
    this.renderOccludedFlags = n4(this._renderers, (e9) => e9.hasOccluders) ? H2 : 1;
  }
  _processDrapeSources(e9, r18) {
    ...
    this._sortedDrapeSourceRenderersDirty && (this._sortedDrapeSourceRenderersDirty = false, t15 = true, this._updateSortedDrapeSourceRenderers(), e9.madeProgress()), this.compact(e9), t15 && (null != this._overlays && 0 === this._renderers.size && this.disposeOverlays(), this.notifyChange("updating"), this.notifyChange("isEmpty"), this._onMaterialOrContentChanged(), this.hasHighlights = n4(this._renderers, (e10) => e10.hasHighlights), this.events.emit("content-changed"));
  }
  compact(e9) {
    let r18 = false;
  ...
  hasHighlight(e9) {
    return n4(this._renderers, (r18) => r18.hasHighlight(e9));
  }
  processSyncDrapeSources() {
    this._processDrapeSources(F, (e9) => 1 === e9.updatePolicy);
  }
  get isEmpty() {
    return !t4.OVERLAY_DRAW_DEBUG_TEXTURE && t2(this._renderers, (e9) => e9.isEmpty);
  }
  get hasWater() {
    const e9 = n4(this._renderers, ({ hasWater: e10 }) => e10);
  ...
  renders(e9) {
    ...
    this._renderContext.output = ((_b = (_a = this._renderTargets) == null ? void 0 : _a.targets.find((r19) => r19.content === e9)) == null ? void 0 : _b.output) ?? 0, ++this._techniques.precompiling;
  ...
  get mode() {
    var _a;
    return this.isEmpty ? 0 : this.hasWater && this.renders(3) ? 2 : ((_a = this._renderTargets) == null ? void 0 : _a.getTexture(0)) ? 1 : 0;
  }
  updateAnimation(e9) {
    let r18 = false;
  ...
  get allSourcesOccluders() {
    return t2(this._renderers, (e9) => e9.hasOnlyOccluders);
  }
  ...
  get _resolution() {
    var _a;
    return ((_a = this._overlays) == null ? void 0 : _a[0].resolution) ?? 0;
  }
  ...
  intersect(e9, r18, t15, s14) {
    ...
    let i12 = 0;
    for (const { renderer: n17 } of this._sortedRenderers) i12 = ((_a = n17.intersect) == null ? void 0 : _a.call(n17, e9, r18, t15, s14, i12)) ?? i12;
  }
  _updateSortedDrapeSourceRenderers() {
    ...
    this._renderers.forEach((t15, s14) => {
      var _a;
      const i12 = e9.indexOf((_a = s14.layer) == null ? void 0 : _a.uid), n17 = i12 >= 0, o14 = s14.renderGroup ?? (n17 ? 0 : 1), a16 = s14.drapeSourcePriorityOffset ?? 0, h10 = r18 * o14 + (n17 ? i12 : 0) + a16;
...
var h8 = class {
  ...
  objectShaderTransformationChanged(t15) {
    null == t15 ? this._shaderTransformation = null : (this._shaderTransformation ?? (this._shaderTransformation = e4()), c3(this._shaderTransformation, t15, this.geometry.transformation)), this._boundingSphere = null;
  }
  get boundingSphere() {
    return this.boundingInfo ? (null == this._boundingSphere && (this._boundingSphere ?? (this._boundingSphere = P()), D(this._boundingSphere, this.boundingInfo.center, this.shaderTransformation), this._boundingSphere[3] = this.boundingInfo.radius * m2(this.shaderTransformation)), this._boundingSphere) : S;
  }
  get material() {
...
function n16(t15) {
  return "style" === (t15 == null ? void 0 : t15.type) ? l7(t15.style) : null;
}
function l7(t15) {
...
var y3 = class extends m4 {
  constructor(e9, r18) {
    super(e9, r18, new t6(v3, () => import("./ColorMaterial.glsl-J2ZTBLIO.js")), v5(r18).locations);
  }
...
//# sourceMappingURL=chunk-VVNAANKQ.js.map
