...
import {
  a as a3
} from "./chunk-H6LITNL7.js";
import {
  R
} from "./chunk-AGFKUVLU.js";
import {
  d as d3,
  i as i9,
  i2 as i10,
  ...
  r as r4,
  t as t5
} from "./chunk-YBOAW63T.js";
import {
  O,
  a as a2,
  u as u7
} from "./chunk-FJXSGGUN.js";
import {
  i as i8
...
import "./chunk-UX7ULDKZ.js";
import "./chunk-6CPY3E7M.js";
import "./chunk-JKVC3PES.js";
...
import {
  b as b3,
  h
} from "./chunk-O2PVKTPO.js";
import {
  n as n3
} from "./chunk-6XKQPIGT.js";
import {
  e as e6
...
import "./chunk-WZ3YWZUG.js";
import {
  f as f3,
  g
} from "./chunk-GJSFCKWY.js";
import "./chunk-524CYU44.js";
import "./chunk-4OFHJCYT.js";
import "./chunk-2QQIFJSE.js";
...
import {
  _
} from "./chunk-UD2KD54X.js";
import "./chunk-6B6OKUKD.js";
import "./chunk-2WVHQ5YM.js";
import "./chunk-4O3MA5ZG.js";
import "./chunk-GVWKTWX5.js";
...
var t8 = class _t {
  ...
  hasArcadeDependency(t17) {
    var _a;
    return ((_a = this._defaultResult) == null ? void 0 : _a.some((e15) => e15.hasArcadeDependency(t17))) ?? false;
  }
  match(t17, e15, s17) {
...
var t9 = class _t extends t8 {
  ...
  hasArcadeDependency(e15) {
    var _a;
    return ((_a = this._field) == null ? void 0 : _a.hasArcadeDependency(e15)) || this._intervals.some((t17) => t17.result.some((t18) => t18.hasArcadeDependency(e15)));
  }
  doMatch(e15, t17) {
    var _a;
    const s17 = (_a = this._field) == null ? void 0 : _a.read(e15, t17);
...
var t10 = class _t extends t8 {
  ...
  hasArcadeDependency(e15) {
    var _a;
    return this._fields.some((t17) => t17.hasArcadeDependency(e15)) || [...this._resultsMap.values()].some((t17) => t17.meshWriters.some((t18) => t18.hasArcadeDependency(e15))) || ((_a = this._nullResult) == null ? void 0 : _a.some((t17) => t17.hasArcadeDependency(e15))) || false;
  }
  doMatch(e15, t17) {
    var _a;
    const s17 = this._getValueFromFields(e15, t17);
    ...
    return (_a = this._resultsMap.get(l11)) == null ? void 0 : _a.meshWriters;
  }
...
var s11 = class _s extends s9 {
  ...
  async enqueueMatcherRequests(e15, t17) {
    var _a;
    await Promise.all([this._symbology.fetchResources(e15, t17), (_a = this._labels) == null ? void 0 : _a.fetchResources(e15, t17)]);
  }
  ...
  hasArcadeDependency(e15) {
    var _a;
    return !(!this._symbology.hasArcadeDependency(e15) && !((_a = this._labels) == null ? void 0 : _a.hasArcadeDependency(e15)));
  }
};
...
var s13 = class _s {
  static async create(i21, e15) {
    ...
    const a9 = await i21.createComputedField({ expression: (_a = e15.onStatisticExpression) == null ? void 0 : _a.expression, field: e15.onStatisticField });
...
var z2 = class {
  ...
  get _trackLineAttributes() {
    var _a;
    const t17 = { ...(_a = this._latestObservationFeature) == null ? void 0 : _a.attributes, aggregateId: this.objectId, [r2]: 0 };
  ...
  *previousObservations() {
  ...
  commitObservations(t17, e15, r10) {
    ...
    switch (this._observationRecords = [], this._trackLinePath = [], this._isStream || null == this._startTimeField || this._nextObservationRecords.sort((t18, e16) => {
      ...
      case "startTimeField":
        o8 = (_a = this._metadata.timeInfo) == null ? void 0 : _a.startTimeField;
        break;
      case "endTimeField":
        o8 = (_b = this._metadata.timeInfo) == null ? void 0 : _b.endTimeField;
        break;
      case "timeReceived":
        o8 = this._isStream ? i6 : null;
    }
    n12 = this._isStream ? (r10 == null ? void 0 : r10.end) ?? Date.now() : (r10 == null ? void 0 : r10.end) ?? -1 / 0;
    ...
    for (let d10 = this._nextObservationRecords.length - 1; d10 >= 0 && !(this._observationRecords.length >= this._maxDisplayObservationsPerTrack); d10--) {
      ...
      (null != r11 ? n12 - r11 : 0) >= this._maxDisplayDuration || (this._commitObservation(t18, e16), c8 ?? (c8 = t18));
    }
    if (null != c8) {
  ...
  _commitObservation(t17, e15) {
    ...
    let r10 = s17 == null ? void 0 : s17.coords[0], i21 = s17 == null ? void 0 : s17.coords[1];
...
var U = class _U extends i14 {
  static async create(t17, e15, s17, a9, o8) {
    ...
    return n12.isWrappable || s5() || await Promise.all([import("./apiConverter-5K3NMBZB.js"), import("./jsonConverter-VSK6CDMA.js"), i7()]).then(([t18, e16, s18]) => {
  ...
  displayMap(t17, e15, s17) {
    ...
    for (const a9 of this._tracks.values()) {
      ...
      if (e16 == null ? void 0 : e16.objectId) {
  ...
  _rebuildTracks() {
    ...
    const e15 = (_a = this._metadata.timeInfo) == null ? void 0 : _a.trackIdField;
    if (null == e15) return;
    ...
    for (const r10 of this._tracks.values()) if (s17.has(r10.trackId)) {
      const e16 = r10.commitObservations(this._attributeStore, t17, (_b = this._featureFilter) == null ? void 0 : _b.timeExtent);
...
var b5 = class {
  ...
  onSubscribe(t17) {
    var _a;
    (_a = this._strategy) == null ? void 0 : _a.onSubscribe(t17);
  }
  onUnsubscribe(t17) {
    var _a;
    (_a = this._strategy) == null ? void 0 : _a.onUnsubscribe(t17);
  }
  requiresInvalidation() {
    var _a;
    return ((_a = this._strategy) == null ? void 0 : _a.requiresInvalidation()) ?? false;
  }
  async update(t17, s17, r10, i21, o8) {
    var _a, _b2, _c, _d, _e, _f, _g;
    const n12 = t17.processor, h7 = i((_a = this._schema) == null ? void 0 : _a.storage, n12.storage), u12 = i((_b2 = this._schema) == null ? void 0 : _b2.mesh.properties, n12.mesh.properties), p4 = i((_c = this._schema) == null ? void 0 : _c.mesh.factory, n12.mesh.factory), y9 = i((_d = this._schema) == null ? void 0 : _d.mesh.strategy, n12.mesh.strategy), d10 = w2((_e = this._schema) == null ? void 0 : _e.expressionProperties, n12.expressionProperties), _7 = d10.some((t18) => this._attributeStore.hasArcadeDependency(t18)), l11 = d10.some((t18) => {
      var _a2;
      return ((_a2 = this._factory) == null ? void 0 : _a2.hasArcadeDependency(t18)) ?? false;
    }), m10 = d10.some((t18) => {
      var _a2;
      return (_a2 = this._strategy) == null ? void 0 : _a2.hasArcadeDependency(t18);
    }) || ((_f = this._strategy) == null ? void 0 : _f.isAggregate) && _7, b6 = l11 || m10, I2 = u12 || p4 || y9;
    ...
    if ((h7 || I2 || _7) && (await this._attributeStore.update(n12.storage, j, this._source.metadata, s17), (_g = this._strategy) == null ? void 0 : _g.invalidateAttributeData(S2(n12))), !i21 && !I2 && !b6) return false;
  ...
  async removeChunks(t17) {
    var _a;
    (_a = this._strategy) == null ? void 0 : _a.removeChunks(t17), this._attributeStore.incrementDisplayIdGeneration();
  }
  ...
  async _doUpdateChunks() {
    ...
    for await (const a9 of t17) {
      ...
      const i21 = t18.push(a9).catch((t19) => m(t19));
      e15.push(i21);
    }
    try {
  ...
  async _updateStrategy(t17, e15, s17, r10) {
    var _a;
    switch ((_a = this._strategy) == null ? void 0 : _a.destroy(), t17.type) {
      case "feature":
  ...
  async _process(t17) {
    ...
    const s17 = { currentUser: (_a = this._schema) == null ? void 0 : _a.mesh.properties.currentUser };
    ...
    if ((_b2 = this._schema) == null ? void 0 : _b2.mesh.properties.returnMeshObjectId) {
      c8.objectIdMap = {};
      const e16 = (_c = t17.reader) == null ? void 0 : _c.getCursor();
  ...
  async _write(t17, e15, s17) {
    var _a;
    const a9 = t17.subscription.tile, o8 = (_a = t17.reader) == null ? void 0 : _a.getCursor(), c8 = (o8 == null ? void 0 : o8.getSize()) ?? 0, h7 = a9.tileInfoView.tileInfo.isWrappable, u12 = a9.tileInfoView.tileInfo.spatialReference.isWGS84, g5 = new g2(a9.key, this._strategy.enablePixelBuffering, h7, u12, c8);
    if (!o8) return g5;
  ...
  _getSortKeyValue(t17, e15) {
    ...
    const { computed: s17, order: r10, byRenderer: i21 } = this._sortInfo, a9 = i21 ? this._factory.getSortKey(t17, e15) : s17 == null ? void 0 : s17.read(t17, e15);
...
function w2(t17, e15) {
  var _a, _b, _c, _d;
  const s17 = [];
  return ((_a = t17 == null ? void 0 : t17.timeExtent) == null ? void 0 : _a.start) === ((_b = e15.timeExtent) == null ? void 0 : _b.start) && ((_c = t17 == null ? void 0 : t17.timeExtent) == null ? void 0 : _c.end) === ((_d = e15.timeExtent) == null ? void 0 : _d.end) || s17.push("timeProperties"), s17;
}
function S2(t17) {
  const { timeZone: e15 } = (t17 == null ? void 0 : t17.mesh.properties) ?? {}, { timeExtent: s17 } = (t17 == null ? void 0 : t17.expressionProperties) ?? {};
...
var a5 = class extends b {
  constructor(e15) {
    super(), this._connection = e15, this._enabledEventTypes = /* @__PURE__ */ new Set(), this._updateInfo = { websocket: 0, client: 0 }, this._lastTime = performance.now(), this._queuedCommands = [], this.addHandles([l(() => {
      var _a;
    ...
    }, (e16) => this._layerView.setProperty({ propertyName: "pipelineErrorString", value: e16 }), { initial: true })]);
  }
  destroy() {
...
__decorate([m2()], a5.prototype, "_strategy", void 0), a5 = __decorate([a("esri.views.2d.layers.features.sources.StreamMessenger")], a5);
...
function a6(e15, a9, c8, f7 = false) {
  ...
  const C2 = e9(c8);
  return m10.idFieldIndices = Array.from(C2, (e16) => {
    var _a;
    return (_a = m10.fields.get(e16)) == null ? void 0 : _a.index;
  }), m10.transform = A, m10.displayIds = new Uint32Array(m10.featureCount), m10.groupIds = new Uint16Array(m10.featureCount), h7.move(l11), m10;
}
...
var I = class _I extends O {
  ...
  _readGeometry(e15 = false) {
    if (void 0 === this._cache.geometry) {
      ...
      return 0 === (r10 == null ? void 0 : r10.coords.length) && (r10 = null), this._cache.geometry = r10, r10;
    }
...
var f6 = class extends c6 {
  async executeQuery(t17, s17) {
    ...
    return "esriGeometryPoint" === this._metadata.geometryType && (c8.features = (_a = c8.features) == null ? void 0 : _a.filter((t18) => {
...
var l8 = class extends e14 {
  constructor(e15, t17, r10) {
    super(e15.metadata, t17, r10), this._service = e15, this._didApplyOverride = false, this._queue = new _({ concurrency: o7, process: async (e16) => {
      var _a;
      const t18 = { signal: (_a = e16.options) == null ? void 0 : _a.signal, query: e16.query.customParameters, useRequestQueue: true };
...
var i18 = class extends i10 {
  constructor(e15, i21, t17, r10, s17, h7) {
    var _a, _b;
    super(), this._reader = e15, this._queryJSON = i21, this._tile = t17, this._sourceTile = r10, this._sourceTileDepth = s17, this._end = h7, this.chunkId = `${this._tile.key.id}.${(_a = this._sourceTile) == null ? void 0 : _a.key.id}${this._end ? "e" : ""}`, this.normalizedChunkId = `${this._tile.key.normalizedId}.${(_b = this._sourceTile) == null ? void 0 : _b.key.normalizedId}${this._end ? "e" : ""}`;
  }
  get queryInfo() {
    var _a;
...
var c7 = class extends s15 {
  ...
  unload(e15) {
    var _a;
    super.unload(e15), (_a = this._loadStates.get(e15.key.id)) == null ? void 0 : _a.destroy(), this._loadStates.delete(e15.key.id);
  }
...
var u11 = class extends e14 {
  ...
  async _updateFields(e15) {
    ...
    if (null == r10) return;
    const a9 = Array.from(t17).map((e16) => {
      var _a;
      return (_a = r10.get(e16)) == null ? void 0 : _a.column;
    });
  ...
  async _insert(e15) {
    ...
    const h7 = new Uint32Array(Array.from(this.availableFields.values()).map((e16) => {
      var _a;
      return (_a = u12.get(e16)) == null ? void 0 : _a.column;
    }).filter((e16) => null != e16));
...
var _5 = class __ {
  static async create(e15, t17, i21, a9, s17, r10) {
    ...
    const [o8] = n12, l11 = o8.fields().map((e16) => ({ name: e16.name, alias: e16.name, type: e16.type, column: o8.columnForFieldName(e16.name) })), { timeZoneByFieldName: d10 } = i21.metadata.fieldsIndex, h7 = Z.fromJSON({ fields: l11, timeZoneByFieldName: d10 }), p4 = new Uint32Array(Array.from(a9.values()).map((e16) => {
      var _a;
      return (_a = h7.get(e16)) == null ? void 0 : _a.column;
    }).filter((e16) => null != e16)), f7 = i21.geometryInfo.displayOptimization;
  ...
  async updateFields(e15) {
    ...
    if (this._availableFields = u2(s17, this._availableFields), s17.size) for (const i21 of this._files) {
      const e16 = Array.from(s17).map((e17) => {
        var _a;
        return (_a = this._fieldsIndex.get(e17)) == null ? void 0 : _a.column;
      });
...
var a8 = class {
  ...
  add(e15) {
    ...
    if (!this._trackIdToObservations.has(r10)) {
      const e16 = null != ((_a2 = this._purgeOptions) == null ? void 0 : _a2.maxObservations) ? this._purgeOptions.maxObservations : d9, i22 = r(e16, 0, d9);
      this._trackIdToObservations.set(r10, new t6(i22));
    }
    const o8 = this._trackIdToObservations.get(r10), a9 = o8 == null ? void 0 : o8.enqueue(i21);
  ...
  checkForUpdates() {
    ...
    return !(!n12.length && !(a9 == null ? void 0 : a9.length)) && (this.store.update(n12, a9), true);
  }
  _getToAdd() {
  ...
  _purgeByAge(t17) {
    var _a2;
    const e15 = (_a2 = this._timeInfo) == null ? void 0 : _a2.startTimeField;
...
__decorate([m2()], s16.prototype, "connection", void 0), __decorate([m2()], s16.prototype, "connectionStatus", null), __decorate([m2()], s16.prototype, "errorString", null), s16 = __decorate([a("esri.views.2d.layers.features.sources.StreamConnectionState")], s16);
...
var t15 = class {
  ...
  update(e15, t17) {
    this._onUpdate((e15 == null ? void 0 : e15.length) ?? 0);
  }
};
...
var m8 = class extends e14 {
  ...
  disconnect() {
    var _a;
    this._streamConnection = u(this._streamConnection), this._connectionState.connection = null, (_a = this._handlesGroup) == null ? void 0 : _a.remove();
  }
  connect() {
  ...
  updateCustomParameters(e15) {
    var _a;
    (_a = this._streamConnection) == null ? void 0 : _a.updateCustomParameters(e15);
  }
  sendMessageToSocket(e15) {
    var _a;
    (_a = this._streamConnection) == null ? void 0 : _a.sendMessageToSocket(e15);
  }
  sendMessageToClient(e15) {
    var _a;
    (_a = this._streamConnection) == null ? void 0 : _a.sendMessageToClient(e15);
  }
  _onOverride() {
  }
  _onWebSocketMessage(e15) {
...
var _6 = class {
  ...
  destroy() {
    var _a, _b, _c;
    (_a = this._strategy) == null ? void 0 : _a.destroy(), (_b = this._streamMessenger) == null ? void 0 : _b.destroy(), (_c = this._updateTracking) == null ? void 0 : _c.destroy(), this.store.destroy();
  }
  get metadata() {
  ...
  get queryEngine() {
    ...
    if (!this._queryEngine) {
      ...
      this._queryEngine = new W({ featureStore: this.store, fieldsIndex: this.metadata.fieldsIndex, geometryType: this.metadata.geometryType, featureIdInfo: this.metadata.featureIdInfo, hasM: false, hasZ: false, spatialReference: this.metadata.outSpatialReference, aggregateAdapter: this._aggregateAdapter, timeInfo: this.metadata.timeInfo, definitionExpression: (_a = this._strategy) == null ? void 0 : _a.definitionExpression, availableFields: (_b = this._strategy) == null ? void 0 : _b.availableFields });
    }
  ...
  onResume(e15) {
    var _a;
    this._updateTracking.addPromise(y((_a = this._strategy) == null ? void 0 : _a.load(e15)));
  }
  onUnsubscribe(e15) {
    var _a;
    this._connection.onEvent({ type: "unsubscribe", tile: e15.tile.id }), (_a = this._strategy) == null ? void 0 : _a.unload(e15);
  }
  async applyOverride(e15) {
    var _a;
    await ((_a = this._strategy) == null ? void 0 : _a.applyOverride(e15));
  }
  takeOverrideUpdate() {
    var _a;
    return (_a = this._strategy) == null ? void 0 : _a.takeOverrideUpdate();
  }
  ...
  async _updateStrategyType(e15, t17, r10) {
    ...
    this.store.clear(), (_a = this._strategy) == null ? void 0 : _a.destroy(), this._strategy = a9, has("esri-2d-update-debug") && console.debug(`Version[${r10}] FeatureSource.updateStrategy`, { strategy: a9 });
...
var y8 = class {
  ...
  async _doUpdateSchema(e15, t17) {
    ...
    const s17 = { tileInfo: (_a = this._tileInfoView) == null ? void 0 : _a.tileInfo }, i21 = await this._source.update(e15.source, t17), r10 = Array.from(this._subscriptions.values()), o8 = this._processor.update(e15, t17, s17, i21, r10);
...
//# sourceMappingURL=FeaturePipelineWorker-GXOGQPVV.js.map
