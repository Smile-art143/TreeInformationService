...
function f5(i3, r5, s7, n5, o2) {
  ...
  const p5 = c(s7, i3), f7 = p5 == null ? void 0 : p5.getExpressions().every((e5) => {
    var _a;
    const { aggregateType: r6, field: s8 } = e5, t6 = (_a = i3.get(s8)) == null ? void 0 : _a.name;
    return n5.some((e6) => {
      var _a2;
      const { onStatisticField: s9, statisticType: n6 } = e6, o3 = (_a2 = i3.get(s9)) == null ? void 0 : _a2.name;
...
function T2(e5, i3, s7, t6, n5) {
  const o2 = i3.get(n5);
  o2 ? s7.has(o2.name) ? "all" !== t6 && false === (t6 == null ? void 0 : t6.has(o2.type)) && e5.set(n5, { type: "invalid-type", fieldName: o2.name, fieldType: i2.fromJSON(o2.type), allowedFieldTypes: Array.from(t6, (e6) => i2.fromJSON(e6)) }) : e5.set(n5, { type: "missing-field", fieldName: o2.name }) : e5.set(n5, { type: "invalid-field", fieldName: n5 });
}
...
var c2 = class {
  ...
  getFieldValue(t6, i3, s7) {
    ...
    let l7 = null;
    return this._fieldDataCache.has(a4) ? l7 = (_a = this._fieldDataCache.get(a4)) == null ? void 0 : _a.clause : s7 || (l7 = c(i3, this.fieldsIndex), this._fieldDataCache.set(a4, { alias: a4, clause: l7 })), s7 ? this.featureAdapter.getAttribute(t6, a4) : l7 == null ? void 0 : l7.calculateValue(t6, this.featureAdapter);
  }
  ...
  async getExpressionValues(t6, e5, i3, a4, l7) {
    ...
    return t6.map((t7) => {
      const e6 = { attributes: this.featureAdapter.getAttributes(t7), layer: c4, geometry: n5 ? { ...a2(a4.geometryType, a4.hasZ, a4.hasM, this.featureAdapter.getGeometry(t7)), spatialReference: i3 == null ? void 0 : i3.spatialReference } : null }, d6 = r5.createExecContext(e6, o2, l7);
  ...
  _processAttributesForOutFields(t6) {
    ...
    if (!(e5 == null ? void 0 : e5.length)) return this.featureAdapter.getAttributes(t6);
    const i3 = {};
    for (const s7 of e5) {
...
var E2 = class {
  ...
  createQueryResponseForCount() {
    ...
    const { groupByFieldsForStatistics: t6, having: i3, outStatistics: s7 } = this.query, a4 = t6 == null ? void 0 : t6.length;
    if (!!!a4) return 1;
  ...
  _sortFeatures(e5, t6, i3) {
    if (e5.length > 1 && (t6 == null ? void 0 : t6.length)) for (const s7 of t6.slice().reverse()) {
      const t7 = s7.split(" "), a4 = t7[0], r5 = this.fieldsIndex.get(a4), n5 = !!t7[1] && "desc" === t7[1].toLowerCase(), o2 = g(r5 == null ? void 0 : r5.type, n5);
      e5.sort((e6, t8) => {
  ...
  _addFeatureJSONMetadata(e5, t6) {
    var _a, _b;
    const i3 = (_b = (_a = this.featureAdapter).getMetadata) == null ? void 0 : _b.call(_a, e5);
  ...
  async _createStatisticsQueryResponse(e5, t6, i3 = { attributes: {} }) {
    var _a;
    const s7 = [], a4 = /* @__PURE__ */ new Map(), r5 = /* @__PURE__ */ new Map(), n5 = /* @__PURE__ */ new Map(), o2 = /* @__PURE__ */ new Map(), u5 = new c2(e5, this.featureAdapter, this.fieldsIndex), c4 = e5.outStatistics, { groupByFieldsForStatistics: m8, having: d6, orderByFields: h4, resultRecordCount: f7 } = e5, p5 = m8 == null ? void 0 : m8.length, y5 = !!p5, g4 = y5 ? m8[0] : null, x2 = y5 && !this.fieldsIndex.get(g4);
    for (const l7 of c4 ?? []) {
      ...
      const S3 = "min" !== c5 && "max" !== c5 || !Fe(this.fieldsIndex.get(f8)) && !this._isAnyDateField(f8) ? null : (_a = this.fieldsIndex.get(f8)) == null ? void 0 : _a.type;
  ...
  _getStatisticValue(e5, t6, i3, s7) {
    ...
    let n5 = null;
    n5 = (i3 == null ? void 0 : i3.has(a4)) ? i3.get(a4) : Fe(this.fieldsIndex.get(a4)) || this._isAnyDateField(a4) ? f3({ values: t6, returnDistinct: s7 }) : p2({ values: s7 ? [...new Set(t6)] : t6, minValue: null, maxValue: null, useSampleStdDev: true }), i3 && i3.set(a4, n5);
  ...
  _getPercentileValue(e5, t6) {
    ...
    return v(t6, { value: r5, orderBy: n5, fieldType: o2 == null ? void 0 : o2.type, isDiscrete: "percentile_disc" === a4 });
  }
  ...
  async createQueryBinsResponse(e5) {
    var _a;
    const t6 = (_a = e5.bin) == null ? void 0 : _a.splitBy;
  ...
  async _createAutoIntervalBinsResponse(e5, t6, i3) {
    var _a;
    const { field: s7, normalizationField: a4, numBins: r5, normalizationType: n5, normalizationTotal: o2, start: l7, end: u5 } = e5, c4 = await this._getDataValues({ field: e5.field, normalizationField: e5.normalizationField, normalizationType: e5.normalizationType, normalizationTotal: e5.normalizationTotal, timeZone: (_a = t6.outTimeReference) == null ? void 0 : _a.ianaTimeZone }, i3), m8 = G(c4, { field: s7, normalizationField: a4, normalizationType: n5, normalizationTotal: o2, numBins: r5, minValue: h2(l7, false), maxValue: h2(u5, false) }), d6 = this._calculateHistogramBins(c4, m8, i3);
    return this._createFeaturesFromHistogramBins(d6, t6);
  }
  async _createDateBinsResponse(e5, t6, i3) {
    var _a, _b;
    const { field: s7, interval: a4, start: r5, end: n5, snapToData: o2, returnFullIntervalBin: l7 } = e5, u5 = a4.unit, c4 = await this._getDataValues({ field: e5.field, timeZone: (_a = t6.outTimeReference) == null ? void 0 : _a.ianaTimeZone }, i3), m8 = xe(this.fieldsIndex.get(s7)), d6 = s4.toJSON(u5), f7 = c4.filter(Boolean).sort((e6, t7) => e6 - t7), p5 = null != r5 ? h2(r5, m8) : f7[0], y5 = null != n5 ? h2(n5, m8) : f7[f7.length - 1], g4 = [];
    if (null != p5 && null != y5) {
      const e6 = { zone: ((_b = t6.outTimeReference) == null ? void 0 : _b.ianaTimeZone) ?? n }, i4 = DateTime.fromMillis(p5, e6), s8 = DateTime.fromMillis(y5, e6);
      if ("last" === o2) {
        let e7 = s8;
        for (; e7 > i4; ) {
  ...
  async _createFixedBoundariesBinsResponse(e5, t6, i3) {
    var _a;
    const { field: s7 } = e5, a4 = await this._getDataValues({ field: s7, timeZone: (_a = t6.outTimeReference) == null ? void 0 : _a.ianaTimeZone }, i3), r5 = xe(this.fieldsIndex.get(s7)), n5 = e5.boundaries.map((e6) => h2(e6, r5)).sort((e6, t7) => e6 - t7), o2 = [];
...
var e4 = class {
  ...
  put(t6, e5) {
    var _a;
    (_a = this._storage) == null ? void 0 : _a.set(t6, new r4(e5)), this._scheduleSweep();
  }
  get(t6) {
    var _a, _b, _c;
    const e5 = (_a = this._storage) == null ? void 0 : _a.get(t6);
    if (e5) return (_b = this._storage) == null ? void 0 : _b.delete(t6), e5.time = performance.now(), (_c = this._storage) == null ? void 0 : _c.set(t6, e5), e5.items;
  }
  clear() {
    var _a;
...
async function p4(t6, i3) {
  var _a;
  const s7 = t6.bin;
  if (!s7.onField && !((_a = s7.onExpression) == null ? void 0 : _a.value) || "autoIntervalBin" === s7.type && null == s7.parameters.numberOfBins || "dateBin" === s7.type && (null == s7.parameters.number || null == s7.parameters.unit) || "fixedBoundariesBin" === s7.type && null == s7.parameters.boundaries || "fixedIntervalBin" === s7.type && null == s7.parameters.interval) throw new s(u4, "Unsupported query options", { query: t6 });
  return d5(t6, i3);
}
...
function c3(s7, r5, o2) {
  ...
  if ("outFields" in o2) {
    if ((_a = o2.outFields) == null ? void 0 : _a.length) g3(s7, r5, o2.outFields, { expressionName: "outFields", query: o2, allowedFieldTypes: "all" });
...
function m7(i3, r5, o2) {
  const { outStatistics: n5, groupByFieldsForStatistics: a4, having: l7 } = o2, p5 = a4 == null ? void 0 : a4.length, d6 = n5 == null ? void 0 : n5.length;
  if (l7) {
...
var W = class {
  constructor(e5) {
    ...
    }).filter((e6) => null != e6)), e5.scheduler && e5.priority ? this._frameTask = e5.scheduler.registerTask(e5.priority) : this._frameTask = G3;
  }
  destroy() {
  ...
  async executeQueryForLatestObservations(e5, t6) {
    var _a;
    const i3 = l2(t6);
    if (!((_a = this.timeInfo) == null ? void 0 : _a.trackIdField)) throw new s(D, "Missing timeInfo or timeInfo.trackIdField", { query: e5, timeInfo: this.timeInfo });
  ...
  async fetchRecomputedExtents(e5) {
    const t6 = l2(e5);
    this._timeExtentPromise || (this._timeExtentPromise = n3(this.timeInfo, this.featureStore));
  ...
  _executeAggregateIdsQuery(e5) {
    var _a;
    if (0 === e5.items.length || !((_a = e5.query.aggregateIds) == null ? void 0 : _a.length) || null == this.aggregateAdapter) return;
  ...
  _executeObjectIdsQuery(e5) {
    var _a;
    if (0 === e5.items.length || !((_a = e5.query.objectIds) == null ? void 0 : _a.length)) return;
  ...
  async *_executeGeometryQueryForSnapping(e5) {
    ...
    if (!((_a = e5 == null ? void 0 : e5.items) == null ? void 0 : _a.length) || !t6.geometry || !i3) return;
...
//# sourceMappingURL=chunk-5HO2SWP4.js.map
