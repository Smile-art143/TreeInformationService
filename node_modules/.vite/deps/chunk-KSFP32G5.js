...
async function l2(e4) {
  try {
    ...
    const e5 = (n4 == null ? void 0 : n4.name) === r2;
    if (!(d(n4) || e5)) throw n4;
    return;
  }
}
...
var r3 = { statsWorker: () => import("./statsWorker-QTKOOFSZ.js"), geometryEngineWorker: () => import("./geometryEngineWorker-OWEOD37P.js"), arcadeGeometryOperatorsWorker: () => import("./operatorsWorker-HYX4SRX2.js"), CSVSourceWorker: () => import("./CSVSourceWorker-7JXT4OXD.js"), EdgeProcessingWorker: () => import("./EdgeProcessingWorker-F6BZ6TXK.js"), ElevationSamplerWorker: () => import("./ElevationSamplerWorker-622EAEML.js"), FeatureServiceSnappingSourceWorker: () => import("./FeatureServiceSnappingSourceWorker-YJ3YN2DH.js"), GaussianSplatSortWorker: () => import("./GaussianSplatSortWorker-TSAUXJZH.js"), GeoJSONSourceWorker: () => import("./GeoJSONSourceWorker-VUQHC2DY.js"), LercWorker: () => import("./LercWorker-XWRNPKAD.js"), MemorySourceWorker: () => import("./MemorySourceWorker-VWUV7V6G.js"), PBFDecoderWorker: () => import("./PBFDecoderWorker-JPQDZIO4.js"), FeaturePipelineWorker: () => import("./FeaturePipelineWorker-GXOGQPVV.js"), PointCloudWorker: () => import("./PointCloudWorker-VSCBMXMS.js"), RasterWorker: () => import("./RasterWorker-4SULI3DG.js"), SceneLayerSnappingSourceWorker: () => import("./SceneLayerSnappingSourceWorker-VVUI4XNJ.js"), SceneLayerWorker: () => import("./SceneLayerWorker-OJWQSLPI.js"), WFSSourceWorker: () => import("./WFSSourceWorker-LAV2IKWA.js"), WorkerTileHandler: () => import("./WorkerTileHandler-MC26SLET.js"), Lyr3DWorker: () => import("./Lyr3DWorker-HRKGH6PU.js"), Feature3DPipelineWorker: () => import("./Feature3DPipelineWorker-76VQ7HTY.js"), TextureCompressionWorker: () => import("./TextureCompressionWorker-BZCOB7AX.js"), FlowWorker: () => import("./FlowWorker-ETUBMGEU.js"), ParquetSourceWorker: () => import("./ParquetSourceWorker-VIGPPUQS.js"), PanoramicMeshWorker: () => import("./PanoramicMeshWorker-BFDL2WJZ.js") };
...
var _E = class _E {
  ...
  apply(e4, t3, o3) {
    const h = o3 == null ? void 0 : o3.signal, a4 = o3 == null ? void 0 : o3.transferList;
  ...
  _processWork() {
    ...
    const e4 = ((_a = this._jobQueue) == null ? void 0 : _a.pop()) ?? ((_b = this._lowPriorityJobQueue) == null ? void 0 : _b.pop());
    if (!e4) return;
  ...
  _onOnMessage(e4) {
    const { port: s5 } = e4, o3 = this._client.on(e4.eventType, (e5) => {
      ...
      const t3 = f(e5);
      (t3 == null ? void 0 : t3.type) === M && (i3.remove(), o3.remove(), s5.close());
    });
  }
...
var c3 = class {
  ...
  broadcast(e4, t3, s5) {
    ...
    for (let o3 = 0; o3 < this._clientPromises.length; ++o3) {
      ...
      i3[o3] = n4.then((i4) => i4 == null ? void 0 : i4.invoke(e4, t3, s5));
    }
    return i3;
  }
  close() {
    ...
    for (const t3 of this._clientPromises) t3.then((e5) => e5 == null ? void 0 : e5.close());
  ...
  apply(e4, t3, s5) {
    const o3 = $();
    ("low" === (s5 == null ? void 0 : s5.priority) ? this._ongoingLowPriorityJobsQueue : this._ongoingJobsQueue).push({ methodName: e4, data: t3, invokeOptions: s5, resolver: o3 });
    for (let i3 = 0; i3 < this._clientPromises.length; i3++) {
      const e5 = this._clients[i3];
      e5 ? e5.jobAdded() : this._clientPromises[i3].then((e6) => e6 == null ? void 0 : e6.jobAdded());
    }
    return o3.promise;
  }
  createInvokeProxy(e4) {
...
//# sourceMappingURL=chunk-KSFP32G5.js.map
