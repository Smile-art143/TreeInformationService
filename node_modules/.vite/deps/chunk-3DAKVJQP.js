...
import {
  ...
  m as m5,
  o as o3
} from "./chunk-KRUCYBVH.js";
import {
  d as d2
} from "./chunk-FVFINDGS.js";
import {
  U,
  d,
  j,
...
import {
  c as c7
} from "./chunk-ZAMCE64L.js";
import {
  a as a7,
  c as c6,
  n as n4
} from "./chunk-EHHT33UD.js";
import {
  b as b2
...
function u5(e6, t4, r4) {
  var _a;
  if (!((_a = e6.vertexAttributes) == null ? void 0 : _a.position)) return;
  const { vertexSpace: i6 } = e6, o4 = (r4 == null ? void 0 : r4.origin) ?? e6.origin, n6 = t3(g2, i6, o4.spatialReference, r4 == null ? void 0 : r4.geographic);
...
async function m6(e6, o4, n6) {
  const { source: i6 } = o4, { loadGLTFMesh: a9 } = await p(import("./loadGLTFMesh-4QFQMC4S.js"), n6), l5 = await p4(i6, n6);
  s2(n6);
  const u9 = a9(new _({ x: 0, y: 0, z: 0, spatialReference: e6.spatialReference }), l5.url, { resolveFile: f6(l5), signal: n6 == null ? void 0 : n6.signal, expectedType: l5.type, unitConversionDisabled: o4.unitConversionDisabled });
...
async function y(e6, s4) {
  ...
  if (a(s4)) throw a9.forEach((e7) => e7.source.dispose()), u();
  return j3(a9);
}
...
function j3(e6) {
  ...
  for (const t4 of e6) {
    ...
    r4 ?? (r4 = T(t4)), "ESRI3DO_NORM.glb" === n7 && (o4 = T(t4)), s4.set(n7, e7.url), e7.files.forEach((e8, t5) => s4.set(t5, e8));
  }
  const n6 = o4 ?? r4;
...
__decorate([m2()], a8.prototype, "externalSources", void 0), __decorate([m2()], a8.prototype, "displaySource", null), __decorate([m2()], a8.prototype, "_implicitDisplaySource", null), __decorate([m2()], a8.prototype, "_explicitDisplaySource", void 0), __decorate([m2()], a8.prototype, "georeferenced", void 0), a8 = __decorate([a2("esri.geometry.support.meshUtils.Metadata")], a8);
...
function x5(t4, e6, r4) {
  t4.isPlane || y2(t4), M3(t4, d4(r4 == null ? void 0 : r4.size, r4 == null ? void 0 : r4.unit, e6.spatialReference));
  ...
  return { vertexAttributes: new c7({ ...c10, uv: t4.uv }), vertexSpace: n6, components: [new h({ faces: t4.faces, material: (r4 == null ? void 0 : r4.material) || null })], spatialReference: e6.spatialReference };
}
function y2(t4) {
...
function B(t4, e6, r4) {
  var _a;
  if (!((_a = t4.vertexAttributes) == null ? void 0 : _a.position) || 0 === e6[3]) return;
  const { spatialReference: o4, vertexSpace: i6 } = t4, n6 = (r4 == null ? void 0 : r4.origin) ?? t4.origin, s4 = r4 == null ? void 0 : r4.geographic, a9 = t3(O4, i6, o4, s4);
  c5(t4) ? G2(t4, e6, n6) : a9 ? H(t4, e6, n6) : I2(t4, e6, n6);
}
function G2(t4, e6, r4) {
  t4.transform ?? (t4.transform = new d2());
...
function q2(e6, t4, r4) {
  var _a;
  if (!((_a = e6.vertexAttributes) == null ? void 0 : _a.position)) return;
  const { vertexSpace: o4, spatialReference: i6 } = e6, n6 = (r4 == null ? void 0 : r4.origin) ?? e6.origin, s4 = r4 == null ? void 0 : r4.geographic, a9 = t3(k2, o4, i6, s4);
  c5(e6) ? z4(e6, t4, n6) : a9 ? L(e6, t4, n6) : M4(e6, t4, n6);
}
function z4(e6, s4, f8) {
  e6.transform ?? (e6.transform = new d2());
...
var Y2 = Q3 = class extends l2(p2(m3(c))) {
  ...
  initialize() {
    (0 === this.metadata.externalSources.length || this.vertexAttributes.position.length) && (this.loadStatus = "loaded"), this.when(() => {
      this.addHandles(l(() => {
        var _a;
        return { vertexAttributes: this.vertexAttributes, components: (_a = this.components) == null ? void 0 : _a.map((e6) => e6.clone()) };
  ...
  get _untransformedBounds() {
    ...
    return 0 === e6.length || 0 === (t4 == null ? void 0 : t4.length) ? u2(Q) : m4(e6);
  }
  get origin() {
  ...
  offset(e6, t4, r4) {
    ...
    const { vertexSpace: o4, vertexAttributes: s4 } = this, n6 = s4 == null ? void 0 : s4.position;
    if (!n6) return this;
    if (t(o4)) {
  ...
  async toBinaryGLTF(e6) {
    const [{ toBinaryGLTF: t4 }] = await Promise.all([import("./gltfexport-FTOB4CY4.js"), this.load(e6)]);
  ...
  static createBox(e6, t4) {
    ...
    return (t4 == null ? void 0 : t4.imageFace) && "all" !== t4.imageFace ? f7(r4, t4.imageFace) : r4;
  }
  static createSphere(e6, t4) {
    return e6 instanceof _ ? new Q3(x5(u8((t4 == null ? void 0 : t4.densificationFactor) || 0), e6, t4)) : (i.getLogger(this.prototype).error(".createSphere()", s3), null);
  }
  static createCylinder(e6, t4) {
    return e6 instanceof _ ? new Q3(x5(h4((t4 == null ? void 0 : t4.densificationFactor) || 0), e6, t4)) : (i.getLogger(this.prototype).error(".createCylinder()", s3), null);
  }
  static createPlane(e6, t4) {
    if (!(e6 instanceof _)) return i.getLogger(this.prototype).error(".createPlane()", s3), null;
    const r4 = (t4 == null ? void 0 : t4.facing) ?? "up", o4 = p5(r4, t4 == null ? void 0 : t4.size);
  ...
  static createFromPolygon(e6, t4) {
    ...
    const r4 = c8(e6);
    return new Q3({ vertexAttributes: new c7({ position: r4.position }), components: [new h({ faces: r4.faces, shading: "flat", material: (t4 == null ? void 0 : t4.material) ?? null })], spatialReference: e6.spatialReference, vertexSpace: new i2() });
  }
  static async createFromGLTF(e6, t4, r4) {
    ...
    const { loadGLTFMesh: o4 } = await p(import("./loadGLTFMesh-4QFQMC4S.js"), r4);
    return new Q3((await o4(e6, t4, r4)).mesh);
  }
  static createWithExternalSource(e6, t4, r4) {
    var _a;
    const o4 = (r4 == null ? void 0 : r4.extent) ?? null, { spatialReference: s4 } = e6, n6 = ((_a = r4 == null ? void 0 : r4.transform) == null ? void 0 : _a.clone()) ?? new d2(), i6 = l3(e6, r4), a9 = r4 == null ? void 0 : r4.unitConversionDisabled, p6 = { source: t4, extent: o4, unitConversionDisabled: a9 }, c10 = new a8();
  ...
  static createIncomplete(e6, t4) {
    var _a;
    const { spatialReference: o4 } = e6, s4 = ((_a = t4 == null ? void 0 : t4.transform) == null ? void 0 : _a.clone()) ?? new d2(), n6 = l3(e6, t4), i6 = new Q3({ transform: s4, vertexSpace: n6, spatialReference: o4 });
    return i6.addResolvingPromise(Promise.reject(new s("mesh-incomplete", "Mesh resources are not complete"))), i6;
  }
};
__decorate([m2({ type: [h], json: { write: true } })], Y2.prototype, "components", void 0), __decorate([m2({ nonNullable: true, types: X2, constructOnly: true, json: { write: true }, clonable: (e6, t4) => {
  var _a;
  return ((_a = n4(t4)) == null ? void 0 : _a.vertexSpace) ?? e6.clone(t4);
} })], Y2.prototype, "vertexSpace", void 0), __decorate([m2({ type: d2, clonable: (e6, t4) => {
  const r4 = n4(t4);
  return r4 && "transform" in r4 ? r4.transform : (e6 == null ? void 0 : e6.clone()) ?? e6;
}, json: { write: true } })], Y2.prototype, "transform", void 0), __decorate([m2({ constructOnly: true, type: a8, clonable: (e6, t4) => {
  var _a;
  return ((_a = n4(t4)) == null ? void 0 : _a.metadata) ?? e6.clone();
} })], Y2.prototype, "metadata", void 0), __decorate([m2()], Y2.prototype, "hasExtent", null), __decorate([m2()], Y2.prototype, "_transformedExtent", null), __decorate([m2()], Y2.prototype, "_untransformedBounds", null), __decorate([m2()], Y2.prototype, "origin", null), __decorate([m2({ readOnly: true, json: { read: false } })], Y2.prototype, "extent", null), __decorate([m2({ readOnly: true, json: { read: false, write: true, default: true } })], Y2.prototype, "hasZ", void 0), __decorate([m2({ readOnly: true, json: { read: false, write: true, default: false } })], Y2.prototype, "hasM", void 0), __decorate([m2({ type: c7, nonNullable: true, json: { write: true }, clonable: (e6, t4) => {
  var _a;
  return ((_a = n4(t4)) == null ? void 0 : _a.vertexAttributes) ?? e6.clone(t4);
} })], Y2.prototype, "vertexAttributes", void 0), Y2 = Q3 = __decorate([a2("esri.geometry.Mesh")], Y2);
var $ = j();

export {
  Y2 as Y
};
//# sourceMappingURL=chunk-3DAKVJQP.js.map
