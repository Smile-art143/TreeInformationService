...
function y(t3, e) {
  ...
  if (null != r && (s.geometry = JSON.stringify(r), s.geometryType = v(r), s.inSR = A(r.spatialReference)), ((_a = o.topFilter) == null ? void 0 : _a.groupByFields) && (s.topFilter.groupByFields = o.topFilter.groupByFields.join(",")), ((_b = o.topFilter) == null ? void 0 : _b.orderByFields) && (s.topFilter.orderByFields = o.topFilter.orderByFields.join(",")), o.topFilter && (s.topFilter = JSON.stringify(s.topFilter)), o.objectIds && (s.objectIds = o.objectIds.join(",")), o.orderByFields && (s.orderByFields = o.orderByFields.join(",")), o.outFields && !((e == null ? void 0 : e.returnCountOnly) || (e == null ? void 0 : e.returnExtentOnly) || (e == null ? void 0 : e.returnIdsOnly)) ? o.outFields.includes("*") ? s.outFields = "*" : s.outFields = o.outFields.join(",") : delete s.outFields, o.outSR ? s.outSR = A(o.outSR) : r && o.returnGeometry && (s.outSR = s.inSR), o.returnGeometry && delete o.returnGeometry, o.timeExtent) {
...
function a(n, i, l, u2 = {}, p2 = {}) {
  ...
  return u2.responseType = "json", P(d2, null, u2).then((e) => {
    const n2 = e == null ? void 0 : e[0];
    null != n2 && ((i = i.clone()).geometry = n2);
    const o = t({ ...m2.query, f: l, ...p2, ...y(i, p2) });
    return H(V(m2.path, "queryTopFeatures"), { ...u2, query: { ...o, ...u2.query } });
  });
}
...
//# sourceMappingURL=chunk-UDPRAI3U.js.map
