...
async function b(e3, o) {
  ...
  !c2 && (o == null ? void 0 : o.defaultLayerType) && (c2 = o.defaultLayerType);
  const p2 = s2[c2];
  ...
  } else "ArcGISFeatureLayer" === c2 ? e2(e3) || r(e3) ? S3 = a.MapNotesLayer : n(e3) ? S3 = a.RouteLayer : A(e3) && (S3 = a.GroupLayer) : ((_a = e3.wmtsInfo) == null ? void 0 : _a.url) && e3.wmtsInfo.layerIdentifier ? S3 = a.WMTSLayer : "WFS" === c2 && "2.0.0" !== ((_b = e3.wfsInfo) == null ? void 0 : _b.version) && (S3 = a.UnsupportedLayer);
  return S3();
}
function A(e3) {
  var _a, _b;
...
//# sourceMappingURL=chunk-E4OR72VV.js.map
