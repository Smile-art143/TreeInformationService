...
function f(e2, n2 = e) {
  return e2 ? u(e2) ? e2.timeZoneIANA : l(e2, n2) : n2;
}
function c(t2) {
...
function l(e2, n2 = e) {
  ...
  return m(e2.timeZone) || e2.respectsDaylightSaving ? r : Z(r);
}
function Z(t2) {
...
function h(t2, o2, r, i, u2) {
  if (o2 && "date" === u2) return { timeZone: n, timeZoneName: void 0 };
  const m2 = i.hour, a3 = r === t;
  return { timeZone: a3 ? "timestamp-offset" === u2 ? void 0 : t2 ?? n : r, timeZoneName: a3 && m2 ? s : void 0 };
}
function p(n2) {
  const o2 = /* @__PURE__ */ new Set(["etc/utc", "etc/gmt", "gmt"]), r = new Set(Intl.supportedValuesOf("timeZone").map((t2) => t2.toLowerCase()));
  return n2 === e || n2 === t || o2.has(n2.toLowerCase()) || r.has(n2.toLowerCase());
}
...
//# sourceMappingURL=chunk-TOKRNZN3.js.map
