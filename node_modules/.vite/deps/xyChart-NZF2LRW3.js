    ...
    if (cursor) {
      ...
      if (snapToSeries && cursorPoint) {
        ...
        if (closestItem) {
          ...
          if (point3) {
            cursor.handleMove(series.toGlobal({ x: point3.x - series.x(), y: point3.y - series.y() }), true);
          }
        }
      }
    }
...
var XYCursor = class extends Container {
  ...
  _getPosition(point3) {
    return { x: point3.x / this.width(), y: point3.y / this.height() };
  }
  /**
  ...
  handleMove(point3, skipEvent, originalEvent) {
    ...
    if (chart && (this._inPlot(local) || this._downPoint)) {
      ...
      if (!skipEvent) {
        ...
        if (this.events.isEnabled(type)) {
          this.events.dispatch(type, { type, target: this, point: point3, originalEvent });
        }
      }
        ...
        if (dataItem) {
          ...
          if (show) {
            ...
            if (chart && chart.inPlot(point3)) {
              ...
              tooltip.set("pointTo", this._display.toGlobal({ x: point3.x, y: point3.y }));
            } else {
              tooltip._setDataItem(void 0);
            }
          } else {
    ...
    each(this.series, (series) => {
      ...
      if (xAxis instanceof _CategoryAxis && yAxis instanceof _CategoryAxis) {
        ...
        if (otherAxis instanceof ValueAxis) {
          if (key || openKey) {
            let findDataItem = function(series2, categoryAxis, key2, openKey2, category, direction) {
              let dataItem;
              ...
              while (!dataItem && idx >= 0 && idx < categoryAxis.dataItems.length) {
                ...
                if (direction == "previous") {
                  for (let i = series2.dataItems.length - 1; i >= 0; i--) {
                    let item = series2.dataItems[i];
...
// node_modules/@amcharts/amcharts5/.internal/charts/xy/axes/EditableAxisLabel.js
var EditableAxisLabel = class extends EditableLabel {
  constructor() {
    super(...arguments);
    Object.defineProperty(this, "_tickPoints", {
      enumerable: true,
...
var ColumnSeries = class extends BaseColumnSeries {
  ...
  _afterColumnsDraw() {
    if (this.get("turboMode")) {
      this.allColumns.set("draw", (display) => {
        display.clear();
        each(this.allColumnsData, (column) => {
  ...
  _updateSeriesGraphics(dataItem, graphics, l, r, t, b, fitW, fitH) {
    if (this.get("turboMode")) {
      ...
      dataItem.setRaw("top", t);
      dataItem.setRaw("bottom", b);
      this.allColumnsData.push({ width: r - l, height: b - t, x: l, y: t, stroke, fill, strokeWidth: strokWidth, strokeOpacity, fillOpacity });
    } else {
...
export {
  AxisRendererX as AxisRendererXAm5,
  AxisRendererY as AxisRendererYAm5,
  CategoryAxis as CategoryAxisAm5,
  ColumnSeries as ColumnSeriesAm5,
  LineSeries as LineSeriesAm5,
  ValueAxis as ValueAxisAm5,
  XYChart as XYChartAm5,
  XYCursor as XYCursorAm5
};
//# sourceMappingURL=xyChart-NZF2LRW3.js.map
