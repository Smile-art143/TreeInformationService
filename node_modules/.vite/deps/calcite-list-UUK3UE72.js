...
} from "./chunk-2CR7PJTV.js";
import "./chunk-HDYFHPTE.js";
import {
  after,
  argumentsTag,
  arrayBufferTag,
  ...
  without,
  zip
} from "./chunk-MZVA7T6W.js";
import "./chunk-IS2AYTII.js";
import {
  numberStringFormatter
} from "./chunk-4EGRXDGE.js";
import "./chunk-MPGW2LBV.js";
import "./chunk-XRUWNQ24.js";
import {
  keyed
} from "./chunk-UYEKLSNV.js";
import "./chunk-ST4334QB.js";
import {
  InteractiveContainer,
  updateHostInteraction
} from "./chunk-ZTTRTO5Y.js";
import {
  useSetFocus
} from "./chunk-PLYSZ7HQ.js";
import {
  useT9n
} from "./chunk-G66PUWVM.js";
import "./chunk-RHPJCKMG.js";
import "./chunk-E7RTJPC6.js";
import "./chunk-3NAR5JYZ.js";
import "./chunk-QKA35R5F.js";
import {
  createObserver
} from "./chunk-W5GI6QI2.js";
import "./chunk-77EVPQAL.js";
import {
  getRootNode,
  slotChangeHasAssignedElement
} from "./chunk-XMMWTXI7.js";
import {
  guid
} from "./chunk-YUI5J4UF.js";
...
function getWithPath(object, path, defaultValue) {
  ...
  for (let index2 = 0; index2 < path.length; index2++) {
    ...
    if (isUnsafeProperty(path[index2])) return defaultValue;
...
function isArrayMatch(target, source, compare, stack) {
  ...
  for (let i = 0; i < source.length; i++) {
    ...
    for (let j = 0; j < target.length; j++) {
      ...
      let matches3 = false;
      if (compare(targetItem, sourceItem, i, target, source, stack)) matches3 = true;
      if (matches3) {
        countedIndex.add(j);
        found = true;
        break;
...
function isIterateeCall(value, index2, object) {
  ...
  if (typeof index2 === "number" && isArrayLike(object) && isIndex(index2) && index2 < object.length || typeof index2 === "string" && index2 in object) return eq(object[index2], value);
  return false;
}
  ...
  switch (typeof doesMatch) {
    ...
    case "object":
      if (Array.isArray(doesMatch) && doesMatch.length === 2) {
        ...
        index2 = subArray.findIndex(matchesProperty(key, value));
      } else index2 = subArray.findIndex(matches(doesMatch));
      break;
    case "number":
    case "symbol":
    case "string":
...
function flatMap(collection, iteratee2 = identity) {
...
function includes(source, target, fromIndex, guard) {
  ...
  for (let i = fromIndex; i < keys2.length; i++) if (eq(Reflect.get(source, keys2[i]), target)) return true;
  return false;
}
...
function intersectionBy2(array, ...values2) {
  ...
  const iteratee2 = getIteratee(lastValue);
  if (count <= 0) return uniqBy(toArray(array), iteratee2 ?? identity);
  let result2 = uniq(toArray(array));
  for (let i = 0; i < count; ++i) {
    const value = values2[i];
    if (!isArrayLikeObject(value)) return [];
    if (iteratee2) result2 = intersectionBy(result2, toArray(value), iteratee2);
  }
  return result2;
}
...
function lastIndexOf(array, searchElement, fromIndex) {
  ...
  let index2 = fromIndex === void 0 ? length - 1 : toInteger(fromIndex);
  if (fromIndex !== void 0) index2 = index2 < 0 ? Math.max(length + index2, 0) : Math.min(index2, length - 1);
  if (Number.isNaN(searchElement)) {
    for (let i = index2; i >= 0; i--) if (Number.isNaN(array[i])) return i;
  }
...
function isKey(value, object) {
  ...
  if (typeof value === "number" || typeof value === "boolean" || value == null || isSymbol2(value)) return true;
...
function pullAt(array, ..._indices) {
  ...
  const indicesToPull = indices.map((index2) => isIndex(index2, array.length) ? Number(index2) : index2).sort((a, b) => b - a);
  for (const index2 of new Set(indicesToPull)) {
    ...
    unset(array, isArray(index2) ? index2 : toPath(index2));
  }
  return result2;
}
...
function sortedIndexBy(array, value, iteratee$1 = identity2, retHighest) {
  ...
  const valIsSymbol = isSymbol2(transformedValue);
  ...
  while (low < high) {
    ...
    const othIsSymbol = isSymbol2(computed);
...
function sortedIndexOf(array, value) {
  ...
  if (index2 < array.length && eq(array[index2], value)) return index2;
  return -1;
}
...
function sortedLastIndex(array, value) {
  if (isNil(array)) return 0;
  let high = array.length;
  if (!isNumber(value) || Number.isNaN(value) || high > HALF_MAX_ARRAY_LENGTH2) return sortedLastIndexBy(array, value, (value2) => value2);
  let low = 0;
  while (low < high) {
    const mid = low + high >>> 1;
    const compute = array[mid];
...
function sortedLastIndexOf(array, value) {
  ...
  if (index2 >= 0 && eq(array[index2], value)) return index2;
  return -1;
}
...
function takeRightWhile(_array, predicate) {
  ...
  const index2 = array.findLastIndex(negate(iteratee(predicate ?? identity)));
...
function takeWhile(array, predicate) {
  ...
  const index2 = _array.findIndex(negate2(iteratee(predicate ?? identity2)));
...
function clone2(obj) {
  ...
  if (tag === "[object Boolean]" || tag === "[object Number]" || tag === "[object String]") {
    ...
    if (tag === "[object String]") cloneStringObjectProperties(clone4, obj);
    else copyOwnProperties(clone4, obj);
    return clone4;
  }
...
function cloneWith(value, customizer) {
  if (!customizer) return clone2(value);
...
function omitBy(object, shouldOmit) {
  ...
  for (let i = 0; i < keys2.length; i++) {
    const key = isSymbol2(keys2[i]) ? keys2[i] : keys2[i].toString();
    const value = object[key];
...
function result(object, path, defaultValue) {
  ...
  for (let index2 = 0; index2 < pathLength; index2++) {
    const value = object == null ? void 0 : object[toKey(path[index2])];
...
function isEqualWith2(a, b, areValuesEqual) {
  ...
  return isEqualWith(a, b, (...args) => {
    ...
    if (a instanceof Map && b instanceof Map) return isEqualWith2(Array.from(a), Array.from(b), after(2, areValuesEqual));
    if (a instanceof Set && b instanceof Set) return isEqualWith2(Array.from(a), Array.from(b), after(2, areValuesEqual));
  });
}
...
function template(string, options, guard) {
  ...
  for (const match of string.matchAll(delimitersRegExp)) {
    ...
    source += ` + '${string.slice(lastIndex, index2).replace(unEscapedRegExp, escapeString)}'`;
...
function invokeImpl(object, path, args) {
  ...
  return (_a = get(parent, lastKey)) == null ? void 0 : _a.apply(parent, args);
}
...
var filter2 = (data, value, filterProps) => {
  ...
  return data.filter((item) => find3(item, regex, filterProps));
};
...
var _Filter = class _Filter extends LitElement {
  constructor() {
    ...
    this.filterDebounced = debounce((value, emit = false, onFilter) => this.updateFiltered(filter2(this.items ?? [], value, this.filterProps), emit, onFilter), DEBOUNCE.filter);
  ...
  async filter(value = this.value) {
    return new Promise((resolve) => {
      this.value = value;
      this.updateFiltered(filter2(this.items ?? [], value, this.filterProps), false, resolve);
    });
  }
  ...
  async load() {
    this.updateFiltered(filter2(this.items ?? [], this.value, this.filterProps));
  }
  willUpdate(changes) {
    var _a;
...
function matrix(el, selfOnly) {
  ...
  if (typeof el === "string") {
    ...
    do {
      var transform2 = css2(el, "transform");
...
function lastChild(el, selector) {
  var last3 = el.lastElementChild;
  while (last3 && (last3 === Sortable.ghost || css2(last3, "display") === "none" || selector && !matches2(last3, selector))) {
    last3 = last3.previousElementSibling;
  }
  return last3 || null;
}
...
var _prepareGroup = function _prepareGroup2(options) {
  function toFn(value, pull3) {
    return function(to, from, dragEl2, evt) {
      var sameGroup = to.options.group.name && from.options.group.name && to.options.group.name === from.options.group.name;
      if (value == null && (pull3 || sameGroup)) {
        return true;
      } else if (value == null || value === false) {
        return false;
      } else if (pull3 && value === "clone") {
        return value;
      } else if (typeof value === "function") {
        return toFn(value(to, from, dragEl2, evt), pull3)(to, from, dragEl2, evt);
      } else {
        var otherGroup = (pull3 ? to : from).options.group.name;
  ...
  _onDragOver: function _onDragOver(evt) {
    ...
    function dragOverEvent(name, extra) {
      pluginEvent2(name, _this, _objectSpread2({
        ...
        target,
        completed,
        onMove: function onMove(target2, after4) {
          return _onMove(rootEl, el, dragEl, dragRect, target2, getRect(target2), evt, after4);
        },
        changed
      }, extra));
    }
    ...
    if (activeSortable && !options.disabled && (isOwner ? canSort || (revert = parentEl !== rootEl) : putSortable === this || (this.lastPutMode = activeGroup.checkPull(this, activeSortable, dragEl, evt)) && group.checkPut(this, activeSortable, dragEl, evt))) {
      ...
      if (!elLastChild || _ghostIsLast(evt, vertical, this) && !elLastChild.animated) {
        ...
        var nextSibling = target.nextElementSibling, after3 = false;
        after3 = direction === 1;
        var moveVector = _onMove(rootEl, el, dragEl, dragRect, target, targetRect, evt, after3);
        if (moveVector !== false) {
          ...
          capture();
          if (after3 && !nextSibling) {
            el.appendChild(dragEl);
          } else {
            target.parentNode.insertBefore(dragEl, after3 ? nextSibling : target);
          }
          if (scrolledPastTop) {
...
function _getSwapDirection(evt, target, targetRect, vertical, swapThreshold, invertedSwapThreshold, invertSwap, isLastTarget) {
  var mouseOnAxis = vertical ? evt.clientY : evt.clientX, targetLength = vertical ? targetRect.height : targetRect.width, targetS1 = vertical ? targetRect.top : targetRect.left, targetS2 = vertical ? targetRect.bottom : targetRect.right, invert3 = false;
  if (!invertSwap) {
...
function connectSortableComponent(component) {
  ...
  component.sortable = sortable_esm_default.create(component.el, {
    dataIdAttr,
    swapThreshold: 0.5,
    ...CSS3,
    ...!!draggable && { draggable },
...
function disconnectSortableComponent(component) {
  ...
  (_a = component.sortable) == null ? void 0 : _a.destroy();
...
var _List = class _List extends LitElement {
  ...
  setParentList() {
    var _a;
    this.parentListEl = (_a = this.el.parentElement) == null ? void 0 : _a.closest(listSelector);
  }
  ...
  allParentListItemsExpanded(item) {
    var _a;
    const parentItem = (_a = item.parentElement) == null ? void 0 : _a.closest(listItemSelector);
    if (!parentItem) {
      return true;
  ...
  updateFilteredItems() {
    ...
    const lastDescendantItems = visibleItems == null ? void 0 : visibleItems.filter((listItem) => visibleItems.every((li) => li === listItem || !listItem.contains(li)));
  ...
  async filterAndUpdateData() {
    var _a;
    await ((_a = this.filterEl) == null ? void 0 : _a.filter(this.filterText));
  ...
  isNavigable(listItem) {
    var _a;
    const parentListItemEl = (_a = listItem.parentElement) == null ? void 0 : _a.closest(listItemSelector);
    if (!parentListItemEl) {
      return true;
    }
  ...
  handleAdd(event) {
    ...
    const fromEl = dragEl2 == null ? void 0 : dragEl2.parentElement;
  ...
  handleReorder(event) {
    ...
    const dragEl2 = event.target;
    const parentEl2 = dragEl2 == null ? void 0 : dragEl2.parentElement;
    if (!parentEl2) {
      return;
    }
    dragEl2.sortHandleOpen = false;
...
sortablejs/modular/sortable.esm.js:
   ...
   *)
*/
//# sourceMappingURL=calcite-list-UUK3UE72.js.map
