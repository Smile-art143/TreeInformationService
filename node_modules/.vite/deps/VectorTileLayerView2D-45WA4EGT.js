...
import {
  t as t3,
  t2 as t4
} from "./chunk-7SZ6J4MO.js";
import "./chunk-U3B7YMY7.js";
import {
  D,
  l
} from "./chunk-RBW4I7MO.js";
import {
  c,
  o as o2,
  t as t2
  ...
  getGlyphItems(s6, i6) {
    ...
    return n8.forEach((t7) => {
      ...
      for (const o4 of i6) {
        ...
        if (!(a7 == null ? void 0 : a7.metrics)) continue;
        const l2 = a7.metrics;
        let c4;
      ...
      case 1: {
        ...
        for (; a7.next(); ) switch (a7.tag()) {
          case 3: {
            ...
            if (t8.release(), r5) {
              const t9 = (n8 == null ? void 0 : n8.length) ?? 0;
...
var r3 = class _r {
  ...
  getSpriteItem(t7, i6 = false) {
    ...
    if (t7 && t7.startsWith(a4) ? ([s6, e8] = this._rasterizeDash(t7), i6 = true) : s6 = this._sprites.getSpriteInfo(t7), !(s6 == null ? void 0 : s6.width) || !s6.height || s6.width < 0 || s6.height < 0) return null;
  ...
  getMosaicItemPosition(t7, i6) {
    const s6 = this.getSpriteItem(t7, i6), e8 = s6 == null ? void 0 : s6.rect;
    if (!e8) return null;
...
var h4 = class {
  ...
  _requestSprite(t7) {
    ...
    const r4 = t7 == null ? void 0 : t7.signal;
    this._inputSignalEventListener && ((_b = this._startOptionsInputSignal) == null ? void 0 : _b.removeEventListener("abort", this._inputSignalEventListener)), this._startOptionsInputSignal = null, r4 && (this._inputSignalEventListener = p4(e8), r4.addEventListener("abort", this._inputSignalEventListener, { once: true }));
...
var c2 = class {
  ...
  _addPlaceholderParent(e8, i6) {
    ...
    for (; ; ) {
      ...
      const e9 = t7.get(s6);
      if (e9 == null ? void 0 : e9.hasData()) return this._addToContainer(e9), void i6.add(e9.id);
    }
  }
...
var u3 = class extends n4 {
  ...
  destroy() {
    var _a, _b;
    super.destroy(), this.removeAllChildren(), (_a = this._spriteMosaic) == null ? void 0 : _a.dispose(), this._spriteMosaic = null, (_b = this._glyphMosaic) == null ? void 0 : _b.dispose(), this._glyphMosaic = null, null != this._symbolFader && (this._symbolFader.clear(), this._symbolFader = null), this._styleRepository = null, this._backgroundTiles = [];
  }
  get fading() {
    var _a;
  ...
  setSpriteMosaic(e8) {
    var _a;
    (_a = this._spriteMosaic) == null ? void 0 : _a.dispose(), this._spriteMosaic = e8;
  }
...
var m3 = class _m {
  ...
  async queryAttributes(e8, t7, s6, i6, o3) {
    ...
    const l2 = [];
    return this._queryIndex(l2, e8, t7, s6, this.tileKey.level, i6), o3 && (o3 == null ? void 0 : o3.length) > 0 && await this._getSymbolsAttributes(l2, o3), l2;
  }
  async _indexLayers() {
  ...
  _queryIndex(t7, s6, r4, o3, l2, a6) {
    ...
    return (_a = this._index) == null ? void 0 : _a.search({ minX: s6 - y3, minY: r4 - y3, maxX: s6 + y3, maxY: r4 + y3 }, (n8) => {
  ...
  async _getTilePayload(e8) {
    return e2(this._tileKeyToPBF, e8.id, () => this._tileHandler.fetchTilePBFs(e8)).then((e9) => e9);
  }
};
...
var P = class extends i3(b(d4)) {
  ...
  async hitTest(e8, t7) {
    var _a, _b;
    const i6 = this._tileHandlerPromise, s6 = (_a = this._vectorTileContainer) == null ? void 0 : _a.symbolFader;
    ...
    if ((!n8 || 0 === n8.length) && 0 === (r4 == null ? void 0 : r4.length)) return null;
    e8 = e8.clone().normalize();
    const o3 = [], h8 = [];
    for (const u4 of n8) o3.push(this._queryTile(h8, e8, I, this.view.state.rotation, u4, r4 == null ? void 0 : r4.filter((e9) => e9.tileKey.id === u4.id)));
  ...
  attach() {
    ...
    this._styleRepository = new l(e8), this._tileInfoView = new t6(this.layer.tileInfo, this.layer.fullExtent), this._vectorTileContainer = new u3(this._tileInfoView), this._tileHandler = new h4(this.layer, this._styleRepository, window.devicePixelRatio || 1, this.layer.tileInfo.lods.length - 1), this.container.addChild(this._vectorTileContainer), this._start(), this.addAttachHandles([this.layer.on("paint-change", (e9) => {
      ...
      if (this._styeChanged = true, e9.isDataDriven) this._styleChanges.push({ type: 0, data: e9 }), this.requestUpdate();
        ...
        if (!i6) return;
        const s6 = 3 === i6.type;
        t7.setPaintProperties(e9.layer, e9.paint), s6 && ((_a = this._vectorTileContainer) == null ? void 0 : _a.restartDeclutter()), (_b = this._vectorTileContainer) == null ? void 0 : _b.requestRender();
      }
      ...
      if (null != s6) {
        if (p(s6, "visibility") && 1 === b2(s6)) return t7.setLayoutProperties(e9.layer, e9.layout), 3 === i6.type && ((_a = this._vectorTileContainer) == null ? void 0 : _a.restartDeclutter()), void ((_b = this._vectorTileContainer) == null ? void 0 : _b.requestRender());
        this._styleChanges.push({ type: 1, data: e9 }), this.requestUpdate();
      }
    }), this.layer.on("style-layer-visibility-change", (e9) => {
      var _a, _b;
      const t7 = this._styleRepository, i6 = t7.getLayerById(e9.layer);
      i6 && (this._styeChanged = true, t7.setStyleLayerVisibility(e9.layer, e9.visibility), 3 === i6.type && ((_a = this._vectorTileContainer) == null ? void 0 : _a.restartDeclutter()), (_b = this._vectorTileContainer) == null ? void 0 : _b.requestRender());
  ...
  supportsSpatialReference(e8) {
    var _a;
    return T((_a = this.layer.tileInfo) == null ? void 0 : _a.spatialReference, e8);
  }
  canResume() {
    let e8 = super.canResume();
    const { currentStyleInfo: t7 } = this.layer;
    if (e8 && (t7 == null ? void 0 : t7.layerDefinition)) {
      const i6 = this.view.scale, { minScale: s6, maxScale: r4 } = t7.layerDefinition;
      (t7 == null ? void 0 : t7.layerDefinition) && (s6 && s6 < i6 && (e8 = false), r4 && r4 > i6 && (e8 = false));
    }
    return e8;
  }
  isUpdating() {
...
__decorate([m2()], P.prototype, "_isTileHandlerReady", void 0), P = __decorate([a2("esri.views.2d.layers.VectorTileLayerView2D")], P);
var V = P;
export {
  V as default
};
//# sourceMappingURL=VectorTileLayerView2D-45WA4EGT.js.map
