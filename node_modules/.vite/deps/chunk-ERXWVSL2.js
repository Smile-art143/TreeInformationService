...
async function U(e3, t7) {
  ...
  for (const o5 in e3) {
    ...
    const a4 = n9.encoding + ";base64," + s6, i5 = "/textureDefinitions/" + o5, l4 = "rgba" === n9.channels ? n9.alphaChannelUsage || "transparency" : "none", u3 = { noUnpackFlip: true, wrap: { s: 10497, t: 10497 }, preMultiplyAlpha: 1 !== I2(l4) }, c2 = (t7 == null ? void 0 : t7.disableTextures) ? Promise.resolve(null) : t3(a4, t7);
...
async function z(e3, r4) {
  ...
  if (r4.cache) s5 = await r4.cache.loadGLTF(o5.url, r4, !!r4.usePBR);
    ...
    const { loadGLTF: e4 } = await import("./loader-UZBE4VR5.js");
...
function X(e3, t7, o5, s5, i5, n8, l4, a4, c2) {
  ...
  if (!n8.has(x2)) {
    ...
    const o6 = y(m2.color[0]), f3 = y(m2.color[1]), d4 = y(m2.color[2]), p3 = null != m2.colorTexture && T3 ? l4.get(m2.colorTexture) : null, g3 = n7(m2), y3 = null != ((_a = m2.normalTextureTransform) == null ? void 0 : _a.scale) ? (_b = m2.normalTextureTransform) == null ? void 0 : _b.scale : a;
...
//# sourceMappingURL=chunk-ERXWVSL2.js.map
