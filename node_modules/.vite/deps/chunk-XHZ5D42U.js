...
async function o(o2) {
  var _a;
  const a2 = "portalItem" in o2 ? o2 : { portalItem: o2 }, { fromItem: e } = await import("./portalLayers-36EWCRSF.js");
  try {
    return await e(a2);
  } catch (p) {
...
var b = class extends n(s3(u)) {
  ...
  static async fromArcGISServerUrl(t) {
    ...
    return (await import("./arcgisLayers-Z2DK2Z7W.js")).fromUrl(e);
  }
...
//# sourceMappingURL=chunk-XHZ5D42U.js.map
