...
function M(e) {
  ...
  return ns(e.getPointCount(), n2), n2;
}
function x(e, t) {
...
var b = class {
  ...
  isNear(e, t) {
    ...
    if (e === t) return true;
    let n2 = true;
    if (e.getGeometryType() !== ee.type && e.getGeometryType() !== re.type || t.getGeometryType() !== ee.type && t.getGeometryType() !== re.type || (n2 = false), n2) {
  ...
  distanceMultipathMultipath(n2, i, s, o) {
    ...
    try {
      ...
      const f2 = M(y), x2 = [], E2 = new fm(), b2 = new n(), S = new n(), B = new n();
...
//# sourceMappingURL=chunk-SGNBLA6R.js.map
