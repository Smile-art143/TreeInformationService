...
var _Chip = class _Chip extends LitElement {
  constructor() {
    super();
  ...
  renderCloseButton() {
    return html`<button .ariaLabel=${this.messages.dismissLabel} class=${safeClassMap(CSS.close)} @click=${this.close} @keydown=${this.closeButtonKeyDownHandler} .tabIndex=${this.disabled ? -1 : 0} ${ref(this.closeButtonRef)}><calcite-icon .icon=${ICONS.close} .scale=${getIconScale(this.scale)}></calcite-icon></button>`;
  }
  renderIcon() {
...
@esri/calcite-components/dist/components/calcite-chip/customElement.js:
  ...
  v3.3.3 *)
*/
//# sourceMappingURL=calcite-chip-A4XOUIE3.js.map
