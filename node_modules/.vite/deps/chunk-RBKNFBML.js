...
function i3() {
  return t3 ?? (t3 = (async () => {
    const i7 = await import("./basis_transcoder-DRI5GRHW.js"), t4 = await i7.default({ locateFile: (i8) => n2(`esri/libs/basisu/${i8}`) });
...
var M = class {
  ...
  get usedMemory() {
    var _a;
    return ((_a = this._glTexture) == null ? void 0 : _a.usedMemory) || v(this._data, this._parameters);
  }
  load(e3) {
...
//# sourceMappingURL=chunk-RBKNFBML.js.map
