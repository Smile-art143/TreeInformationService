...
async function w(e, t, r) {
  ...
  const a = e.write({}, t);
  return await Promise.all(((_a = t.resources) == null ? void 0 : _a.pendingOperations) ?? []), s2(t, { errorName: "layer-write:unsupported" }, r), a;
}
function I(e) {
...
async function v(e, t, r) {
  const a = e.portal;
  await a.signIn(), await a.user.addItem({ item: e, data: t, folder: r == null ? void 0 : r.folder });
}
async function P(e, r) {
  ...
  return await (n == null ? void 0 : n(a, m2, d2)), I(m2), await m2.update({ data: d2 }), i2(c2), await (s3 == null ? void 0 : s3(m2, c2)), m2;
}
async function $(e, r) {
  const { layer: a, createItemData: o2, createJSONContext: i3, setItemProperties: n, saveResources: s3, supplementalUnsupportedErrors: p2 } = e;
  await l(e);
  const m2 = d(e), c2 = i3 ? i3(m2) : y(m2), u2 = await w(a, c2, { ...r, supplementalUnsupportedErrors: p2 }), f2 = await o2({ layer: a, layerJSON: u2 }, m2);
  return await n(a, m2, f2), I(m2), await v(m2, f2, r), a.portalItem = m2, i2(c2), await (s3 == null ? void 0 : s3(m2, c2)), m2;
}
...
//# sourceMappingURL=chunk-P5EKTGRB.js.map
