...
function g2(t3, e2, i5) {
  ...
  switch (f4) {
    ...
    case "multipoint":
      return i5 ?? (i5 = t3.extent.center), new m2({ hasM: c2, hasZ: p, points: m5(t3.points, l5, x3, i5), spatialReference: u4 });
  }
  return null;
}
...
var N = class extends l {
  ...
  initialize() {
    const t3 = this.view;
    this._highlightHelper = new l4({ view: t3 }), this._setup(), this.addHandles([f(() => t3 == null ? void 0 : t3.ready, () => {
    ...
    }, w), l2(() => this.view.effectiveTheme.accentColor, () => this._updateSymbolsForTheme(), h2), this.on("move-start", (t4) => {
      var _a, _b;
      return (_b = (_a = this.callbacks) == null ? void 0 : _a.onMoveStart) == null ? void 0 : _b.call(_a, t4);
    }), this.on("move", (t4) => {
      var _a, _b;
      return (_b = (_a = this.callbacks) == null ? void 0 : _a.onMove) == null ? void 0 : _b.call(_a, t4);
    }), this.on("move-stop", (t4) => {
      var _a, _b;
      return (_b = (_a = this.callbacks) == null ? void 0 : _a.onMoveStop) == null ? void 0 : _b.call(_a, t4);
    }), this.on("rotate-start", (t4) => {
      var _a, _b;
      return (_b = (_a = this.callbacks) == null ? void 0 : _a.onRotateStart) == null ? void 0 : _b.call(_a, t4);
    }), this.on("rotate", (t4) => {
      var _a, _b;
      return (_b = (_a = this.callbacks) == null ? void 0 : _a.onRotate) == null ? void 0 : _b.call(_a, t4);
    }), this.on("rotate-stop", (t4) => {
      var _a, _b;
      return (_b = (_a = this.callbacks) == null ? void 0 : _a.onRotateStop) == null ? void 0 : _b.call(_a, t4);
    }), this.on("scale-start", (t4) => {
      var _a, _b;
      return (_b = (_a = this.callbacks) == null ? void 0 : _a.onScaleStart) == null ? void 0 : _b.call(_a, t4);
    }), this.on("scale", (t4) => {
      var _a, _b;
      return (_b = (_a = this.callbacks) == null ? void 0 : _a.onScale) == null ? void 0 : _b.call(_a, t4);
    }), this.on("scale-stop", (t4) => {
      var _a, _b;
      return (_b = (_a = this.callbacks) == null ? void 0 : _a.onScaleStop) == null ? void 0 : _b.call(_a, t4);
    })]);
  }
  destroy() {
  ...
  get state() {
    var _a;
    const t3 = ((_a = this.view) == null ? void 0 : _a.ready) ?? false, e2 = this.graphics.length && this.layer;
  ...
  _reset() {
    var _a, _b;
    (_a = this._highlightHelper) == null ? void 0 : _a.removeAll(), this._resetGraphicStateVars(), this._resetGraphics(), this._updateTooltip(), (_b = this._mover) == null ? void 0 : _b.destroy(), this._mover = null, this.removeHandles(z);
  }
  ...
  _scaleGraphic(t3) {
    ...
    const { x: u4, y: y3 } = t3.geometry, v2 = m6[0] * u4 + m6[2] * y3 + m6[4], f4 = m6[1] * u4 + m6[3] * y3 + m6[5], G = (h4 == null ? void 0 : h4.map((t4) => t4.geometry)) ?? [], S = G.every((t4) => "point" === t4.type);
    if ((0 === _3 || 0 === c2) && S) {
  ...
  _rotateGraphic(t3) {
    ...
    const _3 = ((_a = this._startInfo.graphicInfos) == null ? void 0 : _a.map((t4) => t4.geometry)) ?? [];
    for (const p of _3) {
  ...
  _setUpHighlights() {
    var _a;
    this.highlightsEnabled && this.graphics.length && ((_a = this._highlightHelper) == null ? void 0 : _a.add(this.graphics, this.highlightName));
  }
  _setupGraphics() {
  ...
  _updateSymbolsForTheme() {
    ...
    this.symbols = { ...this.symbols, fill: { active: (_a = this.symbols.fill.active) == null ? void 0 : _a.clone().set("outline.color", t3), default: (_b = this.symbols.fill.default) == null ? void 0 : _b.clone().set("outline.color", t3) }, handles: { ...this.symbols.handles, default: this.symbols.handles.default.clone().set("outline.color", t3) }, rotator: { ...this.symbols.rotator, default: this.symbols.rotator.default.clone().set("outline.color", t3) }, rotatorLine: this.symbols.rotatorLine.clone().set("color", t3) };
  ...
  _hasExtentGraphic() {
    return this.graphics.some((t3) => null != (t3 == null ? void 0 : t3.geometry) && "extent" === t3.geometry.type);
  }
  _getBoxBounds(t3) {
...
//# sourceMappingURL=Box-YZTJZLNV.js.map
