...
function c(e2) {
  ...
  if (f(e2)) {
    const t = [];
    for (const r of e2) t.push({ scale: r.scale, value: i(r.value) });
    return t;
  }
  return i(e2);
}
...
function u(t, r, s2) {
  if (null == t[r]) throw new s("effect:missing-parameter", `Missing parameter '${r}' in ${t.type} effect`, { effect: t });
...
//# sourceMappingURL=chunk-YUHBFP5M.js.map
