import {
  n as n4
} from "./chunk-YV5MGXDU.js";
import {
  e as e2,
  n as n3
} from "./chunk-JKVC3PES.js";
import {
  a,
  u
...
function d4(e3, t, n5) {
  e3 = e3.trim(), t = t == null ? void 0 : t.trim();
  const r = [], o2 = Array.from(/* @__PURE__ */ new Set([n5 == null ? void 0 : n5.delimiter, ...u2])).filter((e4) => null != e4);
  for (const i2 of o2) {
  ...
  for (const s4 of l2) {
    const t2 = m(e3, s4).names, r2 = n4(t2, n5 == null ? void 0 : n5.longitudeField, n5 == null ? void 0 : n5.latitudeField);
...
var R = class {
  ...
  async load(e3, t = {}) {
    ...
    const [i2] = await Promise.all([this._fetch(t.signal), this._checkProjection((_a = e3 == null ? void 0 : e3.parsingOptions) == null ? void 0 : _a.spatialReference)]), n5 = V(i2, e3);
  ...
  async refresh(e3) {
    var _a;
    this._loadOptions.customParameters = e3, (_a = this._snapshotTask) == null ? void 0 : _a.abort(), this._snapshotTask = d3(this._snapshotFeatures), this._snapshotTask.promise.then((e4) => {
...
//# sourceMappingURL=CSVSourceWorker-7JXT4OXD.js.map
