...
import {
  o as o5
} from "./chunk-V2I3DYVG.js";
import "./chunk-7PIFITKB.js";
import {
  p as p4
} from "./chunk-O3VIS2DE.js";
import {
  n as n5,
  r as r4
...
var T2 = class extends a2(c3) {
  ...
  writeControlPoints(t3, e3, r6, i4) {
    if (null == this.transform) {
      const t4 = new s("web-document-write:invalid-georeference", "Invalid 'controlPoints', 'width', 'height' configuration. Make sure the parent media element is loaded i.e. the ImageElement or VideoElement set as 'MediaLayer.source'.", { layer: i4 == null ? void 0 : i4.layer, georeference: this });
      return void ((i4 == null ? void 0 : i4.messages) ? i4.messages.push(t4) : i.getLogger(this).error(t4.name, t4.message));
    }
...
var p8 = class extends c3 {
  ...
  set coords(t3) {
    ...
    if (t3 = this.projectOrWarn(t3, r6), null == (t3 == null ? void 0 : t3.extent)) return;
...
function P3(n7, t3, r6) {
  ...
  const { coords: a3 } = n7;
  if (5 !== ((_a3 = a3 == null ? void 0 : a3.rings[0]) == null ? void 0 : _a3.length)) return null;
...
function d(e3, n7, t3) {
  return { enabled: !w(t3 == null ? void 0 : t3.layer, t3 == null ? void 0 : t3.origin), ignoreOrigin: true };
}
...
var u6 = class extends o2(l3(u)) {
  ...
  writeGeoreference(e3, o6, t3, n7) {
    var _a3;
    const i4 = (_a3 = n7 == null ? void 0 : n7.resources) == null ? void 0 : _a3.pendingOperations, c4 = () => {
      var _a4;
      const i5 = P3(this.georeference, this.contentWidth, this.contentHeight);
      if (i5) {
        if ("control-points" !== e3.type && i.getLogger(this).warn(`only georeference of type 'control-points' may be persisted. The georeference of type '${e3.type}' has been automatically converted.`), 4 !== ((_a4 = i5.controlPoints) == null ? void 0 : _a4.length) && (n7 == null ? void 0 : n7.messages)) return void n7.messages.push(new s("property:unsupported", "only 'control-points' georeference with 4 control points may be persisted."));
        o6[t3] = i5.write({}, n7);
      }
    };
...
__decorate([m(h2)], u6.prototype, "georeference", void 0), __decorate([o("georeference")], u6.prototype, "readGeoreference", null), __decorate([r2("georeference")], u6.prototype, "writeGeoreference", null), __decorate([m({ json: { read: false, write: false } })], u6.prototype, "opacity", void 0), u6 = __decorate([a("esri.layers.support.MediaElementBase")], u6);
...
var E2 = (_a = class extends u6 {
  ...
  writeImage(t3, e3, r6, o6) {
    if (null == t3) return;
    const n7 = o6 == null ? void 0 : o6.portalItem, s5 = o6 == null ? void 0 : o6.resources;
    if (!n7 || !s5) return void ("string" == typeof t3 && (e3[r6] = m2(t3, o6)));
    const a3 = U2(t3) ? t3 : null;
    if (a3) {
      if (null == v(a3)) return void (e3[r6] = a3);
      const t4 = m2(a3, { ...o6, verifyItemRelativeUrls: (o6 == null ? void 0 : o6.verifyItemRelativeUrls) ? { writtenUrls: o6.verifyItemRelativeUrls.writtenUrls, rootPath: void 0 } : void 0 }, 1);
...
__decorate([m()], E2.prototype, "animationOptions", void 0), __decorate([m({ readOnly: true })], E2.prototype, "content", void 0), __decorate([m({ readOnly: true })], E2.prototype, "contentWidth", null), __decorate([m({ readOnly: true })], E2.prototype, "contentHeight", null), __decorate([m(x3)], E2.prototype, "image", void 0), __decorate([o("image", ["url"])], E2.prototype, "readImage", null), __decorate([r2("image")], E2.prototype, "writeImage", null), __decorate([m(g)], E2.prototype, "type", void 0), E2 = __decorate([a("esri.layers.support.ImageElement")], E2);
...
var V3 = (_a2 = class extends u6 {
  ...
  get contentWidth() {
    var _a3;
    return ((_a3 = this.content) == null ? void 0 : _a3.videoWidth) ?? 0;
  }
  get contentHeight() {
    var _a3;
    return ((_a3 = this.content) == null ? void 0 : _a3.videoHeight) ?? 0;
  }
  get currentTime() {
    var _a3;
    return (_a3 = this.content) == null ? void 0 : _a3.currentTime;
  }
  set currentTime(e3) {
    ...
    "fastSeek" in this.content ? this.content.fastSeek(t3) : this.content.currentTime = t3, this.content.play().then(() => {
      var _a3;
      (_a3 = this.content) == null ? void 0 : _a3.pause();
    }).catch(() => {
    });
  }
  get duration() {
    var _a3;
    return (_a3 = this.content) == null ? void 0 : _a3.duration;
  }
  set video(e3) {
  ...
  writeVideo(e3, t3, r6, s5) {
    if (!e3) return void ((s5 == null ? void 0 : s5.messages) && s5.messages.push(new s("video-element:unsupported-video", "video source is missing")));
    const i4 = _5(e3) ? e3 : null;
    if (!i4) return void ((s5 == null ? void 0 : s5.messages) && s5.messages.push(new s("video-element:unsupported-video", "video source must be an absolute url")));
    !Y(i4) && (s5 == null ? void 0 : s5.blockedRelativeUrls) && s5.blockedRelativeUrls.push(i4);
    const c4 = _(i4);
    !v(c4) ? t3[r6] = c4 : (s5 == null ? void 0 : s5.messages) && s5.messages.push(new s("video-element:unsupported-video", "video source cannot be an item resource"));
  }
...
var I3 = class extends p2(m3(l)) {
  ...
  async load(e3) {
    if (s2(e3), !this.spatialReference) {
      const e4 = this.elements.find((e5) => {
        var _a3;
        return null != ((_a3 = e5.georeference) == null ? void 0 : _a3.coords);
      });
  ...
  set elements(e3) {
    this._set("elements", n3(e3, this._get("elements"), M3));
  }
  get fullExtent() {
...
var L4 = class extends p3(t2(b(j(l3(b2))))) {
  constructor(e3) {
    super(e3), this.effectiveSource = null, this.georeference = null, this.copyright = null, this.operationalLayerType = "MediaLayer", this.spatialReference = null, this.type = "media", this._debouncedSaveOperations = L(async (e4, r6, o6) => {
      const { save: t3, saveAs: s5 } = await import("./mediaLayerUtils-YTOPPP3A.js");
      switch (e4) {
        case 0:
          return t3(this, r6);
        case 1:
  ...
  destroy() {
    var _a3, _b;
    (_a3 = this.effectiveSource) == null ? void 0 : _a3.destroy(), this.effectiveSource !== this.source && ((_b = this.source) == null ? void 0 : _b.destroy());
  }
  ...
  readSource(e3, r6, o6) {
    ...
    return t3 == null ? void 0 : t3.read(r6, o6), t3;
  }
  writeSource(e3, r6, t3, s5) {
    if (e3 && e3 instanceof I3) {
      const r7 = e3.elements.length;
      if (1 !== r7) return void ((s5 == null ? void 0 : s5.messages) && s5.messages.push(new s("media-layer:unsupported-source", `local media element source can only be persisted if it contains exactly one ImageElement, but it has ${r7}.`)));
      e3 = e3.elements.at(0);
    }
    c2(e3) ? e3.write(r6, s5) : (s5 == null ? void 0 : s5.messages) && (e3 ? s5.messages.push(new s("media-layer:unsupported-source", "only media elements of type 'ImageElement' or 'VideoElement' can be persisted")) : s5.messages.push(new s("media-layer:unsupported-source", "the media layer is missing a source")));
  }
  async save(e3) {
