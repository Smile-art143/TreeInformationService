import {
  p as p2
} from "./chunk-44VUAPSN.js";
import "./chunk-GXUOK2PM.js";
import {
  j as j4
...
var l6 = class {
  ...
  async fetchTileIndex(t3) {
    return this._tileIndexPromise || (this._tileIndexPromise = H(this._tileIndexUrl, { query: { ...t3 == null ? void 0 : t3.query } }).then((e4) => e4.data.index)), this._tileIndexPromise;
  }
  dataKey(e4, t3) {
...
var l7 = class {
  ...
  getData(t3) {
    var _a;
    (null == this._promise || a2((_a = this._abortController) == null ? void 0 : _a.signal)) && (this._promise = this._makeRequest(this._tileUrl));
    const o6 = this._abortOptions;
    return o6.push(t3), w(t3, () => {
      o6.every((t4) => a2(t4)) && this._abortController.abort();
...
var m2 = class {
  constructor(h4, m3, u2) {
    ...
    this.tileServers = x3;
    const d5 = u2.capabilities && u2.capabilities.split(",").map((t3) => t3.toLowerCase().trim()), y2 = true === (u2 == null ? void 0 : u2.exportTilesAllowed), T2 = true === (d5 == null ? void 0 : d5.includes("tilemap")), I2 = y2 && u2.hasOwnProperty("maxExportTilesCount") ? u2.maxExportTilesCount : 0;
...
async function S(t3, r3, s6, n3, i2) {
  ...
  if (s2(i2), "string" == typeof s6) {
    const t4 = K(s6);
    a5 = await H(t4, { ...i2, responseType: "json", query: { f: "json", ...i2 == null ? void 0 : i2.query } }), a5.ssl && (u2 && (u2 = u2.replace(/^http:/i, "https:")), c2 && (c2 = c2.replace(/^http:/i, "https:"))), u2 = t4, c2 = t4;
  } else null != s6 && (a5 = { data: s6 }, u2 = s6.jsonUrl || null, c2 = n3);
  const f4 = a5 == null ? void 0 : a5.data;
...
async function U(e4, t3, o6, l8, r3, u2) {
  const c2 = o6 ? jt(o6) + "/" : j(), a5 = v(t3, e4), f4 = new m2(r3, Bt(c2, (u2 == null ? void 0 : u2.query) ?? {}), a5);
...
var B = class extends p(t(f3(p2(l3(b(j3(s4(o3(l(b2)))))))))) {
  ...
  get tileInfo() {
    ...
    let t3 = ((_a = this.primarySource) == null ? void 0 : _a.tileInfo) || new z2();
    if (e4.length > 1) for (let r3 = 0; r3 < e4.length; r3++) r2(t3, e4[r3].tileInfo) && (t3 = o5(t3, e4[r3].tileInfo));
    return t3;
  }
  readTilemapCache(e4, t3) {
    var _a;
    const r3 = (_a = t3.capabilities) == null ? void 0 : _a.includes("Tilemap");
  ...
  async loadSpriteSource(e4 = 1, t3) {
    ...
    if (!this._spriteSourceMap.has(e4)) {
      const r3 = t2().maxTextureSize, i2 = ((_a = this.currentStyleInfo) == null ? void 0 : _a.spriteUrl) ? Bt(this.currentStyleInfo.spriteUrl, { ...this.customParameters, token: this.apiKey }) : null, o6 = new n2({ type: "url", spriteUrl: i2, pixelRatio: e4, spriteFormat: (_b = this.currentStyleInfo) == null ? void 0 : _b.spriteFormat }, r3);
  ...
  async loadStyle(e4, t3) {
    ...
    return this._loadingTask && "string" == typeof i2 && this.url === i2 || ((_a = this._loadingTask) == null ? void 0 : _a.abort(), this._loadingTask = d2((e5) => (this._spriteSourceMap.clear(), this._getSourceAndStyle(i2, { signal: e5 })), t3)), this._loadingTask.promise;
  }
  getStyleLayerId(e4) {
