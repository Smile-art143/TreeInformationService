...
import {
  U as U2,
  p as p2
} from "./chunk-LMWKCKGB.js";
import {
  e
} from "./chunk-GXUOK2PM.js";
import {
  o as o2
...
var m2 = p5 = class extends n {
  ...
  readFullExtents(t3, e2) {
    var _a, _b;
    return ((_a = e2.fullExtents) == null ? void 0 : _a.length) ? e2.fullExtents.map((t4) => z.fromJSON(t4)) : ((_b = e2.tileMatrixSets) == null ? void 0 : _b.map((t4) => z.fromJSON(t4.fullExtent)).filter((t4) => t4)) ?? [];
  }
  get imageFormat() {
    var _a;
...
function d(e2, i2) {
  ...
  const s3 = g("OperationsMetadata", n3), a4 = s3 == null ? void 0 : s3.querySelector("[name='GetTile']"), c = a4 == null ? void 0 : a4.getElementsByTagName("Get"), u2 = c && Array.prototype.slice.call(c), p7 = (_a = i2.url) == null ? void 0 : _a.indexOf("https"), f4 = void 0 !== p7 && p7 > -1;
  let d2, m4, x2 = i2.serviceMode, w2 = i2 == null ? void 0 : i2.url;
  if ((u2 == null ? void 0 : u2.length) && u2.some((e3) => {
    ...
    w2 = e3 == null ? void 0 : e3.getAttribute("xlink:href");
  }
...
function m3(e2) {
  ...
  for (const t3 of e2.layers) for (const e3 of t3.tileMatrixSets ?? []) {
    ...
    if (t4 && 96 !== t4.dpi) {
      for (const i2 of t4.lods ?? []) i2.scale = 96 * i2.scale / t4.dpi, i2.resolution = j2((_a = t4.spatialReference) == null ? void 0 : _a.wkid, i2.scale * u / 96, e3.id);
      t4.dpi = 96;
    }
  }
}
...
function C(e2, t3, i2, n3) {
  ...
  return Array.prototype.slice.call(n3.childNodes).some((n4) => {
    if (n4.nodeName.includes(e2)) {
      const e3 = g(t3, n4), r3 = e3 == null ? void 0 : e3.textContent;
...
function y(e2, t3) {
  var _a;
  const i2 = [], n3 = (_a = e2.layerMap) == null ? void 0 : _a.get(t3);
  if (!n3) return null;
...
function A3(e2, t3, i2, n3, l5, r3, o5, s3) {
  ...
  const { dimensionMap: c } = e2, u2 = (_a = c.get(t3).dimensions) == null ? void 0 : _a[0], p7 = (_b = c.get(t3).dimensions2) == null ? void 0 : _b[0];
...
function R(e2, t3, i2) {
  const n3 = y(e2, t3), l5 = n3 == null ? void 0 : n3.filter((e3) => e3.format === i2);
  return ((l5 == null ? void 0 : l5.length) ? l5 : n3) ?? [];
}
function S(e2, t3, i2, n3) {
  ...
  let o5 = "";
  if (r3 && r3.length > 0) {
    const e3 = (_a = l5.get(t3).dimensions) == null ? void 0 : _a[0], s3 = (_b = l5.get(t3).dimensions2) == null ? void 0 : _b[0];
...
function b3(e2, t3) {
  return h("Style", e2).map((e3) => {
    ...
    let r3 = i2 == null ? void 0 : i2.getAttribute("xlink:href");
    t3 && (r3 = r3 == null ? void 0 : r3.replace(/^http:/i, "https:"));
...
function j2(e2, t3, n3) {
  let l5;
  return l5 = r2.hasOwnProperty("" + e2) ? r2.values[r2[e2]] : "default028mm" === n3 ? 6370997 * Math.PI / 180 : A2(e2).metersPerDegree, 7 * t3 / 25e3 / l5;
}
...
var $ = F2 = class extends p(f2(t2(b(j(l2(b2)))))) {
  ...
  readActiveLayerFromItemOrWebDoc(e2, t3) {
    const { templateUrl: r3, wmtsInfo: i2 } = t3, s3 = r3 ? this._getLowerCasedUrlParams(r3) : null, a4 = i2 == null ? void 0 : i2.layerIdentifier;
    let o5 = null;
    const l5 = i2 == null ? void 0 : i2.tileMatrixSet;
    l5 && (Array.isArray(l5) ? l5.length && (o5 = l5[0]) : o5 = l5);
    const n3 = s3 == null ? void 0 : s3.format, m4 = s3 == null ? void 0 : s3.style;
  ...
  createWebTileLayer(e2) {
    const t3 = this.getUrlTemplate(this.activeLayer.id, this.activeLayer.tileMatrixSetId, this.activeLayer.imageFormat, this.activeLayer.styleId), r3 = this._getTileMatrixSetById(e2.tileMatrixSetId), i2 = r3 == null ? void 0 : r3.tileInfo, s3 = e2.fullExtent, a4 = new p2({ layerIdentifier: e2.id, tileMatrixSet: e2.tileMatrixSetId, url: this.url });
  ...
  getTileUrl(e2, t3, r3) {
    var _a;
    const i2 = this._getTileMatrixSetById(this.activeLayer.tileMatrixSetId), s3 = (_a = i2 == null ? void 0 : i2.tileInfo) == null ? void 0 : _a.lods[e2], a4 = s3 ? s3.levelValue || `${s3.level}` : `${e2}`;
  ...
  _getTileMatrixSetById(e2) {
    ...
    return (_a = t3 == null ? void 0 : t3.tileMatrixSets) == null ? void 0 : _a.find(({ id: t4 }) => t4 === e2);
  }
