...
var V2 = class extends _(l3(b(j(t(l(s3(o3(l2(b2))))))))) {
  ...
  getFieldDomain(e3) {
    ...
    return (r3 == null ? void 0 : r3.domain) ? r3.domain : null;
  }
  ...
  async _load(e3) {
    await this.loadFromPortal({ supportedTypes: ["Scene Service"] }, e3).catch(f), await this._fetchService(e3 == null ? void 0 : e3.signal), await this._fetchRootPageAndUpdateExtent(e3 == null ? void 0 : e3.signal);
  }
  async _fetchRootPageAndUpdateExtent(e3) {
    ...
    if (null != r3 && !r3.hasZ) {
      ...
      O(r3, (_b = (_a = e4 == null ? void 0 : e4.nodes) == null ? void 0 : _a[0]) == null ? void 0 : _b.obb);
    }
  }
  async _fetchRootPage(e3) {
    var _a;
    const r3 = `${((_a = this.parsedUrl) == null ? void 0 : _a.path) ?? ""}/nodepages/0`;
    try {
  ...
  _formatPopupTemplateReturnsField(e3) {
    ...
    if (!r3) return;
    const t2 = (_a = e3.fieldInfos) == null ? void 0 : _a.find((e4) => e4.fieldName === r3.name);
    if (!t2) return;
  ...
  async queryCachedStatistics(e3, r3) {
    ...
    for (const i6 of this.attributeStorageInfo) if (i6.name === o5.name) {
      const e4 = V(((_a = this.parsedUrl) == null ? void 0 : _a.path) ?? "", `./statistics/${i6.key}`);
...
//# sourceMappingURL=PointCloudLayer-NZTTIEEB.js.map
