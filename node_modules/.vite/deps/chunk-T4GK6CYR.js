...
function e3() {
  return a || (a = (async () => {
    const [a3, e6, r2] = await Promise.all([import("./arcadeUtils-ET2MX6C6.js"), import("./batchExec-NCO5W7RE.js"), import("./aiServices-D26ZMPI7.js")]);
...
function g(e6, r2, l3) {
  ...
  return u4(e6) ? { min: (_a = e4(l3)) == null ? void 0 : _a.toMillis(), max: (_b = e4(r2)) == null ? void 0 : _b.toMillis(), rawMin: l3, rawMax: r2 } : o(e6) ? { min: (_c = H(l3)) == null ? void 0 : _c.toMillis(), max: (_d = H(r2)) == null ? void 0 : _d.toMillis(), rawMin: l3, rawMax: r2 } : a2(e6) ? { min: (_e2 = c(l3)) == null ? void 0 : _e2.toMillis(), max: (_f = c(r2)) == null ? void 0 : _f.toMillis(), rawMin: l3, rawMax: r2 } : { max: null, min: null };
}
...
function e5(t4) {
  var _a, _b;
  return ((_b = (_a = t4.match(u5)) == null ? void 0 : _a[1]) == null ? void 0 : _b.replaceAll("\\'", "'")) ?? null;
}
...
async function v(e6, n, i2, t4) {
  ...
  if (r2) x(e6, n, r2);
    ...
    const { arcadeUtils: r3 } = await e3(), l3 = r3.extractFieldNames(t4, (i2 == null ? void 0 : i2.partitions) ?? ((_a = n == null ? void 0 : n.fields) == null ? void 0 : _a.map((e7) => e7.name)));
    for (const t5 of l3) x(e6, (i2 == null ? void 0 : i2.index) ?? n, t5);
  }
}
...
function E({ displayField: e6, fields: n }) {
  return e6 || ((n == null ? void 0 : n.length) ? A(n) : null);
}
function A(e6) {
...
async function O(e6, n, i2) {
  const t4 = [];
  (i2 == null ? void 0 : i2.expressionInfos) && t4.push(...i2.expressionInfos.map((i3) => v(e6, n.fieldsIndex, null, i3.expression)));
...
async function R(e6, n, i2) {
  n && (n.timeInfo && (i2 == null ? void 0 : i2.timeExtent) && w(e6, n.fieldsIndex, [n.timeInfo.startField, n.timeInfo.endField]), n.floorInfo && w(e6, n.fieldsIndex, [n.floorInfo.floorField]), null != (i2 == null ? void 0 : i2.where) && await S(e6, n.fieldsIndex, i2.where));
}
...
function H2(e6, n) {
  var _a;
  return e6.editable && !z.has(e6.type) && !W(n).includes(((_a = e6.name) == null ? void 0 : _a.toLowerCase()) ?? "");
}
function K(e6, n) {
  var _a;
  const i2 = ((_a = e6.name) == null ? void 0 : _a.toLowerCase()) ?? "";
  return !(null != (n == null ? void 0 : n.objectIdField) && i2 === n.objectIdField.toLowerCase() || null != (n == null ? void 0 : n.globalIdField) && i2 === n.globalIdField.toLowerCase() || G(n).includes(i2) || P.has(e6.type) || B.some((e7) => e7.test(i2)));
}
...
function Ce(e6, n, i2) {
  if (!(e6 == null ? void 0 : e6.attributes) || !n) {
...
//# sourceMappingURL=chunk-T4GK6CYR.js.map
