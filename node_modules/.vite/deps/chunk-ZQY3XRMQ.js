...
var h2 = class _h extends b3 {
  ...
  _isInFeatureSet(e3) {
    var _a;
    let t4 = (_a = this._parent) == null ? void 0 : _a._isInFeatureSet(e3);
  ...
  async _fetchAndRefineFeatures(e3, t4, i5) {
    ...
    if (await ((_a = this._parent) == null ? void 0 : _a._getFeatures(r4, -1, n5, i5)), this._checkCancelled(i5), null == this._whereClauseFunction) {
      for (let t5 = 0; t5 < n5; t5++) {
        const s5 = (_b = this._parent) == null ? void 0 : _b._featureFromCache(e3[t5]);
    ...
    for (let s5 = 0; s5 < n5; s5++) {
      const t5 = (_c = this._parent) == null ? void 0 : _c._featureFromCache(e3[s5]);
...
var b5 = class extends b3 {
  ...
  async _getSet(e3) {
    ...
    if (null === this._wset) {
      await this._ensureLoaded();
      let t4 = null;
      return t4 = this._extraFilter ? await this._getFilteredSet("", null, null, null, e3) : await ((_a = this._parent) == null ? void 0 : _a._getSet(e3)), this._checkCancelled(e3), n(t4), this._wset = new t2(t4._candidates.slice(), t4._known.slice(), t4._ordered, this._clonePageDefinition(t4.pagesDefinition)), this._wset;
    }
    return this._wset;
  }
  _isInFeatureSet(e3) {
  ...
  async _getFeatures(r4, s5, i5, l3) {
    ...
    await ((_a = this._parent) == null ? void 0 : _a._getFeatures(r4, -1, h3, l3)), this._checkCancelled(l3);
    const c4 = [];
    for (let e3 = 0; e3 < h3; e3++) {
      const t4 = (_b2 = this._parent) == null ? void 0 : _b2._featureFromCache(n5[e3]);
...
var i3 = class _i extends b3 {
  ...
  async manualOrderSet(e3, t4) {
    ...
    (_a = this._orderbyclause) == null ? void 0 : _a.order(r4);
...
var C4 = class _C extends b3 {
  ...
  executeQuery(e3, t4) {
    ...
    if (this.recentlyUsedQueries) {
      ...
      i5 = this.recentlyUsedQueries.getFromCache(t5), null === i5 && (i5 = r4(e3), this.recentlyUsedQueries.addToCache(t5, i5), i5 = i5.catch((e4) => {
        var _a;
        throw (_a = this.recentlyUsedQueries) == null ? void 0 : _a.removeFromCache(t5), e4;
      }));
    }
  ...
  async _getDistinctPages(e3, t4, r4, i5, s5, n5, l3, o4, u2) {
    ...
    if (f5.features.length === ((_a = this._layer.capabilities) == null ? void 0 : _a.query.maxRecordCount) && o4.length < l3) {
  ...
  async _stats(e3, t4, r4, i5, s5, n5, l3) {
    var _a;
    await this._ensureLoaded();
    const o4 = (_a = this._layer.capabilities) == null ? void 0 : _a.query, u2 = !!(o4 == null ? void 0 : o4.supportsSqlExpression), c4 = !!(o4 == null ? void 0 : o4.supportsStatistics), y3 = !!(o4 == null ? void 0 : o4.supportsDistinct);
  ...
  async _canDoAggregates(e3, t4) {
    ...
    await this._ensureLoaded();
    let r4 = false;
    const i5 = (_a = this._layer.capabilities) == null ? void 0 : _a.query, s5 = true === (i5 == null ? void 0 : i5.supportsSqlExpression);
    if (null != i5 && true === i5.supportsStatistics && true === i5.supportsOrderBy && (r4 = true), r4) for (let a4 = 0; a4 < t4.length - 1; a4++) (false === ((_b = t4[a4].workingexpr) == null ? void 0 : _b.isStandardized) || false === v(t4[a4].workingexpr) && false === s5) && (r4 = false);
    return false !== r4;
  }
  ...
  async _getAggregatePagesDataSourceDefinition(e3, t4, r4, i5, s5, a4, n5) {
    ...
    let c4 = "", h3 = false;
    null != a4 && true === ((_b = (_a = this._layer.capabilities) == null ? void 0 : _a.query) == null ? void 0 : _b.supportsOrderBy) && (null == u2 || s(e3, 0, e3.length, a4._fields, 0, Math.min(a4._fields.length, e3.length), (e4, t5) => e4.toLowerCase() === t5.toLowerCase())) && (c4 = a4.constructClause(), h3 = true), "" === c4 && (c4 = e3.join(","));
    const p6 = [];
    ...
    const g2 = (_c = this._layer.capabilities) == null ? void 0 : _c.query.maxRecordCount;
    null != g2 && g2 < f5 && (f5 = g2);
  ...
  async _getAgregagtePhysicalPage(t4, r4, i5) {
    ...
    if (true === t4.pagesDefinition.useOIDpagination && (s5 = l(s5, t4.pagesDefinition.generatedOid + ">" + t4.pagesDefinition.internal.lastMaxId.toString())), null != ((_a = t4.pagesDefinition.internal.keysetPagination) == null ? void 0 : _a.clause)) {
  ...
  async queryAttachments(e3, t4, r4, a4, n5) {
    function l3(e4) {
      ...
      return (t5 == null ? void 0 : t5.data.supportsAttachment) && (t5 == null ? void 0 : t5.operations.supportsQueryAttachments);
    }
  ...
  async queryRelatedFeatures(t4) {
    var _a;
    const i5 = { f: "json", relationshipId: t4.relationshipId.toString(), definitionExpression: t4.where, outFields: (_a = t4.outFields) == null ? void 0 : _a.join(","), returnGeometry: t4.returnGeometry.toString() };
    ...
    if (s5.data) {
      const t5 = {}, r4 = s5.data;
      if (r4 == null ? void 0 : r4.relatedRecordGroups) {
  ...
  async getIdentityUser() {
    var _a;
    await this.load();
    const e3 = (_a = s2) == null ? void 0 : _a.findCredential(this._layer.url);
    return e3 ? e3.userId : null;
  }
  async getOwningSystemUrl() {
    var _a, _b;
    await this.load();
    const e3 = (_a = s2) == null ? void 0 : _a.findServerInfo(this._layer.url);
    ...
    if (i5 = s5 > -1 ? i5.slice(0, s5) : i5, i5) {
      ...
      try {
        ...
        let t4 = "";
        return ((_b = e4.data) == null ? void 0 : _b.owningSystemUrl) && (t4 = e4.data.owningSystemUrl), t4;
      } catch (a4) {
        return "";
      }
    }
  ...
  async getFeatureSetInfo() {
    ...
    const i5 = ((_a = this._layer.parsedUrl) == null ? void 0 : _a.path) ?? null;
    if (i5) {
      const s6 = await H(i5, { responseType: "json", query: { f: "json" } });
      e3 = ((_b = s6 == null ? void 0 : s6.data) == null ? void 0 : _b.name) ?? null, t4 = ((_c = s6 == null ? void 0 : s6.data) == null ? void 0 : _c.serviceItemId) ?? null;
    }
...
var y2 = class _y extends b3 {
  ...
  static create(e3, t4) {
    ...
    const f5 = { outFields: ["*"], source: l3, fields: d3, hasZ: true === ((_a = e3 == null ? void 0 : e3.layerDefinition) == null ? void 0 : _a.hasZ) || true === ((_b = e3 == null ? void 0 : e3.featureSet) == null ? void 0 : _b.hasZ), hasM: true === ((_c = e3 == null ? void 0 : e3.layerDefinition) == null ? void 0 : _c.hasM) || true === ((_d = e3 == null ? void 0 : e3.featureSet) == null ? void 0 : _d.hasM), types: i5, typeIdField: r4, objectIdField: s5, spatialReference: t4 }, _2 = "esriGeometryNull" === p6 || null === p6;
...
var n4 = class extends b3 {
  ...
  async _getFilteredSet(e3, t4, r4, s5, n5) {
    ...
    if ((_a = l3.capabilities) == null ? void 0 : _a.queryRelated.supportsPagination) return this._getFilteredSetUsingPaging(e3, t4, r4, s5, n5);
    let d3 = "", o4 = false;
    null !== s5 && true === ((_b = l3.capabilities) == null ? void 0 : _b.queryRelated.supportsOrderBy) && (d3 = s5.constructClause(), o4 = true);
    const u2 = new u();
  ...
  async _getFilteredSetUsingPaging(e3, t4, r4, s5, a4) {
    ...
    null !== s5 && true === ((_a = d3.capabilities) == null ? void 0 : _a.queryRelated.supportsOrderBy) && (n5 = s5.constructClause(), l3 = true), await this.databaseType();
    const o4 = "1=1";
    let u2 = this._maxQueryRate();
    const h3 = (_b = d3.capabilities) == null ? void 0 : _b.query.maxRecordCount;
    null != h3 && h3 < u2 && (u2 = h3);
...
async function O(e3, t4, a4) {
  ...
  if (r4.metadata = n5, void 0 !== ((_a = n5.controllerDatasetLayers) == null ? void 0 : _a.utilityNetworkLayerId) && null !== n5.controllerDatasetLayers.utilityNetworkLayerId) {
    ...
    if (s5) {
      r4.queryelem = s5, ((_b = r4.queryelem) == null ? void 0 : _b.dataElement) && void 0 !== r4.queryelem.dataElement.schemaGeneration && (r4.unVersion = r4.queryelem.dataElement.schemaGeneration), r4.lkp = {}, r4.queryelem.dataElement.domainNetworks || (r4.queryelem.dataElement.domainNetworks = []);
...
//# sourceMappingURL=chunk-ZQY3XRMQ.js.map
