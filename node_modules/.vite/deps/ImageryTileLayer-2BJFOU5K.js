import {
  ...
  t as t4,
  u as u4
} from "./chunk-6HHDMW2L.js";
import "./chunk-VDZUQIGW.js";
import {
  c as c4,
  f as f4,
  o as o3
...
import {
  n as n2,
  u as u3
} from "./chunk-EYBRPUFQ.js";
import {
  T,
  w
} from "./chunk-BMHMBZAO.js";
import "./chunk-J5CQQTQ7.js";
import "./chunk-WH5EYNMD.js";
import {
  C,
  G,
  H,
...
function o5(e3) {
  ...
  const { referencing: d7 } = e3.domain, f7 = d7.find((e4) => e4.coordinates.includes(s7[u8])).system.id, p6 = f7 == null ? void 0 : f7.slice(f7.lastIndexOf("/") + 1), h3 = null == p6 || "CRS84" === p6 ? 4326 : Number(p6), g4 = new f2({ wkid: h3 }), [b6, y3] = a2[u8], [x2, j5] = a2[m9], v7 = new z({ xmin: b6, xmax: y3, ymin: x2, ymax: j5, spatialReference: g4 });
...
function c5(t7) {
  ...
  for (const [s7, a2] of Object.entries(l7)) {
    ...
    if ("Parameter" === t8 && (n5[s7] = {}, l8 && (n5[s7].description = u5(l8)), i8 && (n5[s7].unit = i8.label ? u5(i8.label) : null, n5[s7].symbol = (_a = i8.symbol) == null ? void 0 : _a.value), r6)) {
      const t9 = Object.entries(r6).map((e3, t10) => ({ OID: t10, Value: Number(e3[1]), ClassName: e3[0].slice(e3[0].lastIndexOf("/") + 1), Count: 1 }));
      let l9 = false;
      ((_b = o6 == null ? void 0 : o6.categories) == null ? void 0 : _b.length) && (o6.categories.forEach((n6) => {
        if (!n6.id) return;
...
function p4(e3) {
  ...
  for (let s7 = 0; s7 < r6.length; s7++) {
    const e4 = r6[s7];
    (a2 == null ? void 0 : a2.length) && u8.push({ name: e4, dimensions: a2 });
  }
  const m9 = c5(e3);
  ...
  for (let o6 = 0; o6 < r6.length; o6++) {
    ...
    for (let i9 = 0; i9 < j5; i9++) {
      ...
      if (0 === o6 || (a2 == null ? void 0 : a2.length)) {
        const l9 = new c({ width: t7, height: n5, mask: u10 ? r7 : null, pixels: [e5], pixelType: y3 });
        if (l9.updateStatistics(), a2 == null ? void 0 : a2.length) {
  ...
  const g4 = (_a = Object.values(m9).find((e4) => e4.attributeTable)) == null ? void 0 : _a.attributeTable;
...
var f6 = class extends X {
  ...
  async _buildInMemoryRaster(t7, i8, r6) {
    ...
    this._pixelBlockTiles = d7[0].value, m9 || (o6.statistics = (_a = d7[1].value) == null ? void 0 : _a.statistics), p6 || (o6.histograms = (_b = d7[1].value) == null ? void 0 : _b.histograms);
  }
  async _buildMDimStats(t7, e3, s7) {
    for (let i8 = 0; i8 < e3.variables.length; i8++) {
      const r6 = e3.variables[i8];
      if (r6.statistics) continue;
      const o6 = r6.dimensions.map((t8) => {
        var _a, _b;
        return new p3({ variableName: r6.name, dimensionName: t8.name, values: [((_a = t8.values) == null ? void 0 : _a[0]) ?? ((_b = t8.extent) == null ? void 0 : _b[0])], isSlice: true });
      }), a2 = C2(o6, e3), n5 = null == a2 ? null : t7[a2];
      if (null == n5) continue;
...
var m7 = class extends X {
  ...
  async _fetchData(e3) {
    var _a, _b, _c, _d;
    const r6 = this.source ?? (await this.request(this.url, { signal: e3 == null ? void 0 : e3.signal })).data, s7 = "imagery-tile-layer:open-coverage-json";
    if ("coverage" !== ((_a = r6.type) == null ? void 0 : _a.toLowerCase()) || "grid" !== ((_c = (_b = r6.domain) == null ? void 0 : _b.domainType) == null ? void 0 : _c.toLowerCase())) throw new s(s7, "Only coverage with Grid domain type is supported");
    if (!r6.ranges) throw new s(s7, "Missing ranges in the grid coverage data");
    if (!((_d = r6.domain.referencing) == null ? void 0 : _d.length)) throw new s(s7, "Missing domain referencing in the grid coverage data");
    const a2 = Object.values(r6.ranges);
    for (let n5 = 0; n5 < a2.length; n5++) {
      const { axisNames: e4, shape: r7, type: c7, values: l7 } = a2[n5];
      if (!("ndarray" === c7.toLowerCase() && (l7 == null ? void 0 : l7.length) && (e4 == null ? void 0 : e4.length) && (r7 == null ? void 0 : r7.length))) throw new s(s7, "Only ranges with valid NdArray, axisNames, shape, and inline values are supported");
...
function m8(e3) {
  var _a;
  const t7 = o4(e3, "NoDataValue"), n5 = e2(e3, "Histograms/HistItem"), r6 = o4(n5, "HistMin"), o6 = o4(n5, "HistMax"), f7 = o4(n5, "BucketCount"), u8 = (_a = t4(n5, "HistCounts")) == null ? void 0 : _a.split("|").map((e4) => Number(e4));
  let c7, m9, d7, p6;
  ...
  return { noDataValue: t7, histogram: (u8 == null ? void 0 : u8.length) && null != r6 && null != o6 ? { min: r6, max: o6, size: f7 || u8.length, counts: u8 } : null, sourceBandIndex: S4, statistics: null != c7 && null != m9 ? { min: c7, max: m9, avg: d7, stddev: p6 } : null };
}
function d5(e3) {
  if (!e3) return null;
  let r6 = Number(e3);
...
function p5(e3) {
  var _a;
  const t7 = e3.replaceAll("]", "[").replaceAll('"', "").split("[").map((e4) => e4.trim()).filter((e4) => "" !== e4), n5 = t7[t7.length - 1].split(","), r6 = (_a = n5[0]) == null ? void 0 : _a.toLowerCase();
...
function S(t7) {
  var _a;
  if ("pamdataset" !== ((_a = t7 == null ? void 0 : t7.documentElement.tagName) == null ? void 0 : _a.toLowerCase())) return {};
...
var h2 = class extends X {
  ...
  async _open(t7) {
    ...
    const l7 = !e3;
    l7 && (e3 = new f2({ wkid: 3857 })), (o6 == null ? void 0 : o6.length) && null == r6 && (r6 = v3(o6));
  ...
  async _fetchData(t7) {
    const { data: e3 } = await this.request(this.url, { responseType: "array-buffer", signal: t7 == null ? void 0 : t7.signal }), r6 = L2(e3).toUpperCase();
  ...
  async _fetchAuxiliaryData(t7) {
    var _a;
    const s7 = t7 == null ? void 0 : t7.signal, { skipExtensions: o6 = [], skipMapInfo: a2 } = this.ioConfig, i8 = a2 || o6.includes("aux.xml") ? null : this.request(this.url + ".aux.xml", { responseType: "xml", signal: s7 }), n5 = this.datasetFormat, l7 = "JPG" === n5 ? "jgw" : "PNG" === n5 ? "pgw" : "BMP" === n5 ? "bpw" : null, m9 = l7 && o6.includes(l7) ? null : this.request(this.url.slice(0, this.url.lastIndexOf(".")) + "." + l7, { responseType: "text", signal: s7 }), c7 = await j([i8, m9]);
    if (s7 == null ? void 0 : s7.aborted) throw u();
    const f7 = S((_a = c7[0].value) == null ? void 0 : _a.data);
    if (!f7.transform) {
      const t8 = c7[1].value ? c7[1].value.data.split("\n").slice(0, 6).map((t9) => Number(t9)) : null;
      f7.transform = 6 === (t8 == null ? void 0 : t8.length) ? new u3({ forwardCoefficients: [t8[4], t8[5], t8[0], -t8[1], t8[2], -t8[3]] }) : null;
    }
    return f7;
  }
};
...
var g3 = class extends X {
  ...
  async fetchRawTile(e3, t7, i8, s7 = {}) {
    ...
    let u8, h3;
    if (r6.isBsqTile) {
      const e4 = (((_a = s7.bandIds) == null ? void 0 : _a.length) ? s7.bandIds : [0, 1, 2]).map((e5) => this.request(c7, { query: { ...m9, bandId: e5 }, responseType: "array-buffer", signal: s7.signal })), t8 = await Promise.all(e4), i9 = t8.map((e5) => e5.data.byteLength).reduce((e5, t9) => e5 + t9), r7 = new Uint8Array(i9);
      h3 = [];
      let a3 = 0;
    ...
    if (!u8) return null;
    const f7 = n5 ? l7.tileSize : r6.tileInfo.size, d7 = await this.decodePixelBlock(u8, { width: f7[0], height: f7[1], planes: h3 == null ? void 0 : h3.length, offsets: h3, pixelType: null, isPoint: "Elevation" === this.tileType, returnInterleaved: n5, noDataValue: this.rasterInfo.noDataValue });
  ...
  async fetchVariableStatisticsHistograms(e3, t7) {
    var _a, _b, _c;
    const i8 = this.request(this.url + "/statistics", { query: { variable: e3, f: "json" }, signal: t7 }).then((e4) => {
      var _a2;
      return (_a2 = e4.data) == null ? void 0 : _a2.statistics;
    }), s7 = this.request(this.url + "/histograms", { query: { variable: e3, f: "json" }, signal: t7 }).then((e4) => {
      var _a2;
      return (_a2 = e4.data) == null ? void 0 : _a2.histograms;
    }), r6 = await Promise.all([i8, s7]);
  ...
  async _open(e3) {
    var _a, _b;
    const r6 = e3 == null ? void 0 : e3.signal, a2 = this.sourceJSON ? { data: this.sourceJSON } : await this.request(this.url, { query: { f: "json" }, signal: r6 });
    ...
    this.tileType = l7.cacheType, null == this.tileType && (n5.includes(l7.tileInfo.format.toLowerCase()) ? this.tileType = "Map" : "lerc" === l7.tileInfo.format.toLowerCase() ? this.tileType = "Elevation" : this.tileType = "Raster"), this.datasetName = ((_a = l7.name) == null ? void 0 : _a.slice(l7.name.indexOf("/") + 1)) ?? "";
    ...
    let L3;
    l7.transposeInfo && (L3 = { tileSize: [l7.transposeInfo.rows, l7.transposeInfo.cols], packetSize: ((_b = o6.keyProperties) == null ? void 0 : _b._yxs.PacketSize) ?? 0 });
  ...
  async _fetchRasterInfo(e3) {
    ...
    const { signal: i8 } = e3, s7 = f4(this.url, this.sourceJSON, { signal: i8, query: this.ioConfig.customFetchParameters }), r6 = t7.hasMultidimensions ? this.request(`${this.url}/slices`, { query: { f: "json" }, signal: i8 }).then((e4) => {
      var _a;
      return (_a = e4.data) == null ? void 0 : _a.slices;
    }).catch(() => null) : null, a2 = await Promise.all([s7, r6]);
...
function S2(e3) {
  ...
  t7.xmin > -1 && t7.xmax > 181 && (i8 == null ? void 0 : i8.wkid) && i8.isGeographic && (e3.nativeExtent = e3.extent, e3.transform = new n2(), e3.extent = e3.transform.forwardTransform(t7));
}
...
var b4 = class extends X {
  ...
  async fetchRawTile(t7, e3, r6, s7 = {}) {
    ...
    const A = x.get(this.rasterInfo.storageInfo.compression).decoderFormat, S4 = await this.decodePixelBlock(I4.buffer, { width: o6, height: i8, format: A, planes: (u8 == null ? void 0 : u8.length) || f7, offsets: F, pixelType: c7 }).catch(() => null);
  ...
  async _fetchAuxiliaryData(t7) {
    try {
      const { data: e3 } = await this.request(this.url + ".aux.xml", { responseType: "xml", signal: t7 == null ? void 0 : t7.signal });
      return S(e3);
    } catch {
      return null;
    }
...
var S3 = (e3, t7) => {
  var _a;
  return (_a = e3.get(t7)) == null ? void 0 : _a.values;
};
var b5 = (e3, t7) => {
  var _a, _b;
  return (_b = (_a = e3.get(t7)) == null ? void 0 : _a.values) == null ? void 0 : _b[0];
};
var E2 = class extends X {
  ...
  async fetchRawTile(e3, t7, i8, r6 = {}) {
    var _a;
    if (!((_a = this._headerInfo) == null ? void 0 : _a.isSupported) || this.isBlockOutside(e3, t7, i8)) return null;
  ...
  async _open(e3) {
    ...
    const g4 = (_b = (_a = f7[0].get("PREDICTOR")) == null ? void 0 : _a.values) == null ? void 0 : _b[0], x2 = (_d = (_c = f7[0].get("SAMPLEFORMAT")) == null ? void 0 : _c.values) == null ? void 0 : _d[0];
  ...
  async _readIFDs(e3, i8, r6, s7 = 4, a2) {
    ...
    if (!(n5 == null ? void 0 : n5.ifd)) throw new s("tiffraster:open", "cannot parse tiff header. failed to open url " + this.url);
  ...
  async _readIFD(e3, t7, i8 = e, r6 = 4, s7) {
    ...
    if (f7.success) {
      const e4 = [];
      if ((_a = f7.ifd) == null ? void 0 : _a.forEach((t8) => {
        t8.values || e4.push(t8);
      }), e4.length > 0 && await this._fillOffsets(e4, t7, f7.nextIFD, s7), (_b = f7.ifd) == null ? void 0 : _b.has("GEOKEYDIRECTORY")) {
        const e5 = f7.ifd.get("GEOKEYDIRECTORY"), i9 = e5 == null ? void 0 : e5.values;
        if (i9 && i9.length > 4) {
          ...
          e5.data = l7 == null ? void 0 : l7.ifd, e5.data && e5.data.set("GEOTIFFVersion", { id: 0, type: 2, valueCount: 1, valueOffset: null, values: [r7] });
        }
      }
      return f7;
    }
  ...
  _getTileLocation(e3, t7, i8, r6 = false) {
    ...
    if (!o6) return null;
    const f7 = r6 ? o6.maskIFDs[n5] : 0 === n5 ? o6 == null ? void 0 : o6.ifds[0] : o6 == null ? void 0 : o6.pyramidIFDs[n5 - 1];
    if (!f7) return null;
  ...
  async _fetchAuxiliaryMetaData(e3) {
    try {
      const { data: t7 } = await this.request(this.url + ".aux.xml", { responseType: "xml", signal: e3 == null ? void 0 : e3.signal });
      return S(t7);
    } catch {
      return null;
    }
  ...
  async _fetchAuxiliaryTable(e3) {
    try {
      const { data: t7 } = await this.request(this.url + ".vat.dbf", { responseType: "array-buffer", signal: e3 == null ? void 0 : e3.signal }), i8 = r5.parse(t7);
      return (i8 == null ? void 0 : i8.recordSet) ? g.fromJSON(i8.recordSet) : null;
    } catch {
      return null;
    }
  }
...
function k4(e3) {
  ...
  if (z3 <= 3 && (j5 == null ? void 0 : j5.length) > 3 && j5.length % 3 == 0) {
    L3 = [];
...
var u7 = class {
  ...
  static async open(r6) {
    ...
    let c7 = r6.datasetFormat ?? (s7 == null ? void 0 : s7.datasetFormat);
...
var Y2 = class extends p(t(b2(j2(o3(s4(X2(i5(l5(l4(f3(l2(l3(b3))))))))))))) {
  constructor(...e3) {
    super(...e3), this._primaryRasters = [], this.graphicOrigin = new s6(this), this.legendEnabled = true, this.isReference = null, this.listMode = "show", this.sourceJSON = null, this.version = null, this.type = "imagery-tile", this.operationalLayerType = "ArcGISTiledImageServiceLayer", this.popupEnabled = true, this.popupTemplate = null, this.screenSizePerspectiveEnabled = true, this.fields = null, this.source = void 0, this._debouncedSaveOperations = L(async (e4, t7, r6) => {
      const { save: s7, saveAs: i8 } = await import("./imageryUtils-EYYKRIEH.js");
      switch (e4) {
        case 0:
          return s7(this, t7);
        case 1:
  ...
  set elevationInfo(e3) {
    "relative-to-scene" !== (e3 == null ? void 0 : e3.mode) && this._set("elevationInfo", e3), this._validateElevationInfo(e3);
  }
  ...
  get rasterFields() {
    var _a, _b;
    const e3 = [o2("Pixel Value"), c2("Raw Pixel Value")], t7 = ((_a = this.raster) == null ? void 0 : _a.rasterInfo) ?? this.serviceRasterInfo, r6 = t7 == null ? void 0 : t7.attributeTable;
    if (r6) {
      const t8 = v4(r6);
      e3.push(...t8);
    }
    const s7 = t7 == null ? void 0 : t7.dataType, i8 = t7 == null ? void 0 : t7.multidimensionalInfo;
    if (("vector-magdir" === s7 || "vector-uv" === s7) && null != i8) {
      const t8 = (_b = i8.variables[0].unit) == null ? void 0 : _b.trim(), r7 = d2(t8), s8 = $();
      e3.push(r7, s8);
    }
    if (i8) {
      const t8 = p2(i8);
  ...
  createPopupTemplate(e3) {
    const { rasterFields: t7 } = this, r6 = (e3 == null ? void 0 : e3.visibleFieldNames) ?? new Set(t7.map(({ name: e4 }) => e4).filter((e4) => e4 !== i4.rawServicePixelValue)), s7 = d({ fields: t7, title: this.title }, { ...e3, visibleFieldNames: r6 }), { rasterInfo: i8 } = this.raster;
    return (s7 == null ? void 0 : s7.fieldInfos) && i8 && b(s7.fieldInfos, i8), s7;
  }
  async generateRasterInfo(e3, t7) {
    var _a;
    if (e3 = m(N3, e3), await this.load(), !e3 || "none" === ((_a = e3.functionName) == null ? void 0 : _a.toLowerCase())) return this.serviceRasterInfo;
    try {
  ...
  async _openFromSource(e3, t7) {
    var _a;
    const r6 = "the tiled imagery data source is not supported", i8 = "coverage" === ((_a = e3.type) == null ? void 0 : _a.toLowerCase()) ? "CovJSON" : e3.extent && e3.pixelBlock ? "MEMORY" : null;
  ...
  async _openFunctionRaster(e3, t7) {
    ...
    const s7 = T(((_a = e3.functionDefinition) == null ? void 0 : _a.toJSON()) ?? e3.toJSON(), r6), i8 = new m5({ rasterFunction: s7 });
...
//# sourceMappingURL=ImageryTileLayer-2BJFOU5K.js.map
