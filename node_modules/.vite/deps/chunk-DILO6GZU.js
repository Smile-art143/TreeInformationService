...
var A3 = class extends r4 {
  ...
  _createOrUpdateGraphic(t8) {
    ...
    return this._graphic = o6, this.updateGraphicGeometry(t8), this.internalGraphicsLayer.add(o6), this.addHandles(this.initializeGraphic(o6)), this.notifyChange("graphic"), this.addHandles(e2(() => {
...
function f7({ predicate: o6 = () => true, snappingManager: i10, snappingContext: a8, updatingHandles: u5, useZ: p5 = true }) {
  ...
  const T6 = () => {
    Z4 = e(Z4), i10.doneSnapping(), j8 == null ? void 0 : j8.frameTask.remove(), j8 = null, f8 = l(f8), z6 = null;
  }, k6 = d5(i10, p5, c9);
  ...
  return { snappingStep: [(n5) => {
    ...
    if (null != j8) {
      ...
      if (U9 = C3, h6(s4, C3, g6, p5), w8 = m5, I5 = T7, "end" !== e8) {
        ...
        }, z6({ forceUpdate: false }), null == f8 && (f8 = l3(() => i10.options.effectiveEnabled, () => z6 == null ? void 0 : z6({ forceUpdate: true })));
      }
    }
    return "end" === e8 && T6(), n5;
...
//# sourceMappingURL=chunk-DILO6GZU.js.map
