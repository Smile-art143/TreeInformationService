...
import {
  ...
  n as n7,
  r as r2
} from "./chunk-O4YMVU5A.js";
import {
  p as p8
} from "./chunk-FYAJ6THT.js";
import {
  i as i4,
  p as p7
} from "./chunk-ZRSU3QHB.js";
import {
  a as a4,
  f as f5
} from "./chunk-M63PASRK.js";
import {
  t as t3
...
import {
  u as u3
} from "./chunk-OR2CSZGC.js";
import {
  f as f4
} from "./chunk-YYMK4UHI.js";
import {
  W as W2
} from "./chunk-5HO2SWP4.js";
import {
  s as s3,
  t as t2
...
function k(e7, t7) {
  var _a, _b, _c;
  if (!((_a = e7 == null ? void 0 : e7.queryResult) == null ? void 0 : _a.featureResult)) return t7;
  ...
  for (const s8 of e7.queryResult.featureResult.features) {
    ...
    if (((_c = (_b = s8.compressedGeometry) == null ? void 0 : _b.coords) == null ? void 0 : _c.length) > 0) {
...
var o5 = class _o {
  ...
  writeToStore(o9, n12, p13) {
    ...
    return o9.forEach((o10) => {
      if (!(o10 == null ? void 0 : o10.id)) return;
      ...
      if (p13 && o10.properties[p13] && (c6 = ut(o10.properties[p13])), "originId" in o10 && "destinationId" in o10 && (o10.properties[I] = o10.originId, o10.properties[t4] = o10.destinationId), o10.properties[n12] = o10.id, o10.id && this._featureLookup.has(o10.id) && this._featureLookup.get(o10.id).attributes) {
        ...
        p13 && o10.properties[p13] && (i10[p13] = f3(o10.properties[p13])), u9 = new s2(c6 ? JSON.parse(JSON.stringify(c6)) : (t7 == null ? void 0 : t7.geometry) ? JSON.parse(JSON.stringify(t7.geometry)) : null, i10, null, o10.properties[n12]);
...
var n9 = null;
function r4() {
  return e5 || (e5 = import("./lclayout-V5XXDTBS.js").then((t7) => t7.l).then(({ default: e7 }) => e7({ locateFile: (e8) => n(`esri/libs/linkchartlayout/${e8}`) })).then((t7) => {
    s6(t7);
  }), e5);
}
function s6(t7) {
...
function d5(o9, e7) {
  ...
  if ((_a = e7.dataModel) == null ? void 0 : _a.relationshipTypes) for (const r7 of e7.dataModel.relationshipTypes) r7.name && t7.set(r7.name, []);
  for (const r7 of o9) t7.has(r7.typeName) && ((_b = t7.get(r7.typeName)) == null ? void 0 : _b.push(r7.id));
  return t7;
}
async function g4(o9, e7, t7) {
  ...
  const a9 = s8.join(" UNION "), l12 = new p8({ openCypherQuery: a9, bindParameters: i10 }), m7 = (await ie(e7, l12, t7 == null ? void 0 : t7.requestOptions)).resultRowsStream.getReader();
  for (; ; ) {
...
var N3 = class extends b {
  constructor(e7) {
    ...
    const t7 = /* @__PURE__ */ new Map();
    (_a = e7.knowledgeGraph.dataModel.entityTypes) == null ? void 0 : _a.forEach((i10) => {
      var _a2, _b2;
      i10.name && (t7.set(i10.name, "entity"), this._processingCacheUpdatesLookup.set(i10.name, []), e7.inclusionModeDefinition && !((_a2 = e7.inclusionModeDefinition) == null ? void 0 : _a2.generateAllSublayers) || this.entityTypeNames.add(i10.name), (_b2 = i10.properties) == null ? void 0 : _b2.forEach((e8) => {
    ...
    }), (_b = e7.knowledgeGraph.dataModel.relationshipTypes) == null ? void 0 : _b.forEach((i10) => {
      var _a2, _b2;
      i10.name && (t7.set(i10.name, "relationship"), this._processingCacheUpdatesLookup.set(i10.name, []), e7.inclusionModeDefinition && !((_a2 = e7.inclusionModeDefinition) == null ? void 0 : _a2.generateAllSublayers) || this.relationshipTypeNames.add(i10.name), (_b2 = i10.properties) == null ? void 0 : _b2.forEach((e8) => {
        e8.geometryType && "esriGeometryNull" !== e8.geometryType && this.geographicLookup.set(i10.name, { name: e8.name ?? "", geometryType: e8.geometryType });
      }));
    }), (_c = e7.inclusionModeDefinition) == null ? void 0 : _c.namedTypeDefinitions.forEach((i10, s8) => {
      var _a2, _b2;
      if ("entity" === t7.get(s8)) this.entityTypeNames.add(s8);
      else {
        if ("relationship" !== t7.get(s8)) return i.getLogger(this).warn(`A named type, ${s8}, was in the inclusion list that wasn't in the data model and will be removed`), void ((_a2 = e7.inclusionModeDefinition) == null ? void 0 : _a2.namedTypeDefinitions.delete(s8));
        this.relationshipTypeNames.add(s8);
      }
      const a9 = /* @__PURE__ */ new Map();
      (_b2 = i10.members) == null ? void 0 : _b2.forEach((e8) => {
  ...
  async getData(e7, t7, i10) {
    ...
    if (n12 = e7 || new b2({ where: "1=1", outFields: ["*"] }), "link-chart" === t7.parentCompositeLayer.type) {
      ...
      const s8 = this.sublayerCaches.has(t7.objectType.name ?? "") ? Array.from((_b = this.sublayerCaches.get(t7.objectType.name)) == null ? void 0 : _b.values()) : [], a9 = [];
  ...
  async getConnectedRecordIds(e7, t7, i10) {
    ...
    if (t7 && 0 !== (t7 == null ? void 0 : t7.length)) {
    ...
    for (const [m7, l12] of s8) {
      const e8 = `${m7}_ids`;
      a9[e8] = l12, t7 && 0 !== (t7 == null ? void 0 : t7.length) ? r7.push(`MATCH (n:${m7}) WHERE id(n) IN $${e8} WITH n MATCH (n)-[r:${o9}]-(m) RETURN id(r), type(r), id(m), labels(m)[0]`) : r7.push(`MATCH (n:${m7}) WHERE id(n) IN $${e8} WITH n MATCH (n)-[r]-(m) RETURN id(r), type(r), id(m), labels(m)[0]`);
    }
    if (!r7.length) return n12;
    const p13 = r7.join(" UNION "), d7 = (await ie(this.knowledgeGraph, new p8({ openCypherQuery: p13, bindParameters: a9 }), { signal: i10 == null ? void 0 : i10.signal })).resultRowsStream.getReader();
    for (; ; ) {
  ...
  async getRelationshipsBetweenNodes(e7, t7, i10) {
    ...
    const a9 = s8.join(" UNION "), r7 = [], p13 = (await ie(this.knowledgeGraph, new p8({ openCypherQuery: a9, bindParameters: o9 }), { signal: i10 == null ? void 0 : i10.signal })).resultRowsStream.getReader();
    for (; ; ) {
  ...
  async getRelationshipsFromNodes(e7, t7, i10, n12) {
    ...
    const r7 = a9.join(" UNION "), p13 = /* @__PURE__ */ new Map(), d7 = (await ie(this.knowledgeGraph, new p8({ openCypherQuery: r7, bindParameters: s8 }), { signal: n12 == null ? void 0 : n12.signal })).resultRowsStream.getReader();
    for (; ; ) {
      const { done: e8, value: t8 } = await d7.read();
      if (e8) break;
      for (let i11 = 0; i11 < t8.length; i11++) {
  ...
  async refreshCacheContent(e7, t7, n12, a9 = true, r7) {
    ...
    (_a = this.knowledgeGraph.dataModel.entityTypes) == null ? void 0 : _a.forEach((e8) => {
      ...
      var _a2;
      if (this.memberIdTypeLookup.has(e8)) for (const t8 of this.memberIdTypeLookup.get(e8)) m7.has(t8) ? (_a2 = m7.get(t8)) == null ? void 0 : _a2.push(e8) : m7.set(t8, [e8]);
    }) : (_d = (_c = this.inclusionModeDefinition) == null ? void 0 : _c.namedTypeDefinitions) == null ? void 0 : _d.forEach((e8, t8) => {
      e8.useAllData ? m7.set(t8, null) : e8.members && e8.members.forEach((e9) => {
        var _a2;
        m7.has(t8) && null !== m7.get(t8) ? (_a2 = m7.get(t8)) == null ? void 0 : _a2.push(e9.id) : m7.set(t8, [e9.id]);
      });
    }) : ((_e2 = this.knowledgeGraph.dataModel.entityTypes) == null ? void 0 : _e2.forEach((e8) => {
    ...
    for (const [s8, h3] of m7) {
      const e8 = new Set(h3), m8 = new Promise((d8, m9) => {
        const c6 = async () => {
          var _a2, _b2, _c2, _d2, _e3, _f2, _g2, _h2, _i;
          const d9 = /* @__PURE__ */ new Set(), m10 = [];
          let c7, u9 = "", f10 = false;
          if (t7 || ((_b2 = (_a2 = l12.get(s8)) == null ? void 0 : _a2.properties) == null ? void 0 : _b2.forEach((e9) => {
            e9.name && d9.add(e9.name);
          })), n12 && this.geographicLookup.has(s8)) {
            const e9 = (_c2 = this.geographicLookup.get(s8)) == null ? void 0 : _c2.name;
            e9 && d9.add(e9);
          }
          ...
          const g5 = (await ie(this.knowledgeGraph, c7, { signal: r7 == null ? void 0 : r7.signal })).resultRowsStream.getReader();
          for (; ; ) {
            ...
            const r8 = p13.writeToStore(n13, _2, (_d2 = this.geographicLookup.get(s8)) == null ? void 0 : _d2.name);
            this.sublayerCaches.has(s8) || this.sublayerCaches.set(s8, /* @__PURE__ */ new Map()), a9 && !((_e3 = this.inclusionModeDefinition) == null ? void 0 : _e3.namedTypeDefinitions.has(s8)) && ((_f2 = this.inclusionModeDefinition) == null ? void 0 : _f2.namedTypeDefinitions.set(s8, { useAllData: false, members: /* @__PURE__ */ new Map() })), a9 && !((_g2 = this.inclusionModeDefinition) == null ? void 0 : _g2.namedTypeDefinitions.get(s8).members) && (this.inclusionModeDefinition.namedTypeDefinitions.get(s8).members = /* @__PURE__ */ new Map());
            const d10 = this.sublayerCaches.get(s8);
            r8.forEach((e9) => {
              var _a3, _b3;
              d10 == null ? void 0 : d10.set(e9.attributes[_2], e9), a9 && !((_a3 = this.inclusionModeDefinition) == null ? void 0 : _a3.namedTypeDefinitions.get(s8).members.has(e9.attributes[_2])) && ((_b3 = this.inclusionModeDefinition) == null ? void 0 : _b3.namedTypeDefinitions.get(s8).members.set(e9.attributes[_2], { id: e9.attributes[_2] }), e(this.memberIdTypeLookup, e9.attributes[_2], () => /* @__PURE__ */ new Set()).add(s8));
            });
          }
          const b6 = (_h2 = this.inclusionModeDefinition) == null ? void 0 : _h2.namedTypeDefinitions.get(s8);
          if (b6) for (const t8 of e8) (_i = b6.members) == null ? void 0 : _i.delete(t8);
        };
        c6().then(() => {
          d8(null);
        }).catch((e9) => {
      ...
      d7.push(m8), (_g = this._processingCacheUpdatesLookup.get(s8)) == null ? void 0 : _g.push(m8);
    }
    if (await Promise.all(d7), (_h = r7 == null ? void 0 : r7.signal) == null ? void 0 : _h.aborted) throw u();
  }
  removeFromLayer(e7) {
    var _a, _b, _c;
    const t7 = /* @__PURE__ */ new Set(), i10 = new Set(e7.map((e8) => e8.id));
    for (const n12 of e7) t7.add(n12.typeName), 1 === ((_a = this.memberIdTypeLookup.get(n12.id)) == null ? void 0 : _a.size) ? this.memberIdTypeLookup.delete(n12.id) : (_b = this.memberIdTypeLookup.get(n12.id)) == null ? void 0 : _b.delete(n12.typeName), (_c = this.inclusionModeDefinition) == null ? void 0 : _c.namedTypeDefinitions.forEach((e8, t8) => {
      var _a2;
      t8 === n12.typeName && ((_a2 = e8.members) == null ? void 0 : _a2.has(n12.id)) && e8.members.delete(n12.id);
    });
    t7.forEach((e8) => {
      var _a2;
      (_a2 = this.sublayerCaches.get(e8)) == null ? void 0 : _a2.forEach((t8, n12) => {
        var _a3;
        i10.has(n12) && ((_a3 = this.sublayerCaches.get(e8)) == null ? void 0 : _a3.delete(n12));
      });
    });
  }
  async retrieveDataFromService(e7, t7, n12) {
    ...
    let p13, u9 = "", f10 = [];
    const g5 = "relationship" === t7.graphType, b6 = (_c = (_b = (_a = this.inclusionModeDefinition) == null ? void 0 : _a.namedTypeDefinitions) == null ? void 0 : _b.get(t7.objectType.name)) == null ? void 0 : _c.useAllData, E7 = t7.parentCompositeLayer.sublayerIdsCache.get(t7.objectType.name);
    let N5 = !b6 && E7 ? Array.from(E7).sort() : null;
    if ((_f = (_e2 = (_d = this.inclusionModeDefinition) == null ? void 0 : _d.namedTypeDefinitions) == null ? void 0 : _e2.get(t7.objectType.name)) == null ? void 0 : _f.useAllData) ((_i = (_h = (_g = this.inclusionModeDefinition) == null ? void 0 : _g.namedTypeDefinitions) == null ? void 0 : _h.get(t7.objectType.name)) == null ? void 0 : _i.useAllData) && null != e7.objectIds && (N5 = e7.objectIds);
    ...
    if (null != e7.geometry) {
      ...
      let o10;
      const y7 = t7.parentCompositeLayer.dataManager.knowledgeGraph.serviceDefinition, f11 = y7 == null ? void 0 : y7.spatialReference, b7 = (_n = y7 == null ? void 0 : y7.serviceCapabilities) == null ? void 0 : _n.geometryCapabilities;
      let T4 = b7 == null ? void 0 : b7.geometryMaxBoundingRectangleSizeX, w3 = b7 == null ? void 0 : b7.geometryMaxBoundingRectangleSizeY;
      if ("point" === n13.type) {
        let e8 = n13;
        ((_o = e8.spatialReference) == null ? void 0 : _o.isWGS84) || (await N2(e8.spatialReference, N), e8 = W(e8, N)), o10 = new z({ spatialReference: N, xmin: e8.x - 1e-4, ymin: e8.y - 1e-4, xmax: e8.x + 1e-4, ymax: e8.y + 1e-4 });
      } else ((_p = n13 == null ? void 0 : n13.extent) == null ? void 0 : _p.spatialReference) && !((_q = n13.spatialReference) == null ? void 0 : _q.isWGS84) ? (await N2(n13.extent.spatialReference, N), o10 = W(n13.extent, N)) : o10 = n13.extent;
      if (T4 && w3 && f11) {
        if (4326 !== f11.wkid) {
    ...
    for (; ; ) {
      ...
      f10 = f10.concat(o9.writeToStore(n13, _2, (_r = t7.parentCompositeLayer.dataManager.geographicLookup.get(t7.objectType.name)) == null ? void 0 : _r.name));
    }
    return f10;
  }
  _isEndEntitySpatial(e7, t7, i10) {
    ...
    for (const n12 of e7 ?? []) if (this.entityTypeNames.has(n12)) {
      const e8 = this.geographicLookup.get(n12), o9 = e8 && ((_a = this.sublayerCaches.get(n12)) == null ? void 0 : _a.get(t7.attributes[i10]));
      if (e8 && (o9 == null ? void 0 : o9.attributes[e8.name])) return true;
    }
    return false;
  }
  _getNamedTypeIdMapFromNodeIds(e7) {
    ...
    return e7.forEach((e8) => {
      ...
      if (this.memberIdTypeLookup.has(e8)) for (const i10 of this.memberIdTypeLookup.get(e8)) {
        ...
        t7.has(i10) ? (_a = t7.get(i10)) == null ? void 0 : _a.push(e8) : t7.set(i10, [e8]);
      }
    }), t7;
  }
};
...
var j2 = { initializeLayersFromClientData: async (e7, t7, s8) => {
  if (t7 || (t7 = [...e7.layers, ...e7.tables].map((e8) => e8.graphTypeName)), 0 === (t7 == null ? void 0 : t7.length)) return;
  const o9 = /* @__PURE__ */ new Map();
  for (const a9 of t7) o9.set(a9, S3(e7, a9));
  const r7 = await le(e7.dataManager.knowledgeGraph, Array.from(o9.values()), { requestOptions: { signal: s8 == null ? void 0 : s8.signal } });
...
var Ne = class extends p12(a3(f5(c(p2(p6(l5(t(f2(l(b3)))))))))) {
  ...
  get geometryType() {
    ...
    const e7 = (_c = this.parentCompositeLayer) == null ? void 0 : _c.dataManager.geographicLookup.get((_b = this.objectType) == null ? void 0 : _b.name), t7 = e7 == null ? void 0 : e7.geometryType;
    return t7 && "esriGeometryNull" !== t7 ? y2.fromJSON(t7) : null;
  }
  get geometryFieldName() {
    var _a, _b, _c;
    if ("link-chart" === ((_a = this.parentCompositeLayer) == null ? void 0 : _a.type)) return S;
  ...
  get hasM() {
    var _a, _b, _c, _d;
    const e7 = (_b = this.parentCompositeLayer) == null ? void 0 : _b.dataManager.geographicLookup.get((_a = this.objectType) == null ? void 0 : _a.name), t7 = e7 == null ? void 0 : e7.name, r7 = t7 ? (_d = (_c = this.objectType) == null ? void 0 : _c.properties) == null ? void 0 : _d[t7] : null;
  ...
  get renderer() {
    ...
    const e7 = (_c = (_b = (_a = this.parentCompositeLayer) == null ? void 0 : _a.dataManager) == null ? void 0 : _b.knowledgeGraph) == null ? void 0 : _c.dataModel, t7 = [...(e7 == null ? void 0 : e7.entityTypes) ?? [], ...(e7 == null ? void 0 : e7.relationshipTypes) ?? []].map((e8) => e8.name).indexOf(this.graphTypeName), r7 = R(t7);
  ...
  async queryFeatures(e7, t7) {
    await this.load();
    const { resolvedQuery: r7, queryEngine: i10 } = await this._setupQueryObjects(e7), o9 = this.graphicOrigin, s8 = g2.fromJSON(await i10.executeQuery(r7.toJSON(), t7 == null ? void 0 : t7.signal));
  ...
  async queryFeaturesJSON(e7, t7) {
    ...
    return await i10.executeQuery(r7.toJSON(), t7 == null ? void 0 : t7.signal);
  }
  async queryFeatureCount(e7, t7) {
    await this.load();
    const { resolvedQuery: r7, queryEngine: i10 } = await this._setupQueryObjects(e7);
    return i10.executeQueryForCount(r7.toJSON(), t7 == null ? void 0 : t7.signal);
  }
  async queryExtent(e7 = {}, t7) {
    var _a, _b, _c, _d;
    await this.load();
    const r7 = { ...e7, returnGeometry: true }, { resolvedQuery: i10, queryEngine: o9 } = await this._setupQueryObjects(r7), s8 = await o9.executeQueryForExtent(i10.toJSON(), t7 == null ? void 0 : t7.signal);
    let n12;
    return n12 = null != ((_a = s8.extent) == null ? void 0 : _a.xmin) && null != ((_b = s8.extent) == null ? void 0 : _b.xmax) && null != ((_c = s8.extent) == null ? void 0 : _c.ymin) && null != ((_d = s8.extent) == null ? void 0 : _d.ymax) ? new z(s8.extent) : new z(), { count: s8.count, extent: n12 };
  }
  async queryObjectIds(e7, t7) {
    ...
    return await i10.executeQueryForIds(r7.toJSON(), t7 == null ? void 0 : t7.signal);
  }
  async applyEdits(e7) {
    var _a;
    ...
    t7.options = { cascadeDelete: true, cascadeProvenanceDelete: !!((_a = this.parent) == null ? void 0 : _a.knowledgeGraph.serviceDefinition.supportsProvenance) || void 0 };
  ...
  async _setupQueryObjects(e7, t7) {
    ...
    if (i10 && !((_a = i10.spatialReference) == null ? void 0 : _a.isWGS84) && (await N2(i10.spatialReference, N), r7.geometry = W(i10 instanceof P || i10 instanceof y || i10 instanceof _ ? i10 : i10.extent, N)), "link-chart" === this.parentCompositeLayer.type && this._cachedQueryEngine) return { resolvedQuery: r7, queryEngine: this._cachedQueryEngine };
...
function _e(e7, t7, r7) {
  ...
  try {
    for (const t8 of e7) for (const [e8, r8] of i10) t8.labelExpression = (_a = t8.labelExpression) == null ? void 0 : _a.replaceAll(e8, r8), ((_b = t8.labelExpressionInfo) == null ? void 0 : _b.expression) && (t8.labelExpressionInfo.expression = t8.labelExpressionInfo.expression.replaceAll(e8, r8));
  } catch (s8) {
...
//# sourceMappingURL=chunk-MU64LPOA.js.map
