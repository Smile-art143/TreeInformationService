...
async function g2(e2, t = {}, o) {
  ...
  o ?? (o = n.geometryType || O((_a = e2 == null ? void 0 : e2.data) == null ? void 0 : _a.symbol));
...
async function u2(i, o = {}) {
  var _a, _b;
  const { node: l2, opacity: s2, symbolConfig: m2 } = o, h2 = null != m2 && "object" == typeof m2 && "isSquareFill" in m2 && m2.isSquareFill, c2 = o.cimOptions || o, g3 = c2.geometryType || O((_a = i == null ? void 0 : i.data) == null ? void 0 : _a.symbol), u3 = await y(i, o, g3), { feature: d, fieldMap: f } = c2, p = (o == null ? void 0 : o.geometry) || h2 || "esriGeometryPolygon" !== g3 ? "preview" : "legend";
  let w = u3;
  const b = u3;
  if ((o == null ? void 0 : o.geometry) && ("esriGeometryPolygon" === g3 || "esriGeometryPolyline" === g3)) {
    const i2 = 200;
  ...
  const M = await a.rasterizeCIMSymbolAsync(i, d, w, p, f, g3, null, c2.viewParams, c2.allowScalingUp, (_b = o == null ? void 0 : o.geometry) == null ? void 0 : _b.toJSON());
  if (!M) return null;
...
//# sourceMappingURL=chunk-SNFBMSCC.js.map
