...
function c3(e3, r2) {
  var _a;
  const s7 = (_a = e3.drawingInfo) == null ? void 0 : _a.renderer, o5 = s7 ? i2(s7, e3, r2) : null;
  if ("simple" !== (o5 == null ? void 0 : o5.type)) return;
...
function k2(e3, t3) {
  ...
  return "object" != typeof r2 && (r2 = e3.json.write = {}), r2.ignoreOrigin = true, (t3 == null ? void 0 : t3.spatialOnly) && (r2.layerContainerTypes = a3), e3;
}
function B2(e3) {
  const t3 = { write: { ignoreOrigin: true } };
  return (e3 == null ? void 0 : e3.name) && (t3.name = e3.name), "object" == typeof t3.write && ((e3 == null ? void 0 : e3.spatialOnly) && (t3.write.layerContainerTypes = a3), (e3 == null ? void 0 : e3.target) && (t3.write.target = e3.target)), t3;
}
function H2(e3) {
...
function W(e3, t3) {
  return !!t3 && ("unique-value" === (e3 == null ? void 0 : e3.type) && null != e3.field && e3.field.toLowerCase() === t3.toLowerCase() && !e3.field2 && !e3.field3 && !e3.valueExpression);
}
function z(e3, t3) {
  var _a;
...
var X = class extends l3(l4(s3(u2))) {
  ...
  get _titleCreator() {
    ...
    return u(e3), new h({ fieldsIndex: this.fieldsIndex, objectIdField: this.objectIdField, displayField: ((_a = this.parent) == null ? void 0 : _a.displayField) ?? "", fields: this.fields, effectivePopupTemplate: this.popupTemplate ?? this.defaultPopupTemplate });
  }
  get capabilities() {
    var _a;
  ...
  writeFieldOverrides(e3, t3, r2) {
    ...
    if (i4) {
      ...
      i4.forEach(({ name: t4, alias: r3, editable: i5, visible: n4 }) => {
        var _a;
        if (!n4) return;
        const s7 = (_a = o5 == null ? void 0 : o5.fields) == null ? void 0 : _a.find((e5) => e5.name === t4);
        if (!s7) return;
        const a8 = { name: t4 };
        let p5 = false;
    ...
    (l10 == null ? void 0 : l10.length) && e(r2, l10, t3);
  }
  get fields() {
    const { parent: e3, fieldOverrides: t3, subtypeCode: r2 } = this, i4 = e3 == null ? void 0 : e3.fields;
    if (!e3 || !(i4 == null ? void 0 : i4.length)) return null;
    const { subtypes: o5, subtypeField: n4 } = e3, l10 = o5 == null ? void 0 : o5.find((e4) => e4.code === r2), s7 = l10 == null ? void 0 : l10.defaultValues, a8 = l10 == null ? void 0 : l10.domains, p5 = [];
    for (const d3 of i4) {
      const e4 = d3.clone(), { name: i5 } = e4, o6 = t3 == null ? void 0 : t3.find((e5) => e5.name === i5);
      if (e4.visible = !(t3 == null ? void 0 : t3.length) || !!o6, o6) {
        const { alias: t4, editable: r3 } = o6;
        t4 && (e4.alias = t4), false === r3 && (e4.editable = false);
      }
      const l11 = (s7 == null ? void 0 : s7[i5]) ?? null;
      e4.defaultValue = i5 === n4 ? r2 : l11;
      const u8 = (a8 == null ? void 0 : a8[i5]) ?? null;
  ...
  get objectIdField() {
    var _a;
    return this.parent || i.getLogger(this).error(ee("objectIdField")), (_a = this.parent) == null ? void 0 : _a.objectIdField;
  }
  ...
  readRendererFromService(e3, t3, r2) {
    ...
    const i4 = (_a = t3.drawingInfo) == null ? void 0 : _a.renderer, o5 = i2(i4, t3, r2);
    let n4;
    const { subtypeCode: l10 } = this;
    if (null != l10 && W(o5, t3.subtypeField)) {
      const e4 = (_b = o5.uniqueValueInfos) == null ? void 0 : _b.find(({ value: e5 }) => (e5 = "number" == typeof e5 ? String(e5) : e5) === String(l10));
      e4 && (n4 = new p3({ symbol: e4.symbol }));
    } else "simple" !== (o5 == null ? void 0 : o5.type) || ((_c = o5.visualVariables) == null ? void 0 : _c.length) || (n4 = o5);
    return n4;
  }
  ...
  get spatialReference() {
    var _a;
    return ((_a = this.parent) == null ? void 0 : _a.spatialReference) ?? f2.WGS84;
  }
  get subtypeField() {
    var _a;
  ...
  getFieldDomain(e3, t3) {
    if (!(t3 == null ? void 0 : t3.excludeImpliedDomains) && this.parent) {
...
var ue = class extends V(a4(F2(p2(l7(t(f3(l6(b2(j2(l3(s5(o3(l4(b4)))))))))))))) {
  constructor(...e3) {
    super(...e3), this._sublayerLookup = /* @__PURE__ */ new Map(), this.fields = null, this.fieldsIndex = null, this.outFields = null, this.sublayers = new (O.ofType(X))(), this.useUniqueColorsForSublayers = true, this.supportedSourceTypes = /* @__PURE__ */ new Set(["Feature Layer", "Table"]), this.timeInfo = null, this.title = "Layer", this.type = "subtype-group", this._debouncedSaveOperations = L(async (e4, t3, r2) => {
      const { save: s7, saveAs: i4 } = await import("./featureLayerUtils-CK25ENUY.js");
      switch (e4) {
        case 0:
          return s7(this, t3);
        case 1:
  ...
  async createGraphicsSource(e3) {
    const { default: t3 } = await p(import("./FeatureLayerSource-ANVU4O56.js"), e3);
  ...
  getFieldDomain(e3, t3) {
    var _a;
    if (!(t3 == null ? void 0 : t3.excludeImpliedDomains)) {
      const t4 = U2(this, e3);
      if (t4) return t4;
    }
    const r2 = Q(this, t3 == null ? void 0 : t3.feature);
    if (r2) {
      const t4 = (_a = r2.domains) == null ? void 0 : _a[e3];
      return "inherited" === (t4 == null ? void 0 : t4.type) ? this._getLayerDomain(e3) : t4;
    }
    return this._getLayerDomain(e3);
  }
  loadAll() {
  ...
  async queryFeatures(e3, t3) {
    ...
    if (o5 == null ? void 0 : o5.features) for (const a8 of o5.features) {
      const e4 = this.findSublayerForFeature(a8);
      a8.origin = e4 == null ? void 0 : e4.graphicOrigin, a8.layer = a8.sourceLayer = this.findSublayerForFeature(a8);
    }
    return o5;
  }
  async queryObjectIds(e3, t3) {
  ...
  write(e3, t3) {
    ...
    if (this.isTable) {
      if ("web-scene" === r2 || "web-map" === r2 && "tables" !== i4) return o5 == null ? void 0 : o5.push(ie(this, "using a table source cannot be written to web scenes and web maps")), null;
    } else if (this.loaded && "web-map" === r2 && "tables" === i4) return o5 == null ? void 0 : o5.push(ie(this, "using a non-table source cannot be written to tables in web maps")), null;
    return ((_a = this.sublayers) == null ? void 0 : _a.length) ? super.write(e3, t3) : (o5 == null ? void 0 : o5.push(new s("web-document-write:invalid-property", `Layer (${this.title}, ${this.id}) of type '${this.declaredClass}' has invalid value for 'sublayers' property. 'sublayers' collection should contain at least one sublayer`, { layer: this })), null);
  }
  ...
  _initLayerProperties(e3) {
    ...
    if (t3 && (this.sourceJSON = t3, this.read(t3, { origin: "service", url: this.parsedUrl })), !((_a = this.subtypes) == null ? void 0 : _a.length)) throw new s("subtype-grouplayer:missing-subtypes", "SubtypeGroupLayer must be created using a layer with subtypes");
...
__decorate([m({ readOnly: true })], ue.prototype, "createQueryVersion", null), __decorate([m({ readOnly: true })], ue.prototype, "editingEnabled", null), __decorate([m({ readOnly: true })], ue.prototype, "effectiveEditingEnabled", null), __decorate([m({ ...ae.fields, readOnly: true, json: { origins: { service: { read: true } }, read: false } })], ue.prototype, "fields", void 0), __decorate([m(ae.fieldsIndex)], ue.prototype, "fieldsIndex", void 0), __decorate([m(u5)], ue.prototype, "id", void 0), __decorate([m({ type: ["show", "hide", "hide-children"], json: { origins: { "portal-item": { read: false, write: false } } } })], ue.prototype, "listMode", void 0), __decorate([m({ type: ["SubtypeGroupLayer", "SubtypeGroupTable"], json: { ...ne(), origins: { "web-document": ne(), "portal-item": ne() } } })], ue.prototype, "operationalLayerType", null), __decorate([m(ae.outFields)], ue.prototype, "outFields", void 0), __decorate([m({ clonable: false })], ue.prototype, "source", null), __decorate([m({ type: O.ofType(X), json: { origins: { service: { read: { source: "subtypes", reader(e3, t3, s7) {
  ...
  var _a, _b;
  let i4;
  return "SubtypeGroupLayer" === t3.layerType && ((_a = t3.layers) == null ? void 0 : _a.length) ? i4 = oe(t3.layers, s7) : "SubtypeGroupTable" === t3.layerType && ((_b = t3.tables) == null ? void 0 : _b.length) && (i4 = oe(t3.tables, s7)), new (O.ofType(X))(i4);
...
//# sourceMappingURL=SubtypeGroupLayer-TYWBIMCG.js.map
