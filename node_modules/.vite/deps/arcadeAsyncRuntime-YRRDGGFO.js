...
import {
  B as B2
} from "./chunk-DIRCEWM2.js";
import "./chunk-EACLCMZP.js";
import "./chunk-BQARFEUH.js";
  ...
  try {
    for (null !== t3.init && ("VariableDeclaration" === t3.init.type ? await de2(e3, t3.init) : await we(e3, t3.init)); ; ) {
      if (null !== t3.test) {
        ...
        if (true === ((_a = e3.abortSignal) == null ? void 0 : _a.aborted)) throw new n(e3, "Cancelled", t3);
        if (false === n5) break;
...
async function Be(e3, t3) {
  ...
  let a2;
  return ((_a = r3._moduleSingletons) == null ? void 0 : _a.has(o3.uri)) ? a2 = r3._moduleSingletons.get(o3.uri) : (a2 = await fe.load(e3, o3.syntax), (_b = r3._moduleSingletons) == null ? void 0 : _b.set(o3.uri, a2)), n4.scope[n4.id] = { value: a2 }, P;
}
...
function nt(n4, a2) {
  const i5 = new Set(Object.keys((a2 == null ? void 0 : a2.vars) || {}).map((t3) => r(t3))), s5 = new Set(Object.keys((a2 == null ? void 0 : a2.customfunctions) || {}).map((t3) => r(t3))), { globals: c2, exports: l } = i4(n4);
  return async (e3) => {
...
//# sourceMappingURL=arcadeAsyncRuntime-YRRDGGFO.js.map
