...
var r5 = class {
  constructor(t2, e2, i2, s3) {
    this.text = t2, this._alignment = e2, this._parameters = i2, this._maxSize = s3, this._textWidths = [], this._lineWidths = [], this._renderPixelRatio = null, this._metricsCached = null, this.key = `${t2}--${this._parameters.key}-${this._alignment}`, this._lines = t2.replaceAll(" ", " ").split(/\r?\n/);
  }
  get displayWidth() {
...
//# sourceMappingURL=chunk-VCX2EXIQ.js.map
