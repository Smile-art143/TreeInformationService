...
function M({ fieldInfo: e2, graphic: t }) {
  return !(!(e2 == null ? void 0 : e2.fieldName) || U2(e2.fieldName) || he(e2.fieldName) || (t == null ? void 0 : t.isAggregate) || (t == null ? void 0 : t.popupTemplate));
}
function k({ expressionInfos: e2, fieldInfo: t, graphic: n, isContentFieldInfos: r2, layer: i2 }) {
  if (!(t == null ? void 0 : t.fieldName)) return null;
...
function R({ fieldInfo: e2, isContentFieldInfos: t, layer: n }) {
  var _a;
  if (!(e2 == null ? void 0 : e2.fieldName)) return null;
  if (I(n)) {
    const r2 = n.popupTemplate || n.fieldConfigurations ? (_a = n.getFieldConfiguration(e2.fieldName)) == null ? void 0 : _a.fieldFormat : c2(e2, n.getField(e2.fieldName));
...
function $(e2, t) {
  ...
  return `{${(n == null ? void 0 : n.fieldName) || e2}}`;
}
function D(e2) {
...
function K(e2, t) {
  var _a;
  const n = "number" === ((_a = t == null ? void 0 : t.fieldFormat) == null ? void 0 : _a.type) || (t == null ? void 0 : t.format) && null == t.format.dateFormat && (null != t.format.places || null != t.format.digitSeparator);
...
function ne(e2, t) {
  const { fieldInfos: n, fieldName: r2, graphic: l2, isContentFieldInfos: s2, layer: f, preventPlacesFormatting: c3, timeZone: y } = t, m = oe(n, r2), g = S(f, r2), I3 = I(f) && M({ fieldInfo: m, graphic: l2 }), b3 = I3 ? null : m == null ? void 0 : m.format, h3 = I3 ? R({ fieldInfo: m, layer: f, isContentFieldInfos: s2 }) : null, F2 = "number" === (h3 == null ? void 0 : h3.type);
  if (m && !qe(r2)) {
    const t2 = g == null ? void 0 : g.type, n2 = "date-time" === (h3 == null ? void 0 : h3.type), r3 = b3 == null ? void 0 : b3.dateFormat;
...
function oe(e2, t) {
  if ((e2 == null ? void 0 : e2.length) && t) return e2.find((e3) => {
    var _a;
    return ((_a = e3.fieldName) == null ? void 0 : _a.toLowerCase()) === t.toLowerCase();
  });
}
...
function fe(e2) {
  ...
  return n && t.push(...n), r2 && Array.isArray(r2) ? (r2.forEach((e3) => {
    if ("fields" === e3.type) {
      const n2 = e3 == null ? void 0 : e3.fieldInfos;
      n2 && t.push(...n2);
    }
  }), t) : t;
}
...
function pe(e2) {
  ...
  const c3 = (_a = a == null ? void 0 : a.fieldsIndex) == null ? void 0 : _a.get(r2);
...
function ye({ attributes: e2, fieldInfoMap: t, fieldInfos: n, graphic: r2, isContentFieldInfos: i2, layer: o, relatedInfos: a, timeZone: l2 }) {
  const u = {};
  return a == null ? void 0 : a.forEach((e3) => Te({ attributes: u, relatedInfo: e3, fieldInfoMap: t, fieldInfos: n, layer: o, timeZone: l2 })), e2 && Object.keys(e2).forEach((a2) => {
    const s2 = e2[a2];
...
async function me(e2, t) {
  ...
  if (!((_b = (_a = G(n)) == null ? void 0 : _a.operations) == null ? void 0 : _b.supportsQuery)) {
  ...
  s2.objectIds = o, s2.outFields = (i2 == null ? void 0 : i2.length) ? i2 : [n.objectIdField], s2.returnGeometry = !!a, s2.returnZ = !!a, s2.returnM = !!a, s2.outSpatialReference = l2;
  return (await n.queryFeatures(s2, t)).features[0];
}
async function ge(e2) {
  var _a;
  if (!((_a = e2.expressionInfos) == null ? void 0 : _a.length)) return false;
...
async function be({ graphic: e2, popupTemplate: t, layer: n, spatialReference: r2 }, i2) {
  ...
  null == ((_a = n.timeInfo) == null ? void 0 : _a.trackIdField) || u.has(n.timeInfo.trackIdField) || await Ie(t) && u.add(n.timeInfo.trackIdField);
...
function Te({ attributes: e2, relatedInfo: t, fieldInfoMap: n, fieldInfos: r2, layer: i2, timeZone: o }) {
  var _a, _b;
  e2 && t && ((_a = t.relatedFeatures) == null ? void 0 : _a.forEach((a) => we({ attributes: e2, graphic: a, relatedInfo: t, fieldInfoMap: n, fieldInfos: r2, layer: i2, timeZone: o })), (_b = t.relatedStatsFeatures) == null ? void 0 : _b.forEach((a) => we({ attributes: e2, graphic: a, relatedInfo: t, fieldInfoMap: n, fieldInfos: r2, layer: i2, timeZone: o })));
}
var Ne = (e2) => {
  if (!e2) return false;
...
var je = ({ layer: e2, method: t, query: n, definitionExpression: r2 }) => {
  var _a, _b;
  if (!((_b = (_a = e2.capabilities) == null ? void 0 : _a.query) == null ? void 0 : _b.supportsCacheHint) || "attachments" === t) return;
  const i2 = null != n.where ? n.where : null, o = null != n.geometry ? n.geometry : null;
  Ne(r2) || Ne(i2) || "extent" === (o == null ? void 0 : o.type) || "tile" === n.resultType || (n.cacheHint = true);
};
...
function ve(e2, t, n) {
  var _a, _b;
  return e2 && t && n ? "sublayer" === t.type ? qe2({ layers: (_a = t.layer) == null ? void 0 : _a.allSublayers, map: e2, relatedLayer: t, relationship: n }) || qe2({ layers: (_b = t.layer) == null ? void 0 : _b.subtables, map: e2, relatedLayer: t, relationship: n }) : qe2({ layers: e2.allLayers, map: e2, relatedLayer: t, relationship: n }) || qe2({ layers: e2.allTables, map: e2, relatedLayer: t, relationship: n }) : null;
}
function Le(e2, t) {
  var _a;
  return e2 && "utilityNetworks" in e2 && t ? (_a = e2.utilityNetworks) == null ? void 0 : _a.find((e3) => e3.isUtilityLayer(t)) : null;
}
function xe2(e2, t) {
  return e2 == null ? void 0 : e2.allTables.find((e3) => {
    var _a;
    return "feature" === e3.type && e3.layerId === t.id && e3.url === ((_a = t.layer) == null ? void 0 : _a.url);
  });
}
function qe2({ map: e2, relationship: t, relationship: { relatedTableId: n }, relatedLayer: r2, layers: i2 }) {
  ...
  for (const o of i2) {
    ...
    } else if (o !== r2 && ((_a = o.layer) == null ? void 0 : _a.url) === i3 && o.id === n) return o.isTable ? xe2(e2, o) : o;
  }
  return null;
}
...
//# sourceMappingURL=chunk-R67VL22F.js.map
