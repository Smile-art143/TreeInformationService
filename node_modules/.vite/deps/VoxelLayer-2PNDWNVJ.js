...
var u7 = class extends l2(n) {
  ...
  set colorStops(o6) {
    this._set("colorStops", n2(o6, this._get("colorStops"), O.ofType(l6)));
  }
  set opacityStops(o6) {
    this._set("opacityStops", n2(o6, this._get("opacityStops"), O.ofType(i5)));
  }
...
var f5 = class extends n {
  ...
  get timeStops() {
    ...
    if (s11.didParse) {
      if (e3.isRegular) {
        const t5 = ((_a = e3.regularSpacing) == null ? void 0 : _a.offset) ?? 0, n5 = ((_b = e3.regularSpacing) == null ? void 0 : _b.scale) || 1;
        for (let o6 = 0; o6 < e3.size; ++o6) {
          const e4 = t5 + n5 * o6;
          i6.push(i2(s11.reference, e4, s11.unit));
        }
      } else if (Array.isArray((_c = e3.irregularSpacing) == null ? void 0 : _c.values) && e3.irregularSpacing.values.length > 0) for (let t5 = 0; t5 < e3.irregularSpacing.values.length; ++t5) {
  ...
  computeVoxelSpaceLocation(e3) {
    ...
    if (!r4.isRegular && Array.isArray((_a = r4.irregularSpacing) == null ? void 0 : _a.values) && r4.irregularSpacing.values.length > 1) {
  ...
  computeLayerSpaceLocation(e3) {
    ...
    return s11.isRegular || Array.isArray((_a = s11.irregularSpacing) == null ? void 0 : _a.values) && (e3[2] < 0 ? i6[2] = s11.irregularSpacing.values[0] : e3[2] < s11.irregularSpacing.values.length ? i6[2] = s11.irregularSpacing.values[e3[2]] : i6[2] = s11.irregularSpacing.values[s11.irregularSpacing.values.length - 1], s11.isPositiveUp || (i6[2] *= -1)), new _({ x: i6[0], y: i6[1], z: i6[2], spatialReference: this.spatialReference });
  }
};
...
var m6 = p10 = class extends n {
  ...
  set slices(e3) {
    this._set("slices", n2(e3, this._get("slices"), O.ofType(m4)));
  }
  set dynamicSections(e3) {
    this._set("dynamicSections", n2(e3, this._get("dynamicSections"), O.ofType(m5)));
  }
  clone() {
...
var _3 = class extends _2(l3(b2(j(t(l(s5(o4(b3)))))))) {
  ...
  normalizeCtorArgs(e3) {
    return (e3 == null ? void 0 : e3.constantUpscaling) && (this.test = { constantUpscaling: true }, delete e3.constantUpscaling), e3;
  }
  set url(e3) {
  ...
  read(e3, t5) {
    super.read(e3, t5), "service" === (t5 == null ? void 0 : t5.origin) && this.version.major <= 3 && this.version.minor <= 0 && !this.getAtOrigin("popupTemplate", "service") && this.setAtOrigin("popupTemplate", this.createPopupTemplate(), "service");
  ...
  getConfiguration() {
    ...
    return e3.index && ((_b = this.index) == null ? void 0 : _b.isValid()) ? JSON.stringify(e3) : "";
  }
  getVariableStyle(e3) {
    let t5 = -1;
  ...
  get timeInfo() {
    ...
    if ("xyzt" !== (e3 == null ? void 0 : e3.volumeType)) return null;
    const t5 = e3.timeStops;
    if (!(t5 == null ? void 0 : t5.length)) return null;
  ...
  getColorForContinuousDataValue(e3, t5, i6) {
    ...
    if (null == o6 || "continuous" !== ((_a = o6.renderingFormat) == null ? void 0 : _a.continuity)) return null;
    ...
    return (n5 == null ? void 0 : n5.transferFunction) ? n5.transferFunction.getColorForContinuousDataValue(t5, i6) : null;
  }
  getSections() {
    const e3 = [];
...
//# sourceMappingURL=VoxelLayer-2PNDWNVJ.js.map
