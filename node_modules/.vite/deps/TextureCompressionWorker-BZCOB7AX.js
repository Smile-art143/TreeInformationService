...
function s() {
  return t ?? (t = (async () => {
    const s3 = await import("./basis_encoder-25N2W7SG.js"), t2 = await s3.default({ locateFile: (s4) => n(`esri/libs/basisu/${s4}`) });
...
function e() {
  return n2 ?? (n2 = (async () => {
    const e2 = await import("./dxt_encoder-LP252FPT.js");
...
async function h(e2) {
  ...
  try {
    if (e2.hasS3TC) {
      ...
      if (o == null ? void 0 : o.encode(t2, e2.width, e2.height, e2.preMultiplyAlpha, n3)) {
        const e3 = U(n3, true), t3 = [n3.buffer];
        return { result: new u((e3 == null ? void 0 : e3.internalFormat) ?? null, (e3 == null ? void 0 : e3.textureData) ?? null), transferList: t3 };
      }
    ...
    if (e2.hasETC) {
      if (i || await f(), e2.preMultiplyAlpha && !o && await d(), e2.preMultiplyAlpha) {
        ...
        o == null ? void 0 : o.premultiply(new Uint8Array(t2), e2.width, e2.height, n4), t2 = n4;
      }
      const n3 = p(t2, e2.width, e2.height, e2.hasMipmap), r2 = n3 ? m(n3) : null, a2 = ((_a = r2 == null ? void 0 : r2.compressedTexture) == null ? void 0 : _a.levels.map((e3) => e3.buffer)) || [];
      return { result: new u((r2 == null ? void 0 : r2.internalFormat) ?? null, (r2 == null ? void 0 : r2.compressedTexture) ?? null), transferList: a2 };
    }
    return { result: new u(null, null) };
  } finally {
...
async function f() {
  i || (i = await (l ?? (l = s())), l = null);
}
async function d() {
  o || (o = await (s2 ?? (s2 = e())), s2 = null);
}
...
//# sourceMappingURL=TextureCompressionWorker-BZCOB7AX.js.map
