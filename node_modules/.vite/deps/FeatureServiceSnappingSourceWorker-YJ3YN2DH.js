...
var j2 = class extends b {
  ...
  _initializeFetchExtent() {
    ...
    const e5 = d(async (e6) => {
      ...
      try {
        ...
        this.store.extent = z.fromJSON((_a = t2.data) == null ? void 0 : _a.extent);
      } catch (t2) {
  ...
  _createFeaturesQuery(e5 = null) {
    var _a;
    const t2 = this._createBaseQuery(e5), i5 = null != (e5 == null ? void 0 : e5.key) ? this.store.getAttributesForTile((_a = e5 == null ? void 0 : e5.key) == null ? void 0 : _a.id) : null, s3 = u(i2(this.outFields, i5 ?? /* @__PURE__ */ new Set()), this._mandatoryOutFields);
...
var m2 = class extends b {
  ...
  add(e5, t2) {
    ...
    const i5 = this.featureStore.upsertMany(t2), r3 = i5.map((e6) => new Set(Object.keys(e6.attributes))).reduce((e6, t3) => e(e6, t3), new Set(Object.keys(((_a = i5[0]) == null ? void 0 : _a.attributes) ?? []))), o4 = this._memoryLimitExceeded;
  ...
  _estimateRemoveTileMemoryReduction(e5) {
    ...
    for (const s3 of e5.objectIds) {
      if (1 === this._refCounts.get(s3)) {
        ...
        e6 && (t2 += ((_b = (_a = this.featureStore).estimateFeatureUsedMemory) == null ? void 0 : _b.call(_a, e6)) ?? 0);
      }
    }
    return t2;
  }
  ...
  _createTileTree(e5, t2) {
    ...
    return t2.updateTileInfo(s3, 1), this._tileBounds.forEachInBounds(e5.extent, (i5) => {
      var _a;
      const r3 = (_a = this._tiles.get(i5)) == null ? void 0 : _a.key;
...
var w2 = class extends l {
  ...
  async fetchCandidates(e5, t2) {
    ...
    const i5 = j3(e5, this._featureStore.hasZ), s3 = t2 == null ? void 0 : t2.signal, a4 = await this._queryEngine.executeQueryForSnapping(i5, s3);
    s(s3);
...
//# sourceMappingURL=FeatureServiceSnappingSourceWorker-YJ3YN2DH.js.map
