...
var A = class {
  ...
  async load(e, t = {}) {
    ...
    const i3 = [], [r] = await Promise.all([e.url ? this._fetch(t == null ? void 0 : t.signal) : null, this._checkProjection(e.spatialReference)]), n2 = I(r, { geometryType: e.geometryType }), o = e.fields || n2.fields || [], u2 = null != e.hasZ ? e.hasZ : n2.hasZ, l2 = n2.geometryType;
  ...
  async _applyEdits(e) {
    ...
    if ((t == null ? void 0 : t.length) && this._applyAddEdits(r, t), (s2 == null ? void 0 : s2.length) && this._applyUpdateEdits(r, s2), i3 == null ? void 0 : i3.length) {
  ...
  _applyUpdateEdits({ updateResults: e }, t) {
    ...
    for (const y of t) {
      const { attributes: t2, geometry: m } = y, f4 = t2 == null ? void 0 : t2[a2];
      if (null == f4) {
...
//# sourceMappingURL=GeoJSONSourceWorker-VUQHC2DY.js.map
