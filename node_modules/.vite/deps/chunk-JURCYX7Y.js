...
async function G2() {
  has("host-webworker") && (!M2 && globalThis.invokeStaticMessage ? M2 = await import("./request-ATCURE4Q.js") : R3 = true);
}
async function J2() {
  s4 || await import("./IdentityManager-XL6OQ2YV.js");
}
...
async function te(e5) {
  ...
  if (!r4) return se(e5);
  const { QueueProcessor: t5 } = await import("./QueueProcessor-5ZQP4GBL.js"), s5 = e(re, r4.origin, () => {
...
//# sourceMappingURL=chunk-JURCYX7Y.js.map
