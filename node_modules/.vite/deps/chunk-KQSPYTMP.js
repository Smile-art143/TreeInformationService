...
function a3(r3, e, t3, i4, o2) {
  var _a, _b;
  const n5 = {};
  return (_b = (_a = e.write) == null ? void 0 : _a.writer) == null ? void 0 : _b.call(r3, i4, n5, t3, o2), n5;
}
function p(r3, o2, s4, u6, l, a6) {
  if (!(u6 == null ? void 0 : u6.write)) return false;
  const p2 = o(r3, s4);
  ...
  if (l.layerContainerTypes && (a6 == null ? void 0 : a6.layerContainerType) && !l.layerContainerTypes.includes(a6.layerContainerType)) return false;
  if ((null === p2 && !l.allowNull && !l.writerEnsuresNonNull || void 0 === p2) && l.isRequired) {
    ...
    return i4 && (a6 == null ? void 0 : a6.messages) ? a6.messages.push(i4) : i4 && !a6 && i.getLogger("esri.core.accessorSupport.write").error(i4.name, i4.message), false;
  }
  ...
  if (!l.ignoreOrigin && (a6 == null ? void 0 : a6.origin) && o2.store.multipleOriginsSupported) {
    if (o2.store.originOf(s4) < r(a6.origin)) return false;
  }
  return true;
}
...
function c(r3, e, t3, i4) {
  const o2 = n(r3), n5 = o2.metadata, s4 = r2(n5[e], i4);
...
function g(r3, e, t3) {
  ...
  for (const u6 in f3) {
    ...
    Object.keys(d2).length > 0 && (e = u(e, d2), ((_b = (_a = t3 == null ? void 0 : t3.resources) == null ? void 0 : _a.pendingOperations) == null ? void 0 : _b.length) && t3.resources.pendingOperations.push(Promise.all(t3.resources.pendingOperations).then(() => u(e, d2, () => "replace-arrays"))), (t3 == null ? void 0 : t3.writtenProperties) && t3.writtenProperties.push({ target: r3, propName: u6, oldOrigin: u3(n5.store.originOf(u6)), newOrigin: t3.origin }));
  }
  return e;
}
...
var s3 = class _s {
  ...
  get(i4, s4) {
    ...
    return null == s4 || (t3 == null ? void 0 : t3.origin) === s4 ? t3 == null ? void 0 : t3.value : void 0;
  }
  originOf(i4) {
    var _a;
    return ((_a = this._values.get(i4)) == null ? void 0 : _a.origin) ?? 7;
  }
  keys(i4) {
    i4 = this._normalizeOrigin(i4);
    const s4 = [...this._values.keys()];
    return null == i4 ? s4 : s4.filter((s5) => {
      var _a;
      return ((_a = this._values.get(s5)) == null ? void 0 : _a.origin) === i4;
    });
  }
  set(i4, s4, e) {
    if (0 === (e = this._normalizeOrigin(e))) {
      const s5 = this._values.get(i4);
      if (null != (s5 == null ? void 0 : s5.origin) && s5.origin > e) return;
    }
    this._values.set(i4, new t(s4, e));
  }
  delete(i4, s4) {
    var _a;
    null != (s4 = this._normalizeOrigin(s4)) && ((_a = this._values.get(i4)) == null ? void 0 : _a.origin) !== s4 || this._values.delete(i4);
  }
  has(i4, s4) {
    var _a;
    return null != (s4 = this._normalizeOrigin(s4)) ? ((_a = this._values.get(i4)) == null ? void 0 : _a.origin) === s4 : this._values.has(i4);
  }
  isAtOrigin(i4, s4) {
...
function n3(e, r3, s4) {
  if (!(e == null ? void 0 : e.read) || false === e.read.enabled || !e.read.source) return false;
...
function f2(e, t3, r3, s4) {
  const n5 = r3.metadata, i4 = n2(n5[t3], s4), a6 = i4 == null ? void 0 : i4.default;
  if (void 0 === a6) return;
...
function u4(t3, o2, n5 = c2) {
  ...
  for (const r3 of Object.getOwnPropertyNames(d2)) {
    const a6 = i2(u6[r3], n5).read, f3 = a6 == null ? void 0 : a6.source;
    let c3;
    c3 = f3 && "string" == typeof f3 ? u2(o2, f3) : o2[r3], (a6 == null ? void 0 : a6.reader) && (c3 = a6.reader.call(t3, c3, o2, n5)), void 0 !== c3 && i4.set(r3, c3);
  }
...
function d(e, t3, r3, s4 = c2) {
  ...
  r3(o2), (_a = o2.messages) == null ? void 0 : _a.forEach((t4) => {
    "warning" !== t4.type || e.loaded ? (s4 == null ? void 0 : s4.messages) && s4.messages.push(t4) : e.loadWarnings.push(t4);
  });
}
...
//# sourceMappingURL=chunk-KQSPYTMP.js.map
