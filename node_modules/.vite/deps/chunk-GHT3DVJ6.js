...
function d(e, r, t2) {
  ...
  if (e) for (let a3 = 0, i2 = e.length; a3 < i2; a3++) {
    if (o = e.at(a3), (o == null ? void 0 : o[r]) === t2) return o;
    if ("group" === (o == null ? void 0 : o.type) && (s = d(o.layers, r, t2), s)) return s;
  }
}
var n3 = (n5) => {
  const y = n5;
...
function l2(t2, e, r) {
  if (t2) for (let o = 0, s = t2.length; o < s; o++) {
    const s2 = t2.at(o);
    if (s2[e] === r) return s2;
    if ("group" === (s2 == null ? void 0 : s2.type)) {
...
//# sourceMappingURL=chunk-GHT3DVJ6.js.map
