...
var TooltipManager = class {
  constructor() {
    ...
    this.pointerMoveHandler = (event) => {
      ...
      } else if ((_a = this.activeTooltip) == null ? void 0 : _a.open) {
        this.closeHoveredTooltip();
      }
      this.clickedTooltip = null;
    };
    ...
    this.openHoveredTooltip = (tooltip) => {
      ...
      this.hoverOpenTimeout = window.setTimeout(
        ...
        ((_a = this.activeTooltip) == null ? void 0 : _a.open) ? TOOLTIP_QUICK_OPEN_DELAY_MS : TOOLTIP_OPEN_DELAY_MS
      );
    };
    this.closeHoveredTooltip = () => {
  ...
  pathHasOpenTooltip(tooltip, composedPath) {
    const { activeTooltip } = this;
    return (activeTooltip == null ? void 0 : activeTooltip.open) && composedPath.includes(activeTooltip) || (tooltip == null ? void 0 : tooltip.open) && composedPath.includes(tooltip);
  }
...
var _Tooltip = class _Tooltip extends LitElement {
  ...
  render() {
    ...
    })} ${ref(this.setTransitionEl)}>${FloatingArrow({ floatingLayout, ref: this.arrowRef })}<div class=${safeClassMap(CSS.container)}><slot></slot></div></div></div>`;
  }
};
...
@esri/calcite-components/dist/components/calcite-tooltip/customElement.js:
  ...
  v3.3.3 *)
*/
//# sourceMappingURL=calcite-tooltip-ZQVGAV75.js.map
