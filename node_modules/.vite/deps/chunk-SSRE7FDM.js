...
var l3 = class extends m2 {
  constructor(r7, t8) {
    super(r7, t8, new t2(f, () => import("./SSAOBlur.glsl-244WAJPS.js")), s);
  }
  initializePipeline() {
...
var l4 = class extends m2 {
  constructor(r7, t8) {
    super(r7, t8, new t2(g, () => import("./SSAO.glsl-O3CCKOM6.js")), s);
  }
  initializePipeline() {
    return T({ colorWrite: d });
  }
...
var j2 = class extends a3 {
  ...
  render(e10) {
    const t8 = e10.find(({ name: e11 }) => "normals" === e11), s3 = t8 == null ? void 0 : t8.getTexture(), o7 = t8 == null ? void 0 : t8.getTexture(n3);
    if (!s3 || !o7) return;
...
function t7(t8, o7) {
  o7.receiveAmbientOcclusion ? (t8.uniforms.add(new e4("ssaoTex", (e10) => {
    var _a;
    return (_a = e10.ssao) == null ? void 0 : _a.getTexture();
  })), t8.constants.add("blurSizePixelsInverse", "float", 1 / g2), t8.code.add(t`float evaluateAmbientOcclusionInverse() {
...
//# sourceMappingURL=chunk-SSRE7FDM.js.map
