...
var C2 = class extends u {
  ...
  async _loadOGCServices(e2, s7) {
    const o5 = null != s7 ? s7.signal : null, { apiKey: p4, collectionId: i2, customParameters: u3, fields: n3, geometryType: h, hasZ: S2, objectIdField: C3, timeInfo: R, url: v2 } = e2, w = { fields: n3 == null ? void 0 : n3.map((e3) => e3.toJSON()), geometryType: m3.toJSON(h), hasZ: S2 ?? false, objectIdField: C3, timeInfo: R == null ? void 0 : R.toJSON() }, x2 = { apiKey: p4, customParameters: u3, signal: o5 }, O2 = await P(v2, x2), [j2, D] = await Promise.all([O(O2, x2), v(O2, x2)]);
...
var V = class extends a2(o3(s3(f3(c(p(p2(l2(e(t(b2(j(f2(l(b3)))))))))))))) {
  ...
  getFieldDomain(e2, r) {
    var _a;
    let t2, i2 = false;
    const o5 = (_a = r == null ? void 0 : r.feature) == null ? void 0 : _a.attributes, s7 = this.typeIdField && (o5 == null ? void 0 : o5[this.typeIdField]);
    return null != s7 && this.types && (i2 = this.types.some((r2) => {
      var _a2;
      return r2.id == s7 && (t2 = (_a2 = r2.domains) == null ? void 0 : _a2[e2], "inherited" === (t2 == null ? void 0 : t2.type) && (t2 = this._getLayerDomain(e2)), true);
...
//# sourceMappingURL=OGCFeatureLayer-LYNYENW7.js.map
