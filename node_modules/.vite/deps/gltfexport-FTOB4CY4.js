...
function o2(e5) {
  ...
  if (tt(t6)) {
    const e6 = ot(t6);
    return "image/jpeg" === (e6 == null ? void 0 : e6.mediaType) ? e6.mediaType : "image/png";
  }
...
var _3 = class {
  ...
  _createMeshes(e5) {
    ...
    const a4 = q({ vertexAttributes: e5.vertexAttributes, vertexSpace: e5.vertexSpace, transform: ((_a = this.options) == null ? void 0 : _a.ignoreLocalTransform) ? null : e5.transform, spatialReference: e5.spatialReference }, o3, { targetUnit: this.options.unitConversionDisabled ? void 0 : "meters" });
    if (!a4) return [];
    r2(e5, a4), M(a4);
...
async function c4(e5, s6) {
  ...
  const g = s6.jsonSpacing ?? 4, d2 = /* @__PURE__ */ new Map(), w2 = JSON.stringify(a4, (t6, e6) => {
    ...
    if ("extras" !== t6) {
      if (e6 instanceof ArrayBuffer) {
        if (c3(e6)) switch ((_a2 = s6.output) == null ? void 0 : _a2.image) {
          case 1:
          case 2:
            break;
          default: {
        ...
        switch ((_b2 = s6.output) == null ? void 0 : _b2.buffer) {
          case 1:
            return s5(e6);
          case 2:
  ...
  return 2 === ((_a = s6.output) == null ? void 0 : _a.buffer) || 2 === ((_b = s6.output) == null ? void 0 : _b.image) ? d2.set(u2, new t4(w2, p2).buffer) : d2.set(f2, w2), d2;
}
...
//# sourceMappingURL=gltfexport-FTOB4CY4.js.map
