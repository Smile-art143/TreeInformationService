...
function l3(a8, e9, i10) {
  ...
  if (t5(a8)) {
    ...
    return ((_a = a8.visualVariableSizeMinMaxValue) == null ? void 0 : _a.getSize(t9, i10)) ?? ((_b = a8.visualVariableSizeScaleStops) == null ? void 0 : _b.getSizeForViewScale(a8.view.currentScale)) ?? ((_c = a8.visualVariableSizeStops) == null ? void 0 : _c.getSize(t9, i10)) ?? ((_d = a8.visualVariableSizeUnitValue) == null ? void 0 : _d.getSize(t9, i10));
  }
  return i10;
}
...
function a3(a8, l10) {
  const { textureFloatLinear: n16, colorBufferFloat: i10 } = a8.capabilities, s12 = i10 == null ? void 0 : i10.textureFloat, f14 = i10 == null ? void 0 : i10.textureHalfFloat, u18 = i10 == null ? void 0 : i10.floatBlend, _5 = a8.driverTest.floatBufferBlend.result;
  ...
  const c8 = s12 && u18 && _5, m12 = f14, p9 = n16, d9 = !!(i10 == null ? void 0 : i10.R32F), h12 = !!(i10 == null ? void 0 : i10.R16F);
...
var u9 = class extends t6 {
  ...
  renderResolvePass(e9, r10) {
    ...
    if (null == this._prevFBO || null == this._prevViewport || !(n16 == null ? void 0 : n16.initialized)) return;
...
var o14 = (t9) => {
  var _a;
  return "array" === t9.type ? (_a = t9.elementType) == null ? void 0 : _a.type : void 0;
};
...
var u13 = class extends t6 {
  ...
  render(e9, h12) {
    ...
    l10.setNumberOfFields(f14), u18.setShader({ shader: l10, uniforms: { ...u3(e9, h12.target, m12.uniforms.shader), ...V4.storage, ...V4.view, ...V4.highlight, highlightUniforms: V4.highlight, hittestUniforms: V4.hittestRequest ? { hittestDist: (_a = V4.hittestRequest) == null ? void 0 : _a.distance, hittestPos: (_b = V4.hittestRequest) == null ? void 0 : _b.position } : null }, defines: { VV_SIZE_MIN_MAX_VALUE: !!m12.uniforms.shader.visualVariableSizeMinMaxValue, VV_SIZE_SCALE_STOPS: !!m12.uniforms.shader.visualVariableSizeScaleStops, VV_SIZE_FIELD_STOPS: !!m12.uniforms.shader.visualVariableSizeStops, VV_SIZE_UNIT_VALUE: !!m12.uniforms.shader.visualVariableSizeUnitValue, VV_OPACITY: !!m12.uniforms.shader.visualVariableOpacity, HITTEST: S7, highlight: V4.highlight ? 1 : 0, ...d9, numberOfFields: f14 }, optionalAttributes: {}, useComputeBuffer: S7 }), u18.setPipelineState(m3(e9)), u18.submitDraw(e9, h12);
  }
};
...
function V2(a8) {
  var _a;
  if (!((_a = a8.stops) == null ? void 0 : _a.length)) return null;
  if (a8.stops.some((e9) => e9.useMaxValue || e9.useMinValue)) return (i11, t10) => {
    const r10 = i11.statisticsByLevel.get(t10.key.level), u18 = a8.stops.map((i12) => {
      var _a2, _b;
      return { value: i12.useMaxValue ? ((_a2 = r10 == null ? void 0 : r10.get(a8.field)) == null ? void 0 : _a2.maxValue) ?? 0 : i12.useMinValue ? ((_b = r10 == null ? void 0 : r10.get(a8.field)) == null ? void 0 : _b.minValue) ?? 0 : i12.value, size: i12.size ? u(i12.size) : c };
    }).sort((e9, a9) => e9.value - a9.value), n16 = n13(u18, 8);
...
function s10(e9) {
  ...
  return "string" == typeof e9 ? e9 : { ...e9, defaultValue: s10(e9 == null ? void 0 : e9.defaultValue) };
}
...
var o17 = class {
  ...
  async _doPush(e9) {
    ...
    switch (e9.type) {
      case "update":
      case "highlight":
        if ((s12 == null ? void 0 : s12.type) === e9.type) return;
        return r10.push(e9);
      case "override":
      case "edit":
...
//# sourceMappingURL=chunk-2IUBS4CZ.js.map
