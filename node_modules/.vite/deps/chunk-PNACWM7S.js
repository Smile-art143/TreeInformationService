...
function o2(t) {
  var _a;
  return null != t && ((_a = t.pixels) == null ? void 0 : _a.length) > 0;
}
function r(t) {
  var _a;
  if (!(t == null ? void 0 : t.length) || t.some((t2) => !o2(t2))) return null;
  if (1 === t.length) return ((_a = t[0]) == null ? void 0 : _a.clone()) ?? null;
  ...
  const f3 = n.map(({ statistics: t2 }) => t2).filter((t2) => t2 == null ? void 0 : t2.length), c4 = [];
...
function m(t, l3) {
  ...
  const U3 = f3 == null ? void 0 : f3.length;
...
function d(t, e, n, l3) {
  const i3 = null != n && n.length >= 2 ? new Set(n) : null, o4 = 1 === (n == null ? void 0 : n.length) ? n[0] : null, s2 = !!(e == null ? void 0 : e.length);
  for (let r3 = 0; r3 < t.length; r3++) if (l3[r3]) {
    ...
    l3[r3] && (n2 === o4 || (i3 == null ? void 0 : i3.has(n2))) && (l3[r3] = 0);
  }
}
function g(t, e) {
  const n = t[0].length;
...
function w(t, n) {
  ...
  if (m3) {
    ...
    for (let e = 0; e < h3; e++) {
      ...
      n2.set(a3), d(s2[e], f3 == null ? void 0 : f3.slice(2 * e, 2 * e + 2), u4 == null ? void 0 : u4[e], n2), t2.push(n2);
    }
    1 === t2.length ? a3.set(t2[0]) : g(t2, a3);
  } else for (let e = 0; e < h3; e++) d(s2[e], f3 == null ? void 0 : f3.slice(2 * e, 2 * e + 2), u4 == null ? void 0 : u4[e], a3);
...
function k(t) {
  ...
  s2 && p3.fill(255);
  const [x3, m3] = u(h3);
  if ((i3 == null ? void 0 : i3.length) && (o4 == null ? void 0 : o4.length)) {
  ...
  if (r3 == null ? void 0 : r3.length) for (let e = 0; e < r3.length; e++) {
...
function U(t, e) {
  ...
  if (null == (n == null ? void 0 : n.pixelBlock)) return null;
...
function T(t, n, l3 = {}) {
  ...
  const U3 = t.some((t2) => null == t2 || null != t2.mask && t2.mask.length > 0), T2 = t.some((t2) => (t2 == null ? void 0 : t2.bandMasks) && t2.bandMasks.length > 1), v3 = U3 ? new Uint8Array(f3 * c4) : void 0, B2 = T2 ? [] : void 0;
  if (v3) {
    ...
    if (B2) for (let e = 0; e < w3; e++) {
      ...
      for (let l4 = 0; l4 < m3; l4++) for (let i4 = 0; i4 < x3; i4++) {
        const o4 = t[l4 * x3 + i4], s3 = ((_a = o4 == null ? void 0 : o4.bandMasks) == null ? void 0 : _a[e]) ?? (o4 == null ? void 0 : o4.mask);
...
function S(t, n, l3) {
  ...
  const x3 = t.some((t2) => (t2 == null ? void 0 : t2.bandMasks) && t2.bandMasks.length > 1), m3 = x3 ? [] : void 0, d3 = r3 * a3;
  for (let e = 0; e < u4; e++) {
    ...
    for (let i4 = 0, s3 = 0; i4 < t.length; s3 += f3[i4], i4++) {
      ...
      if (null != c5) {
        ...
        if (l4) {
          const t2 = ((_a = h4.bandMasks) == null ? void 0 : _a[e]) ?? h4.mask;
...
function N(t, n, l3, i3, s2 = "nearest") {
  ...
  let S3;
  const v3 = (h3 == null ? void 0 : h3.length) === x3, C2 = [];
  for (let e = 0; e < x3; e++) {
    if (v3) {
...
//# sourceMappingURL=chunk-PNACWM7S.js.map
