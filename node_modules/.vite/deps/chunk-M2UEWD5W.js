...
var o3 = P2(() => import("./bufferOperator-5UTMEVGQ.js"));
var s7 = P2(() => import("./convexHullOperator-5U2FWQXI.js"));
var m2 = P2(() => import("./lengthOperator-3BMTFI7V.js"));
var i8 = P2(() => import("./generalizeOperator-GM5JWDJ2.js"));
var n5 = P2(() => import("./graphicBufferOperator-PUECP2SY.js"));
var p3 = P2(() => import("./offsetOperator-2EPI3T2Y.js"));
var f4 = P2(() => import("./simplifyOperator-6SK6D25Y.js"));
var c3 = 512;
var a3;
function l7(e17) {
  switch (e17.type) {
...
var r3 = class {
  ...
  next() {
    ...
    for (; i18 = this._inputGeometries.next(); ) {
      ...
      if (h8 == null ? void 0 : h8.length) return a2.fromJSONCIM({ paths: h8 });
    }
    return null;
  }
  _clone(s17) {
...
var h4 = class extends r2 {
  ...
  processPath(s17) {
    ...
    return r13 == null ? void 0 : r13.reset(), r13;
  }
};
...
var s14 = class {
  ...
  rasterizeText(e17, s17) {
    ...
    if (c5) {
      h8.save();
      const e18 = s17.backgroundColor ?? [0, 0, 0, 0], t16 = ((_a = s17.borderLine) == null ? void 0 : _a.color) ?? [0, 0, 0, 0], i18 = 2 * (((_b = s17.borderLine) == null ? void 0 : _b.size) ?? 0);
...
var lt = class {
  ...
  drawVectorMarker(t16, e17) {
    ...
    for (const d of r13) {
      (d == null ? void 0 : d.symbol) && d.geometry || nt().error("Invalid marker graphic", d);
...
var ct = class extends lt {
  ...
  hitTest(t16, e17, r13, i18, s17, a11) {
    ...
    if (this._mapRotation = h8 ? s17 : 0, !has("esri-mobile")) {
      ...
      !(("CIMLineSymbol" === (e17 == null ? void 0 : e17.type) || "CIMPolygonSymbol" === (e17 == null ? void 0 : e17.type)) && ((_a = e17.symbolLayers) == null ? void 0 : _a.some(p))) && "CIMMeshSymbol" !== (e17 == null ? void 0 : e17.type) && (U(e17) ?? 0) < r14 && (this._searchDistPoint = t17);
    }
    return this._earlyReturn = false, this.drawSymbol(e17, r13), this._earlyReturn;
  }
  executeEffects(t16, e17) {
    var _a;
    return "CIMGeometricEffectDashes" === ((_a = t16.at(-1)) == null ? void 0 : _a.type) && (t16 = t16.slice(0, -1)), super.executeEffects(t16, e17);
  }
  ...
  _getSvgPath() {
    return null != this._svg && null != this._path || (this._svg ?? (this._svg = e16()), this._path ?? (this._path = t14("path")), this._svg.appendChild(this._path)), this._path;
  }
  _getCanvasContext(t16, e17) {
    return this._canvas ?? (this._canvas = document.createElement("canvas")), this._canvas.width = t16, this._canvas.height = e17, this._canvas.getContext("2d", { willReadFrequently: true });
  }
...
var V2 = class {
  ...
  static _vectorMarkerBounds(e17, t16, r13, o9) {
    let a11 = true;
    const i18 = i2();
    if (t16 == null ? void 0 : t16.markerGraphics) for (const s17 of t16.markerGraphics) {
      const t17 = [0, 0, 0, 0];
  ...
  static _getTextInflatedSize(e17, t16, r13) {
    ...
    const { lineGapType: s17, lineGap: i18 } = t16, n23 = s17 ? _t2(s17, i18 ?? 0, o9) : 0, l12 = "CIMBackgroundCallout" === ((_a = t16.callout) == null ? void 0 : _a.type), c5 = z(a11.glyphMosaicItems, { scale: o9 / q, angle: I2(t16.angle), xOffset: I2(t16.offsetX), yOffset: I2(t16.offsetY), horizontalAlignment: t16.horizontalAlignment, verticalAlignment: t16.verticalAlignment, maxLineWidth: a10(t16.lineWidth), lineHeight: l4 * Math.max(0.25, Math.min(n23 || 1, 4)), decoration: t16.font.decoration || "none", useCIMAngleBehavior: true, hasBackground: l12 }).boundsT, m5 = Math.sqrt(c5.width * c5.width + c5.height * c5.height);
...
var Y = class _Y {
  ...
  static createPictureMarkerRasterizationParam(e17) {
    var _a, _b;
    const { angle: t16, height: r13, width: o9, xoffset: a11, yoffset: s17 } = e17, i18 = e17.url ?? ((_a = e17.source) == null ? void 0 : _a.url) ?? ((_b = e17.source) == null ? void 0 : _b.imageData);
  ...
  static fromSimpleMarker(e17, t16, r13) {
    ...
    if ("outline" in e17 && e17.outline && "none" !== e17.outline.style && "esriSLSNull" !== e17.outline.style) {
      ...
      const c6 = "cross" !== e17.style && "x" !== e17.style || "dot" === (e17 == null ? void 0 : e17.outline.style) || "short-dot" === (e17 == null ? void 0 : e17.outline.style) ? "HalfGap" : "FullPattern", m5 = r14 ? [{ type: "CIMGeometricEffectAddControlPoints" }, { type: "CIMGeometricEffectDashes", dashTemplate: K2(t17.style, null).map((e18) => t17.width && t17.width > 0 ? e18 * t17.width : e18), lineDashEnding: c6, controlPointEnding: "FullPattern" }] : void 0;
  ...
  static fromCIMHatchFill(e17, r13) {
    ...
    (_a = s17.symbolLayers) == null ? void 0 : _a.forEach((e18) => {
      var _a2;
      switch (e18.type) {
        case "CIMSolidStroke":
          null != e18.width && (e18.width *= r13), (_a2 = e18.effects) == null ? void 0 : _a2.forEach((e19) => {
            if ("CIMGeometricEffectDashes" === e19.type) {
              const t16 = e19.dashTemplate;
              e19.dashTemplate = t16 == null ? void 0 : t16.map((e20) => e20 * r13);
            }
          });
          break;
        case "CIMVectorMarker": {
  ...
  static fetchFonts(e17, t16, r13) {
    if (e17 && t16) {
      if ("symbolLayers" in e17 && e17.symbolLayers) {
        for (const o9 of e17.symbolLayers) if ("CIMVectorMarker" === o9.type && o9.markerGraphics) for (const e18 of o9.markerGraphics) (e18 == null ? void 0 : e18.symbol) && _Y.fetchFonts(e18.symbol, t16, r13);
...
//# sourceMappingURL=chunk-M2UEWD5W.js.map
