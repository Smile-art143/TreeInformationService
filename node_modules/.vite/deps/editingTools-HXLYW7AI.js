...
var E2 = class extends A2 {
  constructor(e4) {
    super(e4), this._visualElementGraphics = { regularVertices: null, activeVertex: null, activeEdge: null }, this.activeFillSymbol = null, this.type = "draw-2d", this._visualElementSymbols = { outline: e4.activeLineSymbol ?? t2, regularVertices: e4.regularVerticesSymbol ?? l2, activeVertex: e4.activeVertexSymbol ?? i, fill: e4.activeFillSymbol }, e4.activeVertexSymbol || this.addHandles(l(() => {
      var _a, _b;
      ...
      (_a = this._visualElementGraphics.activeVertex) == null ? void 0 : _a.set("symbol", t3), this._visualElementSymbols = { ...this._visualElementSymbols, activeVertex: t3 };
    }, h));
  }
...
function G3(e4, t3) {
  var _a, _b;
  return (((_a = e4.attributes) == null ? void 0 : _a.displayOrder) ?? -1 / 0) - (((_b = t3.attributes) == null ? void 0 : _b.displayOrder) ?? -1 / 0);
}
...
var Q = class extends r3 {
  ...
  _scale(e4) {
    var _a;
    const t3 = this._editGeometryOperations, i2 = (_a = t3.data.geometry.extent) == null ? void 0 : _a.width, s6 = (i2 + e4 * this.view.resolution) / i2, o2 = t3.scale(this._plane.origin, s3, s6, s6, 0, 1);
...
var d = class extends b {
  ...
  initialize() {
    ...
    d2.view.tools.addMany([this._advancedModeTransformTool]), "controlPoints" in c2 && "controlPoints" in l3 && this.addHandles([d2.view.on("key-down", (o3) => {
      ...
      var _a;
      l3.controlPoints = o3.map(({ sourcePoint: o4 }, t4) => ({ sourcePoint: o4, mapPoint: l3.controlPoints[t4].mapPoint })), (_a = this._activeTool) == null ? void 0 : _a.refresh();
  ...
  undo() {
    ...
    if (this._sharedUndoStack.length > 0) {
      ...
      o2 !== this._activeTool && o2.refresh(), t3.undo(), o2.updateGraphics(), this._sharedRedoStack.push({ tool: o2, operation: t3 }), this._activeTool !== o2 && ((_a = this._activeTool) == null ? void 0 : _a.refresh());
    }
  }
  redo() {
    var _a;
    if (this._sharedRedoStack.length > 0) {
      ...
      o2 !== this._activeTool && o2.refresh(), t3.apply(), o2.updateGraphics(), this._sharedUndoStack.push({ tool: o2, operation: t3 }), this._activeTool !== o2 && ((_a = this._activeTool) == null ? void 0 : _a.refresh());
    }
  }
  refresh() {
...
//# sourceMappingURL=editingTools-HXLYW7AI.js.map
