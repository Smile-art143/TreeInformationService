...
function i(t2) {
  ...
  return { count: !!(s == null ? void 0 : s.includes("count")), sum: !!(s == null ? void 0 : s.includes("sum")), min: !!(s == null ? void 0 : s.includes("min")), max: !!(s == null ? void 0 : s.includes("max")), avg: !!(s == null ? void 0 : s.includes("avg")), var: !!(s == null ? void 0 : s.includes("var")), stddev: !!(s == null ? void 0 : s.includes("stddev")), percentileContinuous: !!(s == null ? void 0 : s.includes("percentile_cont")), percentileDiscrete: !!(s == null ? void 0 : s.includes("percentile_disc")), envelope: !!(s == null ? void 0 : s.includes("envelopeaggregate")), centroid: !!(s == null ? void 0 : s.includes("centroidaggregate")), convexHull: !!(s == null ? void 0 : s.includes("convexhullaggregate")) };
}
function a(t2) {
  var _a;
...
function c(t2, s) {
  return { analytics: d2(t2), attachment: l(t2), data: y(t2), metadata: m(t2), operations: g2(t2.capabilities, t2, s), query: C(t2, s), queryAttributeBins: Q(t2), queryRelated: v(t2), queryTopFeatures: h(t2), editing: A(t2) };
}
function d2(t2) {
  return { supportsCacheHint: n2(t2.advancedQueryCapabilities, "queryAnalytics") };
}
function l(t2) {
  const s = t2.attachmentProperties, e = { supportsName: false, supportsSize: false, supportsContentType: false, supportsKeywords: false, supportsExifInfo: false, supportsCacheHint: n2(t2.advancedQueryCapabilities, "queryAttachments"), supportsOrderByFields: n(t2.advancedQueryCapabilities, "supportsQueryAttachmentOrderByFields", false), supportsResize: n(t2, "supportsAttachmentsResizing", false), supportsTypeWildcard: n(t2.advancedQueryCapabilities, "supportsQueryAttachmentWithTypeWildcard", false) };
...
//# sourceMappingURL=chunk-OGPMXX6R.js.map
