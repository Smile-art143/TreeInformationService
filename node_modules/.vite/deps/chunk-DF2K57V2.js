...
Uu() || Mu((t) => {
  ...
  return a2 = r && b.has(r) ? Math.PI / 200 : m ? re(p) : Math.PI / 180, { isPCS: m, metersOrRadiansPerUnit: a2, semiMajor: 0, wkidOrWkt: t };
});
...
var L = class {
  createJSONObjectIterator(e) {
    return { m_iteratorType: "object", m_o: e, m_keys: this.m_options.strict ? Object.keys(e) : Object.keys(e).filter((t) => void 0 !== e[t]), m_i: -1, m_bReturnKey: true, next: X };
  }
  createJSONArrayIterator(e) {
    return { m_iteratorType: "array", m_strict: this.m_options.strict, m_i: -1, m_a: e, next: Y };
  }
  constructor(e, t) {
  ...
  nextToken() {
    ...
    return b2("unrecognized json element type"), 0;
  }
  currentToken() {
...
var q = class _q {
  ...
  doSwap() {
    return this.m_bLittleEndian !== (1 === _q.getNativeByteOrder());
  }
  setNativeByteOrder() {
    this.m_bLittleEndian = 1 === _q.getNativeByteOrder();
  }
  setOrder(e) {
...
function K2(e, r, i, a2, o, u) {
  let m = false, l = false, c2 = false, d = false, _ = false, h = false, f2 = false, p = false, k = false, b3 = false, y = false, N = false, T = false, g = false, w = false, C2 = false, D = false, F = false, j2 = false, O = false, z2 = false, I = false, E = false, P2 = false, B = Number.NaN, R = Number.NaN, V = Number.NaN, M = Number.NaN, U = 0, W = Number.NaN, X2 = Number.NaN, Y2 = Number.NaN, L2 = Number.NaN, G2 = Number.NaN, q2 = Number.NaN, K3 = Number.NaN, J3 = Number.NaN, re4 = 0, ie2 = 0, se2 = false, ae2 = false, oe2 = null, ue2 = null, me2 = null, le2 = null, ce2 = null;
  for (; 3 !== i.nextToken(); ) {
    const u2 = i.currentString();
    if (i.nextToken(), "spatialReference" === u2) {
      if (o && !m) {
        m = true, 1 === i.currentToken() ? le2 = Q2(i) : 10 !== i.currentToken() && P("failed to parse spatial reference: object or null is expected");
        continue;
      }
      ...
      if (!c2) {
        c2 = true, ae2 = 11 === i.currentToken();
        continue;
      }
    } else if ("rings" === u2) {
      if (!(_ || h || e !== a.enumUnknown && e !== a.enumPolygon)) {
        _ = true, { geometry: ce2, as: oe2, bs: ue2 } = Z(true, false, r, i);
        continue;
      }
    } else if ("curveRings" === u2) {
      if (!h && (e === a.enumUnknown || e === a.enumPolygon)) {
        h = true, { geometry: ce2, as: oe2, bs: ue2 } = Z(true, true, r, i);
        continue;
      }
    } else if ("paths" === u2) {
      if (!(f2 || p || e !== a.enumUnknown && e !== a.enumPolyline)) {
        f2 = true, { geometry: ce2, as: oe2, bs: ue2 } = Z(false, false, r, i);
        continue;
      }
    } else if ("curvePaths" === u2) {
      if (!p && (e === a.enumUnknown || e === a.enumPolyline)) {
        p = true, { geometry: ce2, as: oe2, bs: ue2 } = Z(false, true, r, i);
        continue;
      }
    } else if ("points" === u2) {
      if (!k && (e === a.enumUnknown || e === a.enumMultiPoint)) {
        k = true, { geometry: ce2, as: oe2, bs: ue2 } = H(r, i);
        continue;
      }
    } else if ("ids" === u2) {
      if (!d) {
      ...
      if (!b3 && (e === a.enumUnknown || e === a.enumPoint)) {
        b3 = true, B = ee2(i);
        continue;
      }
    } else if ("y" === u2) {
      ...
      if (!P2 && (e === a.enumUnknown || e === a.enumEnvelope)) {
        P2 = true, ie2 = te(i);
        continue;
      }
  ...
  if (_ || h || f2 || p || k) {
    let e2 = null, t = null;
    const n2 = ce2;
    se2 && (ce2.addAttribute(1), e2 = oe2, e2 || (e2 = $(n2.getPointCount(), Number.NaN))), ae2 && (ce2.addAttribute(2), t = se2 ? ue2 : oe2), null != me2 && ce2.addAttribute(3), se2 && null != e2 && n2.setAttributeStreamRef(1, e2), ae2 && null != t && n2.setAttributeStreamRef(2, t), null != me2 && ne(n2, me2);
  } else if (b3 || y || T || N || g) {
    Ct(B, R) || P("failed to parse point: x and y must be finite or nan"), (Number.isNaN(R) || Number.isNaN(B)) && (B = Number.NaN, R = Number.NaN);
    const e2 = new ee({ x: B, y: R });
    N && e2.setZ(V), T && e2.setM(M), g && e2.setID(U), ce2 = e2;
  } else if (w || C2 || D || F || j2 || O || z2 || I || E || P2) {
    (Number.isNaN(X2) || Number.isNaN(Y2) || Number.isNaN(L2)) && (W = Number.NaN);
    const e2 = new re2({ xmin: W, ymin: X2, xmax: Y2, ymax: L2 });
    j2 && O && e2.setInterval(1, 0, G2, q2), z2 && I && e2.setInterval(2, 0, K3, J3), E && P2 && e2.setInterval(3, 0, re4, ie2), ce2 = e2;
  }
...
function Q2(e) {
  let t = false, n2 = false, r = false, i = false, s = false, a2 = false, o = false, u = false, m = false, l = false, c2 = false, d = false, _ = false, g = false, v = false, x = false, A2 = false, S = -1, w = -1, C2 = -1, D = -1, F = 0, j2 = 0, O = 0, z2 = 0, I = 0, E = 0, P2 = 0, B = 0, R = 0, V = 0, M = "", U = "", W = null;
  for (; 3 !== e.nextToken(); ) {
    const h = e.currentString();
    e.nextToken(), "wkid" === h ? t || (t = true, 8 === e.currentToken() && (S = e.currentInt32Value())) : "latestWkid" === h ? n2 || (n2 = true, 8 === e.currentToken() && (w = e.currentInt32Value())) : "wkt" === h ? s || (s = true, 6 === e.currentToken() && (M = e.currentString())) : "wkt2" === h ? s || 6 === e.currentToken() && (U = e.currentString()) : "vcsWkid" === h ? r || (r = true, 8 === e.currentToken() && (C2 = e.currentInt32Value())) : "latestVcsWkid" === h ? i || (i = true, 8 === e.currentToken() && (D = e.currentInt32Value())) : "xyTolerance" === h ? o || (o = true, a2 = true, F = e.currentDoubleValue()) : "zTolerance" === h ? u || (u = true, a2 = true, j2 = e.currentDoubleValue()) : "mTolerance" === h ? m || (m = true, a2 = true, O = e.currentDoubleValue()) : "falseX" === h ? l || (l = true, a2 = true, P2 = e.currentDoubleValue()) : "falseY" === h ? c2 || (c2 = true, a2 = true, B = e.currentDoubleValue()) : "falseZ" === h ? d || (d = true, a2 = true, R = e.currentDoubleValue()) : "falseM" === h ? _ || (_ = true, a2 = true, V = e.currentDoubleValue()) : "xyUnits" === h ? g || (g = true, a2 = true, z2 = e.currentDoubleValue()) : "zUnits" === h ? v || (v = true, a2 = true, I = e.currentDoubleValue()) : "mUnits" === h ? x || (x = true, a2 = true, E = e.currentDoubleValue()) : "unit" === h ? A2 || (A2 = true, W = J2(e)) : e.skipChildren();
  }
  D <= 0 && C2 > 0 && (D = C2), C2 <= 0 && D > 0 && (C2 = D);
  let X2 = null, Y2 = true;
  if (0 !== M.length && (Y2 = false, Qu(M) && (X2 = Yu(M))), X2 || 0 === U.length || (Y2 = false, Qu(U) && (X2 = Yu(U))), !X2 && w > 0 && (Y2 = false, Ku(w) && (D <= 0 || Hm()) && (X2 = Ou(w, D))), !X2 && S > 0 && (Y2 = false, Ku(S) && (C2 <= 0 || Hm()) && (X2 = Ou(S, C2))), Y2 && (X2 = Wu(W)), a2 && X2) {
    const e2 = new ac();
    X2.queryPrecisionDescriptorWithoutFalseXY(e2), o && e2.setTolerance(0, F), u && e2.setTolerance(1, j2), m && e2.setTolerance(2, O), g && l && c2 && e2.setGridParams(P2, B, z2), v && d && e2.setZParams(R, I), x && _ && e2.setMParams(V, E), X2 = Lu2(X2, e2);
  }
  return X2;
}
function Z(e, n2, r, i) {
  ...
  let h = null, f2 = null, p = null, k = null, b3 = null, y = 0, N = 0, T = 0;
  ...
  for (; 4 !== i.nextToken(); ) {
    ...
    for (i.nextToken(); 4 !== i.currentToken(); ) {
      if (n2 && 1 === i.currentToken()) j2 && P("failed to parse multipath: starting vertex array is expected"), p || (p = K(A2 - 1, 1), k = J(A2 - 1, -1), b3 = $(0)), R = true, r2 = 1, { segFlag: T, toPointSz: z2 } = me(g, P2, x, i);
      else {
        for (R = false, 2 !== i.currentToken() && P("failed to parse multipath: array is expected, rings/paths vertices consist of arrays of coordinates"), z2 = 0; 4 !== i.nextToken(); ) z2 === O && P("failed to parse multipath: each vertex array has to have at most 4 elements"), P2[z2++] = ee2(i);
        z2 < 2 && P("failed to parse multipath: each vertex array has to have at least 2 elements"), Tt(P2[0], P2[1]) || P("failed to parse multipath: x and y must be finite");
      }
      i.nextToken();
      do {
        if (u.size() === 2 * A2 && u.resize(re3(A2)), u.writePoint2D(2 * A2, E.setCoords(P2[0], P2[1])), h && h.size() === A2 && h.resize(ie(A2)), z2 > 2 ? (h || (h = $(A2 + 1, Number.NaN)), h.write(A2, P2[2])) : h && h.write(A2, Number.NaN), f2 && f2.size() === A2 && f2.resize(ie(A2)), z2 > 3 ? (f2 || (f2 = $(A2 + 1, Number.NaN)), f2.write(A2, P2[3])) : f2 && f2.write(A2, Number.NaN), j2) S++, o.add(A2), _.add(F), j2 = false, I = z2, Dt(B, P2, 0, 0, I);
        else if (null !== p) if (R) {
          const e2 = ks(T), t = b3.size();
          b3.resize(t + e2), p.add(T), k.add(y), g.get().writeInBufferStream(b3, y), y += e2, a2.incCurveType(T, 1), N++;
        } else p.add(1), k.add(-1);
        A2++, s2++, x.setCoords(P2[0], P2[1]);
      } while (s2 < r2 && 4 === i.currentToken());
    }
    0 !== s2 && (e && s2 > r2 && z2 === I && 0 === At(P2, B, z2) ? (A2--, s2--) : null !== p && (p.add(1), k.add(-1)));
  }
  return A2 && (o.resize(S), _.resize(S), A2 > 0 && (o.add(A2), _.add(0)), a2.setAttributeStreamRef(0, u), a2.setPathFlagsStreamRef(_), a2.setPathStreamRef(o), null !== p && (a2.updateCurveCounter(N), a2.setSegmentData(k, b3, p, y)), a2.notifyModifiedFlags(65535)), { geometry: s, as: h, bs: f2 };
}
function H(e, n2) {
  2 !== n2.currentToken() && P("failed to parse multipoint: array of vertices is expected");
  let r = 0;
  const i = new cs(), s = $(2, 0);
  let a2 = 0;
  const o = 4, u = Yt(o, Number.NaN), c2 = new mi();
  let d = null, _ = null;
  for (; 4 !== n2.nextToken(); ) {
    for (2 !== n2.currentToken() && P("failed to parse multipoint: array is expected, multipoint vertices consist of arrays of cooridinates"), a2 = 0; 4 !== n2.nextToken(); ) a2 === o && P("failed to parse multipoint: each vertex array has to have at most 4 elements"), u[a2++] = ee2(n2);
    a2 < 2 && P("failed to parse multipoint: each vertex array has to have at least 2 elements"), Tt(u[0], u[1]) || P("failed to parse multipoint: x and y must be finite"), s.size() === 2 * r && s.resize(re3(r)), s.writePoint2D(2 * r, c2.setCoords(u[0], u[1])), d && d.size() === r && d.resize(ie(r)), a2 > 2 ? (d || (d = $(r + 1, Number.NaN)), d.write(r, u[2])) : d && d.write(r, Number.NaN), _ && _.size() === r && _.resize(ie(r)), a2 > 3 ? (_ || (_ = $(r + 1, Number.NaN)), _.write(r, u[3])) : _ && _.write(r, Number.NaN), r++;
  }
  if (r) {
    const e2 = i.getImpl();
...
function $2(e, n2) {
  2 !== n2.currentToken() && P("failed to parse array of IDs: array of array of integers is expected");
  const r = Q(2, 0);
  let i = 0, s = -1;
  for (; 4 !== n2.nextToken(); ) {
    const e2 = i;
    r.size() === i && r.resize(ie(i)), i++;
    let a2 = 0;
    for (-1 === s ? s = 2 === n2.currentToken() ? 1 : 0 : 1 === s && 2 !== n2.currentToken() && P("failed to parse array of IDs: array of array of integers is expected"), 0 === s && (r.size() === i && r.resize(ie(i)), r.write(i, te(n2)), a2++, i++); 4 !== n2.nextToken(); ) r.size() === i && r.resize(ie(i)), r.write(i, te(n2)), a2++, i++;
...
function ne(t, n2) {
  ...
  let s = 0;
  i === cs.type ? s = 1 : i === Os.type || i === ur.type ? s = t.getPathCount() : b2("not implemented"), r.resize(t.getPointCount(), 0);
  let a2 = 0;
  for (let o = 0; o < s; ++o) {
    const s2 = n2.read(a2);
    a2++;
    const u = a2 + s2;
    let m = 0, l = 0;
    i === cs.type ? m = t.getPointCount() : i === Os.type || i === ur.type ? (m = t.getPathSize(o), l = t.getPathStart(o)) : b2("not implemented");
...
function se(e, t, n2, i, s) {
  ...
  return u && !h && (u = false, c2 = true), c2 && h && (u = true, c2 = false, a2.setCoords(0, 0)), u || (m ? c2 ? (e.m_semiMajorAxis = 1, e.m_minorMajorRatio = 0, e.m_interior.assign(a2), e.m_center.setNAN(), e.m_sweepAngle = 0, e.m_startAngle = 0) : (e.constructCircularArcThreePoint(t, n2, a2), h && d === e.isClockwise() && e.reverse()) : c2 ? (e.m_semiMajorAxis = 1, e.m_minorMajorRatio = 0, e.m_center.setNAN(), e.m_sweepAngle = 0, e.m_startAngle = 0, Ru(e), e.queryCoord2D(0.5, e.m_interior)) : Tu(e, t, n2, a2, d, _)), u && (e.m_center.assign(t), e.m_startAngle = a2.x, e.m_sweepAngle = a2.y, ou(e, Number.NaN, d, _), e.m_semiMajorAxis = 0, e.m_minorMajorRatio = 1, e.m_interior.setCoordsPoint2D(t)), e.setProjectionBehavior(0), Ru(e), true;
}
function ae(e, t, n2, r, i) {
...
function me(e, n2, r, i, s) {
  ...
  if ("a" === m) {
    ...
    o = i.nextToken();
    const n3 = ee2(i);
    o = i.nextToken(), 4 !== o && P("failed to parse curve: end array is expected for center point"), d.setCoords(e2, n3), o = i.nextToken(), _ = i.currentInt32Value(), o = i.nextToken(), h = i.currentInt32Value(), o = i.nextToken(), 4 !== o ? (f2 = false, p = ee2(i), o = i.nextToken(), k = ee2(i), o = i.nextToken(), b3 = ee2(i), o = i.nextToken(), 4 !== o && P("failed to parse curve: end array is expected for curve parameters")) : f2 = true, a2.segFlag = 4;
  } else if ("b" === m) {
    for (let e2 = 0; e2 < 2; e2++) {
      ...
      o = i.nextToken();
      const r2 = ee2(i);
      o = i.nextToken(), 4 !== o && P("failed to parse curve: end array is expected for control point"), y[e2].setCoords(n3, r2);
    }
    o = i.nextToken(), 4 !== o && P("failed to parse curve: end array is expected for curve parameters"), a2.segFlag = 2;
  } else if ("n" === m) {
    {
      o = i.nextToken(), 2 !== o && P("failed to parse curve: start array is expected for control point"), o = i.nextToken();
      const e3 = ee2(i);
      o = i.nextToken();
      const n4 = ee2(i);
      o = i.nextToken(), 4 !== o && P("failed to parse curve: end array is expected for control point"), y[0].setCoords(e3, n4);
    }
    o = i.nextToken();
    const e2 = ee2(i);
    o = i.nextToken();
    ...
    o = i.nextToken();
    const r2 = ee2(i);
    y[1].setCoords(e2, n3), y[2].setCoords(r2, r2), o = i.nextToken(), 4 !== o && P("failed to parse curve: end array is expected for curve parameters"), a2.segFlag = 8;
  } else if ("q" === m) {
    ...
    o = i.nextToken(), 4 !== o && P("failed to parse curve: end array is expected for curve parameters"), a2.segFlag = 16;
  } else {
    o = i.nextToken(), 2 !== o && P("failed to parse curve: start array is expected for interior point"), o = i.nextToken();
    const e2 = ee2(i);
    o = i.nextToken();
    const n3 = ee2(i);
    o = i.nextToken(), 4 !== o && P("failed to parse curve: end array is expected for interior point"), N.setCoords(e2, n3), o = i.nextToken(), 4 !== o && P("failed to parse curve: end array is expected for curve parameters"), a2.segFlag = 4;
  }
  if (o = i.nextToken(), 3 !== o && P("failed to parse curve: end object is expected for curve"), "a" === m) if (e.createEllipticArc(), f2) {
    const t = true;
    le(e.get(), r, c2, d, t, _, h);
  } else ce(e.get(), r, c2, d, _, h, p, k, b3);
  else if ("b" === m) e.createCubicBezier(), de(e.get(), r, c2, y);
  else if ("n" === m) e.createQuadraticRationalBezier(), _e(e.get(), r, c2, y[0], y[1].x, y[1].y, y[2].x);
  else if ("q" === m) e.createQuadraticBezier(), e.get().construct(r, y[0], c2);
  else {
    e.createEllipticArc();
    const t = false;
    le(e.get(), r, c2, N, t, -1, -1);
  }
  return a2;
}
function le(e, t, n2, r, i, s, a2) {
  e.dropAllAttributes();
  const o = 20, u = new ArrayBuffer(o), m = new q({ sz: o, buffer: u });
  let l = 0;
  m.writeDouble(l, r.x), l += 8, m.writeDouble(l, r.y), l += 8;
  let c2 = 0;
  i ? (a2 || (c2 |= 8), s && (c2 |= 16)) : c2 |= 128, m.writeInt32(l, c2), l += 4, se(e, t, n2, m, 0);
}
function ce(e, t, n2, r, i, s, a2, o, u) {
  e.dropAllAttributes();
  const m = 44, l = new ArrayBuffer(m), c2 = new q({ sz: m, buffer: l });
  let d = 0;
  c2.writeDouble(d, r.x), d += 8, c2.writeDouble(d, r.y), d += 8, c2.writeDouble(d, a2), d += 8, c2.writeDouble(d, o), d += 8, c2.writeDouble(d, u), d += 8;
  let _ = 0;
  s || (_ |= 2048), i && (_ |= 4096), c2.writeInt32(d, _), d += 4, ae(e, t, n2, c2, 0);
}
function de(e, t, n2, r) {
  e.dropAllAttributes();
  const i = 32, s = new ArrayBuffer(i), a2 = new q({ sz: i, buffer: s });
  let o = 0;
  a2.writeDouble(o, r[0].x), o += 8, a2.writeDouble(o, r[0].y), o += 8, a2.writeDouble(o, r[1].x), o += 8, a2.writeDouble(o, r[1].y), o += 8, oe(e, t, n2, a2, 0);
}
function _e(e, t, n2, r, i, s, a2) {
  e.dropAllAttributes();
  const o = 40, u = new ArrayBuffer(o), m = new q({ sz: o, buffer: u });
  let l = 0;
  m.writeDouble(l, r.x), l += 8, m.writeDouble(l, r.y), l += 8, m.writeDouble(l, i), l += 8, m.writeDouble(l, s), l += 8, m.writeDouble(l, a2), l += 8, ue(e, t, n2, m, 0);
}
function he(e, t, n2, r, i) {
  const o = e.getGeometryType();
  if (o === a.enumEllipticArc) return fe(e, t, n2, r, i);
  if (o === a.enumBezier) return pe(e, t, n2, r, i);
  if (o === a.enumRationalBezier2) return ke(e, t, n2, r, i);
  if (o === a.enumBezier2) {
    const s = new ia();
    return s.constructFromQuadraticSegment(e), pe(s, t, n2, r, i);
  }
  z("");
}
function fe(e, t, r, i, s) {
  ...
  if (o && (m = e.getEndAttributeAsDbl(1, 0)), u && (l = e.getEndAttributeAsDbl(2, 0)), e.isDegenerateToLine() || e.isDegenerate(0)) return be2(o, u, a2.x, a2.y, m, l, i, s), true;
  const c2 = 0 === e.projectionBehavior(), d = !!c2 && e.isClosed();
  if (c2 && !d) s.startObject(), s.addFieldName("c"), s.startArray(), be2(o, u, a2.x, a2.y, m, l, i, s), ye(e.m_interior.x, e.m_interior.y, 17, s), s.endArray(), s.endObject();
  else if (c2) {
    s.startObject(), s.addFieldName("a"), s.startArray(), be2(o, u, a2.x, a2.y, m, l, i, s);
    const t2 = 0, n2 = 0;
    ye(e.m_center.x + t2, e.m_center.y + n2, 17, s);
    const r2 = !e.isMajor();
    s.addInt32(r2 ? 1 : 0);
    const c3 = e.isClockwise();
    s.addInt32(c3 ? 1 : 0), s.endArray(), s.endObject();
  } else {
    s.startObject(), s.addFieldName("a"), s.startArray(), be2(o, u, a2.x, a2.y, m, l, i, s);
    const t2 = e;
    ye(t2.m_center.x, t2.m_center.y, 17, s);
    const n2 = !t2.isMajor();
    s.addInt32(n2 ? 1 : 0);
...
function pe(e, t, n2, r, i) {
  ...
  return a2 && (u = e.getEndAttributeAsDbl(1, 0)), o && (m = e.getEndAttributeAsDbl(2, 0)), i.startObject(), i.addFieldName("b"), i.startArray(), be2(a2, o, s.x, s.y, u, m, r, i), ye(e.m_cp[0].x, e.m_cp[0].y, r, i), ye(e.m_cp[1].x, e.m_cp[1].y, r, i), i.endArray(), i.endObject(), false;
}
function ke(e, t, n2, r, i) {
  const s = e.getEndXY(), a2 = e.hasAttribute(1) && !t, o = e.hasAttribute(2) && !n2;
  let u = Number.NaN, m = Number.NaN;
  a2 && (u = e.getEndAttributeAsDbl(1, 0)), o && (m = e.getEndAttributeAsDbl(2, 0)), i.startObject(), i.addFieldName("n"), i.startArray(), be2(a2, o, s.x, s.y, u, m, r, i), ye(e.m_cp.x, e.m_cp.y, r, i);
  const l = r;
  return i.addDouble(e.m_weights[0], l), i.addDouble(e.m_weights[1], l), i.addDouble(e.m_weights[2], l), i.endArray(), i.endObject(), false;
}
function be2(e, t, n2, r, i, s, a2, o) {
  o.startArray(), o.addDouble(n2, a2), o.addDouble(r, a2), e && o.addDouble(i, a2), t && o.addDouble(s, a2), o.endArray();
}
function ye(e, t, n2, r) {
...
function Te(t, r, i, a2, o) {
  if (r || i) {
    ...
    null !== i && (a2.addFieldName("spatialReference"), we(t, i, a2)), a2.endObject();
  }
}
function ge(e, t, r, i) {
  const s = r.getImpl(), o = !!(2 & t), u = !!(4 & t), m = !!(8 & t), l = s.hasAttribute(1) && !o, c2 = s.hasAttribute(2) && !u, d = s.hasAttribute(3) && !m, _ = s.hasNonLinearSegments();
  l && (i.addFieldName("hasZ"), i.addBool(true)), c2 && (i.addFieldName("hasM"), i.addBool(true)), e ? _ ? i.addFieldName("curveRings") : i.addFieldName("rings") : _ ? i.addFieldName("curvePaths") : i.addFieldName("paths");
  let h = null;
  const f2 = [];
  if (r.isEmpty()) i.startArray(), i.endArray();
    ...
    _ && (T = s.getSegmentFlagsStreamRef(), g = s.getSegmentIndexStreamRef(), v = s.getSegmentDataStreamRef()), l && (k = s.getAttributeStreamRef(1)), c2 && (b3 = s.getAttributeStreamRef(2)), d && (y = s.getAttributeStreamRef(3), h = j(3, 0));
    for (let t2 = 0; t2 < n2; t2++) {
      i.startArray(), d && f2.push(0);
      ...
      let _2 = p.read(2 * m2), x = p.read(2 * m2 + 1), A2 = l ? k.read(m2) : Number.NaN, S = c2 ? b3.read(m2) : Number.NaN, w = d ? y.read(m2) : 0;
      Ce(l, c2, _2, x, A2, S, e2, i);
      let C2 = 1;
      d && (h.add(w), f2[f2.length - 1]++);
      const D = _2, F = x, j2 = A2, O = S, z2 = w;
      let I = false, E = 0, P2 = Number.NaN, B = Number.NaN, R = 0;
      for (let t3 = m2 + 1, r2 = m2, V = s2 ? n3 + 1 : n3; t3 < V; t3++, r2++) {
        const s3 = null !== T ? 31 & T.read(r2) : 1;
        let m3, V2;
        if (t3 < n3 ? (m3 = p.read(2 * t3), V2 = p.read(2 * t3 + 1), l && (P2 = k.read(t3)), c2 && (B = b3.read(t3)), d && (R = y.read(t3))) : (m3 = D, V2 = F, P2 = j2, B = O, R = z2), 1 !== s3) {
          ...
          t4.setStartXYCoords(_2, x), t4.setEndXYCoords(m3, V2), l && (t4.setStartAttribute(1, 0, A2), t4.setEndAttribute(1, 0, P2)), c2 && (t4.setStartAttribute(2, 0, S), t4.setEndAttribute(2, 0, B)), t4.readFromBufferStream(v, n4);
          he(N.get(), o, u, e2, i) && E++;
        } else Ce(l, c2, m3, V2, P2, B, e2, i);
        d && (h.add(R), f2[f2.length - 1]++), C2++, _2 = m3, x = V2, A2 = P2, S = B, w = R;
      }
      I && 0 === E || (C2 < 2 && E < 1 && (Ce(l, c2, _2, x, A2, S, e2, i), C2++, d && (h.add(w), f2[f2.length - 1]++)), s2 && C2 < 3 && E < 2 && (Ce(l, c2, D, F, j2, O, e2, i), C2++, _2 = D, x = F, A2 = j2, S = O, w = z2, d && (h.add(z2), f2[f2.length - 1]++))), i.endArray(), m2 = n3;
    }
    i.endArray();
  }
  if (d) {
    ...
    let e2 = 0;
    for (let t2 = 0, r2 = f2.length; t2 < r2; ++t2) {
      const r3 = f2[t2];
...
function ve(e, t, r) {
  ...
  if (t.isEmpty()) r.startArray(), r.endArray();
    ...
    for (let e2 = 0; e2 < u; e2++) {
      ...
      let l = Number.NaN, c2 = Number.NaN;
      s && (l = o2.read(e2)), a2 && (c2 = m.read(e2)), Ce(s, a2, i2, u2, l, c2, t2, r);
    }
    r.endArray();
  }
  if (o) {
...
function we(e, t, n2) {
  ...
  if (0 === t.getCoordinateSystemType()) n2.addFieldName("wkid"), n2.addNull(), null !== t.getUnit() && (n2.addFieldName("unit"), Se(e, t.getUnit(), n2));
  else if (r <= 0 || 1 & e) {
    let r2 = "";
...
function Ce(e, t, n2, r, i, s, a2, o) {
  o.startArray(), o.addDouble(n2, a2), o.addDouble(r, a2), e && o.addDouble(i, a2), t && o.addDouble(s, a2), o.endArray();
}
var De = { s_a: "a".charCodeAt(0), s_A: "A".charCodeAt(0), s_asterisk: "*".charCodeAt(0), s_b: "b".charCodeAt(0), s_backslash: "\\".charCodeAt(0), s_beginArray: "[".charCodeAt(0), s_beginObject: "{".charCodeAt(0), s_colon: ":".charCodeAt(0), s_period: ".".charCodeAt(0), s_comma: ",".charCodeAt(0), s_doubleQuote: '"'.charCodeAt(0), s_endArray: "]".charCodeAt(0), s_endObject: "}".charCodeAt(0), s_e: "e".charCodeAt(0), s_E: "E".charCodeAt(0), s_f: "f".charCodeAt(0), s_F: "F".charCodeAt(0), s_forwardslash: "/".charCodeAt(0), s_minus: "-".charCodeAt(0), s_plus: "+".charCodeAt(0), s_n: "n".charCodeAt(0), s_N: "N".charCodeAt(0), s_r: "r".charCodeAt(0), s_t: "t".charCodeAt(0), s_u: "u".charCodeAt(0), s_zero: "0".charCodeAt(0), s_nine: "9".charCodeAt(0) };
var Fe = class {
  constructor(t) {
  ...
  getString_(e) {
    var _a;
    const t = (_a = this.m_jsonString) == null ? void 0 : _a.slice(this.m_startToken, this.m_startToken + e - 1);
    this.m_endToken += e - 1;
  ...
  toUTF8_(e, t) {
    let n2 = 0, r = e;
    for (; t.charCodeAt(r) === De.s_backslash && t.charCodeAt(r + 1) === De.s_u; ) n2++, r += 6;
    r = e;
    const i = new Uint8Array(n2);
    let s = 0;
    for (; t.charCodeAt(r) === De.s_backslash && t.charCodeAt(r + 1) === De.s_u; ) i[s++] = Number.parseInt(t.slice(r + 2, r + 6), 16), r += 6;
  ...
  unquoteCurrentString_() {
    ...
    for (let s = t; s < n2; s++) if (i.charCodeAt(s) !== De.s_backslash) r++;
    else {
      switch (r > 0 && (e += i.slice(t, t + r)), i.charCodeAt(++s)) {
        case De.s_doubleQuote:
          e += '"';
          break;
        case De.s_u: {
  ...
  currentDoubleValue() {
    ...
    if (6 === this.m_currentTokenType) {
      ...
      e = e.slice(1), n2 -= 2, 0 === n2 && P("invalid token");
    }
  ...
  currentInt32Value() {
    ...
    let e = this.m_getCurrentSubstr(), n2 = this.m_endToken - this.m_startToken;
    6 === this.m_currentTokenType && (e = e.slice(1), n2 -= 2, 0 === n2 && P("invalid token"));
    const r = parseInt(e);
  ...
  skipComments_() {
    ...
    this.m_stepOverChar(), this.m_eof() && P("invalid token"), e = this.m_peekChar(), e === De.s_asterisk ? this.skipCStyleComments_() : e === De.s_forwardslash ? this.skipCppStyleComments_() : P("invalid token");
  }
  skipWhiteSpace_() {
    let e;
    do {
      ...
      for (; n2 >= 9 && n2 <= 13 || 32 === n2; ) this.m_increment(), this.m_eof() && P("invalid token"), n2 = this.m_peekChar();
      n2 === De.s_forwardslash ? (this.m_startToken = this.m_endToken, e = true, this.skipComments_()) : e = false;
    } while (e);
  }
  rightBracket_() {
    return this.m_peekChar() === De.s_endArray && (this.m_startToken = this.m_endToken, this.m_increment(), this.m_currentTokenType = 4, true);
  }
  rightBrace_() {
    return this.m_peekChar() === De.s_endObject && (this.m_startToken = this.m_endToken, this.m_increment(), this.m_currentTokenType = 3, true);
  }
  string_() {
    this.m_prepSubstr(), this.m_bHasEscapes = false, this.m_stepOverChar(), this.m_eof() && P("invalid token");
    let e = this.m_peekChar();
    for (; e !== De.s_doubleQuote; ) {
      const n2 = e === De.s_backslash;
      if (this.m_stepOverChar(), this.m_eof() && P("invalid token"), e = this.m_peekChar(), n2) if (this.m_bHasEscapes = true, e === De.s_doubleQuote || e === De.s_backslash || e === De.s_forwardslash || e === De.s_b || e === De.s_f || e === De.s_n || e === De.s_r || e === De.s_t) this.m_stepOverChar(), this.m_eof() && P("invalid token"), e = this.m_peekChar();
      else if (e === De.s_u) for (let r = 0; r < 4; r++) this.m_stepOverChar(), this.m_eof() && P("invalid token"), e = this.m_peekChar(), e >= De.s_zero && e <= De.s_nine || e >= De.s_a && e <= De.s_f || e >= De.s_A && e <= De.s_F || P("invalid token");
      else P("invalid token");
    }
    this.m_stepOverChar();
  }
  comma_() {
    return this.m_peekChar() === De.s_comma && (this.m_increment(), true);
  }
  colon_() {
    return this.m_peekChar() === De.s_colon && (this.m_increment(), true);
  }
  fieldNameEnd_() {
  ...
  fieldNameStart_() {
    ...
    this.m_peekChar() !== De.s_doubleQuote && P("invalid token"), this.string_(), this.m_currentTokenType = 5, this.m_functionStack.push(() => this.fieldNameEnd_());
  }
  pairEnd_() {
  ...
  int_() {
    this.m_peekChar() !== De.s_zero ? this.digits_() : this.m_stepOverChar();
  }
  digits_() {
    let e = this.m_peekChar();
    do {
      this.m_stepOverChar(), this.m_eof() && P("invalid token"), e = this.m_peekChar();
    } while (e >= De.s_zero && e <= De.s_nine);
  }
  frac_() {
    let e = this.m_peekChar();
    this.m_stepOverChar(), this.m_eof() && P("invalid token"), e = this.m_peekChar(), e >= De.s_zero && e <= De.s_nine || P("invalid token"), this.digits_();
  }
  exp_() {
    let e = this.m_peekChar();
    this.m_stepOverChar(), this.m_eof() && P("invalid token"), e = this.m_peekChar(), e !== De.s_plus && e !== De.s_minus || (this.m_stepOverChar(), this.m_eof() && P("invalid token"), e = this.m_peekChar()), e >= De.s_zero && e <= De.s_nine || P("invalid token"), this.digits_();
  }
  valueNumber_() {
    this.m_prepSubstr();
    let e = false, n2 = this.m_peekChar();
    if (n2 === De.s_minus ? (this.m_stepOverChar(), this.m_eof() && P("invalid token"), n2 = this.m_peekChar(), e = true, n2 >= De.s_zero && n2 <= De.s_nine || P("invalid token"), this.int_()) : this.int_(), n2 = this.m_peekChar(), n2 === De.s_period) this.m_currentTokenType = 7, this.frac_(), n2 = this.m_peekChar(), n2 !== De.s_e && n2 !== De.s_E || this.exp_();
    else if (n2 === De.s_e || n2 === De.s_E) this.m_currentTokenType = 7, this.exp_();
    else {
      let t = 0;
      e && t++;
  ...
  valueNull_() {
    ...
    n2 && P("invalid token"), "null" !== e && P("invalid token"), this.m_currentTokenType = 10;
  }
  valueTrue_() {
    const { s: e, bDone: n2 } = this.m_get(5);
    n2 && P("invalid token"), "true" !== e && P("invalid token"), this.m_currentTokenType = 11;
  }
  valueFalse_() {
    const { s: e, bDone: n2 } = this.m_get(6);
    n2 && P("invalid token"), "false" !== e && P("invalid token"), this.m_currentTokenType = 12;
  }
  valueNan_() {
    const { s: e, bDone: n2 } = this.m_get(4);
    n2 && P("invalid token"), "NaN" !== e && P("invalid token"), this.m_currentTokenType = 7;
  }
  value_() {
    this.m_startToken = this.m_endToken;
    const e = this.m_peekChar();
    e === De.s_beginObject ? this.valueStartObject_() : e === De.s_beginArray ? this.valueStartArray_() : e === De.s_doubleQuote ? this.valueString_() : e === De.s_minus || e >= De.s_zero && e <= De.s_zero + 9 ? this.valueNumber_() : e === De.s_n ? this.valueNull_() : e === De.s_t ? this.valueTrue_() : e === De.s_f ? this.valueFalse_() : e === De.s_N ? this.valueNan_() : P("invalid token");
  }
  start_() {
    this.skipWhiteSpace_(), this.m_functionStack.pop(), this.m_functionStack.push(() => this.accept_());
    const e = this.m_peekChar();
    e !== De.s_beginObject && e !== De.s_beginArray && P("invalid token"), this.value_();
  }
  accept_() {
...
var je = class {
  ...
  execute(e, n2, r, i, s, a2, o) {
    let u;
    "string" == typeof r ? (u = new Fe({ jsonString: r }), u.nextToken()) : u = r, 1 !== u.currentToken() && P("failed to import map geometry: start of object is expected");
...
function Pe(e, t) {
  var _a, _b, _c, _d;
  const { includeGeometry: n2 = true, includeSpatialReference: r = true } = t ?? {};
  r && (((_a = e.spatialReference) == null ? void 0 : _a.latestVcsWkid) || ((_b = e.spatialReference) == null ? void 0 : _b.vcsWkid)) && (e = { ...e, spatialReference: { ...e.spatialReference } }, (_c = e.spatialReference) == null ? true : delete _c.latestVcsWkid, (_d = e.spatialReference) == null ? true : delete _d.vcsWkid);
  const i = new L(e, { strict: false });
  return i.nextToken(), Ie.execute(0, a.enumUnknown, i, n2, r);
}
function Be(e) {
  let t = null;
  return [e.map((e2) => {
...
function Re(e) {
  return e.spatialReference instanceof f && (e = { ...e, spatialReference: e.spatialReference.toJSON() }), Pe(e);
}
function Ve(e) {
  return Pe(e, { includeSpatialReference: false }).getGeometry();
}
function Me(e) {
  return e instanceof f && (e = e.toJSON()), Pe({ x: 0, y: 0, spatialReference: e }, { includeGeometry: false }).getSpatialReference();
}
function Ue(e, t) {
  return e instanceof ss && (t = e.getSpatialReference(), e = e.getGeometry()), (e == null ? void 0 : e.isEmpty()) ? null : (Oe.reset(), ze.execute(0, e, t, Oe), Oe.getObject());
}
...
//# sourceMappingURL=chunk-DF2K57V2.js.map
