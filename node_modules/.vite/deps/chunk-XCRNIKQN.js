import {
  o as o3
} from "./chunk-42HHREDE.js";
import {
  c as c2
} from "./chunk-3KNORT6I.js";
import {
  C as C2,
  o as o2
...
var E = new s3();
function G() {
  return !!((v == null ? void 0 : v.isLoaded()) && (P2 == null ? void 0 : P2.isLoaded()) && (A == null ? void 0 : A.isLoaded()));
}
function U2() {
...
async function L(n2) {
  null == k && (k = Promise.all([import("./projectOperator-OIAPWPTV.js").then((n3) => (v = n3, v.load())), import("./projectOperator-BYUJ6TJ5.js").then((n3) => (P2 = n3, P2.load())), import("./geographicTransformationUtils-EU345I66.js").then((n3) => (A = n3, A.load()))])), await k, s2(n2), E.notify();
}
function W(n2, e2, r2) {
...
function B(n2, e2, r2, t2) {
  ...
  if (null == (t2 == null ? void 0 : t2.geographicTransformation) && O2(e2)) {
    return n2.map((n3) => Q(n3, e2, f.WGS84)).map((n3) => F(n3, r2));
  }
  if (null == (t2 == null ? void 0 : t2.geographicTransformation) && O2(r2)) {
    return n2.map((n3) => F(n3, f.WGS84)).map((n3) => Q(n3, f.WGS84, r2));
  }
  if (!G()) throw new q();
  if (!(t2 == null ? void 0 : t2.geographicTransformation)) {
    if (t2 == null ? void 0 : t2.extendedParams) t2 = { ...t2, geographicTransformation: A.getTransformation(e2, r2, t2.areaOfInterestExtent) || new c2() };
    else if (!(t2 == null ? void 0 : t2.areaOfInterestExtent)) {
      const n3 = V(e2, r2);
      let o4 = O3[n3];
...
function V(n2, e2) {
  ...
  return [((_a = n2.wkid) == null ? void 0 : _a.toString()) ?? "-1", ((_b = n2.wkt) == null ? void 0 : _b.toString()) ?? "", ((_c = n2.wkt2) == null ? void 0 : _c.toString()) ?? "", ((_d = e2.wkid) == null ? void 0 : _d.toString()) ?? "-1", ((_e = e2.wkt) == null ? void 0 : _e.toString()) ?? "", ((_f = e2.wkt2) == null ? void 0 : _f.toString()) ?? ""].join();
}
function X(n2, e2) {
  const r2 = Y([n2], e2);
...
function J(n2, e2, r2) {
  return !((r2 == null ? void 0 : r2.areaOfInterestExtent) || (r2 == null ? void 0 : r2.extendedParams) || (r2 == null ? void 0 : r2.geographicTransformation)) && (!!T(n2, e2) || p(n2) && p(e2) && !!C2(n2, e2));
}
function K(n2, e2) {
...
//# sourceMappingURL=chunk-XCRNIKQN.js.map
