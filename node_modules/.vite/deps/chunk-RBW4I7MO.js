...
var _s = class _s {
  ...
  encodeAttributes(t6, e6, o2, n2) {
    ...
    for (const u3 of Object.keys(s2)) {
      const h2 = s2[u3], { type: d5, precisionFactor: f2, isLayout: l3 } = r3[u3], y3 = l3 ? o2.getLayoutProperty(u3) : o2.getPaintProperty(u3), _3 = (_a2 = y3.interpolator) == null ? void 0 : _a2.getInterpolationRange(e6);
      let m2 = 0;
      for (const o3 of h2) {
...
`;
  ...
  _encodePattern(t6, e6, o2) {
    if (!(o2 == null ? void 0 : o2.rect)) return;
...
var h = class _h {
  constructor(t6, e6) {
    ...
    const m2 = (e6 == null ? void 0 : e6.stops) && e6.stops.length > 0;
...
var L2 = class extends m {
  constructor(t6, i4, e6, a6) {
    var _a2, _b, _c3, _d, _e3, _f, _g, _h, _i;
    super(t6, i4, e6, a6);
    const o2 = this.getPaintProperty("line-pattern");
    if (this.lineMaterial = new a3(this.computeAttributesKey(3, a3.ATTRIBUTES, a3.ATTRIBUTES_INFO, o2 ? "line-dasharray" : "")), this.hasDataDrivenLine = ((_a2 = this.getPaintProperty("line-blur")) == null ? void 0 : _a2.isDataDriven) || ((_b = this.getPaintProperty("line-color")) == null ? void 0 : _b.isDataDriven) || ((_c3 = this.getPaintProperty("line-gap-width")) == null ? void 0 : _c3.isDataDriven) || ((_d = this.getPaintProperty("line-offset")) == null ? void 0 : _d.isDataDriven) || ((_e3 = this.getPaintProperty("line-opacity")) == null ? void 0 : _e3.isDataDriven) || ((_f = this.getPaintProperty("line-pattern")) == null ? void 0 : _f.isDataDriven) || ((_g = this.getPaintProperty("line-dasharray")) == null ? void 0 : _g.isDataDriven) || ((_h = this.getLayoutProperty("line-cap")) == null ? void 0 : _h.isDataDriven) || ((_i = this.getPaintProperty("line-width")) == null ? void 0 : _i.isDataDriven), this.canUseThinTessellation = false, !this.hasDataDrivenLine) {
...
var V2 = class {
  constructor(t6, i4, e6) {
    let a6;
    this.allowOverlap = t6.getLayoutValue("icon-allow-overlap", i4), this.ignorePlacement = t6.getLayoutValue("icon-ignore-placement", i4), this.keepUpright = t6.getLayoutValue("icon-keep-upright", i4), this.optional = t6.getLayoutValue("icon-optional", i4), this.rotationAlignment = t6.getLayoutValue("icon-rotation-alignment", i4), 2 === this.rotationAlignment && (this.rotationAlignment = e6 ? 0 : 1), a6 = t6.getLayoutProperty("icon-anchor"), (a6 == null ? void 0 : a6.isDataDriven) ? this._anchorProp = a6 : this.anchor = t6.getLayoutValue("icon-anchor", i4), a6 = t6.getLayoutProperty("icon-offset"), (a6 == null ? void 0 : a6.isDataDriven) ? this._offsetProp = a6 : this.offset = t6.getLayoutValue("icon-offset", i4), a6 = t6.getLayoutProperty("icon-padding"), (a6 == null ? void 0 : a6.isDataDriven) ? this._paddingProp = a6 : this.padding = t6.getLayoutValue("icon-padding", i4), a6 = t6.getLayoutProperty("icon-rotate"), (a6 == null ? void 0 : a6.isDataDriven) ? this._rotateProp = a6 : this.rotate = t6.getLayoutValue("icon-rotate", i4), a6 = t6.getLayoutProperty("icon-size"), (a6 == null ? void 0 : a6.isDataDriven) ? this._sizeProp = a6 : this.size = t6.getLayoutValue("icon-size", i4);
  }
  update(t6, i4) {
...
var T5 = class {
  constructor(t6, i4, e6) {
    let a6;
    this.allowOverlap = t6.getLayoutValue("text-allow-overlap", i4), this.ignorePlacement = t6.getLayoutValue("text-ignore-placement", i4), this.keepUpright = t6.getLayoutValue("text-keep-upright", i4), this.optional = t6.getLayoutValue("text-optional", i4), this.rotationAlignment = t6.getLayoutValue("text-rotation-alignment", i4), 2 === this.rotationAlignment && (this.rotationAlignment = e6 ? 0 : 1), a6 = t6.getLayoutProperty("text-anchor"), (a6 == null ? void 0 : a6.isDataDriven) ? this._anchorProp = a6 : this.anchor = t6.getLayoutValue("text-anchor", i4), a6 = t6.getLayoutProperty("text-justify"), (a6 == null ? void 0 : a6.isDataDriven) ? this._justifyProp = a6 : this.justify = t6.getLayoutValue("text-justify", i4), a6 = t6.getLayoutProperty("text-letter-spacing"), (a6 == null ? void 0 : a6.isDataDriven) ? this._letterSpacingProp = a6 : this.letterSpacing = t6.getLayoutValue("text-letter-spacing", i4), a6 = t6.getLayoutProperty("text-line-height"), (a6 == null ? void 0 : a6.isDataDriven) ? this._lineHeightProp = a6 : this.lineHeight = t6.getLayoutValue("text-line-height", i4), a6 = t6.getLayoutProperty("text-max-angle"), (a6 == null ? void 0 : a6.isDataDriven) ? this._maxAngleProp = a6 : this.maxAngle = t6.getLayoutValue("text-max-angle", i4), a6 = t6.getLayoutProperty("text-max-width"), (a6 == null ? void 0 : a6.isDataDriven) ? this._maxWidthProp = a6 : this.maxWidth = t6.getLayoutValue("text-max-width", i4), a6 = t6.getLayoutProperty("text-offset"), (a6 == null ? void 0 : a6.isDataDriven) ? this._offsetProp = a6 : this.offset = t6.getLayoutValue("text-offset", i4), a6 = t6.getLayoutProperty("text-padding"), (a6 == null ? void 0 : a6.isDataDriven) ? this._paddingProp = a6 : this.padding = t6.getLayoutValue("text-padding", i4), a6 = t6.getLayoutProperty("text-rotate"), (a6 == null ? void 0 : a6.isDataDriven) ? this._rotateProp = a6 : this.rotate = t6.getLayoutValue("text-rotate", i4), a6 = t6.getLayoutProperty("text-size"), (a6 == null ? void 0 : a6.isDataDriven) ? this._sizeProp = a6 : this.size = t6.getLayoutValue("text-size", i4), a6 = t6.getLayoutProperty("text-writing-mode"), (a6 == null ? void 0 : a6.isDataDriven) ? this._writingModeProp = a6 : this.writingMode = t6.getLayoutValue("text-writing-mode", i4);
  }
  update(t6, i4) {
...
function z2(i4) {
  const e6 = i4 == null ? void 0 : i4.getGeometry();
...
var l2 = class _l {
  ...
  getLayerStyleProperties(e6, t6) {
    const r3 = this.getStyleLayerByUID(e6), a6 = 0 !== (r3 == null ? void 0 : r3.getLayoutValue("symbol-placement", t6));
    let i4 = r3 == null ? void 0 : r3.getLayoutValue("icon-rotation-alignment", t6);
    2 === i4 && (i4 = a6 ? 0 : 1);
    let s2 = r3 == null ? void 0 : r3.getLayoutValue("text-rotation-alignment", t6);
    2 === s2 && (s2 = a6 ? 0 : 1);
    const l3 = r3 == null ? void 0 : r3.getPaintValue("icon-translate", t6), n2 = r3 == null ? void 0 : r3.getPaintValue("icon-translate-anchor", t6), y3 = r3 == null ? void 0 : r3.getPaintValue("text-translate", t6), o2 = r3 == null ? void 0 : r3.getPaintValue("text-translate-anchor", t6);
    return { geometryType: null, iconAllowOverlap: r3 == null ? void 0 : r3.getLayoutValue("icon-allow-overlap", t6), iconIgnorePlacement: r3 == null ? void 0 : r3.getLayoutValue("icon-ignore-placement", t6), textAllowOverlap: r3 == null ? void 0 : r3.getLayoutValue("text-allow-overlap", t6), textIgnorePlacement: r3 == null ? void 0 : r3.getLayoutValue("text-ignore-placement", t6), iconRotationAlignment: i4, textRotationAlignment: s2, iconTranslateAnchor: n2, iconTranslate: l3, textTranslateAnchor: o2, textTranslate: y3 };
  }
  ...
  setStyleLayer(e6, t6) {
    if (!(e6 == null ? void 0 : e6.id)) return;
  ...
  _identifyRefLayers() {
    ...
    for (const a6 of this.layers) {
      ...
      if (1 === a6.type) {
        ...
        s2 += "|" + ((i4 == null ? void 0 : i4.visibility) ?? ""), s2 += "|" + a6.minzoom, s2 += "|" + a6.maxzoom, s2 += "|" + JSON.stringify(a6.filter), (t7.hasDataDrivenFill || t7.hasDataDrivenOutline) && (s2 += "|" + r3), e6.push({ key: s2, layer: a6 });
      } else if (2 === a6.type) {
        const e7 = a6, s2 = a6.paint, l3 = null != s2 && (null != s2["line-pattern"] || null != s2["line-dasharray"]);
        let n2 = a6.source + "|" + a6.sourceLayer;
        n2 += "|" + ((i4 == null ? void 0 : i4.visibility) ?? ""), n2 += "|" + a6.minzoom, n2 += "|" + a6.maxzoom, n2 += "|" + JSON.stringify(a6.filter), n2 += "|" + (void 0 !== i4 ? i4["line-cap"] : ""), n2 += "|" + (void 0 !== i4 ? i4["line-join"] : ""), (e7.hasDataDrivenLine || l3) && (n2 += "|" + r3), t6.push({ key: n2, layer: a6 });
      }
      ++r3;
    }
...
//# sourceMappingURL=chunk-RBW4I7MO.js.map
