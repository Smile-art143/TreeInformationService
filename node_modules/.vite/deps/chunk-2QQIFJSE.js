...
function p(e) {
  ...
  return l3 && (p2.nullcount = n.length - m2), !e.percentileParams || ((_a = i2 == null ? void 0 : i2.include) == null ? void 0 : _a.length) && !i2.include.includes("median") || ((_b = i2 == null ? void 0 : i2.exclude) == null ? void 0 : _b.length) && i2.exclude.includes("median") || (p2.median = v(n, e.percentileParams)), p2;
}
function v(e, n) {
...
function C(e, n, t2) {
  var _a, _b;
  let l3;
  for (l3 in e) ((_a = n == null ? void 0 : n.include) == null ? void 0 : _a.length) && !n.include.includes(l3) || ((_b = n == null ? void 0 : n.exclude) == null ? void 0 : _b.length) && n.exclude.includes(l3) ? delete e[l3] : c.includes(l3) && (Number.isFinite(e[l3]) || (e[l3] = null));
...
function P(e, n) {
  ...
  const l3 = t2.length, i2 = (_a = t2[0]) == null ? void 0 : _a.minValue, a3 = (_b = t2[l3 - 1]) == null ? void 0 : _b.maxValue, o2 = "standard-deviation" === n, r2 = u;
  return t2 = t2.map((e2) => {
    const n2 = e2.label, t3 = { minValue: e2.minValue, maxValue: e2.maxValue, label: n2 };
    if (o2 && n2) {
      const e3 = n2.match(r2), l4 = (e3 == null ? void 0 : e3.map((e4) => +e4.trim())) ?? [];
...
//# sourceMappingURL=chunk-2QQIFJSE.js.map
