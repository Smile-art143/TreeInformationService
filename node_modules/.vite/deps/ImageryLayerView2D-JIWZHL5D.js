...
var g = class extends b {
  ...
  async _fetchImage(t, e3, i7, r2) {
    ...
    const n3 = new l2(p, (_a = o2.extent) == null ? void 0 : _a.clone(), l3);
...
var x = class extends b {
  ...
  getPixelData() {
    var _a;
    const t = (_a = this.container.children[0]) == null ? void 0 : _a.rawPixelData;
  ...
  _updateSymbolizerParams(t) {
    "vector-field" === (t == null ? void 0 : t.type) && (this._symbolizerParams = this.layer.symbolizer.generateWebGLParameters({ pixelBlock: null }));
  }
};
...
var y = (y2) => {
  ...
  let f = class extends d4 {
    ...
    async fetchPopupFeaturesAtLocation(e3, o2) {
      ...
      const { resolution: d5, spatialReference: f2 } = this.view, h = "2d" === this.view.type ? new _(d5, d5, f2) : new _(0.5 * d5, 0.5 * d5, f2), { returnTopmostRaster: w2, showNoDataRecords: R } = l3.layerOptions || { returnTopmostRaster: true, showNoDataRecords: false }, j2 = { returnDomainValues: true, returnTopmostRaster: w2, pixelSize: h, showNoDataRecords: R, signal: o2 == null ? void 0 : o2.signal };
...
var _3 = class extends y(i4(b3(d2))) {
  ...
  update(i7) {
    var _a;
    (_a = this.subview) == null ? void 0 : _a.update(i7);
  }
  attach() {
  ...
  highlight(i7, h) {
    ...
    const o2 = a3 == null ? void 0 : a3.filter(N);
    if (!(o2 == null ? void 0 : o2.length)) return e();
    const l3 = r(h);
  ...
  isUpdating() {
    var _a, _b;
    const i7 = !this.subview || this.subview.updating || !!((_a = this._highlightView) == null ? void 0 : _a.updating);
...
`), i7;
  ...
  _processHighlight() {
    ...
    (_a = this._highlightView) == null ? void 0 : _a.setHighlight(i7);
  }
  _setSubView() {
    var _a, _b;
    if (!this.view) return;
    const i7 = (_a = this.layer.renderer) == null ? void 0 : _a.type;
    let t = "imagery";
  ...
  _detachSubview(i7) {
    (i7 == null ? void 0 : i7.attached) && (this.container.removeChild(i7.container), i7.detach(), i7.attached = false);
  }
  _updateHighlightOptions(i7) {
    ...
    const e3 = this._pixelHighlights.map(({ target: i8, options: e4 }) => {
      var _a;
      const s5 = r(e4), r2 = ((_a = t.find((i9) => i9.name === s5)) == null ? void 0 : _a.color) ?? e2, { pixelRanges: h, bandId: a3 } = i8;
      return { ranges: h, bandId: a3 ?? 0, color: r2.toArray() };
    });
    "imagery" === (i7 == null ? void 0 : i7.type) && (i7.pixelHighlights = e3, i7.attached && ("lerc" === this.layer.format ? i7.redraw() : this.requestUpdate()));
  }
};
...
//# sourceMappingURL=ImageryLayerView2D-JIWZHL5D.js.map
