...
var g = (_a = class extends l(n) {
  ...
  get transparent() {
    const { data: t, url: e } = this, a3 = (t2) => (t2 == null ? void 0 : t2.toLowerCase().endsWith(".png")) || (t2 == null ? void 0 : t2.toLocaleLowerCase().startsWith("data:image/png;"));
  ...
  clone(t) {
    var _a2, _b;
    const e = u2(t), a3 = (_a2 = e == null ? void 0 : e.textureMap) == null ? void 0 : _a2.get(this);
    if (a3) return a3;
    const r3 = super.clone(t);
    return (_b = e == null ? void 0 : e.textureMap) == null ? void 0 : _b.set(this, r3), r3;
  }
  static from(t) {
...
var n2 = class extends l(n) {
  ...
  clone(o2) {
    var _a2, _b;
    const r3 = r2(o2), e = (_a2 = r3 == null ? void 0 : r3.materialMap) == null ? void 0 : _a2.get(this);
    if (e) return e;
    const t = super.clone(a2(o2));
    return (_b = r3 == null ? void 0 : r3.materialMap) == null ? void 0 : _b.set(this, t), t;
  }
  get memoryUsage() {
...
//# sourceMappingURL=chunk-5WTDLRCB.js.map
