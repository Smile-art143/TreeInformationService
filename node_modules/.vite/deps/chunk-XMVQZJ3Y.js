...
function g(e2, s4, o2) {
  ...
  for (let u3 = 0; u3 < l3.length; u3++) {
    ...
    if (null == e3) continue;
    const c4 = ((_a = i3 == null ? void 0 : i3[u3]) == null ? void 0 : _a.minValue) ?? b2[0], m3 = ((_b = i3 == null ? void 0 : i3[u3]) == null ? void 0 : _b.maxValue) ?? b2[1];
    if (c4 > e3 + Number.EPSILON || m3 < e3 - Number.EPSILON) continue;
    const p2 = f2[u3] || a4.slice(), d = l3[u3], N = o2 == null ? void 0 : o2.customFloatTolerance;
    if (h2 && 0 !== N) {
      let u4 = N;
  ...
  if (g2) {
    ...
    (o2 == null ? void 0 : o2.matchAllNoData) ? e2.mask = t2 && t2.length > 1 ? m2(t2) : a4 : (e2.bandMasks = t2, e2.mask = a4);
  }
  function m2(t2) {
...
var c2 = p = class extends n {
  ...
  extractBands(t2) {
    ...
    const o2 = ((_a = this.bandMasks) == null ? void 0 : _a.length) === i3 ? t2.map((t3) => this.bandMasks[t3]) : void 0;
    let { mask: a4, validPixelCount: n3 } = this;
    const { width: h2, height: c3 } = this;
    return (o2 == null ? void 0 : o2.length) && (a4 = p.combineBandMasks(o2), n3 = a4.filter((t3) => !!t3).length), new p({ pixelType: this.pixelType, width: h2, height: c3, mask: a4, bandMasks: o2, validPixelCount: n3, maskIsAlpha: this.maskIsAlpha, pixels: t2.map((t3) => s4[t3]), statistics: e2 && t2.map((t3) => e2[t3]) });
  }
  clone() {
  ...
  _fillFrom8Bit(t2) {
    ...
    if (!t2 || !(r2 == null ? void 0 : r2.length)) return void i.getLogger(this).error("getAsRGBA()", "Unable to convert to RGBA. The input pixel block is empty.");
    let o2, a4, n3, h2;
  ...
  _fillFromNon8Bit(t2) {
    ...
    if (!t2 || !(s4 == null ? void 0 : s4.length)) return void i.getLogger(this).error("getAsRGBA()", "Unable to convert to RGBA. The input pixel block is empty.");
  ...
  _fillFrom32Bit(t2) {
    ...
    if (!t2 || !(s4 == null ? void 0 : s4.length)) return i.getLogger(this).error("getAsRGBAFloat()", "Unable to convert to RGBA. The input pixel block is empty.");
    let i3, r2, o2, a4;
...
//# sourceMappingURL=chunk-XMVQZJ3Y.js.map
