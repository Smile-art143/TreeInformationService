import {
  n as n4
} from "./chunk-MH5YHRZM.js";
import {
  S as S2
} from "./chunk-CIZLDL5O.js";
import {
  n as n2
} from "./chunk-VZKO76VW.js";
import {
  c
...
var h = (h3) => {
  ...
  let b2 = class extends f4 {
    ...
    readCapabilities(e4, r4) {
      ...
      const s9 = this.type, o3 = "tile" !== s9 && !!r4.supportsDynamicLayers, a4 = t2.includes("query"), p4 = t2.includes("map"), l6 = !!r4.exportTilesAllowed, n5 = t2.includes("tilemap"), c5 = t2.includes("data"), u4 = "tile" !== s9 && (!r4.tileInfo || o3), y3 = "tile" !== s9 && (!r4.tileInfo || o3), d2 = "tile" !== s9, m6 = "tile" !== s9 && o3 && r4.currentVersion >= 11.1, h4 = r4.cimVersion ? r3.parse(r4.cimVersion) : null, f5 = (h4 == null ? void 0 : h4.greaterEqual(1, 4)) ?? false, b3 = (h4 == null ? void 0 : h4.greaterEqual(2, 0)) ?? false;
    ...
    async fetchRelatedService(e4) {
      ...
      return s2(e4), t2 ? { itemId: t2.id, url: t2.url } : null;
    }
    async fetchSublayerInfo(e4, t2) {
      var _a2;
      const { source: s9 } = e4;
      if ((this == null ? void 0 : this.portalItem) && "tile" === this.type && "map-layer" === (s9 == null ? void 0 : s9.type) && a3(this.portalItem) && e4.originIdOf("url") < 2) {
      ...
      if ("data-layer" === s9.type) {
        ...
        const e5 = await this._fetchAllLayersAndTablesFromService(i7), r4 = ((_a2 = p(i7)) == null ? void 0 : _a2.sublayer) ?? s9.mapLayerId;
        a4 = e5.get(r4);
      } catch {
      }
      else {
        let r4 = e4.id;
        "map-layer" === (s9 == null ? void 0 : s9.type) && (r4 = s9.mapLayerId);
        try {
    ...
    async fetchAllLayersAndTables(e4) {
      var _a2;
      return this._fetchAllLayersAndTablesFromService((_a2 = this.parsedUrl) == null ? void 0 : _a2.path, e4);
    }
    async _fetchAllLayersAndTablesFromService(e4, i7) {
      await this.load(i7), this._allLayersAndTablesMap || (this._allLayersAndTablesMap = /* @__PURE__ */ new Map());
      const a4 = p(e4), p4 = e(this._allLayersAndTablesMap, a4 == null ? void 0 : a4.url.path, () => H(V(a4 == null ? void 0 : a4.url.path, "/layers"), { responseType: "json", query: { f: "json", ...this.customParameters, token: this.apiKey } }).then((e5) => {
        const r4 = /* @__PURE__ */ new Map(), { layers: t2, tables: s9 } = e5.data, o3 = [...t2 ?? [], ...s9 ?? []];
        for (const i8 of o3) r4.set(i8.id, i8);
        return { result: r4 };
      }, (e5) => ({ error: e5 }))), l6 = await p4;
      if (s2(i7), "result" in l6) return l6.result;
      throw l6.error;
    }
  };
...
var X;
function Y(e4) {
  return "esriSMS" === (e4 == null ? void 0 : e4.type);
}
...
function ee(e4, r4, t2) {
  ...
  return { ignoreOrigin: true, allowNull: i7, enabled: !!t2 && ("map-image" === ((_a2 = t2.layer) == null ? void 0 : _a2.type) && (t2.writeSublayerStructure || i7)) };
}
function re(e4, r4, t2) {
  var _a2;
  return { enabled: !!t2 && ("tile" === ((_a2 = t2.layer) == null ? void 0 : _a2.type) && (Z2(this, r4, t2) || this._isOverridden(r4))) };
}
function te(e4, r4, t2) {
  return { ignoreOrigin: true, enabled: t2 && t2.writeSublayerStructure || false };
}
function ie(e4, r4, t2) {
  return { ignoreOrigin: true, enabled: !!(t2 == null ? void 0 : t2.writeSublayerStructure) && this.originIdOf(r4) > 2 };
}
...
var le = (_a = class extends l2(s5(u)) {
  ...
  readCapabilities(e4, r4) {
    ...
    return { attachment: { supportsOrderByFields: (t2 == null ? void 0 : t2.supportsOrderByFields) ?? false, supportsResize: (t2 == null ? void 0 : t2.supportsResize) ?? false, supportsTypeWildcard: (t2 == null ? void 0 : t2.supportsTypeWildcard) ?? false }, exportMap: { supportsModification: !!r4.canModifyLayer }, operations: { supportsQuery: i7, supportsQueryAttachments: o3 }, data: { supportsAttachment: n5 }, query: { supportsFormatPBF: s9, supportsOrderBy: a4, supportsPagination: l6 }, queryRelated: p4 };
  }
  ...
  set id(e4) {
    var _a2, _b, _c;
    this._get("id") !== e4 && (false !== ((_c = (_b = (_a2 = this.layer) == null ? void 0 : _a2.capabilities) == null ? void 0 : _b.exportMap) == null ? void 0 : _c.supportsDynamicLayers) ? this._set("id", e4) : this._logLockedError("id", "capability not available 'layer.capabilities.exportMap.supportsDynamicLayers'"));
  }
  readIsTable(e4, r4) {
  ...
  set layer(e4) {
    var _a2;
    this._set("layer", e4), (_a2 = this.sublayers) == null ? void 0 : _a2.forEach((r4) => r4.layer = e4);
  }
  set listMode(e4) {
  ...
  readMinScale(e4, r4) {
    var _a2;
    return r4.minScale || ((_a2 = r4.layerDefinition) == null ? void 0 : _a2.minScale) || 0;
  }
  set maxScale(e4) {
  ...
  readMaxScale(e4, r4) {
    var _a2;
    return r4.maxScale || ((_a2 = r4.layerDefinition) == null ? void 0 : _a2.maxScale) || 0;
  }
  readObjectIdFieldFromService(e4, r4) {
    var _a2;
    if ((r4 = r4.layerDefinition || r4).objectIdField) return r4.objectIdField;
    const t2 = (_a2 = r4.fields) == null ? void 0 : _a2.find((e5) => "esriFieldTypeOID" === e5.type);
  ...
  readOpacity(e4, r4) {
    ...
    return 1 - 0.01 * ((t2 == null ? void 0 : t2.transparency) ?? ((_a2 = t2 == null ? void 0 : t2.drawingInfo) == null ? void 0 : _a2.transparency) ?? 0);
  }
  ...
  get queryTask() {
    var _a2;
    if (!this.layer) return null;
    const { capabilities: e4, fieldsIndex: r4, layer: t2, url: i7 } = this, { spatialReference: o3 } = t2, s9 = "gdbVersion" in t2 ? t2.gdbVersion : void 0, a4 = has("featurelayer-pbf") && (e4 == null ? void 0 : e4.query.supportsFormatPBF);
    return new S2({ fieldsIndex: r4, gdbVersion: s9, pbfSupported: a4, queryAttachmentsSupported: ((_a2 = e4 == null ? void 0 : e4.operations) == null ? void 0 : _a2.supportsQueryAttachments) ?? false, sourceSpatialReference: o3, url: i7 });
  }
  set renderer(e4) {
  ...
  writeSublayers(e4, r4, t2) {
    var _a2;
    ((_a2 = this.sublayers) == null ? void 0 : _a2.length) && (r4[t2] = this.sublayers.map((e5) => e5.id).toArray().reverse());
  }
  readTitle(e4, r4) {
    var _a2;
    return ((_a2 = r4.layerDefinition) == null ? void 0 : _a2.name) ?? r4.name;
  }
  ...
  get url() {
    var _a2;
    const e4 = ((_a2 = this.layer) == null ? void 0 : _a2.parsedUrl) ?? this._lastParsedUrl, r4 = this.source;
    if (!e4) return null;
    if (this._lastParsedUrl = e4, "map-layer" === (r4 == null ? void 0 : r4.type)) return `${e4.path}/${r4.mapLayerId}`;
  ...
  async createFeatureLayer() {
    ...
    const e4 = (await import("./FeatureLayer-FJGPCTQR.js")).default, { layer: r4, url: t2 } = this;
    let i7;
    if (t2 && this.originIdOf("url") > 2) i7 = new e4({ url: t2 });
    else {
      if (!(r4 == null ? void 0 : r4.parsedUrl)) throw new s("createFeatureLayer:missing-information", "Cannot create a FeatureLayer without a url or a parent layer");
      {
  ...
  getFieldDomain(e4, r4) {
    const t2 = r4 == null ? void 0 : r4.feature, i7 = this.getFeatureType(t2);
    if (i7) {
  ...
  async queryAttachments(e4, r4) {
    ...
    if (!((_a2 = t2 == null ? void 0 : t2.data) == null ? void 0 : _a2.supportsAttachment)) throw new s("queryAttachments:not-supported", "this layer doesn't support attachments");
    ...
    if (!((_b = t2 == null ? void 0 : t2.operations) == null ? void 0 : _b.supportsQueryAttachments)) {
      if ((i7 == null ? void 0 : i7.length) > 0 || (a4 == null ? void 0 : a4.length) > 0 || (n5 == null ? void 0 : n5.length) > 0 || l6 || p4 || u4) throw new s("queryAttachments:option-not-supported", "when 'capabilities.operations.supportsQueryAttachments' is false, only objectIds is supported", e4);
    }
    if (!((s9 == null ? void 0 : s9.length) || (a4 == null ? void 0 : a4.length) || u4)) throw new s("queryAttachments:invalid-query", "'objectIds', 'globalIds', or 'where' are required to perform attachment query", e4);
    return !((_c = t2 == null ? void 0 : t2.attachment) == null ? void 0 : _c.supportsOrderByFields) && ((_d = e4.orderByFields) == null ? void 0 : _d.length) && ((e4 = e4.clone()).orderByFields = null), this.queryTask.executeAttachmentQuery(e4, r4);
  }
  async queryFeatureCount(e4 = this.createQuery(), r4) {
    var _a2, _b;
    if (await this.load(), !this.capabilities.operations.supportsQuery) throw new s("queryFeatureCount:not-supported", "this layer doesn't support queries.");
    if (!this.url) throw new s("queryFeatureCount:not-supported", "this layer has no url.");
    const t2 = (_a2 = this.layer) == null ? void 0 : _a2.apiKey;
    return await this.queryTask.executeForCount(e4, { ...r4, query: { ...(_b = this.layer) == null ? void 0 : _b.customParameters, token: t2 } });
  }
  async queryFeatures(e4 = this.createQuery(), r4) {
    var _a2, _b;
    if (await this.load(), !this.capabilities.operations.supportsQuery) throw new s("queryFeatures:not-supported", "this layer doesn't support queries.");
    if (!this.url) throw new s("queryFeatures:not-supported", "this layer has no url.");
    const t2 = await this.queryTask.execute(e4, { ...r4, query: { ...(_a2 = this.layer) == null ? void 0 : _a2.customParameters, token: (_b = this.layer) == null ? void 0 : _b.apiKey } });
    if (t2 == null ? void 0 : t2.features) {
  ...
  async queryObjectIds(e4 = this.createQuery(), r4) {
    var _a2, _b;
    if (await this.load(), !this.capabilities.operations.supportsQuery) throw new s("queryObjectIds:not-supported", "this layer doesn't support queries.");
    if (!this.url) throw new s("queryObjectIds:not-supported", "this layer has no url.");
    const t2 = (_a2 = this.layer) == null ? void 0 : _a2.apiKey;
    return await this.queryTask.executeForIds(e4, { ...r4, query: { ...(_b = this.layer) == null ? void 0 : _b.customParameters, token: t2 } });
  }
  async queryRelatedFeatures(e4, r4) {
    var _a2, _b;
    if (await this.load(), !this.capabilities.operations.supportsQuery) throw new s("queryRelatedFeatures:not-supported", "this layer doesn't support queries.");
    if (!this.url) throw new s("queryRelatedFeatures:not-supported", "this layer has no url.");
    const t2 = (_a2 = this.layer) == null ? void 0 : _a2.apiKey;
    return await this.queryTask.executeRelationshipQuery(e4, { ...r4, query: { ...(_b = this.layer) == null ? void 0 : _b.customParameters, token: t2 } });
  }
  async queryRelatedFeaturesCount(e4, r4) {
    var _a2, _b;
    if (await this.load(), !this.capabilities.operations.supportsQuery) throw new s("queryRelatedFeaturesCount:not-supported", "this layer doesn't support queries.");
    ...
    const t2 = (_a2 = this.layer) == null ? void 0 : _a2.apiKey;
    return await this.queryTask.executeRelationshipQueryForCount(e4, { ...r4, query: { ...(_b = this.layer) == null ? void 0 : _b.customParameters, token: t2 } });
  }
  async reload(e4) {
    if ("not-loaded" === this.loadStatus) return this.load(e4).then(() => {
    });
    const { layer: r4, url: i7 } = this;
    if (!r4 && !i7) throw new s("sublayer:missing-layer", "Sublayer can't be loaded without being part of a layer", { sublayer: this });
  ...
  toExportImageJSON(e4) {
    ...
    const r4 = { id: this.id, source: ((_a2 = this.source) == null ? void 0 : _a2.toJSON()) || { mapLayerId: this.id, type: "mapLayer" } }, t2 = l3(e4, this.definitionExpression);
    ...
    if (o3) {
      ...
      if (i7.renderer > 2 && (e5.renderer = this.renderer ? this.renderer.toJSON() : null), i7.labelsVisible > 2 && (e5.showLabels = this.labelsVisible), this.labelsVisible && i7.labelingInfo > 2) if (this.labelingInfo) {
        !this.loaded && ((_b = this.labelingInfo) == null ? void 0 : _b.some((e6) => !e6.labelPlacement)) && i.getLogger(this).warnOnce(`A Sublayer (title: ${this.title}, id: ${this.id}) has an undefined 'labelPlacement' and so labels cannot be displayed. Either define a valid 'labelPlacement' or call Sublayer.load() to use a default value based on geometry type.`, { sublayer: this });
    ...
    return (((_e = (_d = (_c = this.layer) == null ? void 0 : _c.capabilities) == null ? void 0 : _d.exportMap) == null ? void 0 : _e.supportsSublayerOrderBy) ?? false) && this.originIdOf("orderBy") > 2 && (r4.orderBy = ((_f = this.orderBy) == null ? void 0 : _f.map((e5) => e5.toJSON())) ?? null), r4;
  }
  _assignDefaultSymbolColors(e4) {
    this._forEachSimpleMarkerSymbols(e4, (e5) => {
      var _a2;
      e5.color || "esriSMSX" !== e5.style && "esriSMSCross" !== e5.style || (((_a2 = e5.outline) == null ? void 0 : _a2.color) ? e5.color = e5.outline.color : e5.color = [0, 0, 0, 0]);
    });
  }
  ...
  _setAndNotifyLayer(e4, r4) {
    ...
    if ("service" !== a4) {
      if (o3 && false === ((_c = (_b = (_a2 = this.layer) == null ? void 0 : _a2.capabilities) == null ? void 0 : _b.exportMap) == null ? void 0 : _c[o3])) return void this._logLockedError(e4, `capability not available 'layer.capabilities.exportMap.${o3}'`);
      if (s9 && false === ((_d = this.capabilities) == null ? void 0 : _d.exportMap[s9])) return void this._logLockedError(e4, `capability not available 'capabilities.exportMap.${s9}'`);
    }
    "source" !== e4 || "not-loaded" === this.loadStatus ? (this._set(e4, r4), "service" !== a4 && i7 !== r4 && (t2 == null ? void 0 : t2.emit) && t2.emit("sublayer-update", { propertyName: e4, target: this })) : this._logLockedError(e4, "'source' can't be changed after calling sublayer.load()");
  }
  _handleSublayersChange(e4, r4) {
    r4 && (r4.forEach((e5) => {
      ...
      var _a2, _b, _c;
      (((_c = (_b = (_a2 = this.layer) == null ? void 0 : _a2.capabilities) == null ? void 0 : _b.exportMap) == null ? void 0 : _c.supportsSublayersChanges) ?? 1) || (i.getLogger(this).error(new s("sublayer:sublayers-non-modifiable", "Sublayer can't be added, moved, or removed from the layer's sublayers", { sublayer: this, layer: this.layer })), e5.preventDefault());
    })]));
  }
  _logLockedError(e4, r4) {
    const { layer: t2, declaredClass: i7 } = this;
    i.getLogger(i7).error(new s("sublayer:locked", `Property '${String(e4)}' can't be changed on Sublayer from the layer '${t2 == null ? void 0 : t2.id}'`, { reason: r4, sublayer: this, layer: t2 }));
  }
  _getLayerDomain(e4) {
    var _a2;
    return ((_a2 = this.fieldsIndex.get(e4)) == null ? void 0 : _a2.domain) ?? null;
  }
  ...
  let v = class extends S3 {
    ...
    createSublayersForOrigin(e4) {
      ...
      for (const y3 of n5) {
        ...
        e5 && (u4 = { layers: e5, context: t3 }, r4 ?? (r4 = y3)), s10 && (l6 = { visibleLayers: s10, context: t3 });
      }
      const b2 = p3(o3, a4), m7 = /* @__PURE__ */ new Map(), S4 = /* @__PURE__ */ new Set();
      if (u4) for (const y3 of u4.layers) m7.set(y3.id, y3);
      if (l6 == null ? void 0 : l6.visibleLayers) for (const y3 of l6.visibleLayers) S4.add(y3);
      return f3(b2, (e5) => {
    ...
    _handleSublayersChange(e4, r4) {
      r4 && (r4.forEach((e5) => {
        ...
        i.getLogger("esri.layers.TileLayer").error(new s("tilelayer:sublayers-non-modifiable", "Sublayer can't be added, moved, or removed from the layer's sublayers", { layer: this })), e5.preventDefault();
      }), "sublayers-owner"));
    }
  };
...
//# sourceMappingURL=chunk-BEDBRPAB.js.map
