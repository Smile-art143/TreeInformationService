...
import {
  isActivationKey
} from "./chunk-MPGW2LBV.js";
import {
  html as html2,
  literal,
  unsafeStatic
} from "./chunk-XRUWNQ24.js";
import {
  keyed
...
function createFocusTrapOptions(hostEl, options) {
  const fallbackFocus = (options == null ? void 0 : options.fallbackFocus) || hostEl;
  const clickOutsideDeactivates = (options == null ? void 0 : options.clickOutsideDeactivates) ?? true;
  return {
    fallbackFocus,
    ...options,
    ...
    setReturnFocus: (el) => {
      const returnFocusTarget = typeof (options == null ? void 0 : options.setReturnFocus) === "function" ? options.setReturnFocus(el) : options == null ? void 0 : options.setReturnFocus;
...
function getEffectiveContainerElements(targetEl, { focusTrapOptions }, extraContainers) {
  if (!(focusTrapOptions == null ? void 0 : focusTrapOptions.extraContainers) && !extraContainers) {
    return targetEl;
  }
  return [targetEl, ...toContainerArray(focusTrapOptions == null ? void 0 : focusTrapOptions.extraContainers), ...toContainerArray(extraContainers)];
}
    ...
    const utils = {
      activate: () => {
        ...
        if (!focusTrap) {
          ...
          effectiveContainers || (effectiveContainers = getEffectiveContainerElements(targetEl, component));
      ...
      deactivate: () => focusTrap == null ? void 0 : focusTrap.deactivate(),
      ...
      updateContainerElements: () => {
        return focusTrap == null ? void 0 : focusTrap.updateContainerElements(effectiveContainers);
      }
    };
    return utils;
  });
...
var _ActionMenu = class _ActionMenu extends LitElement {
  ...
  renderMenuItems() {
    ...
    return html`<calcite-popover auto-close .flipPlacements=${flipPlacements} focus-trap-disabled .label=${label} offset-distance=0 @calcitePopoverClose=${this.handlePopoverClose} @calcitePopoverOpen=${this.handlePopoverOpen} .overlayPositioning=${overlayPositioning} .placement=${placement} pointer-disabled .referenceElement=${menuButtonEl} trigger-disabled ${ref(this.setPopoverEl)}><div aria-activedescendant=${activeDescendantId ?? nothing} aria-labelledby=${(menuButtonEl == null ? void 0 : menuButtonEl.id) ?? nothing} class=${safeClassMap(CSS2.menu)} id=${menuId ?? nothing} @click=${this.handleCalciteActionClick} role=menu tabindex=-1><slot @slotchange=${this.handleDefaultSlotChange}></slot></div></calcite-popover>`;
  }
  render() {
...
focus-trap/dist/focus-trap.esm.js:
  ...
  *)
*/
//# sourceMappingURL=chunk-VEPUK3PW.js.map
