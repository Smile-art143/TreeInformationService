...
var w = class extends o4 {
  ...
  _writePlacedMarkers(s9, n5) {
    var _a;
    const o9 = (_a = a2.fromFeatureSetReaderCIM(n5)) == null ? void 0 : _a.clone();
    if (!o9) return;
...
var F2 = class extends E {
  ...
  _write(e4, t, i7, r8) {
    ...
    switch (t.geometryType) {
      ...
      case "esriGeometryMultipoint": {
        ...
        if (r9 == null ? void 0 : r9.nextPath()) for (; r9.nextPoint(); ) this._writePoint(e4, r9.x, r9.y, i8++, t);
        break;
      }
  ...
  _createLineLabelMetric(e4, t, i7, r8, s9, o9) {
    var _a, _b;
    const [n5, a8] = this._getMetricDir(), l8 = ((_a = this.evaluatedMeshParams.scaleInfo) == null ? void 0 : _a.maxScale) ?? 0, c4 = ((_b = this.evaluatedMeshParams.scaleInfo) == null ? void 0 : _b.minScale) ?? 0, h6 = this.evaluatedMeshParams.labelClassId;
  ...
  _writePoint(e4, t, i7, r8, s9) {
    ...
    if (!o9) return;
    const n5 = s9.getDisplayId(), a8 = this.evaluatedMeshParams.labelClassId, l8 = A(this.evaluatedMeshParams.layerId, s9.getObjectId(), r8), c4 = G(s9.getObjectId(), a8, r8), [h6, m3] = this._getMetricDir(), d4 = ((_a = this.evaluatedMeshParams.scaleInfo) == null ? void 0 : _a.maxScale) ?? 0, u7 = ((_b = this.evaluatedMeshParams.scaleInfo) == null ? void 0 : _b.minScale) ?? 0, f6 = this._getPointReferenceBounds() || { offsetX: 0, offsetY: 0, size: 0 };
...
//# sourceMappingURL=chunk-KZ4OBZYG.js.map
