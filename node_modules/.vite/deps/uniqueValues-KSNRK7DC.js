import {
  n as n5
} from "./chunk-IASPG3KY.js";
import {
  a as a4
} from "./chunk-7FRTD4NI.js";
import {
  t
} from "./chunk-GXHVBZWK.js";
...
import {
  ...
  m3 as m6,
  n as n4
} from "./chunk-WZ3YWZUG.js";
import "./chunk-GJSFCKWY.js";
...
import {
  ...
  c,
  w
} from "./chunk-JLLB3PE4.js";
import {
  s as s3
} from "./chunk-BPSN5NKI.js";
...
async function c4(t2, o4, r4, e3, n8) {
  var _a;
  const i6 = { ...e3 }, u6 = p7(o4, r4), f3 = null != ((_a = o4.outStatistics) == null ? void 0 : _a[0]), c6 = has("featurelayer-pbf-statistics"), m10 = !f3 || c6;
  let d4;
  if ("pbf" === (r4 == null ? void 0 : r4.format) && m10) try {
    d4 = await n5(t2, u6, i6, n8);
  } catch (y) {
    if ("query:parsing-pbf" !== y.name) throw y;
    r4.format = "json";
  }
  return "json" !== (r4 == null ? void 0 : r4.format) && m10 || (d4 = await a4(t2, u6, i6, n8)), l2(r4 == null ? void 0 : r4.fieldsIndex, d4.fields), d4;
}
function l2(t2, o4) {
...
async function m8(t2, r4, e3, n8) {
  var _a;
  const s8 = e3 == null ? void 0 : e3.infoFor3D;
  if (!d3(t2, s8) || null == s8 || !r4.assetMaps || !((_a = r4.features) == null ? void 0 : _a.length)) return g2.fromJSON(r4);
  const { meshFeatureSetFromJSON: a5 } = await p(import("./meshFeatureSet-T2HMBD72.js"), n8);
  return a5(t2, s8, r4);
}
function p7(o4, s8) {
  let a5 = b.from(o4);
  a5.sourceSpatialReference = a5.sourceSpatialReference ?? (s8 == null ? void 0 : s8.sourceSpatialReference) ?? null, ((s8 == null ? void 0 : s8.gdbVersion) || (s8 == null ? void 0 : s8.dynamicDataSource)) && (a5 = a5 === o4 ? a5.clone() : a5, a5.gdbVersion = o4.gdbVersion || s8.gdbVersion, a5.dynamicDataSource = o4.dynamicDataSource ? R.from(o4.dynamicDataSource) : s8.dynamicDataSource);
  const i6 = s8 == null ? void 0 : s8.infoFor3D;
  if (null != i6 && d3(o4, i6)) {
...
async function l3(t2, i6, s8, a5) {
  ...
  let m10 = null;
  if (m10 = "class-breaks-definition" === (c6 == null ? void 0 : c6.type) ? c6.classificationField : c6 == null ? void 0 : c6.attributeField, o4) {
    const e3 = { source: o4 == null ? void 0 : o4.toJSON() };
...
function r2(e3, t2) {
  const { field: n8, checkValueRange: l4, url: r4 } = e3, u6 = t2 == null ? void 0 : t2.data;
  if (!u6) return;
  if (!l4) {
    const e4 = o(u6);
...
function o(e3, n8, i6) {
  ...
  return { uniqueValues: (s8 == null ? void 0 : s8.map((e4, t2) => (0 === t2 && null != n8 && (e4.value = n8), t2 === s8.length - 1 && null != i6 && (e4.value = i6), { count: e4.count, value: e4.value, label: e4.label }))) ?? [] };
}
...
function z2(t2, e3) {
  var _a;
  const n8 = [], i6 = t2.layer, l4 = "featureReduction" in i6 ? i6.featureReduction : null, o4 = "binning" === (l4 == null ? void 0 : l4.type), r4 = null != l4 && "fields" in l4 ? (_a = l4.fields) == null ? void 0 : _a.map((t3) => {
    var _a2;
    return (_a2 = t3.name) == null ? void 0 : _a2.toLowerCase();
  }).filter(Boolean) : [];
  if (!o4 || !e3) return n8;
...
function j3(t2, e3, n8) {
  ...
  if (e3) for (const l4 of e3) {
    ...
    e4 && n8 && "availableFields" in n8 && !((_a = n8.availableFields) == null ? void 0 : _a.includes(e4.name)) && i6.push(e4.name);
  }
  return i6;
}
function q2(t2, e3) {
  ...
  if (0 === (n8 == null ? void 0 : n8.length)) return { avg: null, count: 0, max: null, median: null, min: null, nullcount: 0, stddev: null, sum: null, variance: null };
  const i6 = (_a = n8 == null ? void 0 : n8[0]) == null ? void 0 : _a.attributes, l4 = {};
...
function _2(t2) {
  var _a;
  return { viewingMode: "2d" === t2.type ? "map" : t2.viewingMode, scale: t2.scale, spatialReference: (_a = t2.spatialReference) == null ? void 0 : _a.toJSON() };
}
function B(t2, e3) {
...
function k(t2, e3) {
  ...
  switch (t2.statisticType) {
    ...
    case "max":
    case "sum":
      return t2.onStatisticField ? ((_a = e3.get(t2.onStatisticField)) == null ? void 0 : _a.type) ?? null : t2.onStatisticExpression ? "string" === t2.onStatisticExpression.returnType ? null : "double" : null;
    case "mode":
      return t2.onStatisticField ? ((_b = e3.get(t2.onStatisticField)) == null ? void 0 : _b.type) ?? null : t2.onStatisticExpression ? "string" === t2.onStatisticExpression.returnType ? "string" : "double" : null;
    default:
      return null;
  }
}
function A(t2, e3) {
  return U(e3) ? Q(t2, e3 == null ? void 0 : e3.name) : xe(e3) ? P2(e3 == null ? void 0 : e3.name) : null;
}
function H2(t2, e3, n8) {
  ...
  return i6.where = (_a = t2.createQuery()) == null ? void 0 : _a.where, i6;
}
...
function G(t2, e3, n8 = true) {
  ...
  c6.where = U2((_a = t2.createQuery()) == null ? void 0 : _a.where, e3.sqlWhere) ?? void 0;
  const m10 = "new_value";
  return c6.outPivots = [new p5({ sourceFields: i6, valueFieldName: m10 })], c6.outStatistics = J(t2, s8, m10), X(c6, l4), c6;
}
function X(t2, e3) {
  var _a;
  e3 && (t2.geometry = e3.geometry, t2.spatialRelationship = e3.spatialRelationship, t2.timeExtent = ((_a = t2.timeExtent) == null ? void 0 : _a.intersection(e3.timeExtent)) ?? e3.timeExtent, t2.distance = e3.distance, t2.units = e3.units);
}
function K(t2, e3) {
...
async function b3(e3, n8, r4, l4) {
  ...
  const h = new p4({ statisticType: "count", outStatisticFieldName: V2, onStatisticField: "1" }), { where: F2, timeExtent: B2 } = l4 || {}, j5 = U2(F2, x2.sqlWhere), E4 = "lowerBoundary", I5 = "upperBoundary", b5 = new T2({ binParameters: await M4(e3, n8, v3, T5, r4), outStatistics: [h], binOrder: e3.sortOrder, where: j5, timeExtent: B2, lowerBoundaryAlias: E4, upperBoundaryAlias: I5, outTimeZone: (f3 == null ? void 0 : f3.timeZone) && z3 ? O(f3.timeZone) : null });
...
var R3 = class extends p8 {
  ...
  async _summaryStatsFromMemory(e3, t2) {
    ...
    return i6 && r4 && (l4 || u6) && (n8.fieldType = (t2 == null ? void 0 : t2.type) ? i3.toJSON(t2.type) : null, n8.viewInfoParams = _2(r4), n8.timeZone = r4.timeZone, n8.fieldInfos = c6), "percent-of-total" === s8 && null == e3.normalizationTotal && (n8.normalizationTotal = await this._getNormalizationTotalFromMemory(a5, { featuresJSON: l4, graphics: u6, layerView: m10, query: y }, o4)), !l4 && !u6 && m10 && "querySummaryStatistics" in m10 ? m10.querySummaryStatistics(y, n8, { signal: o4 }) : l4 ? this.workerClient.summaryStatistics(n8, l4) : d2({ attribute: n8, features: u6 });
  }
  async _getFilteredFeatures(e3, t2) {
    let r4 = e3;
    const a5 = t2 == null ? void 0 : t2.geometry;
    if ("intersects" === (t2 == null ? void 0 : t2.spatialRelationship) && a5) {
      const t3 = await import("./intersectionOperator-WCED2XDY.js");
  ...
  async _processStatsFromMemoryParams(e3) {
    ...
    if (t2 == null ? void 0 : t2.length) return this._getFilteredFeatures(t2, r4);
    ...
    return c6 || (d4 = await this._fetchFeaturesForStats({ field: i6, field2: s8, field3: o4, valueExpression: l4, normalizationField: n8, returnGeometry: p10, filter: r4, view: a5, signal: m10 }, "json"), h = (await w({ valueExpression: l4 })).map((e4) => {
      var _a;
      return (_a = this.getField(e4)) == null ? void 0 : _a.toJSON();
    }).filter(Boolean)), { layerView: y, query: f3, featuresJSON: d4, fieldInfos: h };
  }
  ...
  async _heatmapStatsFromMemory(e3) {
    ...
    const { featuresJSON: n8, graphics: l4 } = await this._processStatsFromMemoryParams({ ...e3, returnGeometry: true }), u6 = new m7({ extent: t2.extent, tolerance: "2d" === t2.type ? t2.state.resolution : (_a = t2.pixelSizeAt) == null ? void 0 : _a.call(t2, t2.center) }), p10 = { field: r4, radius: a5, transform: s3(u6), spatialReference: (_b = t2.spatialReference) == null ? void 0 : _b.toJSON(), size: t2.size };
    return (n8 == null ? void 0 : n8.length) || (l4 == null ? void 0 : l4.length) ? n8 ? this.workerClient.heatmapStatistics(p10, n8) : z({ attribute: p10, features: l4 }) : { min: null, max: null };
  }
  getField(e3 = "") {
  ...
  async summaryStatistics(e3) {
    const { field: t2, valueExpression: a5, sqlExpression: i6, features: s8, view: o4 } = e3, n8 = t2 ? this.getField(t2) : null, l4 = !!a5, u6 = "3d" === (o4 == null ? void 0 : o4.type);
  ...
  async uniqueValues(e3) {
    const { valueExpression: t2, sqlExpression: a5, features: i6, view: s8 } = e3, o4 = await I3(e3, this), n8 = !!t2, l4 = "3d" === (s8 == null ? void 0 : s8.type);
  ...
  async getSampleFeatures(e3, a5) {
    ...
    if (m10.outSpatialReference = i6 == null ? void 0 : i6.spatialReference, m10.returnGeometry = !!n8, m10.outFields = o4, X(m10, l4), !i6) throw new s(`${this.adapterName}:not-supported`, "view is required to get sample features for Layer");
  ...
  load(e3) {
    const t2 = this.layer.load(e3).then(async (t3) => {
      var _a, _b, _c;
      this.geometryType = t3.geometryType, this.objectIdField = t3.objectIdField, this.supportsSQLExpression = "stream" === t3.type || !!((_b = (_a = t3.capabilities) == null ? void 0 : _a.query) == null ? void 0 : _b.supportsSqlExpression), this.minScale = t3.minScale, this.maxScale = t3.maxScale, this.fullExtent = "fullExtent" in t3 ? t3.fullExtent : (_c = t3.parent) == null ? void 0 : _c.fullExtent, this._hasLocalSource = false, this.hasQueryEngine = true, this.workerClient = n6.getInstance(), await this.workerClient.open(e3.signal);
    });
...
var ie = class extends R3 {
  ...
  _isStatsSupportedOnService() {
    var _a, _b;
    const e3 = this.layer;
    if (!((_b = (_a = e3.capabilities) == null ? void 0 : _a.query) == null ? void 0 : _b.supportsStatistics) || "multipatch" === this.geometryType && !g(e3.url) && e3.version < 10.5) throw new s(`${this.adapterName}:not-supported`, "Layer does not support statistics query");
  ...
  _summaryStatsFromGenRend(e3) {
    ...
    return this.classBreaks({ field: e3.field, numClasses: Y2, classificationMethod: "standard-deviation", standardDeviationInterval: 0.25, normalizationType: t2, normalizationField: "field" === t2 ? i6 : void 0, minValue: e3.minValue, maxValue: e3.maxValue, filter: e3.filter, signal: e3.signal }).then((t3) => {
      var _a;
      let i7, s8, r4;
      if ((_a = t3.classBreakInfos) == null ? void 0 : _a.some((e4) => (e4.hasAvg && (i7 = e4), !!i7)), i7) {
  ...
  async _summaryStatsFromServiceQuery(e3, t2) {
    ...
    const i6 = U(t2) || xe(t2), s8 = "capabilities" in this.layer ? this.layer.capabilities : null, r4 = Z(this, e3, t2, ((_a = s8 == null ? void 0 : s8.query) == null ? void 0 : _a.supportsPercentileStatistics) ?? false), a5 = await this.layer.queryFeatures(r4, { signal: e3.signal }), o4 = q2(a5, i6);
    return C2(o4, e3.outStatisticTypes);
  }
  ...
  async _summaryStatsForFieldsAdvanced(e3, t2) {
    var _a, _b;
    const { outStatisticTypes: i6, fields: s8 } = e3, r4 = ((_a = i6 == null ? void 0 : i6.exclude) == null ? void 0 : _a.includes("variance")) || (i6 == null ? void 0 : i6.include) && !i6.include.includes("variance"), a5 = ((_b = i6 == null ? void 0 : i6.exclude) == null ? void 0 : _b.includes("stddev")) || (i6 == null ? void 0 : i6.include) && !i6.include.includes("stddev");
  ...
  async _summaryStatsUsingQueryPivot(e3) {
    ...
    const t2 = "capabilities" in this.layer ? this.layer.capabilities : null, i6 = G(this, e3, ((_a = t2 == null ? void 0 : t2.query) == null ? void 0 : _a.supportsPercentileStatistics) ?? false), s8 = await this.layer.queryPivot(i6, { signal: e3.signal }), r4 = q2(s8, false);
  ...
  async summaryStatistics(e3) {
    ...
    if (i6 == null ? void 0 : i6.length) {
      const t3 = { ...e3, fields: i6 };
      if (!((_b = (_a = this.layer.capabilities) == null ? void 0 : _a.operations) == null ? void 0 : _b.supportsQueryPivot)) return await this._summaryStatsForFields(t3);
      try {
  ...
  async histogram(e3) {
    ...
    if ((_a = e3.fields) == null ? void 0 : _a.length) {
      if (!f3) throw new s(`${this.adapterName}:not-supported`, "Layer does not support standardized SQL expression for queries");
      if (!((_c = (_b = this.layer.capabilities) == null ? void 0 : _b.operations) == null ? void 0 : _c.supportsQueryPivot)) throw new s(`${this.adapterName}:not-supported`, "Layer does not support pivot queries");
      return this._histogramForFields(e3);
    }
    if (y) return this._histogramFromMemory(e3);
    if (((_e = (_d = this.layer.capabilities) == null ? void 0 : _d.operations) == null ? void 0 : _e.supportsQueryBins) && e3.useQueryAttributeBins) try {
  ...
  async generateRenderer(e3, t2) {
    ...
    return e3.where = U2(e3.where, r4.where), l3(((_a = i6.parsedUrl) == null ? void 0 : _a.path) ?? "", { source: i6.dynamicDataSource ?? void 0, gdbVersion: i6.gdbVersion ?? void 0 }, e3, { signal: t2 });
  }
  async predominantCategories(e3) {
  ...
  async getSampleFeatures(e3, s8) {
    ...
    m10.outSpatialReference = a5 == null ? void 0 : a5.spatialReference, m10.returnGeometry = !!n8, m10.outFields = o4, X(m10, l4);
    let d4 = [], y = false;
    if (a5) try {
    ...
    try {
      ...
      return ((_b = (_a = this.layer.capabilities) == null ? void 0 : _a.query) == null ? void 0 : _b.supportsPagination) && (m10.num = Math.min(r4, ee)), h ? await this._fetchFeaturesJSONFromService(m10, u6) : await this._fetchFeaturesFromService(m10, u6);
    } catch (f3) {
      return s2(u6), d4;
    }
  }
...
var u3 = class extends ie {
  ...
  async _createGenerateRendererResult(e3, r4, i6, n8, l4) {
    const p10 = e3 == null ? void 0 : e3.features, c6 = p10 == null ? void 0 : p10.length;
    ...
    if ("class-breaks-definition" === (l4 == null ? void 0 : l4.type)) {
  ...
  generateRenderer(e3, t2) {
    ...
    "class-breaks-definition" === (r4 == null ? void 0 : r4.type) ? (i6 = r4.classificationField, s8 = r4.normalizationField, o4 = r4.normalizationType) : i6 = r4 == null ? void 0 : r4.attributeField;
    const a5 = this.layer;
...
var T4 = class extends ie {
  ...
  async _processStatsFromMemoryParams(e3) {
    ...
    if (t2 == null ? void 0 : t2.length) return this._getFilteredFeatures(t2, i6);
    ...
    if (!c6 && (F2 = W(this.layer).map((e4) => e4.toJSON()), w2 = await this._fetchFeaturesForStats({ field: o4, field2: n8, field3: l4, valueExpression: m10, normalizationField: u6, returnGeometry: p10, filter: i6, view: s8, signal: g4 }, "json"), !(w2 == null ? void 0 : w2.length))) throw new s(`${this.adapterName}:insufficient-data`, "No features are available to calculate statistics");
  ...
  getField(e3 = "") {
    ...
    return t2 == null ? void 0 : t2.find((t3) => t3.name.toLowerCase() === (e3 == null ? void 0 : e3.toLowerCase()));
  }
  getFieldUsageInfo(e3) {
  ...
  async queryFeatureCount(e3) {
    var _a;
    const t2 = await ((_a = e3.view) == null ? void 0 : _a.whenLayerView(this.layer));
  ...
  async getSampleFeatures(e3, r4) {
    ...
    g4.outSpatialReference = i6 == null ? void 0 : i6.spatialReference, g4.returnGeometry = !!n8, g4.outFields = o4, X(g4, l4);
  ...
  load(e3) {
    const t2 = this.layer.load(e3).then(async (t3) => {
      ...
      if ("binning" !== (r4 == null ? void 0 : r4.type) && "cluster" !== (r4 == null ? void 0 : r4.type)) throw new s(`${this.adapterName}:invalid-parameters`, `Feature reduction type ${r4 == null ? void 0 : r4.type} is not supported`);
      this.geometryType = "cluster" === (r4 == null ? void 0 : r4.type) ? "point" : "polygon", this.objectIdField = null, this.supportsSQLExpression = false, this._hasLocalSource = false, this.hasQueryEngine = true, this.minScale = t3.minScale, this.maxScale = t3.maxScale, this.fullExtent = t3.fullExtent, this.workerClient = n6.getInstance(), await this.workerClient.open(e3.signal);
    });
    return this.addResolvingPromise(t2), Promise.resolve(this);
  }
};
...
var A2 = class extends p8 {
  ...
  async _processStatsFromMemoryParams(e3) {
    ...
    if (!(l4 == null ? void 0 : l4.length)) throw new s("scene-layer-adapter:insufficient-data", "No features are available to calculate statistics");
    return { graphics: l4 };
  }
  _getCachedStatistics(e3, t2) {
    const r4 = this.layer;
    return e3.valueExpression || e3.sqlExpression || e3.sqlWhere || e3.minValue || e3.maxValue ? Promise.reject(new s("scene-layer-adapter:not-supported", "This Layer does not support calculating statistics when 'valueExpression', 'sqlExpression', 'sqlWhere', 'minValue' or 'maxValue' is specified")) : r4.queryCachedStatistics(t2 == null ? void 0 : t2.name, { signal: e3.signal }).then((e4) => {
  ...
  async _getSummaryStatisticsFromMemory(e3, t2) {
    ...
    return e3.valueExpression && r4 && o4 && (l4.fieldType = (t2 == null ? void 0 : t2.type) ? i3.toJSON(t2.type) : null, l4.viewInfoParams = _2(r4), l4.timeZone = r4.timeZone), "percent-of-total" === e3.normalizationType && null == e3.normalizationTotal && (l4.normalizationTotal = await this._getNormalizationTotal(a5, o4, n8)), o4 ? this.workerClient.summaryStatistics(l4, o4) : d2({ attribute: l4, features: n8 });
  }
  _getCachedStatisticsForUniqueValues(e3, r4) {
    const s8 = this.layer, i6 = r4 == null ? void 0 : r4.name, o4 = r4 && e3.field ? this.getFieldDomain(e3.field) : null;
    return e3.valueExpression || e3.sqlExpression || e3.sqlWhere ? Promise.reject(new s("scene-layer-adapter:not-supported", "This Layer does not support calculating statistics when 'valueExpression', 'sqlExpression' or 'sqlWhere' is specified")) : s8.queryCachedStatistics(i6, { signal: e3.signal }).then((a5) => {
      ...
      const n8 = (_a = a5.labels) == null ? void 0 : _a.labels, l4 = {}, u6 = [], c6 = "countOF" + i6;
  ...
  summaryStatistics(e3) {
    ...
    return this._hasCachedStatistics(t2 == null ? void 0 : t2.name) ? this._getCachedStatistics(e3, t2).catch(() => (s2(e3.signal), this._getSummaryStatisticsFromMemory(e3, t2))) : this._getSummaryStatisticsFromMemory(e3, t2);
  }
  async uniqueValues(e3) {
  ...
  classBreaks(e3) {
    ...
    if (e3.filter) throw new s("scene-layer-adapter:not-supported", "filter is not supported");
    return this._hasCachedStatistics(t2 == null ? void 0 : t2.name) ? Promise.reject(new s("scene-layer-adapter:not-supported", "Cached stats not supported")) : this._getClassBreaksFromMemory(e3);
  }
  ...
  async getSampleFeatures(e3, t2) {
    ...
    return (h == null ? void 0 : h.length) ? h : I(d4, d4.length, p10);
  }
  load(e3) {
    const t2 = this.layer.load(e3).then(async (t3) => {
...
var c5 = class extends R3 {
  ...
  async _summaryStatsFromClientQuery(t2, r4) {
    ...
    c6.outStatistics = (_a = c6.outStatistics) == null ? void 0 : _a.filter((t3) => "totalcount_value" !== t3.outStatisticFieldName);
...
async function u5(u6) {
  if (!(u6 == null ? void 0 : u6.layer) || !u6.field && !u6.valueExpression) throw new s("unique-values:missing-parameters", "'layer' and 'field' or 'valueExpression' parameters are required");
...
//# sourceMappingURL=uniqueValues-KSNRK7DC.js.map
