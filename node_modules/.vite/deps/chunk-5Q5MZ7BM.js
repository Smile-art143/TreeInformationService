...
function m(e, t2) {
  var _a;
  if (t2) if (M(e)) {
    const n = t("featureCollection.layers", t2), i = (_a = n == null ? void 0 : n[0]) == null ? void 0 : _a.layerDefinition;
    i && f(e, i);
...
function y2(r, n, o2) {
  ...
  if (!("write" in r) || !r.write) return (o2 == null ? void 0 : o2.messages) && o2.messages.push(new s("layer:unsupported", `Layers (${r.title}, ${r.id}) of type '${r.declaredClass}' cannot be persisted`, { layer: r })), null;
...
//# sourceMappingURL=chunk-5Q5MZ7BM.js.map
