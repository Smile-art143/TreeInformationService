...
import {
  ...
  x,
  y as y2
} from "./chunk-ZQY3XRMQ.js";
import {
  s as s2,
  v
} from "./chunk-SO2LPQNJ.js";
import "./chunk-IG4YDDBS.js";
import {
  l
} from "./chunk-4DB6EZS4.js";
import {
  l as l2
} from "./chunk-BQARFEUH.js";
import {
  t as t3
} from "./chunk-4RLKMPZR.js";
import "./chunk-2CLIBLYZ.js";
import {
  et
...
var t4 = new o2({ Clean: "clean", Dirty: "dirty" });
var i3 = new o2({ Physical: "physical", Virtual: "virtual" });
var o6 = new o2({ "Start and end": "start-and-end", Start: "start", Midspan: "midspan", End: "end" });
var e3 = new o2({ startingPoint: "starting-point", barrier: "barrier", stoppingPoint: "stopping-point" });
var c2 = new o2({ connected: "connected", upstream: "upstream", downstream: "downstream", shortestPath: "shortest-path", subnetwork: "subnetwork", subnetworkController: "subnetwork-controller", loops: "loops", isolation: "isolation", path: "path", circuit: "circuit" });
var r3 = "{00000000-0000-0000-0000-000000000000}";
var a2 = new o2({ junctionJunctionConnectivity: "junction-junction-connectivity", connectivity: "connectivity", attachment: "attachment", containment: "containment", junctionEdgeFromConnectivity: "junction-edge-from-connectivity", junctionEdgeMidspanConnectivity: "junction-edge-midspan-connectivity", junctionEdgeToConnectivity: "junction-edge-to-connectivity" });
var d = new o2({ normal: "normal", rebuild: "rebuild", forceRebuild: "force-rebuild" });
...
__decorate([m2({ type: Boolean, json: { write: true } })], n3.prototype, "returnDeletes", void 0), __decorate([m2({ type: [s4], json: { write: true } })], n3.prototype, "elements", void 0), __decorate([m2({ type: [a2.apiValues], json: { type: a2.jsonValues, read: a2.read, write: a2.write } })], n3.prototype, "types", void 0), __decorate([m2({ type: String, json: { write: true } })], n3.prototype, "gdbVersion", void 0), __decorate([m2({ type: Date, json: { type: Number, write: { writer: (e4, t5) => {
  t5.moment = e4 == null ? void 0 : e4.getTime();
...
function me(e4) {
  return "utc" === (e4 == null ? void 0 : e4.toLowerCase()) ? "UTC" : "unknown" === (e4 == null ? void 0 : e4.toLowerCase()) ? "Unknown" : e4;
}
async function pe(t5, n4, i4, a5, r4, s6, l3) {
  var _a, _b, _c;
  const f2 = await t5.getFeatureSetInfo();
  if (null === ((f2 == null ? void 0 : f2.layerId) ?? null)) return null;
  ...
  if (!p4) {
    ...
    for (const t6 of o7.associations) {
      let n5 = null, o8 = "", l4 = "";
      if (((_a = t6.fromNetworkElement) == null ? void 0 : _a.globalId) === a6.globalId ? (n5 = t6.toNetworkElement, l4 = "to") : ((_b = t6.toNetworkElement) == null ? void 0 : _b.globalId) === a6.globalId && (n5 = t6.fromNetworkElement, l4 = "from"), !n5) continue;
      switch (i4) {
        case "attached":
      ...
      const f3 = ((_c = r4.sourceIdLookup.get(n5.networkSourceId)) == null ? void 0 : _c.className) ?? "";
      ...
      return e4.standardFunctionAsync(n4, a5, async (e5, r4, s6) => {
        ...
        if (B(s6[0])) {
          ...
          switch (ge(e6).toLowerCase()) {
            ...
            case "editfieldsinfo":
              return me(((_a = s6[0].editFieldsInfo) == null ? void 0 : _a.timeZone) ?? null);
            case "timeinfo":
              return me(((_b = s6[0].timeInfo) == null ? void 0 : _b.timeZone) ?? null);
            case "field":
    ...
    e4.functions.getfeatureset = function(t5, n4) {
      ...
      return e4.standardFunctionAsync(t5, i4, (e5, a5, r4) => {
        ...
        if (r4[0] instanceof t3) {
          ...
          let l4;
          return l4 = ((_a = t5.services) == null ? void 0 : _a.portal) ? t5.services.portal : M.getDefault(), l4 = l2(r4[0], l4), R(e6, n4, t5.spatialReference, a6, s7, l4, t5.lrucache, t5.interceptor);
        }
        ...
        return R(s6, l3, t5.spatialReference, d2, u2, ((_b = t5.services) == null ? void 0 : _b.portal) ?? M.getDefault(), t5.lrucache, t5.interceptor);
      });
...
//# sourceMappingURL=featuresetbase-D3PJ3PBR.js.map
