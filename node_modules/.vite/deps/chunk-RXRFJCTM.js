...
async function M(t2, e, n, r, o, i2) {
  ...
  if (null != o && (l.timeExtent = o), "imagery" === t2.type) {
    ...
    if (null == ((_a = o2 == null ? void 0 : o2.pixelData) == null ? void 0 : _a.pixelBlock)) return { data: new Float32Array(n * r * 2), mask: new Uint8Array(n * r), width: n, height: r };
    return y(t2.rasterInfo.dataType, o2.pixelData.pixelBlock);
  }
  await t2.load({ signal: i2 });
  const s4 = await t2.fetchPixels(e, n, r, l);
  if (null == (s4 == null ? void 0 : s4.pixelBlock)) return { data: new Float32Array(n * r * 2), mask: new Uint8Array(n * r), width: n, height: r };
...
//# sourceMappingURL=chunk-RXRFJCTM.js.map
