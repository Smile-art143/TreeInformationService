...
var d = class extends l(n) {
  ...
  clone() {
    ...
    return t2._set("format", (_a = this.format) == null ? void 0 : _a.clone()), t2._set("fieldFormat", (_b = this.fieldFormat) == null ? void 0 : _b.clone()), t2;
  }
};
__decorate([m({ value: null, clonable: false, types: l2, json: { write: { overridePolicy(t2, o4, e4) {
  const { fieldName: r6 } = this;
  return { enabled: !!r6 && !r6.startsWith("expression/") && !r6.startsWith("relationships/") && !!(e4 == null ? void 0 : e4.writeFieldFormat) };
} } } })], d.prototype, "fieldFormat", null), __decorate([m({ type: String, json: { write: true } })], d.prototype, "fieldName", void 0), __decorate([m({ value: null, clonable: false, type: m2, json: { write: true } })], d.prototype, "format", null), __decorate([o("format")], d.prototype, "readFormat", null), __decorate([m({ type: Boolean, json: { write: { alwaysWriteDefaults: true }, default: true } })], d.prototype, "isEditable", void 0), __decorate([m({ type: String, json: { write: true } })], d.prototype, "label", void 0), __decorate([m({ type: ["count", "sum", "min", "max", "avg", "stddev", "var"], json: { write: true } })], d.prototype, "statisticType", void 0), __decorate([r2(new o2({ richtext: "rich-text", textarea: "text-area", textbox: "text-box" }), { default: "text-box" })], d.prototype, "stringFieldOption", void 0), __decorate([m({ type: String, json: { write: true } })], d.prototype, "tooltip", void 0), __decorate([m({ type: Boolean, json: { write: true } })], d.prototype, "visible", void 0), d = __decorate([a2("esri.popup.FieldInfo")], d);
var f = d;
...
var l4 = s6 = class extends b {
  ...
  clone() {
    var _a;
    return new s6({ color: (_a = this.color) == null ? void 0 : _a.clone(), fieldName: this.fieldName, tooltip: this.tooltip, value: this.value });
  }
};
...
var i11 = a4 = class extends i10 {
  ...
  clone() {
    var _a;
    return new a4({ altText: this.altText, title: this.title, caption: this.caption, value: (_a = this.value) == null ? void 0 : _a.clone() });
  }
};
...
var p14 = i14 = class extends i9 {
  ...
  clone() {
    var _a;
    return new i14({ altText: this.altText, title: this.title, caption: this.caption, refreshInterval: this.refreshInterval, value: (_a = this.value) == null ? void 0 : _a.clone() });
  }
};
...
var p15 = i15 = class extends i10 {
  ...
  clone() {
    var _a;
    return new i15({ altText: this.altText, title: this.title, caption: this.caption, value: (_a = this.value) == null ? void 0 : _a.clone() });
  }
};
...
var p16 = i16 = class extends i10 {
  ...
  clone() {
    var _a;
    return new i16({ altText: this.altText, title: this.title, caption: this.caption, value: (_a = this.value) == null ? void 0 : _a.clone() });
  }
};
...
__decorate([m()], u2.prototype, "activeMediaInfoIndex", void 0), __decorate([m({ type: Object, json: { write: true } })], u2.prototype, "attributes", void 0), __decorate([m({ type: String, json: { write: true } })], u2.prototype, "description", void 0), __decorate([m({ types: [m4] })], u2.prototype, "mediaInfos", void 0), __decorate([o("mediaInfos")], u2.prototype, "readMediaInfos", null), __decorate([r("mediaInfos")], u2.prototype, "writeMediaInfos", null), __decorate([m({ type: String, json: { write: true } })], u2.prototype, "title", void 0), __decorate([m({ type: ["media"], readOnly: true, json: { read: false, write: { isRequired: true } } })], u2.prototype, "type", void 0), u2 = l5 = __decorate([a2("esri.popup.content.MediaContent")], u2);
var I = u2;
...
var U = class extends l(n) {
  ...
  writeFieldInfos(t2, e4, o4, s10) {
    ...
    if (t2) {
      const o5 = r6 ? r6.filter((t3) => "fields" === t3.type) : [], s11 = o5.length && o5.every((t3) => {
        var _a;
  ...
  _writePopupTemplateContent(t2, e4, o4) {
    "string" != typeof t2 ? Array.isArray(t2) && (e4.popupElements = t2.filter((t3) => "web-scene" === (o4 == null ? void 0 : o4.origin) ? W.has(t3.type) : k.has(t3.type)).map((t3) => t3 == null ? void 0 : t3.toJSON(o4)), e4.popupElements.forEach((t3) => {
  ...
  _writeFieldsContent(t2, e4, o4) {
    ...
    if (Array.isArray(i21)) for (const r6 of s10) {
      const t3 = i21.find((t4) => {
        var _a, _b;
        return ((_a = t4.fieldName) == null ? void 0 : _a.toLowerCase()) === ((_b = r6.fieldName) == null ? void 0 : _b.toLowerCase());
      });
  ...
  _writeRelationshipContent(t2, e4) {
    var _a, _b;
    const o4 = ((_a = t2.orderByFields) == null ? void 0 : _a.map((e5) => this._toFieldOrderJSON(e5, t2.relationshipId))) || [], s10 = [...((_b = e4.relatedRecordsInfo) == null ? void 0 : _b.orderByFields) || [], ...o4];
    e4.relatedRecordsInfo = { showRelatedRecords: true, ...(s10 == null ? void 0 : s10.length) && { orderByFields: s10 } };
  }
  ...
  _toRelationshipContent(t2) {
    ...
    if (!(e4 == null ? void 0 : e4.startsWith(B))) return null;
  ...
  _readPopupInfo({ description: t2, mediaInfos: e4, showAttachments: o4, relatedRecordsInfo: s10 = { showRelatedRecords: false } }) {
    ...
    return r6 && (n8 == null ? void 0 : n8.length) && n8.forEach((t3) => {
      const e5 = this._toRelationshipContent(t3);
      e5 && i21.push(e5);
    }), i21.length ? i21 : t2;
  }
  _getContentElementFields(t2) {
    const e4 = t2 == null ? void 0 : t2.type;
...
__decorate([m({ type: M })], U.prototype, "actions", void 0), __decorate([m()], U.prototype, "content", void 0), __decorate([s("content")], U.prototype, "castContent", null), __decorate([o("content", ["description", "fieldInfos", "popupElements", "mediaInfos", "showAttachments", "relatedRecordsInfo"])], U.prototype, "readContent", null), __decorate([r("web-scene", "content", { popupElements: { type: O.ofType(c9) }, showAttachments: { type: Boolean }, mediaInfos: { type: O.ofType(m4) }, description: { type: String }, relatedRecordsInfo: { type: i20 } })], U.prototype, "writeWebSceneContent", null), __decorate([r("content", { popupElements: { type: O.ofType(a10) }, showAttachments: { type: Boolean }, mediaInfos: { type: O.ofType(m4) }, description: { type: String }, relatedRecordsInfo: { type: i20 } })], U.prototype, "writeWebMapContent", null), __decorate([m({ type: [i3], json: { write: true } })], U.prototype, "expressionInfos", void 0), __decorate([m({ type: [f] })], U.prototype, "fieldInfos", void 0), __decorate([r("fieldInfos")], U.prototype, "writeFieldInfos", null), __decorate([m({ type: a11 })], U.prototype, "layerOptions", void 0), __decorate([r("layerOptions")], U.prototype, "writeLayerOptions", null), __decorate([m({ type: Boolean, json: { read: { source: "showLastEditInfo" }, write: { target: "showLastEditInfo" }, default: true } })], U.prototype, "lastEditInfoEnabled", void 0), __decorate([m()], U.prototype, "outFields", void 0), __decorate([m()], U.prototype, "overwriteActions", void 0), __decorate([m()], U.prototype, "returnGeometry", void 0), __decorate([m({ json: { type: String } })], U.prototype, "title", void 0), __decorate([r("title")], U.prototype, "writeTitle", null), U = __decorate([a2("esri.PopupTemplate")], U);
var q = U;
...
//# sourceMappingURL=chunk-DPSLSTXW.js.map
