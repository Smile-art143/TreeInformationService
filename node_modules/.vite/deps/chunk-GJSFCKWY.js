...
var _ = class {
  ...
  async push(s3, e, n, r) {
    if (!(s3 == null ? void 0 : s3.length) || !e || !n || T(e, n)) return s3;
    const o2 = { geometries: s3, inSpatialReference: e, outSpatialReference: n, options: r, resolve: $() };
    return this._jobs.push(o2), this._timer ?? (this._timer = setTimeout(this._process, 10)), o2.resolve.promise;
  }
  _process() {
    this._timer = null;
    ...
    M(e, r) && null == (m2 == null ? void 0 : m2.extendedParams) ? C(r) ? i(t.map(x)) : i(t.map(y2)) : i(B(t, e, r, m2)), this._jobs.length > 0 && (this._timer = setTimeout(this._process, 10));
  }
};
var j = new _();
...
async function B2(t, e, i) {
  ...
  if (!t) return null;
  let { where: r } = t;
  if (t.where = r = r == null ? void 0 : r.trim(), (!r || /^1 *= *1$/.test(r) || e && e === r) && (t.where = null), !t.geometry) return t;
  let o2 = await v(t);
  ...
  if (o2) {
    ...
    if (null == e2) throw S;
    const r2 = "quantizationParameters" in t && ((_a = t.quantizationParameters) == null ? void 0 : _a.tolerance) || "maxAllowableOffset" in t && t.maxAllowableOffset || 0, n = r2 && F(o2, i) ? { extendedParams: { densificationStep: 8 * r2 } } : void 0, s3 = e2.toJSON(), l3 = g(s3, s3.spatialReference, i, n);
    if (!l3) throw S;
...
async function v(e) {
  ...
  const s3 = a.spatialReference, l3 = n ? g2.fromJSON(n) : oe(s3), m2 = s3 && (c(s3) || C(s3)) ? a : await f2(s3, N2).then(() => g(a, N2)), f3 = await import("./geodesicBufferOperator-ZMKWTICT.js");
  await f3.load();
...
//# sourceMappingURL=chunk-GJSFCKWY.js.map
