...
import {
  ...
  n as n3,
  o as o6
} from "./chunk-GNEX4MII.js";
import {
  a as a4
} from "./chunk-R4QBNSXX.js";
import {
  D,
  M as M2,
  R,
  ...
  r as r3,
  w
} from "./chunk-TY53BONF.js";
import {
  t as t3
} from "./chunk-AO5WTXLR.js";
import {
  i as i2
} from "./chunk-RI7CUAOI.js";
import {
  o as o4
...
var c3 = class extends n {
  ...
  writeAccumulateAttributes(t4, e2, r4) {
    (t4 == null ? void 0 : t4.length) && (e2[r4] = t4.map((t5) => D.toJSON(t5)));
  }
  get capabilities() {
...
async function v(r4, t4) {
  ...
  if (!(l8 == null ? void 0 : l8.owningSystemUrl)) return { supportedTravelModes: [], defaultTravelMode: null };
  ...
  let T2 = null;
  if ((_b = (_a3 = g2 == null ? void 0 : g2.data) == null ? void 0 : _a3.results) == null ? void 0 : _b.length) {
...
__decorate([m2({ type: Date, json: { read: { source: "arriveTimeUTC" } } })], a6.prototype, "arriveTime", void 0), __decorate([m2()], a6.prototype, "arriveTimeOffset", void 0), __decorate([o2("arriveTimeOffset", ["arriveTimeUTC", "ETA"])], a6.prototype, "readArriveTimeOffset", null), __decorate([m2({ type: _ })], a6.prototype, "geometry", void 0), __decorate([o2("geometry", ["point"])], a6.prototype, "readGeometry", null), __decorate([m2({ type: [i5] })], a6.prototype, "strings", void 0), a6 = __decorate([a("esri.rest.support.DirectionsEvent")], a6);
var c7 = a6;
...
__decorate([m2({ type: [c7] })], c8.prototype, "events", void 0), __decorate([m2({ type: y2 })], c8.prototype, "geometry", void 0), __decorate([o2("geometry", ["compressedGeometry"])], c8.prototype, "readGeometry", null), __decorate([m2({ type: [i5] })], c8.prototype, "strings", void 0), c8 = __decorate([a("esri.rest.support.DirectionsFeature")], c8);
var m9 = c8;
...
__decorate([m2({ type: z, json: { read: { source: "summary.envelope" } } })], m10.prototype, "extent", void 0), __decorate([m2({ nonNullable: true })], m10.prototype, "features", void 0), __decorate([o2("features")], m10.prototype, "readFeatures", null), __decorate([m2()], m10.prototype, "geometryType", void 0), __decorate([m2({ readOnly: true })], m10.prototype, "mergedGeometry", null), __decorate([m2()], m10.prototype, "routeId", void 0), __decorate([m2()], m10.prototype, "routeName", void 0), __decorate([m2({ value: null, readOnly: true })], m10.prototype, "strings", null), __decorate([m2({ json: { read: { source: "summary.totalDriveTime" } } })], m10.prototype, "totalDriveTime", void 0), __decorate([m2({ json: { read: { source: "summary.totalLength" } } })], m10.prototype, "totalLength", void 0), __decorate([m2({ json: { read: { source: "summary.totalTime" } } })], m10.prototype, "totalTime", void 0), m10 = __decorate([a("esri.rest.support.DirectionsFeatureSet")], m10);
var c9 = m10;
...
__decorate([m2({ type: String })], m11.prototype, "checksum", void 0), __decorate([m2({ type: [i4] })], m11.prototype, "messages", void 0), __decorate([m2({ type: [_2] })], m11.prototype, "pointBarriers", void 0), __decorate([o2("pointBarriers", ["barriers"])], m11.prototype, "readPointBarriers", null), __decorate([m2({ type: [_2] })], m11.prototype, "polylineBarriers", void 0), __decorate([o2("polylineBarriers")], m11.prototype, "readPolylineBarriers", null), __decorate([m2({ type: [_2] })], m11.prototype, "polygonBarriers", void 0), __decorate([o2("polygonBarriers")], m11.prototype, "readPolygonBarriers", null), __decorate([m2({ type: [u5] })], m11.prototype, "routeResults", void 0), m11 = __decorate([a("esri.rest.support.RouteSolveResult")], m11);
...
function m12(e2) {
  ...
  c11 == null ? void 0 : c11.features.forEach((e3, r5) => {
  ...
  }), a8 == null ? void 0 : a8.forEach((e3) => {
    const { routeName: r5 } = e3;
    d4(r5).directions = e3;
  });
  const R3 = ((p8 == null ? void 0 : p8.features.every((e3) => null == e3.attributes.RouteName)) ?? false) && g2.length > 0 ? g2[0].routeName : null;
  return p8 == null ? void 0 : p8.features.forEach((e3) => {
    var _a3;
    e3.geometry && ((_a3 = e3.geometry).spatialReference ?? (_a3.spatialReference = p8.spatialReference ?? void 0));
    const r5 = R3 ?? e3.attributes.RouteName, t5 = d4(r5);
    t5.stops ?? (t5.stops = []), t5.stops.push(e3);
  }), s5 == null ? void 0 : s5.features.forEach((e3) => {
    const r5 = e3.attributes.RouteID, t5 = h3(r5), { geometryType: o8, spatialReference: a9 } = s5;
    t5.directionLines ?? (t5.directionLines = { features: [], geometryType: o8, spatialReference: a9 }), t5.directionLines.features.push(e3);
  }), o7 == null ? void 0 : o7.features.forEach((e3) => {
    const r5 = e3.attributes.RouteID, t5 = h3(r5), { geometryType: s6, spatialReference: a9 } = o7;
    t5.directionPoints ?? (t5.directionPoints = { features: [], geometryType: s6, spatialReference: a9 }), t5.directionPoints.features.push(e3);
  }), l8 == null ? void 0 : l8.features.forEach((e3) => {
    const r5 = e3.attributes.RouteID, t5 = h3(r5), { geometryType: s6, spatialReference: o8 } = l8;
    t5.traversedEdges ?? (t5.traversedEdges = { features: [], geometryType: s6, spatialReference: o8 }), t5.traversedEdges.features.push(e3);
  }), m13 == null ? void 0 : m13.features.forEach((e3) => {
    const r5 = e3.attributes.RouteID, t5 = h3(r5), { geometryType: s6, spatialReference: o8 } = m13;
    t5.traversedJunctions ?? (t5.traversedJunctions = { features: [], geometryType: s6, spatialReference: o8 }), t5.traversedJunctions.features.push(e3);
  }), y3 == null ? void 0 : y3.features.forEach((e3) => {
...
var P2 = (_a2 = class extends l2(n) {
  ...
  writeRestrictionAttributes(t4, e2, r4) {
    (t4 == null ? void 0 : t4.length) && (e2[r4] = t4.map((t5) => w.toJSON(t5)));
  }
  readStartTime(t4, e2) {
...
var fe = class extends p(t2(b2(j(l(b4))))) {
  ...
  get fullExtent() {
    ...
    if (null != ((_a3 = this.routeInfo) == null ? void 0 : _a3.geometry)) return this.routeInfo.geometry.extent ?? e2;
  ...
  readMaxScale(e2, t4) {
    var _a3;
    const r4 = H2(t4) ? t4.layers : (_a3 = t4.featureCollection) == null ? void 0 : _a3.layers, o7 = r4 == null ? void 0 : r4.find((e3) => null != e3.layerDefinition.maxScale);
    return (o7 == null ? void 0 : o7.layerDefinition.maxScale) ?? 0;
  }
  readMinScale(e2, t4) {
    var _a3;
    const r4 = H2(t4) ? t4.layers : (_a3 = t4.featureCollection) == null ? void 0 : _a3.layers, o7 = r4 == null ? void 0 : r4.find((e3) => null != e3.layerDefinition.minScale);
  ...
  readSpatialReference(e2, t4) {
    var _a3, _b;
    const r4 = H2(t4) ? t4.layers : (_a3 = t4.featureCollection) == null ? void 0 : _a3.layers;
    if (!(r4 == null ? void 0 : r4.length)) return f.WGS84;
    const { layerDefinition: o7, featureSet: i6 } = r4[0], s5 = i6.features[0], n6 = ((_b = s5 == null ? void 0 : s5.geometry) == null ? void 0 : _b.spatialReference) ?? i6.spatialReference ?? o7.spatialReference ?? o7.extent.spatialReference ?? N2;
  ...
  get title() {
    var _a3;
    return ((_a3 = this.routeInfo) == null ? void 0 : _a3.name) ?? "Route";
  }
  set title(e2) {
  ...
  async saveAs(e2, t4 = {}) {
    ...
    r4.extent ?? (r4.extent = await ie(this.fullExtent)), r4.id = null, r4.portal ?? (r4.portal = M3.getDefault()), r4.title ?? (r4.title = this.title), r4.type = "Feature Collection", r4.typeKeywords = ["Data", "Feature Collection", E.MULTI_LAYER, "Route Layer"];
    const { portal: o7 } = r4, i6 = { messages: [], origin: "portal-item", portal: o7, url: null, writtenProperties: [] };
    await o7.signIn();
    const n6 = t4 == null ? void 0 : t4.folder, a8 = this.write(void 0, i6);
  ...
  async solve(e2, t4) {
    ...
    const r4 = (e2 == null ? void 0 : e2.stops) ?? this.stops, o7 = (e2 == null ? void 0 : e2.pointBarriers) ?? K(this.pointBarriers), n6 = (e2 == null ? void 0 : e2.polylineBarriers) ?? K(this.polylineBarriers), a8 = (e2 == null ? void 0 : e2.polygonBarriers) ?? K(this.polygonBarriers);
    ...
    const l8 = e2 == null ? void 0 : e2.apiKey, { checksum: p8, url: c11 } = this, m13 = await this._getServiceDescription(c11, l8, t4), y3 = (e2 == null ? void 0 : e2.travelMode) ?? m13.defaultTravelMode, f7 = (e2 == null ? void 0 : e2.accumulateAttributes) ?? [];
  ...
  _getNetworkFeatures(e2, t4, s5, n6) {
    var _a3;
    const a8 = H2(e2) ? e2.layers : (_a3 = e2.featureCollection) == null ? void 0 : _a3.layers, l8 = a8 == null ? void 0 : a8.find((e3) => e3.layerDefinition.name === t4);
    ...
    const { layerDefinition: u6, popupInfo: p8, featureSet: c11 } = l8, m13 = u6.drawingInfo.renderer, { features: y3 } = c11, f7 = c11.spatialReference ?? u6.spatialReference ?? u6.extent.spatialReference ?? N2, d4 = m13 && o4(m13), h3 = f.fromJSON(f7), w2 = y3.map((e3) => {
      ...
      const n7 = s5(i6);
      return n7.symbol ?? (n7.symbol = (d4 == null ? void 0 : d4.getSymbol(i6)) ?? this._getNetworkSymbol(t4)), n7.popupTemplate ?? (n7.popupTemplate = p8 && q.fromJSON(p8)), n7;
    });
  ...
  _toRouteLayerSolution(e2) {
    ...
    const { checksum: t4, routeResults: r4 } = e2, o7 = (_a3 = r4[0].stops) == null ? void 0 : _a3.map((e3) => S.fromJSON(e3.toJSON()));
    this._setStopSymbol(o7);
    const i6 = new ye(o7), s5 = new ce((_b = e2.polygonBarriers) == null ? void 0 : _b.map((e3) => {
      const t5 = h2.fromJSON(e3.toJSON());
      return t5.symbol = this.defaultSymbols.polygonBarriers, t5;
    })), n6 = new me((_c = e2.polylineBarriers) == null ? void 0 : _c.map((e3) => {
      const t5 = d2.fromJSON(e3.toJSON());
      return t5.symbol = this.defaultSymbols.polylineBarriers, t5;
    })), a8 = new pe((_d = e2.pointBarriers) == null ? void 0 : _d.map((e3) => {
      const t5 = T.fromJSON(e3.toJSON());
      return t5.symbol = this.defaultSymbols.pointBarriers, t5;
    })), l8 = (_e = r4[0].route) == null ? void 0 : _e.toJSON(), u6 = f5.fromJSON(l8);
    u6.symbol = this.defaultSymbols.routeInfo;
    const p8 = new ue((_f = r4[0].directionPoints) == null ? void 0 : _f.features.map((e3) => {
      const t5 = c.fromJSON(e3.toJSON());
      return t5.symbol = this.defaultSymbols.directionPoints, t5;
    }));
    return { checksum: t4, directionLines: new le((_g = r4[0].directionLines) == null ? void 0 : _g.features.map((e3) => {
  ...
  _writeStops() {
    ...
    const { stops: t4 } = this.defaultSymbols, r4 = (_a3 = t4 == null ? void 0 : t4.first) == null ? void 0 : _a3.toJSON(), o7 = (_b = t4 == null ? void 0 : t4.middle) == null ? void 0 : _b.toJSON(), i6 = (_c = t4 == null ? void 0 : t4.last) == null ? void 0 : _c.toJSON();
  ...
  _populatePortalFields(e2, t4, r4) {
    ...
    const o7 = (_a3 = t4.networkDataset) == null ? void 0 : _a3.networkAttributes, i6 = (o7 == null ? void 0 : o7.filter(({ usageType: e3 }) => "cost" === e3)) ?? [], a8 = r4.travelMode ?? t4.defaultTravelMode;
    ...
    const { timeAttributeName: l8, distanceAttributeName: u6 } = a8, p8 = i6.find(({ name: e3 }) => e3 === l8), c11 = i6.find(({ name: e3 }) => e3 === u6), m13 = ((_b = r4.travelMode) == null ? void 0 : _b.impedanceAttributeName) ?? r4.impedanceAttribute ?? t4.impedance, y3 = p8 == null ? void 0 : p8.units, f7 = c11 == null ? void 0 : c11.units;
    ...
    S2.analysisSettings = new a5({ accumulateAttributes: h3, directionsLanguage: d4, findBestSequence: b5, preserveFirstStop: v2, preserveLastStop: B, startTimeIsUTC: P3, timeWindowsAreUTC: I2, travelMode: a8 }), S2.totalDuration = se(((_c = S2.totalCosts) == null ? void 0 : _c[l8]) ?? 0, y3), S2.totalDistance = ne(((_d = S2.totalCosts) == null ? void 0 : _d[u6]) ?? 0, f7), S2.totalLateDuration = se(((_e = S2.totalViolations) == null ? void 0 : _e[l8]) ?? 0, y3), S2.totalWaitDuration = se(((_f = S2.totalWait) == null ? void 0 : _f[l8]) ?? 0, y3), null != S2.totalCosts && g2(S2.totalCosts), null != S2.totalViolations && g2(S2.totalViolations), null != S2.totalWait && g2(S2.totalWait);
