...
var d = class {
  ...
  addQueryGeometry(e, t) {
    const { queryGeometry: o3, queryGeometryType: i2 } = t, n4 = this._transform ? wt(o3.clone(), o3, false, false, this._transform) : o3.clone(), a2 = lt(n4, i2, false, false);
...
async function n3(o3, s, n4, p) {
  const i2 = f(o3), u2 = { ...n4 }, m = b.from(s), f3 = !m.quantizationParameters, { data: c } = await f2(i2, m, new d({ sourceSpatialReference: m.sourceSpatialReference, applyTransform: f3 }), u2, p);
  return c;
}
...
//# sourceMappingURL=chunk-IASPG3KY.js.map
