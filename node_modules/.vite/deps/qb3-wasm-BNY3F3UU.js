...
var t;
var _a;
var r = (t = "undefined" != typeof document ? (_a = document.currentScript) == null ? void 0 : _a.src : void 0, async function(r2 = {}) {
  ...
  function x(t2) {
    var _a2;
    I++, (_a2 = i.monitorRunDependencies) == null ? void 0 : _a2.call(i, I);
  }
  function T(t2) {
    var _a2;
    if (I--, (_a2 = i.monitorRunDependencies) == null ? void 0 : _a2.call(i, I), 0 == I && U) {
      var r3 = U;
      U = null, r3();
    }
  }
  function H(t2) {
    var _a2;
    (_a2 = i.onAbort) == null ? void 0 : _a2.call(i, t2), d(t2 = "Aborted(" + t2 + ")"), b = true, t2 += ". Build with -sASSERTIONS for more info.";
  ...
  var V = 0, Y = {}, Z = (t2) => {
    ...
    var _a2;
    y = t2, tt() || ((_a2 = i.onExit) == null ? void 0 : _a2.call(i, t2), b = true), p(t2, new D(t2));
  }, et = (t2, r3) => {
    y = t2, rt(t2);
  }, nt = () => {
    if (!tt()) try {
  ...
  function lt() {
    function t2() {
      var _a2;
      i.calledRun = true, b || (E(), e(i), (_a2 = i.onRuntimeInitialized) == null ? void 0 : _a2.call(i), S());
    }
...
//# sourceMappingURL=qb3-wasm-BNY3F3UU.js.map
