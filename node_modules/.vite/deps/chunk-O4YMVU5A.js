...
__decorate([m2()], p3.prototype, "format", void 0), __decorate([m2({ json: { name: "itemID", write: true } })], p3.prototype, "itemId", void 0), __decorate([m2()], p3.prototype, "type", void 0), __decorate([o2("type")], p3.prototype, "readType", null), __decorate([m2({ json: { write: true } })], p3.prototype, "url", void 0), p3 = __decorate([a("esri.rest.support.RasterData")], p3);
  ...
  switch (e11) {
    ...
    case "feature-record-set-layer":
      ...
      if ("layerDefinition" in t19) {
        const e12 = new (0, (await import("./FeatureLayer-FJGPCTQR.js")).default)(), { layerDefinition: a8, featureSet: n6 } = t19;
...
var g3 = (_a = class extends n {
  ...
  async fetchResultMapImageLayer() {
    ...
    return new (0, (await import("./MapImageLayer-YZKXMZVZ.js")).default)({ url: t19 });
  }
...
async function o5(s18) {
  if (s18) {
    const { default: s19 } = await import("./arcgis-knowledge-client-core-simd-JJM2BUWT.js").then((e11) => e11.a);
    return s19({ locateFile: (s20) => n2(t5 + s20) });
  }
  const { default: r6 } = await import("./arcgis-knowledge-client-core-K7E65PCV.js").then((e11) => e11.a);
...
//# sourceMappingURL=chunk-O4YMVU5A.js.map
