  ...
  e.variables.forEach(({ dimensions: e2 }) => {
    e2.forEach((e3) => {
      ...
      if (e3.recurring) o2.set(e3.name, e3.unit);
        ...
        const n2 = "ISO8601" === ((_a = e3.unit) == null ? void 0 : _a.trim()) || "stdtime" === ((_c = (_b = e3.name) == null ? void 0 : _b.trim()) == null ? void 0 : _c.toLowerCase()) ? a2 : r2;
...
function h(e, a2) {
  return a2 = a2 == null ? void 0 : a2.toLowerCase(), a2 && r.has(a2) ? r.get(a2) : x(e);
}
function x(e) {
...
function V(e, a2, r2) {
  (r2 == null ? void 0 : r2.length) && (a2[i.variable] = r2[0].variableName, r2.forEach(({ dimensionName: i2, values: r3 }) => {
    if (i2 && (r3 == null ? void 0 : r3.length)) {
...
function b(e, a2) {
  if (a2.pixelType.startsWith("f") && e.forEach(({ format: e2, fieldName: a3 }) => {
    ...
    e.forEach(({ format: e2, fieldName: a3 }) => {
      var _a;
      if (e2 && (a3 == null ? void 0 : a3.startsWith(n))) {
        const r2 = a3.slice(n.length), l2 = `${r2}${t}`, s2 = i2.find(({ name: e3 }) => e3 === r2 || e3 === l2);
        ((_a = s2 == null ? void 0 : s2.values) == null ? void 0 : _a.every((e3) => Number.isInteger(e3))) && (e2.places = 0);
      }
    });
  }
}
...
//# sourceMappingURL=chunk-MNME5SAY.js.map
