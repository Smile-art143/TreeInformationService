...
var S2 = class extends m4 {
  constructor(e10, t12) {
    super(e10, t12, new t5(z, () => import("./RibbonLine.glsl-C3ZT4DJ5.js")), v2(t12).locations), this.primitiveType = t12.wireframe ? _.LINES : _.TRIANGLE_STRIP;
  }
...
var d5 = class {
  constructor(e10, t12, o8 = "") {
    this.stage = e10, this.apiLayerViewUid = o8, this.id = e(), this.events = new i2(), this.visible = true, this.sliceable = false, this._objectsAdded = new Array(), this._handles = new r(), this._objects = /* @__PURE__ */ new Map(), this._pickable = true, this.visible = (t12 == null ? void 0 : t12.visible) ?? true, this._pickable = (t12 == null ? void 0 : t12.pickable) ?? true, this.updatePolicy = (t12 == null ? void 0 : t12.updatePolicy) ?? 0, e10.addLayer(this);
  ...
  getObject(e10) {
    return r2(this._objects.get(e10));
  }
  set pickable(e10) {
    this._pickable = e10;
  }
...
//# sourceMappingURL=chunk-4HCVJ7PF.js.map
