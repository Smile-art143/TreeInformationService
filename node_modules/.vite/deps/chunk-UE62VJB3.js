...
async function q(e2, t, r3) {
  const { applyEdits: n3 } = await import("./editingSupport-3Y5SDRIN.js"), o2 = await e2.load();
  let i2 = r3;
...
async function S(e2, t, r3) {
  const { uploadAssets: n3 } = await import("./editingSupport-3Y5SDRIN.js"), o2 = await e2.load();
...
async function O(e2, t, n3) {
  const o2 = (await e2.load({ signal: t == null ? void 0 : t.signal })).source;
...
async function A(e2, t, n3, o2) {
  ...
  if (!((_a2 = s4 == null ? void 0 : s4.data) == null ? void 0 : _a2.supportsAttachment)) throw new s(o2, "this layer doesn't support attachments");
  const { attachmentTypes: a4, objectIds: u3, globalIds: c, num: l, size: p4, start: d, where: f } = t;
  if (!((_b = s4 == null ? void 0 : s4.operations) == null ? void 0 : _b.supportsQueryAttachments)) {
    if ((a4 == null ? void 0 : a4.length) > 0 || (c == null ? void 0 : c.length) > 0 || (p4 == null ? void 0 : p4.length) > 0 || l || d || f) throw new s(o2, "when 'capabilities.operations.supportsQueryAttachments' is false, only objectIds is supported", t);
  }
  if (!((u3 == null ? void 0 : u3.length) || (c == null ? void 0 : c.length) || f)) throw new s(o2, "'objectIds', 'globalIds', or 'where' are required to perform attachment query", t);
  if (!i2.queryAttachments) throw new s(o2, "Layer source does not support queryAttachments capability", t);
  return !((_c = s4 == null ? void 0 : s4.attachment) == null ? void 0 : _c.supportsOrderByFields) && ((_d = t.orderByFields) == null ? void 0 : _d.length) && ((t = t.clone()).orderByFields = null), i2.queryAttachments(t);
}
...
function R(e2) {
  ...
  const r3 = (_a2 = e2.capabilities) == null ? void 0 : _a2.query;
  ...
  const n3 = (_b = e2.capabilities) == null ? void 0 : _b.data;
  (n3 == null ? void 0 : n3.supportsZ) && null != e2.returnZ && (t.returnZ = e2.returnZ), (n3 == null ? void 0 : n3.supportsM) && null != e2.returnM && (t.returnM = e2.returnM);
...
function N2(e2, t, r3, n3) {
  var _a2, _b;
  const o2 = r3 == null ? void 0 : r3.feature, i2 = !!((_a2 = e2.subtypes) == null ? void 0 : _a2.length);
  if (i2 && !(r3 == null ? void 0 : r3.excludeImpliedDomains)) {
    const r4 = U(e2, t);
    if (r4) return r4;
  }
  const s4 = i2 && Q(e2, o2);
  if (s4) {
    const e3 = (_b = s4 == null ? void 0 : s4.domains) == null ? void 0 : _b[t];
    return "inherited" === (e3 == null ? void 0 : e3.type) ? n3 : e3;
  }
  const a4 = oe(e2.types, e2.typeIdField, o2);
  if (a4) {
    const e3 = a4.domains && a4.domains[t];
    if (e3 && "inherited" !== (e3 == null ? void 0 : e3.type)) return e3;
  }
  if (n3) return n3;
  if (!(r3 == null ? void 0 : r3.excludeImpliedDomains)) {
    const r4 = V(e2, t);
    if (r4) return r4;
  }
  return null;
...
function Q(e2, t) {
  ...
  if (!(t == null ? void 0 : t.attributes) || !(r3 == null ? void 0 : r3.length) || !n3) return null;
...
function U(e2, t) {
  ...
  if (!o2) return null;
  if ((n3 && ((_a2 = r3.get(n3)) == null ? void 0 : _a2.name)) === o2 && ((_b = e2.subtypes) == null ? void 0 : _b.length)) {
    const t2 = e2.subtypes.map((e3) => new p({ code: G(e3.code, i2), name: e3.name }));
    if (t2 == null ? void 0 : t2.length) return new i({ codedValues: t2 });
  }
  return null;
}
function V(e2, t) {
  ...
  if (!n3) return null;
  if (("typeIdField" in e2 ? (_a2 = r3.get(e2.typeIdField)) == null ? void 0 : _a2.name : null) === n3 && "types" in e2 && ((_b = e2.types) == null ? void 0 : _b.length)) {
...
async function H(e2, t, r3) {
  var _a2;
  const n3 = (_a2 = e2.parsedUrl) == null ? void 0 : _a2.path;
  n3 && e2.authenticationTriggerEvent === t && await Z(n3, r3);
}
async function W(e2) {
  var _a2;
  const t = (_a2 = e2.parsedUrl) == null ? void 0 : _a2.path;
  t && _(e2) && await Z(t);
}
function _(e2) {
...
function K(e2) {
  var _a2;
  return !(!D(e2) || !((_a2 = e2.capabilities) == null ? void 0 : _a2.query.supportsCurrentUser));
}
function X(e2) {
  return !!(e2 == null ? void 0 : e2.toLowerCase().includes("current_user"));
}
function Y(e2) {
...
function te(e2, t) {
  var _a2;
  if (e2.defaultSymbol) return ((_a2 = e2.types) == null ? void 0 : _a2.length) ? new $({ defaultSymbol: ee(e2.defaultSymbol, e2, t), field: e2.typeIdField, uniqueValueInfos: e2.types.map((e3) => ({ id: e3.id, symbol: ee(e3.symbol, e3, t) })) }) : new p2({ symbol: ee(e2.defaultSymbol, e2, t) });
}
function re(e2) {
  var _a2, _b, _c;
  let t = (_a2 = e2.sourceJSON) == null ? void 0 : _a2.cacheMaxAge;
  if (!t) return false;
  const r3 = (_c = (_b = e2.editingInfo) == null ? void 0 : _b.lastEditDate) == null ? void 0 : _c.getTime();
...
function ie(e2) {
  var _a2;
  return ((_a2 = e2.sourceJSON) == null ? void 0 : _a2.isMultiServicesView) || se(e2);
}
function se(e2) {
  var _a2, _b;
  return !!((_b = (_a2 = e2.sourceJSON) == null ? void 0 : _a2.capabilities) == null ? void 0 : _b.toLowerCase().split(",").map((e3) => e3.trim()).includes("map"));
}
function ae(e2, t, n3) {
  var _a2;
  const o2 = t == null ? void 0 : t.queryAttributeBins;
  if (!((_a2 = t == null ? void 0 : t.operations) == null ? void 0 : _a2.supportsQueryBins) || !o2) throw new s(n3, "Layer source does not support binning");
  ...
  const i2 = o2 == null ? void 0 : o2.supportedStatistics;
...
function ue(e2, t) {
  return null != e2 && !!(t == null ? void 0 : t[n2.toJSON(e2)]);
}
...
//# sourceMappingURL=chunk-UE62VJB3.js.map
