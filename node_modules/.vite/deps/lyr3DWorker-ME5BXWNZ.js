...
function n() {
  var _a;
  return e || (e = 1, r = t, n2 = "undefined" != typeof document ? (_a = document.currentScript) == null ? void 0 : _a.src : void 0, o3 = async function(r2 = {}) {
    ...
    function R(r3) {
      var _a2;
      N++, (_a2 = o4.monitorRunDependencies) == null ? void 0 : _a2.call(o4, N);
    }
    function B(r3) {
      var _a2;
      if (N--, (_a2 = o4.monitorRunDependencies) == null ? void 0 : _a2.call(o4, N), 0 == N && M) {
        var e3 = M;
        M = null, e3();
      }
    }
    function j(r3) {
      var _a2;
      (_a2 = o4.onAbort) == null ? void 0 : _a2.call(o4, r3), F(r3 = "Aborted(" + r3 + ")"), A = true, r3 += ". Build with -sASSERTIONS for more info.";
      var e3 = new WebAssembly.RuntimeError(r3);
      throw c == null ? void 0 : c(e3), e3;
    }
    function W() {
    ...
    var rr = (r3, e3, t3) => {
      ...
      var _a2;
      ((_a2 = r3.output) == null ? void 0 : _a2.length) > 0 && (b(ur(r3.output)), r3.output = []);
      ...
      var _a2;
      ((_a2 = r3.output) == null ? void 0 : _a2.length) > 0 && (F(ur(r3.output)), r3.output = []);
    } } }, pr = (r3) => {
      j();
      ...
      function c2(t4) {
        function c3(t5) {
          l2 == null ? void 0 : l2(), s2 || yr(r3, e3, t5, n3, o5, u2), a3 == null ? void 0 : a3(), B();
        }
        Er(t4, d2, c3, () => {
          i2 == null ? void 0 : i2(), B();
        }) || c3(t4);
      ...
      e3.follow_mount ?? (e3.follow_mount = true), nr.isAbs(r3) || (r3 = Fr.cwd() + "/" + r3);
        ...
        for (var n3 = r3.split("/").filter((r4) => !!r4), o5 = Fr.root, a3 = "/", i2 = 0; i2 < n3.length; i2++) {
          ...
          if ("." !== n3[i2]) if (".." !== n3[i2]) {
            ...
            try {
              ...
              if (44 === (l2 == null ? void 0 : l2.errno) && s2 && e3.noent_okay) return { path: a3 };
              throw l2;
            }
      ...
      var n3 = r3 == null ? void 0 : r3.stream_ops.setattr, o5 = n3 ? r3 : e3;
      n3 ?? (n3 = e3.node_ops.setattr), Fr.checkOpExists(n3, 63), n3(o5, t3);
    }, chrdev_stream_ops: { open(r3) {
      var _a2, _b;
      var e3 = Fr.getDevice(r3.node.rdev);
      r3.stream_ops = e3.stream_ops, (_b = (_a2 = r3.stream_ops).open) == null ? void 0 : _b.call(_a2, r3);
    }, llseek() {
      ...
      return n3 ?? (n3 = t3.node_ops.getattr), Fr.checkOpExists(n3, 63), n3(o5);
      ...
      Fr.initialized = true, r3 ?? (r3 = o4.stdin), e3 ?? (e3 = o4.stdout), t3 ?? (t3 = o4.stderr), Fr.createStandardStreams(r3, e3, t3);
    }, quit() {
      ...
      (_a2 = Fr.createDevice).major ?? (_a2.major = 64);
    ...
    var ve = (r3) => {
      ...
      var _a2;
      mt() || ((_a2 = o4.onExit) == null ? void 0 : _a2.call(o4, r3), A = true), i(r3, new V(r3));
    }, pt = (r3, e3) => {
      ht(r3);
    };
    function vt(r3) {
    ...
    function an() {
      function r3() {
        var _a2;
        o4.calledRun = true, A || (T(), d == null ? void 0 : d(o4), (_a2 = o4.onRuntimeInitialized) == null ? void 0 : _a2.call(o4), x());
      }
...
//# sourceMappingURL=lyr3DWorker-ME5BXWNZ.js.map
