...
__decorate([m({ type: String, json: { origins: { "web-scene": { write: true }, "portal-item": { write: true } } } })], a6.prototype, "title", void 0), __decorate([o("service", "title", ["alias", "name"])], a6.prototype, "readTitle", null), __decorate([m()], a6.prototype, "layer", void 0), __decorate([m({ type: x, readOnly: true, json: { read: false, write: { ignoreOrigin: true, isRequired: true } } })], a6.prototype, "id", void 0), __decorate([o("service", "id")], a6.prototype, "readIdOnlyOnce", null), __decorate([m(c2(String))], a6.prototype, "modelName", void 0), __decorate([m(c2(Boolean))], a6.prototype, "isEmpty", void 0), __decorate([m({ type: Boolean, nonNullable: true })], a6.prototype, "legendEnabled", void 0), __decorate([m({ type: Boolean, json: { name: "visibility", write: true } })], a6.prototype, "visible", void 0), __decorate([m({ type: Number, json: { write: true } })], a6.prototype, "opacity", void 0), a6 = __decorate([a2("esri.layers.buildingSublayers.BuildingSublayer")], a6);
...
var C = class extends p(m2(a6)) {
  ...
  get parsedUrl() {
    var _a3, _b;
    return this.layer ? { path: `${(_a3 = this.layer.parsedUrl) == null ? void 0 : _a3.path}/sublayers/${this.id}`, query: (_b = this.layer.parsedUrl) == null ? void 0 : _b.query } : { path: "" };
  }
  get fieldsIndex() {
  ...
  getFieldDomain(e2, t6) {
    var _a3;
    const r3 = ((_a3 = this.getField(e2)) == null ? void 0 : _a3.domain) ?? null;
  ...
  queryFeatures(e2, t6) {
    return this._getAssociatedLayerForQuery().then((r3) => r3.queryFeatures(e2 || this.createQuery(), t6)).then((e3) => {
      if (e3 == null ? void 0 : e3.features) for (const t7 of e3.features) t7.layer = this.layer, t7.sourceLayer = this, t7.origin = this.graphicOrigin;
      return e3;
    });
  }
...
function a7(r3, o7, t6) {
  if (r3 && Array.isArray(r3)) return new O(r3.map((r4) => {
    ...
    return (t6 == null ? void 0 : t6.messages) && r4 && t6.messages.push(new s2("building-scene-layer:unsupported-sublayer-type", "Building scene sublayer of type '" + (r4.type || "unknown") + "' are not supported", { definition: r4, context: t6 })), null;
  }));
}
function c3(r3) {
...
var d5;
var u2 = O.ofType(c6);
var m10 = d5 = class extends n {
  constructor(o7) {
    super(o7), this.description = null, this.filterBlocks = null, this.id = n2(), this.name = null;
  }
  clone() {
...
__decorate([m({ type: String, json: { write: true } })], m10.prototype, "description", void 0), __decorate([m({ type: u2, json: { write: { enabled: true, isRequired: true } } })], m10.prototype, "filterBlocks", void 0), __decorate([m({ types: { key: "type", base: p5, typeMap: { checkbox: m7 } }, json: { read: (o7) => "checkbox" === (o7 == null ? void 0 : o7.type) ? m7.fromJSON(o7) : null, write: true } })], m10.prototype, "filterAuthoringInfo", void 0), __decorate([m({ type: String, constructOnly: true, json: { write: { enabled: true, isRequired: true } } })], m10.prototype, "id", void 0), __decorate([m({ type: String, json: { write: { enabled: true, isRequired: true } } })], m10.prototype, "name", void 0), m10 = d5 = __decorate([a2("esri.layers.support.BuildingFilter")], m10);
...
var _a2;
var H2 = (_a2 = M.json) == null ? void 0 : _a2.origins;
...
var k = class extends _2(l3(b2(j2(t(l2(s5(o4(b3)))))))) {
  ...
  read(e2, t6) {
    if (super.read(e2, t6), ("web-scene" === (t6 == null ? void 0 : t6.origin) || "portal-item" === (t6 == null ? void 0 : t6.origin)) && Array.isArray(e2 == null ? void 0 : e2.sublayers)) {
      const r3 = W(e2.sublayers, t6);
      this.sublayers ? G(this.sublayers, r3) : (this._allSublayerOverrides ?? (this._allSublayerOverrides = /* @__PURE__ */ new Map()), this._allSublayerOverrides.set(t6.origin, r3));
    }
  }
...
function W(e2, t6) {
  ...
  for (const s10 of e2) null != s10 && "object" == typeof s10 && "number" == typeof s10.id ? r3.set(s10.id, s10) : (_a3 = t6.messages) == null ? void 0 : _a3.push(new s("building-scene-layer:invalid-sublayer-override", "Invalid value for sublayer override. Not an object or no id specified.", { value: s10 }));
...
function J(e2, t6, r3) {
  const i7 = (r3 == null ? void 0 : r3.origin) && e2.get(r3.origin);
  i7 && (t6.sublayers = [], i7.overrides.forEach((e3) => {
    t6.sublayers.push(a(e3));
  }));
}
__decorate([m({ type: ["BuildingSceneLayer"] })], k.prototype, "operationalLayerType", void 0), __decorate([m({ readOnly: true })], k.prototype, "allSublayers", void 0), __decorate([m(M)], k.prototype, "sublayers", void 0), __decorate([o("service", "sublayers")], k.prototype, "readSublayers", null), __decorate([m({ type: R2, nonNullable: true, json: { write: true } })], k.prototype, "filters", void 0), __decorate([m({ type: String, json: { write: true } })], k.prototype, "activeFilterId", void 0), __decorate([m({ readOnly: true, type: p12 })], k.prototype, "summaryStatistics", void 0), __decorate([o("summaryStatistics", ["statisticsHRef"])], k.prototype, "readSummaryStatistics", null), __decorate([m({ type: [String], json: { read: false } })], k.prototype, "outFields", void 0), __decorate([m(g)], k.prototype, "fullExtent", void 0), __decorate([m(d2)], k.prototype, "legendEnabled", void 0), __decorate([m({ type: ["show", "hide", "hide-children"] })], k.prototype, "listMode", void 0), __decorate([m(c2(f2))], k.prototype, "spatialReference", void 0), __decorate([m(m4)], k.prototype, "elevationInfo", null), __decorate([m({ json: { read: false }, readOnly: true })], k.prototype, "type", void 0), __decorate([m()], k.prototype, "associatedFeatureServiceItem", void 0), k = __decorate([a2("esri.layers.BuildingSceneLayer")], k);
var q2 = k;
export {
  q2 as default
};
//# sourceMappingURL=BuildingSceneLayer-HRLMIIUT.js.map
