...
function b(e, t) {
  const n2 = t == null ? void 0 : t.visibleFieldNames;
  return f2({ fields: e.fields ?? [], ignoreFieldTypes: (t == null ? void 0 : t.ignoreFieldTypes) || C, sortDisabled: t == null ? void 0 : t.sortDisabled }).map((t2) => new f({ fieldName: t2.name, isEditable: H(t2, e), label: t2.alias, format: g(t2), visible: c(t2, { ...e, visibleFieldNames: n2 }) }));
}
function g(e) {
  switch (e.type) {
    case "small-integer":
...
//# sourceMappingURL=chunk-XKYTWBRI.js.map
