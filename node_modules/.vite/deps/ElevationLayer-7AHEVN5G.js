...
var S = class extends p(l2(b(j(l(b2))))) {
  ...
  async queryElevation(e, r2) {
    const { query: t3 } = await import("./ElevationQuery-GCZ2TE6Y.js");
    return s2(r2), t3(this, e, r2);
  }
  async createElevationSampler(e, r2) {
    const { createSampler: t3 } = await import("./ElevationQuery-GCZ2TE6Y.js");
    return s2(r2), t3(this, e, r2);
  }
...
//# sourceMappingURL=ElevationLayer-7AHEVN5G.js.map
