...
var _Button = class _Button extends LitElement {
  constructor() {
    super(...arguments);
  ...
  render() {
    ...
    const DynamicHtmlTag = this.href ? literal`a` : literal`button`;
    const loaderNode = this.loading ? html`<div class=${safeClassMap(CSS.buttonLoader)}><calcite-loader class=${safeClassMap(this.loading ? CSS.loadingIn : CSS.loadingOut)} inline .label=${this.messages.loading} .scale=${this.scale === "l" ? "m" : "s"}></calcite-loader></div>` : null;
    ...
    return InteractiveContainer({ disabled: this.disabled, children: html2`<${DynamicHtmlTag} .ariaBusy=${this.loading} .ariaExpanded=${this.el.ariaExpanded ? this.el.ariaExpanded : null} .ariaLabel=${!this.loading ? getLabelText(this) : this.messages.loading} aria-live=polite class=${safeClassMap({
...
@esri/calcite-components/dist/components/calcite-button/customElement.js:
  ...
  v3.3.3 *)
*/
//# sourceMappingURL=calcite-button-NG7DECPP.js.map
