...
import "./chunk-XDYFOHYK.js";
import "./chunk-SRURIDNB.js";
...
var h5 = class {
  ...
  _getOutlineColor() {
    var _a;
    const t5 = this._getLayerOpacity(), r4 = this._symbolLayer, i5 = (_a = r4 == null ? void 0 : r4.outline) == null ? void 0 : _a.color;
    if (null != i5) {
  ...
  _getFillColor() {
    ...
    const e12 = null == this._getPrimitive(), t5 = (_b = (_a = this._symbolLayer) == null ? void 0 : _a.material) == null ? void 0 : _b.color;
...
function g2(e12) {
  var _a, _b;
  return ((_a = e12.resource) == null ? void 0 : _a.href) ? null : ((_b = e12.resource) == null ? void 0 : _b.primitive) ?? j2;
}
...
var v2 = class {
  ...
  async _load() {
    ...
    this._primitive = s13 && S(s13 == null ? void 0 : s13.primitive) ? s13.primitive : d3;
...
var s10 = class {
  ...
  async createAddCommand(t5) {
    const e12 = this._context, n13 = this._partition(t5), a10 = await Promise.all(n13.map(async ({ index: t6, features: e13 }) => {
      ...
      return await (n14 == null ? void 0 : n14.createAddCommand(e13));
  ...
  async createRemoveCommand(e12) {
    ...
    const s13 = await Promise.all(i5.map(async ({ index: t5, features: e13 }) => {
      ...
      return await (n14 == null ? void 0 : n14.createRemoveCommand(e13.id));
  ...
  async createUpdateVisibilityCommand(e12) {
    ...
    const s13 = await Promise.all(i5.map(async ({ index: t5, features: e13 }) => {
      const n14 = this._getLoadedSymbol(t5);
      return await (n14 == null ? void 0 : n14.createUpdateVisibilityCommand(e13));
    }));
  ...
  async createUpdateElevationCommand() {
    ...
    for (const o7 of t5.values()) {
      const t6 = o7.map(async ({ index: t7, features: e13 }) => {
        ...
        return await (n14 == null ? void 0 : n14.createUpdateElevationCommand(e13));
      });
      n13.push(...t6);
    }
    const a10 = await Promise.all(n13);
...
var m4 = class {
  ...
  createSymbolRendererFromSymbol(e12) {
    const r4 = e12 == null ? void 0 : e12.type;
    switch (r4) {
      case "point-3d":
...
var _2 = class extends b {
  ...
  get updating() {
    var _a;
    return this._updateRequested || !(((_a = this._synchronizationTask) == null ? void 0 : _a.finished) ?? 1);
  }
  get _boundingRect() {
  ...
  get _missingTiles() {
    ...
    for (const o7 of e12.values()) null == ((_a = s13.get(o7.id)) == null ? void 0 : _a.featureData) && t5.push(o7);
    return t5;
  }
  ...
  _scheduleTilesSync() {
    ...
    const t5 = this._synchronizationTask, e12 = d(async () => {
      try {
        await j(() => (t5 == null ? void 0 : t5.finished) ?? true), await P(), this._updateRequested = false, await this._synchronizeTiles();
      } finally {
  ...
  *loadedTiles() {
  ...
  async _removeTile(s13) {
    ...
    if (null != o7) {
      ...
      try {
        ...
        await (e12 == null ? void 0 : e12.execute());
      } catch (a10) {
  ...
  async _onTileLoad(s13) {
    ...
    try {
      ...
      await (v4 == null ? void 0 : v4.execute());
    } catch (i5) {
...
__decorate([m3()], _2.prototype, "updating", null), __decorate([m3({ constructOnly: true })], _2.prototype, "loadTile", void 0), __decorate([m3({ constructOnly: true })], _2.prototype, "createAddCommand", void 0), __decorate([m3({ constructOnly: true })], _2.prototype, "createRemoveCommand", void 0), __decorate([m3({ constructOnly: true })], _2.prototype, "createUpdateCommand", void 0), __decorate([m3({ constructOnly: true })], _2.prototype, "tileLocks", void 0), __decorate([m3()], _2.prototype, "extent", void 0), __decorate([m3()], _2.prototype, "_boundingRect", null), __decorate([m3()], _2.prototype, "_missingTiles", null), __decorate([m3()], _2.prototype, "_updateRequested", void 0), __decorate([m3()], _2.prototype, "_synchronizationTask", void 0), _2 = __decorate([a("esri.views.3d.layers.graphics.pipeline.Tile3DManager")], _2);
var v3 = class {
  constructor(t5, e12) {
...
var u7 = class {
  ...
  getAttribute(e12, t5) {
    var _a;
    const { _index: { fieldsIndex: r4, attributeIndices: s13 } } = this, n13 = (_a = r4.get(t5)) == null ? void 0 : _a.index;
    if (null == n13) return;
  ...
  async fetch(r4, s13) {
    ...
    for (; !h8; ) {
      ...
      for (const e12 of r5) {
        ...
        h8 || (h8 = !e12.exceededTransferLimit || !t6), t6 && p4.push(e12);
      }
...
__decorate([m3()], R.prototype, "updating", null), R = __decorate([a("esri.views.3d.layers.graphics.pipeline.Feature3DPipelineWorker")], R);
var S2 = R;
var j5 = { result: void 0 };
export {
  S2 as default
};
//# sourceMappingURL=Feature3DPipelineWorker-76VQ7HTY.js.map
