...
var h = class {
  ...
  _fail(t, e2 = false) {
    var _a;
    if ((_a = this._runResolver) == null ? void 0 : _a.reject(t), this._state = "stopped", !e2) throw t;
  }
  _schedule(t) {
  ...
  _tryQueue() {
    var _a, _b;
    if ("running" === this._state) if ((_a = this._abortSignal) == null ? void 0 : _a.aborted) this._fail(u(), true);
    else {
      ...
      if (0 === this._running.size) return (_b = this._runResolver) == null ? void 0 : _b.resolve(), this._runResolver = null, void (this._state = "stopped");
...
//# sourceMappingURL=batchExec-NCO5W7RE.js.map
