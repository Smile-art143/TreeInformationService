import {
  de
} from "./chunk-YJ4JS5GU.js";
import "./chunk-MURNF66K.js";
import "./chunk-RIOHB6DZ.js";
import "./chunk-ZRO75J36.js";
import "./chunk-4IT2QVEY.js";
import "./chunk-CT6RKCRZ.js";
import {
  c as c3
} from "./chunk-XTQ6U5WZ.js";
import "./chunk-JSOMX4ZV.js";
import "./chunk-3KXCGVVM.js";
import "./chunk-NFD7ZJKB.js";
import "./chunk-UN2BL23A.js";
import "./chunk-OL6EYE44.js";
import "./chunk-UAU5YLNR.js";
import {
  j as j2
} from "./chunk-7JGV7FSO.js";
import {
  e as e4
} from "./chunk-YHESGP33.js";
import "./chunk-OU35ROYX.js";
import "./chunk-PDCZEJUK.js";
import "./chunk-PL7JWLUK.js";
import "./chunk-ZNHSRWJV.js";
import "./chunk-VL4B5WMX.js";
import "./chunk-4E3MFXTP.js";
import "./chunk-37CPFFEL.js";
import "./chunk-J4P2TSH5.js";
import {
  R,
  j,
  q,
...
var n4 = class extends m3(l) {
  ...
  get visible() {
    var _a;
    return (((_a = this.parent) == null ? void 0 : _a.visible) && !this.parent.suspended) ?? true;
  }
  set visible(e10) {
...
__decorate([m2({ constructOnly: true })], n4.prototype, "parent", void 0), __decorate([m2({ constructOnly: true })], n4.prototype, "view", void 0), __decorate([m2({ type: Boolean })], n4.prototype, "interactive", null), __decorate([m2()], n4.prototype, "_userInteractive", void 0), __decorate([m2({ readOnly: true })], n4.prototype, "updating", null), __decorate([m2()], n4.prototype, "visible", null), __decorate([m2()], n4.prototype, "_interactiveViewModelCount", void 0), n4 = __decorate([a2("esri.views.analysis.AnalysisView")], n4);

// node_modules/@arcgis/core/views/2d/analysis/AnalysisView2D.js
var e5 = class extends n4 {
};
e5 = __decorate([a2("esri.views.2d.analysis.AnalysisView2D")], e5);
...
__decorate([m2({ constructOnly: true })], e6.prototype, "view", void 0), __decorate([m2({ constructOnly: true })], e6.prototype, "analysisViewData", void 0), __decorate([m2()], e6.prototype, "updating", null), e6 = __decorate([a2("esri.views.2d.analysis.ElevationProfile.ElevationProfileInputVisualization2D")], e6);
...
var d3 = class extends b {
  constructor(t6) {
    super(t6), this._graphic = new _4(), this._layer = new n2({ listMode: "hide", internal: true }), this._updateGeometryThrottled = l3((t7) => {
      ...
      const e10 = this._layer, r6 = (_a = this.view.map) == null ? void 0 : _a.layers;
  ...
  destroy() {
    var _a;
    (_a = this.view.map) == null ? void 0 : _a.remove(this._layer), this._layer.destroy(), this._graphic.destroy();
  }
  get updating() {
  ...
  get _result() {
    ...
    return t6.visible ? t6.results.find(({ available: t7, computation: e10, rawResult: r6 }) => t7 && e10.profile.viewOptions.lineVisible && true === (r6 == null ? void 0 : r6.hasZ)) : null;
  }
  get _geometryUpdateParameters() {
    const t6 = this._result;
    return 1 !== (t6 == null ? void 0 : t6.progress) ? null : { samples: t6.samples, spatialReference: this.view.spatialReference };
  }
  get _colorUpdateParameters() {
    var _a;
    const t6 = (_a = this._result) == null ? void 0 : _a.computation.profile.color;
...
__decorate([m2({ constructOnly: true })], d3.prototype, "view", void 0), __decorate([m2({ constructOnly: true })], d3.prototype, "analysisViewData", void 0), __decorate([m2()], d3.prototype, "updating", null), __decorate([m2()], d3.prototype, "_result", null), __decorate([m2()], d3.prototype, "_geometryUpdateParameters", null), __decorate([m2()], d3.prototype, "_colorUpdateParameters", null), d3 = __decorate([a2("esri.views.2d.analysis.ElevationProfile.ElevationProfileLineVisualization2D")], d3);
...
var l6 = class extends b {
  ...
  initialize() {
    ...
    }, w2)]), (_a = this.view.surface) == null ? void 0 : _a.appendChild(this.element);
  }
  destroy() {
    this.element.remove();
  }
  get _screenLocation() {
    ...
    const t6 = e10 == null ? void 0 : e10.spatialReference, r6 = t6 ? X(o10, t6).geometry : null;
    return r6 && (e10 == null ? void 0 : e10.ready) ? e10.toScreen(r6) : null;
  }
};
function a4() {
...
__decorate([m2()], l6.prototype, "position", void 0), __decorate([m2({ type: u3 })], l6.prototype, "color", void 0), __decorate([m2()], l6.prototype, "view", void 0), __decorate([m2()], l6.prototype, "_screenLocation", null), l6 = __decorate([a2("esri.views.analysis.ElevationProfile.ElevationProfileHoveredPointVisualization")], l6);
...
var l7 = class extends b {
  ...
  initialize() {
    ...
    this.addHandles([l2(() => {
      ...
      return r6 ? i5 ? null : e10.map((o11, e11) => {
        ...
        return true === (r7 == null ? void 0 : r7.viewOptions.hoveredPointVisible) && null != o11 ? { hoveredPoint: o11, color: r7.color } : null;
      }).filter((o11) => !!o11) : [];
  ...
  _update(o10) {
    ...
    for (; e10.length > r6; ) (_a = e10.pop()) == null ? void 0 : _a.destroy();
    for (; e10.length < r6; ) {
...
__decorate([m2()], l7.prototype, "view", void 0), __decorate([m2()], l7.prototype, "analysisViewData", void 0), __decorate([m2()], l7.prototype, "_hoveredPoints", void 0), __decorate([m2()], l7.prototype, "updating", null), l7 = __decorate([a2("esri.views.analysis.ElevationProfile.ElevationProfileHoveredPointsVisualization")], l7);
...
__decorate([m2()], n5.prototype, "view", void 0), __decorate([m2()], n5.prototype, "analysisViewData", void 0), __decorate([m2()], n5.prototype, "updating", null), n5 = __decorate([a2("esri.views.2d.analysis.ElevationProfile.ElevationProfileVisualization2D")], n5);
...
function t3(t6, n9) {
  ...
  function e10(...e11) {
    ...
    return r6 && void 0 !== o10 && (n9 == null ? void 0 : n9(o10, i5)) ? o10 : (r6 = true, o10 = i5, i5);
  }
  return e10;
}
...
async function y4(e10, t6, s6, o10, i5, a6, h4) {
  ...
  let v3 = 0;
  if (!j5) {
    const { execute: t7 } = await import("./lengthOperator-ICDXYTWZ.js");
...
function v({ spatialReference: e10, hasZ: t6 }, n9, r6, { elevationProvider: s6 }) {
  const o10 = (t7, n10, r7, o11) => (s6 == null ? void 0 : s6.getElevation(t7, n10, r7, e10, o11)) ?? 0;
  switch (n9) {
    case "on-the-ground":
...
function S(e10) {
  return b2(e10) && U3(e10 == null ? void 0 : e10.geometry);
}
function U3(e10) {
...
function A(e10) {
  const t6 = e10 == null ? void 0 : e10.layer;
...
async function* j4(e10, t6) {
  ...
  try {
    ...
    j5.forEach((e11) => {
      var _a;
      return (_a = e11.return) == null ? void 0 : _a.call(e11);
    });
  }
...
var k2 = class extends b {
  constructor(t6) {
    super(t6), this.error = null, this._getStableEffectiveUnits = t3(() => {
      ...
      return (t7 == null ? void 0 : t7.ready) && this._queue ? { view: t7, geometry: e10.geometry, geometryIsValid: e10.valid, elevationInfo: this.elevationInfo, queue: this._queue, cache: this._tileCache, options: this._options, slicePlane: "3d" === t7.type ? t7.slice.plane : null } : null;
    }, h), this._getStableElevationInfo = t3(() => this.analysis.elevationInfo ?? V, o), this._getStableOptions = t3(() => {
  ...
  initialize() {
    ...
    this._queue = S2(t6 == null ? void 0 : t6.scheduler), t6 == null ? void 0 : t6.addUpdatingObject(this);
  }
  destroy() {
    var _a;
    this._abortUpdate(), this._parametersPerComputation.clear(), (_a = this._computationsCollection) == null ? void 0 : _a.destroy(), this._queue = u(this._queue), this._currentTileCache = u(this._currentTileCache);
  }
  ...
  get updating() {
    var _a;
    const { progress: t6 } = this, e10 = !!((_a = this._queue) == null ? void 0 : _a.updating), o10 = this._updateThrottled.hasPendingUpdates(), i5 = null != this._updateTask && !this._updateTask.finished;
  ...
  onElevationChange(t6) {
    const { view: e10 } = this;
    return "3d" === (e10 == null ? void 0 : e10.type) ? a3(() => e10.elevationProvider, "elevation-change", t6, { onListenerAdd: t6, onListenerRemove: t6 }) : e2();
  }
  get _tileCache() {
    var _a;
    this._currentTileCache = u(this._currentTileCache);
    const t6 = this.view;
    if ("3d" === (t6 == null ? void 0 : t6.type)) {
      const e10 = (_a = t6.basemapTerrain) == null ? void 0 : _a.elevationQueryCache;
  ...
  get _computations() {
    var _a;
    return ((_a = this._computationsCollection) == null ? void 0 : _a.toArray()) ?? [];
  }
...
__decorate([m2({ constructOnly: true })], k2.prototype, "analysis", void 0), __decorate([m2({ constructOnly: true })], k2.prototype, "analysisViewData", void 0), __decorate([m2({ constructOnly: true })], k2.prototype, "computationFactory", void 0), __decorate([m2({ constructOnly: true })], k2.prototype, "view", void 0), __decorate([m2()], k2.prototype, "error", void 0), __decorate([m2({ readOnly: true })], k2.prototype, "effectiveDisplayUnits", null), __decorate([m2()], k2.prototype, "progress", null), __decorate([m2()], k2.prototype, "updating", null), __decorate([m2()], k2.prototype, "results", null), __decorate([m2()], k2.prototype, "statistics", null), __decorate([m2()], k2.prototype, "hoveredPoints", null), __decorate([m2()], k2.prototype, "_updateTask", void 0), __decorate([m2()], k2.prototype, "_queue", void 0), __decorate([m2()], k2.prototype, "_tileCache", null), __decorate([m2()], k2.prototype, "_computationsCollection", void 0), __decorate([m2()], k2.prototype, "_computations", null), __decorate([m2()], k2.prototype, "_activeComputations", null), __decorate([m2({ readOnly: true })], k2.prototype, "_minDemResolution", null), __decorate([m2()], k2.prototype, "_minDemResolutions", null), __decorate([m2()], k2.prototype, "_updateParameters", null), __decorate([m2()], k2.prototype, "_generationParameters", null), __decorate([m2()], k2.prototype, "elevationInfo", null), __decorate([m2()], k2.prototype, "_options", null), k2 = __decorate([a2("esri.views.analysis.ElevationProfile.ElevationProfileController")], k2);
var V = new c({ ...U2 });
...
__decorate([m2()], u5.prototype, "available", null), __decorate([m2({ readOnly: true })], u5.prototype, "profile", null), __decorate([m2({ readOnly: true })], u5.prototype, "progress", null), __decorate([m2()], u5.prototype, "samples", null), __decorate([m2()], u5.prototype, "statistics", null), __decorate([m2({ constructOnly: true })], u5.prototype, "computation", void 0), __decorate([m2()], u5.prototype, "rawResult", void 0), __decorate([m2()], u5.prototype, "hoveredPoint", null), u5 = __decorate([a2("esri.views.analysis.ElevationProfile.ElevationProfileResult")], u5);
...
__decorate([m2({ constructOnly: true })], p.prototype, "controller", void 0), __decorate([m2({ constructOnly: true })], p.prototype, "profile", void 0), __decorate([m2({ constructOnly: true })], p.prototype, "onInvalidate", void 0), __decorate([m2()], p.prototype, "result", void 0), __decorate([m2({ readOnly: true })], p.prototype, "progress", null), __decorate([m2()], p.prototype, "hoveredPoint", null), __decorate([m2()], p.prototype, "available", null), __decorate([m2()], p.prototype, "numSamplesForPreview", void 0), __decorate([m2()], p.prototype, "numSamplesPerChunk", void 0), __decorate([m2({ readOnly: true })], p.prototype, "minDemResolution", null), p = __decorate([a2("esri.views.analysis.ElevationProfile.ElevationProfileLineComputation")], p);
...
function u6(n9) {
  ...
  const u10 = (_a = r6.lods) == null ? void 0 : _a.at(-1);
...
var u7 = class extends p {
  constructor() {
    super(...arguments), this.type = "ground", this.numSamplesForPreview = 50, this.numSamplesPerChunk = 1e3, this._getStableQueryElevationDependencies = t3(() => ({ ground: this._ground, groundLayers: this._getStableGroundLayers() }), h), this._getStableGroundLayers = t3(() => {
      var _a, _b;
  ...
  get available() {
    var _a;
    return true === ((_a = this._ground) == null ? void 0 : _a.layers.some((e10) => e10.visible));
  }
  initialize() {
  ...
  get _ground() {
    var _a, _b;
    return (_b = (_a = this.controller.view) == null ? void 0 : _a.map) == null ? void 0 : _b.ground;
  }
};
__decorate([m2()], u7.prototype, "minDemResolution", null), __decorate([m2()], u7.prototype, "available", null), __decorate([m2()], u7.prototype, "_queryElevationDependencies", null), __decorate([m2()], u7.prototype, "_ground", null), u7 = __decorate([a2("esri.views.analysis.ElevationProfile.ElevationProfileLineGroundComputation")], u7);

// node_modules/@arcgis/core/views/analysis/ElevationProfile/elevationProfileLayerUtils.js
function r5(r6) {
  var _a, _b;
  return ((_b = (_a = r6 == null ? void 0 : r6.map) == null ? void 0 : _a.allLayers) == null ? void 0 : _b.toArray().filter((r7) => ("graphics" !== r7.type || !r7.internal) && r7.visible).map((r7) => r7.uid)) ?? [];
}
...
var u8 = class extends p {
  constructor() {
    ...
    }, h), this._getStableElevationInfo = t3(() => this.controller.elevationInfo, o), this._getStableSpatialReference = t3(() => {
      var _a;
      return (_a = this.controller.view) == null ? void 0 : _a.spatialReference;
    }, o), this._getStableLayerIds = t3(() => {
      const { view: e10 } = this.controller;
  ...
  get _requiresElevationAlignment() {
    var _a;
    return "on-the-ground" === ((_a = this.controller.elevationInfo) == null ? void 0 : _a.mode) && "3d" === this.controller.view.type;
  }
  get _queryElevationDependencies() {
    return this._getStableElevationDependencies();
  }
};
__decorate([m2()], u8.prototype, "_queryElevationDependencies", null), u8 = __decorate([a2("esri.views.analysis.ElevationProfile.ElevationProfileLineInputComputation")], u8);
...
__decorate([m2({ readOnly: true })], n8.prototype, "minDemResolution", null), __decorate([m2()], n8.prototype, "available", null), n8 = __decorate([a2("esri.views.analysis.ElevationProfile.ElevationProfileLineQueryComputation")], n8);
...
var s5 = class {
  ...
  get currentOperationType() {
    var _a;
    return ((_a = this._currentOperationSignal.value) == null ? void 0 : _a.type) ?? null;
  }
  destroy() {
    this.stop();
  }
  async start(i5, s6, l9) {
    ...
    p2 == null ? void 0 : p2.stop();
    const c4 = new AbortController(), u10 = l9 == null ? void 0 : l9.signal, h4 = AbortSignal.any([c4.signal, u10].filter(N)), m8 = $();
    let g = false;
    const y6 = () => {
    ...
    try {
      ...
      o2(v3.handles), this._currentOperationSignal.value === v3 && (this._currentOperationSignal.value = null);
    }
  }
  stop() {
    var _a;
    (_a = this._currentOperationSignal.value) == null ? void 0 : _a.stop();
  }
};
...
var L2 = class extends b {
  ...
  destroy() {
    ...
    (_a = this.view.map) == null ? void 0 : _a.remove(e10), e10.destroy();
  }
  get sketchGraphic() {
  ...
  place(e10) {
    return this._operationManager.start("place", async (t6) => {
      ...
      const a6 = this.sketchGraphic, o10 = this._analysis.elevationInfo, h4 = e2(() => {
  ...
  async pickFeature(e10) {
    return this._operationManager.start("pick-feature", async (e11) => {
      ...
      const a6 = (a7) => {
        a7.defer(async () => {
          s6 == null ? void 0 : s6.abort(), s6 = d2(async (s7) => {
      ...
      e11.handles.push(t6.on("immediate-click", a6, f6.TOOL), t6.on("key-down", o10, f6.TOOL), t6.acquireCursor("crosshair", "high"), e2(() => {
        s6 == null ? void 0 : s6.abort(), e11.reject();
      })), t6.focus();
    }, e10);
  }
  _startReshape() {
  ...
  _ensureUpdatedSketchGraphic() {
    ...
    const s6 = this.sketchGraphic ?? (this.sketchGraphic = new _4({ symbol: this._lineSymbol, geometry: e10 }));
  ...
  _updateAnalysisFromSketchGraphic() {
    var _a;
    let e10 = (_a = this.sketchGraphic) == null ? void 0 : _a.geometry;
    U3(e10) || (e10 = null);
...
function I4(e10, t6) {
  t6 && (t6.removeFromParent(), e10 == null ? void 0 : e10.add(t6));
}
__decorate([m2({ constructOnly: true })], L2.prototype, "analysisViewData", void 0), __decorate([m2({ constructOnly: true })], L2.prototype, "view", void 0), __decorate([m2()], L2.prototype, "sketchGraphic", null), __decorate([m2({ nonNullable: true })], L2.prototype, "state", null), __decorate([m2()], L2.prototype, "updating", null), __decorate([m2()], L2.prototype, "_sketching", null), __decorate([m2()], L2.prototype, "_analysis", null), __decorate([m2()], L2.prototype, "_lineSymbol", null), L2 = __decorate([a2("esri.views.analysis.ElevationProfile.ElevationProfileTool")], L2);
...
var u9 = class extends e5 {
  ...
  destroy() {
    var _a, _b, _c;
    (_a = this._controller) == null ? void 0 : _a.destroy(), (_b = this._visualization) == null ? void 0 : _b.destroy(), (_c = this._sketchTool) == null ? void 0 : _c.destroy();
  }
  get effectiveDisplayUnits() {
    var _a;
    return ((_a = this._controller) == null ? void 0 : _a.effectiveDisplayUnits) ?? { distance: "meters", elevation: "meters" };
  }
  get error() {
    var _a;
    return (_a = this._controller) == null ? void 0 : _a.error;
  }
  get hoveredPoints() {
    var _a;
    return ((_a = this._controller) == null ? void 0 : _a.hoveredPoints) ?? [];
  }
  get interactive() {
  ...
  get progress() {
    var _a;
    return ((_a = this._controller) == null ? void 0 : _a.progress) ?? 0;
  }
  get results() {
    var _a;
    return ((_a = this._controller) == null ? void 0 : _a.results) ?? [];
  }
  get statistics() {
    var _a;
    return (_a = this._controller) == null ? void 0 : _a.statistics;
  }
  get updating() {
    var _a, _b, _c;
    return true === ((_a = this._controller) == null ? void 0 : _a.updating) || true === ((_b = this._visualization) == null ? void 0 : _b.updating) || true === ((_c = this._sketchTool) == null ? void 0 : _c.updating);
  }
  get visible() {
  ...
  get sketchGraphic() {
    var _a;
    return (_a = this._sketchTool) == null ? void 0 : _a.sketchGraphic;
  }
  get toolState() {
    var _a;
    return ((_a = this._sketchTool) == null ? void 0 : _a.state) ?? "idle";
  }
  place(e10) {
...
__decorate([m2({ readOnly: true })], u9.prototype, "type", void 0), __decorate([m2({ constructOnly: true, nonNullable: true })], u9.prototype, "analysis", void 0), __decorate([m2({ readOnly: true })], u9.prototype, "effectiveDisplayUnits", null), __decorate([m2({ readOnly: true })], u9.prototype, "error", null), __decorate([m2()], u9.prototype, "hoveredPosition", void 0), __decorate([m2()], u9.prototype, "hoveredPoints", null), __decorate([m2({ readOnly: true })], u9.prototype, "progress", null), __decorate([m2({ readOnly: true })], u9.prototype, "results", null), __decorate([m2({ readOnly: true })], u9.prototype, "statistics", null), __decorate([m2({ readOnly: true })], u9.prototype, "updating", null), __decorate([m2()], u9.prototype, "sketchGraphic", null), __decorate([m2()], u9.prototype, "toolState", null), __decorate([m2()], u9.prototype, "_controller", void 0), __decorate([m2()], u9.prototype, "_visualization", void 0), __decorate([m2()], u9.prototype, "_sketchTool", void 0), u9 = __decorate([a2("esri.views.2d.analysis.ElevationProfileAnalysisView2D")], u9);
var y5 = u9;
export {
  y5 as default
};
//# sourceMappingURL=ElevationProfileAnalysisView2D-7YI2IPQQ.js.map
