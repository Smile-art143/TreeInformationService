...
function p4(e4) {
  var _a, _b, _c;
  const i6 = t2(e4, "Service/name"), s5 = e(e4, "Capability"), c2 = ((_a = e(s5, "GetCapabilities/Get/OnlineResource")) == null ? void 0 : _a.getAttribute("xlink:href")) ?? "", p5 = ((_b = e(s5, "DescribeCoverage/Get/OnlineResource")) == null ? void 0 : _b.getAttribute("xlink:href")) ?? "", m5 = ((_c = e(s5, "GetCoverage/Get/OnlineResource")) == null ? void 0 : _c.getAttribute("xlink:href")) ?? "", g4 = { getCapabilities: l7(c2), describeCoverage: l7(p5), getCoverage: l7(m5) }, v4 = n(e4, "CoverageOfferingBrief"), d6 = [];
...
function v(e4) {
  var _a, _b, _c;
  const t4 = ((_a = e(e4.querySelector("Operation[name=GetCapabilities]"), "Get")) == null ? void 0 : _a.getAttribute("xlink:href")) || "", o4 = ((_b = e(e4.querySelector("Operation[name=DescribeCoverage]"), "Get")) == null ? void 0 : _b.getAttribute("xlink:href")) || "", i6 = ((_c = e(e4.querySelector("Operation[name=GetCoverage]"), "Get")) == null ? void 0 : _c.getAttribute("xlink:href")) || "";
...
function S(e4) {
  ...
  const r3 = t4.documentElement.getAttribute("version"), o4 = r3 == null ? void 0 : r3.slice(0, 3);
...
function d5(e4) {
  e4.variables.forEach((e5) => e5.dimensions.forEach((e6) => e6.values ?? (e6.values = w(e6))));
}
function f4(e4) {
...
function x(e4, t4) {
  const n4 = l6(e4, t4);
  return (n4 == null ? void 0 : n4.length) && "" !== n4[0] && !isNaN(Number(n4[0])) ? n4.map((e5) => Number(e5)) : null;
}
function v2(e4) {
...
function L3(e4) {
  ...
  for (let i6 = 0; i6 < e4.childNodes.length; i6++) {
    ...
    if (1 === a3.nodeType) if (i3(a3, "description")) t4.description = t2(a3);
      ...
      (i7 == null ? void 0 : i7.length) && (n4 = D(i7));
...
function C(e4) {
  ...
  const { begin: t4, end: n4, values: i6, units: s5, resolution: a2 } = e4.temporalDomain, o4 = { variables: [{ name: "default", description: "", dimensions: [{ name: "StdTime", description: "", unit: "ISO8601", values: i6 == null ? void 0 : i6.map((e5) => e5.getTime()), hasRegularIntervals: !i6, interval: a2, intervalUnit: s5, extent: [t4.getTime(), n4.getTime()] }] }] };
  return d5(o4), o4;
}
function T(e4, t4) {
...
function R(e4, t4) {
  ...
  if (n4.length && n4.forEach((e5) => {
    ...
    i6.push({ name: e5.identifier.trim(), description: ((_a = e5.description) == null ? void 0 : _a.trim()) ?? "", unit: "", dimensions: t5, statistics: e5.statistics });
  }), t4.temporalDomain) {
    ...
    i6.some((e6) => e6.dimensions.some((e7) => "stdtime" === e7.name.toLowerCase())) || i6.forEach((t5) => {
      t5.dimensions.push({ name: "StdTime", description: "", unit: "ISO8601", values: s5 == null ? void 0 : s5.map((e6) => e6.getTime()), hasRegularIntervals: !s5, interval: o4, intervalUnit: a2, extent: [e5.getTime(), n5.getTime()] });
    });
  }
  if (i6.length) {
...
function M(t4) {
  var _a;
  const i6 = e(t4, "SpatialDomain"), s5 = e(i6, "GridCRS"), a2 = t2(s5, "GridBaseCRS"), l8 = t2(s5, "GridOrigin"), u2 = (l8 == null ? void 0 : l8.split(" ").map((e4) => parseFloat(e4))) ?? [0, 0], m5 = r(s5, "GridOffsets"), d6 = n(i6, "BoundingBox");
  let f5, g4, h2, b6;
  for (let n4 = 0; n4 < d6.length; n4++) {
    const t5 = (_a = d6[n4].getAttribute("crs")) == null ? void 0 : _a.toLowerCase();
    if (null != t5) {
...
function N(e4, t4) {
  ...
  for (let i6 = 0; i6 < e4.childNodes.length; i6++) {
    ...
    switch (p6) {
      ...
      case "range":
        {
          const e5 = T(t5, !!((_a = a2.domain) == null ? void 0 : _a.temporalDomain));
          a2.range = e5.rangeSet, u2 = e5.bandNames;
          const { bandNoDataValues: n5 } = e5;
          (n5 == null ? void 0 : n5.length) && (o4 = D(n5)), l8 = e5.statistics;
        }
        break;
      case "domain":
        a2.domain = M(t5);
  ...
  v4 && (o4 = b6[0].nullValues, 1 === (o4 == null ? void 0 : o4.length) && (o4 = o4[0]));
...
function E(e4, t4) {
  ...
  for (let u2 = 0; u2 < i6.length; u2++) {
    ...
    for (let n5 = 0; n5 < e5.length; n5++) {
      const i7 = e5[n5].getAttribute("name"), o4 = t2(e5[n5], "description") || "", u3 = ((_a = e(e5[n5], "uom")) == null ? void 0 : _a.getAttribute("code")) || "", d6 = r(e5[n5], "interval"), f5 = (_b = x(e5[n5], "nilValue")) == null ? void 0 : _b[0];
      t4 && !i7.toLowerCase().includes("band") || (s5.push(i7), (d6 == null ? void 0 : d6.length) && (a2 = a2 || [], a2.push({ min: d6[0], max: d6[1], avg: -1, stddev: -1 })), l8.push(f5)), m5.push({ name: i7, description: o4, uom: u3, allowedValues: d6, nilValue: f5 });
    }
    n4.push(m5);
  }
...
function A(e4, t4, n4) {
  ...
  if (i6.length) {
    ...
    for (let i7 = 2; i7 < n4.axisLabels.length; i7++) {
      const a3 = ((_b = (_a = t4.uomLabels) == null ? void 0 : _a[i7]) == null ? void 0 : _b.trim()) ?? "", o4 = n4.axisLabels[i7].toLowerCase().includes("time") || "iso8601" === a3.toLowerCase() || "oledatetime" === a3.toLowerCase();
      let l8, r3;
      if (o4) {
    ...
    if (i6.forEach((t5) => {
      var _a2;
      const { allowedValues: n5 } = t5, i7 = 2 === (n5 == null ? void 0 : n5.length) ? [{ min: n5[0], max: n5[1], avg: -1, stddev: -1 }] : null;
      a2.push({ name: t5.name.trim(), description: ((_a2 = t5.description) == null ? void 0 : _a2.trim()) ?? "", unit: t5.uom.trim(), statistics: i7, dimensions: [...e5] });
    }), a2.length) {
...
function F(e4, t4) {
  ...
  let g4 = false;
  if ((t4 == null ? void 0 : t4.length) && (l8 == null ? void 0 : l8.length)) {
...
function B(e4) {
  ...
  for (let i6 = 0; i6 < e4.childNodes.length; i6++) {
    ...
    if (1 === o5.nodeType) {
      if (i3(o5, "coverageId")) t4.coverageId = t2(o5);
        ...
        const e5 = E(o5, ((_a = t4.boundedBy) == null ? void 0 : _a.axisLabels.length) > 2 || ((_b = t4.domainSet) == null ? void 0 : _b.axisLabels.length) > 2);
        t4.rangeType = e5.rangeType, a2 = e5.bandNames, n4 = e5.bandStats;
        const { bandNoDataValues: i7 } = e5;
        (i7 == null ? void 0 : i7.length) && (s5 = D(i7));
      } else if (i3(o5, "domainSet")) t4.domainSet = F(o5, (_c = t4.boundedBy) == null ? void 0 : _c.axisLabels);
  ...
  !n4 && g4 && (n4 = g4 == null ? void 0 : g4.variables[0].statistics), null != g4 && (s5 = d6[0][0].nilValue);
...
async function i5(a2, i6) {
  const { version: n4, customParameters: c2, signal: p5 } = i6 ?? {}, l8 = (n4 == null ? void 0 : n4.startsWith("1.0")) ? "version" : "acceptVersions", m5 = { service: "WCS", request: "GetCapabilities", [l8]: n4, ...c2 };
  try {
    let { data: r3 } = await H(a2, { query: m5, responseType: "xml", signal: p5 });
    return (i6 == null ? void 0 : i6.version) || S(r3) || (m5[l8] = "2.0.1", { data: r3 } = await H(a2, { query: m5, responseType: "xml", signal: p5 })), b3(r3);
  } catch (u2) {
...
function e3(t4) {
  var _a, _b;
  const n4 = (_b = (_a = t4.getHeader) == null ? void 0 : _a.call(t4, "Content-Type")) == null ? void 0 : _b.split(";");
  if (!n4) return null;
...
function r2(t4, n4) {
  ...
  for (let a2 = 0; a2 < r3; a2++) if (e4[a2].length < 4) i6 = i6 + e4[a2].length + 1;
    ...
    if (o4.contentDisposition.toLowerCase().includes("inline") && e4[a2].length >= 4 && ((_a = o4.contentType) == null ? void 0 : _a.toLowerCase().includes("image"))) {
...
var b5 = class extends X {
  ...
  async _open(e4) {
    const { customFetchParameters: i6 } = this.ioConfig, n4 = e4 == null ? void 0 : e4.signal, s5 = await i5(this.url, { version: (i6 == null ? void 0 : i6.version) ?? this.version, customParameters: i6, signal: n4 });
    ...
    this.coverageId ?? (this.coverageId = r3[0].id);
  ...
  async _patchDimensionValues201(e4, t4) {
    var _a, _b, _c, _d, _e;
    const { coverageInfo: i6 } = this, n4 = (_a = i6.rasterInfo.multidimensionalInfo) == null ? void 0 : _a.variables, s5 = C2.has("1.1.2") ? "1.1.2" : C2.has("1.1.1") ? "1.1.1" : C2.has("1.1.0") ? "1.1.0" : null, { customFetchParameters: o4 } = this.ioConfig;
    if (n4 && s5) try {
      ...
      }), c2 = (_b = a2 == null ? void 0 : a2[0].rasterInfo.multidimensionalInfo) == null ? void 0 : _b.variables;
      if (c2) for (const e5 of n4) {
        const t5 = c2.find(({ name: t6 }) => t6 === e5.name);
        if ((_c = t5 == null ? void 0 : t5.dimensions) == null ? void 0 : _c.length) for (let n5 = e5.dimensions.length - 1; n5 >= 0; n5--) {
          const s6 = e5.dimensions[n5], o5 = t5.dimensions.find(({ name: e6 }) => e6 === s6.name);
          o5 ? o5.values && ((_d = o5.extent) == null ? void 0 : _d.join(",")) === ((_e = s6.extent) == null ? void 0 : _e.join(",")) && (e5.dimensions[n5] = { ...s6, values: o5.values }) : i7 && e5.dimensions.splice(n5, 1);
        }
      }
    } catch {
    }
  ...
  async _getPixelTypeAndBandCount(e4) {
    ...
    try {
      ...
      if (!m5) throw y3;
      if ("1.1" === u2) {
        if (!((_a = y3.details) == null ? void 0 : _a.isResolutionMismatch)) throw y3;
  ...
  async _getCoverage(e4, n4, s5, o4, r3, a2 = false) {
    ...
    if (u2.isMultipart && u2.data) {
      ...
      return a2 && "base64" === (e5 == null ? void 0 : e5.contentTransferEncoding) && i.getLogger(this).warn("wcsraster:getcoverage", x2), e5 == null ? void 0 : e5.contentData;
    }
  ...
  _getCoverage110Parameters(e4, t4, i6, n4, s5) {
    ...
    if (null != o4 && o4.length) for (let r3 = 0; r3 < o4.length; r3++) {
      let e5 = o4[r3].values;
      const t5 = (_b = o4[r3].dimensionName) == null ? void 0 : _b.toLowerCase(), i7 = (_c = o4[r3].variableName) == null ? void 0 : _c.toLowerCase(), n5 = s5.range.find((e6) => e6.identifier.toLowerCase() === i7);
      if (e5.length > 0) {
  ...
  _getCoverage201Parameters(e4, t4, i6, n4, s5, o4) {
    ...
    if (d6 == null ? void 0 : d6.length) switch (l8) {
      case 0:
    ...
    if (v4.length > 2) for (let D2 = 2; D2 < v4.length; D2++) {
      ...
      if (v4[D2].toLowerCase().includes("time")) {
        let t5 = e5.toString();
        ((_a = u2.uomLabels) == null ? void 0 : _a[D2].toLowerCase().includes("ole")) && (S3.push(v4[D2]), t5 = $(e5, true)), b6.push(v4[D2] + ",http://www.opengis.net(" + t5 + ")");
...
var T2 = class extends p(t(b(j(s3(X2(i2(l4(f2(l2(l3(b2))))))))))) {
  constructor(...e4) {
    super(...e4), this.coverageId = null, this.version = null, this.isReference = null, this.graphicOrigin = new s4(this), this.legendEnabled = true, this.noData = 0, this.operationalLayerType = "WCS", this.type = "wcs", this.popupEnabled = true, this.popupTemplate = null, this.fields = null, this._debouncedSaveOperations = L(async (e5, r3, t4) => {
      const { save: o4, saveAs: s5 } = await import("./imageryUtils-EYYKRIEH.js");
      switch (e5) {
        case 0:
          return o4(this, r3);
        case 1:
  ...
  get rasterFields() {
    var _a;
    const e4 = [o2("Pixel Value")], r3 = ((_a = this.raster) == null ? void 0 : _a.rasterInfo) ?? this.serviceRasterInfo, t4 = r3 == null ? void 0 : r3.multidimensionalInfo;
    if (t4) {
      const r4 = p2(t4);
      e4.push(...r4);
    }
  ...
  async _openRaster(e4) {
    ...
    if (null != s5) {
      ...
      if (e5) {
        let r4 = ((_a = e5.extent) == null ? void 0 : _a[0]) ?? e5.values[0];
        Array.isArray(r4) && (r4 = r4[0]);
        let t5 = ((_b = e5.extent) == null ? void 0 : _b[1]) ?? e5.values[e5.values.length - 1];
        Array.isArray(t5) && (t5 = t5[1]);
        const o4 = C3.has((_c = e5.intervalUnit) == null ? void 0 : _c.toLowerCase()) ? (_d = e5.intervalUnit) == null ? void 0 : _d.toLowerCase() : null;
...
//# sourceMappingURL=WCSLayer-QYXKDVC3.js.map
