...
var a3 = { async request(a7, s6) {
  ...
  r3.signal = s6 == null ? void 0 : s6.signal, r3.responseType = "native" === n3 || "native-request-init" === n3 ? "native-request-init" : n3 && ["blob", "json", "text"].includes(n3) && ((_a = N(a7.url)) == null ? void 0 : _a.after) ? n3 : "array-buffer";
...
function r2(s6) {
  var _a;
  const r3 = { async: s6.async, isDebug: s6.isDebug, locale: s6.locale, baseUrl: s6.baseUrl, has: { ...s6.has }, map: { ...s6.map }, packages: ((_a = s6.packages) == null ? void 0 : _a.slice()) || [], paths: { ...a4.paths, ...s6.paths } };
...
function b() {
  ...
  const n3 = s.workers.loaderConfig, i2 = r2({ baseUrl: n3 == null ? void 0 : n3.baseUrl, locale: l2(), has: { "csp-restrictions": 1, "dojo-test-sniff": 0, "host-webworker": 1, ...n3 == null ? void 0 : n3.has }, map: { ...n3 == null ? void 0 : n3.map }, paths: { ...n3 == null ? void 0 : n3.paths }, packages: (n3 == null ? void 0 : n3.packages) || [] }), l4 = { buildDate: a, fullVersion: r, revision: c };
...
//# sourceMappingURL=chunk-3C3GTE5D.js.map
