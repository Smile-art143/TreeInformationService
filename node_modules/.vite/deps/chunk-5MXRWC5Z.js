...
var g = class extends h {
  ...
  async _queryBuddy(e) {
    var _a;
    const t = new (await import("./FeatureLayer-FJGPCTQR.js")).default({ url: e }), { capabilities: r2 } = await t.load(), i3 = r2.query.supportsMaxRecordCountFactor, o3 = r2.query.supportsPagination, s2 = r2.query.supportsCentroid, n = this._config.maxRecordCountFactor, c = t.capabilities.query.maxRecordCount, u = i3 ? c * n : c, h3 = new b();
    if (h3.outFields = this._config.outFields ?? ["*"], h3.where = ((_a = this._config.filter) == null ? void 0 : _a.where) ?? "1=1", h3.returnGeometry = true, h3.returnExceededLimitFeatures = true, h3.outSpatialReference = f.fromJSON(this._config.spatialReference), s2 && (h3.returnCentroid = true), i3 && (h3.maxRecordCountFactor = n), o3) return h3.num = u, t.destroy(), this._queryPages(e, h3);
...
//# sourceMappingURL=chunk-5MXRWC5Z.js.map
