...
function* p(e2, t2 = {}) {
  ...
  for (const s3 of e2) {
    ...
    const a2 = new s2(e3 ? h(new e(), e3, t2) : null, f2, null, p2);
    yield a2;
  }
}
function a(e2) {
...
function E(e2, o = 4326) {
  ...
  const { crs: r } = e2;
  if (!r) return;
  const i = "string" == typeof r ? r : "name" === r.type ? r.properties.name : "EPSG" === r.type ? r.properties.code : null, s3 = I({ wkid: o }) ? new RegExp(".*(CRS84H?|4326)$", "i") : new RegExp(`.*(${o})$`, "i");
...
//# sourceMappingURL=chunk-UX7ULDKZ.js.map
