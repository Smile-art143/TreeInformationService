import {
  ...
  s3 as s6,
  u
} from "./chunk-L7SE3MQU.js";
import {
  T
} from "./chunk-GVSBH63T.js";
import {
  r as r2,
  t as t2
...
var G;
async function H3() {
  null == G && (G = await import("./operators-KESN72NZ.js"), await G.loadAll());
}
function F(H6, F4) {
  H6.disjoint = function(e5, n7) {
    ...
    return F4(e5, t5, (a3, l4, o6) => {
      ...
      if (null === s9) {
        const e6 = "point" === u3.type ? u3 : (_a = u3.extent) == null ? void 0 : _a.center;
        return G.rotate(u3, f6, e6 == null ? void 0 : e6.x, e6 == null ? void 0 : e6.y);
      }
...
function te2(e5, n7) {
  var _a;
  const t5 = (_a = e5.localScope) == null ? void 0 : _a.get(n7);
...
function Ie(e5, n7) {
  var _a;
  const t5 = oe2(e5, n7.specifiers[0].local, "global"), r5 = (_a = e5.libraryResolver) == null ? void 0 : _a.loadLibrary(t5.name), o6 = e5.symbols.nextVarId();
...
function en(t5, o6, l4 = false) {
  ...
  const s9 = /* @__PURE__ */ Object.create(null), i7 = new Set(Object.keys((o6 == null ? void 0 : o6.vars) || {}).map((n7) => r2(n7))), u3 = new Set(Object.keys((o6 == null ? void 0 : o6.customfunctions) || {}).map((n7) => r2(n7))), m2 = ie2(t5, l4 ? We.provided : ze.provided, /* @__PURE__ */ new Set([...i7, ...u3]), l4, a3, s9);
  let f6;
...
async function nn() {
  return Ze([await import("./geomasync-GOBVX7EO.js")], "async"), true;
}
...
var C3 = class _C extends Error {
  constructor({ code: e5, index: t5, line: u3, column: i7, len: n7 = 0, description: r5, data: s9 }) {
    var _a;
    super(r5 ?? e5), this.declaredRootClass = "esri.arcade.lib.diagnostic", this.name = "ParsingError", this.code = e5, this.index = t5, this.line = u3, this.column = i7, this.len = n7, this.data = s9, this.description = r5, this.range = { start: { line: u3, column: i7 - 1 }, end: { line: u3, column: i7 + n7 } }, (_a = Error.captureStackTrace) == null ? void 0 : _a.call(Error, this, _C);
  }
};
function F2(e5) {
...
function w2(e5, t5) {
  const u3 = d4[e5];
  return t5 ? u3.replace(S, (e6, u4) => {
    var _a;
    return ((_a = t5[u4]) == null ? void 0 : _a.toString()) ?? "";
  }) : u3;
}
var y3 = class {
  ...
  throwError(e5) {
    throw e5.description ?? (e5.description = w2(e5.code, e5.data)), new C3(e5);
  }
  tolerateError(e5) {
...
n6.forEach((e5) => {
  var _a;
  return (_a = N[e5.length - 1]) == null ? void 0 : _a.push(e5);
}), r4.forEach((e5) => {
  var _a;
  return (_a = N[e5.length - 1]) == null ? void 0 : _a.push(e5);
}), a2.forEach((e5) => {
  ...
  scanPunctuator() {
    ...
    switch (t5) {
      ...
      case "}":
        ...
        break;
      default:
        for (let e6 = N.length; e6 > 0; e6--) if (t5 = this.source.substring(this.index, this.index + e6), (_a = N[e6 - 1]) == null ? void 0 : _a.includes(t5)) {
          this.index += e6;
          break;
        }
    }
...
var K2 = class {
  ...
  throwIfInvalidType(e5, t5, { validTypes: u3, invalidTypes: i7 }) {
    (u3 == null ? void 0 : u3.some((t6) => e5.type === t6)) || (i7 == null ? void 0 : i7.some((t6) => e5.type === t6)) && this.throwError(l3.InvalidExpression, t5);
  }
  ...
  unexpectedTokenError(e5 = {}) {
    ...
    i7 ?? (i7 = l3.UnexpectedToken), n7 ?? (n7 = { value: u3 });
    const r5 = w2(i7, n7);
    if (t5) {
  ...
  finalize(e5) {
    var _a, _b;
    return (this.delegate ?? this.commentHandler) && ((_a = this.commentHandler) == null ? void 0 : _a.attachComments(e5), (_b = this.delegate) == null ? void 0 : _b.call(this, e5)), e5;
  }
  expectPunctuator(e5) {
  ...
  inheritCoverGrammar(e5) {
    ...
    this.context.isAssignmentTarget = true;
    const u3 = e5.call(this);
    return (_a = this.context).isAssignmentTarget && (_a.isAssignmentTarget = t5), u3;
  }
  ...
  parseBinaryExpression() {
    ...
    for (; D4 > 1; ) {
      const e6 = n7.pop();
      if (!e6) break;
      const u4 = c4 == null ? void 0 : c4.lineStart, i8 = O2(e6, u4), r6 = a3[D4 - 1];
...
function je2(e5, t5) {
  ...
  let i7;
  return ((_a = r5._moduleSingletons) == null ? void 0 : _a.has(o6.uri)) ? i7 = r5._moduleSingletons.get(o6.uri) : (i7 = le2.load(e5, o6.syntax), (_b = r5._moduleSingletons) == null ? void 0 : _b.set(o6.uri, i7)), n7.scope[n7.id] = { value: i7 }, P2;
}
function Oe2(e5, t5) {
...
function $e2(n7, i7) {
  const s9 = new Set(Object.keys((i7 == null ? void 0 : i7.vars) || {}).map((t5) => r2(t5))), l4 = new Set(Object.keys((i7 == null ? void 0 : i7.customfunctions) || {}).map((t5) => r2(t5))), { globals: a3, exports: c4 } = i4(n7);
  return (e5) => {
...
async function q3() {
  await nn(), x2 = await import("./arcadeAsyncRuntime-YRRDGGFO.js");
...
async function X2() {
  await N2();
  const [e5, t5, n7, s9, a3, o6] = await Promise.all([import("./featureSetUtils-MK5VDSBC.js"), import("./featuresetbase-D3PJ3PBR.js"), import("./featuresetgeom-H5SNTRPN.js"), import("./featuresetstats-Z5GVPYYR.js"), import("./featuresetstring-JLEI3OSY.js"), import("./knowledgegraph-BOABBGTI.js")]);
...
//# sourceMappingURL=chunk-QVGPTEG6.js.map
