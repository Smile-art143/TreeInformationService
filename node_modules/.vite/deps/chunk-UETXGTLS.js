...
function t4() {
  return r3 ?? (r3 = (async () => {
    const { default: r6 } = await import("./draco_mesh_decoder-J5EP6XEH.js");
...
var Y = class _Y {
  ...
  static async load(t7, r6, o4) {
    ...
    if (te.test(r6) || "gltf" === (o4 == null ? void 0 : o4.expectedType)) {
    ...
    if (re.test(r6) || "glb" === (o4 == null ? void 0 : o4.expectedType)) throw new s("gltf-loader-invalid-glb", "This is not a valid glb file.");
  ...
  _getComponentInfo(e7, t7) {
    const r6 = $[e7.type], o4 = (t7 == null ? void 0 : t7.componentType) || e7.componentType, n5 = W[o4];
  ...
  getDracoAccessor(e7, t7) {
    ...
    return { raw: t7.data.buffer, byteStride: i4, byteOffset: t7.data.byteOffset + ((o4 == null ? void 0 : o4.byteOffset) || 0), entryCount: (o4 == null ? void 0 : o4.count) ?? r6.count, isDenselyPacked: true, componentCount: s3, componentByteSize: a2, componentType: n5, min: r6.min, max: r6.max, normalized: !!r6.normalized };
  }
  async getAccessor(t7, r6) {
    const o4 = this._validateAccessor(t7);
    if (null == (o4 == null ? void 0 : o4.bufferView)) throw new s("gltf-loader-unsupported-feature", "Some accessor does not specify a bufferView.");
  ...
  async getLoadedBuffersSize() {
    ...
    return e7.reduce((e8, t8) => e8 + ((t8 == null ? void 0 : t8.byteLength) ?? 0), 0) + this._dracoBuffersSize + t7.reduce((e8, t8) => e8 + (t8 ? t2(t8) ? t8.data.byteLength : t8.width * t8.height * 4 : 0), 0);
  }
};
...
async function l3(r6, s3, l4 = {}, m2 = true) {
  var _a, _b;
  const T3 = await Y.load(r6, s3, l4), p = "gltf_" + n4++, f2 = { lods: [], materials: /* @__PURE__ */ new Map(), textures: /* @__PURE__ */ new Map(), meta: u(T3) }, x = !(!T3.json.asset.extras || "symbolResource" !== T3.json.asset.extras.ESRI_type), g3 = (_b = (_a = T3.json.asset.extras) == null ? void 0 : _a.ESRI_webstyleSymbol) == null ? void 0 : _b.webstyle, h = /* @__PURE__ */ new Map();
  let w2 = false;
  await c2(T3, async (r7, s4, a2, n5) => {
    ...
    let M2 = null;
    null != ((_a2 = f2.meta) == null ? void 0 : _a2.ESRI_lod) && "screenSpaceRadius" === f2.meta.ESRI_lod.metric && (M2 = f2.meta.ESRI_lod.thresholds[a2]), f2.lods[a2] = f2.lods[a2] || { parts: [], name: n5, lodThreshold: M2 }, f2.lods[a2].parts[u2] = I2;
  });
...
function d(e7, o4, t7) {
  const a2 = (o5) => {
    const r6 = `${t7}_tex_${o5 && o5.id}${(o5 == null ? void 0 : o5.name) ? "_" + o5.name : ""}`;
...
//# sourceMappingURL=chunk-UETXGTLS.js.map
