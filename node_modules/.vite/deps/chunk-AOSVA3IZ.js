...
var a = ["dd", "dl", "dt", "h1", "h2", "h3", "h4", "h5", "h6", "sub", "sup", ...["animate", "animatetransform", "circle", "clippath", "defs", "ellipse", "g", "image", "line", "lineargradient", "marker", "mask", "path", "pattern", "polygon", "polyline", "radialgradient", "rect", "stop", "svg", "switch", "symbol", "text", "textpath", "tspan", "use"]];
var i = a.reduce((e, a2) => (e[a2] = [], e), {});
var r = ["align", "alink", "alt", "bgcolor", "border", "cellpadding", "cellspacing", "class", "color", "cols", "colspan", "coords", "d", "dir", "face", "height", "hspace", "ismap", "lang", "marginheight", "marginwidth", "multiple", "nohref", "noresize", "noshade", "nowrap", "ref", "rel", "rev", "rows", "rowspan", "scrolling", "shape", "span", "summary", "tabindex", "title", "usemap", "valign", "value", "vlink", "vspace", "width"];
var t = new Sanitizer({ whiteList: i, onTagAttr: (e, a2, i2) => {
  const t2 = `${a2}="${i2}"`;
  if (r.includes(a2)) return t2;
}, stripIgnoreTag: true, stripIgnoreTagBody: ["script", "style"] }, true);
var s = new Sanitizer({ whiteList: { br: [] }, stripIgnoreTag: true, escapeHtml: (e) => e }, false);
...
@esri/arcgis-html-sanitizer/dist/esm/index.js:
  ...
  ***************************************************************************** *)
*/
//# sourceMappingURL=chunk-AOSVA3IZ.js.map
