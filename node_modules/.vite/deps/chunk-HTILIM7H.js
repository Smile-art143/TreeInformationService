...
function r6(e9) {
  const t4 = [];
  return t4.push(e9.transform), t4.push(e9.fromColor), t4.push(e9.toColor), t4.push(e9.colorMix), t4.push(e9.toOpacity), t4.push(e9.opacityMix), (e9 == null ? void 0 : e9.shift) ? t4.push(e9 == null ? void 0 : e9.shift) : t4.push([1, 1, 1, 1]), t4;
}
function a5(e9) {
  const t4 = [], o16 = [];
  let i12 = 0;
...
var c4 = 100;
function s8(r12, e9) {
  return [!!(r12 == null ? void 0 : r12.minScale) && e9.scaleToZoom(r12.minScale) || o6, !!(r12 == null ? void 0 : r12.maxScale) && e9.scaleToZoom(r12.maxScale) || c4];
}
function i5(r12) {
  return 1 << r12;
}
...
var i6 = class _i {
  ...
  pack(t4, e9) {
    ...
    } else if ((_a = s19.packAlternating) == null ? void 0 : _a.pack) {
...
var a7 = class {
  ...
  get effectInfos() {
    var _a2;
    return (_a2 = this._evaluator.inputMeshParams.effects) == null ? void 0 : _a2.effectInfos;
  }
  get instanceId() {
  ...
  getEffectCursor(t4, s19, a14) {
    var _a2;
    const i12 = (_a2 = s19.readGeometryForDisplay()) == null ? void 0 : _a2.clone();
    if (!i12) return;
...
var a11 = class extends a7 {
  ...
  _write(e9, t4, r12) {
    const s19 = (r12 == null ? void 0 : r12.asOptimized()) ?? t4.readGeometryForDisplay(), i12 = this._clip(s19);
...
var o11 = class extends c7 {
  ...
  _write(t4, e9, r12) {
    var _a;
    const i12 = (r12 == null ? void 0 : r12.asOptimized()) ?? e9.readGeometryForDisplay(), s19 = this._clip(i12);
    if (!s19) return;
    const o16 = (_a = this.evaluatedMeshParams.sprite) == null ? void 0 : _a.textureBinding;
...
var f7 = class extends c7 {
  ...
  _write(e9, t4) {
    ...
    if ((i12 == null ? void 0 : i12.length) || (r12 == null ? void 0 : r12.length)) {
      if (i12 == null ? void 0 : i12.length) {
        const r13 = this.getEffectCursor(e9, t4, i12);
        if (r13) {
          let i13;
          for (; i13 = r13 == null ? void 0 : r13.next(); ) i13.invertY(), this._writeFill(e9, t4, i13);
        }
      } else this._writeFill(e9, t4);
      if (r12 == null ? void 0 : r12.length) {
        const i13 = this.getEffectCursor(e9, t4, r12);
        if (i13) {
          let r13;
          for (; r13 = i13 == null ? void 0 : i13.next(); ) r13.invertY(), this._writeOutline(e9, t4, r13);
        }
  ...
  _writeFill(e9, t4, i12) {
    const r12 = (i12 == null ? void 0 : i12.asOptimized()) ?? t4.readGeometryForDisplay(), s19 = this._clip(r12);
    s19 && this._writeGeometry(e9, t4, s19);
  }
  _writeOutline(t4, i12, r12) {
    const s19 = (r12 == null ? void 0 : r12.asOptimized()) ?? i12.readGeometryForDisplay(), o16 = this._clip(s19);
  ...
  get effectInfos() {
    var _a, _b;
    return [...((_a = this._evaluator.inputMeshParams.effects) == null ? void 0 : _a.effectInfos) ?? [], ...((_b = this._evaluator.inputMeshParams.outlineEffects) == null ? void 0 : _b.effectInfos) ?? []];
  }
...
var f8 = class extends f7 {
  ...
  write(e9, t4, s19, r12, i12) {
    ...
    const a14 = (_a = this.evaluatedMeshParams.sprite) == null ? void 0 : _a.textureBinding;
...
} }, relativePosition: { count: 2, type: R.HALF_FLOAT, packTessellation: ({ gradientStats: t4 }, e9, r12, i12) => (t4 == null ? void 0 : t4.getRelativePosition(r12, i12)) ?? [0, 0] }, relativeGradientSize: { count: 2, type: R.HALF_FLOAT, packTessellation: ({ gradientStats: t4 }) => (t4 == null ? void 0 : t4.relativeSize) ?? [1, 1] }, gradientMethod: { count: 1, type: R.UNSIGNED_BYTE, pack: ({ gradientMethod: t4 }) => {
...
var u7 = class extends a11 {
  ...
  _write(t4, e9, r12) {
    var _a;
    const i12 = (r12 == null ? void 0 : r12.asOptimized()) ?? e9.readGeometryForDisplay();
...
var i10 = class extends a7 {
  ...
  _write(t4, e9) {
    ...
    if ("esriGeometryPoint" === e9.geometryType) {
      ...
      i12 == null ? void 0 : i12.forEachVertex((e10, i13) => {
...
var E2 = class extends a7 {
  ...
  _write(t4, e9, o16) {
    ...
    if (o16 == null ? void 0 : o16.nextPath()) return o16.nextPoint(), this._writeGlyphs(t4, r12, o16.x, o16.y, i12, 0);
    ...
    if ("esriGeometryMultipoint" === e9.geometryType) {
      ...
      return void (o17 == null ? void 0 : o17.forEachVertex((e10, o18) => this._writeGlyphs(t4, r12, e10, o18, i12, 0)));
    }
  ...
  _getShaping(o16) {
    ...
    if (!((_a = r12.glyphs) == null ? void 0 : _a.glyphs.length)) return null;
...
var l13 = class extends T3 {
  ...
  _write(t4, i12, r12) {
    ...
    this._writeGeometry(t4, i12, s19, o16 == null ? void 0 : o16.textureBinding);
  }
};
...
var l14 = class extends T3 {
  ...
  _write(t4, r12, s19) {
    ...
    this._writeGeometry(t4, r12, o16, i12 == null ? void 0 : i12.textureBinding);
  }
};
...
var I2 = class extends a7 {
  ...
  _write(e9, t4, r12) {
    var _a;
    const o16 = (_a = this.evaluatedMeshParams.sprite) == null ? void 0 : _a.textureBinding, s19 = t4.getDisplayId();
    ...
    if (null != this.evaluatedMeshParams.placement) {
    ...
    } else if (r12 == null ? void 0 : r12.nextPath()) {
      r12.nextPoint();
      ...
      r13 == null ? void 0 : r13.forEachVertex((t5, r14) => {
...
var s18 = class extends a7 {
  ...
  _write(t4, r12) {
    ...
    if ("esriGeometryPoint" === r12.geometryType) c9 = r12.readXForDisplay(), n12 = r12.readYForDisplay();
      ...
      if (!e9) return;
      c9 = e9 == null ? void 0 : e9.coords[0], n12 = e9 == null ? void 0 : e9.coords[1];
    }
...
//# sourceMappingURL=chunk-HTILIM7H.js.map
