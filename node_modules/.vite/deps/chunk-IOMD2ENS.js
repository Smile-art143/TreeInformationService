...
function j2(r2) {
  const t = (r2 == null ? void 0 : r2.origins) ?? [void 0];
  return (e, o2) => {
    const s2 = v2(r2, e, o2);
    for (const r3 of t) {
      const t2 = j(e, r3, o2);
...
function v2(r2, t, e) {
  if ("resource" === (r2 == null ? void 0 : r2.type)) return U(r2, t, e);
  switch ((r2 == null ? void 0 : r2.type) ?? "other") {
    case "other":
...
function U(r2, t, n2) {
  ...
  return { type: String, read: (r3, t2, e) => {
    ...
    const l = S(t2), m2 = m(l, { ...u, verifyItemRelativeUrls: (u == null ? void 0 : u.verifyItemRelativeUrls) ? { writtenUrls: u.verifyItemRelativeUrls.writtenUrls, rootPath: void 0 } : void 0 }, 1), y2 = i2.type !== String && (!i(this) || (u == null ? void 0 : u.origin) && this.originIdOf(n2) > r(u.origin)), g2 = { object: this, propertyName: n2, value: t2, targetUrl: m2, dest: p2, targetPropertyName: c, context: u, params: r2 };
    (u == null ? void 0 : u.portalItem) && m2 && !Y(m2) ? y2 && (r2 == null ? void 0 : r2.contentAddressed) ? w(g2) : y2 ? I(g2) : P(g2) : (u == null ? void 0 : u.portalItem) && (null == m2 || null != v(m2) || Z(m2) || y2) ? w(g2) : p2[c] = m2;
  } } };
}
function w(e) {
  var _a;
  ...
  const h = (p2 == null ? void 0 : p2.contentAddressed) && "json" === y2.type ? x(y2.jsonString) : (f2 == null ? void 0 : f2.filename) ?? n(), j3 = V((p2 == null ? void 0 : p2.prefix) ?? (f2 == null ? void 0 : f2.prefix), h), v3 = `${j3}.${p(y2)}`;
...
function I(r2) {
  ...
  const c = t.portalItem.resourceFromPath(e), u = N(s2, e, t), a = p(u), l = Tt(c.path), d = (o2 == null ? void 0 : o2.compress) ?? false;
...
//# sourceMappingURL=chunk-IOMD2ENS.js.map
