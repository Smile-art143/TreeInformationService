...
function f(t) {
  return t instanceof O ? Object.keys(t.items) : r(t) ? n(t).keys() : t ? Object.keys(t) : [];
}
function i(t, n2) {
  return t instanceof O ? t.items[n2] : t[n2];
}
function l(t, e) {
...
function c(t, e) {
  ...
  const s = f(t), p2 = f(e);
  if (0 === s.length && 0 === p2.length) return;
  if (!s.length || !p2.length || l(t, e)) return { type: "complete", oldValue: t, newValue: e };
  const a = p2.filter((t2) => !s.includes(t2)), y2 = s.filter((t2) => !p2.includes(t2)), d2 = s.filter((n3) => p2.includes(n3) && i(t, n3) !== i(e, n3)).concat(a, y2).sort(), m = u(t);
  ...
  for (const o2 of d2) {
    ...
    if ((b2 || "function" != typeof r2 && "function" != typeof f2) && (r2 !== f2 && (null != r2 || null != f2))) {
      if (n2 && n2[o2] && "function" == typeof n2[o2]) l2 = (_a = n2[o2]) == null ? void 0 : _a.call(n2, r2, f2);
...
//# sourceMappingURL=chunk-BQGRIIAM.js.map
