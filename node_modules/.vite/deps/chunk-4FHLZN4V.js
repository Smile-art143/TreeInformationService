...
var _Action = class _Action extends LitElement {
  ...
  renderIconContainer() {
    ...
    const hasIconToDisplay = iconNode || ((_a = el.children) == null ? void 0 : _a.length);
  ...
  renderButton() {
    ...
    const ariaControlsElements = [
      ...((_a = this.aria) == null ? void 0 : _a.controlsElements) ?? [],
      ...internalControlsElements
    ];
    if (this.dragHandle) {
      return html`<span .ariaBusy=${loading} .ariaControlsElements=${ariaControlsElements} .ariaDescribedByElements=${(_b = this.aria) == null ? void 0 : _b.describedByElements} .ariaExpanded=${(_c = this.aria) == null ? void 0 : _c.expanded} .ariaHasPopup=${(_d = this.aria) == null ? void 0 : _d.hasPopup} .ariaLabel=${ariaLabel} .ariaLabelledByElements=${(_e = this.aria) == null ? void 0 : _e.labelledByElements} .ariaOwnsElements=${(_f = this.aria) == null ? void 0 : _f.ownsElements} .ariaPressed=${(_g = this.aria) == null ? void 0 : _g.pressed} class=${safeClassMap(buttonClasses)} id=${buttonId ?? nothing} role=button tabindex=${this.disabled ? null : 0} ${ref(this.buttonEl)}>${buttonContent}</span>`;
    }
    return html`<button .ariaBusy=${loading} .ariaControlsElements=${ariaControlsElements} .ariaDescribedByElements=${(_h = this.aria) == null ? void 0 : _h.describedByElements} .ariaExpanded=${(_i = this.aria) == null ? void 0 : _i.expanded} .ariaHasPopup=${(_j = this.aria) == null ? void 0 : _j.hasPopup} .ariaLabel=${ariaLabel} .ariaLabelledByElements=${(_k = this.aria) == null ? void 0 : _k.labelledByElements} .ariaOwnsElements=${(_l = this.aria) == null ? void 0 : _l.ownsElements} .ariaPressed=${(_m = this.aria) == null ? void 0 : _m.pressed} class=${safeClassMap(buttonClasses)} .disabled=${disabled} id=${buttonId ?? nothing} @click=${this.handleClick} ${ref(this.buttonEl)}>${buttonContent}</button>`;
  }
  render() {
...
@esri/calcite-components/dist/components/calcite-action/customElement.js:
  ...
  v3.3.3 *)
*/
//# sourceMappingURL=chunk-4FHLZN4V.js.map
