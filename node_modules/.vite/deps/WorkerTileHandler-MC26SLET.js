...
var l3 = class {
  ...
  getShaping(s4, c4, h5) {
    ...
    const y3 = s4.includes("​"), d4 = [], x2 = m3.length;
    ...
    for (const i4 of o5) {
      ...
      for (const t8 of S2) {
        ...
        if (0 !== d5) {
          ...
          n6 = n6.clone(), s4 = s4 == null ? void 0 : s4.clone(), o7 = o7 == null ? void 0 : o7.clone(), l5 = l5 == null ? void 0 : l5.clone(), n6.rotate(e5, t9), l5 == null ? void 0 : l5.rotate(e5, t9), s4 == null ? void 0 : s4.rotate(e5, t9), o7 == null ? void 0 : o7.rotate(e5, t9);
        }
        let p3 = 0, y4 = 256;
...
var n4 = class _n extends e4 {
  ...
  processFeatures(t8) {
    ...
    const u3 = this._features, d4 = t8 == null ? void 0 : t8.validateTessellation;
    if (a6) {
      const n7 = [];
      for (const a7 of u3) {
...
var s3 = class extends e4 {
  ...
  getResources(e5, t8, i4) {
    ...
    if (!r7 && !l4) return;
    const o5 = (a6 == null ? void 0 : a6.getValue(n6)) || 0, u3 = a6 == null ? void 0 : a6.isDataDriven, f3 = r7 == null ? void 0 : r7.isDataDriven, h5 = l4 == null ? void 0 : l4.isDataDriven;
  ...
  processFeatures(e5) {
    ...
    e5 && e5.setExtent(this.layerExtent);
    const a6 = t8.getPaintProperty("line-pattern"), o5 = t8.getPaintProperty("line-dasharray"), u3 = a6 == null ? void 0 : a6.isDataDriven, f3 = o5 == null ? void 0 : o5.isDataDriven;
    let h5;
    h5 = t8.getLayoutProperty("line-cap");
    const p3 = (h5 == null ? void 0 : h5.isDataDriven) ? h5 : null, g = p3 ? null : t8.getLayoutValue("line-cap", i4), y3 = g || 0, d4 = !!p3;
    h5 = t8.getLayoutProperty("line-join");
    const c4 = (h5 == null ? void 0 : h5.isDataDriven) ? h5 : null, _2 = c4 ? null : t8.getLayoutValue("line-join", i4);
    h5 = t8.getLayoutProperty("line-miter-limit");
    const x2 = (h5 == null ? void 0 : h5.isDataDriven) ? h5 : null, V2 = x2 ? null : t8.getLayoutValue("line-miter-limit", i4);
    h5 = t8.getLayoutProperty("line-round-limit");
    const D = (h5 == null ? void 0 : h5.isDataDriven) ? h5 : null, P = D ? null : t8.getLayoutValue("line-round-limit", i4);
    h5 = t8.getPaintProperty("line-width");
    const m3 = (h5 == null ? void 0 : h5.isDataDriven) ? h5 : null, I = m3 ? null : t8.getPaintValue("line-width", i4);
    h5 = t8.getPaintProperty("line-offset");
    const L = (h5 == null ? void 0 : h5.isDataDriven) ? h5 : null, B = L ? null : t8.getPaintValue("line-offset", i4);
    if (u3 || f3) {
      const r8 = [];
      for (const n7 of s4) {
      ...
      if (a6) {
        ...
        if (!(t9 == null ? void 0 : t9.rect)) return;
      }
...
var _u = class _u extends e4 {
  ...
  processFeatures(e5) {
    ...
    const I = [];
    let A = 1;
    (M == null ? void 0 : M.size) && (A = M.size / c3);
    ...
    for (const o5 of this._symbolFeatures) {
      ...
      for (let t8 of o5.geometry) {
        const s5 = [];
        if (1 === r7) {
          if ((n7 == null ? void 0 : n7.length) && (M == null ? void 0 : M.size)) {
        ...
        for (const i4 of s5) {
          ...
          if (l4 && f3 > 0 && 0 === (M == null ? void 0 : M.rotationAlignment) && !_u._honorsTextMaxAngle(t8, i4, f3, V2, w2)) continue;
  ...
  _processFeature(e5, t8, n6) {
    ...
    let c4 = true;
    x2 && (c4 = (t8 == null ? void 0 : t8.optional) || !i4);
    const d4 = a6 && a6.length > 0, f3 = !d4 || (n6 == null ? void 0 : n6.optional);
    let g, y3;
...
var k = class {
  constructor(t8, r7, o5, a6, n6, l4) {
    ...
    this._styleRepository = n6, this._layers = ((_a = this._styleRepository) == null ? void 0 : _a.layers) ?? [];
  ...
  _initialize(e5) {
    const t8 = e5 == null ? void 0 : e5.signal;
...
var r5 = class {
  ...
  async parse(e5, s4) {
    const r7 = s4 == null ? void 0 : s4.signal;
    if (null != r7) {
      const t8 = () => {
...
var o4 = class {
  ...
  fetchSprites(e5, t8, s4) {
    ...
    return 0 === r7.length ? Promise.resolve() : t8.invoke("getSprites", r7, { signal: s4 == null ? void 0 : s4.signal }).then((e6) => {
      for (const t9 in e6) {
        const s5 = e6[t9];
        o5[t9] = s5;
      }
...
//# sourceMappingURL=WorkerTileHandler-MC26SLET.js.map
