...
var x = (_a = class extends a3(u2) {
  constructor(e) {
    ...
    const r2 = (e2) => {
      var _a2;
      const { parent: r3 } = e2;
      r3 && r3 !== this && "remove" in r3 && ((_a2 = r3.remove) == null ? void 0 : _a2.call(r3, e2)), e2.parent = this, "elevation" !== e2.type && "integrated-mesh-3dtiles" !== e2.type || i.getLogger(this).error(`Layer '${e2.title}, id:${e2.id}' of type '${e2.type}' is not supported as a basemap layer and will therefore be ignored.`);
    }, t = (e2) => {
      var _a2;
      const { parent: r3 } = e2;
      r3 && r3 !== this && "remove" in r3 && ((_a2 = r3.remove) == null ? void 0 : _a2.call(r3, e2)), e2.parent = this;
    }, a5 = (e2) => {
      const r3 = e2.item;
  ...
  write(e, r2) {
    var _a2;
    return e = e || {}, (r2 == null ? void 0 : r2.origin) || (r2 = { origin: "web-map", ...r2 }), super.write(e, r2), !this.loaded && ((_a2 = this.resourceInfo) == null ? void 0 : _a2.data.baseMapLayers) && (e.baseMapLayers = this.resourceInfo.data.baseMapLayers.map((e2) => {
      const r3 = a(e2);
  ...
  async _loadLayersFromJSON(e, r2, t) {
    var _a2, _b;
    const s4 = (_a2 = this.resourceInfo) == null ? void 0 : _a2.context, a5 = ((_b = this.portalItem) == null ? void 0 : _b.portal) || (s4 == null ? void 0 : s4.portal) || null, o = O2[(s4 == null ? void 0 : s4.origin) || ""] ?? "web-map", { populateOperationalLayers: i2 } = await import("./layersCreator-J2LIQKSQ.js"), n3 = [];
  ...
  async _loadFromStylesService(e, s4) {
    const a5 = e.serviceUrl.endsWith("/webmaps") ? e.serviceUrl.slice(0, -8) : e.serviceUrl, o = `${a5}/styles/${e.id}/self`, i2 = `${a5}/webmaps/${e.id}`, n3 = e.apiKey ?? s.apiKeys.basemapStyles, [l4, p2] = await Promise.all([(await H(o, { query: { token: n3 }, signal: s4 == null ? void 0 : s4.signal })).data, (await H(i2, { query: { language: e.languageParameter, places: e.places, worldview: e.worldview, token: n3 }, signal: s4 == null ? void 0 : s4.signal })).data]);
    this.thumbnailUrl ?? (this.thumbnailUrl = l4.thumbnailUrl);
    const c = I(i2);
...
//# sourceMappingURL=chunk-ABRFJI4R.js.map
